...
extern crate alloc;
use HaveMTEExt::*;
use execute_aarch64_instrs_integer_tags_mcsubtag::*;
use common::*;
pub fn decode_subg_aarch64_instrs_integer_tags_mcsubtag<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Xd: u8,
    Xn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_21: call execute_aarch64_instrs_integer_tags_mcsubtag(s_1_20, s_1_3, s_1_7, s_1_19, s_1_8)
        let s_1_21: () = execute_aarch64_instrs_integer_tags_mcsubtag(
            state,
            tracer,
            s_1_20,
            s_1_3,
