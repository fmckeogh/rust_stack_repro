...
use common::*;
pub fn VMPIDR_EL2_SysRegWrite_652dff4d193b16d2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call Mk_VMPIDR_EL2_Type(s_6_3)
        let s_6_4: ProductType5c790c8ef59cc8b2 = Mk_VMPIDR_EL2_Type(
            state,
            tracer,
            s_6_3,
        );
        // C s_6_5: const #20672u : u32
        let s_6_5: u32 = 20672;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: call Mk_VMPIDR_EL2_Type(s_8_3)
        let s_8_4: ProductType5c790c8ef59cc8b2 = Mk_VMPIDR_EL2_Type(
            state,
            tracer,
            s_8_3,
        );
        // C s_8_5: const #20672u : u32
        let s_8_5: u32 = 20672;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#97034 <= s_10_0
        fn_state.gs_97034 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#97034:u8
        let s_11_0: bool = fn_state.gs_97034;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#97035 <= s_13_0
        fn_state.gs_97035 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#97035:u8
        let s_14_0: bool = fn_state.gs_97035;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_5: write-var gs#97035 <= s_17_4
        fn_state.gs_97035 = s_17_4;
        // N s_17_6: jump b14
        return block_14(state, tracer, fn_state);
    }
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_21: write-var gs#97034 <= s_19_20
        fn_state.gs_97034 = s_19_20;
        // N s_19_22: jump b11
        return block_11(state, tracer, fn_state);
    }
