...
use common::*;
pub fn decode_aarch32_instrs_LDRSB_r_T2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    Rt: u8,
    ...
    struct FunctionState {
        m: i64,
        t: i64,
        ga_344667: ProductType90c39552810120fd,
        shift_t: u32,
        n: i64,
        shift_nshadow_7183: i128,
        Rn: u8,
        Rt: u8,
        imm2: u8,
        Rm: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_26: write-var ga#344667 <= s_4_25
        fn_state.ga_344667 = s_4_25;
        // D s_4_27: read-var ga#344667.0:struct
        let s_4_27: u32 = fn_state.ga_344667._0;
        // D s_4_28: read-var ga#344667.1:struct
        let s_4_28: i64 = fn_state.ga_344667._1;
        ...
        // D s_4_31: write-var shift_nshadow#7183 <= s_4_30
        fn_state.shift_nshadow_7183 = s_4_30;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: read-var shift_nshadow#7183:i
        let s_5_4: i128 = fn_state.shift_nshadow_7183;
        ...
        // D s_5_8: call execute_aarch32_instrs_LDRSB_r_Op_A_txt(s_5_0, s_5_1, s_5_2, s_5_3, s_5_4, s_5_5, s_5_6, s_5_7)
        let s_5_8: () = execute_aarch32_instrs_LDRSB_r_Op_A_txt(
            state,
            tracer,
            s_5_0,
            s_5_1,
