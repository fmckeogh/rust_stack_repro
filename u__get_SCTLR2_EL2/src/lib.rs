...
use common::*;
pub fn u__get_SCTLR2_EL2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #18446744073709551489u : u64
        let s_0_3: u64 = 18446744073709551489;
        ...
        // D s_0_11: tail-call Mk_SCTLR2_EL2_Type(s_0_10)
        return Mk_SCTLR2_EL2_Type(state, tracer, s_0_10);
    }
}
