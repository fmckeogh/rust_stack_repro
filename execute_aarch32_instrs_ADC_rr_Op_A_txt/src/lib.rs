...
use AddWithCarry::*;
use common::*;
pub fn execute_aarch32_instrs_ADC_rr_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        nzcv: u8,
        gs_877683: ProductTyped54bc449dd09e5bd,
        d: i64,
        m: i64,
        n: i64,
        s: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_27: const #16971u : u32
        let s_0_27: u32 = 16971;
        ...
        let s_0_29: Bits = Bits::new(s_0_26 as u128, 32u16);
        // D s_0_30: cast zx s_0_23 -> bv
        let s_0_30: Bits = Bits::new(s_0_23 as u128, 32u16);
        // D s_0_31: call AddWithCarry(s_0_29, s_0_30, s_0_28)
        let s_0_31: ProductTyped54bc449dd09e5bd = AddWithCarry(
            state,
            tracer,
            s_0_29,
            s_0_30,
        ...
        // D s_0_32: write-var gs#877683 <= s_0_31
        fn_state.gs_877683 = s_0_31;
        // D s_0_33: read-var gs#877683.0:struct
        let s_0_33: Bits = fn_state.gs_877683._0;
        // D s_0_34: cast reint s_0_33 -> u32
        let s_0_34: u32 = (s_0_33.value() as u32);
        // D s_0_35: read-var gs#877683.1:struct
        let s_0_35: u8 = fn_state.gs_877683._1;
        // D s_0_36: write-var nzcv <= s_0_35
        fn_state.nzcv = s_0_35;
        // D s_0_37: read-var d:i64
        let s_0_37: i64 = fn_state.d;
        // D s_0_38: cast zx s_0_37 -> i
        let s_0_38: i128 = (i128::try_from(s_0_37).unwrap());
        // D s_0_39: call R_set(s_0_38, s_0_34)
        let s_0_39: () = R_set(state, tracer, s_0_38, s_0_34);
        // D s_0_40: read-var setflags:u8
        let s_0_40: bool = fn_state.setflags;
        // N s_0_41: branch s_0_40 b2 b1
        if s_0_40 {
