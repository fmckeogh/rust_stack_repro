...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_ADC_rr_Op_A_txt::*;
use DecodeRegShift::*;
use common::*;
pub fn decode_aarch32_instrs_ADC_rr_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    S: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#295390 <= s_3_3
        fn_state.gs_295390 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#295390:u8
        let s_4_0: bool = fn_state.gs_295390;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#295392 <= s_5_3
        fn_state.gs_295392 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#295392:u8
        let s_6_0: bool = fn_state.gs_295392;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#295394 <= s_7_3
        fn_state.gs_295394 = s_7_3;
        // N s_7_5: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#295394:u8
        let s_8_0: bool = fn_state.gs_295394;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_6: call execute_aarch32_instrs_ADC_rr_Op_A_txt(s_9_0, s_9_1, s_9_2, s_9_3, s_9_4, s_9_5)
        let s_9_6: () = execute_aarch32_instrs_ADC_rr_Op_A_txt(
            state,
            tracer,
            s_9_0,
            s_9_1,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#295394 <= s_11_0
        fn_state.gs_295394 = s_11_0;
        // N s_11_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#295392 <= s_12_0
        fn_state.gs_295392 = s_12_0;
        // N s_12_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#295390 <= s_13_0
        fn_state.gs_295390 = s_13_0;
        // N s_13_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
