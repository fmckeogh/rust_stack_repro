...
use TLBI::*;
use common::*;
pub fn AArch64_TLBIP_VAA<T: Tracer>(
    state: &mut State,
    tracer: &T,
    security: u32,
    regime: u32,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_7: write-var gs#26634 <= s_2_6
        fn_state.gs_26634 = s_2_6;
        // N s_2_8: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#26634:u8
        let s_3_0: bool = fn_state.gs_26634;
        // D s_3_1: write-var gs#26635 <= s_3_0
        fn_state.gs_26635 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#26635:u8
        let s_4_0: bool = fn_state.gs_26635;
        ...
        let s_4_26: i128 = 64;
        // C s_4_27: const #107s : i
        let s_4_27: i128 = 107;
        // C s_4_28: const #64s : i
        let s_4_28: i128 = 64;
        // C s_4_29: const #12s : i
        let s_4_29: i128 = 12;
        // D s_4_30: read-var Xt:u128
        let s_4_30: u128 = fn_state.Xt;
        // D s_4_31: cast zx s_4_30 -> bv
        let s_4_31: Bits = Bits::new(s_4_30 as u128, 128u16);
        ...
        // D s_4_35: read-var r.13:struct
        let s_4_35: u8 = fn_state.r._13;
        // C s_4_36: const #2s : i
        let s_4_36: i128 = 2;
        // D s_4_37: cast zx s_4_35 -> bv
        let s_4_37: Bits = Bits::new(s_4_35 as u128, 4u16);
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_0: const #1u : u8
        let s_5_0: bool = true;
        // D s_5_1: write-var gs#26643 <= s_5_0
        fn_state.gs_26643 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#26643:u8
        let s_6_0: bool = fn_state.gs_26643;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#26643 <= s_9_0
        fn_state.gs_26643 = s_9_0;
        // N s_9_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#26634 <= s_10_0
        fn_state.gs_26634 = s_10_0;
        // N s_10_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#26635 <= s_11_0
        fn_state.gs_26635 = s_11_0;
        // N s_11_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
