...
use common::*;
pub fn u__get_ICC_CTLR_NS<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4294115516u : u32
        let s_0_3: u32 = 4294115516;
        ...
        // D s_0_11: tail-call Mk_ICC_CTLR_Type(s_0_10)
        return Mk_ICC_CTLR_Type(state, tracer, s_0_10);
    }
}
