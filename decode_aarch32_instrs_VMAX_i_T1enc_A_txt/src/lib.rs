...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_VMAX_i_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_VMAX_i_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    U: bool,
    D: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#312115 <= s_3_0
        fn_state.gs_312115 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#312115:u8
        let s_4_0: bool = fn_state.gs_312115;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: write-var maximum <= s_6_4
        fn_state.maximum = s_6_4;
    ...
    fn block_7<T: Tracer>(
        ...
        let s_7_0: i64 = 2;
        // D s_7_1: write-var ga#355414 <= s_7_0
        fn_state.ga_355414 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var ga#355414:i64
        let s_8_0: i64 = fn_state.ga_355414;
        ...
        // D s_8_8: read-var maximum:u8
        let s_8_8: bool = fn_state.maximum;
        // D s_8_9: read-var n:i64
        let s_8_9: i64 = fn_state.n;
        // D s_8_10: read-var is_unsigned:u8
        let s_8_10: bool = fn_state.is_unsigned;
        // D s_8_11: call execute_aarch32_instrs_VMAX_i_Op_A_txt(s_8_6, s_8_5, s_8_3, s_8_7, s_8_8, s_8_9, s_8_0, s_8_10)
        let s_8_11: () = execute_aarch32_instrs_VMAX_i_Op_A_txt(
            state,
            tracer,
            s_8_6,
            s_8_5,
    ...
    fn block_9<T: Tracer>(
        ...
        let s_9_0: i64 = 1;
        // D s_9_1: write-var ga#355414 <= s_9_0
        fn_state.ga_355414 = s_9_0;
        // N s_9_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_22: write-var gs#312111 <= s_13_21
        fn_state.gs_312111 = s_13_21;
        // N s_13_23: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#312111:u8
        let s_14_0: bool = fn_state.gs_312111;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_22: write-var gs#312114 <= s_15_21
        fn_state.gs_312114 = s_15_21;
        // N s_15_23: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#312114:u8
        let s_16_0: bool = fn_state.gs_312114;
        // D s_16_1: write-var gs#312115 <= s_16_0
        fn_state.gs_312115 = s_16_0;
        // N s_16_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#312114 <= s_17_0
        fn_state.gs_312114 = s_17_0;
        // N s_17_2: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#312111 <= s_18_0
        fn_state.gs_312111 = s_18_0;
        // N s_18_2: jump b14
        return block_14(state, tracer, fn_state);
    }
}
