...
use common::*;
pub fn decode_aarch32_instrs_MUL_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    Rdm: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var Rdm:u8
        let s_2_0: u8 = fn_state.Rdm;
        ...
        // D s_2_8: read-var Rdm:u8
        let s_2_8: u8 = fn_state.Rdm;
        ...
        // D s_2_15: call execute_aarch32_instrs_MUL_Op_A_txt(s_2_3, s_2_11, s_2_7, s_2_14)
        let s_2_15: () = execute_aarch32_instrs_MUL_Op_A_txt(
            state,
            tracer,
            s_2_3,
            s_2_11,
