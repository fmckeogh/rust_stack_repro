...
extern crate alloc;
use execute_SPLICE_Z_P_ZZ_Con::*;
use CurrentVL_read::*;
use HaveSVE2::*;
use HaveSME::*;
use common::*;
pub fn decode_SPLICE_Z_P_ZZ_Con<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Pv: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#196408 <= s_1_0
        fn_state.gs_196408 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#196408:u8
        let s_2_0: bool = fn_state.gs_196408;
    ...
    fn block_3<T: Tracer>(
        ...
        fn_state.v = s_3_10;
        // D s_3_12: read-var Zd:u8
        let s_3_12: u8 = fn_state.Zd;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: read-var s2:i64
        let s_4_4: i64 = fn_state.s2;
        // D s_4_5: cast zx s_4_4 -> i
        let s_4_5: i128 = (i128::try_from(s_4_4).unwrap());
        // D s_4_6: read-var dst:i64
        let s_4_6: i64 = fn_state.dst;
        // D s_4_7: read-var s1:i64
        let s_4_7: i64 = fn_state.s1;
        // D s_4_8: read-var v:i64
        let s_4_8: i64 = fn_state.v;
        // D s_4_9: call execute_SPLICE_Z_P_ZZ_Con(s_4_0, s_4_6, s_4_3, s_4_7, s_4_5, s_4_8)
        let s_4_9: () = execute_SPLICE_Z_P_ZZ_Con(
            state,
            tracer,
            s_4_0,
            s_4_6,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: read-var s2:i64
        let s_6_4: i64 = fn_state.s2;
        // D s_6_5: cast zx s_6_4 -> i
        let s_6_5: i128 = (i128::try_from(s_6_4).unwrap());
        // D s_6_6: read-var dst:i64
        let s_6_6: i64 = fn_state.dst;
        // D s_6_7: read-var s1:i64
        let s_6_7: i64 = fn_state.s1;
        // D s_6_8: read-var v:i64
        let s_6_8: i64 = fn_state.v;
        // D s_6_9: call execute_SPLICE_Z_P_ZZ_Con(s_6_0, s_6_6, s_6_3, s_6_7, s_6_5, s_6_8)
        let s_6_9: () = execute_SPLICE_Z_P_ZZ_Con(
            state,
            tracer,
            s_6_0,
            s_6_6,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: read-var s2:i64
        let s_8_4: i64 = fn_state.s2;
        // D s_8_5: cast zx s_8_4 -> i
        let s_8_5: i128 = (i128::try_from(s_8_4).unwrap());
        // D s_8_6: read-var dst:i64
        let s_8_6: i64 = fn_state.dst;
        // D s_8_7: read-var s1:i64
        let s_8_7: i64 = fn_state.s1;
        // D s_8_8: read-var v:i64
        let s_8_8: i64 = fn_state.v;
        // D s_8_9: call execute_SPLICE_Z_P_ZZ_Con(s_8_0, s_8_6, s_8_3, s_8_7, s_8_5, s_8_8)
        let s_8_9: () = execute_SPLICE_Z_P_ZZ_Con(
            state,
            tracer,
            s_8_0,
            s_8_6,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: read-var s2:i64
        let s_10_4: i64 = fn_state.s2;
        // D s_10_5: cast zx s_10_4 -> i
        let s_10_5: i128 = (i128::try_from(s_10_4).unwrap());
        // D s_10_6: read-var dst:i64
        let s_10_6: i64 = fn_state.dst;
        // D s_10_7: read-var s1:i64
        let s_10_7: i64 = fn_state.s1;
        // D s_10_8: read-var v:i64
        let s_10_8: i64 = fn_state.v;
        // D s_10_9: call execute_SPLICE_Z_P_ZZ_Con(s_10_0, s_10_6, s_10_3, s_10_7, s_10_5, s_10_8)
        let s_10_9: () = execute_SPLICE_Z_P_ZZ_Con(
            state,
            tracer,
            s_10_0,
            s_10_6,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_4: read-var s2:i64
        let s_12_4: i64 = fn_state.s2;
        // D s_12_5: cast zx s_12_4 -> i
        let s_12_5: i128 = (i128::try_from(s_12_4).unwrap());
        // D s_12_6: read-var dst:i64
        let s_12_6: i64 = fn_state.dst;
        // D s_12_7: read-var s1:i64
        let s_12_7: i64 = fn_state.s1;
        // D s_12_8: read-var v:i64
        let s_12_8: i64 = fn_state.v;
        // D s_12_9: call execute_SPLICE_Z_P_ZZ_Con(s_12_0, s_12_6, s_12_3, s_12_7, s_12_5, s_12_8)
        let s_12_9: () = execute_SPLICE_Z_P_ZZ_Con(
            state,
            tracer,
            s_12_0,
            s_12_6,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#196408 <= s_15_2
        fn_state.gs_196408 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
