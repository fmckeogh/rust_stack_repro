...
use CurrentVL_read::*;
use HaveSME2::*;
use execute_FRINTM_MZ_Z_4::*;
use common::*;
pub fn decode_FRINTM_MZ_Z_4<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Zn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_4: i64 = 4;
        // C s_2_5: const #2u : u32
        let s_2_5: u32 = 2;
        // D s_2_6: call execute_FRINTM_MZ_Z_4(s_2_0, s_2_1, s_2_2, s_2_3, s_2_4, s_2_5)
        let s_2_6: () = execute_FRINTM_MZ_Z_4(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_4: i64 = 4;
        // C s_4_5: const #2u : u32
        let s_4_5: u32 = 2;
        // D s_4_6: call execute_FRINTM_MZ_Z_4(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5)
        let s_4_6: () = execute_FRINTM_MZ_Z_4(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_5: u32 = 2;
        // D s_6_6: call execute_FRINTM_MZ_Z_4(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5)
        let s_6_6: () = execute_FRINTM_MZ_Z_4(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_5: u32 = 2;
        // D s_8_6: call execute_FRINTM_MZ_Z_4(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5)
        let s_8_6: () = execute_FRINTM_MZ_Z_4(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_4: i64 = 4;
        // C s_10_5: const #2u : u32
        let s_10_5: u32 = 2;
        // D s_10_6: call execute_FRINTM_MZ_Z_4(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5)
        let s_10_6: () = execute_FRINTM_MZ_Z_4(
            state,
            tracer,
            s_10_0,
            s_10_1,
