...
use Z_set::*;
use common::*;
pub fn execute_BSL1N_Z_ZZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    dn: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#4292 <= s_0_2
        fn_state.VLshadow_4292 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#4292:i64
        let s_1_0: i64 = fn_state.VLshadow_4292;
        ...
        // D s_1_21: not s_1_6
        let s_1_21: Bits = !s_1_6;
        // D s_1_22: and s_1_21 s_1_18
        let s_1_22: Bits = ((s_1_21) & (s_1_18));
        // D s_1_23: not s_1_18
        let s_1_23: Bits = !s_1_18;
        // D s_1_24: and s_1_12 s_1_23
        let s_1_24: Bits = ((s_1_12) & (s_1_23));
        // D s_1_25: or s_1_22 s_1_24
        let s_1_25: Bits = ((s_1_22) | (s_1_24));
