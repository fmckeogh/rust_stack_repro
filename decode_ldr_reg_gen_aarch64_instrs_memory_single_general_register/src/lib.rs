...
use DecodeRegExtend::*;
use common::*;
pub fn decode_ldr_reg_gen_aarch64_instrs_memory_single_general_register<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 0;
        // D s_2_1: write-var ga#262209 <= s_2_0
        fn_state.ga_262209 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#262209:i64
        let s_3_0: i64 = fn_state.ga_262209;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#163442 <= s_6_0
        fn_state.gs_163442 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#163442:u8
        let s_7_0: bool = fn_state.gs_163442;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_22: write-var gs#163442 <= s_14_21
        fn_state.gs_163442 = s_14_21;
        // N s_14_23: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var ga#262209 <= s_25_0
        fn_state.ga_262209 = s_25_0;
        // N s_25_2: jump b3
        return block_3(state, tracer, fn_state);
    }
