...
use common::*;
pub fn decode_sqxtun_advsimd_aarch64_instrs_vector_arithmetic_unary_extract_sqxtun_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, size: u8) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_14: call execute_aarch64_instrs_vector_arithmetic_unary_extract_sqxtun_sisd(s_1_12, s_1_7, s_1_10, s_1_9, s_1_13, s_1_11)
        let s_1_14: () = execute_aarch64_instrs_vector_arithmetic_unary_extract_sqxtun_sisd(
            state,
            tracer,
            s_1_12,
            s_1_7,
