...
use Mem_set::*;
use common::*;
pub fn execute_ST1H_Z_P_AI_D<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    esize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#5120 <= s_0_2
        fn_state.VLshadow_5120 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#5120:i64
        let s_1_0: i64 = fn_state.VLshadow_5120;
        // D s_1_1: write-var VLshadow#5121 <= s_1_0
        fn_state.VLshadow_5121 = s_1_0;
        // C s_1_2: const #8s : i
        let s_1_2: i128 = 8;
        // D s_1_3: read-var VLshadow#5121:i64
        let s_1_3: i64 = fn_state.VLshadow_5121;
        ...
        // D s_1_7: read-var VLshadow#5121:i64
        let s_1_7: i64 = fn_state.VLshadow_5121;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var srcshadow#5122 <= s_3_0
        fn_state.srcshadow_5122 = s_3_0;
        // D s_3_2: read-var base:bv
        let s_3_2: Bits = fn_state.base;
        // D s_3_3: write-var baseshadow#5123 <= s_3_2
        fn_state.baseshadow_5123 = s_3_2;
        ...
        // D s_3_10: write-var gs#246096 <= s_3_9
        fn_state.gs_246096 = s_3_9;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#246096:i64
        let s_4_1: i64 = fn_state.gs_246096;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_6: read-var baseshadow#5123:bv
        let s_8_6: Bits = fn_state.baseshadow_5123;
        ...
        // D s_8_30: read-var srcshadow#5122:bv
        let s_8_30: Bits = fn_state.srcshadow_5122;
        // D s_8_31: call Elem_read(s_8_30, s_8_28, s_8_29)
        let s_8_31: Bits = Elem_read(state, tracer, s_8_30, s_8_28, s_8_29);
        // D s_8_32: cast reint s_8_31 -> u64
        let s_8_32: u64 = (s_8_31.value() as u64);
        // C s_8_33: const #0s : i
        let s_8_33: i128 = 0;
        // C s_8_34: const #16s : i
        let s_8_34: i128 = 16;
        // D s_8_35: cast zx s_8_32 -> bv
        let s_8_35: Bits = Bits::new(s_8_32 as u128, 64u16);
        // D s_8_36: bit-extract s_8_35 s_8_33 s_8_34
        let s_8_36: Bits = (Bits::new(
            ((s_8_35) >> (s_8_33)).value(),
            u16::try_from(s_8_34).unwrap(),
        ));
        // D s_8_37: cast reint s_8_36 -> u16
        let s_8_37: u16 = (s_8_36.value() as u16);
        ...
        let s_8_40: Bits = Bits::new(s_8_37 as u128, 16u16);
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var VLshadow#5121:i64
        let s_10_0: i64 = fn_state.VLshadow_5121;
        ...
        // D s_10_8: read-var VLshadow#5121:i64
        let s_10_8: i64 = fn_state.VLshadow_5121;
