...
use common::*;
pub fn VMPIDR_EL2_SysRegRead_4d4e4e0bcb925136<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_100124: ProductType5c790c8ef59cc8b2,
        gs_74583: bool,
        ga_100127: ProductType5c790c8ef59cc8b2,
        u__PSTATE_EL: u8,
        ga_100112: u64,
        gs_74584: bool,
        u__HCR_EL2_NV: bool,
        ga_100118: ProductType5c790c8ef59cc8b2,
        el: u8,
        op0: u8,
        op1: u8,
        CRn: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_VMPIDR_EL2(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_VMPIDR_EL2(state, tracer, s_6_2);
        // D s_6_4: write-var ga#100127 <= s_6_3
        fn_state.ga_100127 = s_6_3;
        // D s_6_5: read-var ga#100127.0:struct
        let s_6_5: u64 = fn_state.ga_100127._0;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_3: call __get_MPIDR_EL1(s_7_2)
        let s_7_3: ProductType5c790c8ef59cc8b2 = u__get_MPIDR_EL1(state, tracer, s_7_2);
        // D s_7_4: write-var ga#100124 <= s_7_3
        fn_state.ga_100124 = s_7_3;
        // D s_7_5: read-var ga#100124.0:struct
        let s_7_5: u64 = fn_state.ga_100124._0;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_3: call __get_VMPIDR_EL2(s_8_2)
        let s_8_3: ProductType5c790c8ef59cc8b2 = u__get_VMPIDR_EL2(state, tracer, s_8_2);
        // D s_8_4: write-var ga#100118 <= s_8_3
        fn_state.ga_100118 = s_8_3;
        // D s_8_5: read-var ga#100118.0:struct
        let s_8_5: u64 = fn_state.ga_100118._0;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#74583 <= s_10_0
        fn_state.gs_74583 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#74583:u8
        let s_11_0: bool = fn_state.gs_74583;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#74584 <= s_13_0
        fn_state.gs_74584 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#74584:u8
        let s_14_0: bool = fn_state.gs_74584;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_5: write-var gs#74584 <= s_17_4
        fn_state.gs_74584 = s_17_4;
        // N s_17_6: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_18<T: Tracer>(
        ...
        // D s_18_6: write-var ga#100112 <= s_18_5
        fn_state.ga_100112 = s_18_5;
        // N s_18_7: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var ga#100112:u64
        let s_19_0: u64 = fn_state.ga_100112;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_21: write-var gs#74583 <= s_20_20
        fn_state.gs_74583 = s_20_20;
        // N s_20_22: jump b11
        return block_11(state, tracer, fn_state);
    }
