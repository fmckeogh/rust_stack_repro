...
use HaveSVE2p1::*;
use CurrentVL_read::*;
use execute_LD1W_Z_P_BI_U128::*;
use common::*;
pub fn decode_LD1W_Z_P_BI_U128<T: Tracer>(
    state: &mut State,
    tracer: &T,
    dtype: u8,
    imm4: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        fn_state.n = s_1_8;
        // D s_1_10: read-var Pg:u8
        let s_1_10: u8 = fn_state.Pg;
        ...
        // D s_1_14: write-var g <= s_1_13
        fn_state.g = s_1_13;
        // D s_1_15: read-var imm4:u8
        let s_1_15: u8 = fn_state.imm4;
        // D s_1_16: cast zx s_1_15 -> bv
        let s_1_16: Bits = Bits::new(s_1_15 as u128, 4u16);
        // D s_1_17: cast sx s_1_16 -> i
        let s_1_17: i128 = {
            let sign_bit = s_1_16.length() - 1;
            let mut result = s_1_16.value() as i128;
        ...
        // D s_1_19: write-var offset <= s_1_18
        fn_state.offset = s_1_18;
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_8: const #1u : u8
        let s_2_8: bool = true;
        // D s_2_9: call execute_LD1W_Z_P_BI_U128(s_2_0, s_2_3, s_2_4, s_2_5, s_2_6, s_2_2, s_2_7, s_2_8)
        let s_2_9: () = execute_LD1W_Z_P_BI_U128(
            state,
            tracer,
            s_2_0,
            s_2_3,
    ...
    fn block_4<T: Tracer>(
        ...
        // C s_4_8: const #1u : u8
        let s_4_8: bool = true;
        // D s_4_9: call execute_LD1W_Z_P_BI_U128(s_4_0, s_4_3, s_4_4, s_4_5, s_4_6, s_4_2, s_4_7, s_4_8)
        let s_4_9: () = execute_LD1W_Z_P_BI_U128(
            state,
            tracer,
            s_4_0,
            s_4_3,
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_8: const #1u : u8
        let s_6_8: bool = true;
        // D s_6_9: call execute_LD1W_Z_P_BI_U128(s_6_0, s_6_3, s_6_4, s_6_5, s_6_6, s_6_2, s_6_7, s_6_8)
        let s_6_9: () = execute_LD1W_Z_P_BI_U128(
            state,
            tracer,
            s_6_0,
            s_6_3,
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_8: const #1u : u8
        let s_8_8: bool = true;
        // D s_8_9: call execute_LD1W_Z_P_BI_U128(s_8_0, s_8_3, s_8_4, s_8_5, s_8_6, s_8_2, s_8_7, s_8_8)
        let s_8_9: () = execute_LD1W_Z_P_BI_U128(
            state,
            tracer,
            s_8_0,
            s_8_3,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_9: call execute_LD1W_Z_P_BI_U128(s_10_0, s_10_3, s_10_4, s_10_5, s_10_6, s_10_2, s_10_7, s_10_8)
        let s_10_9: () = execute_LD1W_Z_P_BI_U128(
            state,
            tracer,
            s_10_0,
            s_10_3,
