...
use ALUWritePC::*;
use common::*;
pub fn execute_aarch32_instrs_ADD_r_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        result: u32,
        nzcv: u8,
        gs_877805: ProductTyped54bc449dd09e5bd,
        d: i64,
        m: i64,
        n: i64,
        setflags: bool,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_17: write-var gs#877805 <= s_0_16
        fn_state.gs_877805 = s_0_16;
        // D s_0_18: read-var gs#877805.0:struct
        let s_0_18: Bits = fn_state.gs_877805._0;
        // D s_0_19: cast reint s_0_18 -> u32
        let s_0_19: u32 = (s_0_18.value() as u32);
        // D s_0_20: read-var gs#877805.1:struct
        let s_0_20: u8 = fn_state.gs_877805._1;
        // D s_0_21: write-var result <= s_0_19
        fn_state.result = s_0_19;
        // D s_0_22: write-var nzcv <= s_0_20
        fn_state.nzcv = s_0_20;
        // C s_0_23: const #15s : i
        let s_0_23: i128 = 15;
