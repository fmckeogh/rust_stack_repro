...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_binary_uniform_rsqrts_fp16_sisd::*;
use common::*;
pub fn decode_frsqrts_advsimd_aarch64_instrs_vector_arithmetic_binary_uniform_rsqrts_fp16_simd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, Rm: u8, Q: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#256702 <= s_1_0
        fn_state.ga_256702 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#256702:i64
        let s_2_0: i64 = fn_state.ga_256702;
        // C s_2_1: const #16s : i
        let s_2_1: i128 = 16;
        ...
        // D s_2_12: call execute_aarch64_instrs_vector_arithmetic_binary_uniform_rsqrts_fp16_sisd(s_2_9, s_2_6, s_2_8, s_2_7, s_2_10, s_2_11)
        let s_2_12: () = execute_aarch64_instrs_vector_arithmetic_binary_uniform_rsqrts_fp16_sisd(
            state,
            tracer,
            s_2_9,
            s_2_6,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 128;
        // D s_3_1: write-var ga#256702 <= s_3_0
        fn_state.ga_256702 = s_3_0;
        // N s_3_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
