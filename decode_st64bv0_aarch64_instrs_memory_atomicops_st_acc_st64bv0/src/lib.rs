...
extern crate alloc;
use neq_int::*;
use execute_aarch64_instrs_memory_atomicops_st_acc_st64bv0::*;
use HaveFeatLS64_ACCDATA::*;
use common::*;
pub fn decode_st64bv0_aarch64_instrs_memory_atomicops_st_acc_st64bv0<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_0: const #() : ()
        let s_0_0: () = ();
        // S s_0_1: call HaveFeatLS64_ACCDATA(s_0_0)
        let s_0_1: bool = HaveFeatLS64_ACCDATA(state, tracer, s_0_0);
        // S s_0_2: not s_0_1
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_22: write-var gs#173171 <= s_2_21
        fn_state.gs_173171 = s_2_21;
        // N s_2_23: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#173171:u8
        let s_3_0: bool = fn_state.gs_173171;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_19: call execute_aarch64_instrs_memory_atomicops_st_acc_st64bv0(s_4_18, s_4_17, s_4_8, s_4_3, s_4_12, s_4_7, s_4_15)
        let s_4_19: () = execute_aarch64_instrs_memory_atomicops_st_acc_st64bv0(
            state,
            tracer,
            s_4_18,
            s_4_17,
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #1u : u8
        let s_6_0: bool = true;
        // D s_6_1: write-var gs#173171 <= s_6_0
        fn_state.gs_173171 = s_6_0;
        // N s_6_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_7<T: Tracer>(
