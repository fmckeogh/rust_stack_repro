...
extern crate alloc;
use u_get_SCTLR_EL1_Type_C::*;
use u_get_SCTLR_EL2_Type_C::*;
use u_get_SCTLR_EL3_Type_C::*;
use common::*;
pub fn AArch64_S1DCacheEnabled<T: Tracer>(
    state: &mut State,
    tracer: &T,
    regime: u32,
) -> bool {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_2: call _get_SCTLR_EL3_Type_C(s_1_1)
        let s_1_2: bool = u_get_SCTLR_EL3_Type_C(state, tracer, s_1_1);
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: call _get_SCTLR_EL2_Type_C(s_4_1)
        let s_4_2: bool = u_get_SCTLR_EL2_Type_C(state, tracer, s_4_1);
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call _get_SCTLR_EL2_Type_C(s_6_1)
        let s_6_2: bool = u_get_SCTLR_EL2_Type_C(state, tracer, s_6_1);
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_2: call _get_SCTLR_EL1_Type_C(s_8_1)
        let s_8_2: bool = u_get_SCTLR_EL1_Type_C(state, tracer, s_8_1);
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var ga#12929:u8
        let s_9_0: bool = fn_state.ga_12929;
