...
extern crate alloc;
use u__set_GPCCR_EL3::*;
use X_read::*;
use Mk_GPCCR_EL3_Type::*;
use common::*;
pub fn GPCCR_EL3_SysRegWrite_34a621e690dc851f<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_GPCCR_EL3_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_GPCCR_EL3_Type(state, tracer, s_5_3);
        // D s_5_5: call __set_GPCCR_EL3(s_5_4)
        let s_5_5: () = u__set_GPCCR_EL3(state, tracer, s_5_4);
        // N s_5_6: return
        return;
    }
    fn block_6<T: Tracer>(
