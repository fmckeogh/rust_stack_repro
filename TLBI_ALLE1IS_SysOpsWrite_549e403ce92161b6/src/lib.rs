...
use common::*;
pub fn TLBI_ALLE1IS_SysOpsWrite_549e403ce92161b6<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_3: const #4u : u32
        let s_5_3: u32 = 4;
        // C s_5_4: const #1u : u32
        let s_5_4: u32 = 1;
        // C s_5_5: const #0u : u32
        let s_5_5: u32 = 0;
        // D s_5_6: call AArch64_TLBI_ALL(s_5_2, s_5_3, s_5_4, s_5_5)
        let s_5_6: () = AArch64_TLBI_ALL(state, tracer, s_5_2, s_5_3, s_5_4, s_5_5);
        // N s_5_7: return
        return;
    }
    fn block_6<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#101970 <= s_8_0
        fn_state.gs_101970 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#101970:u8
        let s_9_0: bool = fn_state.gs_101970;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#101970 <= s_12_4
        fn_state.gs_101970 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
