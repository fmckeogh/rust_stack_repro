...
use u_get_HDFGWTR_EL2_Type_OSECCR_EL1::*;
use u_get_MDCR_EL3_Type_TDA::*;
use u_get_OSLSR_EL1_Type_OSLK::*;
use u_get_EDSCR_Type_SDD::*;
use Mk_OSECCR_EL1_Type::*;
use EL2Enabled::*;
use u_get_MDCR_EL2_Type_TDA::*;
use EDSCR_read::*;
use common::*;
pub fn OSECCR_EL1_SysRegWrite_e6c17a3df51100b5<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ...
        u__HDFGWTR_EL2_OSECCR_EL1: bool,
        gs_87050: bool,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_17: call _get_HDFGWTR_EL2_Type_OSECCR_EL1(s_0_16)
        let s_0_17: bool = u_get_HDFGWTR_EL2_Type_OSECCR_EL1(state, tracer, s_0_16);
        // D s_0_18: write-var __HDFGWTR_EL2_OSECCR_EL1 <= s_0_17
        fn_state.u__HDFGWTR_EL2_OSECCR_EL1 = s_0_17;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call Mk_OSECCR_EL1_Type(s_6_3)
        let s_6_4: ProductType5c790c8ef59cc8b2 = Mk_OSECCR_EL1_Type(
            state,
            tracer,
            s_6_3,
        );
        // C s_6_5: const #19968u : u32
        let s_6_5: u32 = 19968;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#87047 <= s_9_0
        fn_state.gs_87047 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#87047:u8
        let s_10_0: bool = fn_state.gs_87047;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#87048 <= s_11_0
        fn_state.gs_87048 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#87048:u8
        let s_12_0: bool = fn_state.gs_87048;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#87049 <= s_13_0
        fn_state.gs_87049 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#87049:u8
        let s_14_0: bool = fn_state.gs_87049;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#87050 <= s_15_0
        fn_state.gs_87050 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#87050:u8
        let s_16_0: bool = fn_state.gs_87050;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#87051 <= s_18_0
        fn_state.gs_87051 = s_18_0;
        // N s_18_2: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#87051:u8
        let s_19_0: bool = fn_state.gs_87051;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_4: call Mk_OSECCR_EL1_Type(s_21_3)
        let s_21_4: ProductType5c790c8ef59cc8b2 = Mk_OSECCR_EL1_Type(
            state,
            tracer,
            s_21_3,
        );
        // C s_21_5: const #19968u : u32
        let s_21_5: u32 = 19968;
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_1: write-var gs#87053 <= s_24_0
        fn_state.gs_87053 = s_24_0;
        // N s_24_2: jump b25
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_0: read-var gs#87053:u8
        let s_25_0: bool = fn_state.gs_87053;
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_5: write-var gs#87053 <= s_28_4
        fn_state.gs_87053 = s_28_4;
        // N s_28_6: jump b25
        return block_25(state, tracer, fn_state);
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_5: write-var gs#87051 <= s_29_4
        fn_state.gs_87051 = s_29_4;
        // N s_29_6: jump b19
        return block_19(state, tracer, fn_state);
    }
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_5: write-var gs#87050 <= s_31_4
        fn_state.gs_87050 = s_31_4;
        // N s_31_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_32<T: Tracer>(
        ...
        // D s_32_2: write-var gs#87049 <= s_32_1
        fn_state.gs_87049 = s_32_1;
        // N s_32_3: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_33<T: Tracer>(
        ...
        // D s_33_5: write-var gs#87048 <= s_33_4
        fn_state.gs_87048 = s_33_4;
        // N s_33_6: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_34<T: Tracer>(
        ...
        // D s_34_4: write-var gs#87047 <= s_34_3
        fn_state.gs_87047 = s_34_3;
        // N s_34_5: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_1: write-var gs#87054 <= s_36_0
        fn_state.gs_87054 = s_36_0;
        // N s_36_2: jump b37
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_0: read-var gs#87054:u8
        let s_37_0: bool = fn_state.gs_87054;
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_1: write-var gs#87055 <= s_38_0
        fn_state.gs_87055 = s_38_0;
        // N s_38_2: jump b39
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_0: read-var gs#87055:u8
        let s_39_0: bool = fn_state.gs_87055;
    ...
    fn block_40<T: Tracer>(
        ...
        // D s_40_1: write-var gs#87056 <= s_40_0
        fn_state.gs_87056 = s_40_0;
        // N s_40_2: jump b41
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_0: read-var gs#87056:u8
        let s_41_0: bool = fn_state.gs_87056;
    ...
    fn block_42<T: Tracer>(
        ...
        // D s_42_1: write-var gs#87057 <= s_42_0
        fn_state.gs_87057 = s_42_0;
        // N s_42_2: jump b43
    ...
    fn block_43<T: Tracer>(
        ...
        // D s_43_0: read-var gs#87057:u8
        let s_43_0: bool = fn_state.gs_87057;
    ...
    fn block_45<T: Tracer>(
        ...
        // D s_45_1: write-var gs#87058 <= s_45_0
        fn_state.gs_87058 = s_45_0;
        // N s_45_2: jump b46
    ...
    fn block_46<T: Tracer>(
        ...
        // D s_46_0: read-var gs#87058:u8
        let s_46_0: bool = fn_state.gs_87058;
    ...
    fn block_47<T: Tracer>(
        ...
        // D s_47_1: write-var gs#87060 <= s_47_0
        fn_state.gs_87060 = s_47_0;
        // N s_47_2: jump b48
    ...
    fn block_48<T: Tracer>(
        ...
        // D s_48_0: read-var gs#87060:u8
        let s_48_0: bool = fn_state.gs_87060;
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_1: write-var gs#87061 <= s_49_0
        fn_state.gs_87061 = s_49_0;
        // N s_49_2: jump b50
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_0: read-var gs#87061:u8
        let s_50_0: bool = fn_state.gs_87061;
    ...
    fn block_52<T: Tracer>(
        ...
        // D s_52_1: write-var gs#87062 <= s_52_0
        fn_state.gs_87062 = s_52_0;
        // N s_52_2: jump b53
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_0: read-var gs#87062:u8
        let s_53_0: bool = fn_state.gs_87062;
    ...
    fn block_55<T: Tracer>(
        ...
        // D s_55_1: write-var gs#87063 <= s_55_0
        fn_state.gs_87063 = s_55_0;
        // N s_55_2: jump b56
    ...
    fn block_56<T: Tracer>(
        ...
        // D s_56_0: read-var gs#87063:u8
        let s_56_0: bool = fn_state.gs_87063;
    ...
    fn block_58<T: Tracer>(
        ...
        // D s_58_4: call Mk_OSECCR_EL1_Type(s_58_3)
        let s_58_4: ProductType5c790c8ef59cc8b2 = Mk_OSECCR_EL1_Type(
            state,
            tracer,
            s_58_3,
        );
        // C s_58_5: const #19968u : u32
        let s_58_5: u32 = 19968;
    ...
    fn block_61<T: Tracer>(
        ...
        // D s_61_1: write-var gs#87065 <= s_61_0
        fn_state.gs_87065 = s_61_0;
        // N s_61_2: jump b62
    ...
    fn block_62<T: Tracer>(
        ...
        // D s_62_0: read-var gs#87065:u8
        let s_62_0: bool = fn_state.gs_87065;
    ...
    fn block_65<T: Tracer>(
        ...
        // D s_65_5: write-var gs#87065 <= s_65_4
        fn_state.gs_87065 = s_65_4;
        // N s_65_6: jump b62
        return block_62(state, tracer, fn_state);
    }
    fn block_66<T: Tracer>(
        ...
        // D s_66_5: write-var gs#87063 <= s_66_4
        fn_state.gs_87063 = s_66_4;
        // N s_66_6: jump b56
        return block_56(state, tracer, fn_state);
    }
    ...
    fn block_68<T: Tracer>(
        ...
        // D s_68_21: write-var gs#87062 <= s_68_20
        fn_state.gs_87062 = s_68_20;
        // N s_68_22: jump b53
        return block_53(state, tracer, fn_state);
    }
    ...
    fn block_70<T: Tracer>(
        ...
        // D s_70_0: read-var __HDFGWTR_EL2_OSECCR_EL1:u8
        let s_70_0: bool = fn_state.u__HDFGWTR_EL2_OSECCR_EL1;
        ...
        // D s_70_5: write-var gs#87061 <= s_70_4
        fn_state.gs_87061 = s_70_4;
        // N s_70_6: jump b50
        return block_50(state, tracer, fn_state);
    }
    ...
    fn block_72<T: Tracer>(
        ...
        // D s_72_5: write-var gs#87059 <= s_72_4
        fn_state.gs_87059 = s_72_4;
        // N s_72_6: jump b73
    ...
    fn block_73<T: Tracer>(
        ...
        // D s_73_0: read-var gs#87059:u8
        let s_73_0: bool = fn_state.gs_87059;
        // D s_73_1: write-var gs#87060 <= s_73_0
        fn_state.gs_87060 = s_73_0;
        // N s_73_2: jump b48
        return block_48(state, tracer, fn_state);
    }
    fn block_74<T: Tracer>(
        ...
        // D s_74_1: write-var gs#87059 <= s_74_0
        fn_state.gs_87059 = s_74_0;
        // N s_74_2: jump b73
        return block_73(state, tracer, fn_state);
    }
    fn block_75<T: Tracer>(
        ...
        // D s_75_2: write-var gs#87058 <= s_75_1
        fn_state.gs_87058 = s_75_1;
        // N s_75_3: jump b46
        return block_46(state, tracer, fn_state);
    }
    ...
    fn block_77<T: Tracer>(
        ...
        // D s_77_5: write-var gs#87057 <= s_77_4
        fn_state.gs_87057 = s_77_4;
        // N s_77_6: jump b43
        return block_43(state, tracer, fn_state);
    }
    fn block_78<T: Tracer>(
        ...
        // D s_78_2: write-var gs#87056 <= s_78_1
        fn_state.gs_87056 = s_78_1;
        // N s_78_3: jump b41
        return block_41(state, tracer, fn_state);
    }
    fn block_79<T: Tracer>(
        ...
        // D s_79_5: write-var gs#87055 <= s_79_4
        fn_state.gs_87055 = s_79_4;
        // N s_79_6: jump b39
        return block_39(state, tracer, fn_state);
    }
    fn block_80<T: Tracer>(
        ...
        // D s_80_4: write-var gs#87054 <= s_80_3
        fn_state.gs_87054 = s_80_3;
        // N s_80_5: jump b37
        return block_37(state, tracer, fn_state);
    }
