...
use common::*;
pub fn decode_fcmeq_advsimd_zero_aarch64_instrs_vector_arithmetic_unary_cmp_fp16_bulk_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, op: bool, U: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_23: write-var ga#253190 <= s_1_22
        fn_state.ga_253190 = s_1_22;
        // D s_1_24: read-var ga#253190:u8
        let s_1_24: u8 = fn_state.ga_253190;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#253190:u8
        let s_4_0: u8 = fn_state.ga_253190;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#253190:u8
        let s_6_0: u8 = fn_state.ga_253190;
