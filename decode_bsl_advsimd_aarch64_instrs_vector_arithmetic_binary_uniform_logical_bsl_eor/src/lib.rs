...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_binary_uniform_logical_bsl_eor::*;
use common::*;
pub fn decode_bsl_advsimd_aarch64_instrs_vector_arithmetic_binary_uniform_logical_bsl_eor<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, Rm: u8, opc2: u8, Q: bool) -> () {
    #[derive(Default)]
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#250220 <= s_1_0
        fn_state.ga_250220 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#250220:i64
        let s_2_0: i64 = fn_state.ga_250220;
        // D s_2_1: write-var datasize <= s_2_0
        fn_state.datasize = s_2_0;
        // D s_2_2: read-var opc2:u8
        let s_2_2: u8 = fn_state.opc2;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_7: call execute_aarch64_instrs_vector_arithmetic_binary_uniform_logical_bsl_eor(s_4_4, s_4_3, s_4_5, s_4_6, s_4_0)
        let s_4_7: () = execute_aarch64_instrs_vector_arithmetic_binary_uniform_logical_bsl_eor(
            state,
            tracer,
            s_4_4,
            s_4_3,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var opc2:u8
        let s_5_0: u8 = fn_state.opc2;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var opc2:u8
        let s_7_0: u8 = fn_state.opc2;
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 128;
        // D s_10_1: write-var ga#250220 <= s_10_0
        fn_state.ga_250220 = s_10_0;
        // N s_10_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
