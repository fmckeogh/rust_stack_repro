...
use common::*;
pub fn decode_aarch32_instrs_SUB_i_T4enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i: bool,
    Rn: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call execute_aarch32_instrs_SUB_i_Op_A_txt(s_5_0, s_5_1, s_5_2, s_5_3)
        let s_5_4: () = execute_aarch32_instrs_SUB_i_Op_A_txt(
            state,
            tracer,
            s_5_0,
            s_5_1,
