...
use common::*;
pub fn HCR_EL2_SysRegWrite_f7613e1ff35a2f03<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_HCR_EL2_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_HCR_EL2_Type(state, tracer, s_5_3);
        // C s_5_5: const #102552u : u32
        let s_5_5: u32 = 102552;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call Mk_HCR_EL2_Type(s_6_3)
        let s_6_4: ProductType5c790c8ef59cc8b2 = Mk_HCR_EL2_Type(state, tracer, s_6_3);
        // C s_6_5: const #102552u : u32
        let s_6_5: u32 = 102552;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#85731 <= s_8_0
        fn_state.gs_85731 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#85731:u8
        let s_9_0: bool = fn_state.gs_85731;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#85732 <= s_11_0
        fn_state.gs_85732 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#85732:u8
        let s_12_0: bool = fn_state.gs_85732;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_5: write-var gs#85732 <= s_15_4
        fn_state.gs_85732 = s_15_4;
        // N s_15_6: jump b12
        return block_12(state, tracer, fn_state);
    }
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_21: write-var gs#85731 <= s_17_20
        fn_state.gs_85731 = s_17_20;
        // N s_17_22: jump b9
        return block_9(state, tracer, fn_state);
    }
