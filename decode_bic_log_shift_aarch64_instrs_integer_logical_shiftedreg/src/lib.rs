...
use common::*;
pub fn decode_bic_log_shift_aarch64_instrs_integer_logical_shiftedreg<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 32;
        // D s_1_1: write-var ga#249514 <= s_1_0
        fn_state.ga_249514 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#249514:i64
        let s_2_0: i64 = fn_state.ga_249514;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var opshadow#1055 <= s_4_0
        fn_state.opshadow_1055 = s_4_0;
        // D s_4_2: read-var setflags:u8
        let s_4_2: bool = fn_state.setflags;
        // D s_4_3: write-var setflagsshadow#1056 <= s_4_2
        fn_state.setflagsshadow_1056 = s_4_2;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#143609 <= s_5_0
        fn_state.gs_143609 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#143609:u8
        let s_6_0: bool = fn_state.gs_143609;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_17: read-var opshadow#1055:u32
        let s_7_17: u32 = fn_state.opshadow_1055;
        // D s_7_18: read-var setflagsshadow#1056:u8
        let s_7_18: bool = fn_state.setflagsshadow_1056;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_22: write-var gs#143609 <= s_9_21
        fn_state.gs_143609 = s_9_21;
        // N s_9_23: jump b6
        return block_6(state, tracer, fn_state);
    }
    ...
    fn block_15<T: Tracer>(
        ...
        let s_15_0: i64 = 64;
        // D s_15_1: write-var ga#249514 <= s_15_0
        fn_state.ga_249514 = s_15_0;
        // N s_15_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
