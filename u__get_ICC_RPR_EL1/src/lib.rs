...
extern crate alloc;
use Mk_ICC_RPR_EL1_Type::*;
use common::*;
pub fn u__get_ICC_RPR_EL1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4611686018427387648u : u64
        let s_0_3: u64 = 4611686018427387648;
        ...
        // D s_0_11: tail-call Mk_ICC_RPR_EL1_Type(s_0_10)
        return Mk_ICC_RPR_EL1_Type(state, tracer, s_0_10);
    }
}
