...
use common::*;
pub fn decode_aarch32_instrs_REVSH_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rm: u8,
    Rd: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_8: call execute_aarch32_instrs_REVSH_Op_A_txt(s_2_3, s_2_7)
        let s_2_8: () = execute_aarch32_instrs_REVSH_Op_A_txt(
            state,
            tracer,
            s_2_3,
            s_2_7,
