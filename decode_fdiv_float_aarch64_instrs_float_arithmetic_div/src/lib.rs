...
extern crate alloc;
use execute_aarch64_instrs_float_arithmetic_div::*;
use common::*;
pub fn decode_fdiv_float_aarch64_instrs_float_arithmetic_div<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_6: call execute_aarch64_instrs_float_arithmetic_div(s_2_3, s_2_2, s_2_4, s_2_5)
        let s_2_6: () = execute_aarch64_instrs_float_arithmetic_div(
            state,
            tracer,
            s_2_3,
            s_2_2,
