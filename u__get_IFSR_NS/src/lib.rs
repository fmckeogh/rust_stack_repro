...
use Mk_IFSR_Type::*;
use common::*;
pub fn u__get_IFSR_NS<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4294896064u : u32
        let s_0_3: u32 = 4294896064;
        ...
        // D s_0_11: tail-call Mk_IFSR_Type(s_0_10)
        return Mk_IFSR_Type(state, tracer, s_0_10);
    }
}
