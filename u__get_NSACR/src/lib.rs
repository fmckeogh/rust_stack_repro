...
pub fn u__get_NSACR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4293424127u : u32
        let s_0_3: u32 = 4293424127;
        ...
        // D s_0_11: tail-call Mk_NSACR_Type(s_0_10)
        return Mk_NSACR_Type(state, tracer, s_0_10);
    }
}
