...
extern crate alloc;
use execute_HISTSEG_Z_ZZ__::*;
use CurrentVL_read::*;
use HaveSVE2::*;
use common::*;
pub fn decode_HISTSEG_Z_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Zm: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var Zd:u8
        let s_2_0: u8 = fn_state.Zd;
        ...
        fn_state.d = s_2_3;
        // D s_2_5: read-var Zn:u8
        let s_2_5: u8 = fn_state.Zn;
        ...
        fn_state.n = s_2_8;
        // D s_2_10: read-var Zm:u8
        let s_2_10: u8 = fn_state.Zm;
        ...
        fn_state.m = s_2_13;
        // D s_2_15: read-var VL:i64
        let s_2_15: i64 = fn_state.VL;
        // C s_2_16: const #128s : i
        let s_2_16: i128 = 128;
        // D s_2_17: cast zx s_2_15 -> i
        let s_2_17: i128 = (i128::try_from(s_2_15).unwrap());
        // D s_2_18: cmp-eq s_2_17 s_2_16
        let s_2_18: bool = ((s_2_17) == (s_2_16));
        // D s_2_19: not s_2_18
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_5: call execute_HISTSEG_Z_ZZ__(s_3_0, s_3_1, s_3_2, s_3_3, s_3_4)
        let s_3_5: () = execute_HISTSEG_Z_ZZ__(
            state,
            tracer,
            s_3_0,
            s_3_1,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_5: call execute_HISTSEG_Z_ZZ__(s_5_0, s_5_1, s_5_2, s_5_3, s_5_4)
        let s_5_5: () = execute_HISTSEG_Z_ZZ__(
            state,
            tracer,
            s_5_0,
            s_5_1,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_5: call execute_HISTSEG_Z_ZZ__(s_7_0, s_7_1, s_7_2, s_7_3, s_7_4)
        let s_7_5: () = execute_HISTSEG_Z_ZZ__(
            state,
            tracer,
            s_7_0,
            s_7_1,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_5: call execute_HISTSEG_Z_ZZ__(s_9_0, s_9_1, s_9_2, s_9_3, s_9_4)
        let s_9_5: () = execute_HISTSEG_Z_ZZ__(
            state,
            tracer,
            s_9_0,
            s_9_1,
    ...
    fn block_11<T: Tracer>(
        ...
        // C s_11_2: const #8s : i64
        let s_11_2: i64 = 8;
        // D s_11_3: read-var m:i64
        let s_11_3: i64 = fn_state.m;
        // D s_11_4: read-var n:i64
        let s_11_4: i64 = fn_state.n;
        // D s_11_5: call execute_HISTSEG_Z_ZZ__(s_11_0, s_11_1, s_11_2, s_11_3, s_11_4)
        let s_11_5: () = execute_HISTSEG_Z_ZZ__(
            state,
            tracer,
            s_11_0,
            s_11_1,
