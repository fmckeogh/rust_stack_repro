...
use Mk_CNTHCTL_Type::*;
use common::*;
pub fn CNTHCTL_SysRegWrite32_7d97fc0c6abe59e3<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call Mk_CNTHCTL_Type(s_6_1)
        let s_6_2: ProductType700c18a878c5601b = Mk_CNTHCTL_Type(state, tracer, s_6_1);
        // D s_6_3: call CNTHCTL_write(s_6_2)
        let s_6_3: () = CNTHCTL_write(state, tracer, s_6_2);
        // N s_6_4: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_2: call Mk_CNTHCTL_Type(s_8_1)
        let s_8_2: ProductType700c18a878c5601b = Mk_CNTHCTL_Type(state, tracer, s_8_1);
        // D s_8_3: call CNTHCTL_write(s_8_2)
        let s_8_3: () = CNTHCTL_write(state, tracer, s_8_2);
        // N s_8_4: return
        return;
    }
    fn block_9<T: Tracer>(
