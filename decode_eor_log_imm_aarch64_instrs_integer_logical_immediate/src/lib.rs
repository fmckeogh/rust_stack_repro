...
use common::*;
pub fn decode_eor_log_imm_aarch64_instrs_integer_logical_immediate<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    struct FunctionState {
        ...
        ga_249410: i64,
        d: i64,
        setflagsshadow_1045: bool,
        datasize: i64,
        ga_249415: ProductTypebc91b195b0b2a883,
        opshadow_1044: u32,
        Rd: u8,
        Rn: u8,
        imms: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 32;
        // D s_1_1: write-var ga#249410 <= s_1_0
        fn_state.ga_249410 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#249410:i64
        let s_2_0: i64 = fn_state.ga_249410;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var opshadow#1044 <= s_4_0
        fn_state.opshadow_1044 = s_4_0;
        // D s_4_2: read-var setflags:u8
        let s_4_2: bool = fn_state.setflags;
        // D s_4_3: write-var setflagsshadow#1045 <= s_4_2
        fn_state.setflagsshadow_1045 = s_4_2;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#143413 <= s_5_0
        fn_state.gs_143413 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#143413:u8
        let s_6_0: bool = fn_state.gs_143413;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_9: write-var ga#249415 <= s_7_8
        fn_state.ga_249415 = s_7_8;
        // N s_7_10: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var ga#249415.0:struct
        let s_8_0: Bits = fn_state.ga_249415._0;
        ...
        // D s_8_6: read-var opshadow#1044:u32
        let s_8_6: u32 = fn_state.opshadow_1044;
        // D s_8_7: read-var setflagsshadow#1045:u8
        let s_8_7: bool = fn_state.setflagsshadow_1045;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: write-var gs#143413 <= s_10_4
        fn_state.gs_143413 = s_10_4;
        // N s_10_6: jump b6
        return block_6(state, tracer, fn_state);
    }
    ...
    fn block_16<T: Tracer>(
        ...
        let s_16_0: i64 = 64;
        // D s_16_1: write-var ga#249410 <= s_16_0
        fn_state.ga_249410 = s_16_0;
        // N s_16_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
