...
use common::*;
pub fn decode_aarch32_instrs_B_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    imm24: u32,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_23: call execute_aarch32_instrs_B_Op_A_txt(s_2_22)
        let s_2_23: () = execute_aarch32_instrs_B_Op_A_txt(state, tracer, s_2_22);
        // N s_2_24: return
        return;
    }
}
