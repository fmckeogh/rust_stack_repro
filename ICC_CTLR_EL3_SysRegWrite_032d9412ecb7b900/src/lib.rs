...
use Mk_ICC_CTLR_EL3_Type::*;
use common::*;
pub fn ICC_CTLR_EL3_SysRegWrite_032d9412ecb7b900<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call Mk_ICC_CTLR_EL3_Type(s_6_3)
        let s_6_4: ProductType5c790c8ef59cc8b2 = Mk_ICC_CTLR_EL3_Type(
            state,
            tracer,
            s_6_3,
        );
        // C s_6_5: const #11632u : u32
        let s_6_5: u32 = 11632;
