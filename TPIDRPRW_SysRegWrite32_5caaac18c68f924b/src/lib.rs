...
use ELUsingAArch32::*;
use TPIDRPRW_write::*;
use TPIDRPRW_NS_write::*;
use u_get_SCR_Type_NS::*;
use HSTR_read::*;
use u_get_HSTR_Type_T13::*;
use EL2Enabled::*;
use common::*;
pub fn TPIDRPRW_SysRegWrite32_5caaac18c68f924b<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call TPIDRPRW_NS_write(s_6_1)
        let s_6_2: () = TPIDRPRW_NS_write(state, tracer, s_6_1);
        // N s_6_3: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#134302 <= s_9_0
        fn_state.gs_134302 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#134302:u8
        let s_10_0: bool = fn_state.gs_134302;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_2: call TPIDRPRW_write(s_11_1)
        let s_11_2: () = TPIDRPRW_write(state, tracer, s_11_1);
        // N s_11_3: return
        return;
    }
    fn block_12<T: Tracer>(
        ...
        // D s_12_2: call TPIDRPRW_NS_write(s_12_1)
        let s_12_2: () = TPIDRPRW_NS_write(state, tracer, s_12_1);
        // N s_12_3: return
        return;
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_3: write-var gs#134302 <= s_13_2
        fn_state.gs_134302 = s_13_2;
        // N s_13_4: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#134303 <= s_15_0
        fn_state.gs_134303 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#134303:u8
        let s_16_0: bool = fn_state.gs_134303;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#134304 <= s_17_0
        fn_state.gs_134304 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#134304:u8
        let s_18_0: bool = fn_state.gs_134304;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#134305 <= s_20_0
        fn_state.gs_134305 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#134305:u8
        let s_21_0: bool = fn_state.gs_134305;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#134306 <= s_22_0
        fn_state.gs_134306 = s_22_0;
        // N s_22_2: jump b23
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_0: read-var gs#134306:u8
        let s_23_0: bool = fn_state.gs_134306;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#134307 <= s_25_0
        fn_state.gs_134307 = s_25_0;
        // N s_25_2: jump b26
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var gs#134307:u8
        let s_26_0: bool = fn_state.gs_134307;
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_2: call TPIDRPRW_write(s_27_1)
        let s_27_2: () = TPIDRPRW_write(state, tracer, s_27_1);
        // N s_27_3: return
        return;
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_2: call TPIDRPRW_NS_write(s_28_1)
        let s_28_2: () = TPIDRPRW_NS_write(state, tracer, s_28_1);
        // N s_28_3: return
        return;
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_3: write-var gs#134307 <= s_29_2
        fn_state.gs_134307 = s_29_2;
        // N s_29_4: jump b26
        return block_26(state, tracer, fn_state);
    }
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_5: write-var gs#134306 <= s_31_4
        fn_state.gs_134306 = s_31_4;
        // N s_31_6: jump b23
        return block_23(state, tracer, fn_state);
    }
    fn block_32<T: Tracer>(
        ...
        // D s_32_3: write-var gs#134305 <= s_32_2
        fn_state.gs_134305 = s_32_2;
        // N s_32_4: jump b21
        return block_21(state, tracer, fn_state);
    }
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_5: write-var gs#134304 <= s_34_4
        fn_state.gs_134304 = s_34_4;
        // N s_34_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    fn block_35<T: Tracer>(
        ...
        // D s_35_4: write-var gs#134303 <= s_35_3
        fn_state.gs_134303 = s_35_3;
        // N s_35_5: jump b16
        return block_16(state, tracer, fn_state);
    }
