...
use TLBI::*;
use common::*;
pub fn AArch32_TLBI_VMALL<T: Tracer>(
    state: &mut State,
    tracer: &T,
    security: u32,
    regime: u32,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_7: write-var gs#32406 <= s_2_6
        fn_state.gs_32406 = s_2_6;
        // N s_2_8: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#32406:u8
        let s_3_0: bool = fn_state.gs_32406;
        // D s_3_1: write-var gs#32407 <= s_3_0
        fn_state.gs_32407 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#32407:u8
        let s_4_0: bool = fn_state.gs_32407;
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #1u : u8
        let s_7_0: bool = true;
        // D s_7_1: write-var gs#32406 <= s_7_0
        fn_state.gs_32406 = s_7_0;
        // N s_7_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #1u : u8
        let s_8_0: bool = true;
        // D s_8_1: write-var gs#32407 <= s_8_0
        fn_state.gs_32407 = s_8_0;
        // N s_8_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
