...
use V_read::*;
use common::*;
pub fn D_set<T: Tracer>(state: &mut State, tracer: &T, n: i128, value_name: u64) -> () {
    #[derive(Default)]
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#31251 <= s_1_0
        fn_state.gs_31251 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#31251:u8
        let s_2_0: bool = fn_state.gs_31251;
        ...
        // D s_2_25: read-var value_name:u64
        let s_2_25: u64 = fn_state.value_name;
        // D s_2_26: cast zx s_2_25 -> bv
        let s_2_26: Bits = Bits::new(s_2_25 as u128, 64u16);
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_3: write-var gs#31251 <= s_3_2
        fn_state.gs_31251 = s_3_2;
        // N s_3_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
