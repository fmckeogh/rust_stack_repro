...
pub fn TTBR0_write<T: Tracer>(
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#33720 <= s_1_0
        fn_state.gs_33720 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#33720:u8
        let s_2_0: bool = fn_state.gs_33720;
    ...
    fn block_4<T: Tracer>(
        ...
        // C s_4_1: const #101800u : u32
        let s_4_1: u32 = 101800;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#33720 <= s_5_3
        fn_state.gs_33720 = s_5_3;
        // N s_5_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
