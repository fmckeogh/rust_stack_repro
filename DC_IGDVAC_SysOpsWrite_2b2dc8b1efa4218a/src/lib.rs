...
use u_get_HFGITR_EL2_Type_DCIVAC::*;
use IsFeatureImplemented::*;
use X_read::*;
use AArch64_SystemAccessTrap::*;
use EL2Enabled::*;
use common::*;
pub fn DC_IGDVAC_SysOpsWrite_2b2dc8b1efa4218a<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_5: call _get_HCR_EL2_Type_TPCP(s_0_4)
        let s_0_5: bool = u_get_HCR_EL2_Type_TPCP(state, tracer, s_0_4);
        // D s_0_6: write-var __HCR_EL2_TPCP <= s_0_5
        fn_state.u__HCR_EL2_TPCP = s_0_5;
        ...
        // D s_0_13: call _get_HFGITR_EL2_Type_DCIVAC(s_0_12)
        let s_0_13: bool = u_get_HFGITR_EL2_Type_DCIVAC(state, tracer, s_0_12);
        // D s_0_14: write-var __HFGITR_EL2_DCIVAC <= s_0_13
        fn_state.u__HFGITR_EL2_DCIVAC = s_0_13;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#101812 <= s_8_0
        fn_state.gs_101812 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#101812:u8
        let s_9_0: bool = fn_state.gs_101812;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#101813 <= s_11_0
        fn_state.gs_101813 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#101813:u8
        let s_12_0: bool = fn_state.gs_101813;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#101815 <= s_13_0
        fn_state.gs_101815 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#101815:u8
        let s_14_0: bool = fn_state.gs_101815;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#101816 <= s_15_0
        fn_state.gs_101816 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#101816:u8
        let s_16_0: bool = fn_state.gs_101816;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var __HFGITR_EL2_DCIVAC:u8
        let s_19_0: bool = fn_state.u__HFGITR_EL2_DCIVAC;
        ...
        // D s_19_5: write-var gs#101816 <= s_19_4
        fn_state.gs_101816 = s_19_4;
        // N s_19_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_5: write-var gs#101814 <= s_21_4
        fn_state.gs_101814 = s_21_4;
        // N s_21_6: jump b22
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_0: read-var gs#101814:u8
        let s_22_0: bool = fn_state.gs_101814;
        // D s_22_1: write-var gs#101815 <= s_22_0
        fn_state.gs_101815 = s_22_0;
        // N s_22_2: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_23<T: Tracer>(
        ...
        // D s_23_1: write-var gs#101814 <= s_23_0
        fn_state.gs_101814 = s_23_0;
        // N s_23_2: jump b22
        return block_22(state, tracer, fn_state);
    }
    fn block_24<T: Tracer>(
        ...
        // D s_24_2: write-var gs#101813 <= s_24_1
        fn_state.gs_101813 = s_24_1;
        // N s_24_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_5: write-var gs#101812 <= s_26_4
        fn_state.gs_101812 = s_26_4;
        // N s_26_6: jump b9
        return block_9(state, tracer, fn_state);
    }
