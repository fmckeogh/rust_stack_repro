...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_binary_element_mul_double_sisd::*;
use common::*;
pub fn decode_sqdmull_advsimd_elt_aarch64_instrs_vector_arithmetic_binary_element_mul_double_simd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#267615 <= s_1_0
        fn_state.ga_267615 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#267615:i64
        let s_2_0: i64 = fn_state.ga_267615;
    ...
    fn block_4<T: Tracer>(
        ...
        // C s_4_39: const #64s : i64
        let s_4_39: i64 = 64;
        // D s_4_40: cast zx s_4_30 -> i
        let s_4_40: i128 = (i128::try_from(s_4_30).unwrap());
        // D s_4_41: cast reint s_4_40 -> i64
        let s_4_41: i64 = (s_4_40 as i64);
        // D s_4_42: read-var idxdsize:i64
        let s_4_42: i64 = fn_state.idxdsize;
        ...
        // D s_4_45: cast zx s_4_38 -> i
        let s_4_45: i128 = (i128::try_from(s_4_38).unwrap());
        // D s_4_46: call execute_aarch64_instrs_vector_arithmetic_binary_element_mul_double_sisd(s_4_5, s_4_39, s_4_45, s_4_41, s_4_44, s_4_1, s_4_24, s_4_9, s_4_34)
        let s_4_46: () = execute_aarch64_instrs_vector_arithmetic_binary_element_mul_double_sisd(
            state,
            tracer,
            s_4_5,
            s_4_39,
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 128;
        // D s_8_1: write-var ga#267615 <= s_8_0
        fn_state.ga_267615 = s_8_0;
        // N s_8_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
