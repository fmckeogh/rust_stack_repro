...
use common::*;
pub fn CNTHP_CTL_EL2_SysRegRead_fc0ab47b2d1292cd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_55669: ProductType5c790c8ef59cc8b2,
        u__PSTATE_EL: u8,
        ga_55673: ProductType5c790c8ef59cc8b2,
        u__HCR_EL2_NV: bool,
        gs_57795: bool,
        el: u8,
        op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // C s_5_1: const #100912u : u32
        let s_5_1: u32 = 100912;
        ...
        // D s_5_3: call __get_CNTHP_CTL_EL2(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_CNTHP_CTL_EL2(
            state,
            tracer,
            s_5_2,
        );
        // D s_5_4: write-var ga#55673 <= s_5_3
        fn_state.ga_55673 = s_5_3;
        // D s_5_5: read-var ga#55673.0:struct
        let s_5_5: u64 = fn_state.ga_55673._0;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 64;
        // C s_6_1: const #100912u : u32
        let s_6_1: u32 = 100912;
        ...
        // D s_6_3: call __get_CNTHP_CTL_EL2(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_CNTHP_CTL_EL2(
            state,
            tracer,
            s_6_2,
        );
        // D s_6_4: write-var ga#55669 <= s_6_3
        fn_state.ga_55669 = s_6_3;
        // D s_6_5: read-var ga#55669.0:struct
        let s_6_5: u64 = fn_state.ga_55669._0;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#57795 <= s_8_0
        fn_state.gs_57795 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#57795:u8
        let s_9_0: bool = fn_state.gs_57795;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#57795 <= s_12_4
        fn_state.gs_57795 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
