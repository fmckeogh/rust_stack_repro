...
use R_set::*;
use common::*;
pub fn execute_aarch32_instrs_LDRH_i_OpT_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    add: bool,
    imm32: u32,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#297495 <= s_5_0
        fn_state.gs_297495 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#297495:u8
        let s_6_0: bool = fn_state.gs_297495;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_3: write-var gs#880064 <= s_8_2
        fn_state.gs_880064 = s_8_2;
        // N s_8_4: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#880064:bv
        let s_9_0: Bits = fn_state.gs_880064;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_4: write-var gs#297495 <= s_14_3
        fn_state.gs_297495 = s_14_3;
        // N s_14_5: jump b6
        return block_6(state, tracer, fn_state);
    }
