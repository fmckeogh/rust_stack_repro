...
use HaveSVE::*;
use CurrentVL_read::*;
use execute_TRN1_Z_ZZ__::*;
use HaveSME::*;
use common::*;
pub fn decode_TRN1_Z_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Zm: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#195253 <= s_1_0
        fn_state.gs_195253 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#195253:u8
        let s_2_0: bool = fn_state.gs_195253;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_8: call execute_TRN1_Z_ZZ__(s_4_0, s_4_5, s_4_3, s_4_6, s_4_7, s_4_4)
        let s_4_8: () = execute_TRN1_Z_ZZ__(
            state,
            tracer,
            s_4_0,
            s_4_5,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_8: call execute_TRN1_Z_ZZ__(s_6_0, s_6_5, s_6_3, s_6_6, s_6_7, s_6_4)
        let s_6_8: () = execute_TRN1_Z_ZZ__(
            state,
            tracer,
            s_6_0,
            s_6_5,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_8: call execute_TRN1_Z_ZZ__(s_8_0, s_8_5, s_8_3, s_8_6, s_8_7, s_8_4)
        let s_8_8: () = execute_TRN1_Z_ZZ__(
            state,
            tracer,
            s_8_0,
            s_8_5,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_8: call execute_TRN1_Z_ZZ__(s_10_0, s_10_5, s_10_3, s_10_6, s_10_7, s_10_4)
        let s_10_8: () = execute_TRN1_Z_ZZ__(
            state,
            tracer,
            s_10_0,
            s_10_5,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_8: call execute_TRN1_Z_ZZ__(s_12_0, s_12_5, s_12_3, s_12_6, s_12_7, s_12_4)
        let s_12_8: () = execute_TRN1_Z_ZZ__(
            state,
            tracer,
            s_12_0,
            s_12_5,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#195253 <= s_15_2
        fn_state.gs_195253 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
