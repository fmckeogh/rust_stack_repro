...
extern crate alloc;
use neq_int::*;
use execute_aarch64_instrs_memory_single_general_immediate_signed_offset_normal::*;
use common::*;
pub fn decode_stur_gen_aarch64_instrs_memory_single_general_immediate_signed_offset_normal<
    T: Tracer,
>(state: &mut State, tracer: &T, Rt: u8, Rn: u8, imm9: u16, opc: u8, size: u8) -> () {
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#164890 <= s_3_0
        fn_state.gs_164890 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#164890:u8
        let s_4_0: bool = fn_state.gs_164890;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var regsizeshadow#1746 <= s_8_0
        fn_state.regsizeshadow_1746 = s_8_0;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#164913 <= s_9_0
        fn_state.gs_164913 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#164913:u8
        let s_10_0: bool = fn_state.gs_164913;
        ...
        // D s_10_4: read-var regsizeshadow#1746:i64
        let s_10_4: i64 = fn_state.regsizeshadow_1746;
        ...
        // D s_10_17: call execute_aarch64_instrs_memory_single_general_immediate_signed_offset_normal(s_10_3, s_10_7, s_10_8, s_10_9, s_10_10, s_10_11, s_10_6, s_10_12, s_10_13, s_10_14, s_10_0, s_10_15, s_10_16)
        let s_10_17: () = execute_aarch64_instrs_memory_single_general_immediate_signed_offset_normal(
            state,
            tracer,
            s_10_3,
            s_10_7,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_4: write-var gs#164913 <= s_11_3
        fn_state.gs_164913 = s_11_3;
        // N s_11_5: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_22: write-var gs#164890 <= s_14_21
        fn_state.gs_164890 = s_14_21;
        // N s_14_23: jump b4
        return block_4(state, tracer, fn_state);
    }
