...
use AddWithCarry::*;
use common::*;
pub fn execute_aarch32_instrs_RSB_i_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    imm32: u32,
    ...
    struct FunctionState {
        gs_882918: ProductTyped54bc449dd09e5bd,
        result: u32,
        nzcv: u8,
        d: i64,
        imm32: u32,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_7: read-var imm32:u32
        let s_0_7: u32 = fn_state.imm32;
        // D s_0_8: cast zx s_0_7 -> bv
        let s_0_8: Bits = Bits::new(s_0_7 as u128, 32u16);
        // C s_0_9: const #1u : u8
        let s_0_9: bool = true;
        // D s_0_10: call AddWithCarry(s_0_6, s_0_8, s_0_9)
        ...
        // D s_0_11: write-var gs#882918 <= s_0_10
        fn_state.gs_882918 = s_0_10;
        // D s_0_12: read-var gs#882918.0:struct
        let s_0_12: Bits = fn_state.gs_882918._0;
        // D s_0_13: cast reint s_0_12 -> u32
        let s_0_13: u32 = (s_0_12.value() as u32);
        // D s_0_14: read-var gs#882918.1:struct
        let s_0_14: u8 = fn_state.gs_882918._1;
        // D s_0_15: write-var result <= s_0_13
        fn_state.result = s_0_13;
        // D s_0_16: write-var nzcv <= s_0_14
        fn_state.nzcv = s_0_14;
