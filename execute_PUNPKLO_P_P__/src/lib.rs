...
use common::*;
pub fn execute_PUNPKLO_P_P__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_32: write-var gs#196980 <= s_1_31
        fn_state.gs_196980 = s_1_31;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#196980:i64
        let s_2_1: i64 = fn_state.gs_196980;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var ga#284796 <= s_4_0
        fn_state.ga_284796 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_5: read-var ga#284796:i64
        let s_5_5: i64 = fn_state.ga_284796;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_6: write-var ga#284796 <= s_6_5
        fn_state.ga_284796 = s_6_5;
        // N s_6_7: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_7<T: Tracer>(
