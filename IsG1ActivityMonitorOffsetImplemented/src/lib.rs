...
extern crate alloc;
use common::*;
pub fn IsG1ActivityMonitorOffsetImplemented<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i: i128,
) -> bool {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#331527 <= s_1_0
        fn_state.gs_331527 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#331527:u8
        let s_2_0: bool = fn_state.gs_331527;
        // N s_2_1: assert s_2_0
        let s_2_1: () = assert!(s_2_0);
        // C s_2_2: const #104672u : u32
        let s_2_2: u32 = 104672;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_3: write-var gs#331527 <= s_3_2
        fn_state.gs_331527 = s_3_2;
        // N s_3_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
