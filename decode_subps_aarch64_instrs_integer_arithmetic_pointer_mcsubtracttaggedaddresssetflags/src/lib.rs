...
extern crate alloc;
use execute_aarch64_instrs_integer_arithmetic_pointer_mcsubtracttaggedaddresssetflags::*;
use HaveMTEExt::*;
use common::*;
pub fn decode_subps_aarch64_instrs_integer_arithmetic_pointer_mcsubtracttaggedaddresssetflags<
    T: Tracer,
>(state: &mut State, tracer: &T, Xd: u8, Xn: u8, Xm: u8) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_13: call execute_aarch64_instrs_integer_arithmetic_pointer_mcsubtracttaggedaddresssetflags(s_1_3, s_1_11, s_1_7, s_1_12)
        let s_1_13: () = execute_aarch64_instrs_integer_arithmetic_pointer_mcsubtracttaggedaddresssetflags(
            state,
            tracer,
            s_1_3,
            s_1_11,
