...
use common::*;
pub fn decode_aarch32_instrs_VRINTZ_vfp_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    D: bool,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#325817 <= s_4_0
        fn_state.gs_325817 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#325817:u8
        let s_5_0: bool = fn_state.gs_325817;
        // D s_5_1: write-var gs#325818 <= s_5_0
        fn_state.gs_325818 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#325818:u8
        let s_6_0: bool = fn_state.gs_325818;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#325819 <= s_8_0
        fn_state.gs_325819 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#325819:u8
        let s_9_0: bool = fn_state.gs_325819;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_5: write-var gs#325819 <= s_22_4
        fn_state.gs_325819 = s_22_4;
        // N s_22_6: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_3: write-var gs#325817 <= s_24_2
        fn_state.gs_325817 = s_24_2;
        // N s_24_4: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#325818 <= s_25_0
        fn_state.gs_325818 = s_25_0;
        // N s_25_2: jump b6
        return block_6(state, tracer, fn_state);
    }
}
