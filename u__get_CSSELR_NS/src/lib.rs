...
use Mk_CSSELR_Type::*;
use common::*;
pub fn u__get_CSSELR_NS<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4294967264u : u32
        let s_0_3: u32 = 4294967264;
        ...
        // D s_0_11: tail-call Mk_CSSELR_Type(s_0_10)
        return Mk_CSSELR_Type(state, tracer, s_0_10);
    }
}
