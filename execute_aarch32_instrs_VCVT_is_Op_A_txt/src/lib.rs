...
use FixedToFP::*;
use common::*;
pub fn execute_aarch32_instrs_VCVT_is_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d__arg: i64,
    elements: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#7407 <= s_0_2
        fn_state.esizeshadow_7407 = s_0_2;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_6: write-var gs#307997 <= s_1_5
        fn_state.gs_307997 = s_1_5;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#307997:i64
        let s_2_1: i64 = fn_state.gs_307997;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_6: write-var gs#308003 <= s_3_5
        fn_state.gs_308003 = s_3_5;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#308003:i64
        let s_4_1: i64 = fn_state.gs_308003;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_8: read-var esizeshadow#7407:i64
        let s_5_8: i64 = fn_state.esizeshadow_7407;
        ...
        fn_state.op1 = s_5_15;
        // D s_5_17: read-var to_integer:u8
        let s_5_17: bool = fn_state.to_integer;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: read-var esizeshadow#7407:i64
        let s_6_2: i64 = fn_state.esizeshadow_7407;
        ...
        // C s_6_5: const #0s : i
        let s_6_5: i128 = 0;
        // D s_6_6: read-var op1:bv
        let s_6_6: Bits = fn_state.op1;
        // D s_6_7: read-var is_unsigned:u8
        let s_6_7: bool = fn_state.is_unsigned;
        // C s_6_8: const #0u : u32
        let s_6_8: u32 = 0;
        // D s_6_9: call FixedToFP(s_6_6, s_6_5, s_6_7, s_6_1, s_6_8, s_6_4)
        let s_6_9: Bits = FixedToFP(
            state,
            tracer,
            s_6_6,
            s_6_5,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_9: read-var esizeshadow#7407:i64
        let s_8_9: i64 = fn_state.esizeshadow_7407;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_2: read-var esizeshadow#7407:i64
        let s_9_2: i64 = fn_state.esizeshadow_7407;
        ...
        // C s_9_5: const #0s : i
        let s_9_5: i128 = 0;
        // D s_9_6: read-var op1:bv
        let s_9_6: Bits = fn_state.op1;
        // D s_9_7: read-var is_unsigned:u8
        let s_9_7: bool = fn_state.is_unsigned;
        // C s_9_8: const #3u : u32
        let s_9_8: u32 = 3;
        // D s_9_9: call FPToFixed(s_9_6, s_9_5, s_9_7, s_9_1, s_9_8, s_9_4)
        let s_9_9: Bits = FPToFixed(
            state,
            tracer,
            s_9_6,
            s_9_5,
        ...
        // D s_9_10: write-var result <= s_9_9
        fn_state.result = s_9_9;
        // N s_9_11: jump b10
