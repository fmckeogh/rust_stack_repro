...
use D_read::*;
use common::*;
pub fn execute_aarch32_instrs_VORN_r_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_6: write-var gs#314645 <= s_1_5
        fn_state.gs_314645 = s_1_5;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#314645:i64
        let s_2_1: i64 = fn_state.gs_314645;
