...
use common::*;
pub fn decode_aarch32_instrs_VQDMLAL_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    size: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_22: write-var gs#315392 <= s_4_21
        fn_state.gs_315392 = s_4_21;
        // N s_4_23: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#315392:u8
        let s_5_0: bool = fn_state.gs_315392;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_66: read-var ga#358254:i
        let s_6_66: i128 = fn_state.ga_358254;
        // C s_6_67: const #0u : u8
        let s_6_67: bool = false;
        // D s_6_68: call execute_aarch32_instrs_VQDMLAL_Op_A_txt(s_6_4, s_6_20, s_6_65, s_6_64, s_6_66, s_6_52, s_6_36, s_6_67)
        let s_6_68: () = execute_aarch32_instrs_VQDMLAL_Op_A_txt(
            state,
            tracer,
            s_6_4,
            s_6_20,
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #1u : u8
        let s_8_0: bool = true;
        // D s_8_1: write-var gs#315392 <= s_8_0
        fn_state.gs_315392 = s_8_0;
        // N s_8_2: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
