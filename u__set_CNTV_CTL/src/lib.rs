...
use common::*;
pub fn u__set_CNTV_CTL<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    struct FunctionState {
        ...
        ga_28435: ProductType700c18a878c5601b,
        ga_28429: ProductType700c18a878c5601b,
        value_name: ProductType700c18a878c5601b,
    }
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_2: const #() : ()
        let s_0_2: () = ();
        // S s_0_3: call CNTV_CTL_read(s_0_2)
        let s_0_3: ProductType700c18a878c5601b = CNTV_CTL_read(state, tracer, s_0_2);
        // D s_0_4: write-var ga#28429 <= s_0_3
        fn_state.ga_28429 = s_0_3;
        // D s_0_5: read-var ga#28429.0:struct
        let s_0_5: u32 = fn_state.ga_28429._0;
        ...
        // D s_0_27: call Mk_CNTV_CTL_Type(s_0_26)
        let s_0_27: ProductType700c18a878c5601b = Mk_CNTV_CTL_Type(
            state,
            tracer,
            s_0_26,
        );
        // D s_0_28: call CNTV_CTL_write(s_0_27)
        let s_0_28: () = CNTV_CTL_write(state, tracer, s_0_27);
        // C s_0_29: const #() : ()
        let s_0_29: () = ();
        // S s_0_30: call CNTV_CTL_read(s_0_29)
        let s_0_30: ProductType700c18a878c5601b = CNTV_CTL_read(state, tracer, s_0_29);
        // D s_0_31: write-var ga#28435 <= s_0_30
        fn_state.ga_28435 = s_0_30;
        // D s_0_32: read-var ga#28435.0:struct
        let s_0_32: u32 = fn_state.ga_28435._0;
        ...
        // D s_0_54: call Mk_CNTV_CTL_Type(s_0_53)
        let s_0_54: ProductType700c18a878c5601b = Mk_CNTV_CTL_Type(
            state,
            tracer,
            s_0_53,
        );
        // D s_0_55: call CNTV_CTL_write(s_0_54)
        let s_0_55: () = CNTV_CTL_write(state, tracer, s_0_54);
        // N s_0_56: return
        return;
    }
}
