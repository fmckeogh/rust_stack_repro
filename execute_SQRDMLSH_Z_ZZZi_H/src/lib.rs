...
use Z_set::*;
use common::*;
pub fn execute_SQRDMLSH_Z_ZZZi_H<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    da: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#3994 <= s_0_2
        fn_state.VLshadow_3994 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#3994:i64
        let s_1_0: i64 = fn_state.VLshadow_3994;
        // D s_1_1: write-var VLshadow#3995 <= s_1_0
        fn_state.VLshadow_3995 = s_1_0;
        // D s_1_2: read-var VLshadow#3995:i64
        let s_1_2: i64 = fn_state.VLshadow_3995;
        ...
        // D s_1_14: read-var VLshadow#3995:i64
        let s_1_14: i64 = fn_state.VLshadow_3995;
        ...
        // D s_1_22: read-var VLshadow#3995:i64
        let s_1_22: i64 = fn_state.VLshadow_3995;
        ...
        // D s_1_30: read-var VLshadow#3995:i64
        let s_1_30: i64 = fn_state.VLshadow_3995;
        ...
        // D s_1_43: write-var gs#214446 <= s_1_42
        fn_state.gs_214446 = s_1_42;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#214446:i64
        let s_2_1: i64 = fn_state.gs_214446;
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_48: Bits = Bits::new(s_3_47 as u128, 16u16);
        ...
        // D s_3_64: sub s_3_54 s_3_63
        let s_3_64: i128 = ((s_3_54) - (s_3_63));
        ...
        // D s_3_71: sub s_3_70 s_3_68
        let s_3_71: i128 = ((s_3_70) - (s_3_68));
        // D s_3_72: cast reint s_3_71 -> i64
        let s_3_72: i64 = (s_3_71 as i64);
        // C s_3_73: const #1s : i
        let s_3_73: i128 = 1;
        // D s_3_74: cast zx s_3_72 -> i
        let s_3_74: i128 = (i128::try_from(s_3_72).unwrap());
        // D s_3_75: lsl s_3_73 s_3_74
        let s_3_75: i128 = s_3_73 << s_3_74;
        // D s_3_76: add s_3_64 s_3_75
        let s_3_76: i128 = (s_3_64 + s_3_75);
        ...
        // D s_3_79: lsr s_3_76 s_3_78
        let s_3_79: i128 = s_3_76 >> s_3_78;
        // D s_3_80: read-var esize:i64
        let s_3_80: i64 = fn_state.esize;
        ...
        // D s_3_84: call SignedSat(s_3_79, s_3_83)
        let s_3_84: Bits = SignedSat(state, tracer, s_3_79, s_3_83);
        // D s_3_85: cast reint s_3_84 -> u16
        let s_3_85: u16 = (s_3_84.value() as u16);
        // D s_3_86: read-var e:i64
        let s_3_86: i64 = fn_state.e;
        ...
        // D s_3_89: cast zx s_3_85 -> bv
        let s_3_89: Bits = Bits::new(s_3_85 as u128, 16u16);
        // D s_3_90: read-var result:bv
        let s_3_90: Bits = fn_state.result;
        // D s_3_91: call Elem_set(s_3_90, s_3_87, s_3_88, s_3_89)
        let s_3_91: Bits = Elem_set(state, tracer, s_3_90, s_3_87, s_3_88, s_3_89);
        // D s_3_92: write-var result <= s_3_91
        fn_state.result = s_3_91;
        // D s_3_93: read-var e:i64
        let s_3_93: i64 = fn_state.e;
        // C s_3_94: const #1s : i64
        let s_3_94: i64 = 1;
        // D s_3_95: add s_3_93 s_3_94
        let s_3_95: i64 = (s_3_93 + s_3_94);
        // D s_3_96: write-var e <= s_3_95
        fn_state.e = s_3_95;
        // N s_3_97: jump b2
        return block_2(state, tracer, fn_state);
    }
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#3995:i64
        let s_4_0: i64 = fn_state.VLshadow_3995;
