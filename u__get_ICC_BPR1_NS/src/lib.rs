...
use common::*;
pub fn u__get_ICC_BPR1_NS<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4294967288u : u32
        let s_0_3: u32 = 4294967288;
        ...
        // D s_0_11: tail-call Mk_ICC_BPR1_Type(s_0_10)
        return Mk_ICC_BPR1_Type(state, tracer, s_0_10);
    }
}
