...
use Mk_CTR_EL0_Type::*;
use common::*;
pub fn u__get_CTR_EL0<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #18446743799905402864u : u64
        let s_0_3: u64 = 18446743799905402864;
        ...
        // D s_0_20: tail-call Mk_CTR_EL0_Type(s_0_19)
        return Mk_CTR_EL0_Type(state, tracer, s_0_19);
    }
}
