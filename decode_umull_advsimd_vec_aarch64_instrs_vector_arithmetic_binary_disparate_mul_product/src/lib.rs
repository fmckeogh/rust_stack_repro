...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_binary_disparate_mul_product::*;
use common::*;
pub fn decode_umull_advsimd_vec_aarch64_instrs_vector_arithmetic_binary_disparate_mul_product<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_14: read-var U:u8
        let s_1_14: bool = fn_state.U;
        ...
        // D s_1_19: cast zx s_1_5 -> i
        let s_1_19: i128 = (i128::try_from(s_1_5).unwrap());
        // D s_1_20: cast reint s_1_19 -> i64
        let s_1_20: i64 = (s_1_19 as i64);
        // C s_1_21: const #64s : i64
        let s_1_21: i64 = 64;
        // D s_1_22: cast zx s_1_13 -> i
        let s_1_22: i128 = (i128::try_from(s_1_13).unwrap());
        ...
        // D s_1_26: call execute_aarch64_instrs_vector_arithmetic_binary_disparate_mul_product(s_1_23, s_1_21, s_1_22, s_1_20, s_1_24, s_1_25, s_1_9, s_1_18)
        let s_1_26: () = execute_aarch64_instrs_vector_arithmetic_binary_disparate_mul_product(
            state,
            tracer,
            s_1_23,
            s_1_21,
