...
use common::*;
pub fn decode_fmaxnmv_advsimd_aarch64_instrs_vector_reduce_fp_maxnm_simd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 64;
        // D s_2_1: write-var ga#255335 <= s_2_0
        fn_state.ga_255335 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#255335:i64
        let s_3_0: i64 = fn_state.ga_255335;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_9: call execute_aarch64_instrs_vector_reduce_fp16_maxnm_simd(s_5_6, s_5_2, s_5_5, s_5_7, s_5_8)
        let s_5_9: () = execute_aarch64_instrs_vector_reduce_fp16_maxnm_simd(
            state,
            tracer,
            s_5_6,
            s_5_2,
    ...
    fn block_7<T: Tracer>(
        ...
        let s_7_0: i64 = 128;
        // D s_7_1: write-var ga#255335 <= s_7_0
        fn_state.ga_255335 = s_7_0;
        // N s_7_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
