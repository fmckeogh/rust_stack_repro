...
use common::*;
pub fn execute_aarch32_instrs_UADD16_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_95: const #0s : i
        let s_0_95: i128 = 0;
        // D s_0_96: read-var sum2:i64
        let s_0_96: i64 = fn_state.sum2;
        ...
        // C s_0_118: const #65536u : u20
        let s_0_118: u32 = 65536;
        // C s_0_119: cast zx s_0_118 -> bv
        let s_0_119: Bits = Bits::new(s_0_118 as u128, 20u16);
        // C s_0_120: cast zx s_0_119 -> i
        let s_0_120: i128 = (s_0_119.value() as i128);
        // C s_0_121: cast reint s_0_120 -> i64
        let s_0_121: i64 = (s_0_120 as i64);
        // D s_0_122: cast zx s_0_31 -> i
        let s_0_122: i128 = (i128::try_from(s_0_31).unwrap());
        // C s_0_123: cast zx s_0_121 -> i
        let s_0_123: i128 = (i128::try_from(s_0_121).unwrap());
        // D s_0_124: cmp-ge s_0_122 s_0_123
        let s_0_124: bool = ((s_0_122) >= (s_0_123));
        // N s_0_125: branch s_0_124 b6 b1
        if s_0_124 {
