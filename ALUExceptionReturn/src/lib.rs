...
use SPSR_read::*;
use common::*;
pub fn ALUExceptionReturn<T: Tracer>(state: &mut State, tracer: &T, address: u32) -> () {
    #[derive(Default)]
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_7: write-var gs#31384 <= s_2_6
        fn_state.gs_31384 = s_2_6;
        // N s_2_8: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#31384:u8
        let s_3_0: bool = fn_state.gs_31384;
    ...
    fn block_4<T: Tracer>(
        ...
        // C s_4_0: const #32s : i
        let s_4_0: i128 = 32;
        // S s_4_1: call SPSR_read(s_4_0)
        let s_4_1: Bits = SPSR_read(state, tracer, s_4_0);
        // S s_4_2: cast reint s_4_1 -> u32
        let s_4_2: u32 = (s_4_1.value() as u32);
        // D s_4_3: read-var address:u32
        let s_4_3: u32 = fn_state.address;
        // D s_4_4: call AArch32_ExceptionReturn(s_4_3, s_4_2)
        let s_4_4: () = AArch32_ExceptionReturn(state, tracer, s_4_3, s_4_2);
        // N s_4_5: return
        return;
    }
    fn block_5<T: Tracer>(
        ...
        // C s_5_0: const #69u : u32
        let s_5_0: u32 = 69;
        // S s_5_1: call ConstrainUnpredictable(s_5_0)
        let s_5_1: u32 = ConstrainUnpredictable(state, tracer, s_5_0);
        // D s_5_2: write-var c <= s_5_1
        fn_state.c = s_5_1;
        // D s_5_3: read-var c:u32
        let s_5_3: u32 = fn_state.c;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var c:u32
        let s_6_0: u32 = fn_state.c;
        // C s_6_1: const #4u : u32
        let s_6_1: u32 = 4;
        // D s_6_2: cmp-eq s_6_0 s_6_1
        let s_6_2: bool = ((s_6_0) == (s_6_1));
        // D s_6_3: write-var gs#31386 <= s_6_2
        fn_state.gs_31386 = s_6_2;
        // N s_6_4: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#31386:u8
        let s_7_0: bool = fn_state.gs_31386;
        // N s_7_1: assert s_7_0
        let s_7_1: () = assert!(s_7_0);
        // C s_7_2: const #2u : u32
        let s_7_2: u32 = 2;
        // D s_7_3: read-var c:u32
        let s_7_3: u32 = fn_state.c;
        // D s_7_4: cmp-eq s_7_2 s_7_3
    ...
    fn block_9<T: Tracer>(
        ...
        let s_9_0: u32 = 4;
        // D s_9_1: read-var c:u32
        let s_9_1: u32 = fn_state.c;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#31386 <= s_12_0
        fn_state.gs_31386 = s_12_0;
        // N s_12_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#31384 <= s_13_0
        fn_state.gs_31384 = s_13_0;
        // N s_13_2: jump b3
        return block_3(state, tracer, fn_state);
    }
