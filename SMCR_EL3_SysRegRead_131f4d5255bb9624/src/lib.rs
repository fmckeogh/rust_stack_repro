...
use u__get_SMCR_EL3::*;
use common::*;
pub fn SMCR_EL3_SysRegRead_131f4d5255bb9624<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ...
        u__PSTATE_EL: u8,
        ga_85356: ProductType5c790c8ef59cc8b2,
        el: u8,
        op0: u8,
        op1: u8,
        CRn: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_5: call _get_CPTR_EL3_Type_ESM(s_0_4)
        let s_0_5: bool = u_get_CPTR_EL3_Type_ESM(state, tracer, s_0_4);
        // D s_0_6: write-var __CPTR_EL3_ESM <= s_0_5
        fn_state.u__CPTR_EL3_ESM = s_0_5;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_SMCR_EL3(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_SMCR_EL3(state, tracer, s_6_2);
        // D s_6_4: write-var ga#85356 <= s_6_3
        fn_state.ga_85356 = s_6_3;
        // D s_6_5: read-var ga#85356.0:struct
        let s_6_5: u64 = fn_state.ga_85356._0;
