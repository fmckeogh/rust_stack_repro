...
use AddWithCarry::*;
use common::*;
pub fn execute_aarch32_instrs_RSC_i_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    imm32: u32,
    ...
    struct FunctionState {
        result: u32,
        nzcv: u8,
        gs_883044: ProductTyped54bc449dd09e5bd,
        d: i64,
        imm32: u32,
        n: i64,
        setflags: bool,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_9: read-var imm32:u32
        let s_0_9: u32 = fn_state.imm32;
        // D s_0_10: cast zx s_0_9 -> bv
        let s_0_10: Bits = Bits::new(s_0_9 as u128, 32u16);
        // D s_0_11: call AddWithCarry(s_0_8, s_0_10, s_0_7)
        ...
        // D s_0_12: write-var gs#883044 <= s_0_11
        fn_state.gs_883044 = s_0_11;
        // D s_0_13: read-var gs#883044.0:struct
        let s_0_13: Bits = fn_state.gs_883044._0;
        // D s_0_14: cast reint s_0_13 -> u32
        let s_0_14: u32 = (s_0_13.value() as u32);
        // D s_0_15: read-var gs#883044.1:struct
        let s_0_15: u8 = fn_state.gs_883044._1;
