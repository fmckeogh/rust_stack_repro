...
use common::*;
pub fn decode_aarch32_instrs_ADD_r_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    S: bool,
    ...
    struct FunctionState {
        ga_342907: ProductType396b95aa74979079,
        cond: u8,
        S: bool,
        Rn: u8,
        Rd: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_20: write-var ga#342907 <= s_3_19
        fn_state.ga_342907 = s_3_19;
        // D s_3_21: read-var ga#342907.0:struct
        let s_3_21: u32 = fn_state.ga_342907._0;
        // D s_3_22: read-var ga#342907.1:struct
        let s_3_22: i128 = fn_state.ga_342907._1;
        // D s_3_23: call execute_aarch32_instrs_ADD_r_Op_A_txt(s_3_3, s_3_11, s_3_7, s_3_16, s_3_22, s_3_21)
        let s_3_23: () = execute_aarch32_instrs_ADD_r_Op_A_txt(
            state,
            tracer,
            s_3_3,
            s_3_11,
