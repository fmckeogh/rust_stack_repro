...
use X_set::*;
use common::*;
pub fn TFSR_EL3_SysRegRead_8cd0ca2e5d9daf2c<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        u__PSTATE_EL: u8,
        ga_99362: ProductType5c790c8ef59cc8b2,
        el: u8,
        op0: u8,
        op1: u8,
        CRn: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // C s_5_1: const #104768u : u32
        let s_5_1: u32 = 104768;
        ...
        // D s_5_3: call __get_TFSR_EL3(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_TFSR_EL3(state, tracer, s_5_2);
        // D s_5_4: write-var ga#99362 <= s_5_3
        fn_state.ga_99362 = s_5_3;
        // D s_5_5: read-var ga#99362.0:struct
        let s_5_5: u64 = fn_state.ga_99362._0;
