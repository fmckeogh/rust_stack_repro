...
extern crate alloc;
use X_set::*;
use u__get_ICC_CTLR_EL3::*;
use AArch64_SystemAccessTrap::*;
use u_get_ICC_SRE_EL3_Type_SRE::*;
use common::*;
pub fn ICC_CTLR_EL3_SysRegRead_7a137fb26d669941<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ...
        u__PSTATE_EL: u8,
        ga_67419: ProductType5c790c8ef59cc8b2,
        el: u8,
        op0: u8,
        op1: u8,
        CRn: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_ICC_CTLR_EL3(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_ICC_CTLR_EL3(
            state,
            tracer,
            s_6_2,
        );
        // D s_6_4: write-var ga#67419 <= s_6_3
        fn_state.ga_67419 = s_6_3;
        // D s_6_5: read-var ga#67419.0:struct
        let s_6_5: u64 = fn_state.ga_67419._0;
