...
use common::*;
pub fn u__get_MPAM1_EL1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #8052154658761736192u : u64
        let s_0_3: u64 = 8052154658761736192;
        ...
        // D s_0_11: tail-call Mk_MPAM1_EL1_Type(s_0_10)
        return Mk_MPAM1_EL1_Type(state, tracer, s_0_10);
    }
}
