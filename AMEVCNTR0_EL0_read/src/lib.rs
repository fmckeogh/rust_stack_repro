...
extern crate alloc;
use common::*;
pub fn AMEVCNTR0_EL0_read<T: Tracer>(
    state: &mut State,
    tracer: &T,
    n: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_0: const #22024u : u32
        let s_0_0: u32 = 22024;
        // D s_0_1: read-reg s_0_0:[struct; 4]
        let s_0_1: [ProductType5c790c8ef59cc8b2; 4usize] = {
            let value = state
                .read_register::<[ProductType5c790c8ef59cc8b2; 4usize]>(s_0_0 as isize);
