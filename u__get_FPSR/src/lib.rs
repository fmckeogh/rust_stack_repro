...
pub fn u__get_FPSR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #18446744069548801888u : u64
        let s_0_3: u64 = 18446744069548801888;
        ...
        // D s_0_11: tail-call Mk_FPSR_Type(s_0_10)
        return Mk_FPSR_Type(state, tracer, s_0_10);
    }
}
