...
use u__id::*;
use common::*;
pub fn decode_ldr_imm_fpsimd_aarch64_instrs_memory_single_simdfp_immediate_unsigned<
    T: Tracer,
>(state: &mut State, tracer: &T, Rt: u8, Rn: u8, imm12: u16, opc: u8, size: u8) -> () {
    #[derive(Default)]
    ...
    fn block_1<T: Tracer>(
        ...
        // C s_1_0: const #64s : i
        let s_1_0: i128 = 64;
        // D s_1_1: read-var imm12:u12
        let s_1_1: u16 = fn_state.imm12;
        // D s_1_2: cast zx s_1_1 -> bv
        let s_1_2: Bits = Bits::new(s_1_1 as u128, 12u16);
        // D s_1_3: bits-cast zx s_1_2 -> bv length s_1_0
        let s_1_3: Bits = s_1_2.zero_extend(s_1_0);
        // D s_1_4: cast reint s_1_3 -> u64
        let s_1_4: u64 = (s_1_3.value() as u64);
        // D s_1_5: cast zx s_1_4 -> bv
        let s_1_5: Bits = Bits::new(s_1_4 as u128, 64u16);
        // D s_1_6: read-var scale:i64
        let s_1_6: i64 = fn_state.scale;
        // D s_1_7: cast zx s_1_6 -> i
        let s_1_7: i128 = (i128::try_from(s_1_6).unwrap());
        // D s_1_8: lsl s_1_5 s_1_7
        let s_1_8: Bits = s_1_5 << s_1_7;
        // D s_1_9: cast reint s_1_8 -> u64
        let s_1_9: u64 = (s_1_8.value() as u64);
        // D s_1_10: write-var offset <= s_1_9
        fn_state.offset = s_1_9;
        // D s_1_11: read-var Rn:u8
        let s_1_11: u8 = fn_state.Rn;
        ...
        // D s_1_15: write-var n <= s_1_14
        fn_state.n = s_1_14;
        // D s_1_16: read-var Rt:u8
        let s_1_16: u8 = fn_state.Rt;
        ...
        // D s_1_20: write-var t <= s_1_19
        fn_state.t = s_1_19;
        // C s_1_21: const #0s : i
        let s_1_21: i128 = 0;
        // D s_1_22: read-var opc:u8
        let s_1_22: u8 = fn_state.opc;
        // D s_1_23: cast zx s_1_22 -> bv
        let s_1_23: Bits = Bits::new(s_1_22 as u128, 2u16);
        // C s_1_24: const #1u : u64
        let s_1_24: u64 = 1;
        // D s_1_25: bit-extract s_1_23 s_1_21 s_1_24
        ...
        // C s_1_27: const #0s : i
        let s_1_27: i128 = 0;
        // C s_1_28: const #0u : u64
        let s_1_28: u64 = 0;
        // D s_1_29: cast zx s_1_26 -> u64
        let s_1_29: u64 = (s_1_26 as u64);
        // C s_1_30: const #1u : u64
        let s_1_30: u64 = 1;
        // D s_1_31: and s_1_29 s_1_30
        let s_1_31: u64 = ((s_1_29) & (s_1_30));
        // D s_1_32: cmp-eq s_1_31 s_1_30
        let s_1_32: bool = ((s_1_31) == (s_1_30));
        // D s_1_33: lsl s_1_29 s_1_27
        let s_1_33: u64 = s_1_29 << s_1_27;
        // D s_1_34: or s_1_28 s_1_33
        let s_1_34: u64 = ((s_1_28) | (s_1_33));
        // D s_1_35: cmpl s_1_33
        let s_1_35: u64 = !s_1_33;
        // D s_1_36: and s_1_28 s_1_35
        let s_1_36: u64 = ((s_1_28) & (s_1_35));
        // D s_1_37: select s_1_32 s_1_34 s_1_36
        let s_1_37: u64 = if s_1_32 { s_1_34 } else { s_1_36 };
        // D s_1_38: cast trunc s_1_37 -> u8
        let s_1_38: bool = ((s_1_37) != 0);
        // D s_1_39: cast zx s_1_38 -> bv
        let s_1_39: Bits = Bits::new(s_1_38 as u128, 1u16);
        // C s_1_40: const #1u : u8
        let s_1_40: bool = true;
        // C s_1_41: cast zx s_1_40 -> bv
        let s_1_41: Bits = Bits::new(s_1_40 as u128, 1u16);
        // D s_1_42: cmp-eq s_1_39 s_1_41
        let s_1_42: bool = ((s_1_39) == (s_1_41));
        // N s_1_43: branch s_1_42 b28 b2
        if s_1_42 {
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#161675 <= s_4_0
        fn_state.gs_161675 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#161675:u8
        let s_5_0: bool = fn_state.gs_161675;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: write-var gs#161678 <= s_6_3
        fn_state.gs_161678 = s_6_3;
        // N s_6_5: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#161678:u8
        let s_7_0: bool = fn_state.gs_161678;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: write-var gs#161680 <= s_8_3
        fn_state.gs_161680 = s_8_3;
        // N s_8_5: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#161680:u8
        let s_9_0: bool = fn_state.gs_161680;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: write-var gs#161682 <= s_10_3
        fn_state.gs_161682 = s_10_3;
        // N s_10_5: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#161682:u8
        let s_11_0: bool = fn_state.gs_161682;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_4: write-var gs#161684 <= s_12_3
        fn_state.gs_161684 = s_12_3;
        // N s_12_5: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#161684:u8
        let s_13_0: bool = fn_state.gs_161684;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_4: write-var gs#161686 <= s_14_3
        fn_state.gs_161686 = s_14_3;
        // N s_14_5: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#161686:u8
        let s_15_0: bool = fn_state.gs_161686;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_4: write-var gs#161688 <= s_16_3
        fn_state.gs_161688 = s_16_3;
        // N s_16_5: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#161688:u8
        let s_17_0: bool = fn_state.gs_161688;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_4: write-var gs#161690 <= s_18_3
        fn_state.gs_161690 = s_18_3;
        // N s_18_5: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#161690:u8
        let s_19_0: bool = fn_state.gs_161690;
        ...
        // C s_19_11: const #0u : u8
        let s_19_11: bool = false;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#161690 <= s_20_0
        fn_state.gs_161690 = s_20_0;
        // N s_20_2: jump b19
        return block_19(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#161688 <= s_21_0
        fn_state.gs_161688 = s_21_0;
        // N s_21_2: jump b17
        return block_17(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#161686 <= s_22_0
        fn_state.gs_161686 = s_22_0;
        // N s_22_2: jump b15
        return block_15(state, tracer, fn_state);
    }
    fn block_23<T: Tracer>(
        ...
        // D s_23_1: write-var gs#161684 <= s_23_0
        fn_state.gs_161684 = s_23_0;
        // N s_23_2: jump b13
        return block_13(state, tracer, fn_state);
    }
    fn block_24<T: Tracer>(
        ...
        // D s_24_1: write-var gs#161682 <= s_24_0
        fn_state.gs_161682 = s_24_0;
        // N s_24_2: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#161680 <= s_25_0
        fn_state.gs_161680 = s_25_0;
        // N s_25_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_26<T: Tracer>(
        ...
        // D s_26_1: write-var gs#161678 <= s_26_0
        fn_state.gs_161678 = s_26_0;
        // N s_26_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_27<T: Tracer>(
        ...
        // D s_27_3: call neq_int(s_27_2, s_27_0)
        let s_27_3: bool = neq_int(state, tracer, s_27_2, s_27_0);
        // D s_27_4: write-var gs#161675 <= s_27_3
        fn_state.gs_161675 = s_27_3;
        // N s_27_5: jump b5
        return block_5(state, tracer, fn_state);
    }
