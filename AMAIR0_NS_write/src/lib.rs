...
extern crate alloc;
use common::*;
pub fn AMAIR0_NS_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #89624u : u32
        let s_0_23: u32 = 89624;
        ...
        // C s_0_25: const #105008u : u32
        let s_0_25: u32 = 105008;
