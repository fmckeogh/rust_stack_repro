...
use common::*;
pub fn u__get_MPAM3_EL3<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #64s : i
        let s_0_3: i128 = 64;
        // C s_0_4: const #895934850870018048u : u60
        let s_0_4: u64 = 895934850870018048;
        ...
        // D s_0_15: tail-call Mk_MPAM3_EL3_Type(s_0_14)
        return Mk_MPAM3_EL3_Type(state, tracer, s_0_14);
    }
}
