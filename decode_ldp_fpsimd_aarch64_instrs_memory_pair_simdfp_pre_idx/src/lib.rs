...
use common::*;
pub fn decode_ldp_fpsimd_aarch64_instrs_memory_pair_simdfp_pre_idx<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#160833 <= s_4_0
        fn_state.gs_160833 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#160833:u8
        let s_5_0: bool = fn_state.gs_160833;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: write-var gs#160836 <= s_8_3
        fn_state.gs_160836 = s_8_3;
        // N s_8_5: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#160836:u8
        let s_9_0: bool = fn_state.gs_160836;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: write-var gs#160838 <= s_10_3
        fn_state.gs_160838 = s_10_3;
        // N s_10_5: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#160838:u8
        let s_11_0: bool = fn_state.gs_160838;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_4: write-var gs#160840 <= s_12_3
        fn_state.gs_160840 = s_12_3;
        // N s_12_5: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#160840:u8
        let s_13_0: bool = fn_state.gs_160840;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#160840 <= s_14_0
        fn_state.gs_160840 = s_14_0;
        // N s_14_2: jump b13
        return block_13(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#160838 <= s_15_0
        fn_state.gs_160838 = s_15_0;
        // N s_15_2: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#160836 <= s_16_0
        fn_state.gs_160836 = s_16_0;
        // N s_16_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_3: write-var gs#160843 <= s_19_2
        fn_state.gs_160843 = s_19_2;
        // N s_19_4: jump b20
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_0: read-var gs#160843:u8
        let s_20_0: bool = fn_state.gs_160843;
        // D s_20_1: write-var gs#160844 <= s_20_0
        fn_state.gs_160844 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#160844:u8
        let s_21_0: bool = fn_state.gs_160844;
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_1: write-var gs#160843 <= s_29_0
        fn_state.gs_160843 = s_29_0;
        // N s_29_2: jump b20
        return block_20(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_1: write-var gs#160844 <= s_30_0
        fn_state.gs_160844 = s_30_0;
        // N s_30_2: jump b21
        return block_21(state, tracer, fn_state);
    }
    fn block_31<T: Tracer>(
        ...
        // D s_31_5: write-var gs#160833 <= s_31_4
        fn_state.gs_160833 = s_31_4;
        // N s_31_6: jump b5
        return block_5(state, tracer, fn_state);
    }
