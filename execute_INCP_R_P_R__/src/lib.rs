...
use common::*;
pub fn execute_INCP_R_P_R__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    dn: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_30: write-var gs#189956 <= s_1_29
        fn_state.gs_189956 = s_1_29;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#189956:i64
        let s_2_1: i64 = fn_state.gs_189956;
