...
use CurrentVL_read::*;
use DecodeBitMasks::*;
use execute_EOR_Z_ZI__::*;
use HaveSME::*;
use common::*;
pub fn decode_EOR_Z_ZI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm13: u16,
    Zdn: u8,
    ...
    struct FunctionState {
        ...
        gs_194246: bool,
        VL: i64,
        gs_745144: ProductTypebc91b195b0b2a883,
        imm: u64,
        imm13: u16,
        Zdn: u8,
    }
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#194246 <= s_1_0
        fn_state.gs_194246 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#194246:u8
        let s_2_0: bool = fn_state.gs_194246;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_43: const #1u : u8
        let s_3_43: bool = true;
        // D s_3_44: call DecodeBitMasks(s_3_22, s_3_31, s_3_40, s_3_43, s_3_42)
        let s_3_44: ProductTypebc91b195b0b2a883 = DecodeBitMasks(
            state,
            tracer,
            s_3_22,
            s_3_31,
        ...
        // D s_3_45: write-var gs#745144 <= s_3_44
        fn_state.gs_745144 = s_3_44;
        // N s_3_46: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#745144.0:struct
        let s_4_0: Bits = fn_state.gs_745144._0;
        // D s_4_1: cast reint s_4_0 -> u64
        let s_4_1: u64 = (s_4_0.value() as u64);
        // D s_4_2: write-var imm <= s_4_1
        fn_state.imm = s_4_1;
        // D s_4_3: read-var VL:i64
        let s_4_3: i64 = fn_state.VL;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 128;
        // D s_5_1: read-var dn:i64
        let s_5_1: i64 = fn_state.dn;
        // D s_5_2: read-var imm:u64
        let s_5_2: u64 = fn_state.imm;
        // D s_5_3: call execute_EOR_Z_ZI__(s_5_0, s_5_1, s_5_2)
        let s_5_3: () = execute_EOR_Z_ZI__(state, tracer, s_5_0, s_5_1, s_5_2);
        // N s_5_4: return
        return;
    }
    fn block_6<T: Tracer>(
    ...
    fn block_7<T: Tracer>(
        ...
        let s_7_0: i64 = 256;
        // D s_7_1: read-var dn:i64
        let s_7_1: i64 = fn_state.dn;
        // D s_7_2: read-var imm:u64
        let s_7_2: u64 = fn_state.imm;
        // D s_7_3: call execute_EOR_Z_ZI__(s_7_0, s_7_1, s_7_2)
        let s_7_3: () = execute_EOR_Z_ZI__(state, tracer, s_7_0, s_7_1, s_7_2);
        // N s_7_4: return
        return;
    }
    fn block_8<T: Tracer>(
    ...
    fn block_9<T: Tracer>(
        ...
        let s_9_0: i64 = 512;
        // D s_9_1: read-var dn:i64
        let s_9_1: i64 = fn_state.dn;
        // D s_9_2: read-var imm:u64
        let s_9_2: u64 = fn_state.imm;
        // D s_9_3: call execute_EOR_Z_ZI__(s_9_0, s_9_1, s_9_2)
        let s_9_3: () = execute_EOR_Z_ZI__(state, tracer, s_9_0, s_9_1, s_9_2);
        // N s_9_4: return
        return;
    }
    ...
    fn block_11<T: Tracer>(
        ...
        let s_11_0: i64 = 1024;
        // D s_11_1: read-var dn:i64
        let s_11_1: i64 = fn_state.dn;
        // D s_11_2: read-var imm:u64
        let s_11_2: u64 = fn_state.imm;
        // D s_11_3: call execute_EOR_Z_ZI__(s_11_0, s_11_1, s_11_2)
        let s_11_3: () = execute_EOR_Z_ZI__(state, tracer, s_11_0, s_11_1, s_11_2);
        // N s_11_4: return
        return;
    }
    ...
    fn block_13<T: Tracer>(
        ...
        let s_13_0: i64 = 2048;
        // D s_13_1: read-var dn:i64
        let s_13_1: i64 = fn_state.dn;
        // D s_13_2: read-var imm:u64
        let s_13_2: u64 = fn_state.imm;
        // D s_13_3: call execute_EOR_Z_ZI__(s_13_0, s_13_1, s_13_2)
        let s_13_3: () = execute_EOR_Z_ZI__(state, tracer, s_13_0, s_13_1, s_13_2);
        // N s_13_4: return
        return;
    }
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_3: write-var gs#194246 <= s_16_2
        fn_state.gs_194246 = s_16_2;
        // N s_16_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
