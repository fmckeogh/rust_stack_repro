...
use HaveFP16Ext::*;
use common::*;
pub fn decode_frecps_advsimd_aarch64_instrs_vector_arithmetic_binary_uniform_recps_fp16_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, Rm: u8) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_19: call execute_aarch64_instrs_vector_arithmetic_binary_uniform_recps_fp16_sisd(s_1_3, s_1_15, s_1_18, s_1_17, s_1_11, s_1_7)
        let s_1_19: () = execute_aarch64_instrs_vector_arithmetic_binary_uniform_recps_fp16_sisd(
            state,
            tracer,
            s_1_3,
            s_1_15,
