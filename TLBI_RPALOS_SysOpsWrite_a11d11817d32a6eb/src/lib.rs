...
extern crate alloc;
use X_read::*;
use AArch64_TLBI_RPA::*;
use common::*;
pub fn TLBI_RPALOS_SysOpsWrite_a11d11817d32a6eb<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_4: u32 = 1;
        // C s_5_5: const #2u : u32
        let s_5_5: u32 = 2;
        // D s_5_6: call AArch64_TLBI_RPA(s_5_4, s_5_3, s_5_5)
        let s_5_6: () = AArch64_TLBI_RPA(state, tracer, s_5_4, s_5_3, s_5_5);
        // N s_5_7: return
        return;
    }
    fn block_6<T: Tracer>(
