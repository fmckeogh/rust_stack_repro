...
use DecodeImmShift::*;
use InITBlock::*;
use execute_aarch32_instrs_LSR_i_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_LSR_i_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm5: u8,
    Rm: u8,
    ...
    struct FunctionState {
        ga_344928: ProductType396b95aa74979079,
        imm5: u8,
        Rm: u8,
        Rd: u8,
    }
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_14: write-var ga#344928 <= s_2_13
        fn_state.ga_344928 = s_2_13;
        // D s_2_15: read-var ga#344928.1:struct
        let s_2_15: i128 = fn_state.ga_344928._1;
        // D s_2_16: call execute_aarch32_instrs_LSR_i_Op_A_txt(s_2_3, s_2_7, s_2_10, s_2_15)
        let s_2_16: () = execute_aarch32_instrs_LSR_i_Op_A_txt(
            state,
            tracer,
            s_2_3,
            s_2_7,
