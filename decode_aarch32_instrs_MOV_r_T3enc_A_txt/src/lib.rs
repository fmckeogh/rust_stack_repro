...
use common::*;
pub fn decode_aarch32_instrs_MOV_r_T3enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    S: bool,
    imm3: u8,
    ...
    struct FunctionState {
        m: i64,
        setflags: bool,
        shift_nshadow_7224: i128,
        shift_t: u32,
        gs_298652: bool,
        ga_345106: ProductType396b95aa74979079,
        d: i64,
        S: bool,
        imm3: u8,
        Rd: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_31: write-var ga#345106 <= s_2_30
        fn_state.ga_345106 = s_2_30;
        // D s_2_32: read-var ga#345106.0:struct
        let s_2_32: u32 = fn_state.ga_345106._0;
        // D s_2_33: read-var ga#345106.1:struct
        let s_2_33: i128 = fn_state.ga_345106._1;
        // D s_2_34: write-var shift_t <= s_2_32
        fn_state.shift_t = s_2_32;
        // D s_2_35: write-var shift_nshadow#7224 <= s_2_33
        fn_state.shift_nshadow_7224 = s_2_33;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#298652 <= s_3_3
        fn_state.gs_298652 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#298652:u8
        let s_4_0: bool = fn_state.gs_298652;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: read-var shift_nshadow#7224:i
        let s_5_1: i128 = fn_state.shift_nshadow_7224;
        ...
        // D s_5_5: call execute_aarch32_instrs_MOV_r_Op_A_txt(s_5_2, s_5_3, s_5_4, s_5_1, s_5_0)
        let s_5_5: () = execute_aarch32_instrs_MOV_r_Op_A_txt(
            state,
            tracer,
            s_5_2,
            s_5_3,
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #1u : u8
        let s_7_0: bool = true;
        // D s_7_1: write-var gs#298652 <= s_7_0
        fn_state.gs_298652 = s_7_0;
        // N s_7_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
