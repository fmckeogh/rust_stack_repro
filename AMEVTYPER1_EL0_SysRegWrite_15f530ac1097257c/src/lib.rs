...
use common::*;
pub fn AMEVTYPER1_EL0_SysRegWrite_15f530ac1097257c<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var gs#80827 <= s_2_0
        fn_state.gs_80827 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#80827:u8
        let s_3_0: bool = fn_state.gs_80827;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: write-var gs#80827 <= s_6_2
        fn_state.gs_80827 = s_6_2;
        // N s_6_4: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_7<T: Tracer>(
