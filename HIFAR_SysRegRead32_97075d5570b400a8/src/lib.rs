...
use HIFAR_read::*;
use common::*;
pub fn HIFAR_SysRegRead32_97075d5570b400a8<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #() : ()
        let s_6_0: () = ();
        // S s_6_1: call HIFAR_read(s_6_0)
        let s_6_1: u32 = HIFAR_read(state, tracer, s_6_0);
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #() : ()
        let s_8_0: () = ();
        // S s_8_1: call HIFAR_read(s_8_0)
        let s_8_1: u32 = HIFAR_read(state, tracer, s_8_0);
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#111260 <= s_10_0
        fn_state.gs_111260 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#111260:u8
        let s_11_0: bool = fn_state.gs_111260;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#111261 <= s_12_0
        fn_state.gs_111261 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#111261:u8
        let s_13_0: bool = fn_state.gs_111261;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#111262 <= s_15_0
        fn_state.gs_111262 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#111262:u8
        let s_16_0: bool = fn_state.gs_111262;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#111263 <= s_17_0
        fn_state.gs_111263 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#111263:u8
        let s_18_0: bool = fn_state.gs_111263;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_5: write-var gs#111263 <= s_21_4
        fn_state.gs_111263 = s_21_4;
        // N s_21_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        // D s_22_3: write-var gs#111262 <= s_22_2
        fn_state.gs_111262 = s_22_2;
        // N s_22_4: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_5: write-var gs#111261 <= s_24_4
        fn_state.gs_111261 = s_24_4;
        // N s_24_6: jump b13
        return block_13(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_4: write-var gs#111260 <= s_25_3
        fn_state.gs_111260 = s_25_3;
        // N s_25_5: jump b11
        return block_11(state, tracer, fn_state);
    }
