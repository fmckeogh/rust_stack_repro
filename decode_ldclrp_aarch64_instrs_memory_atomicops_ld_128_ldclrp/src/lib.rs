...
use neq_int::*;
use HaveLSE128::*;
use execute_aarch64_instrs_memory_atomicops_ld_128_ldclrp::*;
use common::*;
pub fn decode_ldclrp_aarch64_instrs_memory_atomicops_ld_128_ldclrp<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_18: call execute_aarch64_instrs_memory_atomicops_ld_128_ldclrp(s_5_4, s_5_14, s_5_15, s_5_9, s_5_16, s_5_17, s_5_13)
        let s_5_18: () = execute_aarch64_instrs_memory_atomicops_ld_128_ldclrp(
            state,
            tracer,
            s_5_4,
            s_5_14,
