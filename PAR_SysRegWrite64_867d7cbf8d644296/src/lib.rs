...
use common::*;
pub fn PAR_SysRegWrite64_867d7cbf8d644296<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_15: call Mk_PAR_Type(s_6_14)
        let s_6_15: ProductType5c790c8ef59cc8b2 = Mk_PAR_Type(state, tracer, s_6_14);
        // C s_6_16: const #102824u : u32
        let s_6_16: u32 = 102824;
        // N s_6_17: write-reg s_6_16 <= s_6_15
        let s_6_17: () = {
            state.write_register::<ProductType5c790c8ef59cc8b2>(s_6_16 as isize, s_6_15);
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_15: call Mk_PAR_Type(s_7_14)
        let s_7_15: ProductType5c790c8ef59cc8b2 = Mk_PAR_Type(state, tracer, s_7_14);
        // C s_7_16: const #90712u : u32
        let s_7_16: u32 = 90712;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#104972 <= s_9_0
        fn_state.gs_104972 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#104972:u8
        let s_10_0: bool = fn_state.gs_104972;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_15: call Mk_PAR_Type(s_11_14)
        let s_11_15: ProductType5c790c8ef59cc8b2 = Mk_PAR_Type(state, tracer, s_11_14);
        // D s_11_16: call PAR_write(s_11_15)
        let s_11_16: () = PAR_write(state, tracer, s_11_15);
        // N s_11_17: return
        return;
    }
    fn block_12<T: Tracer>(
        ...
        // D s_12_15: call Mk_PAR_Type(s_12_14)
        let s_12_15: ProductType5c790c8ef59cc8b2 = Mk_PAR_Type(state, tracer, s_12_14);
        // C s_12_16: const #102824u : u32
        let s_12_16: u32 = 102824;
        // N s_12_17: write-reg s_12_16 <= s_12_15
        let s_12_17: () = {
            state
                .write_register::<
                    ProductType5c790c8ef59cc8b2,
                >(s_12_16 as isize, s_12_15);
            tracer.write_register(s_12_16 as isize, s_12_15);
        };
        // N s_12_18: return
        return;
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_3: write-var gs#104972 <= s_13_2
        fn_state.gs_104972 = s_13_2;
        // N s_13_4: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#104973 <= s_15_0
        fn_state.gs_104973 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#104973:u8
        let s_16_0: bool = fn_state.gs_104973;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#104974 <= s_17_0
        fn_state.gs_104974 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#104974:u8
        let s_18_0: bool = fn_state.gs_104974;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#104975 <= s_20_0
        fn_state.gs_104975 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#104975:u8
        let s_21_0: bool = fn_state.gs_104975;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#104976 <= s_22_0
        fn_state.gs_104976 = s_22_0;
        // N s_22_2: jump b23
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_0: read-var gs#104976:u8
        let s_23_0: bool = fn_state.gs_104976;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#104977 <= s_25_0
        fn_state.gs_104977 = s_25_0;
        // N s_25_2: jump b26
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var gs#104977:u8
        let s_26_0: bool = fn_state.gs_104977;
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_0: read-var t2:i
        let s_27_0: i128 = fn_state.t2;
        // D s_27_1: call R_read(s_27_0)
        let s_27_1: u32 = R_read(state, tracer, s_27_0);
        // D s_27_2: read-var t:i
        let s_27_2: i128 = fn_state.t;
        // D s_27_3: call R_read(s_27_2)
        let s_27_3: u32 = R_read(state, tracer, s_27_2);
        // D s_27_4: cast zx s_27_1 -> bv
        let s_27_4: Bits = Bits::new(s_27_1 as u128, 32u16);
        // D s_27_5: cast zx s_27_3 -> bv
        let s_27_5: Bits = Bits::new(s_27_3 as u128, 32u16);
        // D s_27_6: cast reint s_27_4 -> u128
        let s_27_6: u128 = (s_27_4.value() as u128);
        // D s_27_7: size-of s_27_4
        let s_27_7: u16 = s_27_4.length();
        // D s_27_8: cast reint s_27_5 -> u128
        let s_27_8: u128 = (s_27_5.value() as u128);
        // D s_27_9: size-of s_27_5
        let s_27_9: u16 = s_27_5.length();
        // D s_27_10: lsl s_27_6 s_27_9
        let s_27_10: u128 = s_27_6 << s_27_9;
        // D s_27_11: or s_27_10 s_27_8
        let s_27_11: u128 = ((s_27_10) | (s_27_8));
        // D s_27_12: add s_27_7 s_27_9
        let s_27_12: u16 = (s_27_7 + s_27_9);
        // D s_27_13: create-bits s_27_11 s_27_12
        let s_27_13: Bits = Bits::new(s_27_11, s_27_12);
        // D s_27_14: cast reint s_27_13 -> u64
        let s_27_14: u64 = (s_27_13.value() as u64);
        // D s_27_15: call Mk_PAR_Type(s_27_14)
        let s_27_15: ProductType5c790c8ef59cc8b2 = Mk_PAR_Type(state, tracer, s_27_14);
        // D s_27_16: call PAR_write(s_27_15)
        let s_27_16: () = PAR_write(state, tracer, s_27_15);
        // N s_27_17: return
        return;
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_0: read-var t2:i
        let s_28_0: i128 = fn_state.t2;
        // D s_28_1: call R_read(s_28_0)
        let s_28_1: u32 = R_read(state, tracer, s_28_0);
        // D s_28_2: read-var t:i
        let s_28_2: i128 = fn_state.t;
        // D s_28_3: call R_read(s_28_2)
        let s_28_3: u32 = R_read(state, tracer, s_28_2);
        // D s_28_4: cast zx s_28_1 -> bv
        let s_28_4: Bits = Bits::new(s_28_1 as u128, 32u16);
        // D s_28_5: cast zx s_28_3 -> bv
        let s_28_5: Bits = Bits::new(s_28_3 as u128, 32u16);
        // D s_28_6: cast reint s_28_4 -> u128
        let s_28_6: u128 = (s_28_4.value() as u128);
        // D s_28_7: size-of s_28_4
        let s_28_7: u16 = s_28_4.length();
        // D s_28_8: cast reint s_28_5 -> u128
        let s_28_8: u128 = (s_28_5.value() as u128);
        // D s_28_9: size-of s_28_5
        let s_28_9: u16 = s_28_5.length();
        // D s_28_10: lsl s_28_6 s_28_9
        let s_28_10: u128 = s_28_6 << s_28_9;
        // D s_28_11: or s_28_10 s_28_8
        let s_28_11: u128 = ((s_28_10) | (s_28_8));
        // D s_28_12: add s_28_7 s_28_9
        let s_28_12: u16 = (s_28_7 + s_28_9);
        // D s_28_13: create-bits s_28_11 s_28_12
        let s_28_13: Bits = Bits::new(s_28_11, s_28_12);
        // D s_28_14: cast reint s_28_13 -> u64
        let s_28_14: u64 = (s_28_13.value() as u64);
        // D s_28_15: call Mk_PAR_Type(s_28_14)
        let s_28_15: ProductType5c790c8ef59cc8b2 = Mk_PAR_Type(state, tracer, s_28_14);
        // C s_28_16: const #102824u : u32
        let s_28_16: u32 = 102824;
        // N s_28_17: write-reg s_28_16 <= s_28_15
        let s_28_17: () = {
            state
                .write_register::<
                    ProductType5c790c8ef59cc8b2,
                >(s_28_16 as isize, s_28_15);
            tracer.write_register(s_28_16 as isize, s_28_15);
        };
        // N s_28_18: return
        return;
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_3: write-var gs#104977 <= s_29_2
        fn_state.gs_104977 = s_29_2;
        // N s_29_4: jump b26
        return block_26(state, tracer, fn_state);
    }
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_5: write-var gs#104976 <= s_31_4
        fn_state.gs_104976 = s_31_4;
        // N s_31_6: jump b23
        return block_23(state, tracer, fn_state);
    }
    fn block_32<T: Tracer>(
        ...
        // D s_32_3: write-var gs#104975 <= s_32_2
        fn_state.gs_104975 = s_32_2;
        // N s_32_4: jump b21
        return block_21(state, tracer, fn_state);
    }
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_5: write-var gs#104974 <= s_34_4
        fn_state.gs_104974 = s_34_4;
        // N s_34_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    fn block_35<T: Tracer>(
        ...
        // D s_35_4: write-var gs#104973 <= s_35_3
        fn_state.gs_104973 = s_35_3;
        // N s_35_5: jump b16
        return block_16(state, tracer, fn_state);
    }
