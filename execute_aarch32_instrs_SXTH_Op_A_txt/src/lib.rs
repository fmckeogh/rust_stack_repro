...
use R_read::*;
use common::*;
pub fn execute_aarch32_instrs_SXTH_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_15: cast reint s_0_14 -> u16
        let s_0_15: u16 = (s_0_14.value() as u16);
        // C s_0_16: const #32s : i
        let s_0_16: i128 = 32;
        // D s_0_17: cast zx s_0_15 -> bv
        let s_0_17: Bits = Bits::new(s_0_15 as u128, 16u16);
        // D s_0_18: bits-cast sx s_0_17 -> bv length s_0_16
        let s_0_18: Bits = s_0_17.sign_extend(s_0_16);
