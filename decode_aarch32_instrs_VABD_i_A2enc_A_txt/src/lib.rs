...
use common::*;
pub fn decode_aarch32_instrs_VABD_i_A2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    U: bool,
    D: bool,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_68: call execute_aarch32_instrs_VABD_i_Op_A_txt(s_4_30, s_4_65, s_4_64, s_4_67, s_4_62, s_4_46, s_4_66, s_4_4)
        let s_4_68: () = execute_aarch32_instrs_VABD_i_Op_A_txt(
            state,
            tracer,
            s_4_30,
            s_4_65,
