...
use common::*;
pub fn execute_PRFH_I_P_BR_S<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    esize: i64,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var offsetshadow#4497 <= s_3_0
        fn_state.offsetshadow_4497 = s_3_0;
        // D s_3_2: read-var base:u64
        let s_3_2: u64 = fn_state.base;
        // D s_3_3: write-var baseshadow#4498 <= s_3_2
        fn_state.baseshadow_4498 = s_3_2;
        ...
        // D s_3_10: write-var gs#226137 <= s_3_9
        fn_state.gs_226137 = s_3_9;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#226137:i64
        let s_4_1: i64 = fn_state.gs_226137;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var offsetshadow#4497:u64
        let s_8_0: u64 = fn_state.offsetshadow_4497;
        ...
        // D s_8_9: read-var baseshadow#4498:u64
        let s_8_9: u64 = fn_state.baseshadow_4498;
