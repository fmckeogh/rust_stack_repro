...
use P_read::*;
use common::*;
pub fn execute_TRN1_P_PP__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_36: write-var gs#194717 <= s_1_35
        fn_state.gs_194717 = s_1_35;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#194717:i64
        let s_2_1: i64 = fn_state.gs_194717;
