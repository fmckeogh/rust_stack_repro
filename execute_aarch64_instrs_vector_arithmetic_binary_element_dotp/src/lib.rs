...
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_binary_element_dotp<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    datasize: i64,
    ...
    struct FunctionState {
        ...
        element2: i128,
        element1: i128,
        esizeshadow_1820: i64,
        result: Bits,
        i: i64,
        operand1: Bits,
        datasizeshadow_1821: i64,
        operand2: u128,
        d: i64,
        datasize: i64,
        elements: i128,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#1820 <= s_0_2
        fn_state.esizeshadow_1820 = s_0_2;
        ...
        // D s_0_7: write-var datasizeshadow#1821 <= s_0_6
        fn_state.datasizeshadow_1821 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var datasizeshadow#1821:i64
        let s_1_0: i64 = fn_state.datasizeshadow_1821;
        ...
        // D s_1_13: read-var datasizeshadow#1821:i64
        let s_1_13: i64 = fn_state.datasizeshadow_1821;
        ...
        // D s_1_19: write-var result <= s_1_18
        fn_state.result = s_1_18;
        ...
        // D s_1_25: write-var gs#167733 <= s_1_24
        fn_state.gs_167733 = s_1_24;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#167733:i64
        let s_2_1: i64 = fn_state.gs_167733;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_7: const #4s : i
        let s_6_7: i128 = 4;
        // D s_6_8: read-var esizeshadow#1820:i64
        let s_6_8: i64 = fn_state.esizeshadow_1820;
        ...
        // C s_6_19: const #4s : i
        let s_6_19: i128 = 4;
        // D s_6_20: read-var index:i64
        let s_6_20: i64 = fn_state.index;
        ...
        // D s_6_36: read-var operand2:u128
        let s_6_36: u128 = fn_state.operand2;
        // D s_6_37: cast zx s_6_36 -> bv
        let s_6_37: Bits = Bits::new(s_6_36 as u128, 128u16);
        // D s_6_38: cast zx s_6_28 -> i
        let s_6_38: i128 = (i128::try_from(s_6_28).unwrap());
        // D s_6_39: cast zx s_6_35 -> i
        let s_6_39: i128 = (i128::try_from(s_6_35).unwrap());
        // D s_6_40: call Elem_read(s_6_37, s_6_38, s_6_39)
        let s_6_40: Bits = Elem_read(state, tracer, s_6_37, s_6_38, s_6_39);
        // D s_6_41: cast zx s_6_40 -> i
        let s_6_41: i128 = (s_6_40.value() as i128);
        // D s_6_42: write-var element2 <= s_6_41
        fn_state.element2 = s_6_41;
        // N s_6_43: jump b7
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_7: const #4s : i
        let s_8_7: i128 = 4;
        // D s_8_8: read-var esizeshadow#1820:i64
        let s_8_8: i64 = fn_state.esizeshadow_1820;
        ...
        // C s_8_19: const #4s : i
        let s_8_19: i128 = 4;
        // D s_8_20: read-var index:i64
        let s_8_20: i64 = fn_state.index;
        ...
        // D s_8_36: read-var operand2:u128
        let s_8_36: u128 = fn_state.operand2;
        // D s_8_37: cast zx s_8_36 -> bv
        let s_8_37: Bits = Bits::new(s_8_36 as u128, 128u16);
        // D s_8_38: cast zx s_8_28 -> i
        let s_8_38: i128 = (i128::try_from(s_8_28).unwrap());
        // D s_8_39: cast zx s_8_35 -> i
        let s_8_39: i128 = (i128::try_from(s_8_35).unwrap());
        // D s_8_40: call Elem_read(s_8_37, s_8_38, s_8_39)
        let s_8_40: Bits = Elem_read(state, tracer, s_8_37, s_8_38, s_8_39);
        // D s_8_41: cast sx s_8_40 -> i
        let s_8_41: i128 = {
            let sign_bit = s_8_40.length() - 1;
            let mut result = s_8_40.value() as i128;
            if ((result >> sign_bit) & 1) == 1 {
                let cleared_bit = result & !(1 << sign_bit);
                result = cleared_bit - (1 << sign_bit);
            }
        ...
        // D s_8_42: write-var element2 <= s_8_41
        fn_state.element2 = s_8_41;
        // N s_8_43: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: read-var esizeshadow#1820:i64
        let s_9_1: i64 = fn_state.esizeshadow_1820;
        // D s_9_2: cast zx s_9_1 -> i
        let s_9_2: i128 = (i128::try_from(s_9_1).unwrap());
        // D s_9_3: cast reint s_9_2 -> i64
        let s_9_3: i64 = (s_9_2 as i64);
        // D s_9_4: read-var esizeshadow#1820:i64
        let s_9_4: i64 = fn_state.esizeshadow_1820;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var datasizeshadow#1821:i64
        let s_10_0: i64 = fn_state.datasizeshadow_1821;
