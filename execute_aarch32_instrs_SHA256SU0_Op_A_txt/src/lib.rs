...
use ROR::*;
use common::*;
pub fn execute_aarch32_instrs_SHA256SU0_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_19: i128 = 32;
        // D s_1_20: read-var x:u128
        let s_1_20: u128 = fn_state.x;
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_29: i64 = 32;
        // D s_3_30: read-var x:u128
        let s_3_30: u128 = fn_state.x;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: read-var result:u128
        let s_4_4: u128 = fn_state.result;
