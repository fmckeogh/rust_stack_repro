...
extern crate alloc;
use HaveSVE2p1::*;
use execute_PMOV_Z_PI_D::*;
use CurrentVL_read::*;
use HaveSME2p1::*;
use common::*;
pub fn decode_PMOV_Z_PI_D<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i3h: bool,
    i3l: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#221350 <= s_1_0
        fn_state.gs_221350 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#221350:u8
        let s_2_0: bool = fn_state.gs_221350;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var Pn:u8
        let s_3_0: u8 = fn_state.Pn;
        ...
        fn_state.n = s_3_3;
        // D s_3_5: read-var Zd:u8
        let s_3_5: u8 = fn_state.Zd;
        ...
        fn_state.d = s_3_8;
        // D s_3_10: read-var i3h:u8
        let s_3_10: bool = fn_state.i3h;
        // D s_3_11: cast zx s_3_10 -> bv
        let s_3_11: Bits = Bits::new(s_3_10 as u128, 1u16);
        // D s_3_12: read-var i3l:u8
        let s_3_12: u8 = fn_state.i3l;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_5: call execute_PMOV_Z_PI_D(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4)
        let s_4_5: () = execute_PMOV_Z_PI_D(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: call execute_PMOV_Z_PI_D(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4)
        let s_6_5: () = execute_PMOV_Z_PI_D(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_5: call execute_PMOV_Z_PI_D(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4)
        let s_8_5: () = execute_PMOV_Z_PI_D(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: call execute_PMOV_Z_PI_D(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4)
        let s_10_5: () = execute_PMOV_Z_PI_D(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: call execute_PMOV_Z_PI_D(s_12_0, s_12_1, s_12_2, s_12_3, s_12_4)
        let s_12_5: () = execute_PMOV_Z_PI_D(
            state,
            tracer,
            s_12_0,
            s_12_1,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#221350 <= s_15_2
        fn_state.gs_221350 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
