...
extern crate alloc;
use neq_int::*;
use execute_aarch64_instrs_memory_single_general_immediate_unsigned::*;
use common::*;
pub fn decode_prfm_imm_aarch64_instrs_memory_single_general_immediate_unsigned<
    T: Tracer,
>(state: &mut State, tracer: &T, Rt: u8, Rn: u8, imm12: u16, opc: u8, size: u8) -> () {
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_8: bits-cast zx s_0_7 -> bv length s_0_5
        let s_0_8: Bits = s_0_7.zero_extend(s_0_5);
        ...
        // D s_0_11: read-var scale:i64
        let s_0_11: i64 = fn_state.scale;
        // D s_0_12: cast zx s_0_11 -> i
        let s_0_12: i128 = (i128::try_from(s_0_11).unwrap());
        // D s_0_13: lsl s_0_10 s_0_12
        let s_0_13: Bits = s_0_10 << s_0_12;
        // D s_0_14: cast reint s_0_13 -> u64
        let s_0_14: u64 = (s_0_13.value() as u64);
        // D s_0_15: write-var offset <= s_0_14
        fn_state.offset = s_0_14;
        // D s_0_16: read-var Rn:u8
        let s_0_16: u8 = fn_state.Rn;
        ...
        // D s_0_20: write-var n <= s_0_19
        fn_state.n = s_0_19;
        // D s_0_21: read-var Rt:u8
        let s_0_21: u8 = fn_state.Rt;
        // D s_0_22: cast zx s_0_21 -> bv
        let s_0_22: Bits = Bits::new(s_0_21 as u128, 5u16);
        // D s_0_23: cast zx s_0_22 -> i
        let s_0_23: i128 = (s_0_22.value() as i128);
        // D s_0_24: cast reint s_0_23 -> i64
        let s_0_24: i64 = (s_0_23 as i64);
        // D s_0_25: write-var t <= s_0_24
        fn_state.t = s_0_24;
        // C s_0_26: const #32s : i64
        let s_0_26: i64 = 32;
        // D s_0_27: write-var regsize <= s_0_26
        fn_state.regsize = s_0_26;
        // C s_0_28: const #1s : i
        let s_0_28: i128 = 1;
        // D s_0_29: read-var opc:u8
        let s_0_29: u8 = fn_state.opc;
        // D s_0_30: cast zx s_0_29 -> bv
        let s_0_30: Bits = Bits::new(s_0_29 as u128, 2u16);
        // C s_0_31: const #1u : u64
        let s_0_31: u64 = 1;
        // D s_0_32: bit-extract s_0_30 s_0_28 s_0_31
        let s_0_32: Bits = (Bits::new(
            ((s_0_30) >> (s_0_28)).value(),
            u16::try_from(s_0_31).unwrap(),
        ));
        // D s_0_33: cast reint s_0_32 -> u8
        let s_0_33: bool = ((s_0_32.value()) != 0);
        // C s_0_34: const #0s : i
        let s_0_34: i128 = 0;
        // C s_0_35: const #0u : u64
        let s_0_35: u64 = 0;
        // D s_0_36: cast zx s_0_33 -> u64
        let s_0_36: u64 = (s_0_33 as u64);
        // C s_0_37: const #1u : u64
        let s_0_37: u64 = 1;
        // D s_0_38: and s_0_36 s_0_37
        let s_0_38: u64 = ((s_0_36) & (s_0_37));
        // D s_0_39: cmp-eq s_0_38 s_0_37
        let s_0_39: bool = ((s_0_38) == (s_0_37));
        // D s_0_40: lsl s_0_36 s_0_34
        let s_0_40: u64 = s_0_36 << s_0_34;
        // D s_0_41: or s_0_35 s_0_40
        let s_0_41: u64 = ((s_0_35) | (s_0_40));
        // D s_0_42: cmpl s_0_40
        let s_0_42: u64 = !s_0_40;
        // D s_0_43: and s_0_35 s_0_42
        let s_0_43: u64 = ((s_0_35) & (s_0_42));
        // D s_0_44: select s_0_39 s_0_41 s_0_43
        let s_0_44: u64 = if s_0_39 { s_0_41 } else { s_0_43 };
        // D s_0_45: cast trunc s_0_44 -> u8
        let s_0_45: bool = ((s_0_44) != 0);
        // D s_0_46: cast zx s_0_45 -> bv
        let s_0_46: Bits = Bits::new(s_0_45 as u128, 1u16);
        // C s_0_47: const #0u : u8
        let s_0_47: bool = false;
        // C s_0_48: cast zx s_0_47 -> bv
        let s_0_48: Bits = Bits::new(s_0_47 as u128, 1u16);
        // D s_0_49: cmp-eq s_0_46 s_0_48
        let s_0_49: bool = ((s_0_46) == (s_0_48));
        // N s_0_50: branch s_0_49 b18 b1
        if s_0_49 {
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#165768 <= s_3_0
        fn_state.gs_165768 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#165768:u8
        let s_4_0: bool = fn_state.gs_165768;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var regsizeshadow#1783 <= s_8_0
        fn_state.regsizeshadow_1783 = s_8_0;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#165791 <= s_9_0
        fn_state.gs_165791 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#165791:u8
        let s_10_0: bool = fn_state.gs_165791;
        ...
        // D s_10_4: read-var regsizeshadow#1783:i64
        let s_10_4: i64 = fn_state.regsizeshadow_1783;
        ...
        // D s_10_17: call execute_aarch64_instrs_memory_single_general_immediate_unsigned(s_10_3, s_10_7, s_10_8, s_10_9, s_10_10, s_10_11, s_10_6, s_10_12, s_10_13, s_10_14, s_10_0, s_10_15, s_10_16)
        let s_10_17: () = execute_aarch64_instrs_memory_single_general_immediate_unsigned(
            state,
            tracer,
            s_10_3,
            s_10_7,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_4: write-var gs#165791 <= s_11_3
        fn_state.gs_165791 = s_11_3;
        // N s_11_5: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_22: write-var gs#165768 <= s_14_21
        fn_state.gs_165768 = s_14_21;
        // N s_14_23: jump b4
        return block_4(state, tracer, fn_state);
    }
