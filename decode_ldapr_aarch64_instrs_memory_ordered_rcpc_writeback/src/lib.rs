...
use common::*;
pub fn decode_ldapr_aarch64_instrs_memory_ordered_rcpc_writeback<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 32;
        // D s_1_1: write-var ga#258840 <= s_1_0
        fn_state.ga_258840 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#258840:i64
        let s_2_0: i64 = fn_state.ga_258840;
        ...
        // D s_2_15: write-var offset <= s_2_14
        fn_state.offset = s_2_14;
        // C s_2_16: const #0u : u8
        let s_2_16: bool = false;
        // D s_2_17: write-var wb_unknown <= s_2_16
        fn_state.wb_unknown = s_2_16;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#158572 <= s_3_0
        fn_state.gs_158572 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#158572:u8
        let s_4_0: bool = fn_state.gs_158572;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_7: read-var offset:i64
        let s_6_7: i64 = fn_state.offset;
        // D s_6_8: read-var t:i64
        let s_6_8: i64 = fn_state.t;
        // C s_6_9: const #1u : u8
        let s_6_9: bool = true;
        // D s_6_10: read-var wb_unknown:u8
        let s_6_10: bool = fn_state.wb_unknown;
        // D s_6_11: read-var wback:u8
        let s_6_11: bool = fn_state.wback;
        // D s_6_12: call execute_aarch64_instrs_memory_ordered_rcpc(s_6_2, s_6_6, s_6_7, s_6_5, s_6_8, s_6_9, s_6_10, s_6_11)
        let s_6_12: () = execute_aarch64_instrs_memory_ordered_rcpc(
            state,
            tracer,
            s_6_2,
            s_6_6,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_3: write-var gs#158574 <= s_10_2
        fn_state.gs_158574 = s_10_2;
        // N s_10_4: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#158574:u8
        let s_11_0: bool = fn_state.gs_158574;
        // D s_11_1: write-var gs#158575 <= s_11_0
        fn_state.gs_158575 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#158575:u8
        let s_12_0: bool = fn_state.gs_158575;
        // D s_12_1: write-var gs#158576 <= s_12_0
        fn_state.gs_158576 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#158576:u8
        let s_13_0: bool = fn_state.gs_158576;
        // N s_13_1: assert s_13_0
        let s_13_1: () = assert!(s_13_0);
        // C s_13_2: const #11u : u32
        let s_13_2: u32 = 11;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var wback <= s_14_0
        fn_state.wback = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var wb_unknown <= s_17_0
        fn_state.wb_unknown = s_17_0;
        // N s_17_2: jump b15
        return block_15(state, tracer, fn_state);
    }
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_1: write-var gs#158574 <= s_23_0
        fn_state.gs_158574 = s_23_0;
        // N s_23_2: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_24<T: Tracer>(
        ...
        // D s_24_1: write-var gs#158575 <= s_24_0
        fn_state.gs_158575 = s_24_0;
        // N s_24_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#158576 <= s_25_0
        fn_state.gs_158576 = s_25_0;
        // N s_25_2: jump b13
        return block_13(state, tracer, fn_state);
    }
    fn block_26<T: Tracer>(
        ...
        // D s_26_4: write-var gs#158572 <= s_26_3
        fn_state.gs_158572 = s_26_3;
        // N s_26_5: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_27<T: Tracer>(
        ...
        let s_27_0: i64 = 64;
        // D s_27_1: write-var ga#258840 <= s_27_0
        fn_state.ga_258840 = s_27_0;
        // N s_27_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
