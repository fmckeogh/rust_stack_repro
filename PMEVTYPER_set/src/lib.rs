...
pub fn PMEVTYPER_set<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_1: const #11208u : u32
        let s_0_1: u32 = 11208;
        // D s_0_2: read-reg s_0_1:[struct; 32]
        let s_0_2: [ProductType5c790c8ef59cc8b2; 32usize] = {
            let value = state
                .read_register::<[ProductType5c790c8ef59cc8b2; 32usize]>(s_0_1 as isize);
        ...
        // C s_0_6: const #11208u : u32
        let s_0_6: u32 = 11208;
        // D s_0_7: read-reg s_0_6:[struct; 32]
        let s_0_7: [ProductType5c790c8ef59cc8b2; 32usize] = {
            let value = state
                .read_register::<[ProductType5c790c8ef59cc8b2; 32usize]>(s_0_6 as isize);
        ...
        let s_0_10: [ProductType5c790c8ef59cc8b2; 32usize] = {
        ...
        // D s_0_12: cast cvt s_0_11 -> [struct; 32]
        let s_0_12: [ProductType5c790c8ef59cc8b2; 32usize] = {
            let mut buf = [Default::default(); 32usize];
            buf.copy_from_slice(&s_0_11);
            buf
        };
        // C s_0_13: const #11208u : u32
        let s_0_13: u32 = 11208;
        ...
        // C s_0_15: const #23464u : u32
        let s_0_15: u32 = 23464;
        // D s_0_16: read-reg s_0_15:[struct; 31]
        let s_0_16: [ProductType700c18a878c5601b; 31usize] = {
            let value = state
                .read_register::<
                    [ProductType700c18a878c5601b; 31usize],
                >(s_0_15 as isize);
        ...
        let s_0_19: [ProductType700c18a878c5601b; 31usize] = {
        ...
        // D s_0_21: cast cvt s_0_20 -> [struct; 31]
        let s_0_21: [ProductType700c18a878c5601b; 31usize] = {
            let mut buf = [Default::default(); 31usize];
            buf.copy_from_slice(&s_0_20);
            buf
        };
        // C s_0_22: const #23464u : u32
        let s_0_22: u32 = 23464;
