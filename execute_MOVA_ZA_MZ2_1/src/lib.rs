...
use ZAvector_set::*;
use common::*;
pub fn execute_MOVA_ZA_MZ2_1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    n: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#5566 <= s_0_2
        fn_state.VLshadow_5566 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#5566:i64
        let s_1_0: i64 = fn_state.VLshadow_5566;
        // D s_1_1: write-var VLshadow#5567 <= s_1_0
        fn_state.VLshadow_5567 = s_1_0;
        // C s_1_2: const #8s : i
        let s_1_2: i128 = 8;
        // D s_1_3: read-var VLshadow#5567:i64
        let s_1_3: i64 = fn_state.VLshadow_5567;
        ...
        // D s_1_37: write-var gs#258605 <= s_1_36
        fn_state.gs_258605 = s_1_36;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#258605:i64
        let s_2_1: i64 = fn_state.gs_258605;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_6: read-var VLshadow#5567:i64
        let s_3_6: i64 = fn_state.VLshadow_5567;
        ...
        // D s_3_13: read-var VLshadow#5567:i64
        let s_3_13: i64 = fn_state.VLshadow_5567;
