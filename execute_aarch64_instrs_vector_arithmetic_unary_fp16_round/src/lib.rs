...
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_unary_fp16_round<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    datasize: i64,
    ...
    struct FunctionState {
        operand: Bits,
        esizeshadow_1434: i64,
        e: i64,
        ga_256331: Bits,
        result: Bits,
        datasizeshadow_1435: i64,
        ga_256330: i64,
        gs_154246: i64,
        d: i64,
        datasize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#1434 <= s_0_2
        fn_state.esizeshadow_1434 = s_0_2;
        ...
        // D s_0_7: write-var datasizeshadow#1435 <= s_0_6
        fn_state.datasizeshadow_1435 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var datasizeshadow#1435:i64
        let s_1_0: i64 = fn_state.datasizeshadow_1435;
        ...
        // D s_1_12: write-var gs#154246 <= s_1_11
        fn_state.gs_154246 = s_1_11;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#154246:i64
        let s_2_1: i64 = fn_state.gs_154246;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var esizeshadow#1434:i64
        let s_3_0: i64 = fn_state.esizeshadow_1434;
        ...
        // D s_3_8: read-var esizeshadow#1434:i64
        let s_3_8: i64 = fn_state.esizeshadow_1434;
        // D s_3_9: cast zx s_3_8 -> i
        let s_3_9: i128 = (i128::try_from(s_3_8).unwrap());
        // D s_3_10: cast reint s_3_9 -> i64
        let s_3_10: i64 = (s_3_9 as i64);
        // D s_3_11: write-var ga#256330 <= s_3_10
        fn_state.ga_256330 = s_3_10;
        // C s_3_12: const #() : ()
        let s_3_12: () = ();
        // S s_3_13: call FPCR_read(s_3_12)
        let s_3_13: ProductType5c790c8ef59cc8b2 = FPCR_read(state, tracer, s_3_12);
        // D s_3_14: read-var rounding:u32
        let s_3_14: u32 = fn_state.rounding;
        // D s_3_15: read-var exact:u8
        let s_3_15: bool = fn_state.exact;
        // D s_3_16: call FPRoundInt(s_3_7, s_3_13, s_3_14, s_3_15)
        let s_3_16: Bits = FPRoundInt(state, tracer, s_3_7, s_3_13, s_3_14, s_3_15);
        // D s_3_17: write-var ga#256331 <= s_3_16
        fn_state.ga_256331 = s_3_16;
        // N s_3_18: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: read-var ga#256330:i64
        let s_4_2: i64 = fn_state.ga_256330;
        // D s_4_3: cast zx s_4_2 -> i
        let s_4_3: i128 = (i128::try_from(s_4_2).unwrap());
        // D s_4_4: read-var result:bv
        let s_4_4: Bits = fn_state.result;
        // D s_4_5: read-var ga#256331:bv
        let s_4_5: Bits = fn_state.ga_256331;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var datasizeshadow#1435:i64
        let s_5_0: i64 = fn_state.datasizeshadow_1435;
