...
use u__set_SCTLR_EL2::*;
use Mk_SCTLR_EL1_Type::*;
use IsFeatureImplemented::*;
use X_read::*;
use NVMem_set::*;
use AArch64_SystemAccessTrap::*;
use u_get_HCR_EL2_Type_NV1::*;
use u__set_SCTLR_EL1::*;
use u_get_HCR_EL2_Type_TVM::*;
use u_get_HCR_EL2_Type_NV::*;
use u_get_HFGWTR_EL2_Type_SCTLR_EL1::*;
use EL2Enabled::*;
use Mk_SCTLR_EL2_Type::*;
use u_get_HCR_EL2_Type_NV2::*;
use common::*;
pub fn SCTLR_EL1_SysRegWrite_82243aef3ddea2c8<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_13: call _get_HFGWTR_EL2_Type_SCTLR_EL1(s_0_12)
        let s_0_13: bool = u_get_HFGWTR_EL2_Type_SCTLR_EL1(state, tracer, s_0_12);
        // D s_0_14: write-var __HFGWTR_EL2_SCTLR_EL1 <= s_0_13
        fn_state.u__HFGWTR_EL2_SCTLR_EL1 = s_0_13;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_SCTLR_EL1_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_SCTLR_EL1_Type(state, tracer, s_5_3);
        // D s_5_5: call __set_SCTLR_EL1(s_5_4)
        let s_5_5: () = u__set_SCTLR_EL1(state, tracer, s_5_4);
        // N s_5_6: return
        return;
    }
    fn block_6<T: Tracer>(
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: call Mk_SCTLR_EL1_Type(s_7_3)
        let s_7_4: ProductType5c790c8ef59cc8b2 = Mk_SCTLR_EL1_Type(state, tracer, s_7_3);
        // D s_7_5: call __set_SCTLR_EL1(s_7_4)
        let s_7_5: () = u__set_SCTLR_EL1(state, tracer, s_7_4);
        // N s_7_6: return
        return;
    }
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: call Mk_SCTLR_EL2_Type(s_8_3)
        let s_8_4: ProductType5c790c8ef59cc8b2 = Mk_SCTLR_EL2_Type(state, tracer, s_8_3);
        // D s_8_5: call __set_SCTLR_EL2(s_8_4)
        let s_8_5: () = u__set_SCTLR_EL2(state, tracer, s_8_4);
        // N s_8_6: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#91807 <= s_10_0
        fn_state.gs_91807 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#91807:u8
        let s_11_0: bool = fn_state.gs_91807;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#91808 <= s_13_0
        fn_state.gs_91808 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#91808:u8
        let s_14_0: bool = fn_state.gs_91808;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#91810 <= s_15_0
        fn_state.gs_91810 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#91810:u8
        let s_16_0: bool = fn_state.gs_91810;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#91811 <= s_17_0
        fn_state.gs_91811 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#91811:u8
        let s_18_0: bool = fn_state.gs_91811;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#91812 <= s_20_0
        fn_state.gs_91812 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#91812:u8
        let s_21_0: bool = fn_state.gs_91812;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_4: call Mk_SCTLR_EL1_Type(s_22_3)
        let s_22_4: ProductType5c790c8ef59cc8b2 = Mk_SCTLR_EL1_Type(
            state,
            tracer,
            s_22_3,
        );
        // D s_22_5: call __set_SCTLR_EL1(s_22_4)
        let s_22_5: () = u__set_SCTLR_EL1(state, tracer, s_22_4);
        // N s_22_6: return
        return;
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_35: write-var gs#91812 <= s_24_34
        fn_state.gs_91812 = s_24_34;
        // N s_24_36: jump b21
        return block_21(state, tracer, fn_state);
    }
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var __HFGWTR_EL2_SCTLR_EL1:u8
        let s_26_0: bool = fn_state.u__HFGWTR_EL2_SCTLR_EL1;
        ...
        // D s_26_5: write-var gs#91811 <= s_26_4
        fn_state.gs_91811 = s_26_4;
        // N s_26_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_5: write-var gs#91809 <= s_28_4
        fn_state.gs_91809 = s_28_4;
        // N s_28_6: jump b29
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_0: read-var gs#91809:u8
        let s_29_0: bool = fn_state.gs_91809;
        // D s_29_1: write-var gs#91810 <= s_29_0
        fn_state.gs_91810 = s_29_0;
        // N s_29_2: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_1: write-var gs#91809 <= s_30_0
        fn_state.gs_91809 = s_30_0;
        // N s_30_2: jump b29
        return block_29(state, tracer, fn_state);
    }
    fn block_31<T: Tracer>(
        ...
        // D s_31_2: write-var gs#91808 <= s_31_1
        fn_state.gs_91808 = s_31_1;
        // N s_31_3: jump b14
        return block_14(state, tracer, fn_state);
    }
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_5: write-var gs#91807 <= s_33_4
        fn_state.gs_91807 = s_33_4;
        // N s_33_6: jump b11
        return block_11(state, tracer, fn_state);
    }
