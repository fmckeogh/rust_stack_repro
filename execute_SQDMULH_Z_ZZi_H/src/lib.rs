...
use Z_set::*;
use common::*;
pub fn execute_SQDMULH_Z_ZZi_H<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#4146 <= s_0_2
        fn_state.VLshadow_4146 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#4146:i64
        let s_1_0: i64 = fn_state.VLshadow_4146;
        // D s_1_1: write-var VLshadow#4147 <= s_1_0
        fn_state.VLshadow_4147 = s_1_0;
        // D s_1_2: read-var VLshadow#4147:i64
        let s_1_2: i64 = fn_state.VLshadow_4147;
        ...
        // D s_1_14: read-var VLshadow#4147:i64
        let s_1_14: i64 = fn_state.VLshadow_4147;
        ...
        // D s_1_22: read-var VLshadow#4147:i64
        let s_1_22: i64 = fn_state.VLshadow_4147;
        ...
        // D s_1_35: write-var gs#217039 <= s_1_34
        fn_state.gs_217039 = s_1_34;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#217039:i64
        let s_2_1: i64 = fn_state.gs_217039;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_50: cast zx s_3_46 -> i
        let s_3_50: i128 = (i128::try_from(s_3_46).unwrap());
        ...
        // D s_3_53: lsr s_3_50 s_3_52
        let s_3_53: i128 = s_3_50 >> s_3_52;
        // D s_3_54: read-var esize:i64
        let s_3_54: i64 = fn_state.esize;
        ...
        // D s_3_58: call SignedSat(s_3_53, s_3_57)
        let s_3_58: Bits = SignedSat(state, tracer, s_3_53, s_3_57);
        ...
        // D s_3_62: cast zx s_3_49 -> i
        let s_3_62: i128 = (i128::try_from(s_3_49).unwrap());
        // D s_3_63: cast zx s_3_59 -> bv
        let s_3_63: Bits = Bits::new(s_3_59 as u128, 16u16);
        // D s_3_64: read-var result:bv
        let s_3_64: Bits = fn_state.result;
        // D s_3_65: call Elem_set(s_3_64, s_3_61, s_3_62, s_3_63)
        let s_3_65: Bits = Elem_set(state, tracer, s_3_64, s_3_61, s_3_62, s_3_63);
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#4147:i64
        let s_4_0: i64 = fn_state.VLshadow_4147;
