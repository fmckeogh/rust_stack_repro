...
use MemA_set::*;
use common::*;
pub fn execute_aarch32_instrs_STREXH_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    n: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_7: write-var ga#348069 <= s_0_6
        fn_state.ga_348069 = s_0_6;
        // N s_0_8: jump b1
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var ga#348069:u8
        let s_1_0: bool = fn_state.ga_348069;
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_12: Bits = Bits::new(s_3_10 as u128, 16u16);
