...
extern crate alloc;
use u_get_TTBR0_EL3_Type_CnP::*;
use HaveCommonNotPrivateTransExt::*;
use common::*;
pub fn AArch64_TLBContextEL3<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ss: u32,
    va: u64,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_2: call _get_TTBR0_EL3_Type_CnP(s_3_1)
        let s_3_2: bool = u_get_TTBR0_EL3_Type_CnP(state, tracer, s_3_1);
