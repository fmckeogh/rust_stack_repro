...
extern crate alloc;
use u__get_ICV_IAR1_EL1::*;
use Halted::*;
use u_get_SCR_EL3_Type_IRQ::*;
use AArch64_SystemAccessTrap::*;
use u__IMPDEF_boolean::*;
use u__get_ICC_IAR1_EL1::*;
use X_set::*;
...
use EL2Enabled::*;
use common::*;
pub fn ICV_IAR1_EL1_SysRegRead_e78579ad210f1e05<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ...
        gs_62669: bool,
        ga_69034: ProductType5c790c8ef59cc8b2,
        u__ICH_HCR_EL2_TALL1: bool,
        gs_62665: bool,
        gs_62666: bool,
        ga_69025: ProductType5c790c8ef59cc8b2,
        gs_62670: bool,
        gs_62678: bool,
        ga_69052: ProductType5c790c8ef59cc8b2,
        ...
        u__PSTATE_EL: u8,
        gs_62675: bool,
        ga_69058: ProductType5c790c8ef59cc8b2,
        gs_62671: bool,
        gs_62674: bool,
        gs_62663: bool,
        el: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_ICC_IAR1_EL1(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_ICC_IAR1_EL1(
            state,
            tracer,
            s_6_2,
        );
        // D s_6_4: write-var ga#69058 <= s_6_3
        fn_state.ga_69058 = s_6_3;
        // D s_6_5: read-var ga#69058.0:struct
        let s_6_5: u64 = fn_state.ga_69058._0;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#62663 <= s_9_0
        fn_state.gs_62663 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#62663:u8
        let s_10_0: bool = fn_state.gs_62663;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#62664 <= s_11_0
        fn_state.gs_62664 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#62664:u8
        let s_12_0: bool = fn_state.gs_62664;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#62665 <= s_13_0
        fn_state.gs_62665 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#62665:u8
        let s_14_0: bool = fn_state.gs_62665;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#62666 <= s_15_0
        fn_state.gs_62666 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#62666:u8
        let s_16_0: bool = fn_state.gs_62666;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#62667 <= s_19_0
        fn_state.gs_62667 = s_19_0;
        // N s_19_2: jump b20
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_0: read-var gs#62667:u8
        let s_20_0: bool = fn_state.gs_62667;
    ...
    fn block_21<T: Tracer>(
        ...
        let s_21_0: i64 = 64;
        // C s_21_1: const #23184u : u32
        let s_21_1: u32 = 23184;
        ...
        // D s_21_3: call __get_ICC_IAR1_EL1(s_21_2)
        let s_21_3: ProductType5c790c8ef59cc8b2 = u__get_ICC_IAR1_EL1(
            state,
            tracer,
            s_21_2,
        );
        // D s_21_4: write-var ga#69052 <= s_21_3
        fn_state.ga_69052 = s_21_3;
        // D s_21_5: read-var ga#69052.0:struct
        let s_21_5: u64 = fn_state.ga_69052._0;
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_1: write-var gs#62669 <= s_23_0
        fn_state.gs_62669 = s_23_0;
        // N s_23_2: jump b24
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_0: read-var gs#62669:u8
        let s_24_0: bool = fn_state.gs_62669;
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_5: write-var gs#62669 <= s_27_4
        fn_state.gs_62669 = s_27_4;
        // N s_27_6: jump b24
        return block_24(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_5: write-var gs#62667 <= s_28_4
        fn_state.gs_62667 = s_28_4;
        // N s_28_6: jump b20
        return block_20(state, tracer, fn_state);
    }
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_5: write-var gs#62666 <= s_31_4
        fn_state.gs_62666 = s_31_4;
        // N s_31_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_32<T: Tracer>(
        ...
        // D s_32_2: write-var gs#62665 <= s_32_1
        fn_state.gs_62665 = s_32_1;
        // N s_32_3: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_33<T: Tracer>(
        ...
        // D s_33_5: write-var gs#62664 <= s_33_4
        fn_state.gs_62664 = s_33_4;
        // N s_33_6: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_34<T: Tracer>(
        ...
        // D s_34_4: write-var gs#62663 <= s_34_3
        fn_state.gs_62663 = s_34_3;
        // N s_34_5: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_1: write-var gs#62670 <= s_36_0
        fn_state.gs_62670 = s_36_0;
        // N s_36_2: jump b37
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_0: read-var gs#62670:u8
        let s_37_0: bool = fn_state.gs_62670;
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_1: write-var gs#62671 <= s_38_0
        fn_state.gs_62671 = s_38_0;
        // N s_38_2: jump b39
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_0: read-var gs#62671:u8
        let s_39_0: bool = fn_state.gs_62671;
    ...
    fn block_40<T: Tracer>(
        ...
        // D s_40_1: write-var gs#62672 <= s_40_0
        fn_state.gs_62672 = s_40_0;
        // N s_40_2: jump b41
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_0: read-var gs#62672:u8
        let s_41_0: bool = fn_state.gs_62672;
    ...
    fn block_42<T: Tracer>(
        ...
        // D s_42_1: write-var gs#62673 <= s_42_0
        fn_state.gs_62673 = s_42_0;
        // N s_42_2: jump b43
    ...
    fn block_43<T: Tracer>(
        ...
        // D s_43_0: read-var gs#62673:u8
        let s_43_0: bool = fn_state.gs_62673;
    ...
    fn block_46<T: Tracer>(
        ...
        // D s_46_1: write-var gs#62674 <= s_46_0
        fn_state.gs_62674 = s_46_0;
        // N s_46_2: jump b47
    ...
    fn block_47<T: Tracer>(
        ...
        // D s_47_0: read-var gs#62674:u8
        let s_47_0: bool = fn_state.gs_62674;
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_1: write-var gs#62675 <= s_49_0
        fn_state.gs_62675 = s_49_0;
        // N s_49_2: jump b50
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_0: read-var gs#62675:u8
        let s_50_0: bool = fn_state.gs_62675;
    ...
    fn block_52<T: Tracer>(
        ...
        // D s_52_1: write-var gs#62676 <= s_52_0
        fn_state.gs_62676 = s_52_0;
        // N s_52_2: jump b53
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_0: read-var gs#62676:u8
        let s_53_0: bool = fn_state.gs_62676;
    ...
    fn block_54<T: Tracer>(
        ...
        let s_54_0: i64 = 64;
        // C s_54_1: const #23184u : u32
        let s_54_1: u32 = 23184;
        ...
        // D s_54_3: call __get_ICC_IAR1_EL1(s_54_2)
        let s_54_3: ProductType5c790c8ef59cc8b2 = u__get_ICC_IAR1_EL1(
            state,
            tracer,
            s_54_2,
        );
        // D s_54_4: write-var ga#69034 <= s_54_3
        fn_state.ga_69034 = s_54_3;
        // D s_54_5: read-var ga#69034.0:struct
        let s_54_5: u64 = fn_state.ga_69034._0;
    ...
    fn block_56<T: Tracer>(
        ...
        // D s_56_1: write-var gs#62678 <= s_56_0
        fn_state.gs_62678 = s_56_0;
        // N s_56_2: jump b57
    ...
    fn block_57<T: Tracer>(
        ...
        // D s_57_0: read-var gs#62678:u8
        let s_57_0: bool = fn_state.gs_62678;
    ...
    fn block_60<T: Tracer>(
        ...
        // D s_60_5: write-var gs#62678 <= s_60_4
        fn_state.gs_62678 = s_60_4;
        // N s_60_6: jump b57
        return block_57(state, tracer, fn_state);
    }
    fn block_61<T: Tracer>(
        ...
        // D s_61_5: write-var gs#62676 <= s_61_4
        fn_state.gs_62676 = s_61_4;
        // N s_61_6: jump b53
        return block_53(state, tracer, fn_state);
    }
    fn block_62<T: Tracer>(
        ...
        let s_62_0: i64 = 64;
        // C s_62_1: const #91048u : u32
        let s_62_1: u32 = 91048;
        ...
        // D s_62_3: call __get_ICV_IAR1_EL1(s_62_2)
        let s_62_3: ProductType5c790c8ef59cc8b2 = u__get_ICV_IAR1_EL1(
            state,
            tracer,
            s_62_2,
        );
        // D s_62_4: write-var ga#69025 <= s_62_3
        fn_state.ga_69025 = s_62_3;
        // D s_62_5: read-var ga#69025.0:struct
        let s_62_5: u64 = fn_state.ga_69025._0;
    ...
    fn block_63<T: Tracer>(
        ...
        // D s_63_5: write-var gs#62675 <= s_63_4
        fn_state.gs_62675 = s_63_4;
        // N s_63_6: jump b50
        return block_50(state, tracer, fn_state);
    }
    ...
    fn block_65<T: Tracer>(
        ...
        // D s_65_5: write-var gs#62674 <= s_65_4
        fn_state.gs_62674 = s_65_4;
        // N s_65_6: jump b47
        return block_47(state, tracer, fn_state);
    }
    ...
    fn block_68<T: Tracer>(
        ...
        // D s_68_5: write-var gs#62673 <= s_68_4
        fn_state.gs_62673 = s_68_4;
        // N s_68_6: jump b43
        return block_43(state, tracer, fn_state);
    }
    fn block_69<T: Tracer>(
        ...
        // D s_69_2: write-var gs#62672 <= s_69_1
        fn_state.gs_62672 = s_69_1;
        // N s_69_3: jump b41
        return block_41(state, tracer, fn_state);
    }
    fn block_70<T: Tracer>(
        ...
        // D s_70_5: write-var gs#62671 <= s_70_4
        fn_state.gs_62671 = s_70_4;
        // N s_70_6: jump b39
        return block_39(state, tracer, fn_state);
    }
    fn block_71<T: Tracer>(
        ...
        // D s_71_4: write-var gs#62670 <= s_71_3
        fn_state.gs_62670 = s_71_3;
        // N s_71_5: jump b37
        return block_37(state, tracer, fn_state);
    }
