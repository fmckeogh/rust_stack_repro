...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_VRSUBHN_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_VRSUBHN_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    size: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_22: write-var gs#318655 <= s_4_21
        fn_state.gs_318655 = s_4_21;
        // N s_4_23: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#318655:u8
        let s_5_0: bool = fn_state.gs_318655;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_61: call execute_aarch32_instrs_VRSUBHN_Op_A_txt(s_6_25, s_6_60, s_6_59, s_6_57, s_6_41)
        let s_6_61: () = execute_aarch32_instrs_VRSUBHN_Op_A_txt(
            state,
            tracer,
            s_6_25,
            s_6_60,
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #1u : u8
        let s_8_0: bool = true;
        // D s_8_1: write-var gs#318655 <= s_8_0
        fn_state.gs_318655 = s_8_0;
        // N s_8_2: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
