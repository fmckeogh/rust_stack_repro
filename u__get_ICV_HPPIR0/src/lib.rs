...
use common::*;
pub fn u__get_ICV_HPPIR0<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4278190080u : u32
        let s_0_3: u32 = 4278190080;
        ...
        // D s_0_11: tail-call Mk_ICV_HPPIR0_Type(s_0_10)
        return Mk_ICV_HPPIR0_Type(state, tracer, s_0_10);
    }
}
