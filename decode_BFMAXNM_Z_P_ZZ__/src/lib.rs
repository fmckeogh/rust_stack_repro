...
extern crate alloc;
use execute_BFMAXNM_Z_P_ZZ__::*;
use CurrentVL_read::*;
use HaveSVEB16B16::*;
use common::*;
pub fn decode_BFMAXNM_Z_P_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Pg: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_4: call execute_BFMAXNM_Z_P_ZZ__(s_2_0, s_2_1, s_2_2, s_2_3)
        let s_2_4: () = execute_BFMAXNM_Z_P_ZZ__(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: call execute_BFMAXNM_Z_P_ZZ__(s_4_0, s_4_1, s_4_2, s_4_3)
        let s_4_4: () = execute_BFMAXNM_Z_P_ZZ__(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call execute_BFMAXNM_Z_P_ZZ__(s_6_0, s_6_1, s_6_2, s_6_3)
        let s_6_4: () = execute_BFMAXNM_Z_P_ZZ__(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: call execute_BFMAXNM_Z_P_ZZ__(s_8_0, s_8_1, s_8_2, s_8_3)
        let s_8_4: () = execute_BFMAXNM_Z_P_ZZ__(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: call execute_BFMAXNM_Z_P_ZZ__(s_10_0, s_10_1, s_10_2, s_10_3)
        let s_10_4: () = execute_BFMAXNM_Z_P_ZZ__(
            state,
            tracer,
            s_10_0,
            s_10_1,
