...
use Qin_read::*;
use common::*;
pub fn execute_aarch32_instrs_VRSUBHN_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d__arg: i64,
    elements: i128,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#7791 <= s_0_2
        fn_state.esizeshadow_7791 = s_0_2;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_5: write-var gs#318639 <= s_1_4
        fn_state.gs_318639 = s_1_4;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#318639:i64
        let s_2_1: i64 = fn_state.gs_318639;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_5: const #2s : i
        let s_3_5: i128 = 2;
        // D s_3_6: read-var esizeshadow#7791:i64
        let s_3_6: i64 = fn_state.esizeshadow_7791;
        ...
        // C s_3_22: const #2s : i
        let s_3_22: i128 = 2;
        // D s_3_23: read-var esizeshadow#7791:i64
        let s_3_23: i64 = fn_state.esizeshadow_7791;
        ...
        // D s_3_34: sub s_3_16 s_3_33
        let s_3_34: Bits = ((s_3_16) - (s_3_33));
        // D s_3_35: cast zx s_3_34 -> i
        let s_3_35: i128 = (s_3_34.value() as i128);
        // D s_3_36: read-var esizeshadow#7791:i64
        let s_3_36: i64 = fn_state.esizeshadow_7791;
        // D s_3_37: cast zx s_3_36 -> i
        let s_3_37: i128 = (i128::try_from(s_3_36).unwrap());
        // C s_3_38: const #1u : u8
        let s_3_38: bool = true;
        // D s_3_39: call RShr(s_3_35, s_3_37, s_3_38)
        let s_3_39: i128 = RShr(state, tracer, s_3_35, s_3_37, s_3_38);
        // D s_3_40: read-var d:i
        let s_3_40: i128 = fn_state.d;
        // D s_3_41: call D_read(s_3_40)
        let s_3_41: u64 = D_read(state, tracer, s_3_40);
        // D s_3_42: read-var esizeshadow#7791:i64
        let s_3_42: i64 = fn_state.esizeshadow_7791;
        ...
        // C s_3_45: const #1s : i
        let s_3_45: i128 = 1;
        // D s_3_46: read-var esizeshadow#7791:i64
        let s_3_46: i64 = fn_state.esizeshadow_7791;
        // D s_3_47: cast zx s_3_46 -> i
        let s_3_47: i128 = (i128::try_from(s_3_46).unwrap());
        // D s_3_48: sub s_3_47 s_3_45
        let s_3_48: i128 = ((s_3_47) - (s_3_45));
        ...
        // D s_3_52: call integer_subrange(s_3_39, s_3_51, s_3_50)
        let s_3_52: Bits = integer_subrange(state, tracer, s_3_39, s_3_51, s_3_50);
        // D s_3_53: cast zx s_3_41 -> bv
        let s_3_53: Bits = Bits::new(s_3_41 as u128, 64u16);
        // D s_3_54: read-var e:i64
        let s_3_54: i64 = fn_state.e;
        // D s_3_55: cast zx s_3_54 -> i
        let s_3_55: i128 = (i128::try_from(s_3_54).unwrap());
        // D s_3_56: cast zx s_3_44 -> i
        let s_3_56: i128 = (i128::try_from(s_3_44).unwrap());
        // D s_3_57: call Elem_set(s_3_53, s_3_55, s_3_56, s_3_52)
        let s_3_57: Bits = Elem_set(state, tracer, s_3_53, s_3_55, s_3_56, s_3_52);
        // D s_3_58: cast reint s_3_57 -> u64
        let s_3_58: u64 = (s_3_57.value() as u64);
        // D s_3_59: read-var d:i
        let s_3_59: i128 = fn_state.d;
        // D s_3_60: call D_set(s_3_59, s_3_58)
        let s_3_60: () = D_set(state, tracer, s_3_59, s_3_58);
