...
use A32ExpandImm::*;
use common::*;
pub fn decode_aarch32_instrs_SUB_i_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    S: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#303146 <= s_3_0
        fn_state.gs_303146 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#303146:u8
        let s_4_0: bool = fn_state.gs_303146;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_15: call execute_aarch32_instrs_SUB_i_Op_A_txt(s_6_3, s_6_14, s_6_7, s_6_12)
        let s_6_15: () = execute_aarch32_instrs_SUB_i_Op_A_txt(
            state,
            tracer,
            s_6_3,
            s_6_14,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_5: write-var gs#303146 <= s_9_4
        fn_state.gs_303146 = s_9_4;
        // N s_9_6: jump b4
        return block_4(state, tracer, fn_state);
    }
}
