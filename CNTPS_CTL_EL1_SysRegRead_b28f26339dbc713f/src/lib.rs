...
use u__get_CNTPS_CTL_EL1::*;
use u_get_SCR_EL3_Type_NS::*;
use AArch64_SystemAccessTrap::*;
use common::*;
pub fn CNTPS_CTL_EL1_SysRegRead_b28f26339dbc713f<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_56477: ProductType5c790c8ef59cc8b2,
        gs_58014: bool,
        u__SCR_EL3_NS: bool,
        u__PSTATE_EL: u8,
        u__SCR_EL3_ST: bool,
        ga_56470: ProductType5c790c8ef59cc8b2,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call __get_CNTPS_CTL_EL1(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_CNTPS_CTL_EL1(
            state,
            tracer,
            s_5_2,
        );
        // D s_5_4: write-var ga#56477 <= s_5_3
        fn_state.ga_56477 = s_5_3;
        // D s_5_5: read-var ga#56477.0:struct
        let s_5_5: u64 = fn_state.ga_56477._0;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#58014 <= s_8_0
        fn_state.gs_58014 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#58014:u8
        let s_9_0: bool = fn_state.gs_58014;
    ...
    fn block_11<T: Tracer>(
        ...
        // N s_11_5: branch s_11_4 b15 b12
        if s_11_4 {
    ...
    fn block_13<T: Tracer>(
        ...
        let s_13_0: i64 = 64;
        // C s_13_1: const #20376u : u32
        let s_13_1: u32 = 20376;
        ...
        // D s_13_3: call __get_CNTPS_CTL_EL1(s_13_2)
        let s_13_3: ProductType5c790c8ef59cc8b2 = u__get_CNTPS_CTL_EL1(
            state,
            tracer,
            s_13_2,
        );
        // D s_13_4: write-var ga#56470 <= s_13_3
        fn_state.ga_56470 = s_13_3;
        // D s_13_5: read-var ga#56470.0:struct
        let s_13_5: u64 = fn_state.ga_56470._0;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var __SCR_EL3_NS:u8
        let s_16_0: bool = fn_state.u__SCR_EL3_NS;
        ...
        // D s_16_5: write-var gs#58014 <= s_16_4
        fn_state.gs_58014 = s_16_4;
        // N s_16_6: jump b9
        return block_9(state, tracer, fn_state);
    }
