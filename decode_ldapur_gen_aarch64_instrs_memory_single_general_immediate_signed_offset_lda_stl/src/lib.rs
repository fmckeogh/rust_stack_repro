...
extern crate alloc;
use neq_int::*;
use execute_aarch64_instrs_memory_single_general_immediate_signed_offset_lda_stl::*;
use common::*;
pub fn decode_ldapur_gen_aarch64_instrs_memory_single_general_immediate_signed_offset_lda_stl<
    T: Tracer,
>(state: &mut State, tracer: &T, Rt: u8, Rn: u8, imm9: u16, opc: u8, size: u8) -> () {
    #[derive(Default)]
    struct FunctionState {
        t: i64,
        regsizeshadow_1611: i64,
        n: i64,
        memop: u32,
        gs_158688: bool,
        regsize: i64,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#158669 <= s_3_0
        fn_state.gs_158669 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#158669:u8
        let s_4_0: bool = fn_state.gs_158669;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var regsizeshadow#1611 <= s_8_0
        fn_state.regsizeshadow_1611 = s_8_0;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#158688 <= s_9_0
        fn_state.gs_158688 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#158688:u8
        let s_10_0: bool = fn_state.gs_158688;
        ...
        // D s_10_4: read-var regsizeshadow#1611:i64
        let s_10_4: i64 = fn_state.regsizeshadow_1611;
        ...
        // D s_10_9: read-var offset:u64
        let s_10_9: u64 = fn_state.offset;
        // C s_10_10: const #0u : u8
        let s_10_10: bool = false;
        // C s_10_11: const #0u : u8
        let s_10_11: bool = false;
        // D s_10_12: read-var is_signed:u8
        let s_10_12: bool = fn_state.is_signed;
        // D s_10_13: read-var t:i64
        let s_10_13: i64 = fn_state.t;
        // C s_10_14: const #0u : u8
        let s_10_14: bool = false;
        // C s_10_15: const #0u : u8
        let s_10_15: bool = false;
        // D s_10_16: call execute_aarch64_instrs_memory_single_general_immediate_signed_offset_lda_stl(s_10_3, s_10_7, s_10_8, s_10_9, s_10_10, s_10_6, s_10_11, s_10_12, s_10_13, s_10_0, s_10_14, s_10_15)
        let s_10_16: () = execute_aarch64_instrs_memory_single_general_immediate_signed_offset_lda_stl(
            state,
            tracer,
            s_10_3,
            s_10_7,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_4: write-var gs#158688 <= s_11_3
        fn_state.gs_158688 = s_11_3;
        // N s_11_5: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_22: write-var gs#158669 <= s_14_21
        fn_state.gs_158669 = s_14_21;
        // N s_14_23: jump b4
        return block_4(state, tracer, fn_state);
    }
