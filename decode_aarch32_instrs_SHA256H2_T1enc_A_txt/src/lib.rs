...
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_SHA256H2_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Vn: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_22: write-var gs#324684 <= s_6_21
        fn_state.gs_324684 = s_6_21;
        // N s_6_23: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#324684:u8
        let s_7_0: bool = fn_state.gs_324684;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_22: write-var gs#324687 <= s_8_21
        fn_state.gs_324687 = s_8_21;
        // N s_8_23: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#324687:u8
        let s_9_0: bool = fn_state.gs_324687;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_48: call execute_aarch32_instrs_SHA256H2_Op_A_txt(s_10_15, s_10_47, s_10_31)
        let s_10_48: () = execute_aarch32_instrs_SHA256H2_Op_A_txt(
            state,
            tracer,
            s_10_15,
            s_10_47,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#324687 <= s_12_0
        fn_state.gs_324687 = s_12_0;
        // N s_12_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#324684 <= s_13_0
        fn_state.gs_324684 = s_13_0;
        // N s_13_2: jump b7
        return block_7(state, tracer, fn_state);
    }
