...
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_unary_special_recip_fp16_sisd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    datasize: i64,
    ...
    struct FunctionState {
        ...
        e: i64,
        esizeshadow_1422: i64,
        gs_153899: bool,
        gs_153905: i64,
        datasizeshadow_1423: i64,
        result: u128,
        ga_256082: Bits,
        ga_256081: i64,
        d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#1422 <= s_0_2
        fn_state.esizeshadow_1422 = s_0_2;
        ...
        // D s_0_7: write-var datasizeshadow#1423 <= s_0_6
        fn_state.datasizeshadow_1423 = s_0_6;
        // C s_0_8: const #1s : i
        let s_0_8: i128 = 1;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var datasizeshadow#1423:i64
        let s_2_0: i64 = fn_state.datasizeshadow_1423;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#153899 <= s_3_0
        fn_state.gs_153899 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#153899:u8
        let s_4_0: bool = fn_state.gs_153899;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: write-var gs#153905 <= s_6_4
        fn_state.gs_153905 = s_6_4;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: read-var gs#153905:i64
        let s_7_1: i64 = fn_state.gs_153905;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var esizeshadow#1422:i64
        let s_8_0: i64 = fn_state.esizeshadow_1422;
        ...
        // D s_8_8: read-var esizeshadow#1422:i64
        let s_8_8: i64 = fn_state.esizeshadow_1422;
        // D s_8_9: cast zx s_8_8 -> i
        let s_8_9: i128 = (i128::try_from(s_8_8).unwrap());
        // D s_8_10: cast reint s_8_9 -> i64
        let s_8_10: i64 = (s_8_9 as i64);
        // D s_8_11: write-var ga#256081 <= s_8_10
        fn_state.ga_256081 = s_8_10;
        // C s_8_12: const #() : ()
        let s_8_12: () = ();
        // S s_8_13: call FPCR_read(s_8_12)
        let s_8_13: ProductType5c790c8ef59cc8b2 = FPCR_read(state, tracer, s_8_12);
        // D s_8_14: call FPRecipEstimate(s_8_7, s_8_13)
        let s_8_14: Bits = FPRecipEstimate(state, tracer, s_8_7, s_8_13);
        // D s_8_15: write-var ga#256082 <= s_8_14
        fn_state.ga_256082 = s_8_14;
        // N s_8_16: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: read-var ga#256081:i64
        let s_9_4: i64 = fn_state.ga_256081;
        // D s_9_5: cast zx s_9_4 -> i
        let s_9_5: i128 = (i128::try_from(s_9_4).unwrap());
        // D s_9_6: read-var ga#256082:bv
        let s_9_6: Bits = fn_state.ga_256082;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_2: write-var gs#153899 <= s_12_1
        fn_state.gs_153899 = s_12_1;
        // N s_12_3: jump b4
        return block_4(state, tracer, fn_state);
    }
