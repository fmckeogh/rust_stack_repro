...
use X_read::*;
use common::*;
pub fn AMCNTENCLR0_EL0_SysRegWrite_87e21241643a862e<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_4: call Mk_AMCNTENCLR0_EL0_Type(s_2_3)
        let s_2_4: ProductType5c790c8ef59cc8b2 = Mk_AMCNTENCLR0_EL0_Type(
            state,
            tracer,
            s_2_3,
        );
        // C s_2_5: const #22792u : u32
        let s_2_5: u32 = 22792;
