...
use MemA_set::*;
use common::*;
pub fn execute_aarch32_instrs_STREXD_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    n: i64,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_3: write-var ga#348030 <= s_2_2
        fn_state.ga_348030 = s_2_2;
        // N s_2_4: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#348030:u8
        let s_3_0: bool = fn_state.ga_348030;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: read-var address:u32
        let s_5_3: u32 = fn_state.address;
        // D s_5_4: call MemA_set(s_5_3, s_5_0, s_5_2)
        let s_5_4: () = MemA_set(state, tracer, s_5_3, s_5_0, s_5_2);
        // N s_5_5: jump b6
