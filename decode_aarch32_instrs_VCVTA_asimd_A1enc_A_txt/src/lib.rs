...
use FPDecodeRM::*;
use common::*;
pub fn decode_aarch32_instrs_VCVTA_asimd_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    size: u8,
    ...
    struct FunctionState {
        m: i64,
        esize: i64,
        elementsshadow_7915: i64,
        gs_325094: bool,
        d: i64,
        esizeshadow_7914: i64,
        ga_365664: i64,
        is_unsigned: bool,
        elements: i64,
        gs_325095: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#325095 <= s_1_0
        fn_state.gs_325095 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#325095:u8
        let s_2_0: bool = fn_state.gs_325095;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_5: write-var gs#325096 <= s_4_4
        fn_state.gs_325096 = s_4_4;
        // N s_4_6: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#325096:u8
        let s_5_0: bool = fn_state.gs_325096;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_9: const #16s : i64
        let s_6_9: i64 = 16;
        // D s_6_10: write-var esize <= s_6_9
        fn_state.esize = s_6_9;
        // C s_6_11: const #2s : i64
        let s_6_11: i64 = 2;
        // D s_6_12: write-var elements <= s_6_11
        fn_state.elements = s_6_11;
        // D s_6_13: read-var size:u8
        let s_6_13: u8 = fn_state.size;
        // D s_6_14: cast zx s_6_13 -> bv
        let s_6_14: Bits = Bits::new(s_6_13 as u128, 2u16);
        // C s_6_15: const #1u : u8
        let s_6_15: u8 = 1;
        // C s_6_16: cast zx s_6_15 -> bv
        let s_6_16: Bits = Bits::new(s_6_15 as u128, 2u16);
        // D s_6_17: cmp-eq s_6_14 s_6_16
        let s_6_17: bool = ((s_6_14) == (s_6_16));
        // D s_6_18: not s_6_17
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var esizeshadow#7914 <= s_8_0
        fn_state.esizeshadow_7914 = s_8_0;
        // D s_8_2: read-var elements:i64
        let s_8_2: i64 = fn_state.elements;
        // D s_8_3: write-var elementsshadow#7915 <= s_8_2
        fn_state.elementsshadow_7915 = s_8_2;
    ...
    fn block_9<T: Tracer>(
        ...
        let s_9_0: i64 = 2;
        // D s_9_1: write-var ga#365664 <= s_9_0
        fn_state.ga_365664 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var ga#365664:i64
        let s_10_0: i64 = fn_state.ga_365664;
        // D s_10_1: read-var esizeshadow#7914:i64
        let s_10_1: i64 = fn_state.esizeshadow_7914;
        ...
        // D s_10_5: read-var elementsshadow#7915:i64
        let s_10_5: i64 = fn_state.elementsshadow_7915;
        // D s_10_6: read-var m:i64
        let s_10_6: i64 = fn_state.m;
        // D s_10_7: read-var rounding:u32
        let s_10_7: u32 = fn_state.rounding;
        // D s_10_8: read-var is_unsigned:u8
        let s_10_8: bool = fn_state.is_unsigned;
        // D s_10_9: call execute_aarch32_instrs_VCVTA_asimd_Op_A_txt(s_10_4, s_10_5, s_10_3, s_10_6, s_10_0, s_10_7, s_10_8)
        let s_10_9: () = execute_aarch32_instrs_VCVTA_asimd_Op_A_txt(
            state,
            tracer,
            s_10_4,
            s_10_5,
    ...
    fn block_11<T: Tracer>(
        ...
        let s_11_0: i64 = 1;
        // D s_11_1: write-var ga#365664 <= s_11_0
        fn_state.ga_365664 = s_11_0;
        // N s_11_2: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#325096 <= s_16_0
        fn_state.gs_325096 = s_16_0;
        // N s_16_2: jump b5
        return block_5(state, tracer, fn_state);
    }
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_22: write-var gs#325094 <= s_19_21
        fn_state.gs_325094 = s_19_21;
        // N s_19_23: jump b20
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_0: read-var gs#325094:u8
        let s_20_0: bool = fn_state.gs_325094;
        // D s_20_1: write-var gs#325095 <= s_20_0
        fn_state.gs_325095 = s_20_0;
        // N s_20_2: jump b2
        return block_2(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#325094 <= s_21_0
        fn_state.gs_325094 = s_21_0;
        // N s_21_2: jump b20
        return block_20(state, tracer, fn_state);
    }
}
