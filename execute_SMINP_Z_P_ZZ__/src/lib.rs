...
use Z_set::*;
use common::*;
pub fn execute_SMINP_Z_P_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    dn: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#3387 <= s_0_2
        fn_state.esizeshadow_3387 = s_0_2;
        ...
        // D s_0_7: write-var VLshadow#3388 <= s_0_6
        fn_state.VLshadow_3388 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#3388:i64
        let s_1_0: i64 = fn_state.VLshadow_3388;
        // D s_1_1: write-var VLshadow#3389 <= s_1_0
        fn_state.VLshadow_3389 = s_1_0;
        // C s_1_2: const #8s : i
        let s_1_2: i128 = 8;
        // D s_1_3: read-var VLshadow#3389:i64
        let s_1_3: i64 = fn_state.VLshadow_3389;
        ...
        // D s_1_7: read-var VLshadow#3389:i64
        let s_1_7: i64 = fn_state.VLshadow_3389;
        // D s_1_8: cast zx s_1_7 -> i
        let s_1_8: i128 = (i128::try_from(s_1_7).unwrap());
        // D s_1_9: read-var esizeshadow#3387:i64
        let s_1_9: i64 = fn_state.esizeshadow_3387;
        ...
        // D s_1_21: read-var VLshadow#3389:i64
        let s_1_21: i64 = fn_state.VLshadow_3389;
        ...
        // D s_1_29: read-var esizeshadow#3387:i64
        let s_1_29: i64 = fn_state.esizeshadow_3387;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var VLshadow#3389:i64
        let s_2_0: i64 = fn_state.VLshadow_3389;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_6: write-var gs#203253 <= s_3_5
        fn_state.gs_203253 = s_3_5;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#203253:i64
        let s_4_1: i64 = fn_state.gs_203253;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_2: read-var esizeshadow#3387:i64
        let s_5_2: i64 = fn_state.esizeshadow_3387;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_5: read-var esizeshadow#3387:i64
        let s_7_5: i64 = fn_state.esizeshadow_3387;
        ...
        // D s_7_12: cast sx s_7_11 -> i
        let s_7_12: i128 = {
            let sign_bit = s_7_11.length() - 1;
            let mut result = s_7_11.value() as i128;
        ...
        // D s_7_19: read-var esizeshadow#3387:i64
        let s_7_19: i64 = fn_state.esizeshadow_3387;
        ...
        // D s_7_26: cast sx s_7_25 -> i
        let s_7_26: i128 = {
            let sign_bit = s_7_25.length() - 1;
            let mut result = s_7_25.value() as i128;
            if ((result >> sign_bit) & 1) == 1 {
                let cleared_bit = result & !(1 << sign_bit);
                result = cleared_bit - (1 << sign_bit);
            }
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: read-var esizeshadow#3387:i64
        let s_8_4: i64 = fn_state.esizeshadow_3387;
        ...
        // C s_8_7: const #1s : i
        let s_8_7: i128 = 1;
        // D s_8_8: read-var esizeshadow#3387:i64
        let s_8_8: i64 = fn_state.esizeshadow_3387;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: read-var esizeshadow#3387:i64
        let s_10_5: i64 = fn_state.esizeshadow_3387;
        ...
        // D s_10_12: cast sx s_10_11 -> i
        let s_10_12: i128 = {
            let sign_bit = s_10_11.length() - 1;
            let mut result = s_10_11.value() as i128;
            if ((result >> sign_bit) & 1) == 1 {
                let cleared_bit = result & !(1 << sign_bit);
                result = cleared_bit - (1 << sign_bit);
            }
        ...
        // D s_10_19: read-var esizeshadow#3387:i64
        let s_10_19: i64 = fn_state.esizeshadow_3387;
        ...
        // D s_10_26: cast sx s_10_25 -> i
        let s_10_26: i128 = {
            let sign_bit = s_10_25.length() - 1;
            let mut result = s_10_25.value() as i128;
            if ((result >> sign_bit) & 1) == 1 {
                let cleared_bit = result & !(1 << sign_bit);
                result = cleared_bit - (1 << sign_bit);
            }
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var esizeshadow#3387:i64
        let s_11_0: i64 = fn_state.esizeshadow_3387;
        // D s_11_1: cast zx s_11_0 -> i
        let s_11_1: i128 = (i128::try_from(s_11_0).unwrap());
        // D s_11_2: cast reint s_11_1 -> i64
        let s_11_2: i64 = (s_11_1 as i64);
        // D s_11_3: read-var esizeshadow#3387:i64
        let s_11_3: i64 = fn_state.esizeshadow_3387;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var VLshadow#3389:i64
        let s_12_0: i64 = fn_state.VLshadow_3389;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var VLshadow#3389:i64
        let s_13_0: i64 = fn_state.VLshadow_3389;
