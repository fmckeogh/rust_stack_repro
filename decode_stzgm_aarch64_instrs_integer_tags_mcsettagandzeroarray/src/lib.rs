...
extern crate alloc;
use execute_aarch64_instrs_integer_tags_mcsettagandzeroarray::*;
use HaveMTE2Ext::*;
use common::*;
pub fn decode_stzgm_aarch64_instrs_integer_tags_mcsettagandzeroarray<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Xt: u8,
    Xn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_8: call execute_aarch64_instrs_integer_tags_mcsettagandzeroarray(s_1_7, s_1_3)
        let s_1_8: () = execute_aarch64_instrs_integer_tags_mcsettagandzeroarray(
            state,
            tracer,
            s_1_7,
            s_1_3,
