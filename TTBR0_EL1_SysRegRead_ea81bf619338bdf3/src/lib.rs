...
use common::*;
pub fn TTBR0_EL1_SysRegRead_ea81bf619338bdf3<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ...
        u__HCR_EL2_E2H: bool,
        ga_99681: u64,
        ga_99689: ProductType782ac6922b48c20d,
        ga_99700: ProductType782ac6922b48c20d,
        u__PSTATE_EL: u8,
        gs_74448: bool,
        u__HCR_EL2_NV: bool,
        gs_74441: bool,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#74440 <= s_6_0
        fn_state.gs_74440 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#74440:u8
        let s_7_0: bool = fn_state.gs_74440;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#74441 <= s_8_0
        fn_state.gs_74441 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#74441:u8
        let s_9_0: bool = fn_state.gs_74441;
    ...
    fn block_11<T: Tracer>(
        ...
        // C s_11_1: const #() : ()
        let s_11_1: () = ();
        // S s_11_2: call TTBR0_EL1_read(s_11_1)
        let s_11_2: ProductType782ac6922b48c20d = TTBR0_EL1_read(state, tracer, s_11_1);
        // S s_11_3: call __get_TTBR0_EL1(s_11_2)
        let s_11_3: ProductType782ac6922b48c20d = u__get_TTBR0_EL1(
            state,
            tracer,
            s_11_2,
        );
        // D s_11_4: write-var ga#99700 <= s_11_3
        fn_state.ga_99700 = s_11_3;
        // D s_11_5: read-var ga#99700.0:struct
        let s_11_5: u128 = fn_state.ga_99700._0;
        // C s_11_6: const #0s : i
        let s_11_6: i128 = 0;
        // D s_11_7: cast zx s_11_5 -> bv
        let s_11_7: Bits = Bits::new(s_11_5 as u128, 128u16);
        // C s_11_8: const #1s : i64
        let s_11_8: i64 = 1;
        // C s_11_9: cast zx s_11_8 -> i
        let s_11_9: i128 = (i128::try_from(s_11_8).unwrap());
        // C s_11_10: const #63s : i
        let s_11_10: i128 = 63;
        ...
        let s_11_14: Bits = Bits::new(s_11_13 as u128, 64u16);
        // D s_11_15: read-var t:i
        let s_11_15: i128 = fn_state.t;
        // D s_11_16: call X_set(s_11_15, s_11_0, s_11_14)
        let s_11_16: () = X_set(state, tracer, s_11_15, s_11_0, s_11_14);
        // N s_11_17: return
        return;
    }
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#74441 <= s_12_4
        fn_state.gs_74441 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_4: write-var gs#74440 <= s_13_3
        fn_state.gs_74440 = s_13_3;
        // N s_13_5: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_16<T: Tracer>(
        ...
        // C s_16_1: const #() : ()
        let s_16_1: () = ();
        // S s_16_2: call TTBR0_EL1_read(s_16_1)
        let s_16_2: ProductType782ac6922b48c20d = TTBR0_EL1_read(state, tracer, s_16_1);
        // S s_16_3: call __get_TTBR0_EL1(s_16_2)
        let s_16_3: ProductType782ac6922b48c20d = u__get_TTBR0_EL1(
            state,
            tracer,
            s_16_2,
        );
        // D s_16_4: write-var ga#99689 <= s_16_3
        fn_state.ga_99689 = s_16_3;
        // D s_16_5: read-var ga#99689.0:struct
        let s_16_5: u128 = fn_state.ga_99689._0;
        // C s_16_6: const #0s : i
        let s_16_6: i128 = 0;
        // D s_16_7: cast zx s_16_5 -> bv
        let s_16_7: Bits = Bits::new(s_16_5 as u128, 128u16);
        // C s_16_8: const #1s : i64
        let s_16_8: i64 = 1;
        // C s_16_9: cast zx s_16_8 -> i
        let s_16_9: i128 = (i128::try_from(s_16_8).unwrap());
        // C s_16_10: const #63s : i
        let s_16_10: i128 = 63;
        // C s_16_11: add s_16_10 s_16_9
        let s_16_11: i128 = (s_16_10 + s_16_9);
        // D s_16_12: bit-extract s_16_7 s_16_6 s_16_11
        let s_16_12: Bits = (Bits::new(
            ((s_16_7) >> (s_16_6)).value(),
            u16::try_from(s_16_11).unwrap(),
        ));
        // D s_16_13: cast reint s_16_12 -> u64
        let s_16_13: u64 = (s_16_12.value() as u64);
        // D s_16_14: cast zx s_16_13 -> bv
        let s_16_14: Bits = Bits::new(s_16_13 as u128, 64u16);
        // D s_16_15: read-var t:i
        let s_16_15: i128 = fn_state.t;
        // D s_16_16: call X_set(s_16_15, s_16_0, s_16_14)
        let s_16_16: () = X_set(state, tracer, s_16_15, s_16_0, s_16_14);
        // N s_16_17: return
        return;
    }
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#74448 <= s_18_0
        fn_state.gs_74448 = s_18_0;
        // N s_18_2: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#74448:u8
        let s_19_0: bool = fn_state.gs_74448;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#74449 <= s_21_0
        fn_state.gs_74449 = s_21_0;
        // N s_21_2: jump b22
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_0: read-var gs#74449:u8
        let s_22_0: bool = fn_state.gs_74449;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_5: write-var gs#74449 <= s_25_4
        fn_state.gs_74449 = s_25_4;
        // N s_25_6: jump b22
        return block_22(state, tracer, fn_state);
    }
    fn block_26<T: Tracer>(
        ...
        // D s_26_6: write-var ga#99681 <= s_26_5
        fn_state.ga_99681 = s_26_5;
        // N s_26_7: jump b27
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_0: read-var ga#99681:u64
        let s_27_0: u64 = fn_state.ga_99681;
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_35: write-var gs#74448 <= s_28_34
        fn_state.gs_74448 = s_28_34;
        // N s_28_36: jump b19
        return block_19(state, tracer, fn_state);
    }
