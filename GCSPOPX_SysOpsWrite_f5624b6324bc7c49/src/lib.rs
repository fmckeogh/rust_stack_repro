...
use GCSPOPX::*;
use common::*;
pub fn GCSPOPX_SysOpsWrite_f5624b6324bc7c49<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_0: const #() : ()
        let s_5_0: () = ();
        // S s_5_1: call GCSPOPX(s_5_0)
        let s_5_1: () = GCSPOPX(state, tracer, s_5_0);
        // N s_5_2: return
        return;
    }
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #() : ()
        let s_6_0: () = ();
        // S s_6_1: call GCSPOPX(s_6_0)
        let s_6_1: () = GCSPOPX(state, tracer, s_6_0);
        // N s_6_2: return
        return;
    }
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #() : ()
        let s_7_0: () = ();
        // S s_7_1: call GCSPOPX(s_7_0)
        let s_7_1: () = GCSPOPX(state, tracer, s_7_0);
        // N s_7_2: return
        return;
    }
    fn block_8<T: Tracer>(
