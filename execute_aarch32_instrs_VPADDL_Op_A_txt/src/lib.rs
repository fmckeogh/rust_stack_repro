...
use fdiv_int::*;
use common::*;
pub fn execute_aarch32_instrs_VPADDL_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d__arg: i64,
    elements: i128,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#7639 <= s_0_2
        fn_state.esizeshadow_7639 = s_0_2;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_10: write-var gs#315015 <= s_1_9
        fn_state.gs_315015 = s_1_9;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#315015:i64
        let s_2_1: i64 = fn_state.gs_315015;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_5: write-var gs#315021 <= s_3_4
        fn_state.gs_315021 = s_3_4;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#315021:i64
        let s_4_1: i64 = fn_state.gs_315021;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_12: read-var esizeshadow#7639:i64
        let s_5_12: i64 = fn_state.esizeshadow_7639;
        ...
        // D s_5_32: read-var esizeshadow#7639:i64
        let s_5_32: i64 = fn_state.esizeshadow_7639;
        ...
        // C s_5_52: const #2s : i
        let s_5_52: i128 = 2;
        // D s_5_53: read-var esizeshadow#7639:i64
        let s_5_53: i64 = fn_state.esizeshadow_7639;
        ...
        // C s_5_59: const #2s : i
        let s_5_59: i128 = 2;
        // D s_5_60: read-var esizeshadow#7639:i64
        let s_5_60: i64 = fn_state.esizeshadow_7639;
        // D s_5_61: cast zx s_5_60 -> i
        let s_5_61: i128 = (i128::try_from(s_5_60).unwrap());
        // D s_5_62: mul s_5_59 s_5_61
        let s_5_62: i128 = ((s_5_59) * (s_5_61));
        // D s_5_63: cast reint s_5_62 -> i64
        let s_5_63: i64 = (s_5_62 as i64);
        // C s_5_64: const #1s : i
        let s_5_64: i128 = 1;
        // D s_5_65: cast zx s_5_63 -> i
        let s_5_65: i128 = (i128::try_from(s_5_63).unwrap());
        // D s_5_66: sub s_5_65 s_5_64
        let s_5_66: i128 = ((s_5_65) - (s_5_64));
        // D s_5_67: cast reint s_5_66 -> i64
        let s_5_67: i64 = (s_5_66 as i64);
        // C s_5_68: const #0s : i
        let s_5_68: i128 = 0;
        // D s_5_69: cast zx s_5_67 -> i
        let s_5_69: i128 = (i128::try_from(s_5_67).unwrap());
        // D s_5_70: call integer_subrange(s_5_42, s_5_69, s_5_68)
        let s_5_70: Bits = integer_subrange(state, tracer, s_5_42, s_5_69, s_5_68);
        // D s_5_71: cast zx s_5_51 -> bv
        let s_5_71: Bits = Bits::new(s_5_51 as u128, 64u16);
        // D s_5_72: read-var e:i64
        let s_5_72: i64 = fn_state.e;
        // D s_5_73: cast zx s_5_72 -> i
        let s_5_73: i128 = (i128::try_from(s_5_72).unwrap());
        // D s_5_74: cast zx s_5_58 -> i
        let s_5_74: i128 = (i128::try_from(s_5_58).unwrap());
        // D s_5_75: call Elem_set(s_5_71, s_5_73, s_5_74, s_5_70)
        let s_5_75: Bits = Elem_set(state, tracer, s_5_71, s_5_73, s_5_74, s_5_70);
        // D s_5_76: cast reint s_5_75 -> u64
        let s_5_76: u64 = (s_5_75.value() as u64);
        // D s_5_77: call D_set(s_5_46, s_5_76)
        let s_5_77: () = D_set(state, tracer, s_5_46, s_5_76);
        // D s_5_78: read-var e:i64
        let s_5_78: i64 = fn_state.e;
        // C s_5_79: const #1s : i64
        let s_5_79: i64 = 1;
        // D s_5_80: add s_5_78 s_5_79
        let s_5_80: i64 = (s_5_78 + s_5_79);
        // D s_5_81: write-var e <= s_5_80
        fn_state.e = s_5_80;
        // N s_5_82: jump b4
        return block_4(state, tracer, fn_state);
    }
