...
use common::*;
pub fn decode_aarch32_instrs_UBFX_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    imm3: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#304044 <= s_3_3
        fn_state.gs_304044 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#304044:u8
        let s_4_0: bool = fn_state.gs_304044;
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#304044 <= s_9_0
        fn_state.gs_304044 = s_9_0;
        // N s_9_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
