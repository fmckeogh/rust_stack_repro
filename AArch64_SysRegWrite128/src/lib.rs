...
use AArch64_AutoGen_SysRegWrite128::*;
use common::*;
pub fn AArch64_SysRegWrite128<T: Tracer>(
    state: &mut State,
    tracer: &T,
    op0: i128,
    op1: i128,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_28: read-var t2:i
        let s_0_28: i128 = fn_state.t2;
        // D s_0_29: call AArch64_AutoGen_SysRegWrite128(s_0_1, s_0_6, s_0_11, s_0_16, s_0_21, s_0_26, s_0_27, s_0_28)
        let s_0_29: () = AArch64_AutoGen_SysRegWrite128(
            state,
            tracer,
            s_0_1,
            s_0_6,
