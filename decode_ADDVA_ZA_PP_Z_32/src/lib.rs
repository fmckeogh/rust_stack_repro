...
extern crate alloc;
use execute_ADDVA_ZA_PP_Z_32::*;
use CurrentVL_read::*;
use HaveSME::*;
use common::*;
pub fn decode_ADDVA_ZA_PP_Z_32<T: Tracer>(
    state: &mut State,
    tracer: &T,
    V: bool,
    Pm: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_27: call execute_ADDVA_ZA_PP_Z_32(s_2_0, s_2_21, s_2_22, s_2_23, s_2_24, s_2_25, s_2_26)
        let s_2_27: () = execute_ADDVA_ZA_PP_Z_32(
            state,
            tracer,
            s_2_0,
            s_2_21,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_27: call execute_ADDVA_ZA_PP_Z_32(s_4_0, s_4_21, s_4_22, s_4_23, s_4_24, s_4_25, s_4_26)
        let s_4_27: () = execute_ADDVA_ZA_PP_Z_32(
            state,
            tracer,
            s_4_0,
            s_4_21,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_27: call execute_ADDVA_ZA_PP_Z_32(s_6_0, s_6_21, s_6_22, s_6_23, s_6_24, s_6_25, s_6_26)
        let s_6_27: () = execute_ADDVA_ZA_PP_Z_32(
            state,
            tracer,
            s_6_0,
            s_6_21,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_27: call execute_ADDVA_ZA_PP_Z_32(s_8_0, s_8_21, s_8_22, s_8_23, s_8_24, s_8_25, s_8_26)
        let s_8_27: () = execute_ADDVA_ZA_PP_Z_32(
            state,
            tracer,
            s_8_0,
            s_8_21,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_27: call execute_ADDVA_ZA_PP_Z_32(s_10_0, s_10_21, s_10_22, s_10_23, s_10_24, s_10_25, s_10_26)
        let s_10_27: () = execute_ADDVA_ZA_PP_Z_32(
            state,
            tracer,
            s_10_0,
            s_10_21,
