...
extern crate alloc;
use Mk_MECID_RL_A_EL3_Type::*;
use common::*;
pub fn u__get_MECID_RL_A_EL3<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_11: tail-call Mk_MECID_RL_A_EL3_Type(s_0_10)
        return Mk_MECID_RL_A_EL3_Type(state, tracer, s_0_10);
    }
}
