...
pub fn PMEVCNTR_set<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_1: const #10744u : u32
        let s_0_1: u32 = 10744;
        // D s_0_2: read-reg s_0_1:[u64; 32]
        let s_0_2: [u64; 32usize] = {
            let value = state.read_register::<[u64; 32usize]>(s_0_1 as isize);
        ...
        // C s_0_26: const #10744u : u32
        let s_0_26: u32 = 10744;
        // D s_0_27: read-reg s_0_26:[u64; 32]
        let s_0_27: [u64; 32usize] = {
            let value = state.read_register::<[u64; 32usize]>(s_0_26 as isize);
        ...
        // D s_0_32: cast cvt s_0_31 -> [u64; 32]
        let s_0_32: [u64; 32usize] = {
            let mut buf = [Default::default(); 32usize];
            buf.copy_from_slice(&s_0_31);
            buf
        };
        // C s_0_33: const #10744u : u32
        let s_0_33: u32 = 10744;
        // N s_0_34: write-reg s_0_33 <= s_0_32
        let s_0_34: () = {
            state.write_register::<[u64; 32usize]>(s_0_33 as isize, s_0_32);
            tracer.write_register(s_0_33 as isize, s_0_32);
        };
        // C s_0_35: const #1656u : u32
        let s_0_35: u32 = 1656;
        // D s_0_36: read-reg s_0_35:[u32; 31]
        let s_0_36: [u32; 31usize] = {
            let value = state.read_register::<[u32; 31usize]>(s_0_35 as isize);
        ...
        // D s_0_41: cast cvt s_0_40 -> [u32; 31]
        let s_0_41: [u32; 31usize] = {
            let mut buf = [Default::default(); 31usize];
            buf.copy_from_slice(&s_0_40);
            buf
        };
        // C s_0_42: const #1656u : u32
        let s_0_42: u32 = 1656;
        // N s_0_43: write-reg s_0_42 <= s_0_41
        let s_0_43: () = {
            state.write_register::<[u32; 31usize]>(s_0_42 as isize, s_0_41);
