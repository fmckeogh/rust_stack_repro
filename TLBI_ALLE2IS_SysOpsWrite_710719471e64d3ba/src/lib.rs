...
use AArch64_TLBI_ALL::*;
use EL2Enabled::*;
use u_get_HCR_EL2_Type_NV::*;
use AArch64_SystemAccessTrap::*;
use common::*;
pub fn TLBI_ALLE2IS_SysOpsWrite_710719471e64d3ba<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_3: const #2u : u32
        let s_7_3: u32 = 2;
        // C s_7_4: const #1u : u32
        let s_7_4: u32 = 1;
        // C s_7_5: const #0u : u32
        let s_7_5: u32 = 0;
        // D s_7_6: call AArch64_TLBI_ALL(s_7_2, s_7_3, s_7_4, s_7_5)
        let s_7_6: () = AArch64_TLBI_ALL(state, tracer, s_7_2, s_7_3, s_7_4, s_7_5);
        // N s_7_7: return
        return;
    }
    fn block_8<T: Tracer>(
        ...
        let s_8_5: u32 = 0;
        // D s_8_6: call AArch64_TLBI_ALL(s_8_2, s_8_3, s_8_4, s_8_5)
        let s_8_6: () = AArch64_TLBI_ALL(state, tracer, s_8_2, s_8_3, s_8_4, s_8_5);
        // N s_8_7: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_11<T: Tracer>(
        ...
        // C s_11_3: const #2u : u32
        let s_11_3: u32 = 2;
        // C s_11_4: const #1u : u32
        let s_11_4: u32 = 1;
        // C s_11_5: const #0u : u32
        let s_11_5: u32 = 0;
        // D s_11_6: call AArch64_TLBI_ALL(s_11_2, s_11_3, s_11_4, s_11_5)
        let s_11_6: () = AArch64_TLBI_ALL(state, tracer, s_11_2, s_11_3, s_11_4, s_11_5);
        // N s_11_7: return
        return;
    }
    fn block_12<T: Tracer>(
        ...
        // C s_12_3: const #3u : u32
        let s_12_3: u32 = 3;
        // C s_12_4: const #1u : u32
        let s_12_4: u32 = 1;
        // C s_12_5: const #0u : u32
        let s_12_5: u32 = 0;
        // D s_12_6: call AArch64_TLBI_ALL(s_12_2, s_12_3, s_12_4, s_12_5)
        let s_12_6: () = AArch64_TLBI_ALL(state, tracer, s_12_2, s_12_3, s_12_4, s_12_5);
        // N s_12_7: return
        return;
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#101975 <= s_14_0
        fn_state.gs_101975 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#101975:u8
        let s_15_0: bool = fn_state.gs_101975;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_5: write-var gs#101975 <= s_18_4
        fn_state.gs_101975 = s_18_4;
        // N s_18_6: jump b15
        return block_15(state, tracer, fn_state);
    }
