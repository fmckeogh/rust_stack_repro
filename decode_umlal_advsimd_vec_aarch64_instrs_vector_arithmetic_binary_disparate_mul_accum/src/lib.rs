...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_binary_disparate_mul_accum::*;
use common::*;
pub fn decode_umlal_advsimd_vec_aarch64_instrs_vector_arithmetic_binary_disparate_mul_accum<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_31: call execute_aarch64_instrs_vector_arithmetic_binary_disparate_mul_accum(s_1_28, s_1_26, s_1_27, s_1_25, s_1_29, s_1_30, s_1_9, s_1_18, s_1_23)
        let s_1_31: () = execute_aarch64_instrs_vector_arithmetic_binary_disparate_mul_accum(
            state,
            tracer,
            s_1_28,
            s_1_26,
