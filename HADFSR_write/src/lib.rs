...
extern crate alloc;
use common::*;
pub fn HADFSR_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #13368u : u32
        let s_0_23: u32 = 13368;
        ...
        // C s_0_25: const #13416u : u32
        let s_0_25: u32 = 13416;
