...
use common::*;
pub fn BPIMVA_SysRegWrite32_913ce21249c53f0d<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_2: call BPIMVA(s_5_1)
        let s_5_2: () = BPIMVA(state, tracer, s_5_1);
        // N s_5_3: return
        return;
    }
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call BPIMVA(s_6_1)
        let s_6_2: () = BPIMVA(state, tracer, s_6_1);
        // N s_6_3: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#124217 <= s_8_0
        fn_state.gs_124217 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#124217:u8
        let s_9_0: bool = fn_state.gs_124217;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#124218 <= s_10_0
        fn_state.gs_124218 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#124218:u8
        let s_11_0: bool = fn_state.gs_124218;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#124219 <= s_13_0
        fn_state.gs_124219 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#124219:u8
        let s_14_0: bool = fn_state.gs_124219;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#124220 <= s_15_0
        fn_state.gs_124220 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#124220:u8
        let s_16_0: bool = fn_state.gs_124220;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_2: call BPIMVA(s_17_1)
        let s_17_2: () = BPIMVA(state, tracer, s_17_1);
        // N s_17_3: return
        return;
    }
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_5: write-var gs#124220 <= s_19_4
        fn_state.gs_124220 = s_19_4;
        // N s_19_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_3: write-var gs#124219 <= s_20_2
        fn_state.gs_124219 = s_20_2;
        // N s_20_4: jump b14
        return block_14(state, tracer, fn_state);
    }
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_5: write-var gs#124218 <= s_22_4
        fn_state.gs_124218 = s_22_4;
        // N s_22_6: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_23<T: Tracer>(
        ...
        // D s_23_4: write-var gs#124217 <= s_23_3
        fn_state.gs_124217 = s_23_3;
        // N s_23_5: jump b9
        return block_9(state, tracer, fn_state);
    }
