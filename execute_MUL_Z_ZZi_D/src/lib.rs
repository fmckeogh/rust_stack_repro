...
use Z_set::*;
use common::*;
pub fn execute_MUL_Z_ZZi_D<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#3890 <= s_0_2
        fn_state.VLshadow_3890 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#3890:i64
        let s_1_0: i64 = fn_state.VLshadow_3890;
        // D s_1_1: write-var VLshadow#3891 <= s_1_0
        fn_state.VLshadow_3891 = s_1_0;
        // D s_1_2: read-var VLshadow#3891:i64
        let s_1_2: i64 = fn_state.VLshadow_3891;
        ...
        // D s_1_14: read-var VLshadow#3891:i64
        let s_1_14: i64 = fn_state.VLshadow_3891;
        ...
        // D s_1_22: read-var VLshadow#3891:i64
        let s_1_22: i64 = fn_state.VLshadow_3891;
        ...
        // D s_1_35: write-var gs#210967 <= s_1_34
        fn_state.gs_210967 = s_1_34;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#210967:i64
        let s_2_1: i64 = fn_state.gs_210967;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_37: mul s_3_26 s_3_36
        let s_3_37: i128 = ((s_3_26) * (s_3_36));
        // D s_3_38: read-var esize:i64
        let s_3_38: i64 = fn_state.esize;
        ...
        // D s_3_44: sub s_3_43 s_3_41
        let s_3_44: i128 = ((s_3_43) - (s_3_41));
        // D s_3_45: cast reint s_3_44 -> i64
        let s_3_45: i64 = (s_3_44 as i64);
        // C s_3_46: const #0s : i
        let s_3_46: i128 = 0;
        // D s_3_47: cast zx s_3_45 -> i
        let s_3_47: i128 = (i128::try_from(s_3_45).unwrap());
        // D s_3_48: call integer_subrange(s_3_37, s_3_47, s_3_46)
        let s_3_48: Bits = integer_subrange(state, tracer, s_3_37, s_3_47, s_3_46);
        // D s_3_49: read-var e:i64
        let s_3_49: i64 = fn_state.e;
        // D s_3_50: cast zx s_3_49 -> i
        let s_3_50: i128 = (i128::try_from(s_3_49).unwrap());
        // D s_3_51: cast zx s_3_40 -> i
        let s_3_51: i128 = (i128::try_from(s_3_40).unwrap());
        // D s_3_52: read-var result:bv
        let s_3_52: Bits = fn_state.result;
        // D s_3_53: call Elem_set(s_3_52, s_3_50, s_3_51, s_3_48)
        let s_3_53: Bits = Elem_set(state, tracer, s_3_52, s_3_50, s_3_51, s_3_48);
        // D s_3_54: write-var result <= s_3_53
        fn_state.result = s_3_53;
        // D s_3_55: read-var e:i64
        let s_3_55: i64 = fn_state.e;
        // C s_3_56: const #1s : i64
        let s_3_56: i64 = 1;
        // D s_3_57: add s_3_55 s_3_56
        let s_3_57: i64 = (s_3_55 + s_3_56);
        // D s_3_58: write-var e <= s_3_57
        fn_state.e = s_3_57;
        // N s_3_59: jump b2
        return block_2(state, tracer, fn_state);
    }
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#3891:i64
        let s_4_0: i64 = fn_state.VLshadow_3891;
