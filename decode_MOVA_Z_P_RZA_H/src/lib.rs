...
extern crate alloc;
use CurrentVL_read::*;
use execute_MOVA_Z_P_RZA_H::*;
use HaveSME::*;
use common::*;
pub fn decode_MOVA_Z_P_RZA_H<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Q: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        fn_state.n = s_1_25;
        // D s_1_27: read-var off3:u8
        let s_1_27: u8 = fn_state.off3;
        ...
        // D s_1_31: write-var offset <= s_1_30
        fn_state.offset = s_1_30;
        // D s_1_32: read-var Zd:u8
        let s_1_32: u8 = fn_state.Zd;
        // D s_1_33: cast zx s_1_32 -> bv
        let s_1_33: Bits = Bits::new(s_1_32 as u128, 5u16);
        // D s_1_34: cast zx s_1_33 -> i
        let s_1_34: i128 = (s_1_33.value() as i128);
        // D s_1_35: cast reint s_1_34 -> i64
        let s_1_35: i64 = (s_1_34 as i64);
        // D s_1_36: write-var d <= s_1_35
        fn_state.d = s_1_35;
        // D s_1_37: read-var V:u8
        let s_1_37: bool = fn_state.V;
        // D s_1_38: cast zx s_1_37 -> bv
        let s_1_38: Bits = Bits::new(s_1_37 as u128, 1u16);
        // C s_1_39: const #1u : u8
        let s_1_39: bool = true;
        // C s_1_40: cast zx s_1_39 -> bv
        let s_1_40: Bits = Bits::new(s_1_39 as u128, 1u16);
        // D s_1_41: cmp-eq s_1_38 s_1_40
        let s_1_41: bool = ((s_1_38) == (s_1_40));
        // D s_1_42: write-var vertical <= s_1_41
        fn_state.vertical = s_1_41;
        // D s_1_43: read-var VL:i64
        let s_1_43: i64 = fn_state.VL;
        // C s_1_44: const #128s : i
        let s_1_44: i128 = 128;
        // D s_1_45: cast zx s_1_43 -> i
        let s_1_45: i128 = (i128::try_from(s_1_43).unwrap());
        // D s_1_46: cmp-eq s_1_45 s_1_44
        let s_1_46: bool = ((s_1_45) == (s_1_44));
        // D s_1_47: not s_1_46
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_8: call execute_MOVA_Z_P_RZA_H(s_2_0, s_2_1, s_2_2, s_2_3, s_2_4, s_2_5, s_2_6, s_2_7)
        let s_2_8: () = execute_MOVA_Z_P_RZA_H(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_8: call execute_MOVA_Z_P_RZA_H(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5, s_4_6, s_4_7)
        let s_4_8: () = execute_MOVA_Z_P_RZA_H(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_8: call execute_MOVA_Z_P_RZA_H(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5, s_6_6, s_6_7)
        let s_6_8: () = execute_MOVA_Z_P_RZA_H(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_8: call execute_MOVA_Z_P_RZA_H(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5, s_8_6, s_8_7)
        let s_8_8: () = execute_MOVA_Z_P_RZA_H(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_8: call execute_MOVA_Z_P_RZA_H(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5, s_10_6, s_10_7)
        let s_10_8: () = execute_MOVA_Z_P_RZA_H(
            state,
            tracer,
            s_10_0,
            s_10_1,
