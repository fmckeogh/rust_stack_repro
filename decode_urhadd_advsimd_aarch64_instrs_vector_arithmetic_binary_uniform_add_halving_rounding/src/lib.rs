...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_binary_uniform_add_halving_rounding::*;
use common::*;
pub fn decode_urhadd_advsimd_aarch64_instrs_vector_arithmetic_binary_uniform_add_halving_rounding<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 64;
        // D s_2_1: write-var ga#268798 <= s_2_0
        fn_state.ga_268798 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#268798:i64
        let s_3_0: i64 = fn_state.ga_268798;
        ...
        // D s_3_20: call execute_aarch64_instrs_vector_arithmetic_binary_uniform_add_halving_rounding(s_3_17, s_3_12, s_3_16, s_3_15, s_3_18, s_3_19, s_3_10)
        let s_3_20: () = execute_aarch64_instrs_vector_arithmetic_binary_uniform_add_halving_rounding(
            state,
            tracer,
            s_3_17,
            s_3_12,
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 128;
        // D s_4_1: write-var ga#268798 <= s_4_0
        fn_state.ga_268798 = s_4_0;
        // N s_4_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_5<T: Tracer>(
