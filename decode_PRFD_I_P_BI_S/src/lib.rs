...
extern crate alloc;
use HaveSVE::*;
use execute_PRFD_I_P_BI_S::*;
use CurrentVL_read::*;
use HaveSME::*;
use common::*;
pub fn decode_PRFD_I_P_BI_S<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm6: u8,
    msz: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#226019 <= s_1_0
        fn_state.gs_226019 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#226019:u8
        let s_2_0: bool = fn_state.gs_226019;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_10: call execute_PRFD_I_P_BI_S(s_6_0, s_6_3, s_6_4, s_6_5, s_6_6, s_6_2, s_6_7, s_6_8, s_6_9)
        let s_6_10: () = execute_PRFD_I_P_BI_S(
            state,
            tracer,
            s_6_0,
            s_6_3,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_10: call execute_PRFD_I_P_BI_S(s_8_0, s_8_3, s_8_4, s_8_5, s_8_6, s_8_2, s_8_7, s_8_8, s_8_9)
        let s_8_10: () = execute_PRFD_I_P_BI_S(
            state,
            tracer,
            s_8_0,
            s_8_3,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_10: call execute_PRFD_I_P_BI_S(s_10_0, s_10_3, s_10_4, s_10_5, s_10_6, s_10_2, s_10_7, s_10_8, s_10_9)
        let s_10_10: () = execute_PRFD_I_P_BI_S(
            state,
            tracer,
            s_10_0,
            s_10_3,
    ...
    fn block_12<T: Tracer>(
        ...
        // C s_12_8: const #3s : i64
        let s_12_8: i64 = 3;
        // D s_12_9: read-var stream:u8
        let s_12_9: bool = fn_state.stream;
        // D s_12_10: call execute_PRFD_I_P_BI_S(s_12_0, s_12_3, s_12_4, s_12_5, s_12_6, s_12_2, s_12_7, s_12_8, s_12_9)
        let s_12_10: () = execute_PRFD_I_P_BI_S(
            state,
            tracer,
            s_12_0,
            s_12_3,
    ...
    fn block_14<T: Tracer>(
        ...
        // C s_14_8: const #3s : i64
        let s_14_8: i64 = 3;
        // D s_14_9: read-var stream:u8
        let s_14_9: bool = fn_state.stream;
        // D s_14_10: call execute_PRFD_I_P_BI_S(s_14_0, s_14_3, s_14_4, s_14_5, s_14_6, s_14_2, s_14_7, s_14_8, s_14_9)
        let s_14_10: () = execute_PRFD_I_P_BI_S(
            state,
            tracer,
            s_14_0,
            s_14_3,
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_3: write-var gs#226019 <= s_18_2
        fn_state.gs_226019 = s_18_2;
        // N s_18_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
