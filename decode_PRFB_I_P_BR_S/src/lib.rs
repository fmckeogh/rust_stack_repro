...
use HaveSVE::*;
use CurrentVL_read::*;
use execute_PRFB_I_P_BR_S::*;
use HaveSME::*;
use common::*;
pub fn decode_PRFB_I_P_BR_S<T: Tracer>(
    state: &mut State,
    tracer: &T,
    msz: u8,
    Rm: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#226083 <= s_1_0
        fn_state.gs_226083 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#226083:u8
        let s_2_0: bool = fn_state.gs_226083;
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_7: const #0s : i64
        let s_7_7: i64 = 0;
        // D s_7_8: read-var stream:u8
        let s_7_8: bool = fn_state.stream;
        // D s_7_9: call execute_PRFB_I_P_BR_S(s_7_0, s_7_1, s_7_2, s_7_3, s_7_4, s_7_5, s_7_6, s_7_7, s_7_8)
        let s_7_9: () = execute_PRFB_I_P_BR_S(
            state,
            tracer,
            s_7_0,
            s_7_1,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_9: call execute_PRFB_I_P_BR_S(s_9_0, s_9_1, s_9_2, s_9_3, s_9_4, s_9_5, s_9_6, s_9_7, s_9_8)
        let s_9_9: () = execute_PRFB_I_P_BR_S(
            state,
            tracer,
            s_9_0,
            s_9_1,
    ...
    fn block_11<T: Tracer>(
        ...
        // C s_11_7: const #0s : i64
        let s_11_7: i64 = 0;
        // D s_11_8: read-var stream:u8
        let s_11_8: bool = fn_state.stream;
        // D s_11_9: call execute_PRFB_I_P_BR_S(s_11_0, s_11_1, s_11_2, s_11_3, s_11_4, s_11_5, s_11_6, s_11_7, s_11_8)
        let s_11_9: () = execute_PRFB_I_P_BR_S(
            state,
            tracer,
            s_11_0,
            s_11_1,
    ...
    fn block_13<T: Tracer>(
        ...
        // C s_13_7: const #0s : i64
        let s_13_7: i64 = 0;
        // D s_13_8: read-var stream:u8
        let s_13_8: bool = fn_state.stream;
        // D s_13_9: call execute_PRFB_I_P_BR_S(s_13_0, s_13_1, s_13_2, s_13_3, s_13_4, s_13_5, s_13_6, s_13_7, s_13_8)
        let s_13_9: () = execute_PRFB_I_P_BR_S(
            state,
            tracer,
            s_13_0,
            s_13_1,
    ...
    fn block_15<T: Tracer>(
        ...
        // C s_15_7: const #0s : i64
        let s_15_7: i64 = 0;
        // D s_15_8: read-var stream:u8
        let s_15_8: bool = fn_state.stream;
        // D s_15_9: call execute_PRFB_I_P_BR_S(s_15_0, s_15_1, s_15_2, s_15_3, s_15_4, s_15_5, s_15_6, s_15_7, s_15_8)
        let s_15_9: () = execute_PRFB_I_P_BR_S(
            state,
            tracer,
            s_15_0,
            s_15_1,
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_3: write-var gs#226083 <= s_20_2
        fn_state.gs_226083 = s_20_2;
        // N s_20_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
