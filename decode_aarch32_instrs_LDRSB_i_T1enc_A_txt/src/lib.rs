...
use common::*;
pub fn decode_aarch32_instrs_LDRSB_i_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    Rt: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_20: call execute_aarch32_instrs_LDRSB_i_Op_A_txt(s_4_18, s_4_16, s_4_17, s_4_11, s_4_3, s_4_19)
        let s_4_20: () = execute_aarch32_instrs_LDRSB_i_Op_A_txt(
            state,
            tracer,
            s_4_18,
            s_4_16,
