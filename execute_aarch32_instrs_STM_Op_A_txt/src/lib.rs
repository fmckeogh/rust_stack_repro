...
use BitCount::*;
use common::*;
pub fn execute_aarch32_instrs_STM_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    n: i64,
    registers: u16,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#302138 <= s_6_0
        fn_state.gs_302138 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#302138:u8
        let s_7_0: bool = fn_state.gs_302138;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#302139 <= s_8_0
        fn_state.gs_302139 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#302139:u8
        let s_9_0: bool = fn_state.gs_302139;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_6: write-var gs#302139 <= s_13_5
        fn_state.gs_302139 = s_13_5;
        // N s_13_7: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#302138 <= s_14_0
        fn_state.gs_302138 = s_14_0;
        // N s_14_2: jump b7
        return block_7(state, tracer, fn_state);
    }
