...
use u_get_TTBR1_EL2_Type_CnP::*;
use AArch64_GetVARange::*;
use Zeros::*;
use HaveCommonNotPrivateTransExt::*;
use u_get_TCR_EL2_Type_AS::*;
use common::*;
pub fn AArch64_TLBContextEL20<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ss: u32,
    va: u64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_6: call _get_TCR_EL2_Type_A1(s_0_5)
        let s_0_6: bool = u_get_TCR_EL2_Type_A1(state, tracer, s_0_5);
    ...
    fn block_1<T: Tracer>(
        ...
        // C s_1_0: const #18432u : u32
        let s_1_0: u32 = 18432;
        // D s_1_1: read-reg s_1_0:struct
        let s_1_1: ProductType782ac6922b48c20d = {
            let value = state
                .read_register::<ProductType782ac6922b48c20d>(s_1_0 as isize);
            tracer.read_register(s_1_0 as isize, value);
            value
        };
        // D s_1_2: call _get_TTBR1_EL2_Type_ASID(s_1_1)
        let s_1_2: u16 = u_get_TTBR1_EL2_Type_ASID(state, tracer, s_1_1);
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_2: call _get_TCR_EL2_Type_AS(s_2_1)
        let s_2_2: bool = u_get_TCR_EL2_Type_AS(state, tracer, s_2_1);
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #18432u : u32
        let s_8_0: u32 = 18432;
        // D s_8_1: read-reg s_8_0:struct
        let s_8_1: ProductType782ac6922b48c20d = {
            let value = state
                .read_register::<ProductType782ac6922b48c20d>(s_8_0 as isize);
            tracer.read_register(s_8_0 as isize, value);
            value
        };
        // D s_8_2: call _get_TTBR1_EL2_Type_CnP(s_8_1)
        let s_8_2: bool = u_get_TTBR1_EL2_Type_CnP(state, tracer, s_8_1);
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #() : ()
        let s_9_0: () = ();
        // S s_9_1: call TTBR0_EL2_read(s_9_0)
        let s_9_1: ProductType782ac6922b48c20d = TTBR0_EL2_read(state, tracer, s_9_0);
        // S s_9_2: call _get_TTBR0_EL2_Type_CnP(s_9_1)
        let s_9_2: bool = u_get_TTBR0_EL2_Type_CnP(state, tracer, s_9_1);
    ...
    fn block_11<T: Tracer>(
        ...
        // C s_11_0: const #() : ()
        let s_11_0: () = ();
        // S s_11_1: call TTBR0_EL2_read(s_11_0)
        let s_11_1: ProductType782ac6922b48c20d = TTBR0_EL2_read(state, tracer, s_11_0);
        // S s_11_2: call _get_TTBR0_EL2_Type_ASID(s_11_1)
        let s_11_2: u16 = u_get_TTBR0_EL2_Type_ASID(state, tracer, s_11_1);
