...
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_VNMLA_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Vn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_7: write-var gs#314573 <= s_3_6
        fn_state.gs_314573 = s_3_6;
        // N s_3_8: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#314573:u8
        let s_4_0: bool = fn_state.gs_314573;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#314574 <= s_7_0
        fn_state.gs_314574 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#314574:u8
        let s_8_0: bool = fn_state.gs_314574;
        // D s_8_1: write-var gs#314575 <= s_8_0
        fn_state.gs_314575 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#314575:u8
        let s_9_0: bool = fn_state.gs_314575;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#314576 <= s_11_0
        fn_state.gs_314576 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#314576:u8
        let s_12_0: bool = fn_state.gs_314576;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_2: write-var gs#314576 <= s_25_1
        fn_state.gs_314576 = s_25_1;
        // N s_25_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_3: write-var gs#314574 <= s_27_2
        fn_state.gs_314574 = s_27_2;
        // N s_27_4: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_1: write-var gs#314575 <= s_28_0
        fn_state.gs_314575 = s_28_0;
        // N s_28_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_30<T: Tracer>(
        ...
        // D s_30_1: write-var gs#314573 <= s_30_0
        fn_state.gs_314573 = s_30_0;
        // N s_30_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
