...
use common::*;
pub fn ICH_LR_EL2_SysRegWrite_7f74a03659a9be73<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call Mk_ICH_LR_EL2_Type(s_6_3)
        let s_6_4: ProductType5c790c8ef59cc8b2 = Mk_ICH_LR_EL2_Type(
            state,
            tracer,
            s_6_3,
        );
        // C s_6_5: const #13s : i
        let s_6_5: i128 = 13;
        // C s_6_6: const #10240u : u32
        let s_6_6: u32 = 10240;
        // D s_6_7: read-reg s_6_6:[struct; 16]
        let s_6_7: [ProductType5c790c8ef59cc8b2; 16usize] = {
            let value = state
                .read_register::<[ProductType5c790c8ef59cc8b2; 16usize]>(s_6_6 as isize);
            tracer.read_register(s_6_6 as isize, value);
            value
        };
        // D s_6_8: mutate-element s_6_7[s_6_5] <= s_6_4
        let s_6_8: [ProductType5c790c8ef59cc8b2; 16usize] = {
            let mut local = s_6_7.clone();
            local[(s_6_5) as usize] = s_6_4;
            local
        };
        // D s_6_9: cast cvt s_6_8 -> [struct; 0]
        let s_6_9: alloc::vec::Vec<ProductType5c790c8ef59cc8b2> = alloc::vec::Vec::from(
            s_6_8,
        );
        // D s_6_10: cast cvt s_6_9 -> [struct; 16]
        let s_6_10: [ProductType5c790c8ef59cc8b2; 16usize] = {
            let mut buf = [Default::default(); 16usize];
            buf.copy_from_slice(&s_6_9);
            buf
        };
        // C s_6_11: const #10240u : u32
        let s_6_11: u32 = 10240;
        // N s_6_12: write-reg s_6_11 <= s_6_10
        let s_6_12: () = {
            state
                .write_register::<
                    [ProductType5c790c8ef59cc8b2; 16usize],
                >(s_6_11 as isize, s_6_10);
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: call Mk_ICH_LR_EL2_Type(s_9_3)
        let s_9_4: ProductType5c790c8ef59cc8b2 = Mk_ICH_LR_EL2_Type(
            state,
            tracer,
            s_9_3,
        );
        // C s_9_5: const #13s : i
        let s_9_5: i128 = 13;
        // C s_9_6: const #10240u : u32
        let s_9_6: u32 = 10240;
        // D s_9_7: read-reg s_9_6:[struct; 16]
        let s_9_7: [ProductType5c790c8ef59cc8b2; 16usize] = {
            let value = state
                .read_register::<[ProductType5c790c8ef59cc8b2; 16usize]>(s_9_6 as isize);
            tracer.read_register(s_9_6 as isize, value);
            value
        };
        // D s_9_8: mutate-element s_9_7[s_9_5] <= s_9_4
        let s_9_8: [ProductType5c790c8ef59cc8b2; 16usize] = {
        ...
        // D s_9_10: cast cvt s_9_9 -> [struct; 16]
        let s_9_10: [ProductType5c790c8ef59cc8b2; 16usize] = {
            let mut buf = [Default::default(); 16usize];
            buf.copy_from_slice(&s_9_9);
            buf
        };
        // C s_9_11: const #10240u : u32
        let s_9_11: u32 = 10240;
    ...
    fn block_11<T: Tracer>(
        ...
        // N s_11_2: branch s_11_1 b21 b12
        if s_11_1 {
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#86313 <= s_12_0
        fn_state.gs_86313 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#86313:u8
        let s_13_0: bool = fn_state.gs_86313;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#86314 <= s_15_0
        fn_state.gs_86314 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#86314:u8
        let s_16_0: bool = fn_state.gs_86314;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_5: write-var gs#86314 <= s_19_4
        fn_state.gs_86314 = s_19_4;
        // N s_19_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // C s_20_9: const #64s : i64
        let s_20_9: i64 = 64;
        // D s_20_10: read-var t:i
        let s_20_10: i128 = fn_state.t;
        // D s_20_11: call X_read(s_20_10, s_20_9)
        let s_20_11: Bits = X_read(state, tracer, s_20_10, s_20_9);
        // D s_20_12: cast reint s_20_11 -> u64
        let s_20_12: u64 = (s_20_11.value() as u64);
        // C s_20_13: cast zx s_20_8 -> i
        let s_20_13: i128 = (i128::try_from(s_20_8).unwrap());
        // D s_20_14: call NVMem_set(s_20_13, s_20_12)
        let s_20_14: () = NVMem_set(state, tracer, s_20_13, s_20_12);
        // N s_20_15: return
        return;
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_2: call _get_HCR_EL2_Type_NV2(s_21_1)
        let s_21_2: bool = u_get_HCR_EL2_Type_NV2(state, tracer, s_21_1);
        ...
        // D s_21_5: call _get_HCR_EL2_Type_NV(s_21_4)
        let s_21_5: bool = u_get_HCR_EL2_Type_NV(state, tracer, s_21_4);
        ...
        // D s_21_21: write-var gs#86313 <= s_21_20
        fn_state.gs_86313 = s_21_20;
        // N s_21_22: jump b13
        return block_13(state, tracer, fn_state);
    }
