...
extern crate alloc;
use execute_aarch64_instrs_vector_bfmmla::*;
use HaveBF16Ext::*;
use common::*;
pub fn decode_bfmmla_advsimd_aarch64_instrs_vector_bfmmla<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_4: read-var Rm:u8
        let s_1_4: u8 = fn_state.Rm;
        ...
        // D s_1_8: read-var Rd:u8
        let s_1_8: u8 = fn_state.Rd;
        ...
        // D s_1_12: call execute_aarch64_instrs_vector_bfmmla(s_1_11, s_1_7, s_1_3)
        let s_1_12: () = execute_aarch64_instrs_vector_bfmmla(
            state,
            tracer,
            s_1_11,
            s_1_7,
