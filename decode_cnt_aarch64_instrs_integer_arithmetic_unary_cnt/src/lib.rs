...
extern crate alloc;
use HaveCSSC::*;
use execute_aarch64_instrs_integer_arithmetic_unary_cnt::*;
use common::*;
pub fn decode_cnt_aarch64_instrs_integer_arithmetic_unary_cnt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_16: call execute_aarch64_instrs_integer_arithmetic_unary_cnt(s_1_13, s_1_15, s_1_9)
        let s_1_16: () = execute_aarch64_instrs_integer_arithmetic_unary_cnt(
            state,
            tracer,
            s_1_13,
            s_1_15,
