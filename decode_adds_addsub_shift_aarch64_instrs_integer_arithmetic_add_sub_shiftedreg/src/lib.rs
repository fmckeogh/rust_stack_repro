...
use common::*;
pub fn decode_adds_addsub_shift_aarch64_instrs_integer_arithmetic_add_sub_shiftedreg<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 32;
        // D s_1_1: write-var ga#249099 <= s_1_0
        fn_state.ga_249099 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#249099:i64
        let s_2_0: i64 = fn_state.ga_249099;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#142919 <= s_4_0
        fn_state.gs_142919 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#142919:u8
        let s_5_0: bool = fn_state.gs_142919;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_22: write-var gs#142919 <= s_8_21
        fn_state.gs_142919 = s_8_21;
        // N s_8_23: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 64;
        // D s_10_1: write-var ga#249099 <= s_10_0
        fn_state.ga_249099 = s_10_0;
        // N s_10_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
