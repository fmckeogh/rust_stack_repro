...
use Qin_read::*;
use common::*;
pub fn execute_aarch32_instrs_VSUBL_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d__arg: i64,
    elements: i128,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#7874 <= s_0_2
        fn_state.esizeshadow_7874 = s_0_2;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_5: write-var gs#322672 <= s_1_4
        fn_state.gs_322672 = s_1_4;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#322672:i64
        let s_2_1: i64 = fn_state.gs_322672;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var is_vsubw:u8
        let s_3_0: bool = fn_state.is_vsubw;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_3: read-var esizeshadow#7874:i64
        let s_4_3: i64 = fn_state.esizeshadow_7874;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: read-var esizeshadow#7874:i64
        let s_5_4: i64 = fn_state.esizeshadow_7874;
        ...
        // C s_5_22: const #2s : i
        let s_5_22: i128 = 2;
        // D s_5_23: read-var esizeshadow#7874:i64
        let s_5_23: i64 = fn_state.esizeshadow_7874;
        ...
        // C s_5_29: const #2s : i
        let s_5_29: i128 = 2;
        // D s_5_30: read-var esizeshadow#7874:i64
        let s_5_30: i64 = fn_state.esizeshadow_7874;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_5: const #2s : i
        let s_6_5: i128 = 2;
        // D s_6_6: read-var esizeshadow#7874:i64
        let s_6_6: i64 = fn_state.esizeshadow_7874;
