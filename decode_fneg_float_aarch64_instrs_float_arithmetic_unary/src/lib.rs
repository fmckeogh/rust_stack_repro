...
use common::*;
pub fn decode_fneg_float_aarch64_instrs_float_arithmetic_unary<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var esizeshadow#1196 <= s_2_0
        fn_state.esizeshadow_1196 = s_2_0;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var esizeshadow#1196:i64
        let s_4_1: i64 = fn_state.esizeshadow_1196;
