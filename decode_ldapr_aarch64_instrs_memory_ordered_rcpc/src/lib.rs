...
use common::*;
pub fn decode_ldapr_aarch64_instrs_memory_ordered_rcpc<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 32;
        // D s_1_1: write-var ga#258834 <= s_1_0
        fn_state.ga_258834 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#258834:i64
        let s_2_0: i64 = fn_state.ga_258834;
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 64;
        // D s_3_1: write-var ga#258834 <= s_3_0
        fn_state.ga_258834 = s_3_0;
        // N s_3_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
