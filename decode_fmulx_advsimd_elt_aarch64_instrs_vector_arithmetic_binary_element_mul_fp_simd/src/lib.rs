...
use common::*;
pub fn decode_fmulx_advsimd_elt_aarch64_instrs_vector_arithmetic_binary_element_mul_fp_simd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#256012 <= s_1_0
        fn_state.ga_256012 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#256012:i64
        let s_2_0: i64 = fn_state.ga_256012;
        ...
        // D s_2_17: write-var ga#256013 <= s_2_16
        fn_state.ga_256013 = s_2_16;
        // D s_2_18: read-var ga#256013:u8
        let s_2_18: u8 = fn_state.ga_256013;
        // C s_2_19: const #1s : i
        let s_2_19: i128 = 1;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var indexshadow#1419 <= s_4_0
        fn_state.indexshadow_1419 = s_4_0;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 64;
        // D s_6_1: write-var ga#256027 <= s_6_0
        fn_state.ga_256027 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var ga#256027:i64
        let s_7_0: i64 = fn_state.ga_256027;
        ...
        // D s_7_21: read-var indexshadow#1419:i64
        let s_7_21: i64 = fn_state.indexshadow_1419;
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 128;
        // D s_8_1: write-var ga#256027 <= s_8_0
        fn_state.ga_256027 = s_8_0;
        // N s_8_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var ga#256013:u8
        let s_10_0: u8 = fn_state.ga_256013;
    ...
    fn block_13<T: Tracer>(
        ...
        let s_13_0: i64 = 128;
        // D s_13_1: write-var ga#256012 <= s_13_0
        fn_state.ga_256012 = s_13_0;
        // N s_13_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
