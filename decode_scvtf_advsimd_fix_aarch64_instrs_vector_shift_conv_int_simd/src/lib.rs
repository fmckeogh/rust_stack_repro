...
use common::*;
pub fn decode_scvtf_advsimd_fix_aarch64_instrs_vector_shift_conv_int_simd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_0: const #1u : u8
        let s_2_0: bool = true;
        // D s_2_1: write-var gs#167413 <= s_2_0
        fn_state.gs_167413 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#167413:u8
        let s_3_0: bool = fn_state.gs_167413;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#167418 <= s_4_0
        fn_state.gs_167418 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#167418:u8
        let s_5_0: bool = fn_state.gs_167418;
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #1u : u8
        let s_8_0: bool = true;
        // D s_8_1: write-var gs#167424 <= s_8_0
        fn_state.gs_167424 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#167424:u8
        let s_9_0: bool = fn_state.gs_167424;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#167429 <= s_11_0
        fn_state.gs_167429 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#167429:u8
        let s_12_0: bool = fn_state.gs_167429;
    ...
    fn block_13<T: Tracer>(
        ...
        let s_13_0: i64 = 16;
        // D s_13_1: write-var ga#265049 <= s_13_0
        fn_state.ga_265049 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var ga#265049:i64
        let s_14_0: i64 = fn_state.ga_265049;
    ...
    fn block_15<T: Tracer>(
        ...
        let s_15_0: i64 = 64;
        // D s_15_1: write-var ga#265051 <= s_15_0
        fn_state.ga_265051 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var ga#265051:i64
        let s_16_0: i64 = fn_state.ga_265051;
        ...
        // C s_16_36: const #() : ()
        let s_16_36: () = ();
        // S s_16_37: call FPCR_read(s_16_36)
        let s_16_37: ProductType5c790c8ef59cc8b2 = FPCR_read(state, tracer, s_16_36);
        // S s_16_38: call FPRoundingMode(s_16_37)
        let s_16_38: u32 = FPRoundingMode(state, tracer, s_16_37);
        // D s_16_39: cast zx s_16_0 -> i
        let s_16_39: i128 = (i128::try_from(s_16_0).unwrap());
        // D s_16_40: cast reint s_16_39 -> i64
        let s_16_40: i64 = (s_16_39 as i64);
        // D s_16_41: read-var esize:i64
        let s_16_41: i64 = fn_state.esize;
        // D s_16_42: cast zx s_16_41 -> i
        let s_16_42: i128 = (i128::try_from(s_16_41).unwrap());
        // D s_16_43: cast reint s_16_42 -> i64
        let s_16_43: i64 = (s_16_42 as i64);
        // D s_16_44: cast zx s_16_5 -> i
        let s_16_44: i128 = (i128::try_from(s_16_5).unwrap());
        // D s_16_45: cast zx s_16_30 -> i
        let s_16_45: i128 = (i128::try_from(s_16_30).unwrap());
        // D s_16_46: read-var d:i64
        let s_16_46: i64 = fn_state.d;
        // D s_16_47: read-var n:i64
        let s_16_47: i64 = fn_state.n;
        // D s_16_48: call execute_aarch64_instrs_vector_shift_conv_int_sisd(s_16_46, s_16_40, s_16_44, s_16_43, s_16_45, s_16_47, s_16_38, s_16_35)
        let s_16_48: () = execute_aarch64_instrs_vector_shift_conv_int_sisd(
            state,
            tracer,
            s_16_46,
            s_16_40,
    ...
    fn block_17<T: Tracer>(
        ...
        let s_17_0: i64 = 128;
        // D s_17_1: write-var ga#265051 <= s_17_0
        fn_state.ga_265051 = s_17_0;
        // N s_17_2: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_18<T: Tracer>(
        ...
        let s_18_0: i64 = 32;
        // D s_18_1: write-var ga#265049 <= s_18_0
        fn_state.ga_265049 = s_18_0;
        // N s_18_2: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#167429 <= s_19_0
        fn_state.gs_167429 = s_19_0;
        // N s_19_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        let s_20_0: i64 = 64;
        // D s_20_1: write-var ga#265049 <= s_20_0
        fn_state.ga_265049 = s_20_0;
        // N s_20_2: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#167424 <= s_21_0
        fn_state.gs_167424 = s_21_0;
        // N s_21_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_1: write-var gs#167418 <= s_24_0
        fn_state.gs_167418 = s_24_0;
        // N s_24_2: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#167413 <= s_25_0
        fn_state.gs_167413 = s_25_0;
        // N s_25_2: jump b3
        return block_3(state, tracer, fn_state);
    }
