...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_STRH_i_OpA_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_STRH_i_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    P: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#302765 <= s_3_0
        fn_state.gs_302765 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#302765:u8
        let s_4_0: bool = fn_state.gs_302765;
    ...
    fn block_5<T: Tracer>(
        ...
        fn_state.n = s_5_8;
        // D s_5_10: read-var imm4H:u8
        let s_5_10: u8 = fn_state.imm4H;
        // D s_5_11: cast zx s_5_10 -> bv
        let s_5_11: Bits = Bits::new(s_5_10 as u128, 4u16);
        // D s_5_12: read-var imm4L:u8
        let s_5_12: u8 = fn_state.imm4L;
        ...
        // C s_5_23: const #32s : i
        let s_5_23: i128 = 32;
        // D s_5_24: cast zx s_5_22 -> bv
        let s_5_24: Bits = Bits::new(s_5_22 as u128, 8u16);
        // D s_5_25: bits-cast zx s_5_24 -> bv length s_5_23
        let s_5_25: Bits = s_5_24.zero_extend(s_5_23);
        // D s_5_26: cast reint s_5_25 -> u32
        let s_5_26: u32 = (s_5_25.value() as u32);
        // D s_5_27: write-var imm32 <= s_5_26
        fn_state.imm32 = s_5_26;
        ...
        // D s_5_33: write-var index <= s_5_32
        fn_state.index = s_5_32;
        // D s_5_34: read-var U:u8
        let s_5_34: bool = fn_state.U;
        ...
        // D s_5_39: write-var add <= s_5_38
        fn_state.add = s_5_38;
        // D s_5_40: read-var P:u8
        let s_5_40: bool = fn_state.P;
        // D s_5_41: cast zx s_5_40 -> bv
        let s_5_41: Bits = Bits::new(s_5_40 as u128, 1u16);
        // C s_5_42: const #0u : u8
        let s_5_42: bool = false;
        // C s_5_43: cast zx s_5_42 -> bv
        let s_5_43: Bits = Bits::new(s_5_42 as u128, 1u16);
        // D s_5_44: cmp-eq s_5_41 s_5_43
        let s_5_44: bool = ((s_5_41) == (s_5_43));
        // N s_5_45: branch s_5_44 b18 b6
        if s_5_44 {
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: write-var gs#302771 <= s_6_4
        fn_state.gs_302771 = s_6_4;
        // N s_6_6: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#302771:u8
        let s_7_0: bool = fn_state.gs_302771;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#302775 <= s_9_0
        fn_state.gs_302775 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#302775:u8
        let s_10_0: bool = fn_state.gs_302775;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_6: call execute_aarch32_instrs_STRH_i_OpA_A_txt(s_11_0, s_11_1, s_11_2, s_11_3, s_11_4, s_11_5)
        let s_11_6: () = execute_aarch32_instrs_STRH_i_OpA_A_txt(
            state,
            tracer,
            s_11_0,
            s_11_1,
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_5: write-var gs#302774 <= s_14_4
        fn_state.gs_302774 = s_14_4;
        // N s_14_6: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#302774:u8
        let s_15_0: bool = fn_state.gs_302774;
        // D s_15_1: write-var gs#302775 <= s_15_0
        fn_state.gs_302775 = s_15_0;
        // N s_15_2: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#302774 <= s_16_0
        fn_state.gs_302774 = s_16_0;
        // N s_16_2: jump b15
        return block_15(state, tracer, fn_state);
    }
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#302771 <= s_18_0
        fn_state.gs_302771 = s_18_0;
        // N s_18_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_5: write-var gs#302765 <= s_20_4
        fn_state.gs_302765 = s_20_4;
        // N s_20_6: jump b4
        return block_4(state, tracer, fn_state);
    }
}
