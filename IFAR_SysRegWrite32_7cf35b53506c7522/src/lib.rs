...
use common::*;
pub fn IFAR_SysRegWrite32_7cf35b53506c7522<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call IFAR_NS_write(s_6_1)
        let s_6_2: () = IFAR_NS_write(state, tracer, s_6_1);
        // N s_6_3: return
        return;
    }
    fn block_7<T: Tracer>(
        ...
        // D s_7_2: call IFAR_S_write(s_7_1)
        let s_7_2: () = IFAR_S_write(state, tracer, s_7_1);
        // N s_7_3: return
        return;
    }
    fn block_8<T: Tracer>(
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#129507 <= s_9_0
        fn_state.gs_129507 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#129507:u8
        let s_10_0: bool = fn_state.gs_129507;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_2: call IFAR_write(s_11_1)
        let s_11_2: () = IFAR_write(state, tracer, s_11_1);
        // N s_11_3: return
        return;
    }
    fn block_12<T: Tracer>(
        ...
        // D s_12_2: call IFAR_NS_write(s_12_1)
        let s_12_2: () = IFAR_NS_write(state, tracer, s_12_1);
        // N s_12_3: return
        return;
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_3: write-var gs#129507 <= s_13_2
        fn_state.gs_129507 = s_13_2;
        // N s_13_4: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#129508 <= s_15_0
        fn_state.gs_129508 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#129508:u8
        let s_16_0: bool = fn_state.gs_129508;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#129509 <= s_17_0
        fn_state.gs_129509 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#129509:u8
        let s_18_0: bool = fn_state.gs_129509;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#129510 <= s_20_0
        fn_state.gs_129510 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#129510:u8
        let s_21_0: bool = fn_state.gs_129510;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#129511 <= s_22_0
        fn_state.gs_129511 = s_22_0;
        // N s_22_2: jump b23
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_0: read-var gs#129511:u8
        let s_23_0: bool = fn_state.gs_129511;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#129512 <= s_25_0
        fn_state.gs_129512 = s_25_0;
        // N s_25_2: jump b26
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var gs#129512:u8
        let s_26_0: bool = fn_state.gs_129512;
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_1: write-var gs#129513 <= s_27_0
        fn_state.gs_129513 = s_27_0;
        // N s_27_2: jump b28
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_0: read-var gs#129513:u8
        let s_28_0: bool = fn_state.gs_129513;
    ...
    fn block_30<T: Tracer>(
        ...
        // D s_30_1: write-var gs#129514 <= s_30_0
        fn_state.gs_129514 = s_30_0;
        // N s_30_2: jump b31
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_0: read-var gs#129514:u8
        let s_31_0: bool = fn_state.gs_129514;
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_1: write-var gs#129515 <= s_32_0
        fn_state.gs_129515 = s_32_0;
        // N s_32_2: jump b33
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var gs#129515:u8
        let s_33_0: bool = fn_state.gs_129515;
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_1: write-var gs#129516 <= s_35_0
        fn_state.gs_129516 = s_35_0;
        // N s_35_2: jump b36
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_0: read-var gs#129516:u8
        let s_36_0: bool = fn_state.gs_129516;
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_2: call IFAR_write(s_37_1)
        let s_37_2: () = IFAR_write(state, tracer, s_37_1);
        // N s_37_3: return
        return;
    }
    fn block_38<T: Tracer>(
        ...
        // D s_38_2: call IFAR_NS_write(s_38_1)
        let s_38_2: () = IFAR_NS_write(state, tracer, s_38_1);
        // N s_38_3: return
        return;
    }
    fn block_39<T: Tracer>(
        ...
        // D s_39_3: write-var gs#129516 <= s_39_2
        fn_state.gs_129516 = s_39_2;
        // N s_39_4: jump b36
        return block_36(state, tracer, fn_state);
    }
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_5: write-var gs#129515 <= s_41_4
        fn_state.gs_129515 = s_41_4;
        // N s_41_6: jump b33
        return block_33(state, tracer, fn_state);
    }
    fn block_42<T: Tracer>(
        ...
        // D s_42_3: write-var gs#129514 <= s_42_2
        fn_state.gs_129514 = s_42_2;
        // N s_42_4: jump b31
        return block_31(state, tracer, fn_state);
    }
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_5: write-var gs#129513 <= s_44_4
        fn_state.gs_129513 = s_44_4;
        // N s_44_6: jump b28
        return block_28(state, tracer, fn_state);
    }
    fn block_45<T: Tracer>(
        ...
        // D s_45_4: write-var gs#129512 <= s_45_3
        fn_state.gs_129512 = s_45_3;
        // N s_45_5: jump b26
        return block_26(state, tracer, fn_state);
    }
    ...
    fn block_47<T: Tracer>(
        ...
        // D s_47_5: write-var gs#129511 <= s_47_4
        fn_state.gs_129511 = s_47_4;
        // N s_47_6: jump b23
        return block_23(state, tracer, fn_state);
    }
    fn block_48<T: Tracer>(
        ...
        // D s_48_3: write-var gs#129510 <= s_48_2
        fn_state.gs_129510 = s_48_2;
        // N s_48_4: jump b21
        return block_21(state, tracer, fn_state);
    }
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_5: write-var gs#129509 <= s_50_4
        fn_state.gs_129509 = s_50_4;
        // N s_50_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    fn block_51<T: Tracer>(
        ...
        // D s_51_4: write-var gs#129508 <= s_51_3
        fn_state.gs_129508 = s_51_3;
        // N s_51_5: jump b16
        return block_16(state, tracer, fn_state);
    }
