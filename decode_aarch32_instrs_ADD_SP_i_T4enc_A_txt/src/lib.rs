...
use common::*;
pub fn decode_aarch32_instrs_ADD_SP_i_T4enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i: bool,
    imm3: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_3: call execute_aarch32_instrs_ADD_SP_i_Op_A_txt(s_3_0, s_3_1, s_3_2)
        let s_3_3: () = execute_aarch32_instrs_ADD_SP_i_Op_A_txt(
            state,
            tracer,
            s_3_0,
            s_3_1,
