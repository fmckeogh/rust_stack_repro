...
use neq_int::*;
use HaveFeatLS64::*;
use execute_aarch64_instrs_memory_atomicops_ld_acc::*;
use common::*;
pub fn decode_ld64b_aarch64_instrs_memory_atomicops_ld_acc<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_22: write-var gs#157692 <= s_2_21
        fn_state.gs_157692 = s_2_21;
        // N s_2_23: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#157692:u8
        let s_3_0: bool = fn_state.gs_157692;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_14: call execute_aarch64_instrs_memory_atomicops_ld_acc(s_4_13, s_4_8, s_4_3, s_4_7, s_4_11)
        let s_4_14: () = execute_aarch64_instrs_memory_atomicops_ld_acc(
            state,
            tracer,
            s_4_13,
            s_4_8,
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #1u : u8
        let s_6_0: bool = true;
        // D s_6_1: write-var gs#157692 <= s_6_0
        fn_state.gs_157692 = s_6_0;
        // N s_6_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_7<T: Tracer>(
