...
use u__get_DCZID_EL0::*;
use u_get_HCR_EL2_Type_E2H::*;
use u_get_HFGRTR_EL2_Type_DCZID_EL0::*;
use IsFeatureImplemented::*;
use AArch64_SystemAccessTrap::*;
use EL2Enabled::*;
use u_get_HCR_EL2_Type_TGE::*;
use common::*;
pub fn DCZID_EL0_SysRegRead_9bb2971f34b1558f<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        gs_61245: bool,
        gs_61247: bool,
        ga_64510: ProductType5c790c8ef59cc8b2,
        gs_61240: bool,
        gs_61241: bool,
        u__SCR_EL3_FGTEn: bool,
        ga_64491: ProductType5c790c8ef59cc8b2,
        gs_61242: bool,
        ga_64506: ProductType5c790c8ef59cc8b2,
        ga_64502: ProductType5c790c8ef59cc8b2,
        gs_61244: bool,
        u__PSTATE_EL: u8,
        gs_61239: bool,
        gs_61248: bool,
        gs_61246: bool,
        u__HFGRTR_EL2_DCZID_EL0: bool,
        el: u8,
        op0: u8,
        op1: u8,
        CRn: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_9: call _get_HFGRTR_EL2_Type_DCZID_EL0(s_0_8)
        let s_0_9: bool = u_get_HFGRTR_EL2_Type_DCZID_EL0(state, tracer, s_0_8);
        // D s_0_10: write-var __HFGRTR_EL2_DCZID_EL0 <= s_0_9
        fn_state.u__HFGRTR_EL2_DCZID_EL0 = s_0_9;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // C s_5_1: const #102208u : u32
        let s_5_1: u32 = 102208;
        ...
        // D s_5_3: call __get_DCZID_EL0(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_DCZID_EL0(state, tracer, s_5_2);
        // D s_5_4: write-var ga#64510 <= s_5_3
        fn_state.ga_64510 = s_5_3;
        // D s_5_5: read-var ga#64510.0:struct
        let s_5_5: u64 = fn_state.ga_64510._0;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 64;
        // C s_6_1: const #102208u : u32
        let s_6_1: u32 = 102208;
        ...
        // D s_6_3: call __get_DCZID_EL0(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_DCZID_EL0(state, tracer, s_6_2);
        // D s_6_4: write-var ga#64506 <= s_6_3
        fn_state.ga_64506 = s_6_3;
        // D s_6_5: read-var ga#64506.0:struct
        let s_6_5: u64 = fn_state.ga_64506._0;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#61239 <= s_8_0
        fn_state.gs_61239 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#61239:u8
        let s_9_0: bool = fn_state.gs_61239;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#61241 <= s_10_0
        fn_state.gs_61241 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#61241:u8
        let s_11_0: bool = fn_state.gs_61241;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#61242 <= s_12_0
        fn_state.gs_61242 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#61242:u8
        let s_13_0: bool = fn_state.gs_61242;
    ...
    fn block_14<T: Tracer>(
        ...
        let s_14_0: i64 = 64;
        // C s_14_1: const #102208u : u32
        let s_14_1: u32 = 102208;
        ...
        // D s_14_3: call __get_DCZID_EL0(s_14_2)
        let s_14_3: ProductType5c790c8ef59cc8b2 = u__get_DCZID_EL0(
            state,
            tracer,
            s_14_2,
        );
        // D s_14_4: write-var ga#64502 <= s_14_3
        fn_state.ga_64502 = s_14_3;
        // D s_14_5: read-var ga#64502.0:struct
        let s_14_5: u64 = fn_state.ga_64502._0;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var __HFGRTR_EL2_DCZID_EL0:u8
        let s_16_0: bool = fn_state.u__HFGRTR_EL2_DCZID_EL0;
        ...
        // D s_16_5: write-var gs#61242 <= s_16_4
        fn_state.gs_61242 = s_16_4;
        // N s_16_6: jump b13
        return block_13(state, tracer, fn_state);
    }
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_5: write-var gs#61240 <= s_18_4
        fn_state.gs_61240 = s_18_4;
        // N s_18_6: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#61240:u8
        let s_19_0: bool = fn_state.gs_61240;
        // D s_19_1: write-var gs#61241 <= s_19_0
        fn_state.gs_61241 = s_19_0;
        // N s_19_2: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#61240 <= s_20_0
        fn_state.gs_61240 = s_20_0;
        // N s_20_2: jump b19
        return block_19(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_2: write-var gs#61239 <= s_21_1
        fn_state.gs_61239 = s_21_1;
        // N s_21_3: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_1: write-var gs#61244 <= s_23_0
        fn_state.gs_61244 = s_23_0;
        // N s_23_2: jump b24
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_0: read-var gs#61244:u8
        let s_24_0: bool = fn_state.gs_61244;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#61245 <= s_25_0
        fn_state.gs_61245 = s_25_0;
        // N s_25_2: jump b26
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var gs#61245:u8
        let s_26_0: bool = fn_state.gs_61245;
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_1: write-var gs#61247 <= s_27_0
        fn_state.gs_61247 = s_27_0;
        // N s_27_2: jump b28
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_0: read-var gs#61247:u8
        let s_28_0: bool = fn_state.gs_61247;
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_1: write-var gs#61248 <= s_29_0
        fn_state.gs_61248 = s_29_0;
        // N s_29_2: jump b30
    ...
    fn block_30<T: Tracer>(
        ...
        // D s_30_0: read-var gs#61248:u8
        let s_30_0: bool = fn_state.gs_61248;
    ...
    fn block_31<T: Tracer>(
        ...
        let s_31_0: i64 = 64;
        // C s_31_1: const #102208u : u32
        let s_31_1: u32 = 102208;
        // D s_31_2: read-reg s_31_1:struct
        let s_31_2: ProductType5c790c8ef59cc8b2 = {
            let value = state
                .read_register::<ProductType5c790c8ef59cc8b2>(s_31_1 as isize);
            tracer.read_register(s_31_1 as isize, value);
            value
        };
        // D s_31_3: call __get_DCZID_EL0(s_31_2)
        let s_31_3: ProductType5c790c8ef59cc8b2 = u__get_DCZID_EL0(
            state,
            tracer,
            s_31_2,
        );
        // D s_31_4: write-var ga#64491 <= s_31_3
        fn_state.ga_64491 = s_31_3;
        // D s_31_5: read-var ga#64491.0:struct
        let s_31_5: u64 = fn_state.ga_64491._0;
        // D s_31_6: cast zx s_31_5 -> bv
        let s_31_6: Bits = Bits::new(s_31_5 as u128, 64u16);
        // D s_31_7: read-var t:i
        let s_31_7: i128 = fn_state.t;
        // D s_31_8: call X_set(s_31_7, s_31_0, s_31_6)
        let s_31_8: () = X_set(state, tracer, s_31_7, s_31_0, s_31_6);
        // N s_31_9: return
        return;
    }
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var __HFGRTR_EL2_DCZID_EL0:u8
        let s_33_0: bool = fn_state.u__HFGRTR_EL2_DCZID_EL0;
        ...
        // D s_33_5: write-var gs#61248 <= s_33_4
        fn_state.gs_61248 = s_33_4;
        // N s_33_6: jump b30
        return block_30(state, tracer, fn_state);
    }
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_5: write-var gs#61246 <= s_35_4
        fn_state.gs_61246 = s_35_4;
        // N s_35_6: jump b36
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_0: read-var gs#61246:u8
        let s_36_0: bool = fn_state.gs_61246;
        // D s_36_1: write-var gs#61247 <= s_36_0
        fn_state.gs_61247 = s_36_0;
        // N s_36_2: jump b28
        return block_28(state, tracer, fn_state);
    }
    fn block_37<T: Tracer>(
        ...
        // D s_37_1: write-var gs#61246 <= s_37_0
        fn_state.gs_61246 = s_37_0;
        // N s_37_2: jump b36
        return block_36(state, tracer, fn_state);
    }
    fn block_38<T: Tracer>(
        ...
        // D s_38_2: write-var gs#61245 <= s_38_1
        fn_state.gs_61245 = s_38_1;
        // N s_38_3: jump b26
        return block_26(state, tracer, fn_state);
    }
    fn block_39<T: Tracer>(
        ...
        // D s_39_21: write-var gs#61244 <= s_39_20
        fn_state.gs_61244 = s_39_20;
        // N s_39_22: jump b24
        return block_24(state, tracer, fn_state);
    }
}
