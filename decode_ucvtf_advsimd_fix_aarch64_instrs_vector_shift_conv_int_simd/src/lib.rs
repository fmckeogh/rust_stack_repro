...
use common::*;
pub fn decode_ucvtf_advsimd_fix_aarch64_instrs_vector_shift_conv_int_simd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_0: const #1u : u8
        let s_2_0: bool = true;
        // D s_2_1: write-var gs#167484 <= s_2_0
        fn_state.gs_167484 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#167484:u8
        let s_3_0: bool = fn_state.gs_167484;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#167489 <= s_4_0
        fn_state.gs_167489 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#167489:u8
        let s_5_0: bool = fn_state.gs_167489;
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #1u : u8
        let s_8_0: bool = true;
        // D s_8_1: write-var gs#167495 <= s_8_0
        fn_state.gs_167495 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#167495:u8
        let s_9_0: bool = fn_state.gs_167495;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#167500 <= s_11_0
        fn_state.gs_167500 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#167500:u8
        let s_12_0: bool = fn_state.gs_167500;
    ...
    fn block_13<T: Tracer>(
        ...
        let s_13_0: i64 = 16;
        // D s_13_1: write-var ga#265095 <= s_13_0
        fn_state.ga_265095 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var ga#265095:i64
        let s_14_0: i64 = fn_state.ga_265095;
    ...
    fn block_15<T: Tracer>(
        ...
        let s_15_0: i64 = 64;
        // D s_15_1: write-var ga#265097 <= s_15_0
        fn_state.ga_265097 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var ga#265097:i64
        let s_16_0: i64 = fn_state.ga_265097;
    ...
    fn block_17<T: Tracer>(
        ...
        let s_17_0: i64 = 128;
        // D s_17_1: write-var ga#265097 <= s_17_0
        fn_state.ga_265097 = s_17_0;
        // N s_17_2: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_18<T: Tracer>(
        ...
        let s_18_0: i64 = 32;
        // D s_18_1: write-var ga#265095 <= s_18_0
        fn_state.ga_265095 = s_18_0;
        // N s_18_2: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#167500 <= s_19_0
        fn_state.gs_167500 = s_19_0;
        // N s_19_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        let s_20_0: i64 = 64;
        // D s_20_1: write-var ga#265095 <= s_20_0
        fn_state.ga_265095 = s_20_0;
        // N s_20_2: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#167495 <= s_21_0
        fn_state.gs_167495 = s_21_0;
        // N s_21_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_1: write-var gs#167489 <= s_24_0
        fn_state.gs_167489 = s_24_0;
        // N s_24_2: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#167484 <= s_25_0
        fn_state.gs_167484 = s_25_0;
        // N s_25_2: jump b3
        return block_3(state, tracer, fn_state);
    }
