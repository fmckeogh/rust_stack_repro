...
use R_set::*;
use common::*;
pub fn execute_aarch32_instrs_LDR_i_OpT_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    add: bool,
    imm32: u32,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#297701 <= s_5_0
        fn_state.gs_297701 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#297701:u8
        let s_6_0: bool = fn_state.gs_297701;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_3: write-var gs#880351 <= s_8_2
        fn_state.gs_880351 = s_8_2;
        // N s_8_4: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#880351:bv
        let s_9_0: Bits = fn_state.gs_880351;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_4: write-var gs#297701 <= s_18_3
        fn_state.gs_297701 = s_18_3;
        // N s_18_5: jump b6
        return block_6(state, tracer, fn_state);
    }
