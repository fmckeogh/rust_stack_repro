...
use common::*;
pub fn decode_aarch32_instrs_MCR_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    opc1: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 15;
        // D s_3_1: write-var ga#344949 <= s_3_0
        fn_state.ga_344949 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#344949:i64
        let s_4_0: i64 = fn_state.ga_344949;
    ...
    fn block_7<T: Tracer>(
        ...
        let s_7_0: i64 = 14;
        // D s_7_1: write-var ga#344949 <= s_7_0
        fn_state.ga_344949 = s_7_0;
        // N s_7_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
