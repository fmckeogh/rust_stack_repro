...
use common::*;
pub fn decode_aarch32_instrs_VMSR_T1enc_AS_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    reg: u8,
    Rt: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_0: const #1u : u8
        let s_3_0: bool = true;
        // D s_3_1: write-var gs#323739 <= s_3_0
        fn_state.gs_323739 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#323739:u8
        let s_4_0: bool = fn_state.gs_323739;
        // D s_4_1: not s_4_0
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#323744 <= s_5_0
        fn_state.gs_323744 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#323744:u8
        let s_6_0: bool = fn_state.gs_323744;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_3: write-var gs#323748 <= s_12_2
        fn_state.gs_323748 = s_12_2;
        // N s_12_4: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#323748:u8
        let s_13_0: bool = fn_state.gs_323748;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#323748 <= s_19_0
        fn_state.gs_323748 = s_19_0;
        // N s_19_2: jump b13
        return block_13(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_5: write-var gs#323744 <= s_20_4
        fn_state.gs_323744 = s_20_4;
        // N s_20_6: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#323739 <= s_21_0
        fn_state.gs_323739 = s_21_0;
        // N s_21_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
