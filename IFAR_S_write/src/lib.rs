...
use HIFAR_read::*;
use common::*;
pub fn IFAR_S_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_1<T: Tracer>(
        ...
        // C s_1_3: const #32s : i
        let s_1_3: i128 = 32;
        // D s_1_4: read-var r:u32
        let s_1_4: u32 = fn_state.r;
        // D s_1_5: cast zx s_1_4 -> bv
        let s_1_5: Bits = Bits::new(s_1_4 as u128, 32u16);
        // D s_1_6: bit-extract s_1_5 s_1_2 s_1_3
        ...
        // C s_1_9: const #0s : i
        let s_1_9: i128 = 0;
        // S s_1_10: cast zx s_1_1 -> bv
        let s_1_10: Bits = Bits::new(s_1_1 as u128, 32u16);
        // D s_1_11: cast zx s_1_7 -> bv
        let s_1_11: Bits = Bits::new(s_1_7 as u128, 32u16);
        // C s_1_12: const #1u : u64
        let s_1_12: u64 = 1;
        // C s_1_13: cast zx s_1_12 -> bv
        let s_1_13: Bits = Bits::new(s_1_12 as u128, 64u16);
        // C s_1_14: lsl s_1_13 s_1_8
        let s_1_14: Bits = s_1_13 << s_1_8;
        // C s_1_15: sub s_1_14 s_1_13
        let s_1_15: Bits = ((s_1_14) - (s_1_13));
        // D s_1_16: and s_1_11 s_1_15
        let s_1_16: Bits = ((s_1_11) & (s_1_15));
        // D s_1_17: lsl s_1_16 s_1_9
        let s_1_17: Bits = s_1_16 << s_1_9;
        // C s_1_18: lsl s_1_15 s_1_9
        let s_1_18: Bits = s_1_15 << s_1_9;
        // C s_1_19: cmpl s_1_18
        let s_1_19: Bits = !s_1_18;
        // S s_1_20: and s_1_10 s_1_19
        let s_1_20: Bits = ((s_1_10) & (s_1_19));
        // D s_1_21: or s_1_20 s_1_17
        let s_1_21: Bits = ((s_1_20) | (s_1_17));
        // D s_1_22: cast reint s_1_21 -> u32
        let s_1_22: u32 = (s_1_21.value() as u32);
        // D s_1_23: call HIFAR_write(s_1_22)
        let s_1_23: () = HIFAR_write(state, tracer, s_1_22);
        // N s_1_24: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_1: const #14720u : u32
        let s_2_1: u32 = 14720;
        // N s_2_2: write-reg s_2_1 <= s_2_0
        let s_2_2: () = {
            state.write_register::<u32>(s_2_1 as isize, s_2_0);
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_1: const #32s : i
        let s_3_1: i128 = 32;
        // D s_3_2: read-var r:u32
        let s_3_2: u32 = fn_state.r;
        ...
        // C s_3_6: const #32s : i
        let s_3_6: i128 = 32;
        // C s_3_7: const #102616u : u32
        let s_3_7: u32 = 102616;
        // D s_3_8: read-reg s_3_7:u64
        let s_3_8: u64 = {
            let value = state.read_register::<u64>(s_3_7 as isize);
            tracer.read_register(s_3_7 as isize, value);
            value
        };
        // D s_3_9: cast zx s_3_8 -> bv
        let s_3_9: Bits = Bits::new(s_3_8 as u128, 64u16);
        // D s_3_10: cast zx s_3_5 -> bv
        let s_3_10: Bits = Bits::new(s_3_5 as u128, 32u16);
        ...
        // D s_3_17: lsl s_3_16 s_3_6
        let s_3_17: Bits = s_3_16 << s_3_6;
        // C s_3_18: lsl s_3_15 s_3_6
        let s_3_18: Bits = s_3_15 << s_3_6;
        ...
        // D s_3_22: cast reint s_3_21 -> u64
        let s_3_22: u64 = (s_3_21.value() as u64);
        // C s_3_23: const #102616u : u32
        let s_3_23: u32 = 102616;
        // N s_3_24: write-reg s_3_23 <= s_3_22
        let s_3_24: () = {
            state.write_register::<u64>(s_3_23 as isize, s_3_22);
