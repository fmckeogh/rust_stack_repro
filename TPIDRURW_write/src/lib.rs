...
use common::*;
pub fn TPIDRURW_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#34908 <= s_1_0
        fn_state.gs_34908 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#34908:u8
        let s_2_0: bool = fn_state.gs_34908;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var r:u32
        let s_3_0: u32 = fn_state.r;
        // D s_3_1: call TPIDRURW_NS_write(s_3_0)
        let s_3_1: () = TPIDRURW_NS_write(state, tracer, s_3_0);
        // N s_3_2: return
        return;
    }
    fn block_4<T: Tracer>(
        ...
        // C s_4_1: const #22496u : u32
        let s_4_1: u32 = 22496;
        // N s_4_2: write-reg s_4_1 <= s_4_0
        let s_4_2: () = {
            state.write_register::<u32>(s_4_1 as isize, s_4_0);
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#34908 <= s_5_3
        fn_state.gs_34908 = s_5_3;
        // N s_5_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
