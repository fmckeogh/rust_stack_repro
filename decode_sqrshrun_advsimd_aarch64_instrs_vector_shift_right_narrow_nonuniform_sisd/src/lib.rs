...
use execute_aarch64_instrs_vector_shift_right_narrow_nonuniform_sisd::*;
use common::*;
pub fn decode_sqrshrun_advsimd_aarch64_instrs_vector_shift_right_narrow_nonuniform_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, op: bool, immb: u8, immh: u8) -> () {
    #[derive(Default)]
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_36: read-var esize:i
        let s_2_36: i128 = fn_state.esize;
        // D s_2_37: call __id(s_2_36)
        let s_2_37: i128 = u__id(state, tracer, s_2_36);
        // C s_2_38: const #4s : i
        let s_2_38: i128 = 4;
        // D s_2_39: cmp-eq s_2_37 s_2_38
        let s_2_39: bool = ((s_2_37) == (s_2_38));
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#171923 <= s_3_3
        fn_state.gs_171923 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#171923:u8
        let s_4_0: bool = fn_state.gs_171923;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#171925 <= s_5_3
        fn_state.gs_171925 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#171925:u8
        let s_6_0: bool = fn_state.gs_171925;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#171927 <= s_7_3
        fn_state.gs_171927 = s_7_3;
        // N s_7_5: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#171927:u8
        let s_8_0: bool = fn_state.gs_171927;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: write-var gs#171929 <= s_9_3
        fn_state.gs_171929 = s_9_3;
        // N s_9_5: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#171929:u8
        let s_10_0: bool = fn_state.gs_171929;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#171939 <= s_11_0
        fn_state.gs_171939 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#171939:u8
        let s_12_0: bool = fn_state.gs_171939;
        ...
        // D s_12_12: call execute_aarch64_instrs_vector_shift_right_narrow_nonuniform_sisd(s_12_8, s_12_3, s_12_6, s_12_5, s_12_9, s_12_7, s_12_10, s_12_11)
        let s_12_12: () = execute_aarch64_instrs_vector_shift_right_narrow_nonuniform_sisd(
            state,
            tracer,
            s_12_8,
            s_12_3,
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_4: write-var gs#171932 <= s_14_3
        fn_state.gs_171932 = s_14_3;
        // N s_14_5: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#171932:u8
        let s_15_0: bool = fn_state.gs_171932;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_4: write-var gs#171934 <= s_16_3
        fn_state.gs_171934 = s_16_3;
        // N s_16_5: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#171934:u8
        let s_17_0: bool = fn_state.gs_171934;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_4: write-var gs#171936 <= s_18_3
        fn_state.gs_171936 = s_18_3;
        // N s_18_5: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#171936:u8
        let s_19_0: bool = fn_state.gs_171936;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_4: write-var gs#171938 <= s_20_3
        fn_state.gs_171938 = s_20_3;
        // N s_20_5: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#171938:u8
        let s_21_0: bool = fn_state.gs_171938;
        // D s_21_1: write-var gs#171939 <= s_21_0
        fn_state.gs_171939 = s_21_0;
        // N s_21_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#171938 <= s_22_0
        fn_state.gs_171938 = s_22_0;
        // N s_22_2: jump b21
        return block_21(state, tracer, fn_state);
    }
    fn block_23<T: Tracer>(
        ...
        // D s_23_1: write-var gs#171936 <= s_23_0
        fn_state.gs_171936 = s_23_0;
        // N s_23_2: jump b19
        return block_19(state, tracer, fn_state);
    }
    fn block_24<T: Tracer>(
        ...
        // D s_24_1: write-var gs#171934 <= s_24_0
        fn_state.gs_171934 = s_24_0;
        // N s_24_2: jump b17
        return block_17(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#171932 <= s_25_0
        fn_state.gs_171932 = s_25_0;
        // N s_25_2: jump b15
        return block_15(state, tracer, fn_state);
    }
    fn block_26<T: Tracer>(
        ...
        // D s_26_1: write-var gs#171929 <= s_26_0
        fn_state.gs_171929 = s_26_0;
        // N s_26_2: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_27<T: Tracer>(
        ...
        // D s_27_1: write-var gs#171927 <= s_27_0
        fn_state.gs_171927 = s_27_0;
        // N s_27_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_1: write-var gs#171925 <= s_28_0
        fn_state.gs_171925 = s_28_0;
        // N s_28_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_1: write-var gs#171923 <= s_29_0
        fn_state.gs_171923 = s_29_0;
        // N s_29_2: jump b4
        return block_4(state, tracer, fn_state);
    }
