...
use HaveSVE::*;
use HaveSME::*;
use execute_CTERMEQ_RR__::*;
use common::*;
pub fn decode_CTERMEQ_RR__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    sz: bool,
    Rm: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#192813 <= s_1_0
        fn_state.gs_192813 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#192813:u8
        let s_2_0: bool = fn_state.gs_192813;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_16: const #0u : u32
        let s_3_16: u32 = 0;
        // D s_3_17: call execute_CTERMEQ_RR__(s_3_15, s_3_13, s_3_9, s_3_16)
        let s_3_17: () = execute_CTERMEQ_RR__(
            state,
            tracer,
            s_3_15,
            s_3_13,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: write-var gs#192813 <= s_5_2
        fn_state.gs_192813 = s_5_2;
        // N s_5_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
