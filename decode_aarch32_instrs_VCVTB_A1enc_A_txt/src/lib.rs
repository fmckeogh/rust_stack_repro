...
use common::*;
pub fn decode_aarch32_instrs_VCVTB_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    D: bool,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_6: read-var sz:u8
        let s_2_6: bool = fn_state.sz;
        ...
        // D s_2_11: write-var uses_double <= s_2_10
        fn_state.uses_double = s_2_10;
        // D s_2_12: read-var op:u8
        let s_2_12: bool = fn_state.op;
        ...
        // D s_2_17: write-var convert_from_half <= s_2_16
        fn_state.convert_from_half = s_2_16;
        // D s_2_18: read-var T:u8
        let s_2_18: bool = fn_state.T;
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 0;
        // D s_3_1: write-var ga#352240 <= s_3_0
        fn_state.ga_352240 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#352240:i64
        let s_4_0: i64 = fn_state.ga_352240;
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 16;
        // D s_10_1: write-var ga#352240 <= s_10_0
        fn_state.ga_352240 = s_10_0;
        // N s_10_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
