...
pub fn u__get_SDCR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #3879813119u : u32
        let s_0_3: u32 = 3879813119;
        ...
        // D s_0_11: tail-call Mk_SDCR_Type(s_0_10)
        return Mk_SDCR_Type(state, tracer, s_0_10);
    }
}
