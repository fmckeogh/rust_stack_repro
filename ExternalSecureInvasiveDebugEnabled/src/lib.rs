...
use common::*;
pub fn ExternalSecureInvasiveDebugEnabled<T: Tracer>(
    state: &mut State,
    tracer: &T,
    gs_2077: (),
) -> bool {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#2078 <= s_1_0
        fn_state.gs_2078 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#2078:u8
        let s_2_0: bool = fn_state.gs_2078;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_0: const #() : ()
        let s_3_0: () = ();
        // S s_3_1: call ExternalInvasiveDebugEnabled(s_3_0)
        let s_3_1: bool = ExternalInvasiveDebugEnabled(state, tracer, s_3_0);
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#2080 <= s_4_0
        fn_state.gs_2080 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#2080:u8
        let s_5_0: bool = fn_state.gs_2080;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#2080 <= s_7_3
        fn_state.gs_2080 = s_7_3;
        // N s_7_5: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #() : ()
        let s_9_0: () = ();
        // S s_9_1: call SecureOnlyImplementation(s_9_0)
        let s_9_1: bool = SecureOnlyImplementation(state, tracer, s_9_0);
        // S s_9_2: not s_9_1
        let s_9_2: bool = !s_9_1;
        // D s_9_3: write-var gs#2078 <= s_9_2
        fn_state.gs_2078 = s_9_2;
        // N s_9_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
