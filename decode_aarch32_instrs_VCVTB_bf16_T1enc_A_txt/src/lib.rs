...
use execute_aarch32_instrs_VCVTB_bf16_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_VCVTB_bf16_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Vd: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_0: const #() : ()
        let s_2_0: () = ();
        // S s_2_1: call HaveAArch32BF16Ext(s_2_0)
        let s_2_1: bool = HaveAArch32BF16Ext(state, tracer, s_2_0);
        // S s_2_2: not s_2_1
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_32: call execute_aarch32_instrs_VCVTB_bf16_Op_A_txt(s_3_15, s_3_31)
        let s_3_32: () = execute_aarch32_instrs_VCVTB_bf16_Op_A_txt(
            state,
            tracer,
            s_3_15,
            s_3_31,
