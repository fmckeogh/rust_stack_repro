...
use R_set::*;
use common::*;
pub fn execute_aarch32_instrs_UQADD8_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_76: cast zx s_0_75 -> i
        let s_0_76: i128 = (s_0_75.value() as i128);
        ...
        // D s_0_90: cast zx s_0_89 -> i
        let s_0_90: i128 = (s_0_89.value() as i128);
        ...
        // D s_0_108: cast zx s_0_107 -> i
        let s_0_108: i128 = (s_0_107.value() as i128);
        ...
        // D s_0_122: cast zx s_0_121 -> i
        let s_0_122: i128 = (s_0_121.value() as i128);
        ...
        // C s_0_131: const #8s : i64
        let s_0_131: i64 = 8;
        // D s_0_132: cast zx s_0_31 -> i
        let s_0_132: i128 = (i128::try_from(s_0_31).unwrap());
        // C s_0_133: cast zx s_0_131 -> i
        let s_0_133: i128 = (i128::try_from(s_0_131).unwrap());
        // D s_0_134: call UnsignedSat(s_0_132, s_0_133)
        let s_0_134: Bits = UnsignedSat(state, tracer, s_0_132, s_0_133);
        ...
        // C s_0_157: const #8s : i64
        let s_0_157: i64 = 8;
        // D s_0_158: cast zx s_0_63 -> i
        let s_0_158: i128 = (i128::try_from(s_0_63).unwrap());
        // C s_0_159: cast zx s_0_157 -> i
        let s_0_159: i128 = (i128::try_from(s_0_157).unwrap());
        // D s_0_160: call UnsignedSat(s_0_158, s_0_159)
        let s_0_160: Bits = UnsignedSat(state, tracer, s_0_158, s_0_159);
        ...
        // C s_0_183: const #8s : i64
        let s_0_183: i64 = 8;
        // D s_0_184: cast zx s_0_95 -> i
        let s_0_184: i128 = (i128::try_from(s_0_95).unwrap());
        // C s_0_185: cast zx s_0_183 -> i
        let s_0_185: i128 = (i128::try_from(s_0_183).unwrap());
        // D s_0_186: call UnsignedSat(s_0_184, s_0_185)
        let s_0_186: Bits = UnsignedSat(state, tracer, s_0_184, s_0_185);
        ...
        // C s_0_209: const #8s : i64
        let s_0_209: i64 = 8;
        // D s_0_210: cast zx s_0_127 -> i
        let s_0_210: i128 = (i128::try_from(s_0_127).unwrap());
        // C s_0_211: cast zx s_0_209 -> i
        let s_0_211: i128 = (i128::try_from(s_0_209).unwrap());
        // D s_0_212: call UnsignedSat(s_0_210, s_0_211)
        let s_0_212: Bits = UnsignedSat(state, tracer, s_0_210, s_0_211);
