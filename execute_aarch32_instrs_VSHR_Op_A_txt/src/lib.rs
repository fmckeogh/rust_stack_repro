...
use D_read::*;
use common::*;
pub fn execute_aarch32_instrs_VSHR_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d__arg: i64,
    elements: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#7810 <= s_0_2
        fn_state.esizeshadow_7810 = s_0_2;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_6: write-var gs#319094 <= s_1_5
        fn_state.gs_319094 = s_1_5;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#319094:i64
        let s_2_1: i64 = fn_state.gs_319094;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_6: write-var gs#319100 <= s_3_5
        fn_state.gs_319100 = s_3_5;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#319100:i64
        let s_4_1: i64 = fn_state.gs_319100;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_8: read-var esizeshadow#7810:i64
        let s_5_8: i64 = fn_state.esizeshadow_7810;
        ...
        // D s_5_29: read-var esizeshadow#7810:i64
        let s_5_29: i64 = fn_state.esizeshadow_7810;
        ...
        // C s_5_32: const #1s : i
        let s_5_32: i128 = 1;
        // D s_5_33: read-var esizeshadow#7810:i64
        let s_5_33: i64 = fn_state.esizeshadow_7810;
        // D s_5_34: cast zx s_5_33 -> i
        let s_5_34: i128 = (i128::try_from(s_5_33).unwrap());
        // D s_5_35: sub s_5_34 s_5_32
        let s_5_35: i128 = ((s_5_34) - (s_5_32));
        ...
        // D s_5_39: call integer_subrange(s_5_19, s_5_38, s_5_37)
        let s_5_39: Bits = integer_subrange(state, tracer, s_5_19, s_5_38, s_5_37);
        // D s_5_40: cast zx s_5_28 -> bv
        let s_5_40: Bits = Bits::new(s_5_28 as u128, 64u16);
        // D s_5_41: read-var e:i64
        let s_5_41: i64 = fn_state.e;
        // D s_5_42: cast zx s_5_41 -> i
        let s_5_42: i128 = (i128::try_from(s_5_41).unwrap());
        // D s_5_43: cast zx s_5_31 -> i
        let s_5_43: i128 = (i128::try_from(s_5_31).unwrap());
        // D s_5_44: call Elem_set(s_5_40, s_5_42, s_5_43, s_5_39)
        let s_5_44: Bits = Elem_set(state, tracer, s_5_40, s_5_42, s_5_43, s_5_39);
        // D s_5_45: cast reint s_5_44 -> u64
        let s_5_45: u64 = (s_5_44.value() as u64);
        // D s_5_46: call D_set(s_5_23, s_5_45)
        let s_5_46: () = D_set(state, tracer, s_5_23, s_5_45);
