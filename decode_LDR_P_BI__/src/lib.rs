...
use HaveSVE::*;
use CurrentVL_read::*;
use execute_LDR_P_BI__::*;
use HaveSME::*;
use common::*;
pub fn decode_LDR_P_BI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm9h: u8,
    imm9l: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#225727 <= s_1_0
        fn_state.gs_225727 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#225727:u8
        let s_2_0: bool = fn_state.gs_225727;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var Pt:u8
        let s_3_0: u8 = fn_state.Pt;
        ...
        fn_state.n = s_3_8;
        // D s_3_10: read-var imm9h:u8
        let s_3_10: u8 = fn_state.imm9h;
        // D s_3_11: cast zx s_3_10 -> bv
        let s_3_11: Bits = Bits::new(s_3_10 as u128, 6u16);
        // D s_3_12: read-var imm9l:u8
        let s_3_12: u8 = fn_state.imm9l;
        ...
        // D s_3_22: cast reint s_3_21 -> u9
        let s_3_22: u16 = (s_3_21.value() as u16);
        // D s_3_23: cast zx s_3_22 -> bv
        let s_3_23: Bits = Bits::new(s_3_22 as u128, 9u16);
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 128;
        // D s_4_1: read-var imm:i64
        let s_4_1: i64 = fn_state.imm;
        ...
        // D s_4_5: call execute_LDR_P_BI__(s_4_0, s_4_2, s_4_3, s_4_4)
        let s_4_5: () = execute_LDR_P_BI__(state, tracer, s_4_0, s_4_2, s_4_3, s_4_4);
        // N s_4_6: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 256;
        // D s_6_1: read-var imm:i64
        let s_6_1: i64 = fn_state.imm;
        ...
        // D s_6_5: call execute_LDR_P_BI__(s_6_0, s_6_2, s_6_3, s_6_4)
        let s_6_5: () = execute_LDR_P_BI__(state, tracer, s_6_0, s_6_2, s_6_3, s_6_4);
        // N s_6_6: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 512;
        // D s_8_1: read-var imm:i64
        let s_8_1: i64 = fn_state.imm;
        ...
        // D s_8_5: call execute_LDR_P_BI__(s_8_0, s_8_2, s_8_3, s_8_4)
        let s_8_5: () = execute_LDR_P_BI__(state, tracer, s_8_0, s_8_2, s_8_3, s_8_4);
        // N s_8_6: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 1024;
        // D s_10_1: read-var imm:i64
        let s_10_1: i64 = fn_state.imm;
        ...
        // D s_10_5: call execute_LDR_P_BI__(s_10_0, s_10_2, s_10_3, s_10_4)
        let s_10_5: () = execute_LDR_P_BI__(
            state,
            tracer,
            s_10_0,
            s_10_2,
    ...
    fn block_12<T: Tracer>(
        ...
        let s_12_0: i64 = 2048;
        // D s_12_1: read-var imm:i64
        let s_12_1: i64 = fn_state.imm;
        ...
        // D s_12_5: call execute_LDR_P_BI__(s_12_0, s_12_2, s_12_3, s_12_4)
        let s_12_5: () = execute_LDR_P_BI__(
            state,
            tracer,
            s_12_0,
            s_12_2,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#225727 <= s_15_2
        fn_state.gs_225727 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
