...
extern crate alloc;
use common::*;
pub fn HACR_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #14904u : u32
        let s_0_23: u32 = 14904;
        ...
        // C s_0_25: const #90440u : u32
        let s_0_25: u32 = 90440;
