...
use AddWithCarry::*;
use common::*;
pub fn execute_aarch32_instrs_SBC_rr_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        nzcv: u8,
        gs_883478: ProductTyped54bc449dd09e5bd,
        d: i64,
        m: i64,
        n: i64,
        s: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_32: cast zx s_0_26 -> bv
        let s_0_32: Bits = Bits::new(s_0_26 as u128, 32u16);
        // D s_0_33: cast zx s_0_29 -> bv
        let s_0_33: Bits = Bits::new(s_0_29 as u128, 32u16);
        ...
        // D s_0_35: write-var gs#883478 <= s_0_34
        fn_state.gs_883478 = s_0_34;
        // D s_0_36: read-var gs#883478.0:struct
        let s_0_36: Bits = fn_state.gs_883478._0;
        // D s_0_37: cast reint s_0_36 -> u32
        let s_0_37: u32 = (s_0_36.value() as u32);
        // D s_0_38: read-var gs#883478.1:struct
        let s_0_38: u8 = fn_state.gs_883478._1;
