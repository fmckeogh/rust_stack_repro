...
use execute_aarch64_instrs_memory_mcpymset_cpy::*;
use ConstrainUnpredictable::*;
use EndOfInstruction::*;
use HaveFeatMOPS::*;
use common::*;
pub fn decode_cpyprtrn_aarch64_instrs_memory_mcpymset_cpy<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var stageshadow#1145 <= s_4_0
        fn_state.stageshadow_1145 = s_4_0;
        // C s_4_2: const #() : ()
        let s_4_2: () = ();
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: write-var gs#146795 <= s_6_4
        fn_state.gs_146795 = s_6_4;
        // N s_6_6: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#146795:u8
        let s_7_0: bool = fn_state.gs_146795;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_5: write-var gs#146796 <= s_8_4
        fn_state.gs_146796 = s_8_4;
        // N s_8_6: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#146796:u8
        let s_9_0: bool = fn_state.gs_146796;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: write-var gs#146798 <= s_10_3
        fn_state.gs_146798 = s_10_3;
        // N s_10_5: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#146798:u8
        let s_11_0: bool = fn_state.gs_146798;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_4: write-var gs#146800 <= s_12_3
        fn_state.gs_146800 = s_12_3;
        // N s_12_5: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#146800:u8
        let s_13_0: bool = fn_state.gs_146800;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_4: write-var gs#146802 <= s_14_3
        fn_state.gs_146802 = s_14_3;
        // N s_14_5: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#146802:u8
        let s_15_0: bool = fn_state.gs_146802;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_4: read-var stageshadow#1145:u32
        let s_17_4: u32 = fn_state.stageshadow_1145;
        // D s_17_5: call execute_aarch64_instrs_memory_mcpymset_cpy(s_17_0, s_17_1, s_17_2, s_17_3, s_17_4)
        let s_17_5: () = execute_aarch64_instrs_memory_mcpymset_cpy(
            state,
            tracer,
            s_17_0,
            s_17_1,
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_3: write-var gs#146804 <= s_19_2
        fn_state.gs_146804 = s_19_2;
        // N s_19_4: jump b20
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_0: read-var gs#146804:u8
        let s_20_0: bool = fn_state.gs_146804;
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_1: write-var gs#146804 <= s_26_0
        fn_state.gs_146804 = s_26_0;
        // N s_26_2: jump b20
        return block_20(state, tracer, fn_state);
    }
    fn block_27<T: Tracer>(
        ...
        // D s_27_1: write-var gs#146802 <= s_27_0
        fn_state.gs_146802 = s_27_0;
        // N s_27_2: jump b15
        return block_15(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_1: write-var gs#146800 <= s_28_0
        fn_state.gs_146800 = s_28_0;
        // N s_28_2: jump b13
        return block_13(state, tracer, fn_state);
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_1: write-var gs#146798 <= s_29_0
        fn_state.gs_146798 = s_29_0;
        // N s_29_2: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_1: write-var gs#146796 <= s_30_0
        fn_state.gs_146796 = s_30_0;
        // N s_30_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_31<T: Tracer>(
        ...
        // D s_31_1: write-var gs#146795 <= s_31_0
        fn_state.gs_146795 = s_31_0;
        // N s_31_2: jump b7
        return block_7(state, tracer, fn_state);
    }
