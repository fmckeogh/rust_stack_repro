...
extern crate alloc;
use HaveSHA3Ext::*;
use execute_aarch64_instrs_vector_crypto_sha3_xar::*;
use common::*;
pub fn decode_xar_advsimd_aarch64_instrs_vector_crypto_sha3_xar<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_12: read-var imm6:u8
        let s_1_12: u8 = fn_state.imm6;
        // D s_1_13: call execute_aarch64_instrs_vector_crypto_sha3_xar(s_1_3, s_1_12, s_1_11, s_1_7)
        let s_1_13: () = execute_aarch64_instrs_vector_crypto_sha3_xar(
            state,
            tracer,
            s_1_3,
            s_1_12,
