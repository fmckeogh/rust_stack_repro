...
pub fn u__get_DBGWCR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #32s : i
        let s_0_3: i128 = 32;
        // C s_0_4: const #14680064u : u24
        let s_0_4: u32 = 14680064;
        ...
        // D s_0_15: tail-call Mk_DBGWCR_Type(s_0_14)
        return Mk_DBGWCR_Type(state, tracer, s_0_14);
    }
}
