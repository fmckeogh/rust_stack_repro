...
extern crate alloc;
use execute_SQCADD_Z_ZZ__::*;
use CurrentVL_read::*;
use HaveSVE2::*;
use HaveSME::*;
use common::*;
pub fn decode_SQCADD_Z_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    rot: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#210167 <= s_1_0
        fn_state.gs_210167 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#210167:u8
        let s_2_0: bool = fn_state.gs_210167;
    ...
    fn block_3<T: Tracer>(
        ...
        fn_state.dn = s_3_15;
        // D s_3_17: read-var rot:u8
        let s_3_17: bool = fn_state.rot;
        ...
        // D s_3_22: write-var sub_i <= s_3_21
        fn_state.sub_i = s_3_21;
        // D s_3_23: read-var rot:u8
        let s_3_23: bool = fn_state.rot;
        ...
        // D s_3_28: write-var sub_r <= s_3_27
        fn_state.sub_r = s_3_27;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: read-var dn:i64
        let s_4_4: i64 = fn_state.dn;
        // D s_4_5: read-var m:i64
        let s_4_5: i64 = fn_state.m;
        // D s_4_6: read-var sub_i:u8
        let s_4_6: bool = fn_state.sub_i;
        // D s_4_7: read-var sub_r:u8
        let s_4_7: bool = fn_state.sub_r;
        // D s_4_8: call execute_SQCADD_Z_ZZ__(s_4_0, s_4_4, s_4_3, s_4_5, s_4_6, s_4_7)
        let s_4_8: () = execute_SQCADD_Z_ZZ__(
            state,
            tracer,
            s_4_0,
            s_4_4,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: read-var dn:i64
        let s_6_4: i64 = fn_state.dn;
        // D s_6_5: read-var m:i64
        let s_6_5: i64 = fn_state.m;
        // D s_6_6: read-var sub_i:u8
        let s_6_6: bool = fn_state.sub_i;
        // D s_6_7: read-var sub_r:u8
        let s_6_7: bool = fn_state.sub_r;
        // D s_6_8: call execute_SQCADD_Z_ZZ__(s_6_0, s_6_4, s_6_3, s_6_5, s_6_6, s_6_7)
        let s_6_8: () = execute_SQCADD_Z_ZZ__(
            state,
            tracer,
            s_6_0,
            s_6_4,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: read-var dn:i64
        let s_8_4: i64 = fn_state.dn;
        // D s_8_5: read-var m:i64
        let s_8_5: i64 = fn_state.m;
        // D s_8_6: read-var sub_i:u8
        let s_8_6: bool = fn_state.sub_i;
        // D s_8_7: read-var sub_r:u8
        let s_8_7: bool = fn_state.sub_r;
        // D s_8_8: call execute_SQCADD_Z_ZZ__(s_8_0, s_8_4, s_8_3, s_8_5, s_8_6, s_8_7)
        let s_8_8: () = execute_SQCADD_Z_ZZ__(
            state,
            tracer,
            s_8_0,
            s_8_4,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: read-var dn:i64
        let s_10_4: i64 = fn_state.dn;
        // D s_10_5: read-var m:i64
        let s_10_5: i64 = fn_state.m;
        // D s_10_6: read-var sub_i:u8
        let s_10_6: bool = fn_state.sub_i;
        // D s_10_7: read-var sub_r:u8
        let s_10_7: bool = fn_state.sub_r;
        // D s_10_8: call execute_SQCADD_Z_ZZ__(s_10_0, s_10_4, s_10_3, s_10_5, s_10_6, s_10_7)
        let s_10_8: () = execute_SQCADD_Z_ZZ__(
            state,
            tracer,
            s_10_0,
            s_10_4,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_4: read-var dn:i64
        let s_12_4: i64 = fn_state.dn;
        // D s_12_5: read-var m:i64
        let s_12_5: i64 = fn_state.m;
        // D s_12_6: read-var sub_i:u8
        let s_12_6: bool = fn_state.sub_i;
        // D s_12_7: read-var sub_r:u8
        let s_12_7: bool = fn_state.sub_r;
        // D s_12_8: call execute_SQCADD_Z_ZZ__(s_12_0, s_12_4, s_12_3, s_12_5, s_12_6, s_12_7)
        let s_12_8: () = execute_SQCADD_Z_ZZ__(
            state,
            tracer,
            s_12_0,
            s_12_4,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#210167 <= s_15_2
        fn_state.gs_210167 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
