...
use P_set::*;
use common::*;
pub fn execute_WHILELE_P_P_RR__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var rsizeshadow#2600 <= s_0_2
        fn_state.rsizeshadow_2600 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_15: read-var rsizeshadow#2600:i64
        let s_1_15: i64 = fn_state.rsizeshadow_2600;
        ...
        // D s_1_22: read-var rsizeshadow#2600:i64
        let s_1_22: i64 = fn_state.rsizeshadow_2600;
        ...
        // D s_1_42: write-var gs#187554 <= s_1_41
        fn_state.gs_187554 = s_1_41;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#187554:i64
        let s_2_1: i64 = fn_state.gs_187554;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#187561 <= s_6_0
        fn_state.gs_187561 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#187561:u8
        let s_7_0: bool = fn_state.gs_187561;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#187561 <= s_11_0
        fn_state.gs_187561 = s_11_0;
        // N s_11_2: jump b7
        return block_7(state, tracer, fn_state);
    }
