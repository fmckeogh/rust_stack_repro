...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_STREXD_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_STREXD_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    Rt: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#302704 <= s_3_3
        fn_state.gs_302704 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#302704:u8
        let s_4_0: bool = fn_state.gs_302704;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#302706 <= s_5_3
        fn_state.gs_302706 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#302706:u8
        let s_6_0: bool = fn_state.gs_302706;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#302708 <= s_7_3
        fn_state.gs_302708 = s_7_3;
        // N s_7_5: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#302708:u8
        let s_8_0: bool = fn_state.gs_302708;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: write-var gs#302709 <= s_10_4
        fn_state.gs_302709 = s_10_4;
        // N s_10_6: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#302709:u8
        let s_11_0: bool = fn_state.gs_302709;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#302710 <= s_12_4
        fn_state.gs_302710 = s_12_4;
        // N s_12_6: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#302710:u8
        let s_13_0: bool = fn_state.gs_302710;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_4: call execute_aarch32_instrs_STREXD_Op_A_txt(s_14_0, s_14_1, s_14_2, s_14_3)
        let s_14_4: () = execute_aarch32_instrs_STREXD_Op_A_txt(
            state,
            tracer,
            s_14_0,
            s_14_1,
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#302710 <= s_16_0
        fn_state.gs_302710 = s_16_0;
        // N s_16_2: jump b13
        return block_13(state, tracer, fn_state);
    }
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#302709 <= s_17_0
        fn_state.gs_302709 = s_17_0;
        // N s_17_2: jump b11
        return block_11(state, tracer, fn_state);
    }
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#302708 <= s_19_0
        fn_state.gs_302708 = s_19_0;
        // N s_19_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#302706 <= s_20_0
        fn_state.gs_302706 = s_20_0;
        // N s_20_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#302704 <= s_21_0
        fn_state.gs_302704 = s_21_0;
        // N s_21_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
