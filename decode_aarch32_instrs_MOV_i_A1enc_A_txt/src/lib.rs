...
use common::*;
pub fn decode_aarch32_instrs_MOV_i_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    S: bool,
    ...
    struct FunctionState {
        ga_345051: ProductType4813027798de1e98,
        cond: u8,
        S: bool,
        Rd: u8,
        imm12: u16,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_19: write-var ga#345051 <= s_2_18
        fn_state.ga_345051 = s_2_18;
        // D s_2_20: read-var ga#345051.0:struct
        let s_2_20: u32 = fn_state.ga_345051._0;
        // D s_2_21: read-var ga#345051.1:struct
        let s_2_21: bool = fn_state.ga_345051._1;
        // D s_2_22: call execute_aarch32_instrs_MOV_i_Op_A_txt(s_2_21, s_2_9, s_2_20, s_2_14)
        let s_2_22: () = execute_aarch32_instrs_MOV_i_Op_A_txt(
            state,
            tracer,
            s_2_21,
            s_2_9,
