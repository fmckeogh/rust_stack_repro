...
use common::*;
pub fn u__set_BRBSRCINJ_EL1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_7: write-var gs#33958 <= s_1_6
        fn_state.gs_33958 = s_1_6;
        // N s_1_8: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#33958:u8
        let s_2_0: bool = fn_state.gs_33958;
        // D s_2_1: not s_2_0
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: call _get_BRBSRCINJ_EL1_Type_ADDRESS(s_4_0)
        let s_4_1: u64 = u_get_BRBSRCINJ_EL1_Type_ADDRESS(state, tracer, s_4_0);
        // C s_4_2: const #21928u : u32
        let s_4_2: u32 = 21928;
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_0: const #1u : u8
        let s_5_0: bool = true;
        // D s_5_1: write-var gs#33958 <= s_5_0
        fn_state.gs_33958 = s_5_0;
        // N s_5_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
