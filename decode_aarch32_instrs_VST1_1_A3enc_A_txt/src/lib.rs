...
extern crate alloc;
use neq_int::*;
use execute_aarch32_instrs_VST1_1_Op_A_txt::*;
use ConditionPassed::*;
use common::*;
pub fn decode_aarch32_instrs_VST1_1_A3enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Rn: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#320039 <= s_5_0
        fn_state.gs_320039 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#320039:u8
        let s_6_0: bool = fn_state.gs_320039;
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 4;
        // D s_8_1: write-var ga#361320 <= s_8_0
        fn_state.ga_361320 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var ga#361320:i64
        let s_9_0: i64 = fn_state.ga_361320;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#320059 <= s_10_0
        fn_state.gs_320059 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#320059:u8
        let s_11_0: bool = fn_state.gs_320059;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_8: call execute_aarch32_instrs_VST1_1_Op_A_txt(s_12_0, s_12_1, s_12_2, s_12_3, s_12_4, s_12_5, s_12_6, s_12_7)
        let s_12_8: () = execute_aarch32_instrs_VST1_1_Op_A_txt(
            state,
            tracer,
            s_12_0,
            s_12_1,
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_4: write-var gs#320059 <= s_14_3
        fn_state.gs_320059 = s_14_3;
        // N s_14_5: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        let s_15_0: i64 = 1;
        // D s_15_1: write-var ga#361320 <= s_15_0
        fn_state.ga_361320 = s_15_0;
        // N s_15_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_13: write-var gs#320039 <= s_17_12
        fn_state.gs_320039 = s_17_12;
        // N s_17_14: jump b6
        return block_6(state, tracer, fn_state);
    }
