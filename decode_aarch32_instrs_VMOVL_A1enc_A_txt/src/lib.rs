...
use fdiv_int::*;
use common::*;
pub fn decode_aarch32_instrs_VMOVL_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    U: bool,
    D: bool,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#313074 <= s_4_0
        fn_state.gs_313074 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#313074:u8
        let s_5_0: bool = fn_state.gs_313074;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#313075 <= s_6_0
        fn_state.gs_313075 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#313075:u8
        let s_7_0: bool = fn_state.gs_313075;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#313075 <= s_12_4
        fn_state.gs_313075 = s_12_4;
        // N s_12_6: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_5: write-var gs#313074 <= s_13_4
        fn_state.gs_313074 = s_13_4;
        // N s_13_6: jump b5
        return block_5(state, tracer, fn_state);
    }
