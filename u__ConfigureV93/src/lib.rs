...
use u__ConfigureV92::*;
use common::*;
pub fn u__ConfigureV93<T: Tracer>(state: &mut State, tracer: &T, enabled: bool) -> () {
    #[derive(Default)]
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: call __ConfigureV92(s_2_0)
        let s_2_1: () = u__ConfigureV92(state, tracer, s_2_0);
        // D s_2_2: read-var enabled:u8
        let s_2_2: bool = fn_state.enabled;
        // D s_2_3: call __ConfigureV88(s_2_2)
        let s_2_3: () = u__ConfigureV88(state, tracer, s_2_2);
        // N s_2_4: return
        return;
    }
}
