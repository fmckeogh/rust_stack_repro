...
use HDFAR_read::*;
use common::*;
pub fn DFAR_S_read<T: Tracer>(state: &mut State, tracer: &T, gs_36842: ()) -> u32 {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_2: const #() : ()
        let s_0_2: () = ();
        // S s_0_3: call HDFAR_read(s_0_2)
        let s_0_3: u32 = HDFAR_read(state, tracer, s_0_2);
        // C s_0_4: const #0s : i
        let s_0_4: i128 = 0;
        // C s_0_5: const #32s : i
        let s_0_5: i128 = 32;
        // S s_0_6: cast zx s_0_3 -> bv
        let s_0_6: Bits = Bits::new(s_0_3 as u128, 32u16);
