...
use SP_set::*;
use common::*;
pub fn execute_ADDVL_R_RI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var VLshadow#2497 <= s_1_0
        fn_state.VLshadow_2497 = s_1_0;
        // C s_1_2: const #31s : i
        let s_1_2: i128 = 31;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_0: const #8s : i
        let s_3_0: i128 = 8;
        // D s_3_1: read-var VLshadow#2497:i64
        let s_3_1: i64 = fn_state.VLshadow_2497;
