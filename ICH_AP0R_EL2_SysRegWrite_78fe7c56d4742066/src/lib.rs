...
use X_read::*;
use Mk_ICH_AP0R_EL2_Type::*;
use EL2Enabled::*;
use u_get_ICC_SRE_EL3_Type_SRE::*;
use AArch64_SystemAccessTrap::*;
use NVMem_set::*;
use common::*;
pub fn ICH_AP0R_EL2_SysRegWrite_78fe7c56d4742066<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: call Mk_ICH_AP0R_EL2_Type(s_8_3)
        let s_8_4: ProductType5c790c8ef59cc8b2 = Mk_ICH_AP0R_EL2_Type(
            state,
            tracer,
            s_8_3,
        );
        ...
        // C s_8_11: const #14832u : u32
        let s_8_11: u32 = 14832;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_4: call Mk_ICH_AP0R_EL2_Type(s_11_3)
        let s_11_4: ProductType5c790c8ef59cc8b2 = Mk_ICH_AP0R_EL2_Type(
            state,
            tracer,
            s_11_3,
        );
        // C s_11_5: const #0s : i
        let s_11_5: i128 = 0;
        // C s_11_6: const #14832u : u32
        let s_11_6: u32 = 14832;
        ...
        // C s_11_11: const #14832u : u32
        let s_11_11: u32 = 14832;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#86185 <= s_14_0
        fn_state.gs_86185 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#86185:u8
        let s_15_0: bool = fn_state.gs_86185;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#86186 <= s_17_0
        fn_state.gs_86186 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#86186:u8
        let s_18_0: bool = fn_state.gs_86186;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_5: write-var gs#86186 <= s_21_4
        fn_state.gs_86186 = s_21_4;
        // N s_21_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_21: write-var gs#86185 <= s_23_20
        fn_state.gs_86185 = s_23_20;
        // N s_23_22: jump b15
        return block_15(state, tracer, fn_state);
    }
