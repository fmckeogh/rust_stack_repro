...
extern crate alloc;
use execute_aarch64_instrs_vector_shift_left_long::*;
use u__id::*;
use HighestSetBit::*;
use u_shl_int_general::*;
use fdiv_int::*;
use common::*;
pub fn decode_sshll_advsimd_aarch64_instrs_vector_shift_left_long<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_15: read-var immh:u8
        let s_2_15: u8 = fn_state.immh;
        // D s_2_16: cast zx s_2_15 -> bv
        let s_2_16: Bits = Bits::new(s_2_15 as u128, 4u16);
        // D s_2_17: read-var immb:u8
        let s_2_17: u8 = fn_state.immb;
        ...
        let s_2_28: Bits = Bits::new(s_2_27 as u128, 7u16);
        ...
        // D s_2_32: read-var esize:i
        let s_2_32: i128 = fn_state.esize;
        // D s_2_33: sub s_2_31 s_2_32
        let s_2_33: i128 = ((s_2_31) - (s_2_32));
        // D s_2_34: write-var shift <= s_2_33
        fn_state.shift = s_2_33;
        // D s_2_35: read-var U:u8
        let s_2_35: bool = fn_state.U;
        // D s_2_36: cast zx s_2_35 -> bv
        let s_2_36: Bits = Bits::new(s_2_35 as u128, 1u16);
        // C s_2_37: const #1u : u8
        let s_2_37: bool = true;
        ...
        // D s_2_40: write-var is_unsigned <= s_2_39
        fn_state.is_unsigned = s_2_39;
        // D s_2_41: read-var esize:i
        let s_2_41: i128 = fn_state.esize;
        // D s_2_42: call __id(s_2_41)
        let s_2_42: i128 = u__id(state, tracer, s_2_41);
        // C s_2_43: const #4s : i
        let s_2_43: i128 = 4;
        // D s_2_44: cmp-eq s_2_42 s_2_43
        let s_2_44: bool = ((s_2_42) == (s_2_43));
        // N s_2_45: branch s_2_44 b14 b3
        if s_2_44 {
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#172968 <= s_3_3
        fn_state.gs_172968 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#172968:u8
        let s_4_0: bool = fn_state.gs_172968;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#172970 <= s_5_3
        fn_state.gs_172970 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#172970:u8
        let s_6_0: bool = fn_state.gs_172970;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#172972 <= s_7_3
        fn_state.gs_172972 = s_7_3;
        // N s_7_5: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#172972:u8
        let s_8_0: bool = fn_state.gs_172972;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: write-var gs#172974 <= s_9_3
        fn_state.gs_172974 = s_9_3;
        // N s_9_5: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#172974:u8
        let s_10_0: bool = fn_state.gs_172974;
        ...
        // D s_10_9: read-var shift:i
        let s_10_9: i128 = fn_state.shift;
        // D s_10_10: read-var is_unsigned:u8
        let s_10_10: bool = fn_state.is_unsigned;
        // D s_10_11: call execute_aarch64_instrs_vector_shift_left_long(s_10_5, s_10_4, s_10_6, s_10_3, s_10_7, s_10_8, s_10_9, s_10_10)
        let s_10_11: () = execute_aarch64_instrs_vector_shift_left_long(
            state,
            tracer,
            s_10_5,
            s_10_4,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#172974 <= s_11_0
        fn_state.gs_172974 = s_11_0;
        // N s_11_2: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#172972 <= s_12_0
        fn_state.gs_172972 = s_12_0;
        // N s_12_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#172970 <= s_13_0
        fn_state.gs_172970 = s_13_0;
        // N s_13_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#172968 <= s_14_0
        fn_state.gs_172968 = s_14_0;
        // N s_14_2: jump b4
        return block_4(state, tracer, fn_state);
    }
