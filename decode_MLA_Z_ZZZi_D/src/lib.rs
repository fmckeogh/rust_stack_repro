...
extern crate alloc;
use execute_MLA_Z_ZZZi_D::*;
use CurrentVL_read::*;
use HaveSVE2::*;
use HaveSME::*;
use common::*;
pub fn decode_MLA_Z_ZZZi_D<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    i1: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#211172 <= s_1_0
        fn_state.gs_211172 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#211172:u8
        let s_2_0: bool = fn_state.gs_211172;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_6: call execute_MLA_Z_ZZZi_D(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5)
        let s_4_6: () = execute_MLA_Z_ZZZi_D(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_6: call execute_MLA_Z_ZZZi_D(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5)
        let s_6_6: () = execute_MLA_Z_ZZZi_D(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_6: call execute_MLA_Z_ZZZi_D(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5)
        let s_8_6: () = execute_MLA_Z_ZZZi_D(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_6: call execute_MLA_Z_ZZZi_D(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5)
        let s_10_6: () = execute_MLA_Z_ZZZi_D(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_6: call execute_MLA_Z_ZZZi_D(s_12_0, s_12_1, s_12_2, s_12_3, s_12_4, s_12_5)
        let s_12_6: () = execute_MLA_Z_ZZZi_D(
            state,
            tracer,
            s_12_0,
            s_12_1,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#211172 <= s_15_2
        fn_state.gs_211172 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
