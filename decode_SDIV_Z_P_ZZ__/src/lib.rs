...
use HaveSVE::*;
use CurrentVL_read::*;
use execute_SDIV_Z_P_ZZ__::*;
use HaveSME::*;
use common::*;
pub fn decode_SDIV_Z_P_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    R: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#186840 <= s_1_0
        fn_state.gs_186840 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#186840:u8
        let s_2_0: bool = fn_state.gs_186840;
    ...
    fn block_4<T: Tracer>(
        ...
        // C s_4_0: const #1u : u8
        let s_4_0: bool = true;
        // D s_4_1: write-var gs#186841 <= s_4_0
        fn_state.gs_186841 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#186841:u8
        let s_5_0: bool = fn_state.gs_186841;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_8: call execute_SDIV_Z_P_ZZ__(s_7_0, s_7_4, s_7_3, s_7_5, s_7_6, s_7_7)
        let s_7_8: () = execute_SDIV_Z_P_ZZ__(
            state,
            tracer,
            s_7_0,
            s_7_4,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_8: call execute_SDIV_Z_P_ZZ__(s_9_0, s_9_4, s_9_3, s_9_5, s_9_6, s_9_7)
        let s_9_8: () = execute_SDIV_Z_P_ZZ__(
            state,
            tracer,
            s_9_0,
            s_9_4,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_8: call execute_SDIV_Z_P_ZZ__(s_11_0, s_11_4, s_11_3, s_11_5, s_11_6, s_11_7)
        let s_11_8: () = execute_SDIV_Z_P_ZZ__(
            state,
            tracer,
            s_11_0,
            s_11_4,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_8: call execute_SDIV_Z_P_ZZ__(s_13_0, s_13_4, s_13_3, s_13_5, s_13_6, s_13_7)
        let s_13_8: () = execute_SDIV_Z_P_ZZ__(
            state,
            tracer,
            s_13_0,
            s_13_4,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_8: call execute_SDIV_Z_P_ZZ__(s_15_0, s_15_4, s_15_3, s_15_5, s_15_6, s_15_7)
        let s_15_8: () = execute_SDIV_Z_P_ZZ__(
            state,
            tracer,
            s_15_0,
            s_15_4,
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#186841 <= s_18_0
        fn_state.gs_186841 = s_18_0;
        // N s_18_2: jump b5
        return block_5(state, tracer, fn_state);
    }
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_3: write-var gs#186840 <= s_20_2
        fn_state.gs_186840 = s_20_2;
        // N s_20_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
