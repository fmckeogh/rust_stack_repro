...
use R_set::*;
use common::*;
pub fn execute_aarch32_instrs_STLEX_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    n: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_7: write-var ga#365499 <= s_0_6
        fn_state.ga_365499 = s_0_6;
        // N s_0_8: jump b1
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var ga#365499:u8
        let s_1_0: bool = fn_state.ga_365499;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_12: call MemO_set(s_3_11, s_3_9, s_3_10)
        let s_3_12: () = MemO_set(state, tracer, s_3_11, s_3_9, s_3_10);
        // N s_3_13: jump b4
