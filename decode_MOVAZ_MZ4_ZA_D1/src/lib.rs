...
extern crate alloc;
use CurrentVL_read::*;
use execute_MOVAZ_MZ4_ZA_D1::*;
use HaveSME2p1::*;
use common::*;
pub fn decode_MOVAZ_MZ4_ZA_D1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    V: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        fn_state.d = s_1_32;
        // D s_1_34: read-var ZAn:u8
        let s_1_34: u8 = fn_state.ZAn;
        ...
        // D s_1_38: write-var n <= s_1_37
        fn_state.n = s_1_37;
        // D s_1_39: read-var V:u8
        let s_1_39: bool = fn_state.V;
        ...
        // D s_1_43: cmp-eq s_1_40 s_1_42
        let s_1_43: bool = ((s_1_40) == (s_1_42));
        // D s_1_44: write-var vertical <= s_1_43
        fn_state.vertical = s_1_43;
        // D s_1_45: read-var VL:i64
        let s_1_45: i64 = fn_state.VL;
        // C s_1_46: const #128s : i
        let s_1_46: i128 = 128;
        // D s_1_47: cast zx s_1_45 -> i
        let s_1_47: i128 = (i128::try_from(s_1_45).unwrap());
        // D s_1_48: cmp-eq s_1_47 s_1_46
        let s_1_48: bool = ((s_1_47) == (s_1_46));
        // D s_1_49: not s_1_48
        let s_1_49: bool = !s_1_48;
        // N s_1_50: branch s_1_49 b3 b2
        if s_1_49 {
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_8: call execute_MOVAZ_MZ4_ZA_D1(s_2_0, s_2_1, s_2_2, s_2_3, s_2_4, s_2_5, s_2_6, s_2_7)
        let s_2_8: () = execute_MOVAZ_MZ4_ZA_D1(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_8: call execute_MOVAZ_MZ4_ZA_D1(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5, s_4_6, s_4_7)
        let s_4_8: () = execute_MOVAZ_MZ4_ZA_D1(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_8: call execute_MOVAZ_MZ4_ZA_D1(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5, s_6_6, s_6_7)
        let s_6_8: () = execute_MOVAZ_MZ4_ZA_D1(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_8: call execute_MOVAZ_MZ4_ZA_D1(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5, s_8_6, s_8_7)
        let s_8_8: () = execute_MOVAZ_MZ4_ZA_D1(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_8: call execute_MOVAZ_MZ4_ZA_D1(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5, s_10_6, s_10_7)
        let s_10_8: () = execute_MOVAZ_MZ4_ZA_D1(
            state,
            tracer,
            s_10_0,
            s_10_1,
