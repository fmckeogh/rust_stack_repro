...
use AddWithCarry::*;
use common::*;
pub fn execute_aarch32_instrs_ADD_rr_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        nzcv: u8,
        gs_877883: ProductTyped54bc449dd09e5bd,
        d: i64,
        m: i64,
        n: i64,
        s: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_31: write-var gs#877883 <= s_0_30
        fn_state.gs_877883 = s_0_30;
        // D s_0_32: read-var gs#877883.0:struct
        let s_0_32: Bits = fn_state.gs_877883._0;
        // D s_0_33: cast reint s_0_32 -> u32
        let s_0_33: u32 = (s_0_32.value() as u32);
        // D s_0_34: read-var gs#877883.1:struct
        let s_0_34: u8 = fn_state.gs_877883._1;
        // D s_0_35: write-var nzcv <= s_0_34
        fn_state.nzcv = s_0_34;
        // D s_0_36: read-var d:i64
        let s_0_36: i64 = fn_state.d;
        // D s_0_37: cast zx s_0_36 -> i
        let s_0_37: i128 = (i128::try_from(s_0_36).unwrap());
        // D s_0_38: call R_set(s_0_37, s_0_33)
        let s_0_38: () = R_set(state, tracer, s_0_37, s_0_33);
        // D s_0_39: read-var setflags:u8
        let s_0_39: bool = fn_state.setflags;
