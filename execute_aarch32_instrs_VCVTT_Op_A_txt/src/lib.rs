...
use FPConvertBF__1::*;
use common::*;
pub fn execute_aarch32_instrs_VCVTT_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_3: write-var ga#367222 <= s_1_2
        fn_state.ga_367222 = s_1_2;
        ...
        // D s_1_11: write-var gs#917457 <= s_1_10
        fn_state.gs_917457 = s_1_10;
        // N s_1_12: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#917457:bv
        let s_2_0: Bits = fn_state.gs_917457;
        // D s_2_1: cast reint s_2_0 -> u16
        let s_2_1: u16 = (s_2_0.value() as u16);
        // C s_2_2: const #16s : i
        let s_2_2: i128 = 16;
        // D s_2_3: read-var ga#367222:u32
        let s_2_3: u32 = fn_state.ga_367222;
