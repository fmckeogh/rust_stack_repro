...
extern crate alloc;
use execute_aarch64_instrs_vector_reduce_fp16_maxnm_simd::*;
use common::*;
pub fn decode_fminnmv_advsimd_aarch64_instrs_vector_reduce_fp16_maxnm_simd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#255343 <= s_1_0
        fn_state.ga_255343 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#255343:i64
        let s_2_0: i64 = fn_state.ga_255343;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_7: call execute_aarch64_instrs_vector_reduce_fp16_maxnm_simd(s_4_4, s_4_2, s_4_3, s_4_5, s_4_6)
        let s_4_7: () = execute_aarch64_instrs_vector_reduce_fp16_maxnm_simd(
            state,
            tracer,
            s_4_4,
            s_4_2,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 128;
        // D s_6_1: write-var ga#255343 <= s_6_0
        fn_state.ga_255343 = s_6_0;
        // N s_6_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
