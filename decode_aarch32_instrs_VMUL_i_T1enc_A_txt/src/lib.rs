...
use common::*;
pub fn decode_aarch32_instrs_VMUL_i_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    op: bool,
    D: bool,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#313779 <= s_4_0
        fn_state.gs_313779 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#313779:u8
        let s_5_0: bool = fn_state.gs_313779;
        // D s_5_1: write-var gs#313780 <= s_5_0
        fn_state.gs_313780 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#313780:u8
        let s_6_0: bool = fn_state.gs_313780;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#313789 <= s_8_0
        fn_state.gs_313789 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#313789:u8
        let s_9_0: bool = fn_state.gs_313789;
    ...
    fn block_11<T: Tracer>(
        ...
        let s_11_0: i64 = 2;
        // D s_11_1: write-var ga#356857 <= s_11_0
        fn_state.ga_356857 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var ga#356857:i64
        let s_12_0: i64 = fn_state.ga_356857;
    ...
    fn block_13<T: Tracer>(
        ...
        let s_13_0: i64 = 1;
        // D s_13_1: write-var ga#356857 <= s_13_0
        fn_state.ga_356857 = s_13_0;
        // N s_13_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_22: write-var gs#313785 <= s_16_21
        fn_state.gs_313785 = s_16_21;
        // N s_16_23: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#313785:u8
        let s_17_0: bool = fn_state.gs_313785;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_22: write-var gs#313788 <= s_18_21
        fn_state.gs_313788 = s_18_21;
        // N s_18_23: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#313788:u8
        let s_19_0: bool = fn_state.gs_313788;
        // D s_19_1: write-var gs#313789 <= s_19_0
        fn_state.gs_313789 = s_19_0;
        // N s_19_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#313788 <= s_20_0
        fn_state.gs_313788 = s_20_0;
        // N s_20_2: jump b19
        return block_19(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#313785 <= s_21_0
        fn_state.gs_313785 = s_21_0;
        // N s_21_2: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_5: write-var gs#313779 <= s_23_4
        fn_state.gs_313779 = s_23_4;
        // N s_23_6: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_24<T: Tracer>(
        ...
        // D s_24_1: write-var gs#313780 <= s_24_0
        fn_state.gs_313780 = s_24_0;
        // N s_24_2: jump b6
        return block_6(state, tracer, fn_state);
    }
}
