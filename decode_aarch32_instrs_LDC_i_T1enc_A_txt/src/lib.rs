...
use place_slice::*;
use common::*;
pub fn decode_aarch32_instrs_LDC_i_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    P: bool,
    U: bool,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#296748 <= s_4_0
        fn_state.gs_296748 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#296748:u8
        let s_5_0: bool = fn_state.gs_296748;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#296749 <= s_6_0
        fn_state.gs_296749 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#296749:u8
        let s_7_0: bool = fn_state.gs_296749;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: write-var gs#296749 <= s_10_4
        fn_state.gs_296749 = s_10_4;
        // N s_10_6: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_11<T: Tracer>(
        ...
        // D s_11_5: write-var gs#296748 <= s_11_4
        fn_state.gs_296748 = s_11_4;
        // N s_11_6: jump b5
        return block_5(state, tracer, fn_state);
    }
