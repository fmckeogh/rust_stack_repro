...
use common::*;
pub fn execute_aarch64_instrs_system_sysinstwithreg_wfet<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#174351 <= s_1_0
        fn_state.gs_174351 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#174351:u8
        let s_2_0: bool = fn_state.gs_174351;
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_1: u32 = 2;
        // D s_4_2: call Hint_WFE(s_4_0, s_4_1)
        let s_4_2: () = Hint_WFE(state, tracer, s_4_0, s_4_1);
        // N s_4_3: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: write-var gs#174351 <= s_6_1
        fn_state.gs_174351 = s_6_1;
        // N s_6_3: jump b2
        return block_2(state, tracer, fn_state);
    }
}
