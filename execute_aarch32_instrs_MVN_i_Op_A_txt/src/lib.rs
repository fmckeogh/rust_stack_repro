...
use ALUWritePC::*;
use common::*;
pub fn execute_aarch32_instrs_MVN_i_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    carry: bool,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_0: read-var imm32:u32
        let s_0_0: u32 = fn_state.imm32;
        // D s_0_1: cast zx s_0_0 -> bv
        let s_0_1: Bits = Bits::new(s_0_0 as u128, 32u16);
        // D s_0_2: not s_0_1
        let s_0_2: Bits = !s_0_1;
        // D s_0_3: cast reint s_0_2 -> u32
        let s_0_3: u32 = (s_0_2.value() as u32);
        // D s_0_4: write-var result <= s_0_3
        fn_state.result = s_0_3;
        // C s_0_5: const #15s : i
        let s_0_5: i128 = 15;
        // D s_0_6: read-var d:i64
        let s_0_6: i64 = fn_state.d;
