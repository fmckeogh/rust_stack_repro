...
use fdiv_int::*;
use common::*;
pub fn decode_shrn_advsimd_aarch64_instrs_vector_shift_right_narrow_logical<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#166892 <= s_3_3
        fn_state.gs_166892 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#166892:u8
        let s_4_0: bool = fn_state.gs_166892;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#166894 <= s_5_3
        fn_state.gs_166894 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#166894:u8
        let s_6_0: bool = fn_state.gs_166894;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#166896 <= s_7_3
        fn_state.gs_166896 = s_7_3;
        // N s_7_5: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#166896:u8
        let s_8_0: bool = fn_state.gs_166896;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: write-var gs#166898 <= s_9_3
        fn_state.gs_166898 = s_9_3;
        // N s_9_5: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#166898:u8
        let s_10_0: bool = fn_state.gs_166898;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#166898 <= s_11_0
        fn_state.gs_166898 = s_11_0;
        // N s_11_2: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#166896 <= s_12_0
        fn_state.gs_166896 = s_12_0;
        // N s_12_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#166894 <= s_13_0
        fn_state.gs_166894 = s_13_0;
        // N s_13_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#166892 <= s_14_0
        fn_state.gs_166892 = s_14_0;
        // N s_14_2: jump b4
        return block_4(state, tracer, fn_state);
    }
