...
use common::*;
pub fn DISR_SysRegWrite32_797163d94eb0b6e5<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_2: call Mk_DISR_Type(s_5_1)
        let s_5_2: ProductType700c18a878c5601b = Mk_DISR_Type(state, tracer, s_5_1);
        // D s_5_3: call DISR_write(s_5_2)
        let s_5_3: () = DISR_write(state, tracer, s_5_2);
        // N s_5_4: return
        return;
    }
    fn block_6<T: Tracer>(
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#127480 <= s_7_0
        fn_state.gs_127480 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#127480:u8
        let s_8_0: bool = fn_state.gs_127480;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#127481 <= s_9_0
        fn_state.gs_127481 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#127481:u8
        let s_10_0: bool = fn_state.gs_127481;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#127482 <= s_11_0
        fn_state.gs_127482 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#127482:u8
        let s_12_0: bool = fn_state.gs_127482;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#127483 <= s_14_0
        fn_state.gs_127483 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#127483:u8
        let s_15_0: bool = fn_state.gs_127483;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#127484 <= s_16_0
        fn_state.gs_127484 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#127484:u8
        let s_17_0: bool = fn_state.gs_127484;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#127485 <= s_18_0
        fn_state.gs_127485 = s_18_0;
        // N s_18_2: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#127485:u8
        let s_19_0: bool = fn_state.gs_127485;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_2: call Mk_DISR_Type(s_20_1)
        let s_20_2: ProductType700c18a878c5601b = Mk_DISR_Type(state, tracer, s_20_1);
        // D s_20_3: call DISR_write(s_20_2)
        let s_20_3: () = DISR_write(state, tracer, s_20_2);
        // N s_20_4: return
        return;
    }
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_5: write-var gs#127485 <= s_22_4
        fn_state.gs_127485 = s_22_4;
        // N s_22_6: jump b19
        return block_19(state, tracer, fn_state);
    }
    fn block_23<T: Tracer>(
        ...
        // D s_23_3: write-var gs#127484 <= s_23_2
        fn_state.gs_127484 = s_23_2;
        // N s_23_4: jump b17
        return block_17(state, tracer, fn_state);
    }
    fn block_24<T: Tracer>(
        ...
        // D s_24_3: write-var gs#127483 <= s_24_2
        fn_state.gs_127483 = s_24_2;
        // N s_24_4: jump b15
        return block_15(state, tracer, fn_state);
    }
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_5: write-var gs#127482 <= s_26_4
        fn_state.gs_127482 = s_26_4;
        // N s_26_6: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_27<T: Tracer>(
        ...
        // D s_27_3: write-var gs#127481 <= s_27_2
        fn_state.gs_127481 = s_27_2;
        // N s_27_4: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_4: write-var gs#127480 <= s_28_3
        fn_state.gs_127480 = s_28_3;
        // N s_28_5: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_30<T: Tracer>(
        ...
        // D s_30_1: write-var gs#127486 <= s_30_0
        fn_state.gs_127486 = s_30_0;
        // N s_30_2: jump b31
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_0: read-var gs#127486:u8
        let s_31_0: bool = fn_state.gs_127486;
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_1: write-var gs#127487 <= s_32_0
        fn_state.gs_127487 = s_32_0;
        // N s_32_2: jump b33
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var gs#127487:u8
        let s_33_0: bool = fn_state.gs_127487;
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_1: write-var gs#127488 <= s_35_0
        fn_state.gs_127488 = s_35_0;
        // N s_35_2: jump b36
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_0: read-var gs#127488:u8
        let s_36_0: bool = fn_state.gs_127488;
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_1: write-var gs#127489 <= s_37_0
        fn_state.gs_127489 = s_37_0;
        // N s_37_2: jump b38
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_0: read-var gs#127489:u8
        let s_38_0: bool = fn_state.gs_127489;
    ...
    fn block_40<T: Tracer>(
        ...
        // D s_40_1: write-var gs#127490 <= s_40_0
        fn_state.gs_127490 = s_40_0;
        // N s_40_2: jump b41
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_0: read-var gs#127490:u8
        let s_41_0: bool = fn_state.gs_127490;
    ...
    fn block_42<T: Tracer>(
        ...
        // D s_42_1: write-var gs#127491 <= s_42_0
        fn_state.gs_127491 = s_42_0;
        // N s_42_2: jump b43
    ...
    fn block_43<T: Tracer>(
        ...
        // D s_43_0: read-var gs#127491:u8
        let s_43_0: bool = fn_state.gs_127491;
    ...
    fn block_45<T: Tracer>(
        ...
        // D s_45_1: write-var gs#127492 <= s_45_0
        fn_state.gs_127492 = s_45_0;
        // N s_45_2: jump b46
    ...
    fn block_46<T: Tracer>(
        ...
        // D s_46_0: read-var gs#127492:u8
        let s_46_0: bool = fn_state.gs_127492;
    ...
    fn block_47<T: Tracer>(
        ...
        // D s_47_1: write-var gs#127493 <= s_47_0
        fn_state.gs_127493 = s_47_0;
        // N s_47_2: jump b48
    ...
    fn block_48<T: Tracer>(
        ...
        // D s_48_0: read-var gs#127493:u8
        let s_48_0: bool = fn_state.gs_127493;
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_1: write-var gs#127494 <= s_50_0
        fn_state.gs_127494 = s_50_0;
        // N s_50_2: jump b51
    ...
    fn block_51<T: Tracer>(
        ...
        // D s_51_0: read-var gs#127494:u8
        let s_51_0: bool = fn_state.gs_127494;
    ...
    fn block_52<T: Tracer>(
        ...
        // D s_52_1: write-var gs#127495 <= s_52_0
        fn_state.gs_127495 = s_52_0;
        // N s_52_2: jump b53
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_0: read-var gs#127495:u8
        let s_53_0: bool = fn_state.gs_127495;
    ...
    fn block_54<T: Tracer>(
        ...
        // D s_54_1: write-var gs#127496 <= s_54_0
        fn_state.gs_127496 = s_54_0;
        // N s_54_2: jump b55
    ...
    fn block_55<T: Tracer>(
        ...
        // D s_55_0: read-var gs#127496:u8
        let s_55_0: bool = fn_state.gs_127496;
    ...
    fn block_57<T: Tracer>(
        ...
        // D s_57_1: write-var gs#127497 <= s_57_0
        fn_state.gs_127497 = s_57_0;
        // N s_57_2: jump b58
    ...
    fn block_58<T: Tracer>(
        ...
        // D s_58_0: read-var gs#127497:u8
        let s_58_0: bool = fn_state.gs_127497;
    ...
    fn block_59<T: Tracer>(
        ...
        // D s_59_1: write-var gs#127498 <= s_59_0
        fn_state.gs_127498 = s_59_0;
        // N s_59_2: jump b60
    ...
    fn block_60<T: Tracer>(
        ...
        // D s_60_0: read-var gs#127498:u8
        let s_60_0: bool = fn_state.gs_127498;
    ...
    fn block_61<T: Tracer>(
        ...
        // D s_61_1: write-var gs#127499 <= s_61_0
        fn_state.gs_127499 = s_61_0;
        // N s_61_2: jump b62
    ...
    fn block_62<T: Tracer>(
        ...
        // D s_62_0: read-var gs#127499:u8
        let s_62_0: bool = fn_state.gs_127499;
    ...
    fn block_63<T: Tracer>(
        ...
        // D s_63_2: call Mk_DISR_Type(s_63_1)
        let s_63_2: ProductType700c18a878c5601b = Mk_DISR_Type(state, tracer, s_63_1);
        // D s_63_3: call DISR_write(s_63_2)
        let s_63_3: () = DISR_write(state, tracer, s_63_2);
        // N s_63_4: return
        return;
    }
    ...
    fn block_65<T: Tracer>(
        ...
        // D s_65_5: write-var gs#127499 <= s_65_4
        fn_state.gs_127499 = s_65_4;
        // N s_65_6: jump b62
        return block_62(state, tracer, fn_state);
    }
    fn block_66<T: Tracer>(
        ...
        // D s_66_3: write-var gs#127498 <= s_66_2
        fn_state.gs_127498 = s_66_2;
        // N s_66_4: jump b60
        return block_60(state, tracer, fn_state);
    }
    fn block_67<T: Tracer>(
        ...
        // D s_67_3: write-var gs#127497 <= s_67_2
        fn_state.gs_127497 = s_67_2;
        // N s_67_4: jump b58
        return block_58(state, tracer, fn_state);
    }
    ...
    fn block_69<T: Tracer>(
        ...
        // D s_69_5: write-var gs#127496 <= s_69_4
        fn_state.gs_127496 = s_69_4;
        // N s_69_6: jump b55
        return block_55(state, tracer, fn_state);
    }
    fn block_70<T: Tracer>(
        ...
        // D s_70_3: write-var gs#127495 <= s_70_2
        fn_state.gs_127495 = s_70_2;
        // N s_70_4: jump b53
        return block_53(state, tracer, fn_state);
    }
    fn block_71<T: Tracer>(
        ...
        // D s_71_4: write-var gs#127494 <= s_71_3
        fn_state.gs_127494 = s_71_3;
        // N s_71_5: jump b51
        return block_51(state, tracer, fn_state);
    }
    fn block_72<T: Tracer>(
        ...
        // D s_72_2: call Mk_VDISR_Type(s_72_1)
        let s_72_2: ProductType700c18a878c5601b = Mk_VDISR_Type(state, tracer, s_72_1);
        // D s_72_3: call VDISR_write(s_72_2)
        let s_72_3: () = VDISR_write(state, tracer, s_72_2);
        // N s_72_4: return
        return;
    }
    fn block_73<T: Tracer>(
        ...
        // D s_73_5: write-var gs#127493 <= s_73_4
        fn_state.gs_127493 = s_73_4;
        // N s_73_6: jump b48
        return block_48(state, tracer, fn_state);
    }
    fn block_74<T: Tracer>(
        ...
        // D s_74_3: write-var gs#127492 <= s_74_2
        fn_state.gs_127492 = s_74_2;
        // N s_74_4: jump b46
        return block_46(state, tracer, fn_state);
    }
    fn block_75<T: Tracer>(
        ...
        // D s_75_4: bits-cast zx s_75_3 -> bv length s_75_2
        let s_75_4: Bits = s_75_3.zero_extend(s_75_2);
        // D s_75_5: cast reint s_75_4 -> u64
        let s_75_5: u64 = (s_75_4.value() as u64);
        // D s_75_6: call Mk_VDISR_EL2_Type(s_75_5)
        let s_75_6: ProductType5c790c8ef59cc8b2 = Mk_VDISR_EL2_Type(
            state,
            tracer,
            s_75_5,
        );
        // C s_75_7: const #19328u : u32
        let s_75_7: u32 = 19328;
        // N s_75_8: write-reg s_75_7 <= s_75_6
        let s_75_8: () = {
            state.write_register::<ProductType5c790c8ef59cc8b2>(s_75_7 as isize, s_75_6);
            tracer.write_register(s_75_7 as isize, s_75_6);
        };
        // N s_75_9: return
        return;
    }
    fn block_76<T: Tracer>(
        ...
        // D s_76_5: write-var gs#127491 <= s_76_4
        fn_state.gs_127491 = s_76_4;
        // N s_76_6: jump b43
        return block_43(state, tracer, fn_state);
    }
    fn block_77<T: Tracer>(
        ...
        // D s_77_4: write-var gs#127490 <= s_77_3
        fn_state.gs_127490 = s_77_3;
        // N s_77_5: jump b41
        return block_41(state, tracer, fn_state);
    }
    ...
    fn block_79<T: Tracer>(
        ...
        // D s_79_5: write-var gs#127489 <= s_79_4
        fn_state.gs_127489 = s_79_4;
        // N s_79_6: jump b38
        return block_38(state, tracer, fn_state);
    }
    fn block_80<T: Tracer>(
        ...
        // D s_80_3: write-var gs#127488 <= s_80_2
        fn_state.gs_127488 = s_80_2;
        // N s_80_4: jump b36
        return block_36(state, tracer, fn_state);
    }
    ...
    fn block_82<T: Tracer>(
        ...
        // D s_82_5: write-var gs#127487 <= s_82_4
        fn_state.gs_127487 = s_82_4;
        // N s_82_6: jump b33
        return block_33(state, tracer, fn_state);
    }
    fn block_83<T: Tracer>(
        ...
        // D s_83_4: write-var gs#127486 <= s_83_3
        fn_state.gs_127486 = s_83_3;
        // N s_83_5: jump b31
        return block_31(state, tracer, fn_state);
    }
