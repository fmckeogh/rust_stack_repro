...
use common::*;
pub fn execute_aarch32_instrs_SSUB8_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_64: write-var diff2 <= s_0_63
        fn_state.diff2 = s_0_63;
        ...
        // D s_0_77: cast sx s_0_76 -> i
        let s_0_77: i128 = {
            let sign_bit = s_0_76.length() - 1;
            let mut result = s_0_76.value() as i128;
            if ((result >> sign_bit) & 1) == 1 {
                let cleared_bit = result & !(1 << sign_bit);
                result = cleared_bit - (1 << sign_bit);
            }
        ...
        // D s_0_91: cast sx s_0_90 -> i
        let s_0_91: i128 = {
            let sign_bit = s_0_90.length() - 1;
            let mut result = s_0_90.value() as i128;
            if ((result >> sign_bit) & 1) == 1 {
                let cleared_bit = result & !(1 << sign_bit);
                result = cleared_bit - (1 << sign_bit);
            }
        ...
        // D s_0_110: cast sx s_0_109 -> i
        let s_0_110: i128 = {
            let sign_bit = s_0_109.length() - 1;
            let mut result = s_0_109.value() as i128;
            if ((result >> sign_bit) & 1) == 1 {
                let cleared_bit = result & !(1 << sign_bit);
                result = cleared_bit - (1 << sign_bit);
            }
        ...
        // D s_0_124: cast sx s_0_123 -> i
        let s_0_124: i128 = {
            let sign_bit = s_0_123.length() - 1;
            let mut result = s_0_123.value() as i128;
            if ((result >> sign_bit) & 1) == 1 {
                let cleared_bit = result & !(1 << sign_bit);
                result = cleared_bit - (1 << sign_bit);
            }
        ...
        let s_0_161: i128 = 0;
        // D s_0_162: read-var diff2:i64
        let s_0_162: i64 = fn_state.diff2;
        ...
        let s_0_188: i128 = 0;
        // D s_0_189: read-var diff3:i64
        let s_0_189: i64 = fn_state.diff3;
        ...
        let s_0_215: i128 = 0;
        // D s_0_216: read-var diff4:i64
        let s_0_216: i64 = fn_state.diff4;
        ...
        // C s_0_238: const #0s : i
        let s_0_238: i128 = 0;
        // D s_0_239: cast zx s_0_31 -> i
        let s_0_239: i128 = (i128::try_from(s_0_31).unwrap());
        // D s_0_240: cmp-ge s_0_239 s_0_238
        let s_0_240: bool = ((s_0_239) >= (s_0_238));
        // N s_0_241: branch s_0_240 b12 b1
        if s_0_240 {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var ga#347555 <= s_1_0
        fn_state.ga_347555 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#347555:u8
        let s_2_0: bool = fn_state.ga_347555;
        ...
        // C s_2_6: const #0s : i
        let s_2_6: i128 = 0;
        // D s_2_7: read-var diff2:i64
        let s_2_7: i64 = fn_state.diff2;
        // D s_2_8: cast zx s_2_7 -> i
        let s_2_8: i128 = (i128::try_from(s_2_7).unwrap());
        // D s_2_9: cmp-ge s_2_8 s_2_6
        let s_2_9: bool = ((s_2_8) >= (s_2_6));
        // N s_2_10: branch s_2_9 b11 b3
        if s_2_9 {
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var ga#347560 <= s_3_0
        fn_state.ga_347560 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#347560:u8
        let s_4_0: bool = fn_state.ga_347560;
        ...
        // C s_4_6: const #0s : i
        let s_4_6: i128 = 0;
        // D s_4_7: read-var diff3:i64
        let s_4_7: i64 = fn_state.diff3;
        // D s_4_8: cast zx s_4_7 -> i
        let s_4_8: i128 = (i128::try_from(s_4_7).unwrap());
        // D s_4_9: cmp-ge s_4_8 s_4_6
        let s_4_9: bool = ((s_4_8) >= (s_4_6));
        // N s_4_10: branch s_4_9 b10 b5
        if s_4_9 {
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var ga#347565 <= s_5_0
        fn_state.ga_347565 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#347565:u8
        let s_6_0: bool = fn_state.ga_347565;
        ...
        // C s_6_6: const #0s : i
        let s_6_6: i128 = 0;
        // D s_6_7: read-var diff4:i64
        let s_6_7: i64 = fn_state.diff4;
        // D s_6_8: cast zx s_6_7 -> i
        let s_6_8: i128 = (i128::try_from(s_6_7).unwrap());
        // D s_6_9: cmp-ge s_6_8 s_6_6
        let s_6_9: bool = ((s_6_8) >= (s_6_6));
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var ga#347570 <= s_7_0
        fn_state.ga_347570 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var ga#347570:u8
        let s_8_0: bool = fn_state.ga_347570;
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var ga#347570 <= s_9_0
        fn_state.ga_347570 = s_9_0;
        // N s_9_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var ga#347565 <= s_10_0
        fn_state.ga_347565 = s_10_0;
        // N s_10_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var ga#347560 <= s_11_0
        fn_state.ga_347560 = s_11_0;
        // N s_11_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var ga#347555 <= s_12_0
        fn_state.ga_347555 = s_12_0;
        // N s_12_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
