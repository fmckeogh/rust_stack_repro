...
use Z_set::*;
use common::*;
pub fn execute_BIC_Z_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#2503 <= s_0_2
        fn_state.VLshadow_2503 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#2503:i64
        let s_1_0: i64 = fn_state.VLshadow_2503;
        ...
        // D s_1_15: not s_1_12
        let s_1_15: Bits = !s_1_12;
        // D s_1_16: and s_1_6 s_1_15
        let s_1_16: Bits = ((s_1_6) & (s_1_15));
        // D s_1_17: read-var d:i64
        let s_1_17: i64 = fn_state.d;
        // D s_1_18: cast zx s_1_17 -> i
        let s_1_18: i128 = (i128::try_from(s_1_17).unwrap());
        // D s_1_19: cast zx s_1_14 -> i
        let s_1_19: i128 = (i128::try_from(s_1_14).unwrap());
        // D s_1_20: call Z_set(s_1_18, s_1_19, s_1_16)
        let s_1_20: () = Z_set(state, tracer, s_1_18, s_1_19, s_1_16);
        // N s_1_21: return
        return;
    }
}
