...
use VPIDR_write::*;
use common::*;
pub fn VPIDR_SysRegWrite32_deaaa2df067d2d32<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_2: call Mk_VPIDR_Type(s_7_1)
        let s_7_2: ProductType700c18a878c5601b = Mk_VPIDR_Type(state, tracer, s_7_1);
        // D s_7_3: call VPIDR_write(s_7_2)
        let s_7_3: () = VPIDR_write(state, tracer, s_7_2);
        // N s_7_4: return
        return;
    }
    fn block_8<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_2: call Mk_VPIDR_Type(s_10_1)
        let s_10_2: ProductType700c18a878c5601b = Mk_VPIDR_Type(state, tracer, s_10_1);
        // D s_10_3: call VPIDR_write(s_10_2)
        let s_10_3: () = VPIDR_write(state, tracer, s_10_2);
        // N s_10_4: return
        return;
    }
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#134472 <= s_12_0
        fn_state.gs_134472 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#134472:u8
        let s_13_0: bool = fn_state.gs_134472;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#134473 <= s_14_0
        fn_state.gs_134473 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#134473:u8
        let s_15_0: bool = fn_state.gs_134473;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#134474 <= s_17_0
        fn_state.gs_134474 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#134474:u8
        let s_18_0: bool = fn_state.gs_134474;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#134475 <= s_19_0
        fn_state.gs_134475 = s_19_0;
        // N s_19_2: jump b20
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_0: read-var gs#134475:u8
        let s_20_0: bool = fn_state.gs_134475;
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_5: write-var gs#134475 <= s_23_4
        fn_state.gs_134475 = s_23_4;
        // N s_23_6: jump b20
        return block_20(state, tracer, fn_state);
    }
    fn block_24<T: Tracer>(
        ...
        // D s_24_3: write-var gs#134474 <= s_24_2
        fn_state.gs_134474 = s_24_2;
        // N s_24_4: jump b18
        return block_18(state, tracer, fn_state);
    }
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_5: write-var gs#134473 <= s_26_4
        fn_state.gs_134473 = s_26_4;
        // N s_26_6: jump b15
        return block_15(state, tracer, fn_state);
    }
    fn block_27<T: Tracer>(
        ...
        // D s_27_4: write-var gs#134472 <= s_27_3
        fn_state.gs_134472 = s_27_3;
        // N s_27_5: jump b13
        return block_13(state, tracer, fn_state);
    }
