...
use R_set::*;
use ELUsingAArch32::*;
use u__get_ICC_MCTLR::*;
use EL2Enabled::*;
use u_get_HSTR_EL2_Type_T12::*;
use HSTR_read::*;
use common::*;
pub fn ICC_MCTLR_SysRegRead32_f1e0f70708724584<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    struct FunctionState {
        ga_179922: ProductType700c18a878c5601b,
        gs_111574: bool,
        u__PSTATE_EL: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_11: const #19992u : u32
        let s_0_11: u32 = 19992;
        ...
        // D s_0_13: call _get_ICC_MSRE_Type_SRE(s_0_12)
        let s_0_13: bool = u_get_ICC_MSRE_Type_SRE(state, tracer, s_0_12);
        // D s_0_14: write-var __ICC_MSRE_SRE <= s_0_13
        fn_state.u__ICC_MSRE_SRE = s_0_13;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #21800u : u32
        let s_6_0: u32 = 21800;
        // D s_6_1: read-reg s_6_0:struct
        let s_6_1: ProductType700c18a878c5601b = {
            let value = state
                .read_register::<ProductType700c18a878c5601b>(s_6_0 as isize);
            tracer.read_register(s_6_0 as isize, value);
            value
        };
        // D s_6_2: call __get_ICC_MCTLR(s_6_1)
        let s_6_2: ProductType700c18a878c5601b = u__get_ICC_MCTLR(state, tracer, s_6_1);
        // D s_6_3: write-var ga#179922 <= s_6_2
        fn_state.ga_179922 = s_6_2;
        // D s_6_4: read-var ga#179922.0:struct
        let s_6_4: u32 = fn_state.ga_179922._0;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#111571 <= s_10_0
        fn_state.gs_111571 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#111571:u8
        let s_11_0: bool = fn_state.gs_111571;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#111572 <= s_12_0
        fn_state.gs_111572 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#111572:u8
        let s_13_0: bool = fn_state.gs_111572;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#111573 <= s_15_0
        fn_state.gs_111573 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#111573:u8
        let s_16_0: bool = fn_state.gs_111573;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#111574 <= s_17_0
        fn_state.gs_111574 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#111574:u8
        let s_18_0: bool = fn_state.gs_111574;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_5: write-var gs#111574 <= s_21_4
        fn_state.gs_111574 = s_21_4;
        // N s_21_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        // D s_22_3: write-var gs#111573 <= s_22_2
        fn_state.gs_111573 = s_22_2;
        // N s_22_4: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_5: write-var gs#111572 <= s_24_4
        fn_state.gs_111572 = s_24_4;
        // N s_24_6: jump b13
        return block_13(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_4: write-var gs#111571 <= s_25_3
        fn_state.gs_111571 = s_25_3;
        // N s_25_5: jump b11
        return block_11(state, tracer, fn_state);
    }
