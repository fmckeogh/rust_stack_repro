...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_MCRR_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_MCRR_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    Rt2: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 15;
        // D s_3_1: write-var ga#344968 <= s_3_0
        fn_state.ga_344968 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#344968:i64
        let s_4_0: i64 = fn_state.ga_344968;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#298431 <= s_5_3
        fn_state.gs_298431 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#298431:u8
        let s_6_0: bool = fn_state.gs_298431;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var cp:i64
        let s_7_0: i64 = fn_state.cp;
        // D s_7_1: read-var t:i64
        let s_7_1: i64 = fn_state.t;
        // D s_7_2: read-var t2:i64
        let s_7_2: i64 = fn_state.t2;
        // D s_7_3: call execute_aarch32_instrs_MCRR_Op_A_txt(s_7_0, s_7_1, s_7_2)
        let s_7_3: () = execute_aarch32_instrs_MCRR_Op_A_txt(
            state,
            tracer,
            s_7_0,
            s_7_1,
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#298431 <= s_9_0
        fn_state.gs_298431 = s_9_0;
        // N s_9_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_10<T: Tracer>(
        ...
        // C s_10_0: const #14s : i64
        let s_10_0: i64 = 14;
        // D s_10_1: write-var ga#344968 <= s_10_0
        fn_state.ga_344968 = s_10_0;
        // N s_10_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
