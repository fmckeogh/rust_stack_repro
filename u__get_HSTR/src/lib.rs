...
pub fn u__get_HSTR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4294918160u : u32
        let s_0_3: u32 = 4294918160;
        ...
        // D s_0_11: tail-call Mk_HSTR_Type(s_0_10)
        return Mk_HSTR_Type(state, tracer, s_0_10);
    }
}
