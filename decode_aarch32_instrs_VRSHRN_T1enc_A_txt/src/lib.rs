...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_VRSHRN_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_VRSHRN_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    imm6: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_0: const #1u : u8
        let s_3_0: bool = true;
        // D s_3_1: write-var gs#318225 <= s_3_0
        fn_state.gs_318225 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#318225:u8
        let s_4_0: bool = fn_state.gs_318225;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_37: call execute_aarch32_instrs_VRSHRN_Op_A_txt(s_8_18, s_8_2, s_8_36, s_8_34, s_8_0)
        let s_8_37: () = execute_aarch32_instrs_VRSHRN_Op_A_txt(
            state,
            tracer,
            s_8_18,
            s_8_2,
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#318225 <= s_16_0
        fn_state.gs_318225 = s_16_0;
        // N s_16_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
