...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_binary_element_mul_acc_double_sisd::*;
use common::*;
pub fn decode_sqdmlsl_advsimd_elt_aarch64_instrs_vector_arithmetic_binary_element_mul_acc_double_simd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#267310 <= s_1_0
        fn_state.ga_267310 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#267310:i64
        let s_2_0: i64 = fn_state.ga_267310;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_39: read-var o2:u8
        let s_4_39: bool = fn_state.o2;
        ...
        // C s_4_44: const #64s : i64
        let s_4_44: i64 = 64;
        // D s_4_45: cast zx s_4_30 -> i
        let s_4_45: i128 = (i128::try_from(s_4_30).unwrap());
        // D s_4_46: cast reint s_4_45 -> i64
        let s_4_46: i64 = (s_4_45 as i64);
        // D s_4_47: read-var idxdsize:i64
        let s_4_47: i64 = fn_state.idxdsize;
        ...
        // D s_4_50: cast zx s_4_38 -> i
        let s_4_50: i128 = (i128::try_from(s_4_38).unwrap());
        // D s_4_51: call execute_aarch64_instrs_vector_arithmetic_binary_element_mul_acc_double_sisd(s_4_5, s_4_44, s_4_50, s_4_46, s_4_49, s_4_1, s_4_24, s_4_9, s_4_34, s_4_43)
        let s_4_51: () = execute_aarch64_instrs_vector_arithmetic_binary_element_mul_acc_double_sisd(
            state,
            tracer,
            s_4_5,
            s_4_44,
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 128;
        // D s_8_1: write-var ga#267310 <= s_8_0
        fn_state.ga_267310 = s_8_0;
        // N s_8_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
