...
use X_set::*;
use MPAM3_EL3_read::*;
use u__get_MPAM3_EL3::*;
use common::*;
pub fn MPAM3_EL3_SysRegRead_2770962b9f8f46c1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_71178: ProductType5c790c8ef59cc8b2,
        u__PSTATE_EL: u8,
        el: u8,
        op0: u8,
        op1: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_1: const #() : ()
        let s_5_1: () = ();
        // S s_5_2: call MPAM3_EL3_read(s_5_1)
        let s_5_2: ProductType5c790c8ef59cc8b2 = MPAM3_EL3_read(state, tracer, s_5_1);
        // S s_5_3: call __get_MPAM3_EL3(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_MPAM3_EL3(state, tracer, s_5_2);
        // D s_5_4: write-var ga#71178 <= s_5_3
        fn_state.ga_71178 = s_5_3;
        // D s_5_5: read-var ga#71178.0:struct
        let s_5_5: u64 = fn_state.ga_71178._0;
