...
use Z_set::*;
use common::*;
pub fn execute_SQCVT_Z_MZ2__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#6765 <= s_0_2
        fn_state.VLshadow_6765 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#6765:i64
        let s_1_0: i64 = fn_state.VLshadow_6765;
        // D s_1_1: write-var VLshadow#6766 <= s_1_0
        fn_state.VLshadow_6766 = s_1_0;
        // C s_1_2: const #2s : i
        let s_1_2: i128 = 2;
        ...
        // D s_1_7: read-var VLshadow#6766:i64
        let s_1_7: i64 = fn_state.VLshadow_6766;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_6: read-var VLshadow#6766:i64
        let s_3_6: i64 = fn_state.VLshadow_6766;
        ...
        // D s_3_19: write-var gs#287440 <= s_3_18
        fn_state.gs_287440 = s_3_18;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#287440:i64
        let s_4_1: i64 = fn_state.gs_287440;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_35: call SignedSat(s_5_33, s_5_34)
        let s_5_35: Bits = SignedSat(state, tracer, s_5_33, s_5_34);
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var VLshadow#6766:i64
        let s_7_0: i64 = fn_state.VLshadow_6766;
