...
use common::*;
pub fn decode_sqsub_advsimd_aarch64_instrs_vector_arithmetic_binary_uniform_sub_saturating_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, Rm: u8, size: u8, U: bool) -> () {
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_27: const #1s : i
        let s_0_27: i128 = 1;
        // D s_0_28: call execute_aarch64_instrs_vector_arithmetic_binary_uniform_sub_saturating_sisd(s_0_3, s_0_24, s_0_27, s_0_26, s_0_11, s_0_7, s_0_22)
        let s_0_28: () = execute_aarch64_instrs_vector_arithmetic_binary_uniform_sub_saturating_sisd(
            state,
            tracer,
            s_0_3,
            s_0_24,
