...
use common::*;
pub fn u__get_PMSICR_EL1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #64s : i
        let s_0_3: i128 = 64;
        // C s_0_4: const #72057589742960640u : u56
        let s_0_4: u64 = 72057589742960640;
        ...
        // D s_0_15: tail-call Mk_PMSICR_EL1_Type(s_0_14)
        return Mk_PMSICR_EL1_Type(state, tracer, s_0_14);
    }
}
