...
use HaveSVE::*;
use CurrentVL_read::*;
use execute_FTMAD_Z_ZZI__::*;
use common::*;
pub fn decode_FTMAD_Z_ZZI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    imm3: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_7: read-var Zdn:u8
        let s_2_7: u8 = fn_state.Zdn;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: read-var dn:i64
        let s_3_4: i64 = fn_state.dn;
        // D s_3_5: read-var imm:i64
        let s_3_5: i64 = fn_state.imm;
        // D s_3_6: read-var m:i64
        let s_3_6: i64 = fn_state.m;
        // D s_3_7: call execute_FTMAD_Z_ZZI__(s_3_0, s_3_4, s_3_3, s_3_5, s_3_6)
        let s_3_7: () = execute_FTMAD_Z_ZZI__(
            state,
            tracer,
            s_3_0,
            s_3_4,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_5: read-var imm:i64
        let s_5_5: i64 = fn_state.imm;
        // D s_5_6: read-var m:i64
        let s_5_6: i64 = fn_state.m;
        // D s_5_7: call execute_FTMAD_Z_ZZI__(s_5_0, s_5_4, s_5_3, s_5_5, s_5_6)
        let s_5_7: () = execute_FTMAD_Z_ZZI__(
            state,
            tracer,
            s_5_0,
            s_5_4,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_5: read-var imm:i64
        let s_7_5: i64 = fn_state.imm;
        // D s_7_6: read-var m:i64
        let s_7_6: i64 = fn_state.m;
        // D s_7_7: call execute_FTMAD_Z_ZZI__(s_7_0, s_7_4, s_7_3, s_7_5, s_7_6)
        let s_7_7: () = execute_FTMAD_Z_ZZI__(
            state,
            tracer,
            s_7_0,
            s_7_4,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_5: read-var imm:i64
        let s_9_5: i64 = fn_state.imm;
        // D s_9_6: read-var m:i64
        let s_9_6: i64 = fn_state.m;
        // D s_9_7: call execute_FTMAD_Z_ZZI__(s_9_0, s_9_4, s_9_3, s_9_5, s_9_6)
        let s_9_7: () = execute_FTMAD_Z_ZZI__(
            state,
            tracer,
            s_9_0,
            s_9_4,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_5: read-var imm:i64
        let s_11_5: i64 = fn_state.imm;
        // D s_11_6: read-var m:i64
        let s_11_6: i64 = fn_state.m;
        // D s_11_7: call execute_FTMAD_Z_ZZI__(s_11_0, s_11_4, s_11_3, s_11_5, s_11_6)
        let s_11_7: () = execute_FTMAD_Z_ZZI__(
            state,
            tracer,
            s_11_0,
            s_11_4,
