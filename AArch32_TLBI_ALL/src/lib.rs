...
use TLBI::*;
use common::*;
pub fn AArch32_TLBI_ALL<T: Tracer>(
    state: &mut State,
    tracer: &T,
    security: u32,
    regime: u32,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_7: write-var gs#32396 <= s_1_6
        fn_state.gs_32396 = s_1_6;
        // N s_1_8: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#32396:u8
        let s_2_0: bool = fn_state.gs_32396;
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_0: const #1u : u8
        let s_5_0: bool = true;
        // D s_5_1: write-var gs#32396 <= s_5_0
        fn_state.gs_32396 = s_5_0;
        // N s_5_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
