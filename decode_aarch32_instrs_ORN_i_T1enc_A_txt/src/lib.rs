...
use ConditionPassed::*;
use T32ExpandImm_C::*;
use execute_aarch32_instrs_ORN_i_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_ORN_i_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i: bool,
    S: bool,
    ...
    struct FunctionState {
        carry: bool,
        imm32: u32,
        ga_345304: ProductType4813027798de1e98,
        setflags: bool,
        n: i64,
        d: i64,
        i: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_44: write-var ga#345304 <= s_3_43
        fn_state.ga_345304 = s_3_43;
        // D s_3_45: read-var ga#345304.0:struct
        let s_3_45: u32 = fn_state.ga_345304._0;
        // D s_3_46: read-var ga#345304.1:struct
        let s_3_46: bool = fn_state.ga_345304._1;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_5: call execute_aarch32_instrs_ORN_i_Op_A_txt(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4)
        let s_4_5: () = execute_aarch32_instrs_ORN_i_Op_A_txt(
            state,
            tracer,
            s_4_0,
            s_4_1,
