...
extern crate alloc;
use AArch64_TLBI_PAALL::*;
use common::*;
pub fn TLBI_PAALLOS_SysOpsWrite_b02935bd045e4472<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: u32 = 2;
        // S s_5_1: call AArch64_TLBI_PAALL(s_5_0)
        let s_5_1: () = AArch64_TLBI_PAALL(state, tracer, s_5_0);
        // N s_5_2: return
        return;
    }
    fn block_6<T: Tracer>(
