...
use ConditionPassed::*;
use neq_int::*;
use execute_aarch32_instrs_CLZ_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_CLZ_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    Rd: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_17: call neq_int(s_2_15, s_2_16)
        let s_2_17: bool = neq_int(state, tracer, s_2_15, s_2_16);
        // N s_2_18: branch s_2_17 b10 b3
        if s_2_17 {
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#296241 <= s_3_3
        fn_state.gs_296241 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#296241:u8
        let s_4_0: bool = fn_state.gs_296241;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#296243 <= s_5_3
        fn_state.gs_296243 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#296243:u8
        let s_6_0: bool = fn_state.gs_296243;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_2: call execute_aarch32_instrs_CLZ_Op_A_txt(s_7_0, s_7_1)
        let s_7_2: () = execute_aarch32_instrs_CLZ_Op_A_txt(state, tracer, s_7_0, s_7_1);
        // N s_7_3: return
        return;
    }
    fn block_8<T: Tracer>(
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#296243 <= s_9_0
        fn_state.gs_296243 = s_9_0;
        // N s_9_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#296241 <= s_10_0
        fn_state.gs_296241 = s_10_0;
        // N s_10_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
