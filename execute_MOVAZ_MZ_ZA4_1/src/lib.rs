...
use ZAvector_read::*;
use common::*;
pub fn execute_MOVAZ_MZ_ZA4_1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#6922 <= s_0_2
        fn_state.VLshadow_6922 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#6922:i64
        let s_1_0: i64 = fn_state.VLshadow_6922;
        // D s_1_1: write-var VLshadow#6923 <= s_1_0
        fn_state.VLshadow_6923 = s_1_0;
        // C s_1_2: const #8s : i
        let s_1_2: i128 = 8;
        // D s_1_3: read-var VLshadow#6923:i64
        let s_1_3: i64 = fn_state.VLshadow_6923;
        ...
        // D s_1_37: write-var gs#291554 <= s_1_36
        fn_state.gs_291554 = s_1_36;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#291554:i64
        let s_2_1: i64 = fn_state.gs_291554;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: read-var VLshadow#6923:i64
        let s_3_1: i64 = fn_state.VLshadow_6923;
        ...
        // D s_3_6: read-var vec:i
        let s_3_6: i128 = fn_state.vec;
        // D s_3_7: read-var VLshadow#6923:i64
        let s_3_7: i64 = fn_state.VLshadow_6923;
        // D s_3_8: cast zx s_3_7 -> i
        let s_3_8: i128 = (i128::try_from(s_3_7).unwrap());
        // D s_3_9: cast reint s_3_8 -> i64
        let s_3_9: i64 = (s_3_8 as i64);
        // D s_3_10: read-var VLshadow#6923:i64
        let s_3_10: i64 = fn_state.VLshadow_6923;
        // D s_3_11: cast zx s_3_10 -> i
        let s_3_11: i128 = (i128::try_from(s_3_10).unwrap());
        // D s_3_12: call Zeros(s_3_11)
        let s_3_12: Bits = Zeros(state, tracer, s_3_11);
        // D s_3_13: cast zx s_3_9 -> i
        let s_3_13: i128 = (i128::try_from(s_3_9).unwrap());
        // D s_3_14: call ZAvector_set(s_3_6, s_3_13, s_3_12)
        let s_3_14: () = ZAvector_set(state, tracer, s_3_6, s_3_13, s_3_12);
        // D s_3_15: read-var d:i64
        let s_3_15: i64 = fn_state.d;
        // D s_3_16: cast zx s_3_15 -> i
        let s_3_16: i128 = (i128::try_from(s_3_15).unwrap());
        // D s_3_17: read-var r:i64
        let s_3_17: i64 = fn_state.r;
        ...
        // D s_3_21: read-var VLshadow#6923:i64
        let s_3_21: i64 = fn_state.VLshadow_6923;
        ...
        // D s_3_26: call Z_set(s_3_24, s_3_25, s_3_5)
        let s_3_26: () = Z_set(state, tracer, s_3_24, s_3_25, s_3_5);
        // D s_3_27: read-var vstride:i64
        let s_3_27: i64 = fn_state.vstride;
        // D s_3_28: cast zx s_3_27 -> i
        let s_3_28: i128 = (i128::try_from(s_3_27).unwrap());
        // D s_3_29: read-var vec:i
        let s_3_29: i128 = fn_state.vec;
        // D s_3_30: add s_3_29 s_3_28
        let s_3_30: i128 = (s_3_29 + s_3_28);
        // D s_3_31: write-var vec <= s_3_30
        fn_state.vec = s_3_30;
        // D s_3_32: read-var r:i64
        let s_3_32: i64 = fn_state.r;
        // C s_3_33: const #1s : i64
        let s_3_33: i64 = 1;
        // D s_3_34: add s_3_32 s_3_33
        let s_3_34: i64 = (s_3_32 + s_3_33);
        // D s_3_35: write-var r <= s_3_34
        fn_state.r = s_3_34;
        // N s_3_36: jump b2
        return block_2(state, tracer, fn_state);
    }
