...
use D_set::*;
use common::*;
pub fn execute_aarch32_instrs_VDOT_bf16_i_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    i: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_10: write-var gs#326895 <= s_1_9
        fn_state.gs_326895 = s_1_9;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#326895:i64
        let s_2_1: i64 = fn_state.gs_326895;
