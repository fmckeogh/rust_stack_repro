...
pub fn u__get_VDISR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #2113929216u : u32
        let s_0_3: u32 = 2113929216;
        ...
        // D s_0_11: tail-call Mk_VDISR_Type(s_0_10)
        return Mk_VDISR_Type(state, tracer, s_0_10);
    }
}
