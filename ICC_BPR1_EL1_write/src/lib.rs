...
use common::*;
pub fn ICC_BPR1_EL1_write<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#33288 <= s_1_0
        fn_state.gs_33288 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#33288:u8
        let s_2_0: bool = fn_state.gs_33288;
    ...
    fn block_4<T: Tracer>(
        ...
        // C s_4_1: const #102528u : u32
        let s_4_1: u32 = 102528;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#33288 <= s_5_3
        fn_state.gs_33288 = s_5_3;
        // N s_5_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
