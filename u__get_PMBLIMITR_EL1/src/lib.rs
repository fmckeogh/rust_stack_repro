...
use common::*;
pub fn u__get_PMBLIMITR_EL1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_15: tail-call Mk_PMBLIMITR_EL1_Type(s_0_14)
        return Mk_PMBLIMITR_EL1_Type(state, tracer, s_0_14);
    }
}
