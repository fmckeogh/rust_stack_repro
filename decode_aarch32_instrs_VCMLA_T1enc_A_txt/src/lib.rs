...
use fdiv_int::*;
use common::*;
pub fn decode_aarch32_instrs_VCMLA_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    rot: u8,
    D: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#326313 <= s_3_0
        fn_state.gs_326313 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#326313:u8
        let s_4_0: bool = fn_state.gs_326313;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 2;
        // D s_6_1: write-var ga#366538 <= s_6_0
        fn_state.ga_366538 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var ga#366538:i64
        let s_7_0: i64 = fn_state.ga_366538;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: write-var gs#326330 <= s_8_3
        fn_state.gs_326330 = s_8_3;
        // N s_8_5: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#326330:u8
        let s_9_0: bool = fn_state.gs_326330;
        ...
        let s_9_9: u8 = fn_state.rot;
        // D s_9_10: call execute_aarch32_instrs_VCMLA_Op_A_txt(s_9_4, s_9_5, s_9_3, s_9_6, s_9_7, s_9_8, s_9_9)
        let s_9_10: () = execute_aarch32_instrs_VCMLA_Op_A_txt(
            state,
            tracer,
            s_9_4,
            s_9_5,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#326330 <= s_10_0
        fn_state.gs_326330 = s_10_0;
        // N s_10_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_11<T: Tracer>(
        ...
        let s_11_0: i64 = 1;
        // D s_11_1: write-var ga#366538 <= s_11_0
        fn_state.ga_366538 = s_11_0;
        // N s_11_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_22: write-var gs#326309 <= s_14_21
        fn_state.gs_326309 = s_14_21;
        // N s_14_23: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#326309:u8
        let s_15_0: bool = fn_state.gs_326309;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_22: write-var gs#326312 <= s_16_21
        fn_state.gs_326312 = s_16_21;
        // N s_16_23: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#326312:u8
        let s_17_0: bool = fn_state.gs_326312;
        // D s_17_1: write-var gs#326313 <= s_17_0
        fn_state.gs_326313 = s_17_0;
        // N s_17_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#326312 <= s_18_0
        fn_state.gs_326312 = s_18_0;
        // N s_18_2: jump b17
        return block_17(state, tracer, fn_state);
    }
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#326309 <= s_19_0
        fn_state.gs_326309 = s_19_0;
        // N s_19_2: jump b15
        return block_15(state, tracer, fn_state);
    }
