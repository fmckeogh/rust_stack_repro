...
extern crate alloc;
use u__get_SDER32_EL3::*;
use X_set::*;
use HaveAArch32EL::*;
use SDER32_EL3_read::*;
use common::*;
pub fn SDER32_EL3_SysRegRead_e8c9baf258d1c833<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_85183: ProductType5c790c8ef59cc8b2,
        gs_69301: bool,
        u__PSTATE_EL: u8,
        el: u8,
        op0: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_4: write-var gs#69301 <= s_1_3
        fn_state.gs_69301 = s_1_3;
        // N s_1_5: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#69301:u8
        let s_2_0: bool = fn_state.gs_69301;
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_1: const #() : ()
        let s_8_1: () = ();
        // S s_8_2: call SDER32_EL3_read(s_8_1)
        let s_8_2: ProductType5c790c8ef59cc8b2 = SDER32_EL3_read(state, tracer, s_8_1);
        // S s_8_3: call __get_SDER32_EL3(s_8_2)
        let s_8_3: ProductType5c790c8ef59cc8b2 = u__get_SDER32_EL3(state, tracer, s_8_2);
        // D s_8_4: write-var ga#85183 <= s_8_3
        fn_state.ga_85183 = s_8_3;
        // D s_8_5: read-var ga#85183.0:struct
        let s_8_5: u64 = fn_state.ga_85183._0;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#69301 <= s_13_0
        fn_state.gs_69301 = s_13_0;
        // N s_13_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
