...
use Mem_set::*;
use common::*;
pub fn execute_STNT1W_Z_P_AR_S_x32_unscaled<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    esize: i64,
    ...
    struct FunctionState {
        gs_249147: i64,
        e: i64,
        offsetshadow_5258: u64,
        base: Bits,
        VLshadow_5256: i64,
        baseshadow_5259: Bits,
        mbytes: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#5255 <= s_0_2
        fn_state.VLshadow_5255 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#5255:i64
        let s_1_0: i64 = fn_state.VLshadow_5255;
        // D s_1_1: write-var VLshadow#5256 <= s_1_0
        fn_state.VLshadow_5256 = s_1_0;
        // C s_1_2: const #8s : i
        let s_1_2: i128 = 8;
        // D s_1_3: read-var VLshadow#5256:i64
        let s_1_3: i64 = fn_state.VLshadow_5256;
        ...
        // D s_1_7: read-var VLshadow#5256:i64
        let s_1_7: i64 = fn_state.VLshadow_5256;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var srcshadow#5257 <= s_3_0
        fn_state.srcshadow_5257 = s_3_0;
        // D s_3_2: read-var offset:u64
        let s_3_2: u64 = fn_state.offset;
        // D s_3_3: write-var offsetshadow#5258 <= s_3_2
        fn_state.offsetshadow_5258 = s_3_2;
        // D s_3_4: read-var base:bv
        let s_3_4: Bits = fn_state.base;
        // D s_3_5: write-var baseshadow#5259 <= s_3_4
        fn_state.baseshadow_5259 = s_3_4;
        ...
        // D s_3_12: write-var gs#249147 <= s_3_11
        fn_state.gs_249147 = s_3_11;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#249147:i64
        let s_4_1: i64 = fn_state.gs_249147;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_6: read-var baseshadow#5259:bv
        let s_8_6: Bits = fn_state.baseshadow_5259;
        ...
        // D s_8_14: read-var offsetshadow#5258:u64
        let s_8_14: u64 = fn_state.offsetshadow_5258;
        ...
        // D s_8_24: read-var srcshadow#5257:bv
        let s_8_24: Bits = fn_state.srcshadow_5257;
        ...
        // D s_8_31: cast reint s_8_30 -> u32
        let s_8_31: u32 = (s_8_30.value() as u32);
        ...
        let s_8_34: Bits = Bits::new(s_8_31 as u128, 32u16);
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var VLshadow#5256:i64
        let s_10_0: i64 = fn_state.VLshadow_5256;
        ...
        // D s_10_14: read-var VLshadow#5256:i64
        let s_10_14: i64 = fn_state.VLshadow_5256;
