...
use Z_set::*;
use common::*;
pub fn execute_SMLSLB_Z_ZZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    da: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#3659 <= s_0_2
        fn_state.esizeshadow_3659 = s_0_2;
        ...
        // D s_0_7: write-var VLshadow#3660 <= s_0_6
        fn_state.VLshadow_3660 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#3660:i64
        let s_1_0: i64 = fn_state.VLshadow_3660;
        // D s_1_1: write-var VLshadow#3661 <= s_1_0
        fn_state.VLshadow_3661 = s_1_0;
        // D s_1_2: read-var VLshadow#3661:i64
        let s_1_2: i64 = fn_state.VLshadow_3661;
        // D s_1_3: cast zx s_1_2 -> i
        let s_1_3: i128 = (i128::try_from(s_1_2).unwrap());
        // D s_1_4: read-var esizeshadow#3659:i64
        let s_1_4: i64 = fn_state.esizeshadow_3659;
        ...
        // D s_1_8: read-var VLshadow#3661:i64
        let s_1_8: i64 = fn_state.VLshadow_3661;
        ...
        // D s_1_16: read-var VLshadow#3661:i64
        let s_1_16: i64 = fn_state.VLshadow_3661;
        ...
        // D s_1_24: read-var VLshadow#3661:i64
        let s_1_24: i64 = fn_state.VLshadow_3661;
        ...
        // D s_1_37: write-var gs#206637 <= s_1_36
        fn_state.gs_206637 = s_1_36;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#206637:i64
        let s_2_1: i64 = fn_state.gs_206637;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_9: const #2s : i
        let s_3_9: i128 = 2;
        // D s_3_10: read-var esizeshadow#3659:i64
        let s_3_10: i64 = fn_state.esizeshadow_3659;
        ...
        // C s_3_31: const #2s : i
        let s_3_31: i128 = 2;
        // D s_3_32: read-var esizeshadow#3659:i64
        let s_3_32: i64 = fn_state.esizeshadow_3659;
        ...
        // D s_3_44: read-var esizeshadow#3659:i64
        let s_3_44: i64 = fn_state.esizeshadow_3659;
        ...
        // D s_3_47: read-var esizeshadow#3659:i64
        let s_3_47: i64 = fn_state.esizeshadow_3659;
        ...
        // C s_3_59: const #1s : i
        let s_3_59: i128 = 1;
        // D s_3_60: read-var esizeshadow#3659:i64
        let s_3_60: i64 = fn_state.esizeshadow_3659;
        // D s_3_61: cast zx s_3_60 -> i
        let s_3_61: i128 = (i128::try_from(s_3_60).unwrap());
        // D s_3_62: sub s_3_61 s_3_59
        let s_3_62: i128 = ((s_3_61) - (s_3_59));
        // D s_3_63: cast reint s_3_62 -> i64
        let s_3_63: i64 = (s_3_62 as i64);
        // C s_3_64: const #0s : i
        let s_3_64: i128 = 0;
        // D s_3_65: cast zx s_3_58 -> i
        let s_3_65: i128 = (i128::try_from(s_3_58).unwrap());
        // D s_3_66: cast zx s_3_63 -> i
        let s_3_66: i128 = (i128::try_from(s_3_63).unwrap());
        // D s_3_67: call integer_subrange(s_3_65, s_3_66, s_3_64)
        let s_3_67: Bits = integer_subrange(state, tracer, s_3_65, s_3_66, s_3_64);
        // D s_3_68: sub s_3_54 s_3_67
        let s_3_68: Bits = ((s_3_54) - (s_3_67));
        // D s_3_69: read-var e:i64
        let s_3_69: i64 = fn_state.e;
        ...
        // D s_3_72: read-var result:bv
        let s_3_72: Bits = fn_state.result;
        // D s_3_73: call Elem_set(s_3_72, s_3_70, s_3_71, s_3_68)
        let s_3_73: Bits = Elem_set(state, tracer, s_3_72, s_3_70, s_3_71, s_3_68);
        // D s_3_74: write-var result <= s_3_73
        fn_state.result = s_3_73;
        // D s_3_75: read-var e:i64
        let s_3_75: i64 = fn_state.e;
        // C s_3_76: const #1s : i64
        let s_3_76: i64 = 1;
        // D s_3_77: add s_3_75 s_3_76
        let s_3_77: i64 = (s_3_75 + s_3_76);
        // D s_3_78: write-var e <= s_3_77
        fn_state.e = s_3_77;
        // N s_3_79: jump b2
        return block_2(state, tracer, fn_state);
    }
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#3661:i64
        let s_4_0: i64 = fn_state.VLshadow_3661;
