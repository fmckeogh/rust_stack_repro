...
extern crate alloc;
use Halt__1::*;
use u_get_EDESR_Type_OSUC::*;
use HaltingAllowed::*;
use common::*;
pub fn CheckPendingOSUnlockCatch<T: Tracer>(
    state: &mut State,
    tracer: &T,
    gs_29565: (),
) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#29566 <= s_1_0
        fn_state.gs_29566 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#29566:u8
        let s_2_0: bool = fn_state.gs_29566;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_2: call _get_EDESR_Type_OSUC(s_5_1)
        let s_5_2: bool = u_get_EDESR_Type_OSUC(state, tracer, s_5_1);
        ...
        // D s_5_7: write-var gs#29566 <= s_5_6
        fn_state.gs_29566 = s_5_6;
        // N s_5_8: jump b2
        return block_2(state, tracer, fn_state);
    }
}
