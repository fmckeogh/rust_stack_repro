...
extern crate alloc;
use common::*;
pub fn PMEVCNTR_read<T: Tracer>(state: &mut State, tracer: &T, n: i64) -> u32 {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_0: const #1656u : u32
        let s_0_0: u32 = 1656;
        // D s_0_1: read-reg s_0_0:[u32; 31]
        let s_0_1: [u32; 31usize] = {
            let value = state.read_register::<[u32; 31usize]>(s_0_0 as isize);
        ...
        // C s_0_5: const #10744u : u32
        let s_0_5: u32 = 10744;
        // D s_0_6: read-reg s_0_5:[u64; 32]
        let s_0_6: [u64; 32usize] = {
            let value = state.read_register::<[u64; 32usize]>(s_0_5 as isize);
