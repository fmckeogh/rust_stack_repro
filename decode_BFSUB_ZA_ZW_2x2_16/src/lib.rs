...
use CurrentVL_read::*;
use HaveSMEB16B16::*;
use execute_BFSUB_ZA_ZW_2x2_16::*;
use common::*;
pub fn decode_BFSUB_ZA_ZW_2x2_16<T: Tracer>(
    state: &mut State,
    tracer: &T,
    sz: bool,
    Rv: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_2: const #2s : i64
        let s_2_2: i64 = 2;
        // D s_2_3: read-var offset:i64
        let s_2_3: i64 = fn_state.offset;
        // D s_2_4: read-var v:i64
        let s_2_4: i64 = fn_state.v;
        // D s_2_5: call execute_BFSUB_ZA_ZW_2x2_16(s_2_0, s_2_1, s_2_2, s_2_3, s_2_4)
        let s_2_5: () = execute_BFSUB_ZA_ZW_2x2_16(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_5: call execute_BFSUB_ZA_ZW_2x2_16(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4)
        let s_4_5: () = execute_BFSUB_ZA_ZW_2x2_16(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: call execute_BFSUB_ZA_ZW_2x2_16(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4)
        let s_6_5: () = execute_BFSUB_ZA_ZW_2x2_16(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_5: call execute_BFSUB_ZA_ZW_2x2_16(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4)
        let s_8_5: () = execute_BFSUB_ZA_ZW_2x2_16(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // C s_10_2: const #2s : i64
        let s_10_2: i64 = 2;
        // D s_10_3: read-var offset:i64
        let s_10_3: i64 = fn_state.offset;
        // D s_10_4: read-var v:i64
        let s_10_4: i64 = fn_state.v;
        // D s_10_5: call execute_BFSUB_ZA_ZW_2x2_16(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4)
        let s_10_5: () = execute_BFSUB_ZA_ZW_2x2_16(
            state,
            tracer,
            s_10_0,
            s_10_1,
