...
use u__get_MFAR_EL3::*;
use common::*;
pub fn MFAR_EL3_SysRegRead_6520d659502d749b<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_70984: ProductType5c790c8ef59cc8b2,
        u__PSTATE_EL: u8,
        el: u8,
        op0: u8,
        op1: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // C s_5_1: const #100280u : u32
        let s_5_1: u32 = 100280;
        ...
        // D s_5_3: call __get_MFAR_EL3(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_MFAR_EL3(state, tracer, s_5_2);
        // D s_5_4: write-var ga#70984 <= s_5_3
        fn_state.ga_70984 = s_5_3;
        // D s_5_5: read-var ga#70984.0:struct
        let s_5_5: u64 = fn_state.ga_70984._0;
