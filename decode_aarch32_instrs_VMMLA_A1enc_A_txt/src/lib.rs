...
use execute_aarch32_instrs_VMMLA_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_VMMLA_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Vn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_22: write-var gs#326973 <= s_2_21
        fn_state.gs_326973 = s_2_21;
        // N s_2_23: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#326973:u8
        let s_3_0: bool = fn_state.gs_326973;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_22: write-var gs#326976 <= s_4_21
        fn_state.gs_326976 = s_4_21;
        // N s_4_23: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#326976:u8
        let s_5_0: bool = fn_state.gs_326976;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_48: call execute_aarch32_instrs_VMMLA_Op_A_txt(s_6_15, s_6_47, s_6_31)
        let s_6_48: () = execute_aarch32_instrs_VMMLA_Op_A_txt(
            state,
            tracer,
            s_6_15,
            s_6_47,
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #1u : u8
        let s_8_0: bool = true;
        // D s_8_1: write-var gs#326976 <= s_8_0
        fn_state.gs_326976 = s_8_0;
        // N s_8_2: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#326973 <= s_9_0
        fn_state.gs_326973 = s_9_0;
        // N s_9_2: jump b3
        return block_3(state, tracer, fn_state);
    }
