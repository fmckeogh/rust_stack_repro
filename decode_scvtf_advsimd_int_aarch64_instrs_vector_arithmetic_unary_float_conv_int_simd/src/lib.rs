...
use common::*;
pub fn decode_scvtf_advsimd_int_aarch64_instrs_vector_arithmetic_unary_float_conv_int_simd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, sz: bool, U: bool, Q: bool) -> () {
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 64;
        // D s_2_1: write-var ga#265142 <= s_2_0
        fn_state.ga_265142 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#265142:i64
        let s_3_0: i64 = fn_state.ga_265142;
        ...
        // D s_3_19: call execute_aarch64_instrs_vector_arithmetic_unary_fp16_conv_int_sisd(s_3_17, s_3_12, s_3_16, s_3_15, s_3_18, s_3_10)
        let s_3_19: () = execute_aarch64_instrs_vector_arithmetic_unary_fp16_conv_int_sisd(
            state,
            tracer,
            s_3_17,
            s_3_12,
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 128;
        // D s_4_1: write-var ga#265142 <= s_4_0
        fn_state.ga_265142 = s_4_0;
        // N s_4_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_5<T: Tracer>(
