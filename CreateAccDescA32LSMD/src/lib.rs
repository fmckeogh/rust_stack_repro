...
use HaveTME::*;
use common::*;
pub fn CreateAccDescA32LSMD<T: Tracer>(
    state: &mut State,
    tracer: &T,
    memop: u32,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_14: write-var accdesc.0 <= s_0_13
        fn_state.accdesc._0 = s_0_13;
        // C s_0_15: const #() : ()
        let s_0_15: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#7283 <= s_1_0
        fn_state.gs_7283 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#7283:u8
        let s_2_0: bool = fn_state.gs_7283;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#7283 <= s_3_3
        fn_state.gs_7283 = s_3_3;
        // N s_3_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
