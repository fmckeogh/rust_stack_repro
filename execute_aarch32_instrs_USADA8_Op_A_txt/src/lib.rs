...
use R_read::*;
use common::*;
pub fn execute_aarch32_instrs_USADA8_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    a: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_140: read-var a:i64
        let s_0_140: i64 = fn_state.a;
        // D s_0_141: cast zx s_0_140 -> i
        let s_0_141: i128 = (i128::try_from(s_0_140).unwrap());
        // D s_0_142: call R_read(s_0_141)
        let s_0_142: u32 = R_read(state, tracer, s_0_141);
        // D s_0_143: cast zx s_0_142 -> bv
        let s_0_143: Bits = Bits::new(s_0_142 as u128, 32u16);
        // D s_0_144: cast zx s_0_143 -> i
        let s_0_144: i128 = (s_0_143.value() as i128);
        // D s_0_145: cast reint s_0_144 -> i64
        let s_0_145: i64 = (s_0_144 as i64);
        // D s_0_146: cast zx s_0_145 -> i
        let s_0_146: i128 = (i128::try_from(s_0_145).unwrap());
        // D s_0_147: cast zx s_0_34 -> i
        let s_0_147: i128 = (i128::try_from(s_0_34).unwrap());
        // D s_0_148: add s_0_146 s_0_147
        let s_0_148: i128 = (s_0_146 + s_0_147);
        // D s_0_149: cast reint s_0_148 -> i64
        let s_0_149: i64 = (s_0_148 as i64);
        // D s_0_150: cast zx s_0_149 -> i
        let s_0_150: i128 = (i128::try_from(s_0_149).unwrap());
        // D s_0_151: cast zx s_0_69 -> i
        let s_0_151: i128 = (i128::try_from(s_0_69).unwrap());
        // D s_0_152: add s_0_150 s_0_151
        let s_0_152: i128 = (s_0_150 + s_0_151);
        // D s_0_153: cast reint s_0_152 -> i64
        let s_0_153: i64 = (s_0_152 as i64);
        // D s_0_154: cast zx s_0_153 -> i
        let s_0_154: i128 = (i128::try_from(s_0_153).unwrap());
        // D s_0_155: cast zx s_0_104 -> i
        let s_0_155: i128 = (i128::try_from(s_0_104).unwrap());
        // D s_0_156: add s_0_154 s_0_155
        let s_0_156: i128 = (s_0_154 + s_0_155);
        // D s_0_157: cast reint s_0_156 -> i64
        let s_0_157: i64 = (s_0_156 as i64);
        // D s_0_158: cast zx s_0_157 -> i
        let s_0_158: i128 = (i128::try_from(s_0_157).unwrap());
        // D s_0_159: cast zx s_0_139 -> i
        let s_0_159: i128 = (i128::try_from(s_0_139).unwrap());
        // D s_0_160: add s_0_158 s_0_159
        let s_0_160: i128 = (s_0_158 + s_0_159);
        // D s_0_161: cast reint s_0_160 -> i64
        let s_0_161: i64 = (s_0_160 as i64);
        // C s_0_162: const #31s : i
        let s_0_162: i128 = 31;
        // C s_0_163: const #0s : i
        let s_0_163: i128 = 0;
        // D s_0_164: cast zx s_0_161 -> i
        let s_0_164: i128 = (i128::try_from(s_0_161).unwrap());
        // D s_0_165: call integer_subrange(s_0_164, s_0_162, s_0_163)
        let s_0_165: Bits = integer_subrange(state, tracer, s_0_164, s_0_162, s_0_163);
        // D s_0_166: cast reint s_0_165 -> u32
        let s_0_166: u32 = (s_0_165.value() as u32);
        // D s_0_167: read-var d:i64
        let s_0_167: i64 = fn_state.d;
        // D s_0_168: cast zx s_0_167 -> i
        let s_0_168: i128 = (i128::try_from(s_0_167).unwrap());
        // D s_0_169: call R_set(s_0_168, s_0_166)
        let s_0_169: () = R_set(state, tracer, s_0_168, s_0_166);
        // N s_0_170: return
        return;
    }
}
