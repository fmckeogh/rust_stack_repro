...
extern crate alloc;
use X_set::*;
use u_get_HFGRTR2_EL2_Type_nERXGSR_EL1::*;
...
use EDSCR_read::*;
use common::*;
pub fn ERXGSR_EL1_SysRegRead_63b383efe8ec0d4f<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ...
        gs_61402: bool,
        gs_61394: bool,
        u__HFGRTR2_EL2_nERXGSR_EL1: bool,
        gs_61404: bool,
        gs_61393: bool,
        el: u8,
        op0: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_21: call _get_HFGRTR2_EL2_Type_nERXGSR_EL1(s_0_20)
        let s_0_21: bool = u_get_HFGRTR2_EL2_Type_nERXGSR_EL1(state, tracer, s_0_20);
        // D s_0_22: write-var __HFGRTR2_EL2_nERXGSR_EL1 <= s_0_21
        fn_state.u__HFGRTR2_EL2_nERXGSR_EL1 = s_0_21;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#61385 <= s_7_0
        fn_state.gs_61385 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#61385:u8
        let s_8_0: bool = fn_state.gs_61385;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#61386 <= s_9_0
        fn_state.gs_61386 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#61386:u8
        let s_10_0: bool = fn_state.gs_61386;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#61387 <= s_11_0
        fn_state.gs_61387 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#61387:u8
        let s_12_0: bool = fn_state.gs_61387;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#61388 <= s_13_0
        fn_state.gs_61388 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#61388:u8
        let s_14_0: bool = fn_state.gs_61388;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#61389 <= s_16_0
        fn_state.gs_61389 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#61389:u8
        let s_17_0: bool = fn_state.gs_61389;
    ...
    fn block_18<T: Tracer>(
        ...
        let s_18_0: i64 = 64;
        // C s_18_1: const #14416u : u32
        let s_18_1: u32 = 14416;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#61391 <= s_20_0
        fn_state.gs_61391 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#61391:u8
        let s_21_0: bool = fn_state.gs_61391;
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_5: write-var gs#61391 <= s_24_4
        fn_state.gs_61391 = s_24_4;
        // N s_24_6: jump b21
        return block_21(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_5: write-var gs#61389 <= s_25_4
        fn_state.gs_61389 = s_25_4;
        // N s_25_6: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_5: write-var gs#61388 <= s_27_4
        fn_state.gs_61388 = s_27_4;
        // N s_27_6: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_2: write-var gs#61387 <= s_28_1
        fn_state.gs_61387 = s_28_1;
        // N s_28_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_5: write-var gs#61386 <= s_29_4
        fn_state.gs_61386 = s_29_4;
        // N s_29_6: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_4: write-var gs#61385 <= s_30_3
        fn_state.gs_61385 = s_30_3;
        // N s_30_5: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_1: write-var gs#61392 <= s_32_0
        fn_state.gs_61392 = s_32_0;
        // N s_32_2: jump b33
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var gs#61392:u8
        let s_33_0: bool = fn_state.gs_61392;
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_1: write-var gs#61393 <= s_34_0
        fn_state.gs_61393 = s_34_0;
        // N s_34_2: jump b35
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_0: read-var gs#61393:u8
        let s_35_0: bool = fn_state.gs_61393;
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_1: write-var gs#61394 <= s_36_0
        fn_state.gs_61394 = s_36_0;
        // N s_36_2: jump b37
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_0: read-var gs#61394:u8
        let s_37_0: bool = fn_state.gs_61394;
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_1: write-var gs#61395 <= s_38_0
        fn_state.gs_61395 = s_38_0;
        // N s_38_2: jump b39
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_0: read-var gs#61395:u8
        let s_39_0: bool = fn_state.gs_61395;
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_1: write-var gs#61396 <= s_41_0
        fn_state.gs_61396 = s_41_0;
        // N s_41_2: jump b42
    ...
    fn block_42<T: Tracer>(
        ...
        // D s_42_0: read-var gs#61396:u8
        let s_42_0: bool = fn_state.gs_61396;
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_1: write-var gs#61397 <= s_44_0
        fn_state.gs_61397 = s_44_0;
        // N s_44_2: jump b45
    ...
    fn block_45<T: Tracer>(
        ...
        // D s_45_0: read-var gs#61397:u8
        let s_45_0: bool = fn_state.gs_61397;
        // N s_45_1: branch s_45_0 b71 b46
        if s_45_0 {
    ...
    fn block_46<T: Tracer>(
        ...
        // D s_46_1: write-var gs#61398 <= s_46_0
        fn_state.gs_61398 = s_46_0;
        // N s_46_2: jump b47
    ...
    fn block_47<T: Tracer>(
        ...
        // D s_47_0: read-var gs#61398:u8
        let s_47_0: bool = fn_state.gs_61398;
    ...
    fn block_48<T: Tracer>(
        ...
        // D s_48_1: write-var gs#61399 <= s_48_0
        fn_state.gs_61399 = s_48_0;
        // N s_48_2: jump b49
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_0: read-var gs#61399:u8
        let s_49_0: bool = fn_state.gs_61399;
    ...
    fn block_50<T: Tracer>(
        ...
        // N s_50_2: branch s_50_1 b68 b51
        if s_50_1 {
    ...
    fn block_51<T: Tracer>(
        ...
        // D s_51_1: write-var gs#61400 <= s_51_0
        fn_state.gs_61400 = s_51_0;
        // N s_51_2: jump b52
    ...
    fn block_52<T: Tracer>(
        ...
        // D s_52_0: read-var gs#61400:u8
        let s_52_0: bool = fn_state.gs_61400;
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_1: write-var gs#61401 <= s_53_0
        fn_state.gs_61401 = s_53_0;
        // N s_53_2: jump b54
    ...
    fn block_54<T: Tracer>(
        ...
        // D s_54_0: read-var gs#61401:u8
        let s_54_0: bool = fn_state.gs_61401;
    ...
    fn block_56<T: Tracer>(
        ...
        // D s_56_1: write-var gs#61402 <= s_56_0
        fn_state.gs_61402 = s_56_0;
        // N s_56_2: jump b57
    ...
    fn block_57<T: Tracer>(
        ...
        // D s_57_0: read-var gs#61402:u8
        let s_57_0: bool = fn_state.gs_61402;
    ...
    fn block_58<T: Tracer>(
        ...
        let s_58_0: i64 = 64;
        // C s_58_1: const #14416u : u32
        let s_58_1: u32 = 14416;
    ...
    fn block_60<T: Tracer>(
        ...
        // D s_60_1: write-var gs#61404 <= s_60_0
        fn_state.gs_61404 = s_60_0;
        // N s_60_2: jump b61
    ...
    fn block_61<T: Tracer>(
        ...
        // D s_61_0: read-var gs#61404:u8
        let s_61_0: bool = fn_state.gs_61404;
    ...
    fn block_64<T: Tracer>(
        ...
        // D s_64_5: write-var gs#61404 <= s_64_4
        fn_state.gs_61404 = s_64_4;
        // N s_64_6: jump b61
        return block_61(state, tracer, fn_state);
    }
    fn block_65<T: Tracer>(
        ...
        // D s_65_0: read-var __SCR_EL3_TERR:u8
        let s_65_0: bool = fn_state.u__SCR_EL3_TERR;
        ...
        // D s_65_5: write-var gs#61402 <= s_65_4
        fn_state.gs_61402 = s_65_4;
        // N s_65_6: jump b57
        return block_57(state, tracer, fn_state);
    }
    ...
    fn block_67<T: Tracer>(
        ...
        // D s_67_0: read-var __HFGRTR2_EL2_nERXGSR_EL1:u8
        let s_67_0: bool = fn_state.u__HFGRTR2_EL2_nERXGSR_EL1;
        ...
        // D s_67_5: write-var gs#61401 <= s_67_4
        fn_state.gs_61401 = s_67_4;
        // N s_67_6: jump b54
        return block_54(state, tracer, fn_state);
    }
    ...
    fn block_70<T: Tracer>(
        ...
        // D s_70_0: read-var __SCR_EL3_FGTEn2:u8
        let s_70_0: bool = fn_state.u__SCR_EL3_FGTEn2;
        ...
        // D s_70_5: write-var gs#61399 <= s_70_4
        fn_state.gs_61399 = s_70_4;
        // N s_70_6: jump b49
        return block_49(state, tracer, fn_state);
    }
    fn block_71<T: Tracer>(
        ...
        // D s_71_4: write-var gs#61398 <= s_71_3
        fn_state.gs_61398 = s_71_3;
        // N s_71_5: jump b47
        return block_47(state, tracer, fn_state);
    }
    ...
    fn block_74<T: Tracer>(
        ...
        // D s_74_0: read-var __HCR_EL2_TERR:u8
        let s_74_0: bool = fn_state.u__HCR_EL2_TERR;
        ...
        // D s_74_5: write-var gs#61396 <= s_74_4
        fn_state.gs_61396 = s_74_4;
        // N s_74_6: jump b42
        return block_42(state, tracer, fn_state);
    }
    ...
    fn block_76<T: Tracer>(
        ...
        // D s_76_0: read-var __SCR_EL3_TERR:u8
        let s_76_0: bool = fn_state.u__SCR_EL3_TERR;
        ...
        // D s_76_5: write-var gs#61395 <= s_76_4
        fn_state.gs_61395 = s_76_4;
        // N s_76_6: jump b39
        return block_39(state, tracer, fn_state);
    }
    fn block_77<T: Tracer>(
        ...
        // D s_77_2: write-var gs#61394 <= s_77_1
        fn_state.gs_61394 = s_77_1;
        // N s_77_3: jump b37
        return block_37(state, tracer, fn_state);
    }
    fn block_78<T: Tracer>(
        ...
        // D s_78_5: write-var gs#61393 <= s_78_4
        fn_state.gs_61393 = s_78_4;
        // N s_78_6: jump b35
        return block_35(state, tracer, fn_state);
    }
    fn block_79<T: Tracer>(
        ...
        // D s_79_4: write-var gs#61392 <= s_79_3
        fn_state.gs_61392 = s_79_3;
        // N s_79_5: jump b33
        return block_33(state, tracer, fn_state);
    }
