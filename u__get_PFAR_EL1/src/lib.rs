...
use common::*;
pub fn u__get_PFAR_EL1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4539628424389459968u : u64
        let s_0_3: u64 = 4539628424389459968;
        ...
        // D s_0_11: tail-call Mk_PFAR_EL1_Type(s_0_10)
        return Mk_PFAR_EL1_Type(state, tracer, s_0_10);
    }
}
