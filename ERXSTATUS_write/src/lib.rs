...
extern crate alloc;
use common::*;
pub fn ERXSTATUS_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_6: const #0s : i
        let s_0_6: i128 = 0;
        // C s_0_7: const #103384u : u32
        let s_0_7: u32 = 103384;
        ...
        // C s_0_23: const #103384u : u32
        let s_0_23: u32 = 103384;
        ...
        // C s_0_25: const #11912u : u32
        let s_0_25: u32 = 11912;
