...
use common::*;
pub fn decode_sqrdmulh_advsimd_elt_aarch64_instrs_vector_arithmetic_binary_element_mul_high_sisd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#267510 <= s_1_0
        fn_state.ga_267510 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#267510:i64
        let s_2_0: i64 = fn_state.ga_267510;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_31: read-var op:u8
        let s_4_31: bool = fn_state.op;
        ...
        // C s_4_43: const #1s : i
        let s_4_43: i128 = 1;
        // D s_4_44: call execute_aarch64_instrs_vector_arithmetic_binary_element_mul_high_sisd(s_4_5, s_4_37, s_4_43, s_4_39, s_4_42, s_4_1, s_4_24, s_4_9, s_4_35)
        let s_4_44: () = execute_aarch64_instrs_vector_arithmetic_binary_element_mul_high_sisd(
            state,
            tracer,
            s_4_5,
            s_4_37,
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 128;
        // D s_8_1: write-var ga#267510 <= s_8_0
        fn_state.ga_267510 = s_8_0;
        // N s_8_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
