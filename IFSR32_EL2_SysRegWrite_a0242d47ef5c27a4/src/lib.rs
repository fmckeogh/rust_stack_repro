...
use X_read::*;
use HaveAArch32EL::*;
use Mk_IFSR32_EL2_Type::*;
use u_get_HCR_EL2_Type_NV::*;
use EL2Enabled::*;
use AArch64_SystemAccessTrap::*;
use common::*;
pub fn IFSR32_EL2_SysRegWrite_a0242d47ef5c27a4<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call Mk_IFSR32_EL2_Type(s_6_3)
        let s_6_4: ProductType5c790c8ef59cc8b2 = Mk_IFSR32_EL2_Type(
            state,
            tracer,
            s_6_3,
        );
        // C s_6_5: const #15056u : u32
        let s_6_5: u32 = 15056;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: call Mk_IFSR32_EL2_Type(s_7_3)
        let s_7_4: ProductType5c790c8ef59cc8b2 = Mk_IFSR32_EL2_Type(
            state,
            tracer,
            s_7_3,
        );
        // C s_7_5: const #15056u : u32
        let s_7_5: u32 = 15056;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#86483 <= s_9_0
        fn_state.gs_86483 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#86483:u8
        let s_10_0: bool = fn_state.gs_86483;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_5: write-var gs#86483 <= s_13_4
        fn_state.gs_86483 = s_13_4;
        // N s_13_6: jump b10
        return block_10(state, tracer, fn_state);
    }
