...
use AlignmentFault::*;
use common::*;
pub fn execute_aarch32_instrs_VST3_m_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    alignment: i64,
    d: i64,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_5: write-var gs#321494 <= s_3_4
        fn_state.gs_321494 = s_3_4;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#321494:i64
        let s_4_1: i64 = fn_state.gs_321494;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_11: write-var address <= s_8_10
        fn_state.address = s_8_10;
