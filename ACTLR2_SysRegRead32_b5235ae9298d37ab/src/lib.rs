...
use common::*;
pub fn ACTLR2_SysRegRead32_b5235ae9298d37ab<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_13: call _get_HCR_EL2_Type_TACR(s_0_12)
        let s_0_13: bool = u_get_HCR_EL2_Type_TACR(state, tracer, s_0_12);
        // D s_0_14: write-var __HCR_EL2_TACR <= s_0_13
        fn_state.u__HCR_EL2_TACR = s_0_13;
        // C s_0_15: const #() : ()
        let s_0_15: () = ();
        // S s_0_16: call HCR_read(s_0_15)
        let s_0_16: ProductType700c18a878c5601b = HCR_read(state, tracer, s_0_15);
        // S s_0_17: call _get_HCR_Type_TAC(s_0_16)
        let s_0_17: bool = u_get_HCR_Type_TAC(state, tracer, s_0_16);
        // D s_0_18: write-var __HCR_TAC <= s_0_17
        fn_state.u__HCR_TAC = s_0_17;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #() : ()
        let s_6_0: () = ();
        // S s_6_1: call ACTLR2_NS_read(s_6_0)
        let s_6_1: u32 = ACTLR2_NS_read(state, tracer, s_6_0);
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#105194 <= s_9_0
        fn_state.gs_105194 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#105194:u8
        let s_10_0: bool = fn_state.gs_105194;
    ...
    fn block_11<T: Tracer>(
        ...
        // C s_11_0: const #() : ()
        let s_11_0: () = ();
        // S s_11_1: call ACTLR2_read(s_11_0)
        let s_11_1: u32 = ACTLR2_read(state, tracer, s_11_0);
    ...
    fn block_12<T: Tracer>(
        ...
        // C s_12_0: const #() : ()
        let s_12_0: () = ();
        // S s_12_1: call ACTLR2_NS_read(s_12_0)
        let s_12_1: u32 = ACTLR2_NS_read(state, tracer, s_12_0);
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_3: write-var gs#105194 <= s_13_2
        fn_state.gs_105194 = s_13_2;
        // N s_13_4: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#105195 <= s_15_0
        fn_state.gs_105195 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#105195:u8
        let s_16_0: bool = fn_state.gs_105195;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#105196 <= s_17_0
        fn_state.gs_105196 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#105196:u8
        let s_18_0: bool = fn_state.gs_105196;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#105197 <= s_20_0
        fn_state.gs_105197 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#105197:u8
        let s_21_0: bool = fn_state.gs_105197;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#105198 <= s_22_0
        fn_state.gs_105198 = s_22_0;
        // N s_22_2: jump b23
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_0: read-var gs#105198:u8
        let s_23_0: bool = fn_state.gs_105198;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#105199 <= s_25_0
        fn_state.gs_105199 = s_25_0;
        // N s_25_2: jump b26
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var gs#105199:u8
        let s_26_0: bool = fn_state.gs_105199;
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_1: write-var gs#105200 <= s_27_0
        fn_state.gs_105200 = s_27_0;
        // N s_27_2: jump b28
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_0: read-var gs#105200:u8
        let s_28_0: bool = fn_state.gs_105200;
    ...
    fn block_30<T: Tracer>(
        ...
        // D s_30_1: write-var gs#105201 <= s_30_0
        fn_state.gs_105201 = s_30_0;
        // N s_30_2: jump b31
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_0: read-var gs#105201:u8
        let s_31_0: bool = fn_state.gs_105201;
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_1: write-var gs#105202 <= s_32_0
        fn_state.gs_105202 = s_32_0;
        // N s_32_2: jump b33
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var gs#105202:u8
        let s_33_0: bool = fn_state.gs_105202;
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_1: write-var gs#105203 <= s_35_0
        fn_state.gs_105203 = s_35_0;
        // N s_35_2: jump b36
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_0: read-var gs#105203:u8
        let s_36_0: bool = fn_state.gs_105203;
    ...
    fn block_37<T: Tracer>(
        ...
        // C s_37_0: const #() : ()
        let s_37_0: () = ();
        // S s_37_1: call ACTLR2_read(s_37_0)
        let s_37_1: u32 = ACTLR2_read(state, tracer, s_37_0);
        // D s_37_2: read-var t:i
        let s_37_2: i128 = fn_state.t;
        // D s_37_3: call R_set(s_37_2, s_37_1)
        let s_37_3: () = R_set(state, tracer, s_37_2, s_37_1);
        // N s_37_4: return
        return;
    }
    fn block_38<T: Tracer>(
        ...
        // C s_38_0: const #() : ()
        let s_38_0: () = ();
        // S s_38_1: call ACTLR2_NS_read(s_38_0)
        let s_38_1: u32 = ACTLR2_NS_read(state, tracer, s_38_0);
        // D s_38_2: read-var t:i
        let s_38_2: i128 = fn_state.t;
        // D s_38_3: call R_set(s_38_2, s_38_1)
        let s_38_3: () = R_set(state, tracer, s_38_2, s_38_1);
        // N s_38_4: return
        return;
    }
    fn block_39<T: Tracer>(
        ...
        // D s_39_3: write-var gs#105203 <= s_39_2
        fn_state.gs_105203 = s_39_2;
        // N s_39_4: jump b36
        return block_36(state, tracer, fn_state);
    }
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_0: read-var __HCR_TAC:u8
        let s_41_0: bool = fn_state.u__HCR_TAC;
        ...
        // D s_41_5: write-var gs#105202 <= s_41_4
        fn_state.gs_105202 = s_41_4;
        // N s_41_6: jump b33
        return block_33(state, tracer, fn_state);
    }
    fn block_42<T: Tracer>(
        ...
        // D s_42_3: write-var gs#105201 <= s_42_2
        fn_state.gs_105201 = s_42_2;
        // N s_42_4: jump b31
        return block_31(state, tracer, fn_state);
    }
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_0: read-var __HCR_EL2_TACR:u8
        let s_44_0: bool = fn_state.u__HCR_EL2_TACR;
        ...
        // D s_44_5: write-var gs#105200 <= s_44_4
        fn_state.gs_105200 = s_44_4;
        // N s_44_6: jump b28
        return block_28(state, tracer, fn_state);
    }
    fn block_45<T: Tracer>(
        ...
        // D s_45_4: write-var gs#105199 <= s_45_3
        fn_state.gs_105199 = s_45_3;
        // N s_45_5: jump b26
        return block_26(state, tracer, fn_state);
    }
    ...
    fn block_47<T: Tracer>(
        ...
        // D s_47_5: write-var gs#105198 <= s_47_4
        fn_state.gs_105198 = s_47_4;
        // N s_47_6: jump b23
        return block_23(state, tracer, fn_state);
    }
    fn block_48<T: Tracer>(
        ...
        // D s_48_3: write-var gs#105197 <= s_48_2
        fn_state.gs_105197 = s_48_2;
        // N s_48_4: jump b21
        return block_21(state, tracer, fn_state);
    }
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_5: write-var gs#105196 <= s_50_4
        fn_state.gs_105196 = s_50_4;
        // N s_50_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    fn block_51<T: Tracer>(
        ...
        // D s_51_4: write-var gs#105195 <= s_51_3
        fn_state.gs_105195 = s_51_3;
        // N s_51_5: jump b16
        return block_16(state, tracer, fn_state);
    }
