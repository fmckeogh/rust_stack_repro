...
use Z_set::*;
use common::*;
pub fn execute_MOVA_MZ4_ZA_W1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#5584 <= s_0_2
        fn_state.VLshadow_5584 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#5584:i64
        let s_1_0: i64 = fn_state.VLshadow_5584;
        // D s_1_1: write-var VLshadow#5585 <= s_1_0
        fn_state.VLshadow_5585 = s_1_0;
        // D s_1_2: read-var VLshadow#5585:i64
        let s_1_2: i64 = fn_state.VLshadow_5585;
        ...
        // D s_1_43: write-var gs#259004 <= s_1_42
        fn_state.gs_259004 = s_1_42;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#259004:i64
        let s_2_1: i64 = fn_state.gs_259004;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_7: read-var VLshadow#5585:i64
        let s_3_7: i64 = fn_state.VLshadow_5585;
        ...
        // D s_3_22: read-var VLshadow#5585:i64
        let s_3_22: i64 = fn_state.VLshadow_5585;
