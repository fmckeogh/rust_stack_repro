...
use common::*;
pub fn decode_fmaxp_advsimd_pair_aarch64_instrs_vector_reduce_fp16_max_sisd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_9: call execute_aarch64_instrs_vector_reduce_fp16_max_sisd(s_4_6, s_4_2, s_4_5, s_4_7, s_4_8)
        let s_4_9: () = execute_aarch64_instrs_vector_reduce_fp16_max_sisd(
            state,
            tracer,
            s_4_6,
            s_4_2,
