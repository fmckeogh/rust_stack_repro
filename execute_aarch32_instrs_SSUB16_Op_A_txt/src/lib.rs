...
use common::*;
pub fn execute_aarch32_instrs_SSUB16_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_95: const #0s : i
        let s_0_95: i128 = 0;
        // D s_0_96: read-var diff2:i64
        let s_0_96: i64 = fn_state.diff2;
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_4: const #0s : i
        let s_2_4: i128 = 0;
        // D s_2_5: read-var diff2:i64
        let s_2_5: i64 = fn_state.diff2;
