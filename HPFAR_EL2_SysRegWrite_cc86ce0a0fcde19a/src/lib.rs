...
use Mk_HPFAR_EL2_Type::*;
use u_get_HCR_EL2_Type_NV::*;
use EL2Enabled::*;
use common::*;
pub fn HPFAR_EL2_SysRegWrite_cc86ce0a0fcde19a<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_HPFAR_EL2_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_HPFAR_EL2_Type(state, tracer, s_5_3);
        // C s_5_5: const #11888u : u32
        let s_5_5: u32 = 11888;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call Mk_HPFAR_EL2_Type(s_6_3)
        let s_6_4: ProductType5c790c8ef59cc8b2 = Mk_HPFAR_EL2_Type(state, tracer, s_6_3);
        // C s_6_5: const #11888u : u32
        let s_6_5: u32 = 11888;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#85846 <= s_8_0
        fn_state.gs_85846 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#85846:u8
        let s_9_0: bool = fn_state.gs_85846;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#85846 <= s_12_4
        fn_state.gs_85846 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
