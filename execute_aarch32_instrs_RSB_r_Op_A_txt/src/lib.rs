...
use ALUWritePC::*;
use common::*;
pub fn execute_aarch32_instrs_RSB_r_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        gs_882964: ProductTyped54bc449dd09e5bd,
        result: u32,
        nzcv: u8,
        d: i64,
        m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_17: cast zx s_0_9 -> bv
        let s_0_17: Bits = Bits::new(s_0_9 as u128, 32u16);
        ...
        // D s_0_20: write-var gs#882964 <= s_0_19
        fn_state.gs_882964 = s_0_19;
        // D s_0_21: read-var gs#882964.0:struct
        let s_0_21: Bits = fn_state.gs_882964._0;
        // D s_0_22: cast reint s_0_21 -> u32
        let s_0_22: u32 = (s_0_21.value() as u32);
        // D s_0_23: read-var gs#882964.1:struct
        let s_0_23: u8 = fn_state.gs_882964._1;
