...
use common::*;
pub fn decode_aarch32_instrs_VSUBL_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    U: bool,
    D: bool,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#322714 <= s_5_0
        fn_state.gs_322714 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#322714:u8
        let s_6_0: bool = fn_state.gs_322714;
        // D s_6_1: write-var gs#322715 <= s_6_0
        fn_state.gs_322715 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#322715:u8
        let s_7_0: bool = fn_state.gs_322715;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_22: write-var gs#322714 <= s_10_21
        fn_state.gs_322714 = s_10_21;
        // N s_10_23: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#322715 <= s_11_0
        fn_state.gs_322715 = s_11_0;
        // N s_11_2: jump b7
        return block_7(state, tracer, fn_state);
    }
