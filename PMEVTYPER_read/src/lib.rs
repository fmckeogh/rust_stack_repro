...
extern crate alloc;
use common::*;
pub fn PMEVTYPER_read<T: Tracer>(
    state: &mut State,
    tracer: &T,
    n: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_0: const #23464u : u32
        let s_0_0: u32 = 23464;
        // D s_0_1: read-reg s_0_0:[struct; 31]
        let s_0_1: [ProductType700c18a878c5601b; 31usize] = {
            let value = state
                .read_register::<[ProductType700c18a878c5601b; 31usize]>(s_0_0 as isize);
