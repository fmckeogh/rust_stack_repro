...
use common::*;
pub fn TTBR0_EL2_SysRegRead_213283d6df4659a2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ...
        ga_99729: ProductType782ac6922b48c20d,
        ga_99747: ProductType782ac6922b48c20d,
        u__HCR_EL2_TRVM: bool,
        gs_74464: bool,
        ga_99727: u64,
        gs_74465: bool,
        ga_99736: ProductType782ac6922b48c20d,
        gs_74461: bool,
        gs_74460: bool,
        u__PSTATE_EL: u8,
        u__HFGRTR_EL2_TTBR0_EL1: bool,
        ga_99741: ProductType782ac6922b48c20d,
        el: u8,
        op0: u8,
        op1: u8,
        CRn: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_13: call _get_HFGRTR_EL2_Type_TTBR0_EL1(s_0_12)
        let s_0_13: bool = u_get_HFGRTR_EL2_Type_TTBR0_EL1(state, tracer, s_0_12);
        // D s_0_14: write-var __HFGRTR_EL2_TTBR0_EL1 <= s_0_13
        fn_state.u__HFGRTR_EL2_TTBR0_EL1 = s_0_13;
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_1: const #() : ()
        let s_5_1: () = ();
        // S s_5_2: call TTBR0_EL1_read(s_5_1)
        let s_5_2: ProductType782ac6922b48c20d = TTBR0_EL1_read(state, tracer, s_5_1);
        // S s_5_3: call __get_TTBR0_EL1(s_5_2)
        let s_5_3: ProductType782ac6922b48c20d = u__get_TTBR0_EL1(state, tracer, s_5_2);
        // D s_5_4: write-var ga#99747 <= s_5_3
        fn_state.ga_99747 = s_5_3;
        // D s_5_5: read-var ga#99747.0:struct
        let s_5_5: u128 = fn_state.ga_99747._0;
        // C s_5_6: const #0s : i
        let s_5_6: i128 = 0;
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_1: const #() : ()
        let s_7_1: () = ();
        // S s_7_2: call TTBR0_EL1_read(s_7_1)
        let s_7_2: ProductType782ac6922b48c20d = TTBR0_EL1_read(state, tracer, s_7_1);
        // S s_7_3: call __get_TTBR0_EL1(s_7_2)
        let s_7_3: ProductType782ac6922b48c20d = u__get_TTBR0_EL1(state, tracer, s_7_2);
        // D s_7_4: write-var ga#99741 <= s_7_3
        fn_state.ga_99741 = s_7_3;
        // D s_7_5: read-var ga#99741.0:struct
        let s_7_5: u128 = fn_state.ga_99741._0;
        // C s_7_6: const #0s : i
        let s_7_6: i128 = 0;
        // D s_7_7: cast zx s_7_5 -> bv
        let s_7_7: Bits = Bits::new(s_7_5 as u128, 128u16);
        // C s_7_8: const #1s : i64
        let s_7_8: i64 = 1;
        // C s_7_9: cast zx s_7_8 -> i
        let s_7_9: i128 = (i128::try_from(s_7_8).unwrap());
        // C s_7_10: const #63s : i
        let s_7_10: i128 = 63;
        ...
        // D s_7_15: read-var t:i
        let s_7_15: i128 = fn_state.t;
        // D s_7_16: call X_set(s_7_15, s_7_0, s_7_14)
        let s_7_16: () = X_set(state, tracer, s_7_15, s_7_0, s_7_14);
        // N s_7_17: return
        return;
    }
    fn block_8<T: Tracer>(
        ...
        // C s_8_1: const #() : ()
        let s_8_1: () = ();
        // S s_8_2: call TTBR0_EL2_read(s_8_1)
        let s_8_2: ProductType782ac6922b48c20d = TTBR0_EL2_read(state, tracer, s_8_1);
        // S s_8_3: call __get_TTBR0_EL2(s_8_2)
        let s_8_3: ProductType782ac6922b48c20d = u__get_TTBR0_EL2(state, tracer, s_8_2);
        // D s_8_4: write-var ga#99736 <= s_8_3
        fn_state.ga_99736 = s_8_3;
        // D s_8_5: read-var ga#99736.0:struct
        let s_8_5: u128 = fn_state.ga_99736._0;
        // C s_8_6: const #0s : i
        let s_8_6: i128 = 0;
        // D s_8_7: cast zx s_8_5 -> bv
        let s_8_7: Bits = Bits::new(s_8_5 as u128, 128u16);
        // C s_8_8: const #1s : i64
        let s_8_8: i64 = 1;
        // C s_8_9: cast zx s_8_8 -> i
        let s_8_9: i128 = (i128::try_from(s_8_8).unwrap());
        // C s_8_10: const #63s : i
        let s_8_10: i128 = 63;
        ...
        // D s_8_13: cast reint s_8_12 -> u64
        let s_8_13: u64 = (s_8_12.value() as u64);
        // D s_8_14: cast zx s_8_13 -> bv
        let s_8_14: Bits = Bits::new(s_8_13 as u128, 64u16);
        // D s_8_15: read-var t:i
        let s_8_15: i128 = fn_state.t;
        // D s_8_16: call X_set(s_8_15, s_8_0, s_8_14)
        let s_8_16: () = X_set(state, tracer, s_8_15, s_8_0, s_8_14);
        // N s_8_17: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#74460 <= s_10_0
        fn_state.gs_74460 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#74460:u8
        let s_11_0: bool = fn_state.gs_74460;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#74461 <= s_13_0
        fn_state.gs_74461 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#74461:u8
        let s_14_0: bool = fn_state.gs_74461;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#74463 <= s_15_0
        fn_state.gs_74463 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#74463:u8
        let s_16_0: bool = fn_state.gs_74463;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#74464 <= s_17_0
        fn_state.gs_74464 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#74464:u8
        let s_18_0: bool = fn_state.gs_74464;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#74465 <= s_20_0
        fn_state.gs_74465 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#74465:u8
        let s_21_0: bool = fn_state.gs_74465;
    ...
    fn block_22<T: Tracer>(
        ...
        // C s_22_1: const #() : ()
        let s_22_1: () = ();
        // S s_22_2: call TTBR0_EL1_read(s_22_1)
        let s_22_2: ProductType782ac6922b48c20d = TTBR0_EL1_read(state, tracer, s_22_1);
        // S s_22_3: call __get_TTBR0_EL1(s_22_2)
        let s_22_3: ProductType782ac6922b48c20d = u__get_TTBR0_EL1(
            state,
            tracer,
            s_22_2,
        );
        // D s_22_4: write-var ga#99729 <= s_22_3
        fn_state.ga_99729 = s_22_3;
        // D s_22_5: read-var ga#99729.0:struct
        let s_22_5: u128 = fn_state.ga_99729._0;
        // C s_22_6: const #0s : i
        let s_22_6: i128 = 0;
        // D s_22_7: cast zx s_22_5 -> bv
        let s_22_7: Bits = Bits::new(s_22_5 as u128, 128u16);
        // C s_22_8: const #1s : i64
        let s_22_8: i64 = 1;
        // C s_22_9: cast zx s_22_8 -> i
        let s_22_9: i128 = (i128::try_from(s_22_8).unwrap());
        // C s_22_10: const #63s : i
        let s_22_10: i128 = 63;
        ...
        // D s_22_13: cast reint s_22_12 -> u64
        let s_22_13: u64 = (s_22_12.value() as u64);
        // D s_22_14: cast zx s_22_13 -> bv
        let s_22_14: Bits = Bits::new(s_22_13 as u128, 64u16);
        // D s_22_15: read-var t:i
        let s_22_15: i128 = fn_state.t;
        // D s_22_16: call X_set(s_22_15, s_22_0, s_22_14)
        let s_22_16: () = X_set(state, tracer, s_22_15, s_22_0, s_22_14);
        // N s_22_17: return
        return;
    }
    fn block_23<T: Tracer>(
        ...
        // D s_23_6: write-var ga#99727 <= s_23_5
        fn_state.ga_99727 = s_23_5;
        // N s_23_7: jump b24
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_0: read-var ga#99727:u64
        let s_24_0: u64 = fn_state.ga_99727;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_35: write-var gs#74465 <= s_25_34
        fn_state.gs_74465 = s_25_34;
        // N s_25_36: jump b21
        return block_21(state, tracer, fn_state);
    }
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_0: read-var __HFGRTR_EL2_TTBR0_EL1:u8
        let s_27_0: bool = fn_state.u__HFGRTR_EL2_TTBR0_EL1;
        ...
        // D s_27_5: write-var gs#74464 <= s_27_4
        fn_state.gs_74464 = s_27_4;
        // N s_27_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_5: write-var gs#74462 <= s_29_4
        fn_state.gs_74462 = s_29_4;
        // N s_29_6: jump b30
    ...
    fn block_30<T: Tracer>(
        ...
        // D s_30_0: read-var gs#74462:u8
        let s_30_0: bool = fn_state.gs_74462;
        // D s_30_1: write-var gs#74463 <= s_30_0
        fn_state.gs_74463 = s_30_0;
        // N s_30_2: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_31<T: Tracer>(
        ...
        // D s_31_1: write-var gs#74462 <= s_31_0
        fn_state.gs_74462 = s_31_0;
        // N s_31_2: jump b30
        return block_30(state, tracer, fn_state);
    }
    fn block_32<T: Tracer>(
        ...
        // D s_32_2: write-var gs#74461 <= s_32_1
        fn_state.gs_74461 = s_32_1;
        // N s_32_3: jump b14
        return block_14(state, tracer, fn_state);
    }
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_5: write-var gs#74460 <= s_34_4
        fn_state.gs_74460 = s_34_4;
        // N s_34_6: jump b11
        return block_11(state, tracer, fn_state);
    }
