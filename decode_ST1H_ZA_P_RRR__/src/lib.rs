...
use HaveSME::*;
use CurrentVL_read::*;
use execute_ST1H_ZA_P_RRR__::*;
use common::*;
pub fn decode_ST1H_ZA_P_RRR__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    msz: u8,
    Rm: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        fn_state.s = s_1_42;
        // D s_1_44: read-var ZAt:u8
        let s_1_44: bool = fn_state.ZAt;
        ...
        // D s_1_48: write-var t <= s_1_47
        fn_state.t = s_1_47;
        // D s_1_49: read-var off3:u8
        let s_1_49: u8 = fn_state.off3;
        // D s_1_50: cast zx s_1_49 -> bv
        let s_1_50: Bits = Bits::new(s_1_49 as u128, 3u16);
        // D s_1_51: cast zx s_1_50 -> i
        let s_1_51: i128 = (s_1_50.value() as i128);
        // D s_1_52: cast reint s_1_51 -> i64
        let s_1_52: i64 = (s_1_51 as i64);
        // D s_1_53: write-var offset <= s_1_52
        fn_state.offset = s_1_52;
        // D s_1_54: read-var V:u8
        let s_1_54: bool = fn_state.V;
        // D s_1_55: cast zx s_1_54 -> bv
        let s_1_55: Bits = Bits::new(s_1_54 as u128, 1u16);
        // C s_1_56: const #1u : u8
        let s_1_56: bool = true;
        // C s_1_57: cast zx s_1_56 -> bv
        let s_1_57: Bits = Bits::new(s_1_56 as u128, 1u16);
        // D s_1_58: cmp-eq s_1_55 s_1_57
        let s_1_58: bool = ((s_1_55) == (s_1_57));
        // D s_1_59: write-var vertical <= s_1_58
        fn_state.vertical = s_1_58;
        // D s_1_60: read-var VL:i64
        let s_1_60: i64 = fn_state.VL;
        // C s_1_61: const #128s : i
        let s_1_61: i128 = 128;
        // D s_1_62: cast zx s_1_60 -> i
        let s_1_62: i128 = (i128::try_from(s_1_60).unwrap());
        // D s_1_63: cmp-eq s_1_62 s_1_61
        let s_1_63: bool = ((s_1_62) == (s_1_61));
        // D s_1_64: not s_1_63
        let s_1_64: bool = !s_1_63;
        // N s_1_65: branch s_1_64 b3 b2
        if s_1_64 {
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_9: call execute_ST1H_ZA_P_RRR__(s_2_0, s_2_1, s_2_2, s_2_3, s_2_4, s_2_5, s_2_6, s_2_7, s_2_8)
        let s_2_9: () = execute_ST1H_ZA_P_RRR__(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_9: call execute_ST1H_ZA_P_RRR__(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5, s_4_6, s_4_7, s_4_8)
        let s_4_9: () = execute_ST1H_ZA_P_RRR__(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_9: call execute_ST1H_ZA_P_RRR__(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5, s_6_6, s_6_7, s_6_8)
        let s_6_9: () = execute_ST1H_ZA_P_RRR__(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_9: call execute_ST1H_ZA_P_RRR__(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5, s_8_6, s_8_7, s_8_8)
        let s_8_9: () = execute_ST1H_ZA_P_RRR__(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_9: call execute_ST1H_ZA_P_RRR__(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5, s_10_6, s_10_7, s_10_8)
        let s_10_9: () = execute_ST1H_ZA_P_RRR__(
            state,
            tracer,
            s_10_0,
            s_10_1,
