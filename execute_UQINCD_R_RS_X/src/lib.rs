...
use SatQ::*;
use common::*;
pub fn execute_UQINCD_R_RS_X<T: Tracer>(
    state: &mut State,
    tracer: &T,
    dn: i64,
    esize: i64,
    ...
    struct FunctionState {
        gs_742010: ProductTypef506aa96a892fe52,
        result: Bits,
        ga_281277: u64,
        dn: i64,
        esize: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_22: write-var gs#742010 <= s_1_21
        fn_state.gs_742010 = s_1_21;
        // D s_1_23: read-var gs#742010.0:struct
        let s_1_23: Bits = fn_state.gs_742010._0;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_4: write-var ga#281277 <= s_2_3
        fn_state.ga_281277 = s_2_3;
        // N s_2_5: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_2: read-var ga#281277:u64
        let s_3_2: u64 = fn_state.ga_281277;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: write-var ga#281277 <= s_4_3
        fn_state.ga_281277 = s_4_3;
        // N s_4_5: jump b3
        return block_3(state, tracer, fn_state);
    }
}
