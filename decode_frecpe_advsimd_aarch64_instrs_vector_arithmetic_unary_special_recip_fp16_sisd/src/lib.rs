...
use common::*;
pub fn decode_frecpe_advsimd_aarch64_instrs_vector_arithmetic_unary_special_recip_fp16_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_15: call execute_aarch64_instrs_vector_arithmetic_unary_special_recip_fp16_sisd(s_1_3, s_1_11, s_1_14, s_1_13, s_1_7)
        let s_1_15: () = execute_aarch64_instrs_vector_arithmetic_unary_special_recip_fp16_sisd(
            state,
            tracer,
            s_1_3,
            s_1_11,
