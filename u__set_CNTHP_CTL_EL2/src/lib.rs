...
extern crate alloc;
use common::*;
pub fn u__set_CNTHP_CTL_EL2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_0: const #100912u : u32
        let s_0_0: u32 = 100912;
        ...
        // C s_0_2: const #100912u : u32
        let s_0_2: u32 = 100912;
        ...
        // C s_0_4: const #100912u : u32
        let s_0_4: u32 = 100912;
        ...
        // C s_0_6: const #100912u : u32
        let s_0_6: u32 = 100912;
