...
use u_get_HFGITR_EL2_Type_ICIALLUIS::*;
use IsFeatureImplemented::*;
use AArch64_SystemAccessTrap::*;
use AArch64_IC::*;
use EL2Enabled::*;
use common::*;
pub fn IC_IALLUIS_SysOpsWrite_3eb8cc845c2f9444<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_5: call _get_HCR_EL2_Type_TPU(s_0_4)
        let s_0_5: bool = u_get_HCR_EL2_Type_TPU(state, tracer, s_0_4);
        // D s_0_6: write-var __HCR_EL2_TPU <= s_0_5
        fn_state.u__HCR_EL2_TPU = s_0_5;
        ...
        // D s_0_9: call _get_HCR_EL2_Type_TICAB(s_0_8)
        let s_0_9: bool = u_get_HCR_EL2_Type_TICAB(state, tracer, s_0_8);
        // D s_0_10: write-var __HCR_EL2_TICAB <= s_0_9
        fn_state.u__HCR_EL2_TICAB = s_0_9;
        ...
        // D s_0_17: call _get_HFGITR_EL2_Type_ICIALLUIS(s_0_16)
        let s_0_17: bool = u_get_HFGITR_EL2_Type_ICIALLUIS(state, tracer, s_0_16);
        // D s_0_18: write-var __HFGITR_EL2_ICIALLUIS <= s_0_17
        fn_state.u__HFGITR_EL2_ICIALLUIS = s_0_17;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: u32 = 8;
        // S s_5_1: call AArch64_IC(s_5_0)
        let s_5_1: () = AArch64_IC(state, tracer, s_5_0);
        // N s_5_2: return
        return;
    }
    fn block_6<T: Tracer>(
        ...
        let s_6_0: u32 = 8;
        // S s_6_1: call AArch64_IC(s_6_0)
        let s_6_1: () = AArch64_IC(state, tracer, s_6_0);
        // N s_6_2: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#101932 <= s_8_0
        fn_state.gs_101932 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#101932:u8
        let s_9_0: bool = fn_state.gs_101932;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#101933 <= s_11_0
        fn_state.gs_101933 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#101933:u8
        let s_12_0: bool = fn_state.gs_101933;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#101934 <= s_14_0
        fn_state.gs_101934 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#101934:u8
        let s_15_0: bool = fn_state.gs_101934;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#101936 <= s_16_0
        fn_state.gs_101936 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#101936:u8
        let s_17_0: bool = fn_state.gs_101936;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#101937 <= s_18_0
        fn_state.gs_101937 = s_18_0;
        // N s_18_2: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#101937:u8
        let s_19_0: bool = fn_state.gs_101937;
    ...
    fn block_20<T: Tracer>(
        ...
        let s_20_0: u32 = 8;
        // S s_20_1: call AArch64_IC(s_20_0)
        let s_20_1: () = AArch64_IC(state, tracer, s_20_0);
        // N s_20_2: return
        return;
    }
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_0: read-var __HFGITR_EL2_ICIALLUIS:u8
        let s_22_0: bool = fn_state.u__HFGITR_EL2_ICIALLUIS;
        ...
        // D s_22_5: write-var gs#101937 <= s_22_4
        fn_state.gs_101937 = s_22_4;
        // N s_22_6: jump b19
        return block_19(state, tracer, fn_state);
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_5: write-var gs#101935 <= s_24_4
        fn_state.gs_101935 = s_24_4;
        // N s_24_6: jump b25
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_0: read-var gs#101935:u8
        let s_25_0: bool = fn_state.gs_101935;
        // D s_25_1: write-var gs#101936 <= s_25_0
        fn_state.gs_101936 = s_25_0;
        // N s_25_2: jump b17
        return block_17(state, tracer, fn_state);
    }
    fn block_26<T: Tracer>(
        ...
        // D s_26_1: write-var gs#101935 <= s_26_0
        fn_state.gs_101935 = s_26_0;
        // N s_26_2: jump b25
        return block_25(state, tracer, fn_state);
    }
    fn block_27<T: Tracer>(
        ...
        // D s_27_2: write-var gs#101934 <= s_27_1
        fn_state.gs_101934 = s_27_1;
        // N s_27_3: jump b15
        return block_15(state, tracer, fn_state);
    }
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_0: read-var __HCR_EL2_TICAB:u8
        let s_29_0: bool = fn_state.u__HCR_EL2_TICAB;
        ...
        // D s_29_5: write-var gs#101933 <= s_29_4
        fn_state.gs_101933 = s_29_4;
        // N s_29_6: jump b12
        return block_12(state, tracer, fn_state);
    }
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_5: write-var gs#101932 <= s_31_4
        fn_state.gs_101932 = s_31_4;
        // N s_31_6: jump b9
        return block_9(state, tracer, fn_state);
    }
