...
use common::*;
pub fn u__get_PMEVTYPER_EL0<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #64s : i
        let s_0_3: i128 = 64;
        // C s_0_4: const #864673536270073856u : u60
        let s_0_4: u64 = 864673536270073856;
        ...
        // D s_0_15: tail-call Mk_PMEVTYPER_EL0_Type(s_0_14)
        return Mk_PMEVTYPER_EL0_Type(state, tracer, s_0_14);
    }
}
