...
extern crate alloc;
use CurrentVL_read::*;
use execute_BFMOPS_ZA32_PP_ZZ__::*;
use HaveSME::*;
use common::*;
pub fn decode_BFMOPS_ZA32_PP_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Zm: u8,
    Pm: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_19: call execute_BFMOPS_ZA32_PP_ZZ__(s_2_0, s_2_12, s_2_13, s_2_14, s_2_15, s_2_16, s_2_17, s_2_18)
        let s_2_19: () = execute_BFMOPS_ZA32_PP_ZZ__(
            state,
            tracer,
            s_2_0,
            s_2_12,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_19: call execute_BFMOPS_ZA32_PP_ZZ__(s_4_0, s_4_12, s_4_13, s_4_14, s_4_15, s_4_16, s_4_17, s_4_18)
        let s_4_19: () = execute_BFMOPS_ZA32_PP_ZZ__(
            state,
            tracer,
            s_4_0,
            s_4_12,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_19: call execute_BFMOPS_ZA32_PP_ZZ__(s_6_0, s_6_12, s_6_13, s_6_14, s_6_15, s_6_16, s_6_17, s_6_18)
        let s_6_19: () = execute_BFMOPS_ZA32_PP_ZZ__(
            state,
            tracer,
            s_6_0,
            s_6_12,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_19: call execute_BFMOPS_ZA32_PP_ZZ__(s_8_0, s_8_12, s_8_13, s_8_14, s_8_15, s_8_16, s_8_17, s_8_18)
        let s_8_19: () = execute_BFMOPS_ZA32_PP_ZZ__(
            state,
            tracer,
            s_8_0,
            s_8_12,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_19: call execute_BFMOPS_ZA32_PP_ZZ__(s_10_0, s_10_12, s_10_13, s_10_14, s_10_15, s_10_16, s_10_17, s_10_18)
        let s_10_19: () = execute_BFMOPS_ZA32_PP_ZZ__(
            state,
            tracer,
            s_10_0,
            s_10_12,
