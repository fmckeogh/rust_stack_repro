...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_LDRSB_r_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_LDRSB_r_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    P: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#297952 <= s_3_0
        fn_state.gs_297952 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#297952:u8
        let s_4_0: bool = fn_state.gs_297952;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: write-var gs#297957 <= s_6_4
        fn_state.gs_297957 = s_6_4;
        // N s_6_6: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#297957:u8
        let s_7_0: bool = fn_state.gs_297957;
        // D s_7_1: write-var wback <= s_7_0
        fn_state.wback = s_7_0;
        // C s_7_2: const #0s : i
        let s_7_2: i128 = 0;
        // C s_7_3: const #0u : u32
        let s_7_3: u32 = 0;
        // D s_7_4: create-product struct = ["s_7_3", "s_7_2"]
        let s_7_4: ProductType396b95aa74979079 = ProductType396b95aa74979079 {
            _0: s_7_3,
            _1: s_7_2,
        };
        // D s_7_5: extract-field s_7_4.0
        let s_7_5: u32 = s_7_4._0;
        // C s_7_6: const #0u : u32
        let s_7_6: u32 = 0;
        // D s_7_7: create-product struct = ["s_7_6", "s_7_2"]
        let s_7_7: ProductType396b95aa74979079 = ProductType396b95aa74979079 {
            _0: s_7_6,
            _1: s_7_2,
        };
        // D s_7_8: extract-field s_7_7.1
        let s_7_8: i128 = s_7_7._1;
        // D s_7_9: cast reint s_7_8 -> i64
        let s_7_9: i64 = (s_7_8 as i64);
        // D s_7_10: write-var shift_t <= s_7_5
        fn_state.shift_t = s_7_5;
        // D s_7_11: cast zx s_7_9 -> i
        let s_7_11: i128 = (i128::try_from(s_7_9).unwrap());
        // D s_7_12: write-var shift_nshadow#7181 <= s_7_11
        fn_state.shift_nshadow_7181 = s_7_11;
        // C s_7_13: const #15s : i
        let s_7_13: i128 = 15;
        // D s_7_14: read-var t:i64
        let s_7_14: i64 = fn_state.t;
        // D s_7_15: cast zx s_7_14 -> i
        let s_7_15: i128 = (i128::try_from(s_7_14).unwrap());
        // D s_7_16: cmp-eq s_7_15 s_7_13
        let s_7_16: bool = ((s_7_15) == (s_7_13));
        // N s_7_17: branch s_7_16 b20 b8
        if s_7_16 {
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: write-var gs#297967 <= s_8_3
        fn_state.gs_297967 = s_8_3;
        // N s_8_5: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#297967:u8
        let s_9_0: bool = fn_state.gs_297967;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#297970 <= s_11_0
        fn_state.gs_297970 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#297970:u8
        let s_12_0: bool = fn_state.gs_297970;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_4: read-var shift_nshadow#7181:i
        let s_13_4: i128 = fn_state.shift_nshadow_7181;
        ...
        // D s_13_8: call execute_aarch32_instrs_LDRSB_r_Op_A_txt(s_13_0, s_13_1, s_13_2, s_13_3, s_13_4, s_13_5, s_13_6, s_13_7)
        let s_13_8: () = execute_aarch32_instrs_LDRSB_r_Op_A_txt(
            state,
            tracer,
            s_13_0,
            s_13_1,
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_5: write-var gs#297969 <= s_16_4
        fn_state.gs_297969 = s_16_4;
        // N s_16_6: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#297969:u8
        let s_17_0: bool = fn_state.gs_297969;
        // D s_17_1: write-var gs#297970 <= s_17_0
        fn_state.gs_297970 = s_17_0;
        // N s_17_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#297969 <= s_18_0
        fn_state.gs_297969 = s_18_0;
        // N s_18_2: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#297967 <= s_20_0
        fn_state.gs_297967 = s_20_0;
        // N s_20_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#297957 <= s_21_0
        fn_state.gs_297957 = s_21_0;
        // N s_21_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_5: write-var gs#297952 <= s_23_4
        fn_state.gs_297952 = s_23_4;
        // N s_23_6: jump b4
        return block_4(state, tracer, fn_state);
    }
}
