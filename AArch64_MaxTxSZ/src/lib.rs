...
use common::*;
pub fn AArch64_MaxTxSZ<T: Tracer>(state: &mut State, tracer: &T, tgx: u32) -> i128 {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_0: const #() : ()
        let s_0_0: () = ();
        // S s_0_1: call HaveSmallTranslationTableExt(s_0_0)
        let s_0_1: bool = HaveSmallTranslationTableExt(state, tracer, s_0_0);
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: u32 = 0;
        // D s_4_1: read-var tgx:u32
        let s_4_1: u32 = fn_state.tgx;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: u32 = 1;
        // D s_6_1: read-var tgx:u32
        let s_6_1: u32 = fn_state.tgx;
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: u32 = 2;
        // D s_8_1: read-var tgx:u32
        let s_8_1: u32 = fn_state.tgx;
