...
use common::*;
pub fn TTBR1_EL2_SysRegRead_0c064c5f1843df74<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_99874: ProductType782ac6922b48c20d,
        u__PSTATE_EL: u8,
        u__HCR_EL2_NV: bool,
        ga_99869: ProductType782ac6922b48c20d,
        gs_74514: bool,
        el: u8,
        op0: u8,
        op1: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // C s_5_1: const #18432u : u32
        let s_5_1: u32 = 18432;
        // D s_5_2: read-reg s_5_1:struct
        let s_5_2: ProductType782ac6922b48c20d = {
            let value = state
                .read_register::<ProductType782ac6922b48c20d>(s_5_1 as isize);
            tracer.read_register(s_5_1 as isize, value);
            value
        };
        // D s_5_3: call __get_TTBR1_EL2(s_5_2)
        let s_5_3: ProductType782ac6922b48c20d = u__get_TTBR1_EL2(state, tracer, s_5_2);
        // D s_5_4: write-var ga#99874 <= s_5_3
        fn_state.ga_99874 = s_5_3;
        // D s_5_5: read-var ga#99874.0:struct
        let s_5_5: u128 = fn_state.ga_99874._0;
        // C s_5_6: const #0s : i
        let s_5_6: i128 = 0;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 64;
        // C s_6_1: const #18432u : u32
        let s_6_1: u32 = 18432;
        // D s_6_2: read-reg s_6_1:struct
        let s_6_2: ProductType782ac6922b48c20d = {
            let value = state
                .read_register::<ProductType782ac6922b48c20d>(s_6_1 as isize);
            tracer.read_register(s_6_1 as isize, value);
            value
        };
        // D s_6_3: call __get_TTBR1_EL2(s_6_2)
        let s_6_3: ProductType782ac6922b48c20d = u__get_TTBR1_EL2(state, tracer, s_6_2);
        // D s_6_4: write-var ga#99869 <= s_6_3
        fn_state.ga_99869 = s_6_3;
        // D s_6_5: read-var ga#99869.0:struct
        let s_6_5: u128 = fn_state.ga_99869._0;
        // C s_6_6: const #0s : i
        let s_6_6: i128 = 0;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#74514 <= s_8_0
        fn_state.gs_74514 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#74514:u8
        let s_9_0: bool = fn_state.gs_74514;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#74514 <= s_12_4
        fn_state.gs_74514 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
