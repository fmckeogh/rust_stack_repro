...
extern crate alloc;
use execute_aarch64_instrs_vector_reduce_int_max::*;
use common::*;
pub fn decode_smaxv_advsimd_aarch64_instrs_vector_reduce_int_max<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 64;
        // D s_3_1: write-var ga#266745 <= s_3_0
        fn_state.ga_266745 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#266745:i64
        let s_4_0: i64 = fn_state.ga_266745;
        ...
        // D s_4_11: read-var op:u8
        let s_4_11: bool = fn_state.op;
        // D s_4_12: cast zx s_4_11 -> bv
        let s_4_12: Bits = Bits::new(s_4_11 as u128, 1u16);
        // C s_4_13: const #1u : u8
        let s_4_13: bool = true;
        // C s_4_14: cast zx s_4_13 -> bv
        let s_4_14: Bits = Bits::new(s_4_13 as u128, 1u16);
        // D s_4_15: cmp-eq s_4_12 s_4_14
        let s_4_15: bool = ((s_4_12) == (s_4_14));
        ...
        // D s_4_21: cast zx s_4_5 -> i
        let s_4_21: i128 = (i128::try_from(s_4_5).unwrap());
        // D s_4_22: read-var d:i64
        let s_4_22: i64 = fn_state.d;
        // D s_4_23: read-var n:i64
        let s_4_23: i64 = fn_state.n;
        // D s_4_24: call execute_aarch64_instrs_vector_reduce_int_max(s_4_22, s_4_17, s_4_21, s_4_20, s_4_15, s_4_23, s_4_10)
        let s_4_24: () = execute_aarch64_instrs_vector_reduce_int_max(
            state,
            tracer,
            s_4_22,
            s_4_17,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 128;
        // D s_5_1: write-var ga#266745 <= s_5_0
        fn_state.ga_266745 = s_5_0;
        // N s_5_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_6<T: Tracer>(
