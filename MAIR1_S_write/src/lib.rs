...
pub fn MAIR1_S_write<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_1: const #100840u : u32
        let s_0_1: u32 = 100840;
        // D s_0_2: read-reg s_0_1:struct
        let s_0_2: ProductType700c18a878c5601b = {
            let value = state
                .read_register::<ProductType700c18a878c5601b>(s_0_1 as isize);
            tracer.read_register(s_0_1 as isize, value);
            value
        };
        // C s_0_3: const #100840u : u32
        let s_0_3: u32 = 100840;
        // N s_0_4: write-reg s_0_3 <= s_0_2
        let s_0_4: () = {
            state.write_register::<ProductType700c18a878c5601b>(s_0_3 as isize, s_0_2);
            tracer.write_register(s_0_3 as isize, s_0_2);
        };
        // C s_0_5: const #15520u : u32
        let s_0_5: u32 = 15520;
