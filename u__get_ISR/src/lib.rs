...
pub fn u__get_ISR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4294965311u : u32
        let s_0_3: u32 = 4294965311;
        ...
        // D s_0_11: tail-call Mk_ISR_Type(s_0_10)
        return Mk_ISR_Type(state, tracer, s_0_10);
    }
}
