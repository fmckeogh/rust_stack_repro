...
use common::*;
pub fn CNTHCTL_EL2_SysRegWrite_c57f8627acf05dc2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_CNTKCTL_EL1_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_CNTKCTL_EL1_Type(
            state,
            tracer,
            s_5_3,
        );
        // C s_5_5: const #22056u : u32
        let s_5_5: u32 = 22056;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: call Mk_CNTKCTL_EL1_Type(s_7_3)
        let s_7_4: ProductType5c790c8ef59cc8b2 = Mk_CNTKCTL_EL1_Type(
            state,
            tracer,
            s_7_3,
        );
        // C s_7_5: const #22056u : u32
        let s_7_5: u32 = 22056;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: call Mk_CNTHCTL_EL2_Type(s_8_3)
        let s_8_4: ProductType5c790c8ef59cc8b2 = Mk_CNTHCTL_EL2_Type(
            state,
            tracer,
            s_8_3,
        );
        // C s_8_5: const #12808u : u32
        let s_8_5: u32 = 12808;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: call Mk_CNTKCTL_EL1_Type(s_9_3)
        let s_9_4: ProductType5c790c8ef59cc8b2 = Mk_CNTKCTL_EL1_Type(
            state,
            tracer,
            s_9_3,
        );
        // C s_9_5: const #22056u : u32
        let s_9_5: u32 = 22056;
