...
extern crate alloc;
use common::*;
pub fn ADFSR_NS_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #16496u : u32
        let s_0_23: u32 = 16496;
        ...
        // C s_0_25: const #20240u : u32
        let s_0_25: u32 = 20240;
