...
use FPRoundingMode::*;
use CurrentVL_read::*;
use execute_FRINTX_Z_P_Z__::*;
use FPCR_read::*;
use HaveSME::*;
use common::*;
pub fn decode_FRINTX_Z_P_Z__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Pg: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#177758 <= s_1_0
        fn_state.gs_177758 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#177758:u8
        let s_2_0: bool = fn_state.gs_177758;
    ...
    fn block_4<T: Tracer>(
        ...
        // C s_4_22: const #() : ()
        let s_4_22: () = ();
        // S s_4_23: call FPCR_read(s_4_22)
        let s_4_23: ProductType5c790c8ef59cc8b2 = FPCR_read(state, tracer, s_4_22);
        // S s_4_24: call FPRoundingMode(s_4_23)
        let s_4_24: u32 = FPRoundingMode(state, tracer, s_4_23);
        // D s_4_25: write-var rounding <= s_4_24
        fn_state.rounding = s_4_24;
        // D s_4_26: read-var VL:i64
        let s_4_26: i64 = fn_state.VL;
        // C s_4_27: const #128s : i
        let s_4_27: i128 = 128;
        // D s_4_28: cast zx s_4_26 -> i
        let s_4_28: i128 = (i128::try_from(s_4_26).unwrap());
        // D s_4_29: cmp-eq s_4_28 s_4_27
        let s_4_29: bool = ((s_4_28) == (s_4_27));
        // D s_4_30: not s_4_29
        let s_4_30: bool = !s_4_29;
        // N s_4_31: branch s_4_30 b6 b5
        if s_4_30 {
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_8: read-var rounding:u32
        let s_5_8: u32 = fn_state.rounding;
        // D s_5_9: call execute_FRINTX_Z_P_Z__(s_5_0, s_5_4, s_5_3, s_5_5, s_5_6, s_5_7, s_5_8)
        let s_5_9: () = execute_FRINTX_Z_P_Z__(
            state,
            tracer,
            s_5_0,
            s_5_4,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_9: call execute_FRINTX_Z_P_Z__(s_7_0, s_7_4, s_7_3, s_7_5, s_7_6, s_7_7, s_7_8)
        let s_7_9: () = execute_FRINTX_Z_P_Z__(
            state,
            tracer,
            s_7_0,
            s_7_4,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_9: call execute_FRINTX_Z_P_Z__(s_9_0, s_9_4, s_9_3, s_9_5, s_9_6, s_9_7, s_9_8)
        let s_9_9: () = execute_FRINTX_Z_P_Z__(
            state,
            tracer,
            s_9_0,
            s_9_4,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_9: call execute_FRINTX_Z_P_Z__(s_11_0, s_11_4, s_11_3, s_11_5, s_11_6, s_11_7, s_11_8)
        let s_11_9: () = execute_FRINTX_Z_P_Z__(
            state,
            tracer,
            s_11_0,
            s_11_4,
    ...
    fn block_13<T: Tracer>(
        ...
        // C s_13_5: const #1u : u8
        let s_13_5: bool = true;
        ...
        // D s_13_9: call execute_FRINTX_Z_P_Z__(s_13_0, s_13_4, s_13_3, s_13_5, s_13_6, s_13_7, s_13_8)
        let s_13_9: () = execute_FRINTX_Z_P_Z__(
            state,
            tracer,
            s_13_0,
            s_13_4,
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_3: write-var gs#177758 <= s_17_2
        fn_state.gs_177758 = s_17_2;
        // N s_17_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
