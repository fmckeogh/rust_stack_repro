...
use common::*;
pub fn ZCR_EL3_SysRegRead_db53f2dcbaed5b3a<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_100516: ProductType5c790c8ef59cc8b2,
        u__PSTATE_EL: u8,
        u__CPTR_EL3_EZ: bool,
        el: u8,
        op0: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_5: call _get_CPTR_EL3_Type_EZ(s_0_4)
        let s_0_5: bool = u_get_CPTR_EL3_Type_EZ(state, tracer, s_0_4);
        // D s_0_6: write-var __CPTR_EL3_EZ <= s_0_5
        fn_state.u__CPTR_EL3_EZ = s_0_5;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_ZCR_EL3(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_ZCR_EL3(state, tracer, s_6_2);
        // D s_6_4: write-var ga#100516 <= s_6_3
        fn_state.ga_100516 = s_6_3;
        // D s_6_5: read-var ga#100516.0:struct
        let s_6_5: u64 = fn_state.ga_100516._0;
