...
use u_get_HFGRTR_EL2_Type_ERXMISCn_EL1::*;
use Halted::*;
...
use EDSCR_read::*;
use common::*;
pub fn ERXMISC2_EL1_SysRegRead_6ed4c8d1911e048a<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ...
        gs_61457: bool,
        u__HFGRTR_EL2_ERXMISCn_EL1: bool,
        el: u8,
        op0: u8,
        op1: u8,
        CRn: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_21: call _get_HFGRTR_EL2_Type_ERXMISCn_EL1(s_0_20)
        let s_0_21: bool = u_get_HFGRTR_EL2_Type_ERXMISCn_EL1(state, tracer, s_0_20);
        // D s_0_22: write-var __HFGRTR_EL2_ERXMISCn_EL1 <= s_0_21
        fn_state.u__HFGRTR_EL2_ERXMISCn_EL1 = s_0_21;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // C s_5_1: const #102472u : u32
        let s_5_1: u32 = 102472;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#61446 <= s_7_0
        fn_state.gs_61446 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#61446:u8
        let s_8_0: bool = fn_state.gs_61446;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#61447 <= s_9_0
        fn_state.gs_61447 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#61447:u8
        let s_10_0: bool = fn_state.gs_61447;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#61448 <= s_11_0
        fn_state.gs_61448 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#61448:u8
        let s_12_0: bool = fn_state.gs_61448;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#61449 <= s_13_0
        fn_state.gs_61449 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#61449:u8
        let s_14_0: bool = fn_state.gs_61449;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#61450 <= s_16_0
        fn_state.gs_61450 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#61450:u8
        let s_17_0: bool = fn_state.gs_61450;
    ...
    fn block_18<T: Tracer>(
        ...
        let s_18_0: i64 = 64;
        // C s_18_1: const #102472u : u32
        let s_18_1: u32 = 102472;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#61452 <= s_20_0
        fn_state.gs_61452 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#61452:u8
        let s_21_0: bool = fn_state.gs_61452;
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_5: write-var gs#61452 <= s_24_4
        fn_state.gs_61452 = s_24_4;
        // N s_24_6: jump b21
        return block_21(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_5: write-var gs#61450 <= s_25_4
        fn_state.gs_61450 = s_25_4;
        // N s_25_6: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_5: write-var gs#61449 <= s_27_4
        fn_state.gs_61449 = s_27_4;
        // N s_27_6: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_2: write-var gs#61448 <= s_28_1
        fn_state.gs_61448 = s_28_1;
        // N s_28_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_5: write-var gs#61447 <= s_29_4
        fn_state.gs_61447 = s_29_4;
        // N s_29_6: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_4: write-var gs#61446 <= s_30_3
        fn_state.gs_61446 = s_30_3;
        // N s_30_5: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_1: write-var gs#61453 <= s_32_0
        fn_state.gs_61453 = s_32_0;
        // N s_32_2: jump b33
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var gs#61453:u8
        let s_33_0: bool = fn_state.gs_61453;
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_1: write-var gs#61454 <= s_34_0
        fn_state.gs_61454 = s_34_0;
        // N s_34_2: jump b35
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_0: read-var gs#61454:u8
        let s_35_0: bool = fn_state.gs_61454;
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_1: write-var gs#61455 <= s_36_0
        fn_state.gs_61455 = s_36_0;
        // N s_36_2: jump b37
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_0: read-var gs#61455:u8
        let s_37_0: bool = fn_state.gs_61455;
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_1: write-var gs#61456 <= s_38_0
        fn_state.gs_61456 = s_38_0;
        // N s_38_2: jump b39
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_0: read-var gs#61456:u8
        let s_39_0: bool = fn_state.gs_61456;
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_1: write-var gs#61457 <= s_41_0
        fn_state.gs_61457 = s_41_0;
        // N s_41_2: jump b42
    ...
    fn block_42<T: Tracer>(
        ...
        // D s_42_0: read-var gs#61457:u8
        let s_42_0: bool = fn_state.gs_61457;
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_1: write-var gs#61458 <= s_44_0
        fn_state.gs_61458 = s_44_0;
        // N s_44_2: jump b45
    ...
    fn block_45<T: Tracer>(
        ...
        // D s_45_0: read-var gs#61458:u8
        let s_45_0: bool = fn_state.gs_61458;
    ...
    fn block_46<T: Tracer>(
        ...
        // D s_46_1: write-var gs#61460 <= s_46_0
        fn_state.gs_61460 = s_46_0;
        // N s_46_2: jump b47
    ...
    fn block_47<T: Tracer>(
        ...
        // D s_47_0: read-var gs#61460:u8
        let s_47_0: bool = fn_state.gs_61460;
    ...
    fn block_48<T: Tracer>(
        ...
        // D s_48_1: write-var gs#61461 <= s_48_0
        fn_state.gs_61461 = s_48_0;
        // N s_48_2: jump b49
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_0: read-var gs#61461:u8
        let s_49_0: bool = fn_state.gs_61461;
    ...
    fn block_51<T: Tracer>(
        ...
        // D s_51_1: write-var gs#61462 <= s_51_0
        fn_state.gs_61462 = s_51_0;
        // N s_51_2: jump b52
    ...
    fn block_52<T: Tracer>(
        ...
        // D s_52_0: read-var gs#61462:u8
        let s_52_0: bool = fn_state.gs_61462;
    ...
    fn block_53<T: Tracer>(
        ...
        let s_53_0: i64 = 64;
        // C s_53_1: const #102472u : u32
        let s_53_1: u32 = 102472;
    ...
    fn block_55<T: Tracer>(
        ...
        // D s_55_1: write-var gs#61464 <= s_55_0
        fn_state.gs_61464 = s_55_0;
        // N s_55_2: jump b56
    ...
    fn block_56<T: Tracer>(
        ...
        // D s_56_0: read-var gs#61464:u8
        let s_56_0: bool = fn_state.gs_61464;
    ...
    fn block_59<T: Tracer>(
        ...
        // D s_59_5: write-var gs#61464 <= s_59_4
        fn_state.gs_61464 = s_59_4;
        // N s_59_6: jump b56
        return block_56(state, tracer, fn_state);
    }
    fn block_60<T: Tracer>(
        ...
        // D s_60_5: write-var gs#61462 <= s_60_4
        fn_state.gs_61462 = s_60_4;
        // N s_60_6: jump b52
        return block_52(state, tracer, fn_state);
    }
    ...
    fn block_62<T: Tracer>(
        ...
        // D s_62_0: read-var __HFGRTR_EL2_ERXMISCn_EL1:u8
        let s_62_0: bool = fn_state.u__HFGRTR_EL2_ERXMISCn_EL1;
        ...
        // D s_62_5: write-var gs#61461 <= s_62_4
        fn_state.gs_61461 = s_62_4;
        // N s_62_6: jump b49
        return block_49(state, tracer, fn_state);
    }
    ...
    fn block_64<T: Tracer>(
        ...
        // D s_64_5: write-var gs#61459 <= s_64_4
        fn_state.gs_61459 = s_64_4;
        // N s_64_6: jump b65
    ...
    fn block_65<T: Tracer>(
        ...
        // D s_65_0: read-var gs#61459:u8
        let s_65_0: bool = fn_state.gs_61459;
        // D s_65_1: write-var gs#61460 <= s_65_0
        fn_state.gs_61460 = s_65_0;
        // N s_65_2: jump b47
        return block_47(state, tracer, fn_state);
    }
    fn block_66<T: Tracer>(
        ...
        // D s_66_1: write-var gs#61459 <= s_66_0
        fn_state.gs_61459 = s_66_0;
        // N s_66_2: jump b65
        return block_65(state, tracer, fn_state);
    }
    fn block_67<T: Tracer>(
        ...
        // D s_67_2: write-var gs#61458 <= s_67_1
        fn_state.gs_61458 = s_67_1;
        // N s_67_3: jump b45
        return block_45(state, tracer, fn_state);
    }
    ...
    fn block_69<T: Tracer>(
        ...
        // D s_69_5: write-var gs#61457 <= s_69_4
        fn_state.gs_61457 = s_69_4;
        // N s_69_6: jump b42
        return block_42(state, tracer, fn_state);
    }
    ...
    fn block_71<T: Tracer>(
        ...
        // D s_71_5: write-var gs#61456 <= s_71_4
        fn_state.gs_61456 = s_71_4;
        // N s_71_6: jump b39
        return block_39(state, tracer, fn_state);
    }
    fn block_72<T: Tracer>(
        ...
        // D s_72_2: write-var gs#61455 <= s_72_1
        fn_state.gs_61455 = s_72_1;
        // N s_72_3: jump b37
        return block_37(state, tracer, fn_state);
    }
    fn block_73<T: Tracer>(
        ...
        // D s_73_5: write-var gs#61454 <= s_73_4
        fn_state.gs_61454 = s_73_4;
        // N s_73_6: jump b35
        return block_35(state, tracer, fn_state);
    }
    fn block_74<T: Tracer>(
        ...
        // D s_74_4: write-var gs#61453 <= s_74_3
        fn_state.gs_61453 = s_74_3;
        // N s_74_5: jump b33
        return block_33(state, tracer, fn_state);
    }
