...
use common::*;
pub fn decode_sub_advsimd_aarch64_instrs_vector_arithmetic_binary_uniform_add_wrapping_single_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, Rm: u8, size: u8, U: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_19: call execute_aarch64_instrs_vector_arithmetic_binary_uniform_add_wrapping_single_sisd(s_1_16, s_1_12, s_1_15, s_1_14, s_1_17, s_1_18, s_1_10)
        let s_1_19: () = execute_aarch64_instrs_vector_arithmetic_binary_uniform_add_wrapping_single_sisd(
            state,
            tracer,
            s_1_16,
            s_1_12,
