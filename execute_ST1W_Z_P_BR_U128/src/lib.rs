...
use Mem_set::*;
use common::*;
pub fn execute_ST1W_Z_P_BR_U128<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    esize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#5032 <= s_0_2
        fn_state.VLshadow_5032 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#5032:i64
        let s_1_0: i64 = fn_state.VLshadow_5032;
        // D s_1_1: write-var VLshadow#5033 <= s_1_0
        fn_state.VLshadow_5033 = s_1_0;
        // C s_1_2: const #8s : i
        let s_1_2: i128 = 8;
        // D s_1_3: read-var VLshadow#5033:i64
        let s_1_3: i64 = fn_state.VLshadow_5033;
        ...
        // D s_1_7: read-var VLshadow#5033:i64
        let s_1_7: i64 = fn_state.VLshadow_5033;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_6: read-var VLshadow#5033:i64
        let s_6_6: i64 = fn_state.VLshadow_5033;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_6: write-var gs#242882 <= s_7_5
        fn_state.gs_242882 = s_7_5;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: read-var gs#242882:i64
        let s_8_1: i64 = fn_state.gs_242882;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_22: cast reint s_12_21 -> u128
        let s_12_22: u128 = (s_12_21.value() as u128);
        // C s_12_23: const #0s : i
        let s_12_23: i128 = 0;
        // C s_12_24: const #32s : i
        let s_12_24: i128 = 32;
        // D s_12_25: cast zx s_12_22 -> bv
        let s_12_25: Bits = Bits::new(s_12_22 as u128, 128u16);
        // D s_12_26: bit-extract s_12_25 s_12_23 s_12_24
        let s_12_26: Bits = (Bits::new(
            ((s_12_25) >> (s_12_23)).value(),
            u16::try_from(s_12_24).unwrap(),
        ));
        // D s_12_27: cast reint s_12_26 -> u32
        let s_12_27: u32 = (s_12_26.value() as u32);
        // D s_12_28: read-var mbytes:i64
        let s_12_28: i64 = fn_state.mbytes;
        // D s_12_29: cast zx s_12_28 -> i
        let s_12_29: i128 = (i128::try_from(s_12_28).unwrap());
        // D s_12_30: cast zx s_12_27 -> bv
        let s_12_30: Bits = Bits::new(s_12_27 as u128, 32u16);
        // D s_12_31: read-var accdesc:struct
        let s_12_31: ProductType9878976b5bcce9c9 = fn_state.accdesc;
        // D s_12_32: call Mem_set(s_12_13, s_12_29, s_12_31, s_12_30)
        let s_12_32: () = Mem_set(state, tracer, s_12_13, s_12_29, s_12_31, s_12_30);
        // N s_12_33: jump b11
        return block_11(state, tracer, fn_state);
    }
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#242877 <= s_17_0
        fn_state.gs_242877 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#242877:u8
        let s_18_0: bool = fn_state.gs_242877;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_2: write-var gs#242877 <= s_22_1
        fn_state.gs_242877 = s_22_1;
        // N s_22_3: jump b18
        return block_18(state, tracer, fn_state);
    }
}
