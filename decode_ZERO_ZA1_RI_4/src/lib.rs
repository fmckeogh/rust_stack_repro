...
extern crate alloc;
use CurrentVL_read::*;
use execute_ZERO_ZA1_RI_4::*;
use HaveSME2p1::*;
use common::*;
pub fn decode_ZERO_ZA1_RI_4<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rv: u8,
    off3: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        fn_state.v = s_1_15;
        // D s_1_17: read-var off3:u8
        let s_1_17: u8 = fn_state.off3;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_4: call execute_ZERO_ZA1_RI_4(s_2_0, s_2_1, s_2_2, s_2_3)
        let s_2_4: () = execute_ZERO_ZA1_RI_4(state, tracer, s_2_0, s_2_1, s_2_2, s_2_3);
        // N s_2_5: return
        return;
    }
    fn block_3<T: Tracer>(
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 256;
        // C s_4_1: const #4s : i64
        let s_4_1: i64 = 4;
        // D s_4_2: read-var offset:i64
        let s_4_2: i64 = fn_state.offset;
        // D s_4_3: read-var v:i64
        let s_4_3: i64 = fn_state.v;
        // D s_4_4: call execute_ZERO_ZA1_RI_4(s_4_0, s_4_1, s_4_2, s_4_3)
        let s_4_4: () = execute_ZERO_ZA1_RI_4(state, tracer, s_4_0, s_4_1, s_4_2, s_4_3);
        // N s_4_5: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 512;
        // C s_6_1: const #4s : i64
        let s_6_1: i64 = 4;
        // D s_6_2: read-var offset:i64
        let s_6_2: i64 = fn_state.offset;
        // D s_6_3: read-var v:i64
        let s_6_3: i64 = fn_state.v;
        // D s_6_4: call execute_ZERO_ZA1_RI_4(s_6_0, s_6_1, s_6_2, s_6_3)
        let s_6_4: () = execute_ZERO_ZA1_RI_4(state, tracer, s_6_0, s_6_1, s_6_2, s_6_3);
        // N s_6_5: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 1024;
        // C s_8_1: const #4s : i64
        let s_8_1: i64 = 4;
        // D s_8_2: read-var offset:i64
        let s_8_2: i64 = fn_state.offset;
        // D s_8_3: read-var v:i64
        let s_8_3: i64 = fn_state.v;
        // D s_8_4: call execute_ZERO_ZA1_RI_4(s_8_0, s_8_1, s_8_2, s_8_3)
        let s_8_4: () = execute_ZERO_ZA1_RI_4(state, tracer, s_8_0, s_8_1, s_8_2, s_8_3);
        // N s_8_5: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 2048;
        // C s_10_1: const #4s : i64
        let s_10_1: i64 = 4;
        // D s_10_2: read-var offset:i64
        let s_10_2: i64 = fn_state.offset;
        // D s_10_3: read-var v:i64
        let s_10_3: i64 = fn_state.v;
        // D s_10_4: call execute_ZERO_ZA1_RI_4(s_10_0, s_10_1, s_10_2, s_10_3)
        let s_10_4: () = execute_ZERO_ZA1_RI_4(
            state,
            tracer,
            s_10_0,
            s_10_1,
