...
use HaveSVE::*;
use CurrentVL_read::*;
use execute_PTEST__P_P__::*;
use HaveSME::*;
use common::*;
pub fn decode_PTEST__P_P__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    S: bool,
    Pg: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#197761 <= s_1_0
        fn_state.gs_197761 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#197761:u8
        let s_2_0: bool = fn_state.gs_197761;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: call execute_PTEST__P_P__(s_4_0, s_4_1, s_4_2, s_4_3)
        let s_4_4: () = execute_PTEST__P_P__(state, tracer, s_4_0, s_4_1, s_4_2, s_4_3);
        // N s_4_5: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call execute_PTEST__P_P__(s_6_0, s_6_1, s_6_2, s_6_3)
        let s_6_4: () = execute_PTEST__P_P__(state, tracer, s_6_0, s_6_1, s_6_2, s_6_3);
        // N s_6_5: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: call execute_PTEST__P_P__(s_8_0, s_8_1, s_8_2, s_8_3)
        let s_8_4: () = execute_PTEST__P_P__(state, tracer, s_8_0, s_8_1, s_8_2, s_8_3);
        // N s_8_5: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: call execute_PTEST__P_P__(s_10_0, s_10_1, s_10_2, s_10_3)
        let s_10_4: () = execute_PTEST__P_P__(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_4: call execute_PTEST__P_P__(s_12_0, s_12_1, s_12_2, s_12_3)
        let s_12_4: () = execute_PTEST__P_P__(
            state,
            tracer,
            s_12_0,
            s_12_1,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#197761 <= s_15_2
        fn_state.gs_197761 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
