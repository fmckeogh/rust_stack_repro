...
use common::*;
pub fn execute_aarch32_instrs_LDAEXD_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    n: i64,
    t: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_9: write-var gs#913503 <= s_1_8
        fn_state.gs_913503 = s_1_8;
        // N s_1_10: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#913503:bv
        let s_2_0: Bits = fn_state.gs_913503;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_9: write-var ga#364851 <= s_3_8
        fn_state.ga_364851 = s_3_8;
        // N s_3_10: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: read-var ga#364851:u32
        let s_4_2: u32 = fn_state.ga_364851;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_9: write-var ga#364853 <= s_5_8
        fn_state.ga_364853 = s_5_8;
        // N s_5_10: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: read-var ga#364853:u32
        let s_6_2: u32 = fn_state.ga_364853;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_9: write-var ga#364853 <= s_7_8
        fn_state.ga_364853 = s_7_8;
        // N s_7_10: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
        ...
        // D s_8_9: write-var ga#364851 <= s_8_8
        fn_state.ga_364851 = s_8_8;
        // N s_8_10: jump b4
        return block_4(state, tracer, fn_state);
    }
}
