...
use common::*;
pub fn decode_aarch32_instrs_VCGE_r_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    U: bool,
    D: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#307038 <= s_3_0
        fn_state.gs_307038 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#307038:u8
        let s_4_0: bool = fn_state.gs_307038;
    ...
    fn block_9<T: Tracer>(
        ...
        let s_9_0: i64 = 2;
        // D s_9_1: write-var ga#351574 <= s_9_0
        fn_state.ga_351574 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var ga#351574:i64
        let s_10_0: i64 = fn_state.ga_351574;
    ...
    fn block_11<T: Tracer>(
        ...
        let s_11_0: i64 = 1;
        // D s_11_1: write-var ga#351574 <= s_11_0
        fn_state.ga_351574 = s_11_0;
        // N s_11_2: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_22: write-var gs#307034 <= s_16_21
        fn_state.gs_307034 = s_16_21;
        // N s_16_23: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#307034:u8
        let s_17_0: bool = fn_state.gs_307034;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_22: write-var gs#307037 <= s_18_21
        fn_state.gs_307037 = s_18_21;
        // N s_18_23: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#307037:u8
        let s_19_0: bool = fn_state.gs_307037;
        // D s_19_1: write-var gs#307038 <= s_19_0
        fn_state.gs_307038 = s_19_0;
        // N s_19_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#307037 <= s_20_0
        fn_state.gs_307037 = s_20_0;
        // N s_20_2: jump b19
        return block_19(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#307034 <= s_21_0
        fn_state.gs_307034 = s_21_0;
        // N s_21_2: jump b17
        return block_17(state, tracer, fn_state);
    }
}
