...
use common::*;
pub fn execute_INSR_Z_V__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    dn: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#3321 <= s_0_2
        fn_state.esizeshadow_3321 = s_0_2;
        ...
        // D s_0_7: write-var VLshadow#3322 <= s_0_6
        fn_state.VLshadow_3322 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#3322:i64
        let s_1_0: i64 = fn_state.VLshadow_3322;
        ...
        // D s_1_7: read-var esizeshadow#3321:i64
        let s_1_7: i64 = fn_state.esizeshadow_3321;
        ...
        // D s_1_19: read-var esizeshadow#3321:i64
        let s_1_19: i64 = fn_state.esizeshadow_3321;
