...
use u__get_MPIDR::*;
use common::*;
pub fn VMPIDR_SysRegRead32_2f5b95225c646973<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    struct FunctionState {
        gs_117532: bool,
        gs_117529: bool,
        ga_197654: ProductType5c790c8ef59cc8b2,
        gs_117530: bool,
        ga_197667: ProductType700c18a878c5601b,
        gs_117533: bool,
        ga_197660: ProductType700c18a878c5601b,
        ga_197663: ProductType700c18a878c5601b,
        gs_117528: bool,
        u__PSTATE_EL: u8,
        u__HSTR_EL2_T0: bool,
        u__HSTR_T0: bool,
        gs_117531: bool,
        ga_197671: ProductType700c18a878c5601b,
        el: u8,
        coproc: u8,
        opc1: u8,
        CRn: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_0: const #() : ()
        let s_5_0: () = ();
        // S s_5_1: call MPIDR_read(s_5_0)
        let s_5_1: ProductType700c18a878c5601b = MPIDR_read(state, tracer, s_5_0);
        // S s_5_2: call __get_MPIDR(s_5_1)
        let s_5_2: ProductType700c18a878c5601b = u__get_MPIDR(state, tracer, s_5_1);
        // D s_5_3: write-var ga#197671 <= s_5_2
        fn_state.ga_197671 = s_5_2;
        // D s_5_4: read-var ga#197671.0:struct
        let s_5_4: u32 = fn_state.ga_197671._0;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #() : ()
        let s_6_0: () = ();
        // S s_6_1: call MPIDR_read(s_6_0)
        let s_6_1: ProductType700c18a878c5601b = MPIDR_read(state, tracer, s_6_0);
        // S s_6_2: call __get_MPIDR(s_6_1)
        let s_6_2: ProductType700c18a878c5601b = u__get_MPIDR(state, tracer, s_6_1);
        // D s_6_3: write-var ga#197667 <= s_6_2
        fn_state.ga_197667 = s_6_2;
        // D s_6_4: read-var ga#197667.0:struct
        let s_6_4: u32 = fn_state.ga_197667._0;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#117528 <= s_8_0
        fn_state.gs_117528 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#117528:u8
        let s_9_0: bool = fn_state.gs_117528;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#117529 <= s_10_0
        fn_state.gs_117529 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#117529:u8
        let s_11_0: bool = fn_state.gs_117529;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#117530 <= s_13_0
        fn_state.gs_117530 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#117530:u8
        let s_14_0: bool = fn_state.gs_117530;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#117531 <= s_15_0
        fn_state.gs_117531 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#117531:u8
        let s_16_0: bool = fn_state.gs_117531;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#117532 <= s_18_0
        fn_state.gs_117532 = s_18_0;
        // N s_18_2: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#117532:u8
        let s_19_0: bool = fn_state.gs_117532;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#117533 <= s_21_0
        fn_state.gs_117533 = s_21_0;
        // N s_21_2: jump b22
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_0: read-var gs#117533:u8
        let s_22_0: bool = fn_state.gs_117533;
    ...
    fn block_23<T: Tracer>(
        ...
        // C s_23_0: const #() : ()
        let s_23_0: () = ();
        // S s_23_1: call MPIDR_read(s_23_0)
        let s_23_1: ProductType700c18a878c5601b = MPIDR_read(state, tracer, s_23_0);
        // S s_23_2: call __get_MPIDR(s_23_1)
        let s_23_2: ProductType700c18a878c5601b = u__get_MPIDR(state, tracer, s_23_1);
        // D s_23_3: write-var ga#197663 <= s_23_2
        fn_state.ga_197663 = s_23_2;
        // D s_23_4: read-var ga#197663.0:struct
        let s_23_4: u32 = fn_state.ga_197663._0;
    ...
    fn block_24<T: Tracer>(
        ...
        // C s_24_0: const #() : ()
        let s_24_0: () = ();
        // S s_24_1: call VMPIDR_read(s_24_0)
        let s_24_1: ProductType700c18a878c5601b = VMPIDR_read(state, tracer, s_24_0);
        // S s_24_2: call __get_VMPIDR(s_24_1)
        let s_24_2: ProductType700c18a878c5601b = u__get_VMPIDR(state, tracer, s_24_1);
        // D s_24_3: write-var ga#197660 <= s_24_2
        fn_state.ga_197660 = s_24_2;
        // D s_24_4: read-var ga#197660.0:struct
        let s_24_4: u32 = fn_state.ga_197660._0;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_3: write-var gs#117533 <= s_25_2
        fn_state.gs_117533 = s_25_2;
        // N s_25_4: jump b22
        return block_22(state, tracer, fn_state);
    }
    fn block_26<T: Tracer>(
        ...
        // C s_26_0: const #20672u : u32
        let s_26_0: u32 = 20672;
        ...
        // D s_26_2: call __get_VMPIDR_EL2(s_26_1)
        let s_26_2: ProductType5c790c8ef59cc8b2 = u__get_VMPIDR_EL2(
            state,
            tracer,
            s_26_1,
        );
        // D s_26_3: write-var ga#197654 <= s_26_2
        fn_state.ga_197654 = s_26_2;
        // D s_26_4: read-var ga#197654.0:struct
        let s_26_4: u64 = fn_state.ga_197654._0;
        // C s_26_5: const #0s : i
        let s_26_5: i128 = 0;
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_4: write-var gs#117532 <= s_27_3
        fn_state.gs_117532 = s_27_3;
        // N s_27_5: jump b19
        return block_19(state, tracer, fn_state);
    }
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_5: write-var gs#117531 <= s_29_4
        fn_state.gs_117531 = s_29_4;
        // N s_29_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_3: write-var gs#117530 <= s_30_2
        fn_state.gs_117530 = s_30_2;
        // N s_30_4: jump b14
        return block_14(state, tracer, fn_state);
    }
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_5: write-var gs#117529 <= s_32_4
        fn_state.gs_117529 = s_32_4;
        // N s_32_6: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_33<T: Tracer>(
        ...
        // D s_33_4: write-var gs#117528 <= s_33_3
        fn_state.gs_117528 = s_33_3;
        // N s_33_5: jump b9
        return block_9(state, tracer, fn_state);
    }
