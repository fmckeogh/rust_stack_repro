...
use AddWithCarry::*;
use common::*;
pub fn execute_aarch64_instrs_integer_conditional_compare_register<T: Tracer>(
    state: &mut State,
    tracer: &T,
    condition: u8,
    datasize: i64,
    ...
    struct FunctionState {
        carry_in: bool,
        ga_251024: ProductTyped54bc449dd09e5bd,
        taken: bool,
        operand1: Bits,
        flags: u8,
        datasizeshadow_1114: i64,
        operand2: Bits,
        condition: u8,
        datasize: i64,
        flags__arg: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var datasizeshadow#1114 <= s_0_2
        fn_state.datasizeshadow_1114 = s_0_2;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var datasizeshadow#1114:i64
        let s_5_0: i64 = fn_state.datasizeshadow_1114;
        ...
        // D s_5_7: read-var datasizeshadow#1114:i64
        let s_5_7: i64 = fn_state.datasizeshadow_1114;
        ...
        // D s_5_12: call X_read(s_5_11, s_5_9)
        let s_5_12: Bits = X_read(state, tracer, s_5_11, s_5_9);
        // D s_5_13: write-var operand2 <= s_5_12
        fn_state.operand2 = s_5_12;
        // C s_5_14: const #0u : u8
        let s_5_14: bool = false;
        // D s_5_15: write-var carry_in <= s_5_14
        fn_state.carry_in = s_5_14;
        // D s_5_16: read-var sub_op:u8
        let s_5_16: bool = fn_state.sub_op;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var ga#251024 <= s_7_3
        fn_state.ga_251024 = s_7_3;
        // D s_7_5: read-var ga#251024.1:struct
        let s_7_5: u8 = fn_state.ga_251024._1;
