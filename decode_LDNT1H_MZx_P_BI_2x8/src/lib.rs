...
extern crate alloc;
use execute_LDNT1H_MZx_P_BI_2x8::*;
use CurrentVL_read::*;
use HaveSME2::*;
use common::*;
pub fn decode_LDNT1H_MZx_P_BI_2x8<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm4: u8,
    msz: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_8: i64 = 8;
        // D s_2_9: call execute_LDNT1H_MZx_P_BI_2x8(s_2_0, s_2_3, s_2_4, s_2_5, s_2_6, s_2_2, s_2_7, s_2_8)
        let s_2_9: () = execute_LDNT1H_MZx_P_BI_2x8(
            state,
            tracer,
            s_2_0,
            s_2_3,
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_8: i64 = 8;
        // D s_4_9: call execute_LDNT1H_MZx_P_BI_2x8(s_4_0, s_4_3, s_4_4, s_4_5, s_4_6, s_4_2, s_4_7, s_4_8)
        let s_4_9: () = execute_LDNT1H_MZx_P_BI_2x8(
            state,
            tracer,
            s_4_0,
            s_4_3,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_8: i64 = 8;
        // D s_6_9: call execute_LDNT1H_MZx_P_BI_2x8(s_6_0, s_6_3, s_6_4, s_6_5, s_6_6, s_6_2, s_6_7, s_6_8)
        let s_6_9: () = execute_LDNT1H_MZx_P_BI_2x8(
            state,
            tracer,
            s_6_0,
            s_6_3,
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_8: i64 = 8;
        // D s_8_9: call execute_LDNT1H_MZx_P_BI_2x8(s_8_0, s_8_3, s_8_4, s_8_5, s_8_6, s_8_2, s_8_7, s_8_8)
        let s_8_9: () = execute_LDNT1H_MZx_P_BI_2x8(
            state,
            tracer,
            s_8_0,
            s_8_3,
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_8: i64 = 8;
        // D s_10_9: call execute_LDNT1H_MZx_P_BI_2x8(s_10_0, s_10_3, s_10_4, s_10_5, s_10_6, s_10_2, s_10_7, s_10_8)
        let s_10_9: () = execute_LDNT1H_MZx_P_BI_2x8(
            state,
            tracer,
            s_10_0,
            s_10_3,
