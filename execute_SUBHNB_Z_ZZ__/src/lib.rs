...
use Zeros::*;
use common::*;
pub fn execute_SUBHNB_Z_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#3796 <= s_0_2
        fn_state.esizeshadow_3796 = s_0_2;
        ...
        // D s_0_7: write-var VLshadow#3797 <= s_0_6
        fn_state.VLshadow_3797 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#3797:i64
        let s_1_0: i64 = fn_state.VLshadow_3797;
        // D s_1_1: write-var VLshadow#3798 <= s_1_0
        fn_state.VLshadow_3798 = s_1_0;
        // D s_1_2: read-var VLshadow#3798:i64
        let s_1_2: i64 = fn_state.VLshadow_3798;
        // D s_1_3: cast zx s_1_2 -> i
        let s_1_3: i128 = (i128::try_from(s_1_2).unwrap());
        // D s_1_4: read-var esizeshadow#3796:i64
        let s_1_4: i64 = fn_state.esizeshadow_3796;
        ...
        // D s_1_8: read-var VLshadow#3798:i64
        let s_1_8: i64 = fn_state.VLshadow_3798;
        ...
        // D s_1_16: read-var VLshadow#3798:i64
        let s_1_16: i64 = fn_state.VLshadow_3798;
        ...
        // C s_1_24: const #2s : i
        let s_1_24: i128 = 2;
        // D s_1_25: read-var esizeshadow#3796:i64
        let s_1_25: i64 = fn_state.esizeshadow_3796;
        ...
        // D s_1_35: write-var gs#208741 <= s_1_34
        fn_state.gs_208741 = s_1_34;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#208741:i64
        let s_2_1: i64 = fn_state.gs_208741;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var esizeshadow#3796:i64
        let s_3_0: i64 = fn_state.esizeshadow_3796;
        ...
        // D s_3_9: read-var esizeshadow#3796:i64
        let s_3_9: i64 = fn_state.esizeshadow_3796;
        ...
        // D s_3_54: add s_3_53 s_3_52
        let s_3_54: i128 = (s_3_53 + s_3_52);
        // D s_3_55: cast reint s_3_54 -> i64
        let s_3_55: i64 = (s_3_54 as i64);
        // D s_3_56: read-var halfesize:i64
        let s_3_56: i64 = fn_state.halfesize;
        ...
        // D s_3_59: read-var halfesize:i64
        let s_3_59: i64 = fn_state.halfesize;
        // D s_3_60: cast zx s_3_59 -> i
        let s_3_60: i128 = (i128::try_from(s_3_59).unwrap());
        // D s_3_61: call Zeros(s_3_60)
        let s_3_61: Bits = Zeros(state, tracer, s_3_60);
        // D s_3_62: cast zx s_3_55 -> i
        let s_3_62: i128 = (i128::try_from(s_3_55).unwrap());
        // D s_3_63: cast zx s_3_58 -> i
        let s_3_63: i128 = (i128::try_from(s_3_58).unwrap());
        // D s_3_64: read-var result:bv
        let s_3_64: Bits = fn_state.result;
        // D s_3_65: call Elem_set(s_3_64, s_3_62, s_3_63, s_3_61)
        let s_3_65: Bits = Elem_set(state, tracer, s_3_64, s_3_62, s_3_63, s_3_61);
        // D s_3_66: write-var result <= s_3_65
        fn_state.result = s_3_65;
        // D s_3_67: read-var e:i64
        let s_3_67: i64 = fn_state.e;
        // C s_3_68: const #1s : i64
        let s_3_68: i64 = 1;
        // D s_3_69: add s_3_67 s_3_68
        let s_3_69: i64 = (s_3_67 + s_3_68);
        // D s_3_70: write-var e <= s_3_69
        fn_state.e = s_3_69;
        // N s_3_71: jump b2
        return block_2(state, tracer, fn_state);
    }
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#3798:i64
        let s_4_0: i64 = fn_state.VLshadow_3798;
