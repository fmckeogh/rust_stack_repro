...
use common::*;
pub fn AArch64_S2TxSZFaults<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: read-var s1aarch64:u8
        let s_0_3: bool = fn_state.s1aarch64;
        // D s_0_4: call AArch64_S2MinTxSZ(s_0_0, s_0_1, s_0_2, s_0_3)
        let s_0_4: i128 = AArch64_S2MinTxSZ(state, tracer, s_0_0, s_0_1, s_0_2, s_0_3);
        // D s_0_5: read-var walkparams.26:struct
        let s_0_5: u32 = fn_state.walkparams._26;
        ...
        // D s_0_8: read-var walkparams.29:struct
        let s_0_8: u8 = fn_state.walkparams._29;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var walkparams.29:struct
        let s_1_0: u8 = fn_state.walkparams._29;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: write-var gs#19019 <= s_6_1
        fn_state.gs_19019 = s_6_1;
        // N s_6_3: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#19019:u8
        let s_7_0: bool = fn_state.gs_19019;
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #1u : u8
        let s_8_0: bool = true;
        // D s_8_1: write-var gs#19019 <= s_8_0
        fn_state.gs_19019 = s_8_0;
        // N s_8_2: jump b7
        return block_7(state, tracer, fn_state);
    }
}
