...
use AddWithCarry::*;
use common::*;
pub fn execute_aarch32_instrs_RSB_rr_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        nzcv: u8,
        gs_883013: ProductTyped54bc449dd09e5bd,
        d: i64,
        m: i64,
        n: i64,
        s: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_31: cast zx s_0_23 -> bv
        let s_0_31: Bits = Bits::new(s_0_23 as u128, 32u16);
        ...
        // D s_0_34: write-var gs#883013 <= s_0_33
        fn_state.gs_883013 = s_0_33;
        // D s_0_35: read-var gs#883013.0:struct
        let s_0_35: Bits = fn_state.gs_883013._0;
        // D s_0_36: cast reint s_0_35 -> u32
        let s_0_36: u32 = (s_0_35.value() as u32);
        // D s_0_37: read-var gs#883013.1:struct
        let s_0_37: u8 = fn_state.gs_883013._1;
        // D s_0_38: write-var nzcv <= s_0_37
        fn_state.nzcv = s_0_37;
        // D s_0_39: read-var d:i64
        let s_0_39: i64 = fn_state.d;
        // D s_0_40: cast zx s_0_39 -> i
        let s_0_40: i128 = (i128::try_from(s_0_39).unwrap());
        // D s_0_41: call R_set(s_0_40, s_0_36)
        let s_0_41: () = R_set(state, tracer, s_0_40, s_0_36);
        // D s_0_42: read-var setflags:u8
        let s_0_42: bool = fn_state.setflags;
        // N s_0_43: branch s_0_42 b2 b1
        if s_0_42 {
