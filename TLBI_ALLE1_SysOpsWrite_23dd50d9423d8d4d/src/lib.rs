...
use common::*;
pub fn TLBI_ALLE1_SysOpsWrite_23dd50d9423d8d4d<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#101973 <= s_9_0
        fn_state.gs_101973 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#101973:u8
        let s_10_0: bool = fn_state.gs_101973;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_5: write-var gs#101973 <= s_13_4
        fn_state.gs_101973 = s_13_4;
        // N s_13_6: jump b10
        return block_10(state, tracer, fn_state);
    }
