...
extern crate alloc;
use common::*;
pub fn HIFAR_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_6: const #32s : i
        let s_0_6: i128 = 32;
        // C s_0_7: const #102616u : u32
        let s_0_7: u32 = 102616;
        ...
        // C s_0_23: const #102616u : u32
        let s_0_23: u32 = 102616;
        ...
        // C s_0_25: const #20704u : u32
        let s_0_25: u32 = 20704;
