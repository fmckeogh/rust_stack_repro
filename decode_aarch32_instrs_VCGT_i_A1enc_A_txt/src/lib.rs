...
use common::*;
pub fn decode_aarch32_instrs_VCGT_i_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    size: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#307188 <= s_4_0
        fn_state.gs_307188 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#307188:u8
        let s_5_0: bool = fn_state.gs_307188;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#307194 <= s_7_0
        fn_state.gs_307194 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#307194:u8
        let s_8_0: bool = fn_state.gs_307194;
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 2;
        // D s_10_1: write-var ga#351694 <= s_10_0
        fn_state.ga_351694 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var ga#351694:i64
        let s_11_0: i64 = fn_state.ga_351694;
        ...
        // D s_11_9: call execute_aarch32_instrs_VCGT_i_Op_A_txt(s_11_6, s_11_5, s_11_3, s_11_7, s_11_8, s_11_0)
        let s_11_9: () = execute_aarch32_instrs_VCGT_i_Op_A_txt(
            state,
            tracer,
            s_11_6,
            s_11_5,
    ...
    fn block_12<T: Tracer>(
        ...
        let s_12_0: i64 = 1;
        // D s_12_1: write-var ga#351694 <= s_12_0
        fn_state.ga_351694 = s_12_0;
        // N s_12_2: jump b11
        return block_11(state, tracer, fn_state);
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_22: write-var gs#307193 <= s_15_21
        fn_state.gs_307193 = s_15_21;
        // N s_15_23: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#307193:u8
        let s_16_0: bool = fn_state.gs_307193;
        // D s_16_1: write-var gs#307194 <= s_16_0
        fn_state.gs_307194 = s_16_0;
        // N s_16_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#307193 <= s_17_0
        fn_state.gs_307193 = s_17_0;
        // N s_17_2: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_5: write-var gs#307188 <= s_19_4
        fn_state.gs_307188 = s_19_4;
        // N s_19_6: jump b5
        return block_5(state, tracer, fn_state);
    }
