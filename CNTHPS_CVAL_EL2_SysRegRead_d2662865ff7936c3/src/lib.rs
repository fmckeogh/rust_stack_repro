...
use EL2Enabled::*;
use common::*;
pub fn CNTHPS_CVAL_EL2_SysRegRead_d2662865ff7936c3<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#57785 <= s_13_0
        fn_state.gs_57785 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#57785:u8
        let s_14_0: bool = fn_state.gs_57785;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_5: write-var gs#57785 <= s_17_4
        fn_state.gs_57785 = s_17_4;
        // N s_17_6: jump b14
        return block_14(state, tracer, fn_state);
    }
