...
pub fn u__get_HTRFCR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4294967188u : u32
        let s_0_3: u32 = 4294967188;
        ...
        // D s_0_11: tail-call Mk_HTRFCR_Type(s_0_10)
        return Mk_HTRFCR_Type(state, tracer, s_0_10);
    }
}
