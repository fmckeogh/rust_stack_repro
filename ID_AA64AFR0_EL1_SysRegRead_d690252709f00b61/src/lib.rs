...
use EL2Enabled::*;
use common::*;
pub fn ID_AA64AFR0_EL1_SysRegRead_d690252709f00b61<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call __get_ID_AA64AFR0_EL1(s_5_2)
        let s_5_3: u64 = u__get_ID_AA64AFR0_EL1(state, tracer, s_5_2);
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_ID_AA64AFR0_EL1(s_6_2)
        let s_6_3: u64 = u__get_ID_AA64AFR0_EL1(state, tracer, s_6_2);
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#62700 <= s_8_0
        fn_state.gs_62700 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#62700:u8
        let s_9_0: bool = fn_state.gs_62700;
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 64;
        // C s_10_1: const #10608u : u32
        let s_10_1: u32 = 10608;
        // D s_10_2: read-reg s_10_1:u64
        let s_10_2: u64 = {
            let value = state.read_register::<u64>(s_10_1 as isize);
            tracer.read_register(s_10_1 as isize, value);
            value
        };
        // D s_10_3: call __get_ID_AA64AFR0_EL1(s_10_2)
        let s_10_3: u64 = u__get_ID_AA64AFR0_EL1(state, tracer, s_10_2);
        // D s_10_4: cast zx s_10_3 -> bv
        let s_10_4: Bits = Bits::new(s_10_3 as u128, 64u16);
        // D s_10_5: read-var t:i
        let s_10_5: i128 = fn_state.t;
        // D s_10_6: call X_set(s_10_5, s_10_0, s_10_4)
        let s_10_6: () = X_set(state, tracer, s_10_5, s_10_0, s_10_4);
        // N s_10_7: return
        return;
    }
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#62700 <= s_12_4
        fn_state.gs_62700 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#62702 <= s_16_0
        fn_state.gs_62702 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#62702:u8
        let s_17_0: bool = fn_state.gs_62702;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_5: write-var gs#62702 <= s_20_4
        fn_state.gs_62702 = s_20_4;
        // N s_20_6: jump b17
        return block_17(state, tracer, fn_state);
    }
}
