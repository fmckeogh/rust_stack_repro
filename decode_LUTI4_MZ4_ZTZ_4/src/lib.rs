...
use CurrentVL_read::*;
use HaveSME2p1::*;
use execute_LUTI4_MZ4_ZTZ_4::*;
use common::*;
pub fn decode_LUTI4_MZ4_ZTZ_4<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i1: bool,
    size: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        fn_state.n = s_2_10;
        // D s_2_12: read-var D:u8
        let s_2_12: bool = fn_state.D;
        ...
        // D s_2_26: read-var Zd:u8
        let s_2_26: u8 = fn_state.Zd;
        ...
        fn_state.d = s_2_39;
        // D s_2_41: read-var i1:u8
        let s_2_41: bool = fn_state.i1;
        ...
        // D s_2_45: write-var imm <= s_2_44
        fn_state.imm = s_2_44;
        // D s_2_46: read-var VL:i64
        let s_2_46: i64 = fn_state.VL;
        // C s_2_47: const #128s : i
        let s_2_47: i128 = 128;
        // D s_2_48: cast zx s_2_46 -> i
        let s_2_48: i128 = (i128::try_from(s_2_46).unwrap());
        // D s_2_49: cmp-eq s_2_48 s_2_47
        let s_2_49: bool = ((s_2_48) == (s_2_47));
        // D s_2_50: not s_2_49
        let s_2_50: bool = !s_2_49;
        // N s_2_51: branch s_2_50 b4 b3
        if s_2_50 {
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_10: call execute_LUTI4_MZ4_ZTZ_4(s_3_0, s_3_7, s_3_4, s_3_3, s_3_8, s_3_5, s_3_9, s_3_6)
        let s_3_10: () = execute_LUTI4_MZ4_ZTZ_4(
            state,
            tracer,
            s_3_0,
            s_3_7,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_10: call execute_LUTI4_MZ4_ZTZ_4(s_5_0, s_5_7, s_5_4, s_5_3, s_5_8, s_5_5, s_5_9, s_5_6)
        let s_5_10: () = execute_LUTI4_MZ4_ZTZ_4(
            state,
            tracer,
            s_5_0,
            s_5_7,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_10: call execute_LUTI4_MZ4_ZTZ_4(s_7_0, s_7_7, s_7_4, s_7_3, s_7_8, s_7_5, s_7_9, s_7_6)
        let s_7_10: () = execute_LUTI4_MZ4_ZTZ_4(
            state,
            tracer,
            s_7_0,
            s_7_7,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_10: call execute_LUTI4_MZ4_ZTZ_4(s_9_0, s_9_7, s_9_4, s_9_3, s_9_8, s_9_5, s_9_9, s_9_6)
        let s_9_10: () = execute_LUTI4_MZ4_ZTZ_4(
            state,
            tracer,
            s_9_0,
            s_9_7,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_10: call execute_LUTI4_MZ4_ZTZ_4(s_11_0, s_11_7, s_11_4, s_11_3, s_11_8, s_11_5, s_11_9, s_11_6)
        let s_11_10: () = execute_LUTI4_MZ4_ZTZ_4(
            state,
            tracer,
            s_11_0,
            s_11_7,
