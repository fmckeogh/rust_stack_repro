...
use CurrentVL_read::*;
use HaveSME2::*;
use execute_PEXT_PN_RR__::*;
use common::*;
pub fn decode_PEXT_PN_RR__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    imm2: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#221603 <= s_1_0
        fn_state.gs_221603 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#221603:u8
        let s_2_0: bool = fn_state.gs_221603;
    ...
    fn block_3<T: Tracer>(
        ...
        fn_state.d = s_3_27;
        // D s_3_29: read-var imm2:u8
        let s_3_29: u8 = fn_state.imm2;
        ...
        // D s_3_33: write-var part <= s_3_32
        fn_state.part = s_3_32;
        // D s_3_34: read-var VL:i64
        let s_3_34: i64 = fn_state.VL;
        // C s_3_35: const #128s : i
        let s_3_35: i128 = 128;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: read-var part:i64
        let s_4_4: i64 = fn_state.part;
        // D s_4_5: call execute_PEXT_PN_RR__(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4)
        let s_4_5: () = execute_PEXT_PN_RR__(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: read-var part:i64
        let s_6_4: i64 = fn_state.part;
        // D s_6_5: call execute_PEXT_PN_RR__(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4)
        let s_6_5: () = execute_PEXT_PN_RR__(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: read-var part:i64
        let s_8_4: i64 = fn_state.part;
        // D s_8_5: call execute_PEXT_PN_RR__(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4)
        let s_8_5: () = execute_PEXT_PN_RR__(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: read-var part:i64
        let s_10_4: i64 = fn_state.part;
        // D s_10_5: call execute_PEXT_PN_RR__(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4)
        let s_10_5: () = execute_PEXT_PN_RR__(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_4: read-var part:i64
        let s_12_4: i64 = fn_state.part;
        // D s_12_5: call execute_PEXT_PN_RR__(s_12_0, s_12_1, s_12_2, s_12_3, s_12_4)
        let s_12_5: () = execute_PEXT_PN_RR__(
            state,
            tracer,
            s_12_0,
            s_12_1,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#221603 <= s_15_2
        fn_state.gs_221603 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
