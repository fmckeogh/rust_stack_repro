...
extern crate alloc;
use execute_aarch32_instrs_LDMDB_Op_A_txt::*;
use ConditionPassed::*;
use LastInITBlock::*;
use BitCount::*;
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_LDMDB_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    W: bool,
    Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_5: write-var gs#296936 <= s_3_4
        fn_state.gs_296936 = s_3_4;
        // N s_3_6: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#296936:u8
        let s_4_0: bool = fn_state.gs_296936;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#296937 <= s_6_0
        fn_state.gs_296937 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#296937:u8
        let s_7_0: bool = fn_state.gs_296937;
        // D s_7_1: write-var gs#296938 <= s_7_0
        fn_state.gs_296938 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#296938:u8
        let s_8_0: bool = fn_state.gs_296938;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#296940 <= s_10_0
        fn_state.gs_296940 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#296940:u8
        let s_11_0: bool = fn_state.gs_296940;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#296945 <= s_14_0
        fn_state.gs_296945 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#296945:u8
        let s_15_0: bool = fn_state.gs_296945;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#296946 <= s_16_0
        fn_state.gs_296946 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#296946:u8
        let s_17_0: bool = fn_state.gs_296946;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_3: call execute_aarch32_instrs_LDMDB_Op_A_txt(s_18_0, s_18_1, s_18_2)
        let s_18_3: () = execute_aarch32_instrs_LDMDB_Op_A_txt(
            state,
            tracer,
            s_18_0,
            s_18_1,
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_3: write-var gs#296946 <= s_20_2
        fn_state.gs_296946 = s_20_2;
        // N s_20_4: jump b17
        return block_17(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_2: write-var gs#296945 <= s_21_1
        fn_state.gs_296945 = s_21_1;
        // N s_21_3: jump b15
        return block_15(state, tracer, fn_state);
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_23: write-var gs#296940 <= s_24_22
        fn_state.gs_296940 = s_24_22;
        // N s_24_24: jump b11
        return block_11(state, tracer, fn_state);
    }
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_5: write-var gs#296937 <= s_26_4
        fn_state.gs_296937 = s_26_4;
        // N s_26_6: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_27<T: Tracer>(
        ...
        // D s_27_1: write-var gs#296938 <= s_27_0
        fn_state.gs_296938 = s_27_0;
        // N s_27_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_1: write-var gs#296936 <= s_28_0
        fn_state.gs_296936 = s_28_0;
        // N s_28_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
