...
use SetIss2::*;
use common::*;
pub fn execute_aarch64_instrs_memory_atomicops_st_acc_st64bv<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rs: u8,
    lst: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_0: const #() : ()
        let s_0_0: () = ();
        // S s_0_1: call CheckST64BVEnabled(s_0_0)
        let s_0_1: () = CheckST64BVEnabled(state, tracer, s_0_0);
        // N s_0_2: jump b1
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_9: read-var Rs:u8
        let s_9_9: u8 = fn_state.Rs;
        // D s_9_10: call SetIss2(s_9_9)
        let s_9_10: () = SetIss2(state, tracer, s_9_9);
        // D s_9_11: read-var address:u64
        let s_9_11: u64 = fn_state.address;
        // D s_9_12: read-var data:u512
        let s_9_12: u64 = fn_state.data;
        // D s_9_13: read-var accdesc:struct
        let s_9_13: ProductType9878976b5bcce9c9 = fn_state.accdesc;
        // D s_9_14: call MemStore64BWithRet(s_9_11, s_9_12, s_9_13)
        let s_9_14: u64 = MemStore64BWithRet(state, tracer, s_9_11, s_9_12, s_9_13);
        // D s_9_15: write-var status <= s_9_14
        fn_state.status = s_9_14;
        // N s_9_16: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_3: call neq_int(s_10_2, s_10_0)
        let s_10_3: bool = neq_int(state, tracer, s_10_2, s_10_0);
    ...
    fn block_15<T: Tracer>(
        ...
        let s_15_0: i64 = 64;
        // D s_15_1: read-var s:i64
        let s_15_1: i64 = fn_state.s;
        // D s_15_2: cast zx s_15_1 -> i
        let s_15_2: i128 = (i128::try_from(s_15_1).unwrap());
        // D s_15_3: read-var status:u64
        let s_15_3: u64 = fn_state.status;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_2: write-var address <= s_17_1
        fn_state.address = s_17_1;
        // N s_17_3: jump b9
        return block_9(state, tracer, fn_state);
    }
}
