...
use common::*;
pub fn TLBI_ALLE1OS_SysOpsWrite_614f5311238ca5e2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#101971 <= s_9_0
        fn_state.gs_101971 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#101971:u8
        let s_10_0: bool = fn_state.gs_101971;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_5: write-var gs#101971 <= s_13_4
        fn_state.gs_101971 = s_13_4;
        // N s_13_6: jump b10
        return block_10(state, tracer, fn_state);
    }
