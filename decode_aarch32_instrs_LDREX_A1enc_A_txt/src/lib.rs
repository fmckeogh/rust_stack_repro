...
use Zeros::*;
use common::*;
pub fn decode_aarch32_instrs_LDREX_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        fn_state.n = s_2_14;
        // C s_2_16: const #32s : i
        let s_2_16: i128 = 32;
        // S s_2_17: call Zeros(s_2_16)
        let s_2_17: Bits = Zeros(state, tracer, s_2_16);
        // S s_2_18: cast reint s_2_17 -> u32
        let s_2_18: u32 = (s_2_17.value() as u32);
        // D s_2_19: write-var imm32 <= s_2_18
        fn_state.imm32 = s_2_18;
        // C s_2_20: const #15s : i
        let s_2_20: i128 = 15;
        // D s_2_21: read-var t:i64
        let s_2_21: i64 = fn_state.t;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#297367 <= s_3_3
        fn_state.gs_297367 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#297367:u8
        let s_4_0: bool = fn_state.gs_297367;
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #1u : u8
        let s_7_0: bool = true;
        // D s_7_1: write-var gs#297367 <= s_7_0
        fn_state.gs_297367 = s_7_0;
        // N s_7_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
