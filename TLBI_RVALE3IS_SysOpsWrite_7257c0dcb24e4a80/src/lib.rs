...
use VMID_read::*;
use common::*;
pub fn TLBI_RVALE3IS_SysOpsWrite_7257c0dcb24e4a80<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_12: u32 = 0;
        // D s_5_13: call AArch64_TLBI_RVA(s_5_2, s_5_9, s_5_4, s_5_10, s_5_11, s_5_12, s_5_8)
        let s_5_13: () = AArch64_TLBI_RVA(
            state,
            tracer,
            s_5_2,
            s_5_9,
