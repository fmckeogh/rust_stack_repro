...
extern crate alloc;
use AArch64_SysRegRead::*;
use AArch64_SysRegWrite::*;
use common::*;
pub fn execute_aarch64_instrs_system_register_system<T: Tracer>(
    state: &mut State,
    tracer: &T,
    read: bool,
    sys_crm: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_12: call AArch64_SysRegWrite(s_1_1, s_1_3, s_1_5, s_1_7, s_1_9, s_1_11)
        let s_1_12: () = AArch64_SysRegWrite(
            state,
            tracer,
            s_1_1,
            s_1_3,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_12: call AArch64_SysRegRead(s_2_1, s_2_3, s_2_5, s_2_7, s_2_9, s_2_11)
        let s_2_12: () = AArch64_SysRegRead(
            state,
            tracer,
            s_2_1,
            s_2_3,
