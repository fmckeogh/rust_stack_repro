...
extern crate alloc;
use common::*;
pub fn ID_AFR0_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #21080u : u32
        let s_0_23: u32 = 21080;
        ...
        // C s_0_25: const #102808u : u32
        let s_0_25: u32 = 102808;
