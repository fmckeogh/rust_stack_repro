...
extern crate alloc;
use common::*;
pub fn ACTLR_NS_read<T: Tracer>(state: &mut State, tracer: &T, gs_35321: ()) -> u32 {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_0: const #102744u : u32
        let s_0_0: u32 = 102744;
        ...
        // C s_0_3: const #32s : i
        let s_0_3: i128 = 32;
        // C s_0_4: const #104680u : u32
        let s_0_4: u32 = 104680;
