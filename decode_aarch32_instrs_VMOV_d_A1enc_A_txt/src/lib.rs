...
use common::*;
pub fn decode_aarch32_instrs_VMOV_d_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    op: bool,
    ...
    fn block_2<T: Tracer>(
        ...
        fn_state.t2 = s_2_20;
        // D s_2_22: read-var M:u8
        let s_2_22: bool = fn_state.M;
        // D s_2_23: cast zx s_2_22 -> bv
        let s_2_23: Bits = Bits::new(s_2_22 as u128, 1u16);
        // D s_2_24: read-var Vm:u8
        let s_2_24: u8 = fn_state.Vm;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#312806 <= s_3_3
        fn_state.gs_312806 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#312806:u8
        let s_4_0: bool = fn_state.gs_312806;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#312807 <= s_6_0
        fn_state.gs_312807 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#312807:u8
        let s_7_0: bool = fn_state.gs_312807;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: write-var gs#312807 <= s_10_4
        fn_state.gs_312807 = s_10_4;
        // N s_10_6: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#312806 <= s_12_0
        fn_state.gs_312806 = s_12_0;
        // N s_12_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
