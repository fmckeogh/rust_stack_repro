...
use Z_set::*;
use common::*;
pub fn execute_DECW_Z_ZS__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    dn: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#2742 <= s_0_2
        fn_state.VLshadow_2742 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#2742:i64
        let s_1_0: i64 = fn_state.VLshadow_2742;
        // D s_1_1: write-var VLshadow#2743 <= s_1_0
        fn_state.VLshadow_2743 = s_1_0;
        // D s_1_2: read-var VLshadow#2743:i64
        let s_1_2: i64 = fn_state.VLshadow_2743;
        ...
        // D s_1_13: read-var VLshadow#2743:i64
        let s_1_13: i64 = fn_state.VLshadow_2743;
        ...
        // D s_1_26: write-var gs#192012 <= s_1_25
        fn_state.gs_192012 = s_1_25;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#192012:i64
        let s_2_1: i64 = fn_state.gs_192012;
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_23: Bits = Bits::new(s_3_19 as u128, 32u16);
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#2743:i64
        let s_4_0: i64 = fn_state.VLshadow_2743;
