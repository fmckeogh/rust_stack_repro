...
pub fn TTBR1_write<T: Tracer>(
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#33718 <= s_1_0
        fn_state.gs_33718 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#33718:u8
        let s_2_0: bool = fn_state.gs_33718;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#33718 <= s_5_3
        fn_state.gs_33718 = s_5_3;
        // N s_5_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
