...
pub fn u__get_DBGVCR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #570368801u : u32
        let s_0_3: u32 = 570368801;
        ...
        // D s_0_11: tail-call Mk_DBGVCR_Type(s_0_10)
        return Mk_DBGVCR_Type(state, tracer, s_0_10);
    }
}
