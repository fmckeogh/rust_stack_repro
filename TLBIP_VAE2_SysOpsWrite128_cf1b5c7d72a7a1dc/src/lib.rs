...
use common::*;
pub fn TLBIP_VAE2_SysOpsWrite128_cf1b5c7d72a7a1dc<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#139311 <= s_14_0
        fn_state.gs_139311 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#139311:u8
        let s_15_0: bool = fn_state.gs_139311;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_5: write-var gs#139311 <= s_18_4
        fn_state.gs_139311 = s_18_4;
        // N s_18_6: jump b15
        return block_15(state, tracer, fn_state);
    }
