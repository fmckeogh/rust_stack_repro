...
pub fn DBGBXVR_set<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_1: const #103424u : u32
        let s_0_1: u32 = 103424;
        // D s_0_2: read-reg s_0_1:[struct; 64]
        let s_0_2: [ProductType5c790c8ef59cc8b2; 64usize] = {
            let value = state
                .read_register::<[ProductType5c790c8ef59cc8b2; 64usize]>(s_0_1 as isize);
        ...
        // C s_0_6: const #103424u : u32
        let s_0_6: u32 = 103424;
        // D s_0_7: read-reg s_0_6:[struct; 64]
        let s_0_7: [ProductType5c790c8ef59cc8b2; 64usize] = {
            let value = state
                .read_register::<[ProductType5c790c8ef59cc8b2; 64usize]>(s_0_6 as isize);
        ...
        let s_0_10: [ProductType5c790c8ef59cc8b2; 64usize] = {
        ...
        // C s_0_15: const #22432u : u32
        let s_0_15: u32 = 22432;
        // D s_0_16: read-reg s_0_15:[struct; 16]
        let s_0_16: [ProductType700c18a878c5601b; 16usize] = {
            let value = state
                .read_register::<
                    [ProductType700c18a878c5601b; 16usize],
                >(s_0_15 as isize);
        ...
        let s_0_19: [ProductType700c18a878c5601b; 16usize] = {
        ...
        let s_0_21: [ProductType700c18a878c5601b; 16usize] = {
            let mut buf = [Default::default(); 16usize];
            buf.copy_from_slice(&s_0_20);
            buf
        };
        // C s_0_22: const #22432u : u32
        let s_0_22: u32 = 22432;
