...
extern crate alloc;
use execute_aarch64_instrs_integer_ins_ext_extract_immediate::*;
use common::*;
pub fn decode_extr_aarch64_instrs_integer_ins_ext_extract_immediate<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 32;
        // D s_1_1: write-var ga#252624 <= s_1_0
        fn_state.ga_252624 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#252624:i64
        let s_2_0: i64 = fn_state.ga_252624;
        // D s_2_1: write-var datasize <= s_2_0
        fn_state.datasize = s_2_0;
        // D s_2_2: read-var N:u8
        let s_2_2: bool = fn_state.N;
        // D s_2_3: cast zx s_2_2 -> bv
        let s_2_3: Bits = Bits::new(s_2_2 as u128, 1u16);
        // D s_2_4: read-var sf:u8
        let s_2_4: bool = fn_state.sf;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#148142 <= s_4_0
        fn_state.gs_148142 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#148142:u8
        let s_5_0: bool = fn_state.gs_148142;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var imms:u8
        let s_6_0: u8 = fn_state.imms;
        // D s_6_1: cast zx s_6_0 -> bv
        let s_6_1: Bits = Bits::new(s_6_0 as u128, 6u16);
        // D s_6_2: cast zx s_6_1 -> i
        let s_6_2: i128 = (s_6_1.value() as i128);
        // D s_6_3: cast reint s_6_2 -> i64
        let s_6_3: i64 = (s_6_2 as i64);
        // D s_6_4: read-var datasize:i64
        let s_6_4: i64 = fn_state.datasize;
        ...
        // D s_6_9: read-var n:i64
        let s_6_9: i64 = fn_state.n;
        // D s_6_10: call execute_aarch64_instrs_integer_ins_ext_extract_immediate(s_6_7, s_6_6, s_6_3, s_6_8, s_6_9)
        let s_6_10: () = execute_aarch64_instrs_integer_ins_ext_extract_immediate(
            state,
            tracer,
            s_6_7,
            s_6_6,
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #5s : i
        let s_8_0: i128 = 5;
        // D s_8_1: read-var imms:u8
        let s_8_1: u8 = fn_state.imms;
        ...
        // D s_8_22: write-var gs#148142 <= s_8_21
        fn_state.gs_148142 = s_8_21;
        // N s_8_23: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 64;
        // D s_10_1: write-var ga#252624 <= s_10_0
        fn_state.ga_252624 = s_10_0;
        // N s_10_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
