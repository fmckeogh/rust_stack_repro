...
use HaveSMEF16F16::*;
use CurrentVL_read::*;
use execute_FSUB_ZA_ZW_4x4_16::*;
use common::*;
pub fn decode_FSUB_ZA_ZW_4x4_16<T: Tracer>(
    state: &mut State,
    tracer: &T,
    sz: bool,
    Rv: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        fn_state.v = s_1_15;
        // D s_1_17: read-var Zm:u8
        let s_1_17: u8 = fn_state.Zm;
        ...
        // D s_1_38: write-var offset <= s_1_37
        fn_state.offset = s_1_37;
        // D s_1_39: read-var VL:i64
        let s_1_39: i64 = fn_state.VL;
        // C s_1_40: const #128s : i
        let s_1_40: i128 = 128;
        // D s_1_41: cast zx s_1_39 -> i
        let s_1_41: i128 = (i128::try_from(s_1_39).unwrap());
        // D s_1_42: cmp-eq s_1_41 s_1_40
        let s_1_42: bool = ((s_1_41) == (s_1_40));
        // D s_1_43: not s_1_42
        let s_1_43: bool = !s_1_42;
        // N s_1_44: branch s_1_43 b3 b2
        if s_1_43 {
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_3: const #4s : i64
        let s_2_3: i64 = 4;
        // D s_2_4: read-var offset:i64
        let s_2_4: i64 = fn_state.offset;
        // D s_2_5: read-var v:i64
        let s_2_5: i64 = fn_state.v;
        // D s_2_6: call execute_FSUB_ZA_ZW_4x4_16(s_2_0, s_2_1, s_2_2, s_2_3, s_2_4, s_2_5)
        let s_2_6: () = execute_FSUB_ZA_ZW_4x4_16(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        // C s_4_3: const #4s : i64
        let s_4_3: i64 = 4;
        // D s_4_4: read-var offset:i64
        let s_4_4: i64 = fn_state.offset;
        // D s_4_5: read-var v:i64
        let s_4_5: i64 = fn_state.v;
        // D s_4_6: call execute_FSUB_ZA_ZW_4x4_16(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5)
        let s_4_6: () = execute_FSUB_ZA_ZW_4x4_16(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_6: call execute_FSUB_ZA_ZW_4x4_16(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5)
        let s_6_6: () = execute_FSUB_ZA_ZW_4x4_16(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_3: const #4s : i64
        let s_8_3: i64 = 4;
        // D s_8_4: read-var offset:i64
        let s_8_4: i64 = fn_state.offset;
        // D s_8_5: read-var v:i64
        let s_8_5: i64 = fn_state.v;
        // D s_8_6: call execute_FSUB_ZA_ZW_4x4_16(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5)
        let s_8_6: () = execute_FSUB_ZA_ZW_4x4_16(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // C s_10_3: const #4s : i64
        let s_10_3: i64 = 4;
        // D s_10_4: read-var offset:i64
        let s_10_4: i64 = fn_state.offset;
        // D s_10_5: read-var v:i64
        let s_10_5: i64 = fn_state.v;
        // D s_10_6: call execute_FSUB_ZA_ZW_4x4_16(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5)
        let s_10_6: () = execute_FSUB_ZA_ZW_4x4_16(
            state,
            tracer,
            s_10_0,
            s_10_1,
