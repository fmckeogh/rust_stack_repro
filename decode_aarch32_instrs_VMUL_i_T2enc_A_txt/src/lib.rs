...
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_VMUL_i_T2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    U: bool,
    D: bool,
    ...
    struct FunctionState {
        ...
        polynomial: bool,
        esize: i64,
        esizeshadow_7587: i64,
        is_unsigned: bool,
        elements: i128,
        elementsshadow_7588: i128,
        U: bool,
        D: bool,
        size: u8,
        Vn: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var esizeshadow#7587 <= s_5_0
        fn_state.esizeshadow_7587 = s_5_0;
        // D s_5_2: read-var elements:i
        let s_5_2: i128 = fn_state.elements;
        // D s_5_3: write-var elementsshadow#7588 <= s_5_2
        fn_state.elementsshadow_7588 = s_5_2;
        // C s_5_4: const #0s : i
        let s_5_4: i128 = 0;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_48: read-var esizeshadow#7587:i64
        let s_6_48: i64 = fn_state.esizeshadow_7587;
        ...
        let s_6_51: i64 = 1;
        // D s_6_52: read-var elementsshadow#7588:i
        let s_6_52: i128 = fn_state.elementsshadow_7588;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_5: write-var gs#313813 <= s_9_4
        fn_state.gs_313813 = s_9_4;
        // N s_9_6: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#313813:u8
        let s_10_0: bool = fn_state.gs_313813;
    ...
    fn block_15<T: Tracer>(
        ...
        // C s_15_0: const #() : ()
        let s_15_0: () = ();
        // S s_15_1: call HaveBit128PMULLExt(s_15_0)
        let s_15_1: bool = HaveBit128PMULLExt(state, tracer, s_15_0);
        // S s_15_2: not s_15_1
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#313813 <= s_20_0
        fn_state.gs_313813 = s_20_0;
        // N s_20_2: jump b10
        return block_10(state, tracer, fn_state);
    }
