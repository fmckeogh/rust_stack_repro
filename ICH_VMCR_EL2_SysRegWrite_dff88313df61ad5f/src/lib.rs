...
use common::*;
pub fn ICH_VMCR_EL2_SysRegWrite_dff88313df61ad5f<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call Mk_ICH_VMCR_EL2_Type(s_6_3)
        let s_6_4: ProductType5c790c8ef59cc8b2 = Mk_ICH_VMCR_EL2_Type(
            state,
            tracer,
            s_6_3,
        );
        // C s_6_5: const #15376u : u32
        let s_6_5: u32 = 15376;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: call Mk_ICH_VMCR_EL2_Type(s_9_3)
        let s_9_4: ProductType5c790c8ef59cc8b2 = Mk_ICH_VMCR_EL2_Type(
            state,
            tracer,
            s_9_3,
        );
        // C s_9_5: const #15376u : u32
        let s_9_5: u32 = 15376;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#86419 <= s_12_0
        fn_state.gs_86419 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#86419:u8
        let s_13_0: bool = fn_state.gs_86419;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#86420 <= s_15_0
        fn_state.gs_86420 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#86420:u8
        let s_16_0: bool = fn_state.gs_86420;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_5: write-var gs#86420 <= s_19_4
        fn_state.gs_86420 = s_19_4;
        // N s_19_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_6: call X_read(s_20_5, s_20_4)
        let s_20_6: Bits = X_read(state, tracer, s_20_5, s_20_4);
        // D s_20_7: cast reint s_20_6 -> u64
        let s_20_7: u64 = (s_20_6.value() as u64);
        // C s_20_8: cast zx s_20_3 -> i
        let s_20_8: i128 = (i128::try_from(s_20_3).unwrap());
        // D s_20_9: call NVMem_set(s_20_8, s_20_7)
        let s_20_9: () = NVMem_set(state, tracer, s_20_8, s_20_7);
        // N s_20_10: return
        return;
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_21: write-var gs#86419 <= s_21_20
        fn_state.gs_86419 = s_21_20;
        // N s_21_22: jump b13
        return block_13(state, tracer, fn_state);
    }
