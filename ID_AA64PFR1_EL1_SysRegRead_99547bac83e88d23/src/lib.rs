...
use u__get_ID_AA64PFR1_EL1::*;
use AArch64_SystemAccessTrap::*;
use u_get_HCR_EL2_Type_TGE::*;
use EL2Enabled::*;
use common::*;
pub fn ID_AA64PFR1_EL1_SysRegRead_99547bac83e88d23<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_69423: ProductType5c790c8ef59cc8b2,
        u__HCR_EL2_TID3: bool,
        gs_62779: bool,
        u__HCR_EL2_TGE: bool,
        gs_62777: bool,
        ga_69419: ProductType5c790c8ef59cc8b2,
        u__PSTATE_EL: u8,
        ga_69427: ProductType5c790c8ef59cc8b2,
        el: u8,
        op0: u8,
        op1: u8,
        CRn: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call __get_ID_AA64PFR1_EL1(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_ID_AA64PFR1_EL1(
            state,
            tracer,
            s_5_2,
        );
        // D s_5_4: write-var ga#69427 <= s_5_3
        fn_state.ga_69427 = s_5_3;
        // D s_5_5: read-var ga#69427.0:struct
        let s_5_5: u64 = fn_state.ga_69427._0;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_ID_AA64PFR1_EL1(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_ID_AA64PFR1_EL1(
            state,
            tracer,
            s_6_2,
        );
        // D s_6_4: write-var ga#69423 <= s_6_3
        fn_state.ga_69423 = s_6_3;
        // D s_6_5: read-var ga#69423.0:struct
        let s_6_5: u64 = fn_state.ga_69423._0;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#62777 <= s_8_0
        fn_state.gs_62777 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#62777:u8
        let s_9_0: bool = fn_state.gs_62777;
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 64;
        // C s_10_1: const #22552u : u32
        let s_10_1: u32 = 22552;
        ...
        // D s_10_3: call __get_ID_AA64PFR1_EL1(s_10_2)
        let s_10_3: ProductType5c790c8ef59cc8b2 = u__get_ID_AA64PFR1_EL1(
            state,
            tracer,
            s_10_2,
        );
        // D s_10_4: write-var ga#69419 <= s_10_3
        fn_state.ga_69419 = s_10_3;
        // D s_10_5: read-var ga#69419.0:struct
        let s_10_5: u64 = fn_state.ga_69419._0;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#62777 <= s_12_4
        fn_state.gs_62777 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#62779 <= s_16_0
        fn_state.gs_62779 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#62779:u8
        let s_17_0: bool = fn_state.gs_62779;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_5: write-var gs#62779 <= s_20_4
        fn_state.gs_62779 = s_20_4;
        // N s_20_6: jump b17
        return block_17(state, tracer, fn_state);
    }
}
