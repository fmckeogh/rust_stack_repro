...
use common::*;
pub fn decode_aarch32_instrs_LDRSBT_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    Rt: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var mshadow#7190 <= s_3_0
        fn_state.mshadow_7190 = s_3_0;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: read-var mshadow#7190:i
        let s_4_2: i128 = fn_state.mshadow_7190;
        ...
        // D s_4_7: call execute_aarch32_instrs_LDRSBT_Op_A_txt(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5, s_4_6)
        let s_4_7: () = execute_aarch32_instrs_LDRSBT_Op_A_txt(
            state,
            tracer,
            s_4_0,
            s_4_1,
