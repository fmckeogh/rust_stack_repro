...
pub fn PMCCNTR_write<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_1: const #104776u : u32
        let s_0_1: u32 = 104776;
        ...
        // C s_0_3: const #104776u : u32
        let s_0_3: u32 = 104776;
        ...
        // C s_0_5: const #12928u : u32
        let s_0_5: u32 = 12928;
        // N s_0_6: write-reg s_0_5 <= s_0_0
        let s_0_6: () = {
            state.write_register::<ProductType5c790c8ef59cc8b2>(s_0_5 as isize, s_0_0);
