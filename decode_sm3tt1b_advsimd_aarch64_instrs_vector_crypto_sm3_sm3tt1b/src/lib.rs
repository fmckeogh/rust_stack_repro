...
extern crate alloc;
use execute_aarch64_instrs_vector_crypto_sm3_sm3tt1b::*;
use HaveSM3Ext::*;
use common::*;
pub fn decode_sm3tt1b_advsimd_aarch64_instrs_vector_crypto_sm3_sm3tt1b<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_16: call execute_aarch64_instrs_vector_crypto_sm3_sm3tt1b(s_1_3, s_1_15, s_1_11, s_1_7)
        let s_1_16: () = execute_aarch64_instrs_vector_crypto_sm3_sm3tt1b(
            state,
            tracer,
            s_1_3,
            s_1_15,
