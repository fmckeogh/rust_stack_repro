...
use Mk_RMR_EL3_Type::*;
use common::*;
pub fn RMR_EL3_SysRegWrite_d2303115883d7964<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#91707 <= s_1_0
        fn_state.gs_91707 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#91707:u8
        let s_2_0: bool = fn_state.gs_91707;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: call Mk_RMR_EL3_Type(s_4_3)
        let s_4_4: ProductType5c790c8ef59cc8b2 = Mk_RMR_EL3_Type(state, tracer, s_4_3);
        // C s_4_5: const #101912u : u32
        let s_4_5: u32 = 101912;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: write-var gs#91707 <= s_5_2
        fn_state.gs_91707 = s_5_2;
        // N s_5_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
