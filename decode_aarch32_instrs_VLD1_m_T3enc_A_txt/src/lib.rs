...
use ConditionPassed::*;
use common::*;
pub fn decode_aarch32_instrs_VLD1_m_T3enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Rn: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_7: write-var ga#353755 <= s_4_6
        fn_state.ga_353755 = s_4_6;
        // N s_4_8: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var ga#353755:i
        let s_5_0: i128 = fn_state.ga_353755;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#309953 <= s_6_0
        fn_state.gs_309953 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#309953:u8
        let s_7_0: bool = fn_state.gs_309953;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_9: write-var gs#309956 <= s_8_8
        fn_state.gs_309956 = s_8_8;
        // N s_8_10: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#309956:u8
        let s_9_0: bool = fn_state.gs_309956;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_7: write-var gs#309959 <= s_11_6
        fn_state.gs_309959 = s_11_6;
        // N s_11_8: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#309959:u8
        let s_12_0: bool = fn_state.gs_309959;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_7: write-var gs#309961 <= s_13_6
        fn_state.gs_309961 = s_13_6;
        // N s_13_8: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#309961:u8
        let s_14_0: bool = fn_state.gs_309961;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_7: write-var gs#309963 <= s_15_6
        fn_state.gs_309963 = s_15_6;
        // N s_15_8: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#309963:u8
        let s_16_0: bool = fn_state.gs_309963;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#309993 <= s_17_0
        fn_state.gs_309993 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#309993:u8
        let s_18_0: bool = fn_state.gs_309993;
        ...
        // C s_18_11: const #3s : i64
        let s_18_11: i64 = 3;
        // D s_18_12: read-var wback:u8
        let s_18_12: bool = fn_state.wback;
        // D s_18_13: call execute_aarch32_instrs_VLD1_m_Op_A_txt(s_18_3, s_18_6, s_18_7, s_18_5, s_18_8, s_18_9, s_18_10, s_18_11, s_18_12)
        let s_18_13: () = execute_aarch32_instrs_VLD1_m_Op_A_txt(
            state,
            tracer,
            s_18_3,
            s_18_6,
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#309992 <= s_20_0
        fn_state.gs_309992 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#309992:u8
        let s_21_0: bool = fn_state.gs_309992;
        // D s_21_1: write-var gs#309993 <= s_21_0
        fn_state.gs_309993 = s_21_0;
        // N s_21_2: jump b18
        return block_18(state, tracer, fn_state);
    }
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_1: write-var gs#309991 <= s_23_0
        fn_state.gs_309991 = s_23_0;
        // N s_23_2: jump b24
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_0: read-var gs#309991:u8
        let s_24_0: bool = fn_state.gs_309991;
        // D s_24_1: write-var gs#309992 <= s_24_0
        fn_state.gs_309992 = s_24_0;
        // N s_24_2: jump b21
        return block_21(state, tracer, fn_state);
    }
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_1: write-var gs#309990 <= s_26_0
        fn_state.gs_309990 = s_26_0;
        // N s_26_2: jump b27
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_0: read-var gs#309990:u8
        let s_27_0: bool = fn_state.gs_309990;
        // D s_27_1: write-var gs#309991 <= s_27_0
        fn_state.gs_309991 = s_27_0;
        // N s_27_2: jump b24
        return block_24(state, tracer, fn_state);
    }
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_1: write-var gs#309989 <= s_29_0
        fn_state.gs_309989 = s_29_0;
        // N s_29_2: jump b30
    ...
    fn block_30<T: Tracer>(
        ...
        // D s_30_0: read-var gs#309989:u8
        let s_30_0: bool = fn_state.gs_309989;
        // D s_30_1: write-var gs#309990 <= s_30_0
        fn_state.gs_309990 = s_30_0;
        // N s_30_2: jump b27
        return block_27(state, tracer, fn_state);
    }
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_7: write-var gs#309970 <= s_32_6
        fn_state.gs_309970 = s_32_6;
        // N s_32_8: jump b33
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var gs#309970:u8
        let s_33_0: bool = fn_state.gs_309970;
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_7: write-var gs#309972 <= s_34_6
        fn_state.gs_309972 = s_34_6;
        // N s_34_8: jump b35
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_0: read-var gs#309972:u8
        let s_35_0: bool = fn_state.gs_309972;
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_7: write-var gs#309974 <= s_36_6
        fn_state.gs_309974 = s_36_6;
        // N s_36_8: jump b37
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_0: read-var gs#309974:u8
        let s_37_0: bool = fn_state.gs_309974;
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_1: write-var gs#309988 <= s_38_0
        fn_state.gs_309988 = s_38_0;
        // N s_38_2: jump b39
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_0: read-var gs#309988:u8
        let s_39_0: bool = fn_state.gs_309988;
        // D s_39_1: write-var gs#309989 <= s_39_0
        fn_state.gs_309989 = s_39_0;
        // N s_39_2: jump b30
        return block_30(state, tracer, fn_state);
    }
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_1: write-var gs#309987 <= s_41_0
        fn_state.gs_309987 = s_41_0;
        // N s_41_2: jump b42
    ...
    fn block_42<T: Tracer>(
        ...
        // D s_42_0: read-var gs#309987:u8
        let s_42_0: bool = fn_state.gs_309987;
        // D s_42_1: write-var gs#309988 <= s_42_0
        fn_state.gs_309988 = s_42_0;
        // N s_42_2: jump b39
        return block_39(state, tracer, fn_state);
    }
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_1: write-var gs#309986 <= s_44_0
        fn_state.gs_309986 = s_44_0;
        // N s_44_2: jump b45
    ...
    fn block_45<T: Tracer>(
        ...
        // D s_45_0: read-var gs#309986:u8
        let s_45_0: bool = fn_state.gs_309986;
        // D s_45_1: write-var gs#309987 <= s_45_0
        fn_state.gs_309987 = s_45_0;
        // N s_45_2: jump b42
        return block_42(state, tracer, fn_state);
    }
    ...
    fn block_47<T: Tracer>(
        ...
        // D s_47_4: write-var gs#309979 <= s_47_3
        fn_state.gs_309979 = s_47_3;
        // N s_47_5: jump b48
    ...
    fn block_48<T: Tracer>(
        ...
        // D s_48_0: read-var gs#309979:u8
        let s_48_0: bool = fn_state.gs_309979;
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_4: write-var gs#309981 <= s_49_3
        fn_state.gs_309981 = s_49_3;
        // N s_49_5: jump b50
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_0: read-var gs#309981:u8
        let s_50_0: bool = fn_state.gs_309981;
    ...
    fn block_51<T: Tracer>(
        ...
        // D s_51_4: write-var gs#309983 <= s_51_3
        fn_state.gs_309983 = s_51_3;
        // N s_51_5: jump b52
    ...
    fn block_52<T: Tracer>(
        ...
        // D s_52_0: read-var gs#309983:u8
        let s_52_0: bool = fn_state.gs_309983;
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_4: write-var gs#309985 <= s_53_3
        fn_state.gs_309985 = s_53_3;
        // N s_53_5: jump b54
    ...
    fn block_54<T: Tracer>(
        ...
        // D s_54_0: read-var gs#309985:u8
        let s_54_0: bool = fn_state.gs_309985;
        // D s_54_1: write-var gs#309986 <= s_54_0
        fn_state.gs_309986 = s_54_0;
        // N s_54_2: jump b45
        return block_45(state, tracer, fn_state);
    }
    fn block_55<T: Tracer>(
        ...
        // D s_55_1: write-var gs#309985 <= s_55_0
        fn_state.gs_309985 = s_55_0;
        // N s_55_2: jump b54
        return block_54(state, tracer, fn_state);
    }
    fn block_56<T: Tracer>(
        ...
        // D s_56_1: write-var gs#309983 <= s_56_0
        fn_state.gs_309983 = s_56_0;
        // N s_56_2: jump b52
        return block_52(state, tracer, fn_state);
    }
    fn block_57<T: Tracer>(
        ...
        // D s_57_1: write-var gs#309981 <= s_57_0
        fn_state.gs_309981 = s_57_0;
        // N s_57_2: jump b50
        return block_50(state, tracer, fn_state);
    }
    fn block_58<T: Tracer>(
        ...
        // D s_58_1: write-var gs#309979 <= s_58_0
        fn_state.gs_309979 = s_58_0;
        // N s_58_2: jump b48
        return block_48(state, tracer, fn_state);
    }
    fn block_59<T: Tracer>(
        ...
        // D s_59_1: write-var gs#309974 <= s_59_0
        fn_state.gs_309974 = s_59_0;
        // N s_59_2: jump b37
        return block_37(state, tracer, fn_state);
    }
    fn block_60<T: Tracer>(
        ...
        // D s_60_1: write-var gs#309972 <= s_60_0
        fn_state.gs_309972 = s_60_0;
        // N s_60_2: jump b35
        return block_35(state, tracer, fn_state);
    }
    fn block_61<T: Tracer>(
        ...
        // D s_61_1: write-var gs#309970 <= s_61_0
        fn_state.gs_309970 = s_61_0;
        // N s_61_2: jump b33
        return block_33(state, tracer, fn_state);
    }
    fn block_62<T: Tracer>(
        ...
        // D s_62_1: write-var gs#309963 <= s_62_0
        fn_state.gs_309963 = s_62_0;
        // N s_62_2: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_63<T: Tracer>(
        ...
        // D s_63_1: write-var gs#309961 <= s_63_0
        fn_state.gs_309961 = s_63_0;
        // N s_63_2: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_64<T: Tracer>(
        ...
        // D s_64_1: write-var gs#309959 <= s_64_0
        fn_state.gs_309959 = s_64_0;
        // N s_64_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    ...
    fn block_66<T: Tracer>(
        ...
        // D s_66_1: write-var gs#309956 <= s_66_0
        fn_state.gs_309956 = s_66_0;
        // N s_66_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_67<T: Tracer>(
        ...
        // D s_67_4: write-var gs#309953 <= s_67_3
        fn_state.gs_309953 = s_67_3;
        // N s_67_5: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_68<T: Tracer>(
        ...
        // C s_68_0: const #1s : i
        let s_68_0: i128 = 1;
        // D s_68_1: write-var ga#353755 <= s_68_0
        fn_state.ga_353755 = s_68_0;
        // N s_68_2: jump b5
        return block_5(state, tracer, fn_state);
    }
