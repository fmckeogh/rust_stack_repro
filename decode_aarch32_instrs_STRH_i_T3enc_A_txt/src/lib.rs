...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_STRH_i_OpT_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_STRH_i_T3enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    Rt: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#302808 <= s_3_0
        fn_state.gs_302808 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#302808:u8
        let s_4_0: bool = fn_state.gs_302808;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#302809 <= s_5_0
        fn_state.gs_302809 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#302809:u8
        let s_6_0: bool = fn_state.gs_302809;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#302810 <= s_9_0
        fn_state.gs_302810 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#302810:u8
        let s_10_0: bool = fn_state.gs_302810;
        // D s_10_1: write-var gs#302811 <= s_10_0
        fn_state.gs_302811 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#302811:u8
        let s_11_0: bool = fn_state.gs_302811;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#302818 <= s_14_0
        fn_state.gs_302818 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#302818:u8
        let s_15_0: bool = fn_state.gs_302818;
        // D s_15_1: write-var gs#302819 <= s_15_0
        fn_state.gs_302819 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#302819:u8
        let s_16_0: bool = fn_state.gs_302819;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_6: call execute_aarch32_instrs_STRH_i_OpT_A_txt(s_17_0, s_17_1, s_17_2, s_17_3, s_17_4, s_17_5)
        let s_17_6: () = execute_aarch32_instrs_STRH_i_OpT_A_txt(
            state,
            tracer,
            s_17_0,
            s_17_1,
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_5: write-var gs#302818 <= s_19_4
        fn_state.gs_302818 = s_19_4;
        // N s_19_6: jump b15
        return block_15(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#302819 <= s_20_0
        fn_state.gs_302819 = s_20_0;
        // N s_20_2: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_5: write-var gs#302810 <= s_22_4
        fn_state.gs_302810 = s_22_4;
        // N s_22_6: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_23<T: Tracer>(
        ...
        // D s_23_1: write-var gs#302811 <= s_23_0
        fn_state.gs_302811 = s_23_0;
        // N s_23_2: jump b11
        return block_11(state, tracer, fn_state);
    }
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_5: write-var gs#302809 <= s_25_4
        fn_state.gs_302809 = s_25_4;
        // N s_25_6: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_26<T: Tracer>(
        ...
        // D s_26_5: write-var gs#302808 <= s_26_4
        fn_state.gs_302808 = s_26_4;
        // N s_26_6: jump b4
        return block_4(state, tracer, fn_state);
    }
}
