...
use common::*;
pub fn decode_aarch32_instrs_STRH_r_T2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    Rt: u8,
    ...
    struct FunctionState {
        m: i64,
        shift_nshadow_7285: i128,
        t: i64,
        ga_348183: ProductType90c39552810120fd,
        gs_302887: bool,
        shift_t: u32,
        n: i64,
        Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_21: write-var ga#348183 <= s_3_20
        fn_state.ga_348183 = s_3_20;
        // D s_3_22: read-var ga#348183.0:struct
        let s_3_22: u32 = fn_state.ga_348183._0;
        // D s_3_23: read-var ga#348183.1:struct
        let s_3_23: i64 = fn_state.ga_348183._1;
        ...
        // D s_3_26: write-var shift_nshadow#7285 <= s_3_25
        fn_state.shift_nshadow_7285 = s_3_25;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: write-var gs#302887 <= s_4_3
        fn_state.gs_302887 = s_4_3;
        // N s_4_5: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#302887:u8
        let s_5_0: bool = fn_state.gs_302887;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: read-var shift_nshadow#7285:i
        let s_6_4: i128 = fn_state.shift_nshadow_7285;
        ...
        // D s_6_8: call execute_aarch32_instrs_STRH_r_Op_A_txt(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5, s_6_6, s_6_7)
        let s_6_8: () = execute_aarch32_instrs_STRH_r_Op_A_txt(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #1u : u8
        let s_8_0: bool = true;
        // D s_8_1: write-var gs#302887 <= s_8_0
        fn_state.gs_302887 = s_8_0;
        // N s_8_2: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
