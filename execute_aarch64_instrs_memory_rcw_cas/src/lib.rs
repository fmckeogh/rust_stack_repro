...
use MemAtomicRCW::*;
use common::*;
pub fn execute_aarch64_instrs_memory_rcw_cas<T: Tracer>(
    state: &mut State,
    tracer: &T,
    acquire: bool,
    n: i64,
    ...
    struct FunctionState {
        compdata: u64,
        gs_708084: ProductType42c31f3d0ab6eb17,
        address: u64,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_7: write-var gs#708084 <= s_3_6
        fn_state.gs_708084 = s_3_6;
        // N s_3_8: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#708084.0:struct
        let s_4_0: u8 = fn_state.gs_708084._0;
        // D s_4_1: read-var gs#708084.1:struct
        let s_4_1: Bits = fn_state.gs_708084._1;
