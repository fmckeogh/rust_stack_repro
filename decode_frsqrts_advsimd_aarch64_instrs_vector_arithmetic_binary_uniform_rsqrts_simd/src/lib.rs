...
use common::*;
pub fn decode_frsqrts_advsimd_aarch64_instrs_vector_arithmetic_binary_uniform_rsqrts_simd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, Rm: u8, sz: bool, Q: bool) -> () {
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 64;
        // D s_2_1: write-var ga#256715 <= s_2_0
        fn_state.ga_256715 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#256715:i64
        let s_3_0: i64 = fn_state.ga_256715;
        ...
        // D s_3_15: call execute_aarch64_instrs_vector_arithmetic_binary_uniform_rsqrts_fp16_sisd(s_3_12, s_3_7, s_3_11, s_3_10, s_3_13, s_3_14)
        let s_3_15: () = execute_aarch64_instrs_vector_arithmetic_binary_uniform_rsqrts_fp16_sisd(
            state,
            tracer,
            s_3_12,
            s_3_7,
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 128;
        // D s_4_1: write-var ga#256715 <= s_4_0
        fn_state.ga_256715 = s_4_0;
        // N s_4_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_5<T: Tracer>(
