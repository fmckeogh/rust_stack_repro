...
use common::*;
pub fn HDFAR_SysRegRead32_b442fa1081ced0da<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #() : ()
        let s_6_0: () = ();
        // S s_6_1: call HDFAR_read(s_6_0)
        let s_6_1: u32 = HDFAR_read(state, tracer, s_6_0);
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #() : ()
        let s_8_0: () = ();
        // S s_8_1: call HDFAR_read(s_8_0)
        let s_8_1: u32 = HDFAR_read(state, tracer, s_8_0);
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#111256 <= s_10_0
        fn_state.gs_111256 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#111256:u8
        let s_11_0: bool = fn_state.gs_111256;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#111257 <= s_12_0
        fn_state.gs_111257 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#111257:u8
        let s_13_0: bool = fn_state.gs_111257;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#111258 <= s_15_0
        fn_state.gs_111258 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#111258:u8
        let s_16_0: bool = fn_state.gs_111258;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#111259 <= s_17_0
        fn_state.gs_111259 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#111259:u8
        let s_18_0: bool = fn_state.gs_111259;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_5: write-var gs#111259 <= s_21_4
        fn_state.gs_111259 = s_21_4;
        // N s_21_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        // D s_22_3: write-var gs#111258 <= s_22_2
        fn_state.gs_111258 = s_22_2;
        // N s_22_4: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_5: write-var gs#111257 <= s_24_4
        fn_state.gs_111257 = s_24_4;
        // N s_24_6: jump b13
        return block_13(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_4: write-var gs#111256 <= s_25_3
        fn_state.gs_111256 = s_25_3;
        // N s_25_5: jump b11
        return block_11(state, tracer, fn_state);
    }
