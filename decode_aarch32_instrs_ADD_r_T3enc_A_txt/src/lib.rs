...
use common::*;
pub fn decode_aarch32_instrs_ADD_r_T3enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    S: bool,
    Rn: u8,
    ...
    struct FunctionState {
        m: i64,
        gs_295553: bool,
        ga_342941: ProductType396b95aa74979079,
        gs_295565: bool,
        gs_295569: bool,
        setflags: bool,
        n: i64,
        d: i64,
        shift_nshadow_7114: i128,
        gs_295567: bool,
        shift_t: u32,
        S: bool,
        Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#295553 <= s_3_0
        fn_state.gs_295553 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#295553:u8
        let s_4_0: bool = fn_state.gs_295553;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_36: write-var ga#342941 <= s_6_35
        fn_state.ga_342941 = s_6_35;
        // D s_6_37: read-var ga#342941.0:struct
        let s_6_37: u32 = fn_state.ga_342941._0;
        // D s_6_38: read-var ga#342941.1:struct
        let s_6_38: i128 = fn_state.ga_342941._1;
        // D s_6_39: write-var shift_t <= s_6_37
        fn_state.shift_t = s_6_37;
        // D s_6_40: write-var shift_nshadow#7114 <= s_6_38
        fn_state.shift_nshadow_7114 = s_6_38;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#295565 <= s_7_0
        fn_state.gs_295565 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#295565:u8
        let s_8_0: bool = fn_state.gs_295565;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: write-var gs#295567 <= s_9_3
        fn_state.gs_295567 = s_9_3;
        // N s_9_5: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#295567:u8
        let s_10_0: bool = fn_state.gs_295567;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_4: write-var gs#295569 <= s_11_3
        fn_state.gs_295569 = s_11_3;
        // N s_11_5: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#295569:u8
        let s_12_0: bool = fn_state.gs_295569;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_4: read-var shift_nshadow#7114:i
        let s_13_4: i128 = fn_state.shift_nshadow_7114;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#295569 <= s_15_0
        fn_state.gs_295569 = s_15_0;
        // N s_15_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#295567 <= s_16_0
        fn_state.gs_295567 = s_16_0;
        // N s_16_2: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_17<T: Tracer>(
        ...
        // D s_17_2: write-var gs#295565 <= s_17_1
        fn_state.gs_295565 = s_17_1;
        // N s_17_3: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_5: write-var gs#295553 <= s_20_4
        fn_state.gs_295553 = s_20_4;
        // N s_20_6: jump b4
        return block_4(state, tracer, fn_state);
    }
}
