...
use HaveSVE::*;
use CurrentVL_read::*;
use execute_INCH_R_RS__::*;
use HaveSME::*;
use common::*;
pub fn decode_INCH_R_RS__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    imm4: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#191029 <= s_1_0
        fn_state.gs_191029 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#191029:u8
        let s_2_0: bool = fn_state.gs_191029;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_5: call execute_INCH_R_RS__(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4)
        let s_4_5: () = execute_INCH_R_RS__(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: call execute_INCH_R_RS__(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4)
        let s_6_5: () = execute_INCH_R_RS__(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_5: call execute_INCH_R_RS__(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4)
        let s_8_5: () = execute_INCH_R_RS__(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: call execute_INCH_R_RS__(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4)
        let s_10_5: () = execute_INCH_R_RS__(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: call execute_INCH_R_RS__(s_12_0, s_12_1, s_12_2, s_12_3, s_12_4)
        let s_12_5: () = execute_INCH_R_RS__(
            state,
            tracer,
            s_12_0,
            s_12_1,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#191029 <= s_15_2
        fn_state.gs_191029 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
