...
use common::*;
pub fn u__get_DBGDSCRint<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #2683858883u : u32
        let s_0_3: u32 = 2683858883;
        ...
        // D s_0_11: tail-call Mk_DBGDSCRint_Type(s_0_10)
        return Mk_DBGDSCRint_Type(state, tracer, s_0_10);
    }
}
