...
extern crate alloc;
use execute_aarch64_instrs_float_arithmetic_max_min::*;
use common::*;
pub fn decode_fminnm_float_aarch64_instrs_float_arithmetic_max_min<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        fn_state.m = s_0_13;
        // C s_0_15: const #16s : i64
        let s_0_15: i64 = 16;
        // D s_0_16: write-var esize <= s_0_15
        fn_state.esize = s_0_15;
        // D s_0_17: read-var ftype:u8
        let s_0_17: u8 = fn_state.ftype;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var esizeshadow#1379 <= s_2_0
        fn_state.esizeshadow_1379 = s_2_0;
        // D s_2_2: read-var op:u8
        let s_2_2: u8 = fn_state.op;
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: u32 = 0;
        // D s_3_1: write-var operation <= s_3_0
        fn_state.operation = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var operation:u32
        let s_4_0: u32 = fn_state.operation;
        // D s_4_1: read-var esizeshadow#1379:i64
        let s_4_1: i64 = fn_state.esizeshadow_1379;
        ...
        // D s_4_7: call execute_aarch64_instrs_float_arithmetic_max_min(s_4_4, s_4_3, s_4_5, s_4_6, s_4_0)
        let s_4_7: () = execute_aarch64_instrs_float_arithmetic_max_min(
            state,
            tracer,
            s_4_4,
            s_4_3,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: u32 = 1;
        // D s_6_1: write-var operation <= s_6_0
        fn_state.operation = s_6_0;
        // N s_6_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: u32 = 2;
        // D s_8_1: write-var operation <= s_8_0
        fn_state.operation = s_8_0;
        // N s_8_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
        ...
        let s_9_0: u32 = 3;
        // D s_9_1: write-var operation <= s_9_0
        fn_state.operation = s_9_0;
        // N s_9_2: jump b4
        return block_4(state, tracer, fn_state);
    }
