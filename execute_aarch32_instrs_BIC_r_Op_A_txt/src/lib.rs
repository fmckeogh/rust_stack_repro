...
use ALUWritePC::*;
use common::*;
pub fn execute_aarch32_instrs_BIC_r_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        carry: bool,
        result: u32,
        gs_878396: ProductTypef506aa96a892fe52,
        d: i64,
        m: i64,
        n: i64,
        setflags: bool,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_9: write-var gs#878396 <= s_0_8
        fn_state.gs_878396 = s_0_8;
        // D s_0_10: read-var gs#878396.0:struct
        let s_0_10: Bits = fn_state.gs_878396._0;
        // D s_0_11: cast reint s_0_10 -> u32
        let s_0_11: u32 = (s_0_10.value() as u32);
        // D s_0_12: read-var gs#878396.1:struct
        let s_0_12: bool = fn_state.gs_878396._1;
