...
use u__id::*;
use ConditionPassed::*;
use execute_aarch32_instrs_VLD2_m_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_VLD2_m_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Rn: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 1;
        // D s_5_1: write-var ga#354096 <= s_5_0
        fn_state.ga_354096 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#354096:i64
        let s_6_0: i64 = fn_state.ga_354096;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_7: write-var ga#354099 <= s_7_6
        fn_state.ga_354099 = s_7_6;
        // N s_7_8: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var ga#354099:i
        let s_8_0: i128 = fn_state.ga_354099;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#310414 <= s_9_0
        fn_state.gs_310414 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#310414:u8
        let s_10_0: bool = fn_state.gs_310414;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_9: write-var gs#310417 <= s_11_8
        fn_state.gs_310417 = s_11_8;
        // N s_11_10: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#310417:u8
        let s_12_0: bool = fn_state.gs_310417;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_7: write-var gs#310420 <= s_14_6
        fn_state.gs_310420 = s_14_6;
        // N s_14_8: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#310420:u8
        let s_15_0: bool = fn_state.gs_310420;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#310450 <= s_16_0
        fn_state.gs_310450 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#310450:u8
        let s_17_0: bool = fn_state.gs_310450;
        ...
        // D s_17_15: call execute_aarch32_instrs_VLD2_m_Op_A_txt(s_17_3, s_17_8, s_17_5, s_17_9, s_17_7, s_17_10, s_17_11, s_17_12, s_17_13, s_17_14)
        let s_17_15: () = execute_aarch32_instrs_VLD2_m_Op_A_txt(
            state,
            tracer,
            s_17_3,
            s_17_8,
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#310449 <= s_19_0
        fn_state.gs_310449 = s_19_0;
        // N s_19_2: jump b20
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_0: read-var gs#310449:u8
        let s_20_0: bool = fn_state.gs_310449;
        // D s_20_1: write-var gs#310450 <= s_20_0
        fn_state.gs_310450 = s_20_0;
        // N s_20_2: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#310448 <= s_22_0
        fn_state.gs_310448 = s_22_0;
        // N s_22_2: jump b23
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_0: read-var gs#310448:u8
        let s_23_0: bool = fn_state.gs_310448;
        // D s_23_1: write-var gs#310449 <= s_23_0
        fn_state.gs_310449 = s_23_0;
        // N s_23_2: jump b20
        return block_20(state, tracer, fn_state);
    }
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#310447 <= s_25_0
        fn_state.gs_310447 = s_25_0;
        // N s_25_2: jump b26
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var gs#310447:u8
        let s_26_0: bool = fn_state.gs_310447;
        // D s_26_1: write-var gs#310448 <= s_26_0
        fn_state.gs_310448 = s_26_0;
        // N s_26_2: jump b23
        return block_23(state, tracer, fn_state);
    }
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_1: write-var gs#310446 <= s_28_0
        fn_state.gs_310446 = s_28_0;
        // N s_28_2: jump b29
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_0: read-var gs#310446:u8
        let s_29_0: bool = fn_state.gs_310446;
        // D s_29_1: write-var gs#310447 <= s_29_0
        fn_state.gs_310447 = s_29_0;
        // N s_29_2: jump b26
        return block_26(state, tracer, fn_state);
    }
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_7: write-var gs#310427 <= s_31_6
        fn_state.gs_310427 = s_31_6;
        // N s_31_8: jump b32
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_0: read-var gs#310427:u8
        let s_32_0: bool = fn_state.gs_310427;
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_7: write-var gs#310429 <= s_33_6
        fn_state.gs_310429 = s_33_6;
        // N s_33_8: jump b34
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_0: read-var gs#310429:u8
        let s_34_0: bool = fn_state.gs_310429;
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_7: write-var gs#310431 <= s_35_6
        fn_state.gs_310431 = s_35_6;
        // N s_35_8: jump b36
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_0: read-var gs#310431:u8
        let s_36_0: bool = fn_state.gs_310431;
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_1: write-var gs#310445 <= s_37_0
        fn_state.gs_310445 = s_37_0;
        // N s_37_2: jump b38
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_0: read-var gs#310445:u8
        let s_38_0: bool = fn_state.gs_310445;
        // D s_38_1: write-var gs#310446 <= s_38_0
        fn_state.gs_310446 = s_38_0;
        // N s_38_2: jump b29
        return block_29(state, tracer, fn_state);
    }
    ...
    fn block_40<T: Tracer>(
        ...
        // D s_40_1: write-var gs#310444 <= s_40_0
        fn_state.gs_310444 = s_40_0;
        // N s_40_2: jump b41
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_0: read-var gs#310444:u8
        let s_41_0: bool = fn_state.gs_310444;
        // D s_41_1: write-var gs#310445 <= s_41_0
        fn_state.gs_310445 = s_41_0;
        // N s_41_2: jump b38
        return block_38(state, tracer, fn_state);
    }
    ...
    fn block_43<T: Tracer>(
        ...
        // D s_43_1: write-var gs#310443 <= s_43_0
        fn_state.gs_310443 = s_43_0;
        // N s_43_2: jump b44
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_0: read-var gs#310443:u8
        let s_44_0: bool = fn_state.gs_310443;
        // D s_44_1: write-var gs#310444 <= s_44_0
        fn_state.gs_310444 = s_44_0;
        // N s_44_2: jump b41
        return block_41(state, tracer, fn_state);
    }
    ...
    fn block_46<T: Tracer>(
        ...
        // D s_46_4: write-var gs#310436 <= s_46_3
        fn_state.gs_310436 = s_46_3;
        // N s_46_5: jump b47
    ...
    fn block_47<T: Tracer>(
        ...
        // D s_47_0: read-var gs#310436:u8
        let s_47_0: bool = fn_state.gs_310436;
    ...
    fn block_48<T: Tracer>(
        ...
        // D s_48_4: write-var gs#310438 <= s_48_3
        fn_state.gs_310438 = s_48_3;
        // N s_48_5: jump b49
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_0: read-var gs#310438:u8
        let s_49_0: bool = fn_state.gs_310438;
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_4: write-var gs#310440 <= s_50_3
        fn_state.gs_310440 = s_50_3;
        // N s_50_5: jump b51
    ...
    fn block_51<T: Tracer>(
        ...
        // D s_51_0: read-var gs#310440:u8
        let s_51_0: bool = fn_state.gs_310440;
    ...
    fn block_52<T: Tracer>(
        ...
        // D s_52_4: write-var gs#310442 <= s_52_3
        fn_state.gs_310442 = s_52_3;
        // N s_52_5: jump b53
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_0: read-var gs#310442:u8
        let s_53_0: bool = fn_state.gs_310442;
        // D s_53_1: write-var gs#310443 <= s_53_0
        fn_state.gs_310443 = s_53_0;
        // N s_53_2: jump b44
        return block_44(state, tracer, fn_state);
    }
    fn block_54<T: Tracer>(
        ...
        // D s_54_1: write-var gs#310442 <= s_54_0
        fn_state.gs_310442 = s_54_0;
        // N s_54_2: jump b53
        return block_53(state, tracer, fn_state);
    }
    fn block_55<T: Tracer>(
        ...
        // D s_55_1: write-var gs#310440 <= s_55_0
        fn_state.gs_310440 = s_55_0;
        // N s_55_2: jump b51
        return block_51(state, tracer, fn_state);
    }
    fn block_56<T: Tracer>(
        ...
        // D s_56_1: write-var gs#310438 <= s_56_0
        fn_state.gs_310438 = s_56_0;
        // N s_56_2: jump b49
        return block_49(state, tracer, fn_state);
    }
    fn block_57<T: Tracer>(
        ...
        // D s_57_1: write-var gs#310436 <= s_57_0
        fn_state.gs_310436 = s_57_0;
        // N s_57_2: jump b47
        return block_47(state, tracer, fn_state);
    }
    fn block_58<T: Tracer>(
        ...
        // D s_58_1: write-var gs#310431 <= s_58_0
        fn_state.gs_310431 = s_58_0;
        // N s_58_2: jump b36
        return block_36(state, tracer, fn_state);
    }
    fn block_59<T: Tracer>(
        ...
        // D s_59_1: write-var gs#310429 <= s_59_0
        fn_state.gs_310429 = s_59_0;
        // N s_59_2: jump b34
        return block_34(state, tracer, fn_state);
    }
    fn block_60<T: Tracer>(
        ...
        // D s_60_1: write-var gs#310427 <= s_60_0
        fn_state.gs_310427 = s_60_0;
        // N s_60_2: jump b32
        return block_32(state, tracer, fn_state);
    }
    fn block_61<T: Tracer>(
        ...
        // D s_61_1: write-var gs#310420 <= s_61_0
        fn_state.gs_310420 = s_61_0;
        // N s_61_2: jump b15
        return block_15(state, tracer, fn_state);
    }
    ...
    fn block_63<T: Tracer>(
        ...
        // D s_63_1: write-var gs#310417 <= s_63_0
        fn_state.gs_310417 = s_63_0;
        // N s_63_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_64<T: Tracer>(
        ...
        // D s_64_4: write-var gs#310414 <= s_64_3
        fn_state.gs_310414 = s_64_3;
        // N s_64_5: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_65<T: Tracer>(
        ...
        // C s_65_0: const #1s : i
        let s_65_0: i128 = 1;
        // D s_65_1: write-var ga#354099 <= s_65_0
        fn_state.ga_354099 = s_65_0;
        // N s_65_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_66<T: Tracer>(
        ...
        let s_66_0: i64 = 2;
        // D s_66_1: write-var ga#354096 <= s_66_0
        fn_state.ga_354096 = s_66_0;
        // N s_66_2: jump b6
        return block_6(state, tracer, fn_state);
    }
