...
use Z_set::*;
use common::*;
pub fn execute_LD1ROW_Z_P_BR_Contiguous<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    esize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#4713 <= s_0_2
        fn_state.VLshadow_4713 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#4713:i64
        let s_1_0: i64 = fn_state.VLshadow_4713;
        // D s_1_1: write-var VLshadow#4714 <= s_1_0
        fn_state.VLshadow_4714 = s_1_0;
        // C s_1_2: const #8s : i
        let s_1_2: i128 = 8;
        // D s_1_3: read-var VLshadow#4714:i64
        let s_1_3: i64 = fn_state.VLshadow_4714;
        ...
        let s_1_8: i128 = 256;
        // D s_1_9: read-var VLshadow#4714:i64
        let s_1_9: i64 = fn_state.VLshadow_4714;
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_20: const #0u : u32
        let s_2_20: u32 = 0;
        // C s_2_21: const #0u : u8
        let s_2_21: bool = false;
        // C s_2_22: const #1u : u8
        let s_2_22: bool = true;
        // C s_2_23: const #1u : u8
        let s_2_23: bool = true;
        // S s_2_24: call CreateAccDescSVE(s_2_20, s_2_21, s_2_22, s_2_23)
        let s_2_24: ProductType9878976b5bcce9c9 = CreateAccDescSVE(
            state,
            tracer,
            s_2_20,
            s_2_21,
        ...
        // D s_2_26: read-var esize:i64
        let s_2_26: i64 = fn_state.esize;
        // D s_2_27: cast zx s_2_26 -> i
        let s_2_27: i128 = (i128::try_from(s_2_26).unwrap());
        // D s_2_28: read-var mask:bv
        let s_2_28: Bits = fn_state.mask;
        // D s_2_29: call AnyActiveElement(s_2_28, s_2_27)
        let s_2_29: bool = AnyActiveElement(state, tracer, s_2_28, s_2_27);
        // D s_2_30: not s_2_29
        let s_2_30: bool = !s_2_29;
        // N s_2_31: branch s_2_30 b18 b3
        if s_2_30 {
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_6: write-var gs#232535 <= s_8_5
        fn_state.gs_232535 = s_8_5;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: read-var gs#232535:i64
        let s_9_1: i64 = fn_state.gs_232535;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_6: cast reint s_11_5 -> u32
        let s_11_6: u32 = (s_11_5.value() as u32);
        ...
        let s_11_12: Bits = Bits::new(s_11_6 as u128, 32u16);
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var offset:u64
        let s_13_0: u64 = fn_state.offset;
        ...
        // D s_13_3: read-var e:i64
        let s_13_3: i64 = fn_state.e;
        // D s_13_4: cast zx s_13_3 -> i
        let s_13_4: i128 = (i128::try_from(s_13_3).unwrap());
        // D s_13_5: add s_13_2 s_13_4
        let s_13_5: i128 = (s_13_2 + s_13_4);
        // D s_13_6: read-var mbytes:i64
        let s_13_6: i64 = fn_state.mbytes;
        // D s_13_7: cast zx s_13_6 -> i
        let s_13_7: i128 = (i128::try_from(s_13_6).unwrap());
        // D s_13_8: mul s_13_5 s_13_7
        let s_13_8: i128 = ((s_13_5) * (s_13_7));
        // D s_13_9: read-var base:u64
        let s_13_9: u64 = fn_state.base;
        // D s_13_10: cast zx s_13_9 -> bv
        let s_13_10: Bits = Bits::new(s_13_9 as u128, 64u16);
        // D s_13_11: cast cvt s_13_8 -> bv
        let s_13_11: Bits = Bits::new(s_13_8 as u128, 128);
        // D s_13_12: add s_13_10 s_13_11
        let s_13_12: Bits = (s_13_10 + s_13_11);
        // D s_13_13: cast reint s_13_12 -> u64
        let s_13_13: u64 = (s_13_12.value() as u64);
        // D s_13_14: read-var esize:i64
        let s_13_14: i64 = fn_state.esize;
        ...
        // D s_13_17: write-var ga#306340 <= s_13_16
        fn_state.ga_306340 = s_13_16;
        // D s_13_18: read-var mbytes:i64
        let s_13_18: i64 = fn_state.mbytes;
        // D s_13_19: cast zx s_13_18 -> i
        let s_13_19: i128 = (i128::try_from(s_13_18).unwrap());
        // D s_13_20: read-var accdesc:struct
        let s_13_20: ProductType9878976b5bcce9c9 = fn_state.accdesc;
        // D s_13_21: call Mem_read(s_13_13, s_13_19, s_13_20)
        let s_13_21: Bits = Mem_read(state, tracer, s_13_13, s_13_19, s_13_20);
        // D s_13_22: write-var ga#306341 <= s_13_21
        fn_state.ga_306341 = s_13_21;
        // N s_13_23: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_4: read-var ga#306340:i64
        let s_14_4: i64 = fn_state.ga_306340;
        // D s_14_5: cast zx s_14_4 -> i
        let s_14_5: i128 = (i128::try_from(s_14_4).unwrap());
        // D s_14_6: read-var ga#306341:bv
        let s_14_6: Bits = fn_state.ga_306341;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var VLshadow#4714:i64
        let s_15_0: i64 = fn_state.VLshadow_4714;
        ...
        let s_15_3: i128 = 256;
        // D s_15_4: read-var VLshadow#4714:i64
        let s_15_4: i64 = fn_state.VLshadow_4714;
        ...
        // D s_15_13: read-var VLshadow#4714:i64
        let s_15_13: i64 = fn_state.VLshadow_4714;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#232550 <= s_19_0
        fn_state.gs_232550 = s_19_0;
        // N s_19_2: jump b20
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_0: read-var gs#232550:u8
        let s_20_0: bool = fn_state.gs_232550;
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_2: write-var gs#232550 <= s_24_1
        fn_state.gs_232550 = s_24_1;
        // N s_24_3: jump b20
        return block_20(state, tracer, fn_state);
    }
