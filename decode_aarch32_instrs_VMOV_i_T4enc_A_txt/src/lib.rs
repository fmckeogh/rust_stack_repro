...
use common::*;
pub fn decode_aarch32_instrs_VMOV_i_T4enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i: bool,
    D: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#313014 <= s_3_0
        fn_state.gs_313014 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#313014:u8
        let s_4_0: bool = fn_state.gs_313014;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#313017 <= s_5_0
        fn_state.gs_313017 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#313017:u8
        let s_6_0: bool = fn_state.gs_313017;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#313018 <= s_8_0
        fn_state.gs_313018 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#313018:u8
        let s_9_0: bool = fn_state.gs_313018;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#313021 <= s_11_0
        fn_state.gs_313021 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#313021:u8
        let s_12_0: bool = fn_state.gs_313021;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var imm32shadow#7547 <= s_13_0
        fn_state.imm32shadow_7547 = s_13_0;
    ...
    fn block_15<T: Tracer>(
        ...
        let s_15_0: i64 = 2;
        // D s_15_1: write-var ga#356256 <= s_15_0
        fn_state.ga_356256 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var ga#356256:i64
        let s_16_0: i64 = fn_state.ga_356256;
        // C s_16_1: const #1u : u8
        let s_16_1: bool = true;
        // D s_16_2: read-var d:i64
        let s_16_2: i64 = fn_state.d;
        // D s_16_3: read-var imm32shadow#7547:u32
        let s_16_3: u32 = fn_state.imm32shadow_7547;
    ...
    fn block_17<T: Tracer>(
        ...
        let s_17_0: i64 = 1;
        // D s_17_1: write-var ga#356256 <= s_17_0
        fn_state.ga_356256 = s_17_0;
        // N s_17_2: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_22: write-var gs#313021 <= s_19_21
        fn_state.gs_313021 = s_19_21;
        // N s_19_23: jump b12
        return block_12(state, tracer, fn_state);
    }
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_5: write-var gs#313018 <= s_21_4
        fn_state.gs_313018 = s_21_4;
        // N s_21_6: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_13: write-var gs#313017 <= s_23_12
        fn_state.gs_313017 = s_23_12;
        // N s_23_14: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_24<T: Tracer>(
        ...
        // D s_24_22: write-var gs#313014 <= s_24_21
        fn_state.gs_313014 = s_24_21;
        // N s_24_23: jump b4
        return block_4(state, tracer, fn_state);
    }
}
