...
use CurrentVL_read::*;
use DecodeBitMasks::*;
use execute_AND_Z_ZI__::*;
use HaveSME::*;
use common::*;
pub fn decode_AND_Z_ZI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm13: u16,
    Zdn: u8,
    ...
    struct FunctionState {
        ...
        gs_194194: bool,
        imm: u64,
        gs_745097: ProductTypebc91b195b0b2a883,
        imm13: u16,
        Zdn: u8,
    }
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#194194 <= s_1_0
        fn_state.gs_194194 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#194194:u8
        let s_2_0: bool = fn_state.gs_194194;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_45: write-var gs#745097 <= s_3_44
        fn_state.gs_745097 = s_3_44;
        // N s_3_46: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#745097.0:struct
        let s_4_0: Bits = fn_state.gs_745097._0;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call execute_AND_Z_ZI__(s_5_0, s_5_1, s_5_2)
        let s_5_3: () = execute_AND_Z_ZI__(state, tracer, s_5_0, s_5_1, s_5_2);
        // N s_5_4: return
        return;
    }
    fn block_6<T: Tracer>(
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_3: call execute_AND_Z_ZI__(s_7_0, s_7_1, s_7_2)
        let s_7_3: () = execute_AND_Z_ZI__(state, tracer, s_7_0, s_7_1, s_7_2);
        // N s_7_4: return
        return;
    }
    fn block_8<T: Tracer>(
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_3: call execute_AND_Z_ZI__(s_9_0, s_9_1, s_9_2)
        let s_9_3: () = execute_AND_Z_ZI__(state, tracer, s_9_0, s_9_1, s_9_2);
        // N s_9_4: return
        return;
    }
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_3: call execute_AND_Z_ZI__(s_11_0, s_11_1, s_11_2)
        let s_11_3: () = execute_AND_Z_ZI__(state, tracer, s_11_0, s_11_1, s_11_2);
        // N s_11_4: return
        return;
    }
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_3: call execute_AND_Z_ZI__(s_13_0, s_13_1, s_13_2)
        let s_13_3: () = execute_AND_Z_ZI__(state, tracer, s_13_0, s_13_1, s_13_2);
        // N s_13_4: return
        return;
    }
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_3: write-var gs#194194 <= s_16_2
        fn_state.gs_194194 = s_16_2;
        // N s_16_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
