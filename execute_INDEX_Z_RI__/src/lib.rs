...
use Z_set::*;
use common::*;
pub fn execute_INDEX_Z_RI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#2855 <= s_0_2
        fn_state.esizeshadow_2855 = s_0_2;
        ...
        // D s_0_7: write-var VLshadow#2856 <= s_0_6
        fn_state.VLshadow_2856 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#2856:i64
        let s_1_0: i64 = fn_state.VLshadow_2856;
        // D s_1_1: write-var VLshadow#2857 <= s_1_0
        fn_state.VLshadow_2857 = s_1_0;
        // D s_1_2: read-var VLshadow#2857:i64
        let s_1_2: i64 = fn_state.VLshadow_2857;
        // D s_1_3: cast zx s_1_2 -> i
        let s_1_3: i128 = (i128::try_from(s_1_2).unwrap());
        // D s_1_4: read-var esizeshadow#2855:i64
        let s_1_4: i64 = fn_state.esizeshadow_2855;
        ...
        // D s_1_8: read-var esizeshadow#2855:i64
        let s_1_8: i64 = fn_state.esizeshadow_2855;
        ...
        // D s_1_22: write-var gs#194077 <= s_1_21
        fn_state.gs_194077 = s_1_21;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#194077:i64
        let s_2_1: i64 = fn_state.gs_194077;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_2: read-var imm:i
        let s_3_2: i128 = fn_state.imm;
        // D s_3_3: mul s_3_1 s_3_2
        let s_3_3: i128 = ((s_3_1) * (s_3_2));
        // D s_3_4: read-var element1:i64
        let s_3_4: i64 = fn_state.element1;
        // D s_3_5: cast zx s_3_4 -> i
        let s_3_5: i128 = (i128::try_from(s_3_4).unwrap());
        // D s_3_6: add s_3_5 s_3_3
        let s_3_6: i128 = (s_3_5 + s_3_3);
        // D s_3_7: read-var esizeshadow#2855:i64
        let s_3_7: i64 = fn_state.esizeshadow_2855;
        ...
        // C s_3_10: const #1s : i
        let s_3_10: i128 = 1;
        // D s_3_11: read-var esizeshadow#2855:i64
        let s_3_11: i64 = fn_state.esizeshadow_2855;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#2857:i64
        let s_4_0: i64 = fn_state.VLshadow_2857;
