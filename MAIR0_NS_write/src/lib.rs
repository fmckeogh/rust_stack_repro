...
use PRRR_write::*;
use common::*;
pub fn MAIR0_NS_write<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    struct FunctionState {
        ...
        ga_27291: ProductType700c18a878c5601b,
        gs_35165: bool,
        ga_27305: ProductType700c18a878c5601b,
        value_name: ProductType700c18a878c5601b,
    }
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_4: write-var gs#35165 <= s_2_3
        fn_state.gs_35165 = s_2_3;
        // N s_2_5: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#35165:u8
        let s_3_0: bool = fn_state.gs_35165;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: write-var ga#27305 <= s_4_1
        fn_state.ga_27305 = s_4_1;
        // D s_4_3: read-var ga#27305.0:struct
        let s_4_3: u32 = fn_state.ga_27305._0;
        ...
        // D s_4_25: call Mk_PRRR_Type(s_4_24)
        let s_4_25: ProductType700c18a878c5601b = Mk_PRRR_Type(state, tracer, s_4_24);
        // D s_4_26: call PRRR_write(s_4_25)
        let s_4_26: () = PRRR_write(state, tracer, s_4_25);
        // N s_4_27: jump b5
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #1u : u8
        let s_7_0: bool = true;
        // D s_7_1: write-var gs#35165 <= s_7_0
        fn_state.gs_35165 = s_7_0;
        // N s_7_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
        ...
        // D s_8_2: write-var ga#27291 <= s_8_1
        fn_state.ga_27291 = s_8_1;
        // D s_8_3: read-var ga#27291.0:struct
        let s_8_3: u32 = fn_state.ga_27291._0;
        ...
        // D s_8_25: call Mk_PRRR_Type(s_8_24)
        let s_8_25: ProductType700c18a878c5601b = Mk_PRRR_Type(state, tracer, s_8_24);
        // D s_8_26: call PRRR_NS_write(s_8_25)
        let s_8_26: () = PRRR_NS_write(state, tracer, s_8_25);
        // N s_8_27: jump b5
        return block_5(state, tracer, fn_state);
    }
}
