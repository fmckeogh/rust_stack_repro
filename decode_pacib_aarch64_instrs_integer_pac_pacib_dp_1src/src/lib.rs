...
use common::*;
pub fn decode_pacib_aarch64_instrs_integer_pac_pacib_dp_1src<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_3: call execute_aarch64_instrs_integer_pac_pacib_dp_1src(s_4_0, s_4_1, s_4_2)
        let s_4_3: () = execute_aarch64_instrs_integer_pac_pacib_dp_1src(
            state,
            tracer,
            s_4_0,
            s_4_1,
