...
use common::*;
pub fn decode_aarch32_instrs_TST_i_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i: bool,
    Rn: u8,
    ...
    struct FunctionState {
        carry: bool,
        imm32: u32,
        ga_348758: ProductType4813027798de1e98,
        n: i64,
        i: bool,
        Rn: u8,
        imm3: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_33: write-var ga#348758 <= s_2_32
        fn_state.ga_348758 = s_2_32;
        // D s_2_34: read-var ga#348758.0:struct
        let s_2_34: u32 = fn_state.ga_348758._0;
        // D s_2_35: read-var ga#348758.1:struct
        let s_2_35: bool = fn_state.ga_348758._1;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_3: call execute_aarch32_instrs_TST_i_Op_A_txt(s_3_1, s_3_0, s_3_2)
        let s_3_3: () = execute_aarch32_instrs_TST_i_Op_A_txt(
            state,
            tracer,
            s_3_1,
            s_3_0,
