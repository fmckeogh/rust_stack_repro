...
use ConditionPassed::*;
use DecodeImmShift::*;
use execute_aarch32_instrs_ORR_r_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_ORR_r_T2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    S: bool,
    Rn: u8,
    ...
    struct FunctionState {
        d: i64,
        m: i64,
        ga_345369: ProductType396b95aa74979079,
        shift_nshadow_7237: i128,
        gs_299066: bool,
        setflags: bool,
        shift_t: u32,
        n: i64,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_36: write-var ga#345369 <= s_3_35
        fn_state.ga_345369 = s_3_35;
        // D s_3_37: read-var ga#345369.0:struct
        let s_3_37: u32 = fn_state.ga_345369._0;
        // D s_3_38: read-var ga#345369.1:struct
        let s_3_38: i128 = fn_state.ga_345369._1;
        // D s_3_39: write-var shift_t <= s_3_37
        fn_state.shift_t = s_3_37;
        // D s_3_40: write-var shift_nshadow#7237 <= s_3_38
        fn_state.shift_nshadow_7237 = s_3_38;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: write-var gs#299066 <= s_4_3
        fn_state.gs_299066 = s_4_3;
        // N s_4_5: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#299066:u8
        let s_5_0: bool = fn_state.gs_299066;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: read-var shift_nshadow#7237:i
        let s_6_4: i128 = fn_state.shift_nshadow_7237;
        // D s_6_5: read-var shift_t:u32
        let s_6_5: u32 = fn_state.shift_t;
        // D s_6_6: call execute_aarch32_instrs_ORR_r_Op_A_txt(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5)
        let s_6_6: () = execute_aarch32_instrs_ORR_r_Op_A_txt(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #1u : u8
        let s_8_0: bool = true;
        // D s_8_1: write-var gs#299066 <= s_8_0
        fn_state.gs_299066 = s_8_0;
        // N s_8_2: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
