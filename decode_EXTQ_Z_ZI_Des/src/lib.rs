...
use CurrentVL_read::*;
use HaveSME2p1::*;
use execute_EXTQ_Z_ZI_Des::*;
use common::*;
pub fn decode_EXTQ_Z_ZI_Des<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm4: u8,
    Zm: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#220200 <= s_1_0
        fn_state.gs_220200 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#220200:u8
        let s_2_0: bool = fn_state.gs_220200;
    ...
    fn block_3<T: Tracer>(
        ...
        fn_state.m = s_3_8;
        // D s_3_10: read-var imm4:u8
        let s_3_10: u8 = fn_state.imm4;
        ...
        // D s_3_16: lsl s_3_15 s_3_14
        let s_3_16: i128 = s_3_15 << s_3_14;
        // D s_3_17: write-var position <= s_3_16
        fn_state.position = s_3_16;
        // D s_3_18: read-var VL:i64
        let s_3_18: i64 = fn_state.VL;
        // C s_3_19: const #128s : i
        let s_3_19: i128 = 128;
        // D s_3_20: cast zx s_3_18 -> i
        let s_3_20: i128 = (i128::try_from(s_3_18).unwrap());
        // D s_3_21: cmp-eq s_3_20 s_3_19
        let s_3_21: bool = ((s_3_20) == (s_3_19));
        // D s_3_22: not s_3_21
        let s_3_22: bool = !s_3_21;
        // N s_3_23: branch s_3_22 b5 b4
        if s_3_22 {
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_3: read-var position:i
        let s_4_3: i128 = fn_state.position;
        // D s_4_4: call execute_EXTQ_Z_ZI_Des(s_4_0, s_4_1, s_4_2, s_4_3)
        let s_4_4: () = execute_EXTQ_Z_ZI_Des(state, tracer, s_4_0, s_4_1, s_4_2, s_4_3);
        // N s_4_5: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: read-var position:i
        let s_6_3: i128 = fn_state.position;
        // D s_6_4: call execute_EXTQ_Z_ZI_Des(s_6_0, s_6_1, s_6_2, s_6_3)
        let s_6_4: () = execute_EXTQ_Z_ZI_Des(state, tracer, s_6_0, s_6_1, s_6_2, s_6_3);
        // N s_6_5: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_3: read-var position:i
        let s_8_3: i128 = fn_state.position;
        // D s_8_4: call execute_EXTQ_Z_ZI_Des(s_8_0, s_8_1, s_8_2, s_8_3)
        let s_8_4: () = execute_EXTQ_Z_ZI_Des(state, tracer, s_8_0, s_8_1, s_8_2, s_8_3);
        // N s_8_5: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_3: read-var position:i
        let s_10_3: i128 = fn_state.position;
        // D s_10_4: call execute_EXTQ_Z_ZI_Des(s_10_0, s_10_1, s_10_2, s_10_3)
        let s_10_4: () = execute_EXTQ_Z_ZI_Des(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_3: read-var position:i
        let s_12_3: i128 = fn_state.position;
        // D s_12_4: call execute_EXTQ_Z_ZI_Des(s_12_0, s_12_1, s_12_2, s_12_3)
        let s_12_4: () = execute_EXTQ_Z_ZI_Des(
            state,
            tracer,
            s_12_0,
            s_12_1,
    ...
    fn block_15<T: Tracer>(
        ...
        // C s_15_0: const #() : ()
        let s_15_0: () = ();
        // S s_15_1: call HaveSME2p1(s_15_0)
        let s_15_1: bool = HaveSME2p1(state, tracer, s_15_0);
        // S s_15_2: not s_15_1
        let s_15_2: bool = !s_15_1;
        // D s_15_3: write-var gs#220200 <= s_15_2
        fn_state.gs_220200 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
