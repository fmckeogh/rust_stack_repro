...
use u__get_VBAR_EL3::*;
use common::*;
pub fn VBAR_EL3_SysRegRead_1921cc85b07f3896<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call __get_VBAR_EL3(s_5_2)
        let s_5_3: u64 = u__get_VBAR_EL3(state, tracer, s_5_2);
