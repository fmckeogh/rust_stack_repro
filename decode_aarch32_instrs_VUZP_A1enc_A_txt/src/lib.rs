...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_VUZP_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_VUZP_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    size: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#323003 <= s_4_0
        fn_state.gs_323003 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#323003:u8
        let s_5_0: bool = fn_state.gs_323003;
        // D s_5_1: write-var gs#323004 <= s_5_0
        fn_state.gs_323004 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#323004:u8
        let s_6_0: bool = fn_state.gs_323004;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#323010 <= s_8_0
        fn_state.gs_323010 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#323010:u8
        let s_9_0: bool = fn_state.gs_323010;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_45: call execute_aarch32_instrs_VUZP_Op_A_txt(s_10_26, s_10_44, s_10_42, s_10_4)
        let s_10_45: () = execute_aarch32_instrs_VUZP_Op_A_txt(
            state,
            tracer,
            s_10_26,
            s_10_44,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_22: write-var gs#323009 <= s_13_21
        fn_state.gs_323009 = s_13_21;
        // N s_13_23: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#323009:u8
        let s_14_0: bool = fn_state.gs_323009;
        // D s_14_1: write-var gs#323010 <= s_14_0
        fn_state.gs_323010 = s_14_0;
        // N s_14_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#323009 <= s_15_0
        fn_state.gs_323009 = s_15_0;
        // N s_15_2: jump b14
        return block_14(state, tracer, fn_state);
    }
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_5: write-var gs#323003 <= s_17_4
        fn_state.gs_323003 = s_17_4;
        // N s_17_6: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#323004 <= s_18_0
        fn_state.gs_323004 = s_18_0;
        // N s_18_2: jump b6
        return block_6(state, tracer, fn_state);
    }
}
