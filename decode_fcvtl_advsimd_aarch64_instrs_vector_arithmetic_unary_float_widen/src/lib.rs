...
extern crate alloc;
use u__id::*;
use execute_aarch64_instrs_vector_arithmetic_unary_float_widen::*;
use fdiv_int::*;
use common::*;
pub fn decode_fcvtl_advsimd_aarch64_instrs_vector_arithmetic_unary_float_widen<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, sz: bool, Q: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_4: write-var gs#151378 <= s_1_3
        fn_state.gs_151378 = s_1_3;
        // N s_1_5: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#151378:u8
        let s_2_0: bool = fn_state.gs_151378;
        ...
        // D s_2_9: call execute_aarch64_instrs_vector_arithmetic_unary_float_widen(s_2_5, s_2_4, s_2_6, s_2_3, s_2_7, s_2_8)
        let s_2_9: () = execute_aarch64_instrs_vector_arithmetic_unary_float_widen(
            state,
            tracer,
            s_2_5,
            s_2_4,
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_0: const #1u : u8
        let s_3_0: bool = true;
        // D s_3_1: write-var gs#151378 <= s_3_0
        fn_state.gs_151378 = s_3_0;
        // N s_3_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
