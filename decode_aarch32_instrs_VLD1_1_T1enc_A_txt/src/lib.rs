...
use common::*;
pub fn decode_aarch32_instrs_VLD1_1_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Rn: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#309344 <= s_5_0
        fn_state.gs_309344 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#309344:u8
        let s_6_0: bool = fn_state.gs_309344;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: write-var gs#309344 <= s_9_3
        fn_state.gs_309344 = s_9_3;
        // N s_9_5: jump b6
        return block_6(state, tracer, fn_state);
    }
