...
extern crate alloc;
use common::*;
pub fn AArch64_AddrTop<T: Tracer>(
    state: &mut State,
    tracer: &T,
    tbid: bool,
    acctype: u32,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_0: read-var tbid:u8
        let s_0_0: bool = fn_state.tbid;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#17400 <= s_1_0
        fn_state.gs_17400 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#17400:u8
        let s_2_0: bool = fn_state.gs_17400;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var acctype:u32
        let s_8_0: u32 = fn_state.acctype;
        // C s_8_1: const #0u : u32
        let s_8_1: u32 = 0;
        // D s_8_2: cmp-eq s_8_0 s_8_1
        let s_8_2: bool = ((s_8_0) == (s_8_1));
        // D s_8_3: write-var gs#17400 <= s_8_2
        fn_state.gs_17400 = s_8_2;
        // N s_8_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
