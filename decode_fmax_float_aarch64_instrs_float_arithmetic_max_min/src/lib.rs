...
use common::*;
pub fn decode_fmax_float_aarch64_instrs_float_arithmetic_max_min<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var esizeshadow#1373 <= s_2_0
        fn_state.esizeshadow_1373 = s_2_0;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var esizeshadow#1373:i64
        let s_4_1: i64 = fn_state.esizeshadow_1373;
