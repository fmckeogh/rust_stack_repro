...
use P_set::*;
use common::*;
pub fn execute_WHILEHS_PP_RR__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d0: i64,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#219518 <= s_6_0
        fn_state.gs_219518 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#219518:u8
        let s_7_0: bool = fn_state.gs_219518;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#219518 <= s_11_0
        fn_state.gs_219518 = s_11_0;
        // N s_11_2: jump b7
        return block_7(state, tracer, fn_state);
    }
