...
use R_set::*;
use common::*;
pub fn JOSCR_SysRegRead32_64dbf044d539336d<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_2: call __get_JOSCR(s_5_1)
        let s_5_2: u32 = u__get_JOSCR(state, tracer, s_5_1);
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call __get_JOSCR(s_6_1)
        let s_6_2: u32 = u__get_JOSCR(state, tracer, s_6_1);
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_2: call __get_JOSCR(s_7_1)
        let s_7_2: u32 = u__get_JOSCR(state, tracer, s_7_1);
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #"JOSCR UNDEFINED at EL0" : str
        let s_8_0: &'static str = "JOSCR UNDEFINED at EL0";
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_2: call __get_JOSCR(s_9_1)
        let s_9_2: u32 = u__get_JOSCR(state, tracer, s_9_1);
