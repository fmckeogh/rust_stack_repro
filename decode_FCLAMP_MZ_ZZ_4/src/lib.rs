...
extern crate alloc;
use execute_FCLAMP_MZ_ZZ_4::*;
use CurrentVL_read::*;
use HaveSME2::*;
use common::*;
pub fn decode_FCLAMP_MZ_ZZ_4<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Zm: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_8: call execute_FCLAMP_MZ_ZZ_4(s_2_0, s_2_5, s_2_3, s_2_6, s_2_7, s_2_4)
        let s_2_8: () = execute_FCLAMP_MZ_ZZ_4(
            state,
            tracer,
            s_2_0,
            s_2_5,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_8: call execute_FCLAMP_MZ_ZZ_4(s_4_0, s_4_5, s_4_3, s_4_6, s_4_7, s_4_4)
        let s_4_8: () = execute_FCLAMP_MZ_ZZ_4(
            state,
            tracer,
            s_4_0,
            s_4_5,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_8: call execute_FCLAMP_MZ_ZZ_4(s_6_0, s_6_5, s_6_3, s_6_6, s_6_7, s_6_4)
        let s_6_8: () = execute_FCLAMP_MZ_ZZ_4(
            state,
            tracer,
            s_6_0,
            s_6_5,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_8: call execute_FCLAMP_MZ_ZZ_4(s_8_0, s_8_5, s_8_3, s_8_6, s_8_7, s_8_4)
        let s_8_8: () = execute_FCLAMP_MZ_ZZ_4(
            state,
            tracer,
            s_8_0,
            s_8_5,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_8: call execute_FCLAMP_MZ_ZZ_4(s_10_0, s_10_5, s_10_3, s_10_6, s_10_7, s_10_4)
        let s_10_8: () = execute_FCLAMP_MZ_ZZ_4(
            state,
            tracer,
            s_10_0,
            s_10_5,
