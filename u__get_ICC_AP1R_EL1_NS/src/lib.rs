...
use common::*;
pub fn u__get_ICC_AP1R_EL1_NS<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #9223372032559808512u : u64
        let s_0_3: u64 = 9223372032559808512;
        ...
        // D s_0_11: tail-call Mk_ICC_AP1R_EL1_Type(s_0_10)
        return Mk_ICC_AP1R_EL1_Type(state, tracer, s_0_10);
    }
}
