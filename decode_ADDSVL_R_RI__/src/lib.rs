...
extern crate alloc;
use CurrentSVL_read::*;
use execute_ADDSVL_R_RI__::*;
use HaveSME::*;
use common::*;
pub fn decode_ADDSVL_R_RI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    imm6: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_5: call execute_ADDSVL_R_RI__(s_2_0, s_2_3, s_2_2, s_2_4)
        let s_2_5: () = execute_ADDSVL_R_RI__(state, tracer, s_2_0, s_2_3, s_2_2, s_2_4);
        // N s_2_6: return
        return;
    }
    fn block_3<T: Tracer>(
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_5: call execute_ADDSVL_R_RI__(s_4_0, s_4_3, s_4_2, s_4_4)
        let s_4_5: () = execute_ADDSVL_R_RI__(state, tracer, s_4_0, s_4_3, s_4_2, s_4_4);
        // N s_4_6: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: call execute_ADDSVL_R_RI__(s_6_0, s_6_3, s_6_2, s_6_4)
        let s_6_5: () = execute_ADDSVL_R_RI__(state, tracer, s_6_0, s_6_3, s_6_2, s_6_4);
        // N s_6_6: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_5: call execute_ADDSVL_R_RI__(s_8_0, s_8_3, s_8_2, s_8_4)
        let s_8_5: () = execute_ADDSVL_R_RI__(state, tracer, s_8_0, s_8_3, s_8_2, s_8_4);
        // N s_8_6: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: call execute_ADDSVL_R_RI__(s_10_0, s_10_3, s_10_2, s_10_4)
        let s_10_5: () = execute_ADDSVL_R_RI__(
            state,
            tracer,
            s_10_0,
            s_10_3,
