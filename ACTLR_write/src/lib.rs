...
use common::*;
pub fn ACTLR_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#35336 <= s_1_0
        fn_state.gs_35336 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#35336:u8
        let s_2_0: bool = fn_state.gs_35336;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: call ACTLR_NS_write(s_3_0)
        let s_3_1: () = ACTLR_NS_write(state, tracer, s_3_0);
        // N s_3_2: return
        return;
    }
    fn block_4<T: Tracer>(
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#35336 <= s_5_3
        fn_state.gs_35336 = s_5_3;
        // N s_5_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
