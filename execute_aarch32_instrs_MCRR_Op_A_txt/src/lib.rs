...
extern crate alloc;
use AArch32_SysRegWrite64::*;
use ThisInstr::*;
use common::*;
pub fn execute_aarch32_instrs_MCRR_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cp: i64,
    t: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_8: call AArch32_SysRegWrite64(s_0_3, s_0_1, s_0_5, s_0_7)
        let s_0_8: () = AArch32_SysRegWrite64(state, tracer, s_0_3, s_0_1, s_0_5, s_0_7);
        // N s_0_9: return
        return;
    }
}
