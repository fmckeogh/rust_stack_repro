...
use ALUWritePC::*;
use common::*;
pub fn execute_aarch32_instrs_SBC_r_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        gs_883423: ProductTyped54bc449dd09e5bd,
        result: u32,
        nzcv: u8,
        d: i64,
        m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_18: cast zx s_0_12 -> bv
        let s_0_18: Bits = Bits::new(s_0_12 as u128, 32u16);
        // D s_0_19: cast zx s_0_15 -> bv
        let s_0_19: Bits = Bits::new(s_0_15 as u128, 32u16);
        // D s_0_20: call AddWithCarry(s_0_18, s_0_19, s_0_17)
        let s_0_20: ProductTyped54bc449dd09e5bd = AddWithCarry(
            state,
            tracer,
            s_0_18,
            s_0_19,
        ...
        // D s_0_21: write-var gs#883423 <= s_0_20
        fn_state.gs_883423 = s_0_20;
        // D s_0_22: read-var gs#883423.0:struct
        let s_0_22: Bits = fn_state.gs_883423._0;
        // D s_0_23: cast reint s_0_22 -> u32
        let s_0_23: u32 = (s_0_22.value() as u32);
        // D s_0_24: read-var gs#883423.1:struct
        let s_0_24: u8 = fn_state.gs_883423._1;
        // D s_0_25: write-var result <= s_0_23
        fn_state.result = s_0_23;
        // D s_0_26: write-var nzcv <= s_0_24
        fn_state.nzcv = s_0_24;
        // C s_0_27: const #15s : i
        let s_0_27: i128 = 15;
        // D s_0_28: read-var d:i64
        let s_0_28: i64 = fn_state.d;
        // D s_0_29: cast zx s_0_28 -> i
        let s_0_29: i128 = (i128::try_from(s_0_28).unwrap());
        // D s_0_30: cmp-eq s_0_29 s_0_27
        let s_0_30: bool = ((s_0_29) == (s_0_27));
        // N s_0_31: branch s_0_30 b4 b1
        if s_0_30 {
