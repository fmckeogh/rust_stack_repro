...
use ALUWritePC::*;
use common::*;
pub fn execute_aarch32_instrs_RSC_r_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        gs_883071: ProductTyped54bc449dd09e5bd,
        result: u32,
        nzcv: u8,
        d: i64,
        m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_19: cast zx s_0_9 -> bv
        let s_0_19: Bits = Bits::new(s_0_9 as u128, 32u16);
        ...
        // D s_0_21: write-var gs#883071 <= s_0_20
        fn_state.gs_883071 = s_0_20;
        // D s_0_22: read-var gs#883071.0:struct
        let s_0_22: Bits = fn_state.gs_883071._0;
        // D s_0_23: cast reint s_0_22 -> u32
        let s_0_23: u32 = (s_0_22.value() as u32);
        // D s_0_24: read-var gs#883071.1:struct
        let s_0_24: u8 = fn_state.gs_883071._1;
