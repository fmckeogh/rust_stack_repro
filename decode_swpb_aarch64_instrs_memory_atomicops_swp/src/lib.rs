...
use common::*;
pub fn decode_swpb_aarch64_instrs_memory_atomicops_swp<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 32;
        // D s_2_1: write-var ga#269788 <= s_2_0
        fn_state.ga_269788 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#269788:i64
        let s_3_0: i64 = fn_state.ga_269788;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#173770 <= s_4_0
        fn_state.gs_173770 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#173770:u8
        let s_5_0: bool = fn_state.gs_173770;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: write-var gs#173770 <= s_6_4
        fn_state.gs_173770 = s_6_4;
        // N s_6_6: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_7<T: Tracer>(
        ...
        let s_7_0: i64 = 64;
        // D s_7_1: write-var ga#269788 <= s_7_0
        fn_state.ga_269788 = s_7_0;
        // N s_7_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
