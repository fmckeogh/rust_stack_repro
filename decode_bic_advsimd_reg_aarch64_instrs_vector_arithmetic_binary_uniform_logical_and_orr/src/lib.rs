...
use common::*;
pub fn decode_bic_advsimd_reg_aarch64_instrs_vector_arithmetic_binary_uniform_logical_and_orr<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, Rm: u8, size: u8, Q: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#249446 <= s_1_0
        fn_state.ga_249446 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#249446:i64
        let s_2_0: i64 = fn_state.ga_249446;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 128;
        // D s_6_1: write-var ga#249446 <= s_6_0
        fn_state.ga_249446 = s_6_0;
        // N s_6_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
