...
use common::*;
pub fn AFSR1_EL2_SysRegWrite_a63eac436b30cded<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#80125 <= s_8_0
        fn_state.gs_80125 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#80125:u8
        let s_9_0: bool = fn_state.gs_80125;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#80125 <= s_12_4
        fn_state.gs_80125 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
