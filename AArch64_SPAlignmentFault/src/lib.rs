...
use common::*;
pub fn AArch64_SPAlignmentFault<T: Tracer>(
    state: &mut State,
    tracer: &T,
    gs_15804: (),
) -> () {
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_15: write-var target_el <= s_0_14
        fn_state.target_el = s_0_14;
        ...
        // D s_0_26: cast zx s_0_20 -> i
        let s_0_26: i128 = (i128::try_from(s_0_20).unwrap());
        // D s_0_27: cast zx s_0_25 -> i
        let s_0_27: i128 = (i128::try_from(s_0_25).unwrap());
        // D s_0_28: cmp-gt s_0_26 s_0_27
        let s_0_28: bool = ((s_0_26) > (s_0_27));
        // N s_0_29: branch s_0_28 b8 b1
        if s_0_28 {
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var gs#15808 <= s_2_0
        fn_state.gs_15808 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#15808:u8
        let s_3_0: bool = fn_state.gs_15808;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_7: write-var gs#15808 <= s_7_6
        fn_state.gs_15808 = s_7_6;
        // N s_7_8: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
