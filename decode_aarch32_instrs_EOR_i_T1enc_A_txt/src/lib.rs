...
use ConditionPassed::*;
use T32ExpandImm_C::*;
use execute_aarch32_instrs_EOR_i_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_EOR_i_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i: bool,
    S: bool,
    ...
    struct FunctionState {
        ...
        gs_296605: bool,
        n: i64,
        ga_343619: ProductType4813027798de1e98,
        d: i64,
        i: bool,
        S: bool,
        Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#296605 <= s_3_0
        fn_state.gs_296605 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#296605:u8
        let s_4_0: bool = fn_state.gs_296605;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_44: write-var ga#343619 <= s_5_43
        fn_state.ga_343619 = s_5_43;
        // D s_5_45: read-var ga#343619.0:struct
        let s_5_45: u32 = fn_state.ga_343619._0;
        // D s_5_46: read-var ga#343619.1:struct
        let s_5_46: bool = fn_state.ga_343619._1;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#296613 <= s_6_0
        fn_state.gs_296613 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#296613:u8
        let s_7_0: bool = fn_state.gs_296613;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: write-var gs#296615 <= s_8_3
        fn_state.gs_296615 = s_8_3;
        // N s_8_5: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#296615:u8
        let s_9_0: bool = fn_state.gs_296615;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: call execute_aarch32_instrs_EOR_i_Op_A_txt(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4)
        let s_10_5: () = execute_aarch32_instrs_EOR_i_Op_A_txt(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#296615 <= s_12_0
        fn_state.gs_296615 = s_12_0;
        // N s_12_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_2: write-var gs#296613 <= s_13_1
        fn_state.gs_296613 = s_13_1;
        // N s_13_3: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_5: write-var gs#296605 <= s_15_4
        fn_state.gs_296605 = s_15_4;
        // N s_15_6: jump b4
        return block_4(state, tracer, fn_state);
    }
}
