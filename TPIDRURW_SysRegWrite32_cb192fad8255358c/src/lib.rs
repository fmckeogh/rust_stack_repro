...
use u_get_HFGWTR_EL2_Type_TPIDR_EL0::*;
use R_read::*;
use ELUsingAArch32::*;
use TPIDRURW_NS_write::*;
use EL2Enabled::*;
use u_get_HCR_EL2_Type_TGE::*;
use AArch32_TakeHypTrapException::*;
use common::*;
pub fn TPIDRURW_SysRegWrite32_cb192fad8255358c<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_17: call _get_HFGWTR_EL2_Type_TPIDR_EL0(s_0_16)
        let s_0_17: bool = u_get_HFGWTR_EL2_Type_TPIDR_EL0(state, tracer, s_0_16);
        // D s_0_18: write-var __HFGWTR_EL2_TPIDR_EL0 <= s_0_17
        fn_state.u__HFGWTR_EL2_TPIDR_EL0 = s_0_17;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call TPIDRURW_NS_write(s_6_1)
        let s_6_2: () = TPIDRURW_NS_write(state, tracer, s_6_1);
        // N s_6_3: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#134314 <= s_9_0
        fn_state.gs_134314 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#134314:u8
        let s_10_0: bool = fn_state.gs_134314;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_2: call TPIDRURW_write(s_11_1)
        let s_11_2: () = TPIDRURW_write(state, tracer, s_11_1);
        // N s_11_3: return
        return;
    }
    fn block_12<T: Tracer>(
        ...
        // D s_12_2: call TPIDRURW_NS_write(s_12_1)
        let s_12_2: () = TPIDRURW_NS_write(state, tracer, s_12_1);
        // N s_12_3: return
        return;
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_3: write-var gs#134314 <= s_13_2
        fn_state.gs_134314 = s_13_2;
        // N s_13_4: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#134315 <= s_15_0
        fn_state.gs_134315 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#134315:u8
        let s_16_0: bool = fn_state.gs_134315;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#134316 <= s_17_0
        fn_state.gs_134316 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#134316:u8
        let s_18_0: bool = fn_state.gs_134316;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#134317 <= s_20_0
        fn_state.gs_134317 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#134317:u8
        let s_21_0: bool = fn_state.gs_134317;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#134318 <= s_22_0
        fn_state.gs_134318 = s_22_0;
        // N s_22_2: jump b23
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_0: read-var gs#134318:u8
        let s_23_0: bool = fn_state.gs_134318;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#134319 <= s_25_0
        fn_state.gs_134319 = s_25_0;
        // N s_25_2: jump b26
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var gs#134319:u8
        let s_26_0: bool = fn_state.gs_134319;
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_2: call TPIDRURW_write(s_27_1)
        let s_27_2: () = TPIDRURW_write(state, tracer, s_27_1);
        // N s_27_3: return
        return;
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_2: call TPIDRURW_NS_write(s_28_1)
        let s_28_2: () = TPIDRURW_NS_write(state, tracer, s_28_1);
        // N s_28_3: return
        return;
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_3: write-var gs#134319 <= s_29_2
        fn_state.gs_134319 = s_29_2;
        // N s_29_4: jump b26
        return block_26(state, tracer, fn_state);
    }
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_5: write-var gs#134318 <= s_31_4
        fn_state.gs_134318 = s_31_4;
        // N s_31_6: jump b23
        return block_23(state, tracer, fn_state);
    }
    fn block_32<T: Tracer>(
        ...
        // D s_32_3: write-var gs#134317 <= s_32_2
        fn_state.gs_134317 = s_32_2;
        // N s_32_4: jump b21
        return block_21(state, tracer, fn_state);
    }
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_5: write-var gs#134316 <= s_34_4
        fn_state.gs_134316 = s_34_4;
        // N s_34_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    fn block_35<T: Tracer>(
        ...
        // D s_35_4: write-var gs#134315 <= s_35_3
        fn_state.gs_134315 = s_35_3;
        // N s_35_5: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_1: write-var gs#134320 <= s_37_0
        fn_state.gs_134320 = s_37_0;
        // N s_37_2: jump b38
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_0: read-var gs#134320:u8
        let s_38_0: bool = fn_state.gs_134320;
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_1: write-var gs#134321 <= s_39_0
        fn_state.gs_134321 = s_39_0;
        // N s_39_2: jump b40
    ...
    fn block_40<T: Tracer>(
        ...
        // D s_40_0: read-var gs#134321:u8
        let s_40_0: bool = fn_state.gs_134321;
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_1: write-var gs#134322 <= s_41_0
        fn_state.gs_134322 = s_41_0;
        // N s_41_2: jump b42
    ...
    fn block_42<T: Tracer>(
        ...
        // D s_42_0: read-var gs#134322:u8
        let s_42_0: bool = fn_state.gs_134322;
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_1: write-var gs#134323 <= s_44_0
        fn_state.gs_134323 = s_44_0;
        // N s_44_2: jump b45
    ...
    fn block_45<T: Tracer>(
        ...
        // D s_45_0: read-var gs#134323:u8
        let s_45_0: bool = fn_state.gs_134323;
    ...
    fn block_46<T: Tracer>(
        ...
        // D s_46_1: write-var gs#134324 <= s_46_0
        fn_state.gs_134324 = s_46_0;
        // N s_46_2: jump b47
    ...
    fn block_47<T: Tracer>(
        ...
        // D s_47_0: read-var gs#134324:u8
        let s_47_0: bool = fn_state.gs_134324;
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_1: write-var gs#134325 <= s_49_0
        fn_state.gs_134325 = s_49_0;
        // N s_49_2: jump b50
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_0: read-var gs#134325:u8
        let s_50_0: bool = fn_state.gs_134325;
    ...
    fn block_51<T: Tracer>(
        ...
        // D s_51_1: write-var gs#134326 <= s_51_0
        fn_state.gs_134326 = s_51_0;
        // N s_51_2: jump b52
    ...
    fn block_52<T: Tracer>(
        ...
        // D s_52_0: read-var gs#134326:u8
        let s_52_0: bool = fn_state.gs_134326;
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_1: write-var gs#134327 <= s_53_0
        fn_state.gs_134327 = s_53_0;
        // N s_53_2: jump b54
    ...
    fn block_54<T: Tracer>(
        ...
        // D s_54_0: read-var gs#134327:u8
        let s_54_0: bool = fn_state.gs_134327;
    ...
    fn block_55<T: Tracer>(
        ...
        // D s_55_1: write-var gs#134329 <= s_55_0
        fn_state.gs_134329 = s_55_0;
        // N s_55_2: jump b56
    ...
    fn block_56<T: Tracer>(
        ...
        // D s_56_0: read-var gs#134329:u8
        let s_56_0: bool = fn_state.gs_134329;
    ...
    fn block_57<T: Tracer>(
        ...
        // D s_57_1: write-var gs#134330 <= s_57_0
        fn_state.gs_134330 = s_57_0;
        // N s_57_2: jump b58
    ...
    fn block_58<T: Tracer>(
        ...
        // D s_58_0: read-var gs#134330:u8
        let s_58_0: bool = fn_state.gs_134330;
    ...
    fn block_59<T: Tracer>(
        ...
        // D s_59_2: call TPIDRURW_write(s_59_1)
        let s_59_2: () = TPIDRURW_write(state, tracer, s_59_1);
        // N s_59_3: return
        return;
    }
    ...
    fn block_61<T: Tracer>(
        ...
        // D s_61_0: read-var __HFGWTR_EL2_TPIDR_EL0:u8
        let s_61_0: bool = fn_state.u__HFGWTR_EL2_TPIDR_EL0;
        ...
        // D s_61_5: write-var gs#134330 <= s_61_4
        fn_state.gs_134330 = s_61_4;
        // N s_61_6: jump b58
        return block_58(state, tracer, fn_state);
    }
    ...
    fn block_63<T: Tracer>(
        ...
        // D s_63_5: write-var gs#134328 <= s_63_4
        fn_state.gs_134328 = s_63_4;
        // N s_63_6: jump b64
    ...
    fn block_64<T: Tracer>(
        ...
        // D s_64_0: read-var gs#134328:u8
        let s_64_0: bool = fn_state.gs_134328;
        // D s_64_1: write-var gs#134329 <= s_64_0
        fn_state.gs_134329 = s_64_0;
        // N s_64_2: jump b56
        return block_56(state, tracer, fn_state);
    }
    fn block_65<T: Tracer>(
        ...
        // D s_65_1: write-var gs#134328 <= s_65_0
        fn_state.gs_134328 = s_65_0;
        // N s_65_2: jump b64
        return block_64(state, tracer, fn_state);
    }
    fn block_66<T: Tracer>(
        ...
        // D s_66_2: write-var gs#134327 <= s_66_1
        fn_state.gs_134327 = s_66_1;
        // N s_66_3: jump b54
        return block_54(state, tracer, fn_state);
    }
    fn block_67<T: Tracer>(
        ...
        // D s_67_21: write-var gs#134326 <= s_67_20
        fn_state.gs_134326 = s_67_20;
        // N s_67_22: jump b52
        return block_52(state, tracer, fn_state);
    }
    fn block_68<T: Tracer>(
        ...
        // D s_68_4: write-var gs#134325 <= s_68_3
        fn_state.gs_134325 = s_68_3;
        // N s_68_5: jump b50
        return block_50(state, tracer, fn_state);
    }
    ...
    fn block_70<T: Tracer>(
        ...
        // D s_70_5: write-var gs#134324 <= s_70_4
        fn_state.gs_134324 = s_70_4;
        // N s_70_6: jump b47
        return block_47(state, tracer, fn_state);
    }
    fn block_71<T: Tracer>(
        ...
        // D s_71_3: write-var gs#134323 <= s_71_2
        fn_state.gs_134323 = s_71_2;
        // N s_71_4: jump b45
        return block_45(state, tracer, fn_state);
    }
    ...
    fn block_73<T: Tracer>(
        ...
        // D s_73_5: write-var gs#134322 <= s_73_4
        fn_state.gs_134322 = s_73_4;
        // N s_73_6: jump b42
        return block_42(state, tracer, fn_state);
    }
    fn block_74<T: Tracer>(
        ...
        // D s_74_21: write-var gs#134321 <= s_74_20
        fn_state.gs_134321 = s_74_20;
        // N s_74_22: jump b40
        return block_40(state, tracer, fn_state);
    }
    fn block_75<T: Tracer>(
        ...
        // D s_75_4: write-var gs#134320 <= s_75_3
        fn_state.gs_134320 = s_75_3;
        // N s_75_5: jump b38
        return block_38(state, tracer, fn_state);
    }
}
