...
use MemAtomicRCW::*;
use common::*;
pub fn execute_aarch64_instrs_memory_rcw_cas_128<T: Tracer>(
    state: &mut State,
    tracer: &T,
    acquire: bool,
    n: i64,
    ...
    struct FunctionState {
        ...
        t1: u64,
        s2: u64,
        gs_708141: ProductType42c31f3d0ab6eb17,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_7: write-var gs#708141 <= s_7_6
        fn_state.gs_708141 = s_7_6;
        // N s_7_8: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#708141.0:struct
        let s_8_0: u8 = fn_state.gs_708141._0;
        // D s_8_1: read-var gs#708141.1:struct
        let s_8_1: Bits = fn_state.gs_708141._1;
