...
use HaveSME::*;
use CurrentVL_read::*;
use execute_ST1W_Z_P_BI__::*;
use common::*;
pub fn decode_ST1W_Z_P_BI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    msz: u8,
    sz: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#246612 <= s_1_0
        fn_state.gs_246612 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#246612:u8
        let s_2_0: bool = fn_state.gs_246612;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_19: const #32s : i64
        let s_3_19: i64 = 32;
        // D s_3_20: lsl s_3_19 s_3_18
        let s_3_20: i64 = s_3_19 << s_3_18;
        // D s_3_21: write-var esize <= s_3_20
        fn_state.esize = s_3_20;
        // D s_3_22: read-var imm4:u8
        let s_3_22: u8 = fn_state.imm4;
        ...
        // D s_3_26: write-var offset <= s_3_25
        fn_state.offset = s_3_25;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_10: call execute_ST1W_Z_P_BI__(s_4_0, s_4_3, s_4_7, s_4_4, s_4_8, s_4_6, s_4_9)
        let s_4_10: () = execute_ST1W_Z_P_BI__(
            state,
            tracer,
            s_4_0,
            s_4_3,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_10: call execute_ST1W_Z_P_BI__(s_6_0, s_6_3, s_6_7, s_6_4, s_6_8, s_6_6, s_6_9)
        let s_6_10: () = execute_ST1W_Z_P_BI__(
            state,
            tracer,
            s_6_0,
            s_6_3,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_10: call execute_ST1W_Z_P_BI__(s_8_0, s_8_3, s_8_7, s_8_4, s_8_8, s_8_6, s_8_9)
        let s_8_10: () = execute_ST1W_Z_P_BI__(
            state,
            tracer,
            s_8_0,
            s_8_3,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_10: call execute_ST1W_Z_P_BI__(s_10_0, s_10_3, s_10_7, s_10_4, s_10_8, s_10_6, s_10_9)
        let s_10_10: () = execute_ST1W_Z_P_BI__(
            state,
            tracer,
            s_10_0,
            s_10_3,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_9: read-var t:i64
        let s_12_9: i64 = fn_state.t;
        // D s_12_10: call execute_ST1W_Z_P_BI__(s_12_0, s_12_3, s_12_7, s_12_4, s_12_8, s_12_6, s_12_9)
        let s_12_10: () = execute_ST1W_Z_P_BI__(
            state,
            tracer,
            s_12_0,
            s_12_3,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#246612 <= s_15_2
        fn_state.gs_246612 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
