...
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_binary_uniform_div_fp16<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    datasize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#1363 <= s_0_2
        fn_state.esizeshadow_1363 = s_0_2;
        ...
        // D s_0_7: write-var datasizeshadow#1364 <= s_0_6
        fn_state.datasizeshadow_1364 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var datasizeshadow#1364:i64
        let s_1_0: i64 = fn_state.datasizeshadow_1364;
        ...
        // D s_1_7: read-var datasizeshadow#1364:i64
        let s_1_7: i64 = fn_state.datasizeshadow_1364;
        ...
        // D s_1_19: write-var gs#152232 <= s_1_18
        fn_state.gs_152232 = s_1_18;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#152232:i64
        let s_2_1: i64 = fn_state.gs_152232;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var esizeshadow#1363:i64
        let s_3_0: i64 = fn_state.esizeshadow_1363;
        ...
        // D s_3_8: read-var esizeshadow#1363:i64
        let s_3_8: i64 = fn_state.esizeshadow_1363;
        ...
        // D s_3_16: read-var esizeshadow#1363:i64
        let s_3_16: i64 = fn_state.esizeshadow_1363;
        ...
        // D s_3_19: write-var ga#254969 <= s_3_18
        fn_state.ga_254969 = s_3_18;
        // C s_3_20: const #() : ()
        let s_3_20: () = ();
        // S s_3_21: call FPCR_read(s_3_20)
        let s_3_21: ProductType5c790c8ef59cc8b2 = FPCR_read(state, tracer, s_3_20);
        // D s_3_22: call FPDiv(s_3_7, s_3_15, s_3_21)
        let s_3_22: Bits = FPDiv(state, tracer, s_3_7, s_3_15, s_3_21);
        // D s_3_23: write-var ga#254970 <= s_3_22
        fn_state.ga_254970 = s_3_22;
        // N s_3_24: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: read-var ga#254969:i64
        let s_4_2: i64 = fn_state.ga_254969;
        // D s_4_3: cast zx s_4_2 -> i
        let s_4_3: i128 = (i128::try_from(s_4_2).unwrap());
        // D s_4_4: read-var result:bv
        let s_4_4: Bits = fn_state.result;
        // D s_4_5: read-var ga#254970:bv
        let s_4_5: Bits = fn_state.ga_254970;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var datasizeshadow#1364:i64
        let s_5_0: i64 = fn_state.datasizeshadow_1364;
