...
extern crate alloc;
use HaveSM3Ext::*;
use execute_aarch64_instrs_vector_crypto_sm3_sm3tt2a::*;
use common::*;
pub fn decode_sm3tt2a_advsimd_aarch64_instrs_vector_crypto_sm3_sm3tt2a<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_0: const #() : ()
        let s_0_0: () = ();
        // S s_0_1: call HaveSM3Ext(s_0_0)
        let s_0_1: bool = HaveSM3Ext(state, tracer, s_0_0);
        // S s_0_2: not s_0_1
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_12: read-var imm2:u8
        let s_1_12: u8 = fn_state.imm2;
        ...
        // D s_1_16: call execute_aarch64_instrs_vector_crypto_sm3_sm3tt2a(s_1_3, s_1_15, s_1_11, s_1_7)
        let s_1_16: () = execute_aarch64_instrs_vector_crypto_sm3_sm3tt2a(
            state,
            tracer,
            s_1_3,
            s_1_15,
