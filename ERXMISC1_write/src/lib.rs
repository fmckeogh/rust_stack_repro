...
extern crate alloc;
use common::*;
pub fn ERXMISC1_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #22600u : u32
        let s_0_23: u32 = 22600;
        ...
        // C s_0_25: const #10224u : u32
        let s_0_25: u32 = 10224;
