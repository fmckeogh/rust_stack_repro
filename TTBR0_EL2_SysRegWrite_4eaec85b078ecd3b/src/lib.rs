...
use common::*;
pub fn TTBR0_EL2_SysRegWrite_4eaec85b078ecd3b<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_147586: ProductType782ac6922b48c20d,
        u__HCR_EL2_E2H: bool,
        gs_96918: bool,
        gs_96917: bool,
        ...
        gs_96913: bool,
        gs_96914: bool,
        ga_147607: ProductType782ac6922b48c20d,
        ga_147594: ProductType782ac6922b48c20d,
        u__PSTATE_EL: u8,
        u__HFGWTR_EL2_TTBR0_EL1: bool,
        ga_147600: ProductType782ac6922b48c20d,
        gs_96916: bool,
        el: u8,
        op0: u8,
        op1: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_13: call _get_HFGWTR_EL2_Type_TTBR0_EL1(s_0_12)
        let s_0_13: bool = u_get_HFGWTR_EL2_Type_TTBR0_EL1(state, tracer, s_0_12);
        // D s_0_14: write-var __HFGWTR_EL2_TTBR0_EL1 <= s_0_13
        fn_state.u__HFGWTR_EL2_TTBR0_EL1 = s_0_13;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_2: write-var ga#147607 <= s_5_1
        fn_state.ga_147607 = s_5_1;
        // D s_5_3: read-var ga#147607.0:struct
        let s_5_3: u128 = fn_state.ga_147607._0;
        ...
        // D s_5_23: call Mk_TTBR0_EL1_Type(s_5_22)
        let s_5_23: ProductType782ac6922b48c20d = Mk_TTBR0_EL1_Type(
            state,
            tracer,
            s_5_22,
        );
        // D s_5_24: call TTBR0_EL1_write(s_5_23)
        let s_5_24: () = TTBR0_EL1_write(state, tracer, s_5_23);
        // N s_5_25: return
        return;
    }
    fn block_6<T: Tracer>(
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #() : ()
        let s_7_0: () = ();
        // S s_7_1: call TTBR0_EL1_read(s_7_0)
        let s_7_1: ProductType782ac6922b48c20d = TTBR0_EL1_read(state, tracer, s_7_0);
        // D s_7_2: write-var ga#147600 <= s_7_1
        fn_state.ga_147600 = s_7_1;
        // D s_7_3: read-var ga#147600.0:struct
        let s_7_3: u128 = fn_state.ga_147600._0;
        ...
        // D s_7_23: call Mk_TTBR0_EL1_Type(s_7_22)
        let s_7_23: ProductType782ac6922b48c20d = Mk_TTBR0_EL1_Type(
            state,
            tracer,
            s_7_22,
        );
        // D s_7_24: call TTBR0_EL1_write(s_7_23)
        let s_7_24: () = TTBR0_EL1_write(state, tracer, s_7_23);
        // N s_7_25: return
        return;
    }
    fn block_8<T: Tracer>(
        ...
        // D s_8_2: write-var ga#147594 <= s_8_1
        fn_state.ga_147594 = s_8_1;
        // D s_8_3: read-var ga#147594.0:struct
        let s_8_3: u128 = fn_state.ga_147594._0;
        // C s_8_4: const #64s : i64
        let s_8_4: i64 = 64;
        // D s_8_5: read-var t:i
        let s_8_5: i128 = fn_state.t;
        // D s_8_6: call X_read(s_8_5, s_8_4)
        let s_8_6: Bits = X_read(state, tracer, s_8_5, s_8_4);
        // D s_8_7: cast reint s_8_6 -> u64
        let s_8_7: u64 = (s_8_6.value() as u64);
        // C s_8_8: const #0s : i
        let s_8_8: i128 = 0;
        // D s_8_9: cast zx s_8_3 -> bv
        let s_8_9: Bits = Bits::new(s_8_3 as u128, 128u16);
        // D s_8_10: cast zx s_8_7 -> bv
        let s_8_10: Bits = Bits::new(s_8_7 as u128, 64u16);
        // C s_8_11: const #63s : i
        let s_8_11: i128 = 63;
        ...
        // D s_8_17: lsl s_8_16 s_8_8
        let s_8_17: Bits = s_8_16 << s_8_8;
        // C s_8_18: lsl s_8_15 s_8_8
        let s_8_18: Bits = s_8_15 << s_8_8;
        ...
        // D s_8_23: call Mk_TTBR0_EL2_Type(s_8_22)
        let s_8_23: ProductType782ac6922b48c20d = Mk_TTBR0_EL2_Type(
            state,
            tracer,
            s_8_22,
        );
        // D s_8_24: call TTBR0_EL2_write(s_8_23)
        let s_8_24: () = TTBR0_EL2_write(state, tracer, s_8_23);
        // N s_8_25: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#96913 <= s_10_0
        fn_state.gs_96913 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#96913:u8
        let s_11_0: bool = fn_state.gs_96913;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#96914 <= s_13_0
        fn_state.gs_96914 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#96914:u8
        let s_14_0: bool = fn_state.gs_96914;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#96916 <= s_15_0
        fn_state.gs_96916 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#96916:u8
        let s_16_0: bool = fn_state.gs_96916;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#96917 <= s_17_0
        fn_state.gs_96917 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#96917:u8
        let s_18_0: bool = fn_state.gs_96917;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#96918 <= s_20_0
        fn_state.gs_96918 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#96918:u8
        let s_21_0: bool = fn_state.gs_96918;
    ...
    fn block_22<T: Tracer>(
        ...
        // C s_22_0: const #() : ()
        let s_22_0: () = ();
        // S s_22_1: call TTBR0_EL1_read(s_22_0)
        let s_22_1: ProductType782ac6922b48c20d = TTBR0_EL1_read(state, tracer, s_22_0);
        // D s_22_2: write-var ga#147586 <= s_22_1
        fn_state.ga_147586 = s_22_1;
        // D s_22_3: read-var ga#147586.0:struct
        let s_22_3: u128 = fn_state.ga_147586._0;
        ...
        // D s_22_23: call Mk_TTBR0_EL1_Type(s_22_22)
        let s_22_23: ProductType782ac6922b48c20d = Mk_TTBR0_EL1_Type(
            state,
            tracer,
            s_22_22,
        );
        // D s_22_24: call TTBR0_EL1_write(s_22_23)
        let s_22_24: () = TTBR0_EL1_write(state, tracer, s_22_23);
        // N s_22_25: return
        return;
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_35: write-var gs#96918 <= s_24_34
        fn_state.gs_96918 = s_24_34;
        // N s_24_36: jump b21
        return block_21(state, tracer, fn_state);
    }
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var __HFGWTR_EL2_TTBR0_EL1:u8
        let s_26_0: bool = fn_state.u__HFGWTR_EL2_TTBR0_EL1;
        ...
        // D s_26_5: write-var gs#96917 <= s_26_4
        fn_state.gs_96917 = s_26_4;
        // N s_26_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_5: write-var gs#96915 <= s_28_4
        fn_state.gs_96915 = s_28_4;
        // N s_28_6: jump b29
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_0: read-var gs#96915:u8
        let s_29_0: bool = fn_state.gs_96915;
        // D s_29_1: write-var gs#96916 <= s_29_0
        fn_state.gs_96916 = s_29_0;
        // N s_29_2: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_1: write-var gs#96915 <= s_30_0
        fn_state.gs_96915 = s_30_0;
        // N s_30_2: jump b29
        return block_29(state, tracer, fn_state);
    }
    fn block_31<T: Tracer>(
        ...
        // D s_31_2: write-var gs#96914 <= s_31_1
        fn_state.gs_96914 = s_31_1;
        // N s_31_3: jump b14
        return block_14(state, tracer, fn_state);
    }
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_5: write-var gs#96913 <= s_33_4
        fn_state.gs_96913 = s_33_4;
        // N s_33_6: jump b11
        return block_11(state, tracer, fn_state);
    }
