...
use Mk_ICH_VTR_Type::*;
use common::*;
pub fn u__get_ICH_VTR<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #32s : i
        let s_0_3: i128 = 32;
        // C s_0_4: const #262112u : u20
        let s_0_4: u32 = 262112;
        ...
        // D s_0_15: tail-call Mk_ICH_VTR_Type(s_0_14)
        return Mk_ICH_VTR_Type(state, tracer, s_0_14);
    }
}
