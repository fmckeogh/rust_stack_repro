...
use common::*;
pub fn decode_blr_aarch64_instrs_branch_unconditional_register<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rm: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#144679 <= s_1_0
        fn_state.gs_144679 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#144679:u8
        let s_2_0: bool = fn_state.gs_144679;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#144681 <= s_3_0
        fn_state.gs_144681 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#144681:u8
        let s_4_0: bool = fn_state.gs_144681;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#144689 <= s_6_0
        fn_state.gs_144689 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#144689:u8
        let s_7_0: bool = fn_state.gs_144689;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var branch_typeshadow#1098 <= s_10_0
        fn_state.branch_typeshadow_1098 = s_10_0;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: read-var branch_typeshadow#1098:u32
        let s_12_1: u32 = fn_state.branch_typeshadow_1098;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#144692 <= s_14_0
        fn_state.gs_144692 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#144692:u8
        let s_15_0: bool = fn_state.gs_144692;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var branch_typeshadow#1098:u32
        let s_16_0: u32 = fn_state.branch_typeshadow_1098;
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_4: write-var gs#144692 <= s_23_3
        fn_state.gs_144692 = s_23_3;
        // N s_23_5: jump b15
        return block_15(state, tracer, fn_state);
    }
    ...
    fn block_30<T: Tracer>(
        ...
        // D s_30_3: write-var gs#144689 <= s_30_2
        fn_state.gs_144689 = s_30_2;
        // N s_30_4: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_4: write-var gs#144681 <= s_32_3
        fn_state.gs_144681 = s_32_3;
        // N s_32_5: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_33<T: Tracer>(
        ...
        // D s_33_4: write-var gs#144679 <= s_33_3
        fn_state.gs_144679 = s_33_3;
        // N s_33_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
