...
use common::*;
pub fn decode_ummla_advsimd_vec_aarch64_instrs_vector_arithmetic_binary_uniform_mat_mul_int_mla<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, B: bool, Rm: u8, U: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_13: write-var ga#266990 <= s_1_12
        fn_state.ga_266990 = s_1_12;
        // D s_1_14: read-var ga#266990:u8
        let s_1_14: u8 = fn_state.ga_266990;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#266990:u8
        let s_4_0: u8 = fn_state.ga_266990;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#266990:u8
        let s_6_0: u8 = fn_state.ga_266990;
