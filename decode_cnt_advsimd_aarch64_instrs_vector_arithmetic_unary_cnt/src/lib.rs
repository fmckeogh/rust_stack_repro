...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_unary_cnt::*;
use common::*;
pub fn decode_cnt_advsimd_aarch64_instrs_vector_arithmetic_unary_cnt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 64;
        // D s_2_1: write-var ga#251399 <= s_2_0
        fn_state.ga_251399 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#251399:i64
        let s_3_0: i64 = fn_state.ga_251399;
        // C s_3_1: const #8s : i
        let s_3_1: i128 = 8;
        ...
        // C s_3_7: const #8s : i64
        let s_3_7: i64 = 8;
        // D s_3_8: read-var d:i64
        let s_3_8: i64 = fn_state.d;
        // D s_3_9: read-var n:i64
        let s_3_9: i64 = fn_state.n;
        // D s_3_10: call execute_aarch64_instrs_vector_arithmetic_unary_cnt(s_3_8, s_3_6, s_3_4, s_3_7, s_3_9)
        let s_3_10: () = execute_aarch64_instrs_vector_arithmetic_unary_cnt(
            state,
            tracer,
            s_3_8,
            s_3_6,
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 128;
        // D s_4_1: write-var ga#251399 <= s_4_0
        fn_state.ga_251399 = s_4_0;
        // N s_4_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_5<T: Tracer>(
