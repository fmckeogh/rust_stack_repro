...
use Z_set::*;
use common::*;
pub fn execute_BEXT_Z_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#4121 <= s_0_2
        fn_state.esizeshadow_4121 = s_0_2;
        ...
        // D s_0_7: write-var VLshadow#4122 <= s_0_6
        fn_state.VLshadow_4122 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#4122:i64
        let s_1_0: i64 = fn_state.VLshadow_4122;
        // D s_1_1: write-var VLshadow#4123 <= s_1_0
        fn_state.VLshadow_4123 = s_1_0;
        // D s_1_2: read-var VLshadow#4123:i64
        let s_1_2: i64 = fn_state.VLshadow_4123;
        // D s_1_3: cast zx s_1_2 -> i
        let s_1_3: i128 = (i128::try_from(s_1_2).unwrap());
        // D s_1_4: read-var esizeshadow#4121:i64
        let s_1_4: i64 = fn_state.esizeshadow_4121;
        ...
        // D s_1_8: read-var VLshadow#4123:i64
        let s_1_8: i64 = fn_state.VLshadow_4123;
        ...
        // D s_1_15: write-var data <= s_1_14
        fn_state.data = s_1_14;
        // D s_1_16: read-var VLshadow#4123:i64
        let s_1_16: i64 = fn_state.VLshadow_4123;
        ...
        // D s_1_23: write-var mask <= s_1_22
        fn_state.mask = s_1_22;
        ...
        // D s_1_29: write-var gs#216411 <= s_1_28
        fn_state.gs_216411 = s_1_28;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#216411:i64
        let s_2_1: i64 = fn_state.gs_216411;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var esizeshadow#4121:i64
        let s_3_0: i64 = fn_state.esizeshadow_4121;
        // D s_3_1: cast zx s_3_0 -> i
        let s_3_1: i128 = (i128::try_from(s_3_0).unwrap());
        // D s_3_2: cast reint s_3_1 -> i64
        let s_3_2: i64 = (s_3_1 as i64);
        // D s_3_3: read-var esizeshadow#4121:i64
        let s_3_3: i64 = fn_state.esizeshadow_4121;
        ...
        // D s_3_9: read-var data:bv
        let s_3_9: Bits = fn_state.data;
        // D s_3_10: call Elem_read(s_3_9, s_3_7, s_3_8)
        let s_3_10: Bits = Elem_read(state, tracer, s_3_9, s_3_7, s_3_8);
        // D s_3_11: read-var esizeshadow#4121:i64
        let s_3_11: i64 = fn_state.esizeshadow_4121;
        ...
        // D s_3_17: read-var mask:bv
        let s_3_17: Bits = fn_state.mask;
        // D s_3_18: call Elem_read(s_3_17, s_3_15, s_3_16)
        let s_3_18: Bits = Elem_read(state, tracer, s_3_17, s_3_15, s_3_16);
        // D s_3_19: call BitExtract(s_3_10, s_3_18)
        let s_3_19: Bits = BitExtract(state, tracer, s_3_10, s_3_18);
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#4123:i64
        let s_4_0: i64 = fn_state.VLshadow_4123;
