...
extern crate alloc;
use execute_SUNPK_MZ_Z_2::*;
use CurrentVL_read::*;
use HaveSME2::*;
use common::*;
pub fn decode_SUNPK_MZ_Z_2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Zn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        fn_state.d = s_2_27;
        // D s_2_29: read-var VL:i64
        let s_2_29: i64 = fn_state.VL;
        // C s_2_30: const #128s : i
        let s_2_30: i128 = 128;
        // D s_2_31: cast zx s_2_29 -> i
        let s_2_31: i128 = (i128::try_from(s_2_29).unwrap());
        // D s_2_32: cmp-eq s_2_31 s_2_30
        let s_2_32: bool = ((s_2_31) == (s_2_30));
        // D s_2_33: not s_2_32
        let s_2_33: bool = !s_2_32;
        // N s_2_34: branch s_2_33 b4 b3
        if s_2_33 {
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_8: call execute_SUNPK_MZ_Z_2(s_3_0, s_3_5, s_3_3, s_3_6, s_3_4, s_3_7)
        let s_3_8: () = execute_SUNPK_MZ_Z_2(
            state,
            tracer,
            s_3_0,
            s_3_5,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_8: call execute_SUNPK_MZ_Z_2(s_5_0, s_5_5, s_5_3, s_5_6, s_5_4, s_5_7)
        let s_5_8: () = execute_SUNPK_MZ_Z_2(
            state,
            tracer,
            s_5_0,
            s_5_5,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_8: call execute_SUNPK_MZ_Z_2(s_7_0, s_7_5, s_7_3, s_7_6, s_7_4, s_7_7)
        let s_7_8: () = execute_SUNPK_MZ_Z_2(
            state,
            tracer,
            s_7_0,
            s_7_5,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_8: call execute_SUNPK_MZ_Z_2(s_9_0, s_9_5, s_9_3, s_9_6, s_9_4, s_9_7)
        let s_9_8: () = execute_SUNPK_MZ_Z_2(
            state,
            tracer,
            s_9_0,
            s_9_5,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_8: call execute_SUNPK_MZ_Z_2(s_11_0, s_11_5, s_11_3, s_11_6, s_11_4, s_11_7)
        let s_11_8: () = execute_SUNPK_MZ_Z_2(
            state,
            tracer,
            s_11_0,
            s_11_5,
