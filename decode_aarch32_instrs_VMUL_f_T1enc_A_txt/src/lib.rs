...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_VMUL_f_Op_A_txt::*;
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_VMUL_f_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    sz: bool,
    ...
    struct FunctionState {
        m: i64,
        elementsshadow_7579: i64,
        esizeshadow_7578: i64,
        esize: i64,
        gs_313630: bool,
        n: i64,
        gs_313626: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#313621 <= s_3_0
        fn_state.gs_313621 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#313621:u8
        let s_4_0: bool = fn_state.gs_313621;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#313630 <= s_6_0
        fn_state.gs_313630 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#313630:u8
        let s_7_0: bool = fn_state.gs_313630;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var esizeshadow#7578 <= s_10_0
        fn_state.esizeshadow_7578 = s_10_0;
        // D s_10_2: read-var elements:i64
        let s_10_2: i64 = fn_state.elements;
        // D s_10_3: write-var elementsshadow#7579 <= s_10_2
        fn_state.elementsshadow_7579 = s_10_2;
    ...
    fn block_11<T: Tracer>(
        ...
        let s_11_0: i64 = 2;
        // D s_11_1: write-var ga#356731 <= s_11_0
        fn_state.ga_356731 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var ga#356731:i64
        let s_12_0: i64 = fn_state.ga_356731;
        // D s_12_1: read-var esizeshadow#7578:i64
        let s_12_1: i64 = fn_state.esizeshadow_7578;
        ...
        // D s_12_4: read-var elementsshadow#7579:i64
        let s_12_4: i64 = fn_state.elementsshadow_7579;
        ...
        // D s_12_11: call execute_aarch32_instrs_VMUL_f_Op_A_txt(s_12_7, s_12_8, s_12_5, s_12_3, s_12_9, s_12_10, s_12_6)
        let s_12_11: () = execute_aarch32_instrs_VMUL_f_Op_A_txt(
            state,
            tracer,
            s_12_7,
            s_12_8,
    ...
    fn block_13<T: Tracer>(
        ...
        let s_13_0: i64 = 1;
        // D s_13_1: write-var ga#356731 <= s_13_0
        fn_state.ga_356731 = s_13_0;
        // N s_13_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    ...
    fn block_17<T: Tracer>(
        ...
        // C s_17_0: const #0s : i
        let s_17_0: i128 = 0;
        // D s_17_1: read-var Vn:u8
        let s_17_1: u8 = fn_state.Vn;
        ...
        // D s_17_22: write-var gs#313626 <= s_17_21
        fn_state.gs_313626 = s_17_21;
        // N s_17_23: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#313626:u8
        let s_18_0: bool = fn_state.gs_313626;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_22: write-var gs#313629 <= s_19_21
        fn_state.gs_313629 = s_19_21;
        // N s_19_23: jump b20
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_0: read-var gs#313629:u8
        let s_20_0: bool = fn_state.gs_313629;
        // D s_20_1: write-var gs#313630 <= s_20_0
        fn_state.gs_313630 = s_20_0;
        // N s_20_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#313629 <= s_21_0
        fn_state.gs_313629 = s_21_0;
        // N s_21_2: jump b20
        return block_20(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#313626 <= s_22_0
        fn_state.gs_313626 = s_22_0;
        // N s_22_2: jump b18
        return block_18(state, tracer, fn_state);
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_2: write-var gs#313621 <= s_24_1
        fn_state.gs_313621 = s_24_1;
        // N s_24_3: jump b4
        return block_4(state, tracer, fn_state);
    }
}
