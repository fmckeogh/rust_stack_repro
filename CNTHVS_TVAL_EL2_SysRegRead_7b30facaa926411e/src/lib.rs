...
extern crate alloc;
use u__get_CNTHVS_TVAL_EL2::*;
use X_set::*;
use u__UNKNOWN_bits::*;
use u_get_HCR_EL2_Type_NV::*;
use Mk_CNTHVS_TVAL_EL2_Type::*;
...
use EL2Enabled::*;
use common::*;
pub fn CNTHVS_TVAL_EL2_SysRegRead_7b30facaa926411e<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_55984: ProductType5c790c8ef59cc8b2,
        u__CNTHVS_CTL_EL2_ENABLE: bool,
        u__PSTATE_EL: u8,
        gs_57875: bool,
        ga_55970: ProductType5c790c8ef59cc8b2,
        u__HCR_EL2_NV: bool,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_9: call _get_CNTHVS_CTL_EL2_Type_ENABLE(s_0_8)
        let s_0_9: bool = u_get_CNTHVS_CTL_EL2_Type_ENABLE(state, tracer, s_0_8);
        // D s_0_10: write-var __CNTHVS_CTL_EL2_ENABLE <= s_0_9
        fn_state.u__CNTHVS_CTL_EL2_ENABLE = s_0_9;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var __CNTHVS_CTL_EL2_ENABLE:u8
        let s_6_0: bool = fn_state.u__CNTHVS_CTL_EL2_ENABLE;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_9: call Mk_CNTHVS_TVAL_EL2_Type(s_7_8)
        let s_7_9: ProductType5c790c8ef59cc8b2 = Mk_CNTHVS_TVAL_EL2_Type(
            state,
            tracer,
            s_7_8,
        );
        // D s_7_10: call __get_CNTHVS_TVAL_EL2(s_7_9)
        let s_7_10: ProductType5c790c8ef59cc8b2 = u__get_CNTHVS_TVAL_EL2(
            state,
            tracer,
            s_7_9,
        );
        // D s_7_11: write-var ga#55984 <= s_7_10
        fn_state.ga_55984 = s_7_10;
        // D s_7_12: read-var ga#55984.0:struct
        let s_7_12: u64 = fn_state.ga_55984._0;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var __CNTHVS_CTL_EL2_ENABLE:u8
        let s_11_0: bool = fn_state.u__CNTHVS_CTL_EL2_ENABLE;
    ...
    fn block_12<T: Tracer>(
        ...
        let s_12_0: i64 = 64;
        // C s_12_1: const #10064u : u32
        let s_12_1: u32 = 10064;
        ...
        // D s_12_9: call Mk_CNTHVS_TVAL_EL2_Type(s_12_8)
        let s_12_9: ProductType5c790c8ef59cc8b2 = Mk_CNTHVS_TVAL_EL2_Type(
            state,
            tracer,
            s_12_8,
        );
        // D s_12_10: call __get_CNTHVS_TVAL_EL2(s_12_9)
        let s_12_10: ProductType5c790c8ef59cc8b2 = u__get_CNTHVS_TVAL_EL2(
            state,
            tracer,
            s_12_9,
        );
        // D s_12_11: write-var ga#55970 <= s_12_10
        fn_state.ga_55970 = s_12_10;
        // D s_12_12: read-var ga#55970.0:struct
        let s_12_12: u64 = fn_state.ga_55970._0;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#57875 <= s_17_0
        fn_state.gs_57875 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#57875:u8
        let s_18_0: bool = fn_state.gs_57875;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_5: write-var gs#57875 <= s_21_4
        fn_state.gs_57875 = s_21_4;
        // N s_21_6: jump b18
        return block_18(state, tracer, fn_state);
    }
