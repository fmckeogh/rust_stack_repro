...
use HaveTME::*;
use common::*;
pub fn CreateAccDescGPR<T: Tracer>(
    state: &mut State,
    tracer: &T,
    memop: u32,
    nontemporal: bool,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_12: read-var tagchecked:u8
        let s_2_12: bool = fn_state.tagchecked;
        // D s_2_13: write-var accdesc.28 <= s_2_12
        fn_state.accdesc._28 = s_2_12;
        // C s_2_14: const #() : ()
        let s_2_14: () = ();
        // S s_2_15: call HaveTME(s_2_14)
        let s_2_15: bool = HaveTME(state, tracer, s_2_14);
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#7186 <= s_3_0
        fn_state.gs_7186 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#7186:u8
        let s_4_0: bool = fn_state.gs_7186;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#7186 <= s_5_3
        fn_state.gs_7186 = s_5_3;
        // N s_5_5: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_6<T: Tracer>(
