...
use common::*;
pub fn decode_fminv_advsimd_aarch64_instrs_vector_reduce_fp16_max_simd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#255434 <= s_1_0
        fn_state.ga_255434 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#255434:i64
        let s_2_0: i64 = fn_state.ga_255434;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 128;
        // D s_6_1: write-var ga#255434 <= s_6_0
        fn_state.ga_255434 = s_6_0;
        // N s_6_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
