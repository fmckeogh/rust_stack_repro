...
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_RSB_i_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    Rd: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_11: i128 = 32;
        // S s_2_12: call Zeros(s_2_11)
        let s_2_12: Bits = Zeros(state, tracer, s_2_11);
        // S s_2_13: cast reint s_2_12 -> u32
        let s_2_13: u32 = (s_2_12.value() as u32);
        // D s_2_14: call execute_aarch32_instrs_RSB_i_Op_A_txt(s_2_3, s_2_13, s_2_7, s_2_10)
        let s_2_14: () = execute_aarch32_instrs_RSB_i_Op_A_txt(
            state,
            tracer,
            s_2_3,
            s_2_13,
