...
use u__get_CNTHP_CTL::*;
use R_set::*;
use common::*;
pub fn CNTHP_CTL_SysRegRead32_5ea09b260a579171<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    struct FunctionState {
        u__SCR_NS: bool,
        ga_166546: ProductType700c18a878c5601b,
        ga_166540: ProductType700c18a878c5601b,
        u__PSTATE_EL: u8,
        el: u8,
        coproc: u8,
        opc1: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #() : ()
        let s_6_0: () = ();
        // S s_6_1: call CNTHP_CTL_read(s_6_0)
        let s_6_1: ProductType700c18a878c5601b = CNTHP_CTL_read(state, tracer, s_6_0);
        // S s_6_2: call __get_CNTHP_CTL(s_6_1)
        let s_6_2: ProductType700c18a878c5601b = u__get_CNTHP_CTL(state, tracer, s_6_1);
        // D s_6_3: write-var ga#166546 <= s_6_2
        fn_state.ga_166546 = s_6_2;
        // D s_6_4: read-var ga#166546.0:struct
        let s_6_4: u32 = fn_state.ga_166546._0;
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #() : ()
        let s_8_0: () = ();
        // S s_8_1: call CNTHP_CTL_read(s_8_0)
        let s_8_1: ProductType700c18a878c5601b = CNTHP_CTL_read(state, tracer, s_8_0);
        // S s_8_2: call __get_CNTHP_CTL(s_8_1)
        let s_8_2: ProductType700c18a878c5601b = u__get_CNTHP_CTL(state, tracer, s_8_1);
        // D s_8_3: write-var ga#166540 <= s_8_2
        fn_state.ga_166540 = s_8_2;
        // D s_8_4: read-var ga#166540.0:struct
        let s_8_4: u32 = fn_state.ga_166540._0;
