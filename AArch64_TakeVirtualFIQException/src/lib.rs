...
use common::*;
pub fn AArch64_TakeVirtualFIQException<T: Tracer>(
    state: &mut State,
    tracer: &T,
    gs_25271: (),
) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_7: write-var gs#25272 <= s_1_6
        fn_state.gs_25272 = s_1_6;
        // N s_1_8: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#25272:u8
        let s_2_0: bool = fn_state.gs_25272;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#25273 <= s_3_0
        fn_state.gs_25273 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#25273:u8
        let s_4_0: bool = fn_state.gs_25273;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#25274 <= s_5_0
        fn_state.gs_25274 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#25274:u8
        let s_6_0: bool = fn_state.gs_25274;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_2: call _get_HCR_EL2_Type_FMO(s_7_1)
        let s_7_2: bool = u_get_HCR_EL2_Type_FMO(state, tracer, s_7_1);
        ...
        // D s_7_7: write-var gs#25274 <= s_7_6
        fn_state.gs_25274 = s_7_6;
        // N s_7_8: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
        ...
        // D s_8_2: write-var gs#25273 <= s_8_1
        fn_state.gs_25273 = s_8_1;
        // N s_8_3: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#25272 <= s_9_0
        fn_state.gs_25272 = s_9_0;
        // N s_9_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
