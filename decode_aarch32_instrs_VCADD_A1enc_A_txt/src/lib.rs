...
use fdiv_int::*;
use common::*;
pub fn decode_aarch32_instrs_VCADD_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    rot: bool,
    D: bool,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var gs#326528 <= s_2_0
        fn_state.gs_326528 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#326528:u8
        let s_3_0: bool = fn_state.gs_326528;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 2;
        // D s_5_1: write-var ga#366744 <= s_5_0
        fn_state.ga_366744 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#366744:i64
        let s_6_0: i64 = fn_state.ga_366744;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#326544 <= s_7_3
        fn_state.gs_326544 = s_7_3;
        // N s_7_5: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#326544:u8
        let s_8_0: bool = fn_state.gs_326544;
        ...
        let s_8_9: bool = fn_state.rot;
        // D s_8_10: call execute_aarch32_instrs_VCADD_Op_A_txt(s_8_4, s_8_5, s_8_3, s_8_6, s_8_7, s_8_8, s_8_9)
        let s_8_10: () = execute_aarch32_instrs_VCADD_Op_A_txt(
            state,
            tracer,
            s_8_4,
            s_8_5,
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#326544 <= s_9_0
        fn_state.gs_326544 = s_9_0;
        // N s_9_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 1;
        // D s_10_1: write-var ga#366744 <= s_10_0
        fn_state.ga_366744 = s_10_0;
        // N s_10_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_22: write-var gs#326524 <= s_13_21
        fn_state.gs_326524 = s_13_21;
        // N s_13_23: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#326524:u8
        let s_14_0: bool = fn_state.gs_326524;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_22: write-var gs#326527 <= s_15_21
        fn_state.gs_326527 = s_15_21;
        // N s_15_23: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#326527:u8
        let s_16_0: bool = fn_state.gs_326527;
        // D s_16_1: write-var gs#326528 <= s_16_0
        fn_state.gs_326528 = s_16_0;
        // N s_16_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#326527 <= s_17_0
        fn_state.gs_326527 = s_17_0;
        // N s_17_2: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#326524 <= s_18_0
        fn_state.gs_326524 = s_18_0;
        // N s_18_2: jump b14
        return block_14(state, tracer, fn_state);
    }
