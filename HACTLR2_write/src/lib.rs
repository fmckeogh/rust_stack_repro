...
extern crate alloc;
use common::*;
pub fn HACTLR2_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #10616u : u32
        let s_0_23: u32 = 10616;
        ...
        // C s_0_25: const #22944u : u32
        let s_0_25: u32 = 22944;
