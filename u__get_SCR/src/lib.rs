...
pub fn u__get_SCR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4294921216u : u32
        let s_0_3: u32 = 4294921216;
        ...
        // D s_0_11: tail-call Mk_SCR_Type(s_0_10)
        return Mk_SCR_Type(state, tracer, s_0_10);
    }
}
