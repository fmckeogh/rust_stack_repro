...
use common::*;
pub fn decode_pmul_advsimd_aarch64_instrs_vector_arithmetic_binary_uniform_mul_int_product<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#165461 <= s_1_0
        fn_state.gs_165461 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#165461:u8
        let s_2_0: bool = fn_state.gs_165461;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // D s_5_1: write-var ga#263717 <= s_5_0
        fn_state.ga_263717 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#263717:i64
        let s_6_0: i64 = fn_state.ga_263717;
    ...
    fn block_7<T: Tracer>(
        ...
        let s_7_0: i64 = 128;
        // D s_7_1: write-var ga#263717 <= s_7_0
        fn_state.ga_263717 = s_7_0;
        // N s_7_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: write-var gs#165461 <= s_10_4
        fn_state.gs_165461 = s_10_4;
        // N s_10_6: jump b2
        return block_2(state, tracer, fn_state);
    }
}
