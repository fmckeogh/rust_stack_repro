...
use Mk_TCR_EL1_Type::*;
use common::*;
pub fn u__get_TCR_EL1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #13835058089641902080u : u64
        let s_0_3: u64 = 13835058089641902080;
        ...
        // D s_0_11: tail-call Mk_TCR_EL1_Type(s_0_10)
        return Mk_TCR_EL1_Type(state, tracer, s_0_10);
    }
}
