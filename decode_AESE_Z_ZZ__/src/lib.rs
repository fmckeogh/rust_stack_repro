...
use HaveSVE2AES::*;
use CurrentVL_read::*;
use execute_AESE_Z_ZZ__::*;
use common::*;
pub fn decode_AESE_Z_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Zm: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // C s_1_0: const #() : ()
        let s_1_0: () = ();
        // S s_1_1: call HaveSVE2AES(s_1_0)
        let s_1_1: bool = HaveSVE2AES(state, tracer, s_1_0);
        // S s_1_2: not s_1_1
        let s_1_2: bool = !s_1_1;
        // D s_1_3: write-var gs#217846 <= s_1_2
        fn_state.gs_217846 = s_1_2;
        // N s_1_4: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#217846:u8
        let s_2_0: bool = fn_state.gs_217846;
    ...
    fn block_3<T: Tracer>(
        ...
        fn_state.m = s_3_3;
        // D s_3_5: read-var Zdn:u8
        let s_3_5: u8 = fn_state.Zdn;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_3: call execute_AESE_Z_ZZ__(s_4_0, s_4_1, s_4_2)
        let s_4_3: () = execute_AESE_Z_ZZ__(state, tracer, s_4_0, s_4_1, s_4_2);
        // N s_4_4: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call execute_AESE_Z_ZZ__(s_6_0, s_6_1, s_6_2)
        let s_6_3: () = execute_AESE_Z_ZZ__(state, tracer, s_6_0, s_6_1, s_6_2);
        // N s_6_4: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_3: call execute_AESE_Z_ZZ__(s_8_0, s_8_1, s_8_2)
        let s_8_3: () = execute_AESE_Z_ZZ__(state, tracer, s_8_0, s_8_1, s_8_2);
        // N s_8_4: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_3: call execute_AESE_Z_ZZ__(s_10_0, s_10_1, s_10_2)
        let s_10_3: () = execute_AESE_Z_ZZ__(state, tracer, s_10_0, s_10_1, s_10_2);
        // N s_10_4: return
        return;
    }
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_3: call execute_AESE_Z_ZZ__(s_12_0, s_12_1, s_12_2)
        let s_12_3: () = execute_AESE_Z_ZZ__(state, tracer, s_12_0, s_12_1, s_12_2);
        // N s_12_4: return
        return;
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#217846 <= s_15_0
        fn_state.gs_217846 = s_15_0;
        // N s_15_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
