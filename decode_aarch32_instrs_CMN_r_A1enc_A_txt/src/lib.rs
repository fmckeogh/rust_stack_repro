...
use common::*;
pub fn decode_aarch32_instrs_CMN_r_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    Rn: u8,
    ...
    struct FunctionState {
        ga_343455: ProductType396b95aa74979079,
        cond: u8,
        Rn: u8,
        imm5: u8,
        stype: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_17: write-var ga#343455 <= s_2_16
        fn_state.ga_343455 = s_2_16;
        // D s_2_18: read-var ga#343455.0:struct
        let s_2_18: u32 = fn_state.ga_343455._0;
        // D s_2_19: read-var ga#343455.1:struct
        let s_2_19: i128 = fn_state.ga_343455._1;
        // D s_2_20: call execute_aarch32_instrs_CMN_r_Op_A_txt(s_2_13, s_2_9, s_2_19, s_2_18)
        let s_2_20: () = execute_aarch32_instrs_CMN_r_Op_A_txt(
            state,
            tracer,
            s_2_13,
            s_2_9,
