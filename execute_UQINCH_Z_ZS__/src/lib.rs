...
use Z_set::*;
use common::*;
pub fn execute_UQINCH_Z_ZS__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    dn: i64,
    ...
    struct FunctionState {
        ...
        result: Bits,
        operand1: Bits,
        gs_742757: ProductTypef506aa96a892fe52,
        VL: i64,
        dn: i64,
        esize: i64,
        imm: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#2752 <= s_0_2
        fn_state.VLshadow_2752 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#2752:i64
        let s_1_0: i64 = fn_state.VLshadow_2752;
        // D s_1_1: write-var VLshadow#2753 <= s_1_0
        fn_state.VLshadow_2753 = s_1_0;
        // D s_1_2: read-var VLshadow#2753:i64
        let s_1_2: i64 = fn_state.VLshadow_2753;
        ...
        // D s_1_13: read-var VLshadow#2753:i64
        let s_1_13: i64 = fn_state.VLshadow_2753;
        ...
        // D s_1_26: write-var gs#192232 <= s_1_25
        fn_state.gs_192232 = s_1_25;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#192232:i64
        let s_2_1: i64 = fn_state.gs_192232;
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_9: Bits = Bits::new(s_3_8 as u128, 16u16);
        ...
        // D s_3_23: write-var gs#742757 <= s_3_22
        fn_state.gs_742757 = s_3_22;
        // D s_3_24: read-var gs#742757.0:struct
        let s_3_24: Bits = fn_state.gs_742757._0;
        // D s_3_25: cast reint s_3_24 -> u16
        let s_3_25: u16 = (s_3_24.value() as u16);
        // D s_3_26: cast zx s_3_25 -> bv
        let s_3_26: Bits = Bits::new(s_3_25 as u128, 16u16);
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#2753:i64
        let s_4_0: i64 = fn_state.VLshadow_2753;
