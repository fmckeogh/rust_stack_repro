...
use AddWithCarry::*;
use common::*;
pub fn execute_aarch32_instrs_SBC_i_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    imm32: u32,
    ...
    struct FunctionState {
        gs_883382: ProductTyped54bc449dd09e5bd,
        result: u32,
        nzcv: u8,
        d: i64,
        imm32: u32,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_7: const #16971u : u32
        let s_0_7: u32 = 16971;
        // D s_0_8: read-reg s_0_7:u8
        let s_0_8: bool = {
            let value = state.read_register::<bool>(s_0_7 as isize);
            tracer.read_register(s_0_7 as isize, value);
            value
        };
        // D s_0_9: cast zx s_0_2 -> bv
        let s_0_9: Bits = Bits::new(s_0_2 as u128, 32u16);
        // D s_0_10: cast zx s_0_6 -> bv
        let s_0_10: Bits = Bits::new(s_0_6 as u128, 32u16);
        // D s_0_11: call AddWithCarry(s_0_9, s_0_10, s_0_8)
        let s_0_11: ProductTyped54bc449dd09e5bd = AddWithCarry(
            state,
            tracer,
            s_0_9,
            s_0_10,
        ...
        // D s_0_12: write-var gs#883382 <= s_0_11
        fn_state.gs_883382 = s_0_11;
        // D s_0_13: read-var gs#883382.0:struct
        let s_0_13: Bits = fn_state.gs_883382._0;
        // D s_0_14: cast reint s_0_13 -> u32
        let s_0_14: u32 = (s_0_13.value() as u32);
        // D s_0_15: read-var gs#883382.1:struct
        let s_0_15: u8 = fn_state.gs_883382._1;
        // D s_0_16: write-var result <= s_0_14
        fn_state.result = s_0_14;
        // D s_0_17: write-var nzcv <= s_0_15
        fn_state.nzcv = s_0_15;
