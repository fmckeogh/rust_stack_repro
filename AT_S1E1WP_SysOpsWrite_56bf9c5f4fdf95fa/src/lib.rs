...
use X_read::*;
use EL2Enabled::*;
use u_get_HFGITR_EL2_Type_ATS1E1WP::*;
use u_get_HCR_EL2_Type_AT::*;
use common::*;
pub fn AT_S1E1WP_SysOpsWrite_56bf9c5f4fdf95fa<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_5: call _get_HCR_EL2_Type_AT(s_0_4)
        let s_0_5: bool = u_get_HCR_EL2_Type_AT(state, tracer, s_0_4);
        // D s_0_6: write-var __HCR_EL2_AT <= s_0_5
        fn_state.u__HCR_EL2_AT = s_0_5;
        ...
        // D s_0_13: call _get_HFGITR_EL2_Type_ATS1E1WP(s_0_12)
        let s_0_13: bool = u_get_HFGITR_EL2_Type_ATS1E1WP(state, tracer, s_0_12);
        // D s_0_14: write-var __HFGITR_EL2_ATS1E1WP <= s_0_13
        fn_state.u__HFGITR_EL2_ATS1E1WP = s_0_13;
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_7: const #3u : u32
        let s_5_7: u32 = 3;
        // D s_5_8: call AArch64_AT(s_5_3, s_5_4, s_5_6, s_5_7)
        let s_5_8: () = AArch64_AT(state, tracer, s_5_3, s_5_4, s_5_6, s_5_7);
        // N s_5_9: return
        return;
    }
    fn block_6<T: Tracer>(
        ...
        // C s_6_7: const #3u : u32
        let s_6_7: u32 = 3;
        // D s_6_8: call AArch64_AT(s_6_3, s_6_4, s_6_6, s_6_7)
        let s_6_8: () = AArch64_AT(state, tracer, s_6_3, s_6_4, s_6_6, s_6_7);
        // N s_6_9: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#101239 <= s_8_0
        fn_state.gs_101239 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#101239:u8
        let s_9_0: bool = fn_state.gs_101239;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#101240 <= s_11_0
        fn_state.gs_101240 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#101240:u8
        let s_12_0: bool = fn_state.gs_101240;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#101242 <= s_13_0
        fn_state.gs_101242 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#101242:u8
        let s_14_0: bool = fn_state.gs_101242;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#101243 <= s_15_0
        fn_state.gs_101243 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#101243:u8
        let s_16_0: bool = fn_state.gs_101243;
    ...
    fn block_17<T: Tracer>(
        ...
        // C s_17_7: const #3u : u32
        let s_17_7: u32 = 3;
        // D s_17_8: call AArch64_AT(s_17_3, s_17_4, s_17_6, s_17_7)
        let s_17_8: () = AArch64_AT(state, tracer, s_17_3, s_17_4, s_17_6, s_17_7);
        // N s_17_9: return
        return;
    }
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var __HFGITR_EL2_ATS1E1WP:u8
        let s_19_0: bool = fn_state.u__HFGITR_EL2_ATS1E1WP;
        ...
        // D s_19_5: write-var gs#101243 <= s_19_4
        fn_state.gs_101243 = s_19_4;
        // N s_19_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_5: write-var gs#101241 <= s_21_4
        fn_state.gs_101241 = s_21_4;
        // N s_21_6: jump b22
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_0: read-var gs#101241:u8
        let s_22_0: bool = fn_state.gs_101241;
        // D s_22_1: write-var gs#101242 <= s_22_0
        fn_state.gs_101242 = s_22_0;
        // N s_22_2: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_23<T: Tracer>(
        ...
        // D s_23_1: write-var gs#101241 <= s_23_0
        fn_state.gs_101241 = s_23_0;
        // N s_23_2: jump b22
        return block_22(state, tracer, fn_state);
    }
    fn block_24<T: Tracer>(
        ...
        // D s_24_2: write-var gs#101240 <= s_24_1
        fn_state.gs_101240 = s_24_1;
        // N s_24_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var __HCR_EL2_AT:u8
        let s_26_0: bool = fn_state.u__HCR_EL2_AT;
        ...
        // D s_26_5: write-var gs#101239 <= s_26_4
        fn_state.gs_101239 = s_26_4;
        // N s_26_6: jump b9
        return block_9(state, tracer, fn_state);
    }
