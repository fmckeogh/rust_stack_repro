...
use common::*;
pub fn decode_fcvtau_advsimd_aarch64_instrs_vector_arithmetic_unary_float_conv_float_tieaway_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, sz: bool, U: bool) -> () {
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #1s : i
        let s_0_23: i128 = 1;
        // C s_0_24: const #4u : u32
        let s_0_24: u32 = 4;
        // D s_0_25: call execute_aarch64_instrs_vector_arithmetic_unary_fp16_conv_float_tieaway_sisd(s_0_3, s_0_20, s_0_23, s_0_22, s_0_7, s_0_24, s_0_18)
        let s_0_25: () = execute_aarch64_instrs_vector_arithmetic_unary_fp16_conv_float_tieaway_sisd(
            state,
            tracer,
            s_0_3,
            s_0_20,
