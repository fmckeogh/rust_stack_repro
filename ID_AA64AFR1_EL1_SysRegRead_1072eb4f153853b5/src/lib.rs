...
use u__get_ID_AA64AFR1_EL1::*;
use EL2Enabled::*;
use common::*;
pub fn ID_AA64AFR1_EL1_SysRegRead_1072eb4f153853b5<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call __get_ID_AA64AFR1_EL1(s_5_2)
        let s_5_3: u64 = u__get_ID_AA64AFR1_EL1(state, tracer, s_5_2);
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_ID_AA64AFR1_EL1(s_6_2)
        let s_6_3: u64 = u__get_ID_AA64AFR1_EL1(state, tracer, s_6_2);
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#62705 <= s_8_0
        fn_state.gs_62705 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#62705:u8
        let s_9_0: bool = fn_state.gs_62705;
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 64;
        // C s_10_1: const #20144u : u32
        let s_10_1: u32 = 20144;
        ...
        // D s_10_3: call __get_ID_AA64AFR1_EL1(s_10_2)
        let s_10_3: u64 = u__get_ID_AA64AFR1_EL1(state, tracer, s_10_2);
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#62705 <= s_12_4
        fn_state.gs_62705 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#62707 <= s_16_0
        fn_state.gs_62707 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#62707:u8
        let s_17_0: bool = fn_state.gs_62707;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_5: write-var gs#62707 <= s_20_4
        fn_state.gs_62707 = s_20_4;
        // N s_20_6: jump b17
        return block_17(state, tracer, fn_state);
    }
}
