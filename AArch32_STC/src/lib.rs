...
extern crate alloc;
use DBGDTRRXint_STC_521dc9133ebece9c::*;
use common::*;
pub fn AArch32_STC<T: Tracer>(
    state: &mut State,
    tracer: &T,
    coproc: u8,
    CRd: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#136984 <= s_1_0
        fn_state.gs_136984 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#136984:u8
        let s_2_0: bool = fn_state.gs_136984;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_3: call DBGDTRRXint_STC_521dc9133ebece9c(s_4_0, s_4_1, s_4_2)
        let s_4_3: () = DBGDTRRXint_STC_521dc9133ebece9c(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_5: write-var gs#136984 <= s_5_4
        fn_state.gs_136984 = s_5_4;
        // N s_5_6: jump b2
        return block_2(state, tracer, fn_state);
    }
}
