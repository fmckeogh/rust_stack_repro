...
use u__get_MPIDR_EL1::*;
use IsFeatureImplemented::*;
use AArch64_SystemAccessTrap::*;
use u_get_HCR_EL2_Type_TGE::*;
use EL2Enabled::*;
use u_get_HFGRTR_EL2_Type_MPIDR_EL1::*;
use common::*;
pub fn VMPIDR_EL2_SysRegRead_6d0c680fdfd4837e<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_100153: ProductType5c790c8ef59cc8b2,
        u__HCR_EL2_TGE: bool,
        gs_74594: bool,
        gs_74588: bool,
        gs_74591: bool,
        ga_100149: ProductType5c790c8ef59cc8b2,
        u__SCR_EL3_FGTEn: bool,
        ga_100157: ProductType5c790c8ef59cc8b2,
        u__PSTATE_EL: u8,
        u__HFGRTR_EL2_MPIDR_EL1: bool,
        ga_100146: ProductType5c790c8ef59cc8b2,
        gs_74590: bool,
        gs_74589: bool,
        el: u8,
        op0: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_13: call _get_HFGRTR_EL2_Type_MPIDR_EL1(s_0_12)
        let s_0_13: bool = u_get_HFGRTR_EL2_Type_MPIDR_EL1(state, tracer, s_0_12);
        // D s_0_14: write-var __HFGRTR_EL2_MPIDR_EL1 <= s_0_13
        fn_state.u__HFGRTR_EL2_MPIDR_EL1 = s_0_13;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call __get_MPIDR_EL1(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_MPIDR_EL1(state, tracer, s_5_2);
        // D s_5_4: write-var ga#100157 <= s_5_3
        fn_state.ga_100157 = s_5_3;
        // D s_5_5: read-var ga#100157.0:struct
        let s_5_5: u64 = fn_state.ga_100157._0;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_MPIDR_EL1(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_MPIDR_EL1(state, tracer, s_6_2);
        // D s_6_4: write-var ga#100153 <= s_6_3
        fn_state.ga_100153 = s_6_3;
        // D s_6_5: read-var ga#100153.0:struct
        let s_6_5: u64 = fn_state.ga_100153._0;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#74588 <= s_8_0
        fn_state.gs_74588 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#74588:u8
        let s_9_0: bool = fn_state.gs_74588;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#74590 <= s_10_0
        fn_state.gs_74590 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#74590:u8
        let s_11_0: bool = fn_state.gs_74590;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#74591 <= s_12_0
        fn_state.gs_74591 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#74591:u8
        let s_13_0: bool = fn_state.gs_74591;
    ...
    fn block_15<T: Tracer>(
        ...
        let s_15_0: i64 = 64;
        // C s_15_1: const #17376u : u32
        let s_15_1: u32 = 17376;
        ...
        // D s_15_3: call __get_MPIDR_EL1(s_15_2)
        let s_15_3: ProductType5c790c8ef59cc8b2 = u__get_MPIDR_EL1(
            state,
            tracer,
            s_15_2,
        );
        // D s_15_4: write-var ga#100149 <= s_15_3
        fn_state.ga_100149 = s_15_3;
        // D s_15_5: read-var ga#100149.0:struct
        let s_15_5: u64 = fn_state.ga_100149._0;
    ...
    fn block_16<T: Tracer>(
        ...
        let s_16_0: i64 = 64;
        // C s_16_1: const #20672u : u32
        let s_16_1: u32 = 20672;
        ...
        // D s_16_3: call __get_VMPIDR_EL2(s_16_2)
        let s_16_3: ProductType5c790c8ef59cc8b2 = u__get_VMPIDR_EL2(
            state,
            tracer,
            s_16_2,
        );
        // D s_16_4: write-var ga#100146 <= s_16_3
        fn_state.ga_100146 = s_16_3;
        // D s_16_5: read-var ga#100146.0:struct
        let s_16_5: u64 = fn_state.ga_100146._0;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var __HFGRTR_EL2_MPIDR_EL1:u8
        let s_18_0: bool = fn_state.u__HFGRTR_EL2_MPIDR_EL1;
        ...
        // D s_18_5: write-var gs#74591 <= s_18_4
        fn_state.gs_74591 = s_18_4;
        // N s_18_6: jump b13
        return block_13(state, tracer, fn_state);
    }
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_5: write-var gs#74589 <= s_20_4
        fn_state.gs_74589 = s_20_4;
        // N s_20_6: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#74589:u8
        let s_21_0: bool = fn_state.gs_74589;
        // D s_21_1: write-var gs#74590 <= s_21_0
        fn_state.gs_74590 = s_21_0;
        // N s_21_2: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#74589 <= s_22_0
        fn_state.gs_74589 = s_22_0;
        // N s_22_2: jump b21
        return block_21(state, tracer, fn_state);
    }
    fn block_23<T: Tracer>(
        ...
        // D s_23_2: write-var gs#74588 <= s_23_1
        fn_state.gs_74588 = s_23_1;
        // N s_23_3: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_1: write-var gs#74594 <= s_27_0
        fn_state.gs_74594 = s_27_0;
        // N s_27_2: jump b28
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_0: read-var gs#74594:u8
        let s_28_0: bool = fn_state.gs_74594;
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_5: write-var gs#74594 <= s_31_4
        fn_state.gs_74594 = s_31_4;
        // N s_31_6: jump b28
        return block_28(state, tracer, fn_state);
    }
}
