...
extern crate alloc;
use neq_int::*;
use execute_aarch64_instrs_memory_rcw_cas_128::*;
use HaveTHExt::*;
use Have128BitDescriptorExt::*;
use common::*;
pub fn decode_rcwcasp_aarch64_instrs_memory_rcw_cas_128<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_3: write-var gs#165941 <= s_1_2
        fn_state.gs_165941 = s_1_2;
        // N s_1_4: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#165941:u8
        let s_2_0: bool = fn_state.gs_165941;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_26: call execute_aarch64_instrs_memory_rcw_cas_128(s_5_17, s_5_7, s_5_22, s_5_11, s_5_12, s_5_3, s_5_25)
        let s_5_26: () = execute_aarch64_instrs_memory_rcw_cas_128(
            state,
            tracer,
            s_5_17,
            s_5_7,
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#165941 <= s_9_0
        fn_state.gs_165941 = s_9_0;
        // N s_9_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
