...
use FixedToFP::*;
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_unary_fp16_conv_int_sisd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    datasize: i64,
    ...
    struct FunctionState {
        ...
        e: i64,
        ga_265109: Bits,
        esizeshadow_1813: i64,
        datasizeshadow_1814: i64,
        rounding: u32,
        result: u128,
        gs_167523: bool,
        gs_167529: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#1813 <= s_0_2
        fn_state.esizeshadow_1813 = s_0_2;
        ...
        // D s_0_7: write-var datasizeshadow#1814 <= s_0_6
        fn_state.datasizeshadow_1814 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var datasizeshadow#1814:i64
        let s_1_0: i64 = fn_state.datasizeshadow_1814;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var gs#167523 <= s_2_0
        fn_state.gs_167523 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#167523:u8
        let s_3_0: bool = fn_state.gs_167523;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var fpcr:struct
        let s_5_0: ProductType5c790c8ef59cc8b2 = fn_state.fpcr;
        // D s_5_1: call FPRoundingMode(s_5_0)
        let s_5_1: u32 = FPRoundingMode(state, tracer, s_5_0);
        ...
        // C s_5_4: const #1s : i
        let s_5_4: i128 = 1;
        // D s_5_5: read-var elements:i
        let s_5_5: i128 = fn_state.elements;
        // D s_5_6: sub s_5_5 s_5_4
        let s_5_6: i128 = ((s_5_5) - (s_5_4));
        // D s_5_7: cast reint s_5_6 -> i64
        let s_5_7: i64 = (s_5_6 as i64);
        // D s_5_8: write-var gs#167529 <= s_5_7
        fn_state.gs_167529 = s_5_7;
        // D s_5_9: write-var e <= s_5_3
        fn_state.e = s_5_3;
        // N s_5_10: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: read-var gs#167529:i64
        let s_6_1: i64 = fn_state.gs_167529;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var esizeshadow#1813:i64
        let s_7_0: i64 = fn_state.esizeshadow_1813;
        ...
        // D s_7_8: read-var esizeshadow#1813:i64
        let s_7_8: i64 = fn_state.esizeshadow_1813;
        // D s_7_9: cast zx s_7_8 -> i
        let s_7_9: i128 = (i128::try_from(s_7_8).unwrap());
        // D s_7_10: cast reint s_7_9 -> i64
        let s_7_10: i64 = (s_7_9 as i64);
        // D s_7_11: write-var ga#265108 <= s_7_10
        fn_state.ga_265108 = s_7_10;
        // D s_7_12: read-var esizeshadow#1813:i64
        let s_7_12: i64 = fn_state.esizeshadow_1813;
        ...
        // D s_7_19: call FixedToFP(s_7_7, s_7_15, s_7_16, s_7_17, s_7_18, s_7_14)
        let s_7_19: Bits = FixedToFP(
            state,
            tracer,
            s_7_7,
            s_7_15,
        ...
        // D s_7_20: write-var ga#265109 <= s_7_19
        fn_state.ga_265109 = s_7_19;
        // N s_7_21: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: read-var ga#265108:i64
        let s_8_4: i64 = fn_state.ga_265108;
        // D s_8_5: cast zx s_8_4 -> i
        let s_8_5: i128 = (i128::try_from(s_8_4).unwrap());
        // D s_8_6: read-var ga#265109:bv
        let s_8_6: Bits = fn_state.ga_265109;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_2: write-var gs#167523 <= s_11_1
        fn_state.gs_167523 = s_11_1;
        // N s_11_3: jump b3
        return block_3(state, tracer, fn_state);
    }
}
