...
use common::*;
pub fn ICH_HCR_SysRegWrite32_391df800f72b5649<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call Mk_ICH_HCR_Type(s_6_1)
        let s_6_2: ProductType700c18a878c5601b = Mk_ICH_HCR_Type(state, tracer, s_6_1);
        // D s_6_3: call ICH_HCR_write(s_6_2)
        let s_6_3: () = ICH_HCR_write(state, tracer, s_6_2);
        // N s_6_4: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_2: call Mk_ICH_HCR_Type(s_9_1)
        let s_9_2: ProductType700c18a878c5601b = Mk_ICH_HCR_Type(state, tracer, s_9_1);
        // D s_9_3: call ICH_HCR_write(s_9_2)
        let s_9_3: () = ICH_HCR_write(state, tracer, s_9_2);
        // N s_9_4: return
        return;
    }
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#128866 <= s_12_0
        fn_state.gs_128866 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#128866:u8
        let s_13_0: bool = fn_state.gs_128866;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#128867 <= s_14_0
        fn_state.gs_128867 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#128867:u8
        let s_15_0: bool = fn_state.gs_128867;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#128868 <= s_17_0
        fn_state.gs_128868 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#128868:u8
        let s_18_0: bool = fn_state.gs_128868;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#128869 <= s_19_0
        fn_state.gs_128869 = s_19_0;
        // N s_19_2: jump b20
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_0: read-var gs#128869:u8
        let s_20_0: bool = fn_state.gs_128869;
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_5: write-var gs#128869 <= s_23_4
        fn_state.gs_128869 = s_23_4;
        // N s_23_6: jump b20
        return block_20(state, tracer, fn_state);
    }
    fn block_24<T: Tracer>(
        ...
        // D s_24_3: write-var gs#128868 <= s_24_2
        fn_state.gs_128868 = s_24_2;
        // N s_24_4: jump b18
        return block_18(state, tracer, fn_state);
    }
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_5: write-var gs#128867 <= s_26_4
        fn_state.gs_128867 = s_26_4;
        // N s_26_6: jump b15
        return block_15(state, tracer, fn_state);
    }
    fn block_27<T: Tracer>(
        ...
        // D s_27_4: write-var gs#128866 <= s_27_3
        fn_state.gs_128866 = s_27_3;
        // N s_27_5: jump b13
        return block_13(state, tracer, fn_state);
    }
