...
use common::*;
pub fn decode_fabd_advsimd_aarch64_instrs_vector_arithmetic_binary_uniform_sub_fp16_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, Rm: u8) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_13: i64 = 1;
        // C s_1_14: const #1u : u8
        let s_1_14: bool = true;
        // C s_1_15: cast zx s_1_12 -> i
        let s_1_15: i128 = (i128::try_from(s_1_12).unwrap());
        // C s_1_16: cast reint s_1_15 -> i64
        let s_1_16: i64 = (s_1_15 as i64);
        // C s_1_17: cast zx s_1_12 -> i
        let s_1_17: i128 = (i128::try_from(s_1_12).unwrap());
        // C s_1_18: cast reint s_1_17 -> i64
        let s_1_18: i64 = (s_1_17 as i64);
        // C s_1_19: cast zx s_1_13 -> i
        let s_1_19: i128 = (i128::try_from(s_1_13).unwrap());
        // D s_1_20: call execute_aarch64_instrs_vector_arithmetic_binary_uniform_sub_fp16_sisd(s_1_14, s_1_3, s_1_16, s_1_19, s_1_18, s_1_11, s_1_7)
        let s_1_20: () = execute_aarch64_instrs_vector_arithmetic_binary_uniform_sub_fp16_sisd(
            state,
            tracer,
            s_1_14,
            s_1_3,
