...
use common::*;
pub fn CNTHP_CVAL_SysRegWrite64_558ce8493f8ab75e<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_15: call Mk_CNTHP_CVAL_Type(s_6_14)
        let s_6_15: ProductType5c790c8ef59cc8b2 = Mk_CNTHP_CVAL_Type(
            state,
            tracer,
            s_6_14,
        );
        // D s_6_16: call CNTHP_CVAL_write(s_6_15)
        let s_6_16: () = CNTHP_CVAL_write(state, tracer, s_6_15);
        // N s_6_17: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_15: call Mk_CNTHP_CVAL_Type(s_8_14)
        let s_8_15: ProductType5c790c8ef59cc8b2 = Mk_CNTHP_CVAL_Type(
            state,
            tracer,
            s_8_14,
        );
        // D s_8_16: call CNTHP_CVAL_write(s_8_15)
        let s_8_16: () = CNTHP_CVAL_write(state, tracer, s_8_15);
        // N s_8_17: return
        return;
    }
    fn block_9<T: Tracer>(
