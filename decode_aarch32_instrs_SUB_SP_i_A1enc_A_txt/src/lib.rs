...
use common::*;
pub fn decode_aarch32_instrs_SUB_SP_i_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    S: bool,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_17: call execute_aarch32_instrs_SUB_SP_i_Op_A_txt(s_2_9, s_2_16, s_2_14)
        let s_2_17: () = execute_aarch32_instrs_SUB_SP_i_Op_A_txt(
            state,
            tracer,
            s_2_9,
            s_2_16,
