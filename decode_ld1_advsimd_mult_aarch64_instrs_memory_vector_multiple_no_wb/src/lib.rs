...
use common::*;
pub fn decode_ld1_advsimd_mult_aarch64_instrs_memory_vector_multiple_no_wb<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 64;
        // D s_3_1: write-var ga#258104 <= s_3_0
        fn_state.ga_258104 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#258104:i64
        let s_4_0: i64 = fn_state.ga_258104;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var selemshadow#1542 <= s_6_0
        fn_state.selemshadow_1542 = s_6_0;
        // D s_6_2: read-var rpt:i64
        let s_6_2: i64 = fn_state.rpt;
        // D s_6_3: write-var rptshadow#1543 <= s_6_2
        fn_state.rptshadow_1543 = s_6_2;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#156817 <= s_7_0
        fn_state.gs_156817 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#156817:u8
        let s_8_0: bool = fn_state.gs_156817;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_12: read-var rptshadow#1543:i64
        let s_9_12: i64 = fn_state.rptshadow_1543;
        // D s_9_13: read-var selemshadow#1542:i64
        let s_9_13: i64 = fn_state.selemshadow_1542;
    ...
    fn block_11<T: Tracer>(
        ...
        // C s_11_0: const #1s : i
        let s_11_0: i128 = 1;
        // D s_11_1: read-var selemshadow#1542:i64
        let s_11_1: i64 = fn_state.selemshadow_1542;
        ...
        // D s_11_4: write-var gs#156817 <= s_11_3
        fn_state.gs_156817 = s_11_3;
        // N s_11_5: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_25<T: Tracer>(
        ...
        let s_25_0: i64 = 128;
        // D s_25_1: write-var ga#258104 <= s_25_0
        fn_state.ga_258104 = s_25_0;
        // N s_25_2: jump b4
        return block_4(state, tracer, fn_state);
    }
