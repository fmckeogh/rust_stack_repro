...
extern crate alloc;
use CurrentVL_read::*;
use execute_URSQRTE_Z_P_Z__::*;
use HaveSVE2::*;
use HaveSME::*;
use common::*;
pub fn decode_URSQRTE_Z_P_Z__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Q: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#215885 <= s_1_0
        fn_state.gs_215885 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#215885:u8
        let s_2_0: bool = fn_state.gs_215885;
    ...
    fn block_4<T: Tracer>(
        ...
        fn_state.g = s_4_3;
        // D s_4_5: read-var Zn:u8
        let s_4_5: u8 = fn_state.Zn;
        ...
        fn_state.n = s_4_8;
        // D s_4_10: read-var Zd:u8
        let s_4_10: u8 = fn_state.Zd;
        ...
        // D s_4_14: write-var d <= s_4_13
        fn_state.d = s_4_13;
        // D s_4_15: read-var VL:i64
        let s_4_15: i64 = fn_state.VL;
        // C s_4_16: const #128s : i
        let s_4_16: i128 = 128;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_2: i64 = 32;
        // D s_5_3: read-var g:i64
        let s_5_3: i64 = fn_state.g;
        // D s_5_4: read-var n:i64
        let s_5_4: i64 = fn_state.n;
        // D s_5_5: call execute_URSQRTE_Z_P_Z__(s_5_0, s_5_1, s_5_2, s_5_3, s_5_4)
        let s_5_5: () = execute_URSQRTE_Z_P_Z__(
            state,
            tracer,
            s_5_0,
            s_5_1,
    ...
    fn block_7<T: Tracer>(
        ...
        let s_7_2: i64 = 32;
        // D s_7_3: read-var g:i64
        let s_7_3: i64 = fn_state.g;
        // D s_7_4: read-var n:i64
        let s_7_4: i64 = fn_state.n;
        // D s_7_5: call execute_URSQRTE_Z_P_Z__(s_7_0, s_7_1, s_7_2, s_7_3, s_7_4)
        let s_7_5: () = execute_URSQRTE_Z_P_Z__(
            state,
            tracer,
            s_7_0,
            s_7_1,
    ...
    fn block_9<T: Tracer>(
        ...
        let s_9_2: i64 = 32;
        // D s_9_3: read-var g:i64
        let s_9_3: i64 = fn_state.g;
        // D s_9_4: read-var n:i64
        let s_9_4: i64 = fn_state.n;
        // D s_9_5: call execute_URSQRTE_Z_P_Z__(s_9_0, s_9_1, s_9_2, s_9_3, s_9_4)
        let s_9_5: () = execute_URSQRTE_Z_P_Z__(
            state,
            tracer,
            s_9_0,
            s_9_1,
    ...
    fn block_11<T: Tracer>(
        ...
        // C s_11_2: const #32s : i64
        let s_11_2: i64 = 32;
        // D s_11_3: read-var g:i64
        let s_11_3: i64 = fn_state.g;
        // D s_11_4: read-var n:i64
        let s_11_4: i64 = fn_state.n;
        // D s_11_5: call execute_URSQRTE_Z_P_Z__(s_11_0, s_11_1, s_11_2, s_11_3, s_11_4)
        let s_11_5: () = execute_URSQRTE_Z_P_Z__(
            state,
            tracer,
            s_11_0,
            s_11_1,
    ...
    fn block_13<T: Tracer>(
        ...
        // C s_13_2: const #32s : i64
        let s_13_2: i64 = 32;
        // D s_13_3: read-var g:i64
        let s_13_3: i64 = fn_state.g;
        // D s_13_4: read-var n:i64
        let s_13_4: i64 = fn_state.n;
        // D s_13_5: call execute_URSQRTE_Z_P_Z__(s_13_0, s_13_1, s_13_2, s_13_3, s_13_4)
        let s_13_5: () = execute_URSQRTE_Z_P_Z__(
            state,
            tracer,
            s_13_0,
            s_13_1,
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_3: write-var gs#215885 <= s_17_2
        fn_state.gs_215885 = s_17_2;
        // N s_17_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
