...
extern crate alloc;
use HaveMTEExt::*;
use execute_aarch64_instrs_integer_tags_mcsettagpairandzerodatapost::*;
use common::*;
pub fn decode_stz2g_aarch64_instrs_integer_tags_mcsettagpairandzerodatapost<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Xt: u8,
    Xn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_22: call execute_aarch64_instrs_integer_tags_mcsettagpairandzerodatapost(s_1_3, s_1_18, s_1_20, s_1_7, s_1_19, s_1_21)
        let s_1_22: () = execute_aarch64_instrs_integer_tags_mcsettagpairandzerodatapost(
            state,
            tracer,
            s_1_3,
            s_1_18,
