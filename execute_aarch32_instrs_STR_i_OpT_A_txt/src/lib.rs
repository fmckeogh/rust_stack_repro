...
use MemU_set::*;
use common::*;
pub fn execute_aarch32_instrs_STR_i_OpT_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    add: bool,
    imm32: u32,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#302962 <= s_5_0
        fn_state.gs_302962 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#302962:u8
        let s_6_0: bool = fn_state.gs_302962;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_6: call MemU_set(s_8_5, s_8_3, s_8_4)
        let s_8_6: () = MemU_set(state, tracer, s_8_5, s_8_3, s_8_4);
        // N s_8_7: jump b9
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_4: write-var gs#302962 <= s_13_3
        fn_state.gs_302962 = s_13_3;
        // N s_13_5: jump b6
        return block_6(state, tracer, fn_state);
    }
