...
extern crate alloc;
use Mk_CPTR_EL3_Type::*;
use common::*;
pub fn u__get_CPTR_EL3<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #18446744070487272191u : u64
        let s_0_3: u64 = 18446744070487272191;
        ...
        // D s_0_11: tail-call Mk_CPTR_EL3_Type(s_0_10)
        return Mk_CPTR_EL3_Type(state, tracer, s_0_10);
    }
}
