...
use common::*;
pub fn ICC_AP1R_EL1_SysRegWrite_0d9519f401c9d3ae<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_11: call _get_ICH_HCR_EL2_Type_TALL1(s_0_10)
        let s_0_11: bool = u_get_ICH_HCR_EL2_Type_TALL1(state, tracer, s_0_10);
        ...
        // D s_0_14: call _get_HCR_EL2_Type_IMO(s_0_13)
        let s_0_14: bool = u_get_HCR_EL2_Type_IMO(state, tracer, s_0_13);
        ...
        // C s_0_18: const #16368u : u32
        let s_0_18: u32 = 16368;
        ...
        // D s_0_20: call _get_ICC_SRE_EL2_Type_SRE(s_0_19)
        let s_0_20: bool = u_get_ICC_SRE_EL2_Type_SRE(state, tracer, s_0_19);
        // C s_0_21: const #10200u : u32
        let s_0_21: u32 = 10200;
        ...
        // D s_0_23: call _get_ICC_SRE_EL3_Type_SRE(s_0_22)
        let s_0_23: bool = u_get_ICC_SRE_EL3_Type_SRE(state, tracer, s_0_22);
        // N s_0_24: panic
        panic!("{:?}", ());
        // N s_0_25: return
        return;
