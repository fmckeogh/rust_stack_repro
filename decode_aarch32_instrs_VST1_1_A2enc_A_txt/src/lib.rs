...
use ConditionPassed::*;
use common::*;
pub fn decode_aarch32_instrs_VST1_1_A2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Rn: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 2;
        // D s_5_1: write-var ga#361295 <= s_5_0
        fn_state.ga_361295 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#361295:i64
        let s_6_0: i64 = fn_state.ga_361295;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#320023 <= s_7_0
        fn_state.gs_320023 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#320023:u8
        let s_8_0: bool = fn_state.gs_320023;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_4: write-var gs#320023 <= s_11_3
        fn_state.gs_320023 = s_11_3;
        // N s_11_5: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_12<T: Tracer>(
        ...
        let s_12_0: i64 = 1;
        // D s_12_1: write-var ga#361295 <= s_12_0
        fn_state.ga_361295 = s_12_0;
        // N s_12_2: jump b6
        return block_6(state, tracer, fn_state);
    }
