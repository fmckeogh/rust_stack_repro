...
use common::*;
pub fn decode_aarch32_instrs_VEOR_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Vn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#308809 <= s_3_0
        fn_state.gs_308809 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#308809:u8
        let s_4_0: bool = fn_state.gs_308809;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 2;
        // D s_6_1: write-var ga#352848 <= s_6_0
        fn_state.ga_352848 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var ga#352848:i64
        let s_7_0: i64 = fn_state.ga_352848;
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 1;
        // D s_8_1: write-var ga#352848 <= s_8_0
        fn_state.ga_352848 = s_8_0;
        // N s_8_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_22: write-var gs#308805 <= s_11_21
        fn_state.gs_308805 = s_11_21;
        // N s_11_23: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#308805:u8
        let s_12_0: bool = fn_state.gs_308805;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_22: write-var gs#308808 <= s_13_21
        fn_state.gs_308808 = s_13_21;
        // N s_13_23: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#308808:u8
        let s_14_0: bool = fn_state.gs_308808;
        // D s_14_1: write-var gs#308809 <= s_14_0
        fn_state.gs_308809 = s_14_0;
        // N s_14_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#308808 <= s_15_0
        fn_state.gs_308808 = s_15_0;
        // N s_15_2: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#308805 <= s_16_0
        fn_state.gs_308805 = s_16_0;
        // N s_16_2: jump b12
        return block_12(state, tracer, fn_state);
    }
}
