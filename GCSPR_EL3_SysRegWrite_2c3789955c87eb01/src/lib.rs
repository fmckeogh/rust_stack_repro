...
extern crate alloc;
use Mk_GCSPR_EL3_Type::*;
use X_read::*;
use common::*;
pub fn GCSPR_EL3_SysRegWrite_2c3789955c87eb01<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_GCSPR_EL3_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_GCSPR_EL3_Type(state, tracer, s_5_3);
        // C s_5_5: const #18248u : u32
        let s_5_5: u32 = 18248;
