...
use ConditionPassed::*;
use DecodeImmShift::*;
use execute_aarch32_instrs_AND_r_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_AND_r_T2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    S: bool,
    Rn: u8,
    ...
    struct FunctionState {
        ...
        gs_295851: bool,
        gs_295864: bool,
        ga_343102: ProductType396b95aa74979079,
        gs_295862: bool,
        d: i64,
        shift_nshadow_7123: i128,
        shift_t: u32,
        gs_295866: bool,
        S: bool,
        Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#295851 <= s_3_0
        fn_state.gs_295851 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#295851:u8
        let s_4_0: bool = fn_state.gs_295851;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_36: write-var ga#343102 <= s_5_35
        fn_state.ga_343102 = s_5_35;
        // D s_5_37: read-var ga#343102.0:struct
        let s_5_37: u32 = fn_state.ga_343102._0;
        // D s_5_38: read-var ga#343102.1:struct
        let s_5_38: i128 = fn_state.ga_343102._1;
        // D s_5_39: write-var shift_t <= s_5_37
        fn_state.shift_t = s_5_37;
        // D s_5_40: write-var shift_nshadow#7123 <= s_5_38
        fn_state.shift_nshadow_7123 = s_5_38;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#295862 <= s_6_0
        fn_state.gs_295862 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#295862:u8
        let s_7_0: bool = fn_state.gs_295862;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: write-var gs#295864 <= s_8_3
        fn_state.gs_295864 = s_8_3;
        // N s_8_5: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#295864:u8
        let s_9_0: bool = fn_state.gs_295864;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: write-var gs#295866 <= s_10_3
        fn_state.gs_295866 = s_10_3;
        // N s_10_5: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#295866:u8
        let s_11_0: bool = fn_state.gs_295866;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_4: read-var shift_nshadow#7123:i
        let s_12_4: i128 = fn_state.shift_nshadow_7123;
        // D s_12_5: read-var shift_t:u32
        let s_12_5: u32 = fn_state.shift_t;
        // D s_12_6: call execute_aarch32_instrs_AND_r_Op_A_txt(s_12_0, s_12_1, s_12_2, s_12_3, s_12_4, s_12_5)
        let s_12_6: () = execute_aarch32_instrs_AND_r_Op_A_txt(
            state,
            tracer,
            s_12_0,
            s_12_1,
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#295866 <= s_14_0
        fn_state.gs_295866 = s_14_0;
        // N s_14_2: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#295864 <= s_15_0
        fn_state.gs_295864 = s_15_0;
        // N s_15_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_16<T: Tracer>(
        ...
        // D s_16_2: write-var gs#295862 <= s_16_1
        fn_state.gs_295862 = s_16_1;
        // N s_16_3: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_5: write-var gs#295851 <= s_18_4
        fn_state.gs_295851 = s_18_4;
        // N s_18_6: jump b4
        return block_4(state, tracer, fn_state);
    }
}
