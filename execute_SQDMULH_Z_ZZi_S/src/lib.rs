...
use Z_set::*;
use common::*;
pub fn execute_SQDMULH_Z_ZZi_S<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#4148 <= s_0_2
        fn_state.VLshadow_4148 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#4148:i64
        let s_1_0: i64 = fn_state.VLshadow_4148;
        // D s_1_1: write-var VLshadow#4149 <= s_1_0
        fn_state.VLshadow_4149 = s_1_0;
        // D s_1_2: read-var VLshadow#4149:i64
        let s_1_2: i64 = fn_state.VLshadow_4149;
        ...
        // D s_1_14: read-var VLshadow#4149:i64
        let s_1_14: i64 = fn_state.VLshadow_4149;
        ...
        // D s_1_22: read-var VLshadow#4149:i64
        let s_1_22: i64 = fn_state.VLshadow_4149;
        ...
        // D s_1_35: write-var gs#217098 <= s_1_34
        fn_state.gs_217098 = s_1_34;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#217098:i64
        let s_2_1: i64 = fn_state.gs_217098;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_49: read-var esize:i64
        let s_3_49: i64 = fn_state.esize;
        // D s_3_50: cast zx s_3_49 -> i
        let s_3_50: i128 = (i128::try_from(s_3_49).unwrap());
        // D s_3_51: lsr s_3_45 s_3_50
        ...
        // D s_3_56: call SignedSat(s_3_51, s_3_55)
        let s_3_56: Bits = SignedSat(state, tracer, s_3_51, s_3_55);
        ...
        // D s_3_60: cast zx s_3_48 -> i
        let s_3_60: i128 = (i128::try_from(s_3_48).unwrap());
        // D s_3_61: cast zx s_3_57 -> bv
        let s_3_61: Bits = Bits::new(s_3_57 as u128, 32u16);
        // D s_3_62: read-var result:bv
        let s_3_62: Bits = fn_state.result;
        // D s_3_63: call Elem_set(s_3_62, s_3_59, s_3_60, s_3_61)
        let s_3_63: Bits = Elem_set(state, tracer, s_3_62, s_3_59, s_3_60, s_3_61);
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#4149:i64
        let s_4_0: i64 = fn_state.VLshadow_4149;
