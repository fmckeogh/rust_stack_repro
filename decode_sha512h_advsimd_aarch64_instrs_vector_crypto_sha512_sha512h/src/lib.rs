...
extern crate alloc;
use HaveSHA512Ext::*;
use execute_aarch64_instrs_vector_crypto_sha512_sha512h::*;
use common::*;
pub fn decode_sha512h_advsimd_aarch64_instrs_vector_crypto_sha512_sha512h<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_12: call execute_aarch64_instrs_vector_crypto_sha512_sha512h(s_1_3, s_1_11, s_1_7)
        let s_1_12: () = execute_aarch64_instrs_vector_crypto_sha512_sha512h(
            state,
            tracer,
            s_1_3,
            s_1_11,
