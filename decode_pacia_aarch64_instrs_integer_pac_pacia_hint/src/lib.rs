...
extern crate alloc;
use execute_aarch64_instrs_integer_pac_pacia_dp_1src::*;
use BTypeCompatible_PACIXSP::*;
use HaveBTIExt::*;
use u__id::*;
use SetBTypeCompatible::*;
use common::*;
pub fn decode_pacia_aarch64_instrs_integer_pac_pacia_hint<T: Tracer>(
    state: &mut State,
    tracer: &T,
    op2: u8,
    CRm: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_17: write-var ga#263840 <= s_0_16
        fn_state.ga_263840 = s_0_16;
        // D s_0_18: read-var ga#263840:u8
        let s_0_18: u8 = fn_state.ga_263840;
        // D s_0_19: cast zx s_0_18 -> bv
        let s_0_19: Bits = Bits::new(s_0_18 as u128, 7u16);
        // C s_0_20: const #24u : u8
        let s_0_20: u8 = 24;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var nshadow#1775 <= s_2_0
        fn_state.nshadow_1775 = s_2_0;
        // D s_2_2: read-var d:i64
        let s_2_2: i64 = fn_state.d;
        // D s_2_3: write-var dshadow#1776 <= s_2_2
        fn_state.dshadow_1776 = s_2_2;
        // D s_2_4: read-var nshadow#1775:i
        let s_2_4: i128 = fn_state.nshadow_1775;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#165635 <= s_3_0
        fn_state.gs_165635 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#165635:u8
        let s_4_0: bool = fn_state.gs_165635;
        // N s_4_1: assert s_4_0
        let s_4_1: () = assert!(s_4_0);
        // D s_4_2: read-var nshadow#1775:i
        let s_4_2: i128 = fn_state.nshadow_1775;
        // D s_4_3: cast reint s_4_2 -> i64
        let s_4_3: i64 = (s_4_2 as i64);
        // D s_4_4: read-var dshadow#1776:i64
        let s_4_4: i64 = fn_state.dshadow_1776;
        // D s_4_5: read-var source_is_sp:u8
        let s_4_5: bool = fn_state.source_is_sp;
        // D s_4_6: call execute_aarch64_instrs_integer_pac_pacia_dp_1src(s_4_4, s_4_3, s_4_5)
        let s_4_6: () = execute_aarch64_instrs_integer_pac_pacia_dp_1src(
            state,
            tracer,
            s_4_4,
            s_4_3,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var nshadow#1775:i
        let s_5_0: i128 = fn_state.nshadow_1775;
        ...
        // D s_5_4: write-var gs#165635 <= s_5_3
        fn_state.gs_165635 = s_5_3;
        // N s_5_5: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#263840:u8
        let s_6_0: u8 = fn_state.ga_263840;
        // D s_6_1: cast zx s_6_0 -> bv
        let s_6_1: Bits = Bits::new(s_6_0 as u128, 7u16);
        // C s_6_2: const #25u : u8
        let s_6_2: u8 = 25;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var ga#263840:u8
        let s_11_0: u8 = fn_state.ga_263840;
        // D s_11_1: cast zx s_11_0 -> bv
        let s_11_1: Bits = Bits::new(s_11_0 as u128, 7u16);
        // C s_11_2: const #8u : u8
        let s_11_2: u8 = 8;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var ga#263840:u8
        let s_13_0: u8 = fn_state.ga_263840;
        // D s_13_1: cast zx s_13_0 -> bv
        let s_13_1: Bits = Bits::new(s_13_0 as u128, 7u16);
        // C s_13_2: const #10u : u8
        let s_13_2: u8 = 10;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var ga#263840:u8
        let s_15_0: u8 = fn_state.ga_263840;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var ga#263840:u8
        let s_17_0: u8 = fn_state.ga_263840;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var ga#263840:u8
        let s_19_0: u8 = fn_state.ga_263840;
        // C s_19_1: const #1s : i
        let s_19_1: i128 = 1;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var ga#263840:u8
        let s_21_0: u8 = fn_state.ga_263840;
        // C s_21_1: const #1s : i
        let s_21_1: i128 = 1;
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_0: read-var ga#263840:u8
        let s_23_0: u8 = fn_state.ga_263840;
        // C s_23_1: const #1s : i
        let s_23_1: i128 = 1;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_0: read-var ga#263840:u8
        let s_25_0: u8 = fn_state.ga_263840;
