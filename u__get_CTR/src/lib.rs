...
pub fn u__get_CTR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #1073758192u : u32
        let s_0_3: u32 = 1073758192;
        ...
        // D s_0_16: tail-call Mk_CTR_Type(s_0_15)
        return Mk_CTR_Type(state, tracer, s_0_15);
    }
}
