...
use common::*;
pub fn SCTLR_EL2_SysRegWrite_3de2374320961a12<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_SCTLR_EL2_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_SCTLR_EL2_Type(state, tracer, s_5_3);
        // D s_5_5: call __set_SCTLR_EL2(s_5_4)
        let s_5_5: () = u__set_SCTLR_EL2(state, tracer, s_5_4);
        // N s_5_6: return
        return;
    }
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call Mk_SCTLR_EL2_Type(s_6_3)
        let s_6_4: ProductType5c790c8ef59cc8b2 = Mk_SCTLR_EL2_Type(state, tracer, s_6_3);
        // D s_6_5: call __set_SCTLR_EL2(s_6_4)
        let s_6_5: () = u__set_SCTLR_EL2(state, tracer, s_6_4);
        // N s_6_6: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#91817 <= s_8_0
        fn_state.gs_91817 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#91817:u8
        let s_9_0: bool = fn_state.gs_91817;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#91817 <= s_12_4
        fn_state.gs_91817 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
