...
extern crate alloc;
use execute_aarch64_instrs_integer_pac_autia_dp_1src::*;
use u__id::*;
use common::*;
pub fn decode_autia_aarch64_instrs_integer_pac_autia_hint<T: Tracer>(
    state: &mut State,
    tracer: &T,
    op2: u8,
    CRm: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_17: write-var ga#249674 <= s_0_16
        fn_state.ga_249674 = s_0_16;
        // D s_0_18: read-var ga#249674:u8
        let s_0_18: u8 = fn_state.ga_249674;
        // D s_0_19: cast zx s_0_18 -> bv
        let s_0_19: Bits = Bits::new(s_0_18 as u128, 7u16);
        // C s_0_20: const #28u : u8
        let s_0_20: u8 = 28;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var nshadow#1068 <= s_2_0
        fn_state.nshadow_1068 = s_2_0;
        // D s_2_2: read-var d:i64
        let s_2_2: i64 = fn_state.d;
        // D s_2_3: write-var dshadow#1069 <= s_2_2
        fn_state.dshadow_1069 = s_2_2;
        // D s_2_4: read-var nshadow#1068:i
        let s_2_4: i128 = fn_state.nshadow_1068;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#143867 <= s_3_0
        fn_state.gs_143867 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#143867:u8
        let s_4_0: bool = fn_state.gs_143867;
        // N s_4_1: assert s_4_0
        let s_4_1: () = assert!(s_4_0);
        // D s_4_2: read-var nshadow#1068:i
        let s_4_2: i128 = fn_state.nshadow_1068;
        // D s_4_3: cast reint s_4_2 -> i64
        let s_4_3: i64 = (s_4_2 as i64);
        // D s_4_4: read-var dshadow#1069:i64
        let s_4_4: i64 = fn_state.dshadow_1069;
        // D s_4_5: read-var source_is_sp:u8
        let s_4_5: bool = fn_state.source_is_sp;
        // D s_4_6: call execute_aarch64_instrs_integer_pac_autia_dp_1src(s_4_4, s_4_3, s_4_5)
        let s_4_6: () = execute_aarch64_instrs_integer_pac_autia_dp_1src(
            state,
            tracer,
            s_4_4,
            s_4_3,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var nshadow#1068:i
        let s_5_0: i128 = fn_state.nshadow_1068;
        ...
        // D s_5_4: write-var gs#143867 <= s_5_3
        fn_state.gs_143867 = s_5_3;
        // N s_5_5: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#249674:u8
        let s_6_0: u8 = fn_state.ga_249674;
        // D s_6_1: cast zx s_6_0 -> bv
        let s_6_1: Bits = Bits::new(s_6_0 as u128, 7u16);
        // C s_6_2: const #29u : u8
        let s_6_2: u8 = 29;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var ga#249674:u8
        let s_8_0: u8 = fn_state.ga_249674;
        // D s_8_1: cast zx s_8_0 -> bv
        let s_8_1: Bits = Bits::new(s_8_0 as u128, 7u16);
        // C s_8_2: const #12u : u8
        let s_8_2: u8 = 12;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var ga#249674:u8
        let s_10_0: u8 = fn_state.ga_249674;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var ga#249674:u8
        let s_12_0: u8 = fn_state.ga_249674;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var ga#249674:u8
        let s_14_0: u8 = fn_state.ga_249674;
        // D s_14_1: cast zx s_14_0 -> bv
        let s_14_1: Bits = Bits::new(s_14_0 as u128, 7u16);
        // C s_14_2: const #14u : u8
        let s_14_2: u8 = 14;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var ga#249674:u8
        let s_16_0: u8 = fn_state.ga_249674;
        // C s_16_1: const #1s : i
        let s_16_1: i128 = 1;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var ga#249674:u8
        let s_18_0: u8 = fn_state.ga_249674;
        // C s_18_1: const #1s : i
        let s_18_1: i128 = 1;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_0: read-var ga#249674:u8
        let s_20_0: u8 = fn_state.ga_249674;
        // C s_20_1: const #1s : i
        let s_20_1: i128 = 1;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_0: read-var ga#249674:u8
        let s_22_0: u8 = fn_state.ga_249674;
