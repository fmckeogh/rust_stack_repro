...
use AlignmentFault::*;
use common::*;
pub fn execute_aarch32_instrs_VLD4_a_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    alignment: i64,
    d: i64,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_11: read-var ebytes:i64
        let s_5_11: i64 = fn_state.ebytes;
        // D s_5_12: call MemU_read(s_5_10, s_5_11)
        let s_5_12: Bits = MemU_read(state, tracer, s_5_10, s_5_11);
        // D s_5_13: write-var element3 <= s_5_12
        fn_state.element3 = s_5_12;
        // N s_5_14: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_11: read-var ebytes:i64
        let s_6_11: i64 = fn_state.ebytes;
        // D s_6_12: call MemU_read(s_6_10, s_6_11)
        let s_6_12: Bits = MemU_read(state, tracer, s_6_10, s_6_11);
        // D s_6_13: write-var element4 <= s_6_12
        fn_state.element4 = s_6_12;
        // N s_6_14: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_7: cast reint s_7_5 -> u64
        let s_7_7: u64 = (s_7_5 as u64);
        // D s_7_8: call replicate_bits_borealis_internal(s_7_6, s_7_7)
        let s_7_8: Bits = replicate_bits_borealis_internal(state, tracer, s_7_6, s_7_7);
        // D s_7_9: read-var d:i64
        let s_7_9: i64 = fn_state.d;
        // D s_7_10: cast zx s_7_9 -> i
        let s_7_10: i128 = (i128::try_from(s_7_9).unwrap());
        // D s_7_11: cast reint s_7_8 -> u64
        let s_7_11: u64 = (s_7_8.value() as u64);
        // D s_7_12: call D_set(s_7_10, s_7_11)
        let s_7_12: () = D_set(state, tracer, s_7_10, s_7_11);
        // C s_7_13: const #64s : i
        let s_7_13: i128 = 64;
        // D s_7_14: read-var esize:i64
        let s_7_14: i64 = fn_state.esize;
        // D s_7_15: cast zx s_7_14 -> i
        let s_7_15: i128 = (i128::try_from(s_7_14).unwrap());
        // D s_7_16: div s_7_13 s_7_15
        ...
        // D s_7_19: read-var element2:bv
        let s_7_19: Bits = fn_state.element2;
        // D s_7_20: cast reint s_7_18 -> u64
        let s_7_20: u64 = (s_7_18 as u64);
        // D s_7_21: call replicate_bits_borealis_internal(s_7_19, s_7_20)
        let s_7_21: Bits = replicate_bits_borealis_internal(
            state,
            tracer,
            s_7_19,
            s_7_20,
        ...
        // D s_7_23: read-var d2:i
        let s_7_23: i128 = fn_state.d2;
        // D s_7_24: call D_set(s_7_23, s_7_22)
        let s_7_24: () = D_set(state, tracer, s_7_23, s_7_22);
        // C s_7_25: const #64s : i
        let s_7_25: i128 = 64;
        ...
        // D s_7_31: read-var element3:bv
        let s_7_31: Bits = fn_state.element3;
        // D s_7_32: cast reint s_7_30 -> u64
        let s_7_32: u64 = (s_7_30 as u64);
        // D s_7_33: call replicate_bits_borealis_internal(s_7_31, s_7_32)
        let s_7_33: Bits = replicate_bits_borealis_internal(
            state,
            tracer,
            s_7_31,
            s_7_32,
        );
        // D s_7_34: cast reint s_7_33 -> u64
        let s_7_34: u64 = (s_7_33.value() as u64);
        // D s_7_35: read-var d3:i
        let s_7_35: i128 = fn_state.d3;
        // D s_7_36: call D_set(s_7_35, s_7_34)
        let s_7_36: () = D_set(state, tracer, s_7_35, s_7_34);
        // C s_7_37: const #64s : i
        let s_7_37: i128 = 64;
        // D s_7_38: read-var esize:i64
        let s_7_38: i64 = fn_state.esize;
        // D s_7_39: cast zx s_7_38 -> i
        let s_7_39: i128 = (i128::try_from(s_7_38).unwrap());
        // D s_7_40: div s_7_37 s_7_39
        let s_7_40: i128 = ((s_7_37) / (s_7_39));
        ...
        // D s_7_43: read-var element4:bv
        let s_7_43: Bits = fn_state.element4;
        // D s_7_44: cast reint s_7_42 -> u64
        let s_7_44: u64 = (s_7_42 as u64);
        // D s_7_45: call replicate_bits_borealis_internal(s_7_43, s_7_44)
        let s_7_45: Bits = replicate_bits_borealis_internal(
            state,
            tracer,
            s_7_43,
            s_7_44,
        );
        // D s_7_46: cast reint s_7_45 -> u64
        let s_7_46: u64 = (s_7_45.value() as u64);
        // D s_7_47: read-var d4:i
        let s_7_47: i128 = fn_state.d4;
        // D s_7_48: call D_set(s_7_47, s_7_46)
        let s_7_48: () = D_set(state, tracer, s_7_47, s_7_46);
        // D s_7_49: read-var wback:u8
        let s_7_49: bool = fn_state.wback;
        // N s_7_50: branch s_7_49 b9 b8
        if s_7_49 {
