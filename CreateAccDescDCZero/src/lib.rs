...
use HaveTME::*;
use common::*;
pub fn CreateAccDescDCZero<T: Tracer>(
    state: &mut State,
    tracer: &T,
    tagaccess: bool,
    tagchecked: bool,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #1u : u8
        let s_0_3: bool = true;
        // D s_0_4: write-var accdesc.32 <= s_0_3
        fn_state.accdesc._32 = s_0_3;
        // C s_0_5: const #1u : u8
        let s_0_5: bool = true;
        // D s_0_6: write-var accdesc.20 <= s_0_5
        fn_state.accdesc._20 = s_0_5;
        // D s_0_7: read-var tagchecked:u8
        let s_0_7: bool = fn_state.tagchecked;
        // D s_0_8: write-var accdesc.28 <= s_0_7
        fn_state.accdesc._28 = s_0_7;
        // D s_0_9: read-var tagaccess:u8
        let s_0_9: bool = fn_state.tagaccess;
        // D s_0_10: write-var accdesc.27 <= s_0_9
        fn_state.accdesc._27 = s_0_9;
        // C s_0_11: const #() : ()
        let s_0_11: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#7327 <= s_1_0
        fn_state.gs_7327 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#7327:u8
        let s_2_0: bool = fn_state.gs_7327;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#7327 <= s_3_3
        fn_state.gs_7327 = s_3_3;
        // N s_3_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
