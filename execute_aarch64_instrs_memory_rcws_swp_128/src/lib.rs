...
use MemAtomicRCW::*;
use common::*;
pub fn execute_aarch64_instrs_memory_rcws_swp_128<T: Tracer>(
    state: &mut State,
    tracer: &T,
    acquire: bool,
    n: i64,
    ...
    struct FunctionState {
        ...
        value2_name: u64,
        value1_name: u64,
        gs_708796: ProductType42c31f3d0ab6eb17,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_10: write-var gs#708796 <= s_5_9
        fn_state.gs_708796 = s_5_9;
        // N s_5_11: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#708796.0:struct
        let s_6_0: u8 = fn_state.gs_708796._0;
        // D s_6_1: read-var gs#708796.1:struct
        let s_6_1: Bits = fn_state.gs_708796._1;
