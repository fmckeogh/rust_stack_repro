...
use common::*;
pub fn decode_fcvtxn_advsimd_aarch64_instrs_vector_arithmetic_unary_float_xtn_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, sz: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_1: i64 = 1;
        // C s_1_2: const #0s : i64
        let s_1_2: i64 = 0;
        // C s_1_3: cast zx s_1_0 -> i
        let s_1_3: i128 = (i128::try_from(s_1_0).unwrap());
        // C s_1_4: cast reint s_1_3 -> i64
        let s_1_4: i64 = (s_1_3 as i64);
        // D s_1_5: read-var d:i64
        let s_1_5: i64 = fn_state.d;
        // D s_1_6: read-var n:i64
        let s_1_6: i64 = fn_state.n;
        // D s_1_7: call execute_aarch64_instrs_vector_arithmetic_unary_float_xtn_sisd(s_1_5, s_1_4, s_1_1, s_1_0, s_1_6, s_1_2)
        let s_1_7: () = execute_aarch64_instrs_vector_arithmetic_unary_float_xtn_sisd(
            state,
            tracer,
            s_1_5,
            s_1_4,
