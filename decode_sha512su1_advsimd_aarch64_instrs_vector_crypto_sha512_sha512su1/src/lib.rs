...
extern crate alloc;
use HaveSHA512Ext::*;
use execute_aarch64_instrs_vector_crypto_sha512_sha512su1::*;
use common::*;
pub fn decode_sha512su1_advsimd_aarch64_instrs_vector_crypto_sha512_sha512su1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_0: const #() : ()
        let s_0_0: () = ();
        // S s_0_1: call HaveSHA512Ext(s_0_0)
        let s_0_1: bool = HaveSHA512Ext(state, tracer, s_0_0);
        // S s_0_2: not s_0_1
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_12: call execute_aarch64_instrs_vector_crypto_sha512_sha512su1(s_1_3, s_1_11, s_1_7)
        let s_1_12: () = execute_aarch64_instrs_vector_crypto_sha512_sha512su1(
            state,
            tracer,
            s_1_3,
            s_1_11,
