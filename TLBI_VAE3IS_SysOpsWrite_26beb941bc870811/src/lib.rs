...
use AArch64_TLBI_VA::*;
use common::*;
pub fn TLBI_VAE3IS_SysOpsWrite_26beb941bc870811<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_7: u32 = 0;
        // C s_6_8: const #1080u : u32
        let s_6_8: u32 = 1080;
        // D s_6_9: read-reg s_6_8:u16
        let s_6_9: u16 = {
            let value = state.read_register::<u16>(s_6_8 as isize);
        ...
        let s_6_11: u32 = 0;
        // C s_6_12: const #1u : u32
        let s_6_12: u32 = 1;
        // D s_6_13: call AArch64_TLBI_VA(s_6_2, s_6_7, s_6_9, s_6_10, s_6_11, s_6_12, s_6_6)
