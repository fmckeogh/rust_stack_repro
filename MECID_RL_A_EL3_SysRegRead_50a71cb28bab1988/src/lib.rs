...
extern crate alloc;
use X_set::*;
use u__get_MECID_RL_A_EL3::*;
use common::*;
pub fn MECID_RL_A_EL3_SysRegRead_50a71cb28bab1988<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        u__PSTATE_EL: u8,
        ga_70974: ProductType5c790c8ef59cc8b2,
        el: u8,
        op0: u8,
        op1: u8,
        CRn: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // C s_5_1: const #102568u : u32
        let s_5_1: u32 = 102568;
        ...
        // D s_5_3: call __get_MECID_RL_A_EL3(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_MECID_RL_A_EL3(
            state,
            tracer,
            s_5_2,
        );
        // D s_5_4: write-var ga#70974 <= s_5_3
        fn_state.ga_70974 = s_5_3;
        // D s_5_5: read-var ga#70974.0:struct
        let s_5_5: u64 = fn_state.ga_70974._0;
