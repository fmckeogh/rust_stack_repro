...
use Zeros::*;
use common::*;
pub fn SSBS_SysRegRead_2e7b32f98c2852d5<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // S s_5_3: cast reint s_5_2 -> u51
        let s_5_3: u64 = (s_5_2.value() as u64);
        // C s_5_4: const #16992u : u32
        let s_5_4: u32 = 16992;
        ...
        let s_5_6: Bits = Bits::new(s_5_3 as u128, 51u16);
        ...
        // D s_5_16: cast reint s_5_15 -> u52
        ...
        // S s_5_19: cast reint s_5_18 -> u12
        let s_5_19: u16 = (s_5_18.value() as u16);
        // D s_5_20: cast zx s_5_16 -> bv
        let s_5_20: Bits = Bits::new(s_5_16 as u128, 52u16);
        // S s_5_21: cast zx s_5_19 -> bv
        let s_5_21: Bits = Bits::new(s_5_19 as u128, 12u16);
    ...
    fn block_6<T: Tracer>(
        ...
        // S s_6_3: cast reint s_6_2 -> u51
        let s_6_3: u64 = (s_6_2.value() as u64);
        // C s_6_4: const #16992u : u32
        let s_6_4: u32 = 16992;
        ...
        let s_6_6: Bits = Bits::new(s_6_3 as u128, 51u16);
        ...
        // D s_6_16: cast reint s_6_15 -> u52
        let s_6_16: u64 = (s_6_15.value() as u64);
        // C s_6_17: const #12s : i
        let s_6_17: i128 = 12;
        // S s_6_18: call Zeros(s_6_17)
        let s_6_18: Bits = Zeros(state, tracer, s_6_17);
        // S s_6_19: cast reint s_6_18 -> u12
        let s_6_19: u16 = (s_6_18.value() as u16);
        // D s_6_20: cast zx s_6_16 -> bv
        let s_6_20: Bits = Bits::new(s_6_16 as u128, 52u16);
        // S s_6_21: cast zx s_6_19 -> bv
        let s_6_21: Bits = Bits::new(s_6_19 as u128, 12u16);
    ...
    fn block_7<T: Tracer>(
        ...
        // S s_7_3: cast reint s_7_2 -> u51
        let s_7_3: u64 = (s_7_2.value() as u64);
        // C s_7_4: const #16992u : u32
        let s_7_4: u32 = 16992;
        ...
        let s_7_6: Bits = Bits::new(s_7_3 as u128, 51u16);
        ...
        // D s_7_16: cast reint s_7_15 -> u52
        let s_7_16: u64 = (s_7_15.value() as u64);
        // C s_7_17: const #12s : i
        let s_7_17: i128 = 12;
        // S s_7_18: call Zeros(s_7_17)
        let s_7_18: Bits = Zeros(state, tracer, s_7_17);
        // S s_7_19: cast reint s_7_18 -> u12
        let s_7_19: u16 = (s_7_18.value() as u16);
        // D s_7_20: cast zx s_7_16 -> bv
        let s_7_20: Bits = Bits::new(s_7_16 as u128, 52u16);
        // S s_7_21: cast zx s_7_19 -> bv
        let s_7_21: Bits = Bits::new(s_7_19 as u128, 12u16);
    ...
    fn block_8<T: Tracer>(
        ...
        // S s_8_3: cast reint s_8_2 -> u51
        let s_8_3: u64 = (s_8_2.value() as u64);
        // C s_8_4: const #16992u : u32
        let s_8_4: u32 = 16992;
        ...
        // S s_8_6: cast zx s_8_3 -> bv
        let s_8_6: Bits = Bits::new(s_8_3 as u128, 51u16);
        // D s_8_7: cast zx s_8_5 -> bv
        let s_8_7: Bits = Bits::new(s_8_5 as u128, 1u16);
        // S s_8_8: cast reint s_8_6 -> u128
        ...
        // D s_8_16: cast reint s_8_15 -> u52
        let s_8_16: u64 = (s_8_15.value() as u64);
        // C s_8_17: const #12s : i
        let s_8_17: i128 = 12;
        // S s_8_18: call Zeros(s_8_17)
        let s_8_18: Bits = Zeros(state, tracer, s_8_17);
        // S s_8_19: cast reint s_8_18 -> u12
        let s_8_19: u16 = (s_8_18.value() as u16);
        // D s_8_20: cast zx s_8_16 -> bv
        let s_8_20: Bits = Bits::new(s_8_16 as u128, 52u16);
        // S s_8_21: cast zx s_8_19 -> bv
        let s_8_21: Bits = Bits::new(s_8_19 as u128, 12u16);
        // D s_8_22: cast reint s_8_20 -> u128
        let s_8_22: u128 = (s_8_20.value() as u128);
        // D s_8_23: size-of s_8_20
        let s_8_23: u16 = s_8_20.length();
        // S s_8_24: cast reint s_8_21 -> u128
        ...
        let s_8_31: Bits = Bits::new(s_8_30 as u128, 64u16);
        // D s_8_32: read-var t:i
        let s_8_32: i128 = fn_state.t;
        // D s_8_33: call X_set(s_8_32, s_8_0, s_8_31)
        let s_8_33: () = X_set(state, tracer, s_8_32, s_8_0, s_8_31);
        // N s_8_34: return
        return;
    }
}
