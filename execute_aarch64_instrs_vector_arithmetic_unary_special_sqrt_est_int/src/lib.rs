...
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_unary_special_sqrt_est_int<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    datasize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var datasizeshadow#2011 <= s_0_2
        fn_state.datasizeshadow_2011 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var datasizeshadow#2011:i64
        let s_1_0: i64 = fn_state.datasizeshadow_2011;
        ...
        // D s_1_12: write-var gs#174242 <= s_1_11
        fn_state.gs_174242 = s_1_11;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#174242:i64
        let s_2_1: i64 = fn_state.gs_174242;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_9: call UnsignedRSqrtEstimate(s_3_8)
        let s_3_9: Bits = UnsignedRSqrtEstimate(state, tracer, s_3_8);
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var datasizeshadow#2011:i64
        let s_4_0: i64 = fn_state.datasizeshadow_2011;
