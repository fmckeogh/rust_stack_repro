...
use u_update_HSCTLR_Type_ITD::*;
use Mk_HSCTLR_Type::*;
use HSCTLR_write::*;
use u_update_HSCTLR_Type_CP15BEN::*;
use u_get_HSCTLR_Type_CP15BEN::*;
use u__IMPDEF_boolean::*;
use HSCTLR_read::*;
use common::*;
pub fn u__set_HSCTLR<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    struct FunctionState {
        ...
        ga_27905: ProductType700c18a878c5601b,
        ga_27911: ProductType700c18a878c5601b,
        ga_27899: ProductType700c18a878c5601b,
        value_name: ProductType700c18a878c5601b,
    }
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_2: const #() : ()
        let s_0_2: () = ();
        // S s_0_3: call HSCTLR_read(s_0_2)
        let s_0_3: ProductType700c18a878c5601b = HSCTLR_read(state, tracer, s_0_2);
        // D s_0_4: write-var ga#27899 <= s_0_3
        fn_state.ga_27899 = s_0_3;
        // D s_0_5: read-var ga#27899.0:struct
        let s_0_5: u32 = fn_state.ga_27899._0;
        ...
        // D s_0_27: call Mk_HSCTLR_Type(s_0_26)
        let s_0_27: ProductType700c18a878c5601b = Mk_HSCTLR_Type(state, tracer, s_0_26);
        // D s_0_28: call HSCTLR_write(s_0_27)
        let s_0_28: () = HSCTLR_write(state, tracer, s_0_27);
        // C s_0_29: const #() : ()
        let s_0_29: () = ();
        // S s_0_30: call HSCTLR_read(s_0_29)
        let s_0_30: ProductType700c18a878c5601b = HSCTLR_read(state, tracer, s_0_29);
        // D s_0_31: write-var ga#27905 <= s_0_30
        fn_state.ga_27905 = s_0_30;
        // D s_0_32: read-var ga#27905.0:struct
        let s_0_32: u32 = fn_state.ga_27905._0;
        ...
        // D s_0_54: call Mk_HSCTLR_Type(s_0_53)
        let s_0_54: ProductType700c18a878c5601b = Mk_HSCTLR_Type(state, tracer, s_0_53);
        // D s_0_55: call HSCTLR_write(s_0_54)
        let s_0_55: () = HSCTLR_write(state, tracer, s_0_54);
        // C s_0_56: const #() : ()
        let s_0_56: () = ();
        // S s_0_57: call HSCTLR_read(s_0_56)
        let s_0_57: ProductType700c18a878c5601b = HSCTLR_read(state, tracer, s_0_56);
        // D s_0_58: write-var ga#27911 <= s_0_57
        fn_state.ga_27911 = s_0_57;
        // D s_0_59: read-var ga#27911.0:struct
        let s_0_59: u32 = fn_state.ga_27911._0;
        ...
        // D s_0_81: call Mk_HSCTLR_Type(s_0_80)
        let s_0_81: ProductType700c18a878c5601b = Mk_HSCTLR_Type(state, tracer, s_0_80);
        // D s_0_82: call HSCTLR_write(s_0_81)
        let s_0_82: () = HSCTLR_write(state, tracer, s_0_81);
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_3: call _get_HSCTLR_Type_CP15BEN(s_4_2)
        let s_4_3: bool = u_get_HSCTLR_Type_CP15BEN(state, tracer, s_4_2);
        // D s_4_4: call _update_HSCTLR_Type_CP15BEN(s_4_1, s_4_3)
        let s_4_4: ProductType700c18a878c5601b = u_update_HSCTLR_Type_CP15BEN(
            state,
            tracer,
            s_4_1,
            s_4_3,
        );
        // D s_4_5: call HSCTLR_write(s_4_4)
        let s_4_5: () = HSCTLR_write(state, tracer, s_4_4);
        // N s_4_6: return
        return;
    }
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call _get_HSCTLR_Type_ITD(s_5_2)
        let s_5_3: bool = u_get_HSCTLR_Type_ITD(state, tracer, s_5_2);
        // D s_5_4: call _update_HSCTLR_Type_ITD(s_5_1, s_5_3)
        let s_5_4: ProductType700c18a878c5601b = u_update_HSCTLR_Type_ITD(
            state,
            tracer,
            s_5_1,
            s_5_3,
        );
        // D s_5_5: call HSCTLR_write(s_5_4)
        let s_5_5: () = HSCTLR_write(state, tracer, s_5_4);
        // N s_5_6: jump b2
        return block_2(state, tracer, fn_state);
    }
}
