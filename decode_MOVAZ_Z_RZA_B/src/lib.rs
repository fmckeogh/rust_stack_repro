...
extern crate alloc;
use execute_MOVAZ_Z_RZA_B::*;
use CurrentVL_read::*;
use HaveSME2p1::*;
use common::*;
pub fn decode_MOVAZ_Z_RZA_B<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Q: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_2: read-var Rs:u8
        let s_1_2: u8 = fn_state.Rs;
        ...
        // D s_1_16: write-var s <= s_1_15
        fn_state.s = s_1_15;
        // D s_1_17: read-var off4:u8
        let s_1_17: u8 = fn_state.off4;
        ...
        // D s_1_21: write-var offset <= s_1_20
        fn_state.offset = s_1_20;
        // D s_1_22: read-var Zd:u8
        let s_1_22: u8 = fn_state.Zd;
        ...
        fn_state.d = s_1_25;
        // D s_1_27: read-var V:u8
        let s_1_27: bool = fn_state.V;
        ...
        // D s_1_32: write-var vertical <= s_1_31
        fn_state.vertical = s_1_31;
        // D s_1_33: read-var VL:i64
        let s_1_33: i64 = fn_state.VL;
        // C s_1_34: const #128s : i
        let s_1_34: i128 = 128;
        // D s_1_35: cast zx s_1_33 -> i
        let s_1_35: i128 = (i128::try_from(s_1_33).unwrap());
        // D s_1_36: cmp-eq s_1_35 s_1_34
        let s_1_36: bool = ((s_1_35) == (s_1_34));
        // D s_1_37: not s_1_36
        let s_1_37: bool = !s_1_36;
        // N s_1_38: branch s_1_37 b3 b2
        if s_1_37 {
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_2: const #8s : i64
        let s_2_2: i64 = 8;
        // C s_2_3: const #0s : i64
        let s_2_3: i64 = 0;
        // D s_2_4: read-var offset:i64
        let s_2_4: i64 = fn_state.offset;
        // D s_2_5: read-var s:i64
        let s_2_5: i64 = fn_state.s;
        // D s_2_6: read-var vertical:u8
        let s_2_6: bool = fn_state.vertical;
        // D s_2_7: call execute_MOVAZ_Z_RZA_B(s_2_0, s_2_1, s_2_2, s_2_3, s_2_4, s_2_5, s_2_6)
        let s_2_7: () = execute_MOVAZ_Z_RZA_B(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_2: i64 = 8;
        // C s_4_3: const #0s : i64
        let s_4_3: i64 = 0;
        // D s_4_4: read-var offset:i64
        let s_4_4: i64 = fn_state.offset;
        // D s_4_5: read-var s:i64
        let s_4_5: i64 = fn_state.s;
        // D s_4_6: read-var vertical:u8
        let s_4_6: bool = fn_state.vertical;
        // D s_4_7: call execute_MOVAZ_Z_RZA_B(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5, s_4_6)
        let s_4_7: () = execute_MOVAZ_Z_RZA_B(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_2: i64 = 8;
        // C s_6_3: const #0s : i64
        let s_6_3: i64 = 0;
        // D s_6_4: read-var offset:i64
        let s_6_4: i64 = fn_state.offset;
        // D s_6_5: read-var s:i64
        let s_6_5: i64 = fn_state.s;
        // D s_6_6: read-var vertical:u8
        let s_6_6: bool = fn_state.vertical;
        // D s_6_7: call execute_MOVAZ_Z_RZA_B(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5, s_6_6)
        let s_6_7: () = execute_MOVAZ_Z_RZA_B(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_2: i64 = 8;
        // C s_8_3: const #0s : i64
        let s_8_3: i64 = 0;
        // D s_8_4: read-var offset:i64
        let s_8_4: i64 = fn_state.offset;
        // D s_8_5: read-var s:i64
        let s_8_5: i64 = fn_state.s;
        // D s_8_6: read-var vertical:u8
        let s_8_6: bool = fn_state.vertical;
        // D s_8_7: call execute_MOVAZ_Z_RZA_B(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5, s_8_6)
        let s_8_7: () = execute_MOVAZ_Z_RZA_B(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: read-var s:i64
        let s_10_5: i64 = fn_state.s;
        // D s_10_6: read-var vertical:u8
        let s_10_6: bool = fn_state.vertical;
        // D s_10_7: call execute_MOVAZ_Z_RZA_B(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5, s_10_6)
        let s_10_7: () = execute_MOVAZ_Z_RZA_B(
            state,
            tracer,
            s_10_0,
            s_10_1,
