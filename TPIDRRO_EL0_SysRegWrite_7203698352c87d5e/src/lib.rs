...
use X_read::*;
use EL2Enabled::*;
use u_get_HFGWTR_EL2_Type_TPIDRRO_EL0::*;
use AArch64_SystemAccessTrap::*;
use common::*;
pub fn TPIDRRO_EL0_SysRegWrite_7203698352c87d5e<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        gs_96820: bool,
        u__HFGWTR_EL2_TPIDRRO_EL0: bool,
        u__PSTATE_EL: u8,
        gs_96817: bool,
        gs_96819: bool,
        gs_96818: bool,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_9: call _get_HFGWTR_EL2_Type_TPIDRRO_EL0(s_0_8)
        let s_0_9: bool = u_get_HFGWTR_EL2_Type_TPIDRRO_EL0(state, tracer, s_0_8);
        // D s_0_10: write-var __HFGWTR_EL2_TPIDRRO_EL0 <= s_0_9
        fn_state.u__HFGWTR_EL2_TPIDRRO_EL0 = s_0_9;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#96817 <= s_8_0
        fn_state.gs_96817 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#96817:u8
        let s_9_0: bool = fn_state.gs_96817;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#96819 <= s_10_0
        fn_state.gs_96819 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#96819:u8
        let s_11_0: bool = fn_state.gs_96819;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#96820 <= s_12_0
        fn_state.gs_96820 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#96820:u8
        let s_13_0: bool = fn_state.gs_96820;
    ...
    fn block_14<T: Tracer>(
        ...
        // C s_14_4: const #17240u : u32
        let s_14_4: u32 = 17240;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var __HFGWTR_EL2_TPIDRRO_EL0:u8
        let s_16_0: bool = fn_state.u__HFGWTR_EL2_TPIDRRO_EL0;
        ...
        // D s_16_5: write-var gs#96820 <= s_16_4
        fn_state.gs_96820 = s_16_4;
        // N s_16_6: jump b13
        return block_13(state, tracer, fn_state);
    }
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_5: write-var gs#96818 <= s_18_4
        fn_state.gs_96818 = s_18_4;
        // N s_18_6: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#96818:u8
        let s_19_0: bool = fn_state.gs_96818;
        // D s_19_1: write-var gs#96819 <= s_19_0
        fn_state.gs_96819 = s_19_0;
        // N s_19_2: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#96818 <= s_20_0
        fn_state.gs_96818 = s_20_0;
        // N s_20_2: jump b19
        return block_19(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_2: write-var gs#96817 <= s_21_1
        fn_state.gs_96817 = s_21_1;
        // N s_21_3: jump b9
        return block_9(state, tracer, fn_state);
    }
