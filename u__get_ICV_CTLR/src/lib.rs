...
use common::*;
pub fn u__get_ICV_CTLR<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4294115580u : u32
        let s_0_3: u32 = 4294115580;
        ...
        // D s_0_11: tail-call Mk_ICV_CTLR_Type(s_0_10)
        return Mk_ICV_CTLR_Type(state, tracer, s_0_10);
    }
}
