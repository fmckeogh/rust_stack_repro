...
use common::*;
pub fn decode_cmle_advsimd_aarch64_instrs_vector_arithmetic_unary_cmp_int_bulk_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, op: bool, size: u8, U: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_22: write-var ga#251182 <= s_1_21
        fn_state.ga_251182 = s_1_21;
        // D s_1_23: read-var ga#251182:u8
        let s_1_23: u8 = fn_state.ga_251182;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#251182:u8
        let s_4_0: u8 = fn_state.ga_251182;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#251182:u8
        let s_6_0: u8 = fn_state.ga_251182;
