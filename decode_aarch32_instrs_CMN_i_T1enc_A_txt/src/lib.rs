...
use T32ExpandImm::*;
use common::*;
pub fn decode_aarch32_instrs_CMN_i_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i: bool,
    Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_2: call execute_aarch32_instrs_CMN_i_Op_A_txt(s_3_0, s_3_1)
        let s_3_2: () = execute_aarch32_instrs_CMN_i_Op_A_txt(
            state,
            tracer,
            s_3_0,
            s_3_1,
