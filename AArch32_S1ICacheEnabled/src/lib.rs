...
extern crate alloc;
use u_get_SCTLR_Type_I::*;
use SCTLR_read__2::*;
use HaveAArch32EL::*;
use SCTLR_NS_read::*;
use u_get_HSCTLR_Type_I::*;
use HSCTLR_read::*;
use common::*;
pub fn AArch32_S1ICacheEnabled<T: Tracer>(
    state: &mut State,
    tracer: &T,
    regime: u32,
) -> bool {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_2: call _get_SCTLR_Type_I(s_1_1)
        let s_1_2: bool = u_get_SCTLR_Type_I(state, tracer, s_1_1);
    ...
    fn block_4<T: Tracer>(
        ...
        // S s_4_2: call _get_HSCTLR_Type_I(s_4_1)
        let s_4_2: bool = u_get_HSCTLR_Type_I(state, tracer, s_4_1);
    ...
    fn block_7<T: Tracer>(
        ...
        // S s_7_2: call _get_SCTLR_Type_I(s_7_1)
        let s_7_2: bool = u_get_SCTLR_Type_I(state, tracer, s_7_1);
        // D s_7_3: write-var ga#21341 <= s_7_2
        fn_state.ga_21341 = s_7_2;
        // N s_7_4: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var ga#21341:u8
        let s_8_0: bool = fn_state.ga_21341;
    ...
    fn block_9<T: Tracer>(
        ...
        // S s_9_2: call _get_SCTLR_Type_I(s_9_1)
        let s_9_2: bool = u_get_SCTLR_Type_I(state, tracer, s_9_1);
        // D s_9_3: write-var ga#21341 <= s_9_2
        fn_state.ga_21341 = s_9_2;
        // N s_9_4: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var ga#21343:u8
        let s_10_0: bool = fn_state.ga_21343;
