...
extern crate alloc;
use common::*;
pub fn HAMAIR0_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #12832u : u32
        let s_0_23: u32 = 12832;
        ...
        // C s_0_25: const #12160u : u32
        let s_0_25: u32 = 12160;
