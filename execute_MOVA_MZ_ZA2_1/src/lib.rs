...
use ZAvector_read::*;
use common::*;
pub fn execute_MOVA_MZ_ZA2_1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#5588 <= s_0_2
        fn_state.VLshadow_5588 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#5588:i64
        let s_1_0: i64 = fn_state.VLshadow_5588;
        // D s_1_1: write-var VLshadow#5589 <= s_1_0
        fn_state.VLshadow_5589 = s_1_0;
        // C s_1_2: const #8s : i
        let s_1_2: i128 = 8;
        // D s_1_3: read-var VLshadow#5589:i64
        let s_1_3: i64 = fn_state.VLshadow_5589;
        ...
        // D s_1_37: write-var gs#259111 <= s_1_36
        fn_state.gs_259111 = s_1_36;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#259111:i64
        let s_2_1: i64 = fn_state.gs_259111;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: read-var VLshadow#5589:i64
        let s_3_1: i64 = fn_state.VLshadow_5589;
        ...
        // D s_3_12: read-var VLshadow#5589:i64
        let s_3_12: i64 = fn_state.VLshadow_5589;
