...
use ALUWritePC::*;
use common::*;
pub fn execute_aarch32_instrs_MOV_i_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    carry: bool,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_2: const #15s : i
        let s_0_2: i128 = 15;
        // D s_0_3: read-var d:i64
        let s_0_3: i64 = fn_state.d;
        // D s_0_4: cast zx s_0_3 -> i
        let s_0_4: i128 = (i128::try_from(s_0_3).unwrap());
        // D s_0_5: cmp-eq s_0_4 s_0_2
        let s_0_5: bool = ((s_0_4) == (s_0_2));
