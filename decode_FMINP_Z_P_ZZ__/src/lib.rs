...
extern crate alloc;
use CurrentVL_read::*;
use execute_FMINP_Z_P_ZZ__::*;
use HaveSVE2::*;
use HaveSME::*;
use common::*;
pub fn decode_FMINP_Z_P_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Pg: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#182038 <= s_1_0
        fn_state.gs_182038 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#182038:u8
        let s_2_0: bool = fn_state.gs_182038;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_7: call execute_FMINP_Z_P_ZZ__(s_5_0, s_5_4, s_5_3, s_5_5, s_5_6)
        let s_5_7: () = execute_FMINP_Z_P_ZZ__(
            state,
            tracer,
            s_5_0,
            s_5_4,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_7: call execute_FMINP_Z_P_ZZ__(s_7_0, s_7_4, s_7_3, s_7_5, s_7_6)
        let s_7_7: () = execute_FMINP_Z_P_ZZ__(
            state,
            tracer,
            s_7_0,
            s_7_4,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_7: call execute_FMINP_Z_P_ZZ__(s_9_0, s_9_4, s_9_3, s_9_5, s_9_6)
        let s_9_7: () = execute_FMINP_Z_P_ZZ__(
            state,
            tracer,
            s_9_0,
            s_9_4,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_7: call execute_FMINP_Z_P_ZZ__(s_11_0, s_11_4, s_11_3, s_11_5, s_11_6)
        let s_11_7: () = execute_FMINP_Z_P_ZZ__(
            state,
            tracer,
            s_11_0,
            s_11_4,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_7: call execute_FMINP_Z_P_ZZ__(s_13_0, s_13_4, s_13_3, s_13_5, s_13_6)
        let s_13_7: () = execute_FMINP_Z_P_ZZ__(
            state,
            tracer,
            s_13_0,
            s_13_4,
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_3: write-var gs#182038 <= s_17_2
        fn_state.gs_182038 = s_17_2;
        // N s_17_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
