...
use common::*;
pub fn decode_crc32_aarch64_instrs_integer_crc<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var gs#147757 <= s_2_0
        fn_state.gs_147757 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#147757:u8
        let s_3_0: bool = fn_state.gs_147757;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#147758 <= s_5_0
        fn_state.gs_147758 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#147758:u8
        let s_6_0: bool = fn_state.gs_147758;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_5: write-var gs#147758 <= s_9_4
        fn_state.gs_147758 = s_9_4;
        // N s_9_6: jump b6
        return block_6(state, tracer, fn_state);
    }
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_5: write-var gs#147757 <= s_11_4
        fn_state.gs_147757 = s_11_4;
        // N s_11_6: jump b3
        return block_3(state, tracer, fn_state);
    }
