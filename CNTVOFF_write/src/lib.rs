...
extern crate alloc;
use common::*;
pub fn CNTVOFF_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u64) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        let s_0_3: Bits = Bits::new(s_0_0 as u128, 64u16);
        ...
        let s_0_10: Bits = Bits::new(s_0_5 as u128, 64u16);
        // C s_0_11: const #63s : i
        let s_0_11: i128 = 63;
        ...
        // C s_0_23: const #22400u : u32
        let s_0_23: u32 = 22400;
        ...
        // C s_0_25: const #90992u : u32
        let s_0_25: u32 = 90992;
        // N s_0_26: write-reg s_0_25 <= s_0_0
        let s_0_26: () = {
            state.write_register::<u64>(s_0_25 as isize, s_0_0);
