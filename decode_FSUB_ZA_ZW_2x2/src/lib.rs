...
use CurrentVL_read::*;
use HaveSME2::*;
use execute_FSUB_ZA_ZW_2x2::*;
use HaveSMEF64F64::*;
use common::*;
pub fn decode_FSUB_ZA_ZW_2x2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    sz: bool,
    Rv: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var gs#264385 <= s_2_0
        fn_state.gs_264385 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#264385:u8
        let s_3_0: bool = fn_state.gs_264385;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_24: read-var Zm:u8
        let s_4_24: u8 = fn_state.Zm;
        ...
        // D s_4_40: write-var m <= s_4_39
        fn_state.m = s_4_39;
        // D s_4_41: read-var off3:u8
        let s_4_41: u8 = fn_state.off3;
        ...
        // D s_4_45: write-var offset <= s_4_44
        fn_state.offset = s_4_44;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_6: read-var offset:i64
        let s_5_6: i64 = fn_state.offset;
        // D s_5_7: read-var v:i64
        let s_5_7: i64 = fn_state.v;
        // D s_5_8: call execute_FSUB_ZA_ZW_2x2(s_5_0, s_5_3, s_5_5, s_5_4, s_5_6, s_5_7)
        let s_5_8: () = execute_FSUB_ZA_ZW_2x2(
            state,
            tracer,
            s_5_0,
            s_5_3,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_6: read-var offset:i64
        let s_7_6: i64 = fn_state.offset;
        // D s_7_7: read-var v:i64
        let s_7_7: i64 = fn_state.v;
        // D s_7_8: call execute_FSUB_ZA_ZW_2x2(s_7_0, s_7_3, s_7_5, s_7_4, s_7_6, s_7_7)
        let s_7_8: () = execute_FSUB_ZA_ZW_2x2(
            state,
            tracer,
            s_7_0,
            s_7_3,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_6: read-var offset:i64
        let s_9_6: i64 = fn_state.offset;
        // D s_9_7: read-var v:i64
        let s_9_7: i64 = fn_state.v;
        // D s_9_8: call execute_FSUB_ZA_ZW_2x2(s_9_0, s_9_3, s_9_5, s_9_4, s_9_6, s_9_7)
        let s_9_8: () = execute_FSUB_ZA_ZW_2x2(
            state,
            tracer,
            s_9_0,
            s_9_3,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_6: read-var offset:i64
        let s_11_6: i64 = fn_state.offset;
        // D s_11_7: read-var v:i64
        let s_11_7: i64 = fn_state.v;
        // D s_11_8: call execute_FSUB_ZA_ZW_2x2(s_11_0, s_11_3, s_11_5, s_11_4, s_11_6, s_11_7)
        let s_11_8: () = execute_FSUB_ZA_ZW_2x2(
            state,
            tracer,
            s_11_0,
            s_11_3,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_6: read-var offset:i64
        let s_13_6: i64 = fn_state.offset;
        // D s_13_7: read-var v:i64
        let s_13_7: i64 = fn_state.v;
        // D s_13_8: call execute_FSUB_ZA_ZW_2x2(s_13_0, s_13_3, s_13_5, s_13_4, s_13_6, s_13_7)
        let s_13_8: () = execute_FSUB_ZA_ZW_2x2(
            state,
            tracer,
            s_13_0,
            s_13_3,
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_3: write-var gs#264385 <= s_16_2
        fn_state.gs_264385 = s_16_2;
        // N s_16_4: jump b3
        return block_3(state, tracer, fn_state);
    }
