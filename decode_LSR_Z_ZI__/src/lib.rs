...
use HaveSVE::*;
use CurrentVL_read::*;
use execute_LSR_Z_ZI__::*;
use HaveSME::*;
use common::*;
pub fn decode_LSR_Z_ZI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    tszh: u8,
    tszl: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#199335 <= s_1_0
        fn_state.gs_199335 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#199335:u8
        let s_2_0: bool = fn_state.gs_199335;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var esizeshadow#3095 <= s_7_0
        fn_state.esizeshadow_3095 = s_7_0;
        ...
        // C s_7_12: const #2s : i
        let s_7_12: i128 = 2;
        // D s_7_13: read-var esizeshadow#3095:i64
        let s_7_13: i64 = fn_state.esizeshadow_3095;
        ...
        // D s_7_38: read-var esizeshadow#3095:i64
        let s_7_38: i64 = fn_state.esizeshadow_3095;
        // C s_7_39: const #8s : i
        let s_7_39: i128 = 8;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_6: call execute_LSR_Z_ZI__(s_9_0, s_9_4, s_9_1, s_9_5, s_9_3)
        let s_9_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_9_0,
            s_9_4,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_6: call execute_LSR_Z_ZI__(s_11_0, s_11_4, s_11_1, s_11_5, s_11_3)
        let s_11_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_11_0,
            s_11_4,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_6: call execute_LSR_Z_ZI__(s_13_0, s_13_4, s_13_1, s_13_5, s_13_3)
        let s_13_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_13_0,
            s_13_4,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_6: call execute_LSR_Z_ZI__(s_15_0, s_15_4, s_15_1, s_15_5, s_15_3)
        let s_15_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_15_0,
            s_15_4,
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_6: call execute_LSR_Z_ZI__(s_17_0, s_17_4, s_17_1, s_17_5, s_17_3)
        let s_17_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_17_0,
            s_17_4,
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var esizeshadow#3095:i64
        let s_19_0: i64 = fn_state.esizeshadow_3095;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_6: call execute_LSR_Z_ZI__(s_21_0, s_21_4, s_21_1, s_21_5, s_21_3)
        let s_21_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_21_0,
            s_21_4,
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_6: call execute_LSR_Z_ZI__(s_23_0, s_23_4, s_23_1, s_23_5, s_23_3)
        let s_23_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_23_0,
            s_23_4,
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_6: call execute_LSR_Z_ZI__(s_25_0, s_25_4, s_25_1, s_25_5, s_25_3)
        let s_25_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_25_0,
            s_25_4,
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_6: call execute_LSR_Z_ZI__(s_27_0, s_27_4, s_27_1, s_27_5, s_27_3)
        let s_27_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_27_0,
            s_27_4,
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_6: call execute_LSR_Z_ZI__(s_29_0, s_29_4, s_29_1, s_29_5, s_29_3)
        let s_29_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_29_0,
            s_29_4,
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_0: read-var esizeshadow#3095:i64
        let s_31_0: i64 = fn_state.esizeshadow_3095;
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_6: call execute_LSR_Z_ZI__(s_33_0, s_33_4, s_33_1, s_33_5, s_33_3)
        let s_33_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_33_0,
            s_33_4,
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_6: call execute_LSR_Z_ZI__(s_35_0, s_35_4, s_35_1, s_35_5, s_35_3)
        let s_35_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_35_0,
            s_35_4,
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_6: call execute_LSR_Z_ZI__(s_37_0, s_37_4, s_37_1, s_37_5, s_37_3)
        let s_37_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_37_0,
            s_37_4,
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_6: call execute_LSR_Z_ZI__(s_39_0, s_39_4, s_39_1, s_39_5, s_39_3)
        let s_39_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_39_0,
            s_39_4,
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_6: call execute_LSR_Z_ZI__(s_41_0, s_41_4, s_41_1, s_41_5, s_41_3)
        let s_41_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_41_0,
            s_41_4,
    ...
    fn block_43<T: Tracer>(
        ...
        // D s_43_0: read-var esizeshadow#3095:i64
        let s_43_0: i64 = fn_state.esizeshadow_3095;
    ...
    fn block_45<T: Tracer>(
        ...
        // D s_45_6: call execute_LSR_Z_ZI__(s_45_0, s_45_4, s_45_1, s_45_5, s_45_3)
        let s_45_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_45_0,
            s_45_4,
    ...
    fn block_47<T: Tracer>(
        ...
        // D s_47_6: call execute_LSR_Z_ZI__(s_47_0, s_47_4, s_47_1, s_47_5, s_47_3)
        let s_47_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_47_0,
            s_47_4,
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_6: call execute_LSR_Z_ZI__(s_49_0, s_49_4, s_49_1, s_49_5, s_49_3)
        let s_49_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_49_0,
            s_49_4,
    ...
    fn block_51<T: Tracer>(
        ...
        // D s_51_6: call execute_LSR_Z_ZI__(s_51_0, s_51_4, s_51_1, s_51_5, s_51_3)
        let s_51_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_51_0,
            s_51_4,
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_6: call execute_LSR_Z_ZI__(s_53_0, s_53_4, s_53_1, s_53_5, s_53_3)
        let s_53_6: () = execute_LSR_Z_ZI__(
            state,
            tracer,
            s_53_0,
            s_53_4,
    ...
    fn block_62<T: Tracer>(
        ...
        // D s_62_3: write-var gs#199335 <= s_62_2
        fn_state.gs_199335 = s_62_2;
        // N s_62_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
