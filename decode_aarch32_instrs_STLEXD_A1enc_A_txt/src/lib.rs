...
use common::*;
pub fn decode_aarch32_instrs_STLEXD_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        fn_state.d = s_2_9;
        // D s_2_11: read-var Rt:u8
        let s_2_11: u8 = fn_state.Rt;
        ...
        // D s_2_15: write-var t <= s_2_14
        fn_state.t = s_2_14;
        // C s_2_16: const #1s : i
        let s_2_16: i128 = 1;
        // D s_2_17: read-var t:i64
        let s_2_17: i64 = fn_state.t;
        ...
        fn_state.t2 = s_2_20;
        // D s_2_22: read-var Rn:u8
        let s_2_22: u8 = fn_state.Rn;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_22: write-var gs#324977 <= s_3_21
        fn_state.gs_324977 = s_3_21;
        // N s_3_23: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#324977:u8
        let s_4_0: bool = fn_state.gs_324977;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#324979 <= s_5_3
        fn_state.gs_324979 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#324979:u8
        let s_6_0: bool = fn_state.gs_324979;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#324981 <= s_7_3
        fn_state.gs_324981 = s_7_3;
        // N s_7_5: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#324981:u8
        let s_8_0: bool = fn_state.gs_324981;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: write-var gs#324982 <= s_10_4
        fn_state.gs_324982 = s_10_4;
        // N s_10_6: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#324982:u8
        let s_11_0: bool = fn_state.gs_324982;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#324983 <= s_12_4
        fn_state.gs_324983 = s_12_4;
        // N s_12_6: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#324983:u8
        let s_13_0: bool = fn_state.gs_324983;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#324983 <= s_16_0
        fn_state.gs_324983 = s_16_0;
        // N s_16_2: jump b13
        return block_13(state, tracer, fn_state);
    }
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#324982 <= s_17_0
        fn_state.gs_324982 = s_17_0;
        // N s_17_2: jump b11
        return block_11(state, tracer, fn_state);
    }
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#324981 <= s_19_0
        fn_state.gs_324981 = s_19_0;
        // N s_19_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#324979 <= s_20_0
        fn_state.gs_324979 = s_20_0;
        // N s_20_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#324977 <= s_21_0
        fn_state.gs_324977 = s_21_0;
        // N s_21_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
