...
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_unary_cmp_int_bulk_sisd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    comparison: u32,
    d: i64,
    ...
    struct FunctionState {
        ...
        result: Bits,
        test_passed: bool,
        datasizeshadow_1121: i64,
        ga_251106: i64,
        ga_251107: Bits,
        esizeshadow_1120: i64,
        comparison: u32,
        d: i64,
        datasize: i64,
        elements: i128,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#1120 <= s_0_2
        fn_state.esizeshadow_1120 = s_0_2;
        ...
        // D s_0_7: write-var datasizeshadow#1121 <= s_0_6
        fn_state.datasizeshadow_1121 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var datasizeshadow#1121:i64
        let s_1_0: i64 = fn_state.datasizeshadow_1121;
        ...
        // D s_1_12: write-var gs#145989 <= s_1_11
        fn_state.gs_145989 = s_1_11;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#145989:i64
        let s_2_1: i64 = fn_state.gs_145989;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var esizeshadow#1120:i64
        let s_3_0: i64 = fn_state.esizeshadow_1120;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var esizeshadow#1120:i64
        let s_5_0: i64 = fn_state.esizeshadow_1120;
        // D s_5_1: cast zx s_5_0 -> i
        let s_5_1: i128 = (i128::try_from(s_5_0).unwrap());
        // D s_5_2: cast reint s_5_1 -> i64
        let s_5_2: i64 = (s_5_1 as i64);
        // D s_5_3: write-var ga#251106 <= s_5_2
        fn_state.ga_251106 = s_5_2;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var esizeshadow#1120:i64
        let s_6_0: i64 = fn_state.esizeshadow_1120;
        // D s_6_1: cast zx s_6_0 -> i
        let s_6_1: i128 = (i128::try_from(s_6_0).unwrap());
        // D s_6_2: call Zeros(s_6_1)
        let s_6_2: Bits = Zeros(state, tracer, s_6_1);
        // D s_6_3: write-var ga#251107 <= s_6_2
        fn_state.ga_251107 = s_6_2;
        // N s_6_4: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_2: read-var ga#251106:i64
        let s_7_2: i64 = fn_state.ga_251106;
        // D s_7_3: cast zx s_7_2 -> i
        let s_7_3: i128 = (i128::try_from(s_7_2).unwrap());
        // D s_7_4: read-var result:bv
        let s_7_4: Bits = fn_state.result;
        // D s_7_5: read-var ga#251107:bv
        let s_7_5: Bits = fn_state.ga_251107;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var esizeshadow#1120:i64
        let s_8_0: i64 = fn_state.esizeshadow_1120;
        // D s_8_1: cast zx s_8_0 -> i
        let s_8_1: i128 = (i128::try_from(s_8_0).unwrap());
        // D s_8_2: call Ones(s_8_1)
        let s_8_2: Bits = Ones(state, tracer, s_8_1);
        // D s_8_3: write-var ga#251107 <= s_8_2
        fn_state.ga_251107 = s_8_2;
        // N s_8_4: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var datasizeshadow#1121:i64
        let s_18_0: i64 = fn_state.datasizeshadow_1121;
