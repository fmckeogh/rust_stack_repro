...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_binary_uniform_max_min_fp16_1985::*;
use common::*;
pub fn decode_fminp_advsimd_vec_aarch64_instrs_vector_arithmetic_binary_uniform_max_min_fp_1985<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 64;
        // D s_2_1: write-var ga#255166 <= s_2_0
        fn_state.ga_255166 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#255166:i64
        let s_3_0: i64 = fn_state.ga_255166;
        ...
        // D s_3_11: read-var o1:u8
        let s_3_11: bool = fn_state.o1;
        ...
        // D s_3_21: cast zx s_3_5 -> i
        let s_3_21: i128 = (i128::try_from(s_3_5).unwrap());
        // D s_3_22: read-var d:i64
        let s_3_22: i64 = fn_state.d;
        // D s_3_23: read-var m:i64
        let s_3_23: i64 = fn_state.m;
        // D s_3_24: read-var n:i64
        let s_3_24: i64 = fn_state.n;
        // D s_3_25: call execute_aarch64_instrs_vector_arithmetic_binary_uniform_max_min_fp16_1985(s_3_22, s_3_17, s_3_21, s_3_20, s_3_23, s_3_15, s_3_24, s_3_10)
        let s_3_25: () = execute_aarch64_instrs_vector_arithmetic_binary_uniform_max_min_fp16_1985(
            state,
            tracer,
            s_3_22,
            s_3_17,
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 128;
        // D s_4_1: write-var ga#255166 <= s_4_0
        fn_state.ga_255166 = s_4_0;
        // N s_4_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_5<T: Tracer>(
