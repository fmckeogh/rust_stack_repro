...
use asl_Int::*;
use CurrentVL_read::*;
use execute_UMIN_Z_ZI__::*;
use HaveSME::*;
use common::*;
pub fn decode_UMIN_Z_ZI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    U: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#185623 <= s_1_0
        fn_state.gs_185623 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#185623:u8
        let s_2_0: bool = fn_state.gs_185623;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_15: call asl_Int(s_3_13, s_3_14)
        let s_3_15: i128 = asl_Int(state, tracer, s_3_13, s_3_14);
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_5: read-var imm:i
        let s_4_5: i128 = fn_state.imm;
        // C s_4_6: const #1u : u8
        let s_4_6: bool = true;
        // D s_4_7: call execute_UMIN_Z_ZI__(s_4_0, s_4_4, s_4_3, s_4_5, s_4_6)
        let s_4_7: () = execute_UMIN_Z_ZI__(
            state,
            tracer,
            s_4_0,
            s_4_4,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: read-var imm:i
        let s_6_5: i128 = fn_state.imm;
        // C s_6_6: const #1u : u8
        let s_6_6: bool = true;
        // D s_6_7: call execute_UMIN_Z_ZI__(s_6_0, s_6_4, s_6_3, s_6_5, s_6_6)
        let s_6_7: () = execute_UMIN_Z_ZI__(
            state,
            tracer,
            s_6_0,
            s_6_4,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_5: read-var imm:i
        let s_8_5: i128 = fn_state.imm;
        // C s_8_6: const #1u : u8
        let s_8_6: bool = true;
        // D s_8_7: call execute_UMIN_Z_ZI__(s_8_0, s_8_4, s_8_3, s_8_5, s_8_6)
        let s_8_7: () = execute_UMIN_Z_ZI__(
            state,
            tracer,
            s_8_0,
            s_8_4,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: read-var imm:i
        let s_10_5: i128 = fn_state.imm;
        // C s_10_6: const #1u : u8
        let s_10_6: bool = true;
        // D s_10_7: call execute_UMIN_Z_ZI__(s_10_0, s_10_4, s_10_3, s_10_5, s_10_6)
        let s_10_7: () = execute_UMIN_Z_ZI__(
            state,
            tracer,
            s_10_0,
            s_10_4,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: read-var imm:i
        let s_12_5: i128 = fn_state.imm;
        // C s_12_6: const #1u : u8
        let s_12_6: bool = true;
        // D s_12_7: call execute_UMIN_Z_ZI__(s_12_0, s_12_4, s_12_3, s_12_5, s_12_6)
        let s_12_7: () = execute_UMIN_Z_ZI__(
            state,
            tracer,
            s_12_0,
            s_12_4,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#185623 <= s_15_2
        fn_state.gs_185623 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
