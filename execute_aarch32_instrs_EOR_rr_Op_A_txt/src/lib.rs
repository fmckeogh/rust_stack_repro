...
use IsZeroBit::*;
use common::*;
pub fn execute_aarch32_instrs_EOR_rr_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        carry: bool,
        result: u32,
        gs_879006: ProductTypef506aa96a892fe52,
        d: i64,
        m: i64,
        n: i64,
        s: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_23: write-var gs#879006 <= s_0_22
        fn_state.gs_879006 = s_0_22;
        // D s_0_24: read-var gs#879006.0:struct
        let s_0_24: Bits = fn_state.gs_879006._0;
        // D s_0_25: cast reint s_0_24 -> u32
        let s_0_25: u32 = (s_0_24.value() as u32);
        // D s_0_26: read-var gs#879006.1:struct
        let s_0_26: bool = fn_state.gs_879006._1;
        ...
        let s_0_31: Bits = Bits::new(s_0_30 as u128, 32u16);
        // D s_0_32: cast zx s_0_25 -> bv
        let s_0_32: Bits = Bits::new(s_0_25 as u128, 32u16);
        // D s_0_33: xor s_0_31 s_0_32
        let s_0_33: Bits = ((s_0_31) ^ (s_0_32));
        // D s_0_34: cast reint s_0_33 -> u32
        let s_0_34: u32 = (s_0_33.value() as u32);
        // D s_0_35: write-var result <= s_0_34
        fn_state.result = s_0_34;
        // D s_0_36: read-var d:i64
        let s_0_36: i64 = fn_state.d;
        // D s_0_37: cast zx s_0_36 -> i
        let s_0_37: i128 = (i128::try_from(s_0_36).unwrap());
        // D s_0_38: read-var result:u32
        let s_0_38: u32 = fn_state.result;
        // D s_0_39: call R_set(s_0_37, s_0_38)
        let s_0_39: () = R_set(state, tracer, s_0_37, s_0_38);
