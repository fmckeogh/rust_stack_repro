...
extern crate alloc;
use Mk_ID_AA64ZFR0_EL1_Type::*;
use common::*;
pub fn u__get_ID_AA64ZFR0_EL1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #17298045728572112640u : u64
        let s_0_3: u64 = 17298045728572112640;
        ...
        // D s_0_11: tail-call Mk_ID_AA64ZFR0_EL1_Type(s_0_10)
        return Mk_ID_AA64ZFR0_EL1_Type(state, tracer, s_0_10);
    }
}
