...
use EL2Enabled::*;
use common::*;
pub fn AArch64_PACFailException<T: Tracer>(
    state: &mut State,
    tracer: &T,
    syndrome: u8,
) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#14765 <= s_1_0
        fn_state.gs_14765 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#14765:u8
        let s_2_0: bool = fn_state.gs_14765;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#14766 <= s_3_0
        fn_state.gs_14766 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#14766:u8
        let s_4_0: bool = fn_state.gs_14766;
        ...
        // D s_4_15: read-var except:struct
        let s_4_15: ProductTypeb7f99f96751e17c4 = fn_state.except;
        // D s_4_16: write-var except <= s_4_15
        fn_state.except = s_4_15;
        // C s_4_17: const #23s : i
        let s_4_17: i128 = 23;
        // S s_4_18: call Zeros(s_4_17)
        let s_4_18: Bits = Zeros(state, tracer, s_4_17);
        // D s_4_19: read-var except:struct
        let s_4_19: ProductTypeb7f99f96751e17c4 = fn_state.except;
        // D s_4_20: write-var except <= s_4_19
        fn_state.except = s_4_19;
        // C s_4_21: const #16975u : u32
        let s_4_21: u32 = 16975;
        // D s_4_22: read-reg s_4_21:u8
        let s_4_22: u8 = {
            let value = state.read_register::<u8>(s_4_21 as isize);
            tracer.read_register(s_4_21 as isize, value);
            value
        };
        // D s_4_23: cast zx s_4_22 -> bv
        let s_4_23: Bits = Bits::new(s_4_22 as u128, 2u16);
        ...
        // D s_4_31: cast zx s_4_25 -> i
        let s_4_31: i128 = (i128::try_from(s_4_25).unwrap());
        // D s_4_32: cast zx s_4_30 -> i
        let s_4_32: i128 = (i128::try_from(s_4_30).unwrap());
        // D s_4_33: cmp-gt s_4_31 s_4_32
        let s_4_33: bool = ((s_4_31) > (s_4_32));
        // N s_4_34: branch s_4_33 b8 b5
        if s_4_33 {
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_7: write-var gs#14766 <= s_9_6
        fn_state.gs_14766 = s_9_6;
        // N s_9_8: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_10<T: Tracer>(
        ...
        // D s_10_2: write-var gs#14765 <= s_10_1
        fn_state.gs_14765 = s_10_1;
        // N s_10_3: jump b2
        return block_2(state, tracer, fn_state);
    }
}
