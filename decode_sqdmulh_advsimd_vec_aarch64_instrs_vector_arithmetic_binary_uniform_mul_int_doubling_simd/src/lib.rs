...
use common::*;
pub fn decode_sqdmulh_advsimd_vec_aarch64_instrs_vector_arithmetic_binary_uniform_mul_int_doubling_simd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_5: write-var gs#170797 <= s_1_4
        fn_state.gs_170797 = s_1_4;
        // N s_1_6: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#170797:u8
        let s_2_0: bool = fn_state.gs_170797;
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 64;
        // D s_4_1: write-var ga#267435 <= s_4_0
        fn_state.ga_267435 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var ga#267435:i64
        let s_5_0: i64 = fn_state.ga_267435;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 128;
        // D s_6_1: write-var ga#267435 <= s_6_0
        fn_state.ga_267435 = s_6_0;
        // N s_6_2: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #1u : u8
        let s_8_0: bool = true;
        // D s_8_1: write-var gs#170797 <= s_8_0
        fn_state.gs_170797 = s_8_0;
        // N s_8_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
