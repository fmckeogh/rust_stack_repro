...
use u__ConfigureV89::*;
use common::*;
pub fn u__ConfigureV94<T: Tracer>(state: &mut State, tracer: &T, enabled: bool) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_1: const #101792u : u32
        let s_0_1: u32 = 101792;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: call __ConfigureV93(s_2_0)
        let s_2_1: () = u__ConfigureV93(state, tracer, s_2_0);
        // D s_2_2: read-var enabled:u8
        let s_2_2: bool = fn_state.enabled;
        // D s_2_3: call __ConfigureV89(s_2_2)
        let s_2_3: () = u__ConfigureV89(state, tracer, s_2_2);
        // N s_2_4: return
        return;
    }
}
