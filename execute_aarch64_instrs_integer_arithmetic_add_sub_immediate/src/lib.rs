...
use AddWithCarry::*;
use common::*;
pub fn execute_aarch64_instrs_integer_arithmetic_add_sub_immediate<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    datasize: i64,
    ...
    struct FunctionState {
        nzcv: u8,
        gs_142984: bool,
        datasizeshadow_1024: i64,
        carry_in: bool,
        ga_249137: ProductTyped54bc449dd09e5bd,
        result: Bits,
        operand1: Bits,
        operand2: Bits,
        d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var datasizeshadow#1024 <= s_0_2
        fn_state.datasizeshadow_1024 = s_0_2;
        // C s_0_4: const #31s : i
        let s_0_4: i128 = 31;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var datasizeshadow#1024:i64
        let s_1_0: i64 = fn_state.datasizeshadow_1024;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var operand2 <= s_2_0
        fn_state.operand2 = s_2_0;
        // D s_2_2: read-var sub_op:u8
        let s_2_2: bool = fn_state.sub_op;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: write-var ga#249137 <= s_4_3
        fn_state.ga_249137 = s_4_3;
        // D s_4_5: read-var ga#249137.0:struct
        let s_4_5: Bits = fn_state.ga_249137._0;
        // D s_4_6: read-var ga#249137.1:struct
        let s_4_6: u8 = fn_state.ga_249137._1;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#142984 <= s_7_0
        fn_state.gs_142984 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#142984:u8
        let s_8_0: bool = fn_state.gs_142984;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var datasizeshadow#1024:i64
        let s_9_0: i64 = fn_state.datasizeshadow_1024;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_2: write-var gs#142984 <= s_11_1
        fn_state.gs_142984 = s_11_1;
        // N s_11_3: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // C s_14_2: const #1s : i
        let s_14_2: i128 = 1;
        // D s_14_3: read-var datasizeshadow#1024:i64
        let s_14_3: i64 = fn_state.datasizeshadow_1024;
