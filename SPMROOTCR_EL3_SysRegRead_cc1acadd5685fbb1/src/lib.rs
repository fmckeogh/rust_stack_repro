...
use SPMROOTCR_EL3_read::*;
use X_set::*;
use common::*;
pub fn SPMROOTCR_EL3_SysRegRead_cc1acadd5685fbb1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_8: call SPMROOTCR_EL3_read(s_5_7)
        let s_5_8: u64 = SPMROOTCR_EL3_read(state, tracer, s_5_7);
