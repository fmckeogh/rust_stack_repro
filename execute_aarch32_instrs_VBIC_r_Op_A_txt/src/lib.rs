...
use D_read::*;
use common::*;
pub fn execute_aarch32_instrs_VBIC_r_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_6: write-var gs#306580 <= s_1_5
        fn_state.gs_306580 = s_1_5;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#306580:i64
        let s_2_1: i64 = fn_state.gs_306580;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_23: not s_3_22
        let s_3_23: Bits = !s_3_22;
        // D s_3_24: cast reint s_3_23 -> u64
        let s_3_24: u64 = (s_3_23.value() as u64);
        // D s_3_25: cast zx s_3_13 -> bv
        let s_3_25: Bits = Bits::new(s_3_13 as u128, 64u16);
        // D s_3_26: cast zx s_3_24 -> bv
        let s_3_26: Bits = Bits::new(s_3_24 as u128, 64u16);
        // D s_3_27: and s_3_25 s_3_26
        let s_3_27: Bits = ((s_3_25) & (s_3_26));
        // D s_3_28: cast reint s_3_27 -> u64
        let s_3_28: u64 = (s_3_27.value() as u64);
        // D s_3_29: cast zx s_3_5 -> i
        let s_3_29: i128 = (i128::try_from(s_3_5).unwrap());
        // D s_3_30: call D_set(s_3_29, s_3_28)
        let s_3_30: () = D_set(state, tracer, s_3_29, s_3_28);
        // D s_3_31: read-var r:i64
        let s_3_31: i64 = fn_state.r;
        // C s_3_32: const #1s : i64
        let s_3_32: i64 = 1;
        // D s_3_33: add s_3_31 s_3_32
        let s_3_33: i64 = (s_3_31 + s_3_32);
        // D s_3_34: write-var r <= s_3_33
        fn_state.r = s_3_33;
        // N s_3_35: jump b2
        return block_2(state, tracer, fn_state);
    }
