...
use common::*;
pub fn decode_aarch32_instrs_VSHLL_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    U: bool,
    D: bool,
    ...
    struct FunctionState {
        esize: i64,
        gs_318945: bool,
        shift_amountshadow_7804: i128,
        esizeshadow_7805: i64,
        elementsshadow_7806: i64,
        elements: i64,
        shift_amount: i128,
        U: bool,
        D: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_0: const #1u : u8
        let s_3_0: bool = true;
        // D s_3_1: write-var gs#318945 <= s_3_0
        fn_state.gs_318945 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#318945:u8
        let s_4_0: bool = fn_state.gs_318945;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var shift_amountshadow#7804 <= s_8_0
        fn_state.shift_amountshadow_7804 = s_8_0;
        // D s_8_2: read-var esize:i64
        let s_8_2: i64 = fn_state.esize;
        // D s_8_3: write-var esizeshadow#7805 <= s_8_2
        fn_state.esizeshadow_7805 = s_8_2;
        // D s_8_4: read-var elements:i64
        let s_8_4: i64 = fn_state.elements;
        // D s_8_5: write-var elementsshadow#7806 <= s_8_4
        fn_state.elementsshadow_7806 = s_8_4;
        // C s_8_6: const #0s : i
        let s_8_6: i128 = 0;
        // D s_8_7: read-var shift_amountshadow#7804:i
        let s_8_7: i128 = fn_state.shift_amountshadow_7804;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var shift_amountshadow#7804:i
        let s_9_0: i128 = fn_state.shift_amountshadow_7804;
        ...
        // D s_9_38: read-var esizeshadow#7805:i64
        let s_9_38: i64 = fn_state.esizeshadow_7805;
        ...
        // D s_9_41: read-var elementsshadow#7806:i64
        let s_9_41: i64 = fn_state.elementsshadow_7806;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#318945 <= s_18_0
        fn_state.gs_318945 = s_18_0;
        // N s_18_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
