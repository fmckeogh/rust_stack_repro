...
use common::*;
pub fn decode_aarch32_instrs_MCRR_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt2: u8,
    Rt: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 15;
        // D s_3_1: write-var ga#344978 <= s_3_0
        fn_state.ga_344978 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#344978:i64
        let s_4_0: i64 = fn_state.ga_344978;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#298446 <= s_5_3
        fn_state.gs_298446 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#298446:u8
        let s_6_0: bool = fn_state.gs_298446;
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#298446 <= s_9_0
        fn_state.gs_298446 = s_9_0;
        // N s_9_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 14;
        // D s_10_1: write-var ga#344978 <= s_10_0
        fn_state.ga_344978 = s_10_0;
        // N s_10_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
