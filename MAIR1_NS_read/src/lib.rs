...
pub fn MAIR1_NS_read<T: Tracer>(
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_4: write-var gs#27509 <= s_2_3
        fn_state.gs_27509 = s_2_3;
        // N s_2_5: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#27509:u8
        let s_3_0: bool = fn_state.gs_27509;
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #1u : u8
        let s_7_0: bool = true;
        // D s_7_1: write-var gs#27509 <= s_7_0
        fn_state.gs_27509 = s_7_0;
        // N s_7_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
