...
extern crate alloc;
use HaveSVE::*;
use execute_FADDA_V_P_Z__::*;
use CurrentVL_read::*;
use common::*;
pub fn decode_FADDA_V_P_Z__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Pg: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_7: read-var Pg:u8
        let s_2_7: u8 = fn_state.Pg;
        ...
        // D s_2_11: write-var g <= s_2_10
        fn_state.g = s_2_10;
        // D s_2_12: read-var Vdn:u8
        let s_2_12: u8 = fn_state.Vdn;
        ...
        // D s_2_16: write-var dn <= s_2_15
        fn_state.dn = s_2_15;
        // D s_2_17: read-var Zm:u8
        let s_2_17: u8 = fn_state.Zm;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_5: read-var g:i64
        let s_3_5: i64 = fn_state.g;
        // D s_3_6: read-var m:i64
        let s_3_6: i64 = fn_state.m;
        // D s_3_7: call execute_FADDA_V_P_Z__(s_3_0, s_3_4, s_3_3, s_3_5, s_3_6)
        let s_3_7: () = execute_FADDA_V_P_Z__(
            state,
            tracer,
            s_3_0,
            s_3_4,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_7: call execute_FADDA_V_P_Z__(s_5_0, s_5_4, s_5_3, s_5_5, s_5_6)
        let s_5_7: () = execute_FADDA_V_P_Z__(
            state,
            tracer,
            s_5_0,
            s_5_4,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_7: call execute_FADDA_V_P_Z__(s_7_0, s_7_4, s_7_3, s_7_5, s_7_6)
        let s_7_7: () = execute_FADDA_V_P_Z__(
            state,
            tracer,
            s_7_0,
            s_7_4,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_7: call execute_FADDA_V_P_Z__(s_9_0, s_9_4, s_9_3, s_9_5, s_9_6)
        let s_9_7: () = execute_FADDA_V_P_Z__(
            state,
            tracer,
            s_9_0,
            s_9_4,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_7: call execute_FADDA_V_P_Z__(s_11_0, s_11_4, s_11_3, s_11_5, s_11_6)
        let s_11_7: () = execute_FADDA_V_P_Z__(
            state,
            tracer,
            s_11_0,
            s_11_4,
