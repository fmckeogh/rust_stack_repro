...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_STRH_r_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_STRH_r_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    P: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#302834 <= s_3_0
        fn_state.gs_302834 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#302834:u8
        let s_4_0: bool = fn_state.gs_302834;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: write-var gs#302839 <= s_6_4
        fn_state.gs_302839 = s_6_4;
        // N s_6_6: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#302839:u8
        let s_7_0: bool = fn_state.gs_302839;
        ...
        // D s_7_12: write-var shift_nshadow#7283 <= s_7_11
        fn_state.shift_nshadow_7283 = s_7_11;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: write-var gs#302849 <= s_8_3
        fn_state.gs_302849 = s_8_3;
        // N s_8_5: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#302849:u8
        let s_9_0: bool = fn_state.gs_302849;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#302852 <= s_11_0
        fn_state.gs_302852 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#302852:u8
        let s_12_0: bool = fn_state.gs_302852;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_4: read-var shift_nshadow#7283:i
        let s_13_4: i128 = fn_state.shift_nshadow_7283;
        ...
        // D s_13_8: call execute_aarch32_instrs_STRH_r_Op_A_txt(s_13_0, s_13_1, s_13_2, s_13_3, s_13_4, s_13_5, s_13_6, s_13_7)
        let s_13_8: () = execute_aarch32_instrs_STRH_r_Op_A_txt(
            state,
            tracer,
            s_13_0,
            s_13_1,
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_5: write-var gs#302851 <= s_16_4
        fn_state.gs_302851 = s_16_4;
        // N s_16_6: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#302851:u8
        let s_17_0: bool = fn_state.gs_302851;
        // D s_17_1: write-var gs#302852 <= s_17_0
        fn_state.gs_302852 = s_17_0;
        // N s_17_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#302851 <= s_18_0
        fn_state.gs_302851 = s_18_0;
        // N s_18_2: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#302849 <= s_20_0
        fn_state.gs_302849 = s_20_0;
        // N s_20_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#302839 <= s_21_0
        fn_state.gs_302839 = s_21_0;
        // N s_21_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_5: write-var gs#302834 <= s_23_4
        fn_state.gs_302834 = s_23_4;
        // N s_23_6: jump b4
        return block_4(state, tracer, fn_state);
    }
}
