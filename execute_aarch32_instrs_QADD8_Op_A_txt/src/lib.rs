...
use SignedSat::*;
use common::*;
pub fn execute_aarch32_instrs_QADD8_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_134: call SignedSat(s_0_132, s_0_133)
        let s_0_134: Bits = SignedSat(state, tracer, s_0_132, s_0_133);
        ...
        // D s_0_160: call SignedSat(s_0_158, s_0_159)
        let s_0_160: Bits = SignedSat(state, tracer, s_0_158, s_0_159);
        ...
        // D s_0_186: call SignedSat(s_0_184, s_0_185)
        let s_0_186: Bits = SignedSat(state, tracer, s_0_184, s_0_185);
        ...
        // D s_0_212: call SignedSat(s_0_210, s_0_211)
        let s_0_212: Bits = SignedSat(state, tracer, s_0_210, s_0_211);
