...
use common::*;
pub fn execute_BRKA_P_P_P__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_48: write-var gs#197798 <= s_1_47
        fn_state.gs_197798 = s_1_47;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#197798:i64
        let s_2_1: i64 = fn_state.gs_197798;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#197803 <= s_11_0
        fn_state.gs_197803 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#197803:u8
        let s_12_0: bool = fn_state.gs_197803;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#197803 <= s_13_0
        fn_state.gs_197803 = s_13_0;
        // N s_13_2: jump b12
        return block_12(state, tracer, fn_state);
    }
