...
use common::*;
pub fn decode_aarch32_instrs_STREX_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    Rt: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_21: call place_slice(s_2_15, s_2_20, s_2_16, s_2_17, s_2_18)
        let s_2_21: Bits = place_slice(
            state,
            tracer,
            s_2_15,
            s_2_20,
        ...
        // D s_2_23: write-var imm32 <= s_2_22
        fn_state.imm32 = s_2_22;
        // C s_2_24: const #15s : i
        let s_2_24: i128 = 15;
        // D s_2_25: read-var d:i64
        let s_2_25: i64 = fn_state.d;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#302622 <= s_3_3
        fn_state.gs_302622 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#302622:u8
        let s_4_0: bool = fn_state.gs_302622;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#302624 <= s_5_3
        fn_state.gs_302624 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#302624:u8
        let s_6_0: bool = fn_state.gs_302624;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_5: write-var gs#302625 <= s_8_4
        fn_state.gs_302625 = s_8_4;
        // N s_8_6: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#302625:u8
        let s_9_0: bool = fn_state.gs_302625;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#302625 <= s_12_0
        fn_state.gs_302625 = s_12_0;
        // N s_12_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#302624 <= s_14_0
        fn_state.gs_302624 = s_14_0;
        // N s_14_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#302622 <= s_15_0
        fn_state.gs_302622 = s_15_0;
        // N s_15_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
