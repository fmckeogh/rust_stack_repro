...
use u__get_GCSCRE0_EL1::*;
use u_get_HFGRTR_EL2_Type_nGCS_EL0::*;
use common::*;
pub fn GCSCRE0_EL1_SysRegRead_0250ee8c94b04721<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ...
        gs_61766: bool,
        gs_61767: bool,
        ga_65763: ProductType5c790c8ef59cc8b2,
        u__EDSCR_SDD: bool,
        gs_61770: bool,
        u__SCR_EL3_FGTEn: bool,
        gs_61760: bool,
        ga_65759: ProductType5c790c8ef59cc8b2,
        gs_61775: bool,
        u__PSTATE_EL: u8,
        ...
        gs_61764: bool,
        gs_61761: bool,
        ga_65743: ProductType5c790c8ef59cc8b2,
        el: u8,
        op0: u8,
        op1: u8,
        CRn: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_17: call _get_HFGRTR_EL2_Type_nGCS_EL0(s_0_16)
        let s_0_17: bool = u_get_HFGRTR_EL2_Type_nGCS_EL0(state, tracer, s_0_16);
        // D s_0_18: write-var __HFGRTR_EL2_nGCS_EL0 <= s_0_17
        fn_state.u__HFGRTR_EL2_nGCS_EL0 = s_0_17;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call __get_GCSCRE0_EL1(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_GCSCRE0_EL1(
            state,
            tracer,
            s_5_2,
        );
        // D s_5_4: write-var ga#65763 <= s_5_3
        fn_state.ga_65763 = s_5_3;
        // D s_5_5: read-var ga#65763.0:struct
        let s_5_5: u64 = fn_state.ga_65763._0;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#61760 <= s_7_0
        fn_state.gs_61760 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#61760:u8
        let s_8_0: bool = fn_state.gs_61760;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#61761 <= s_9_0
        fn_state.gs_61761 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#61761:u8
        let s_10_0: bool = fn_state.gs_61761;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#61762 <= s_11_0
        fn_state.gs_61762 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#61762:u8
        let s_12_0: bool = fn_state.gs_61762;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#61763 <= s_13_0
        fn_state.gs_61763 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#61763:u8
        let s_14_0: bool = fn_state.gs_61763;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#61764 <= s_16_0
        fn_state.gs_61764 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#61764:u8
        let s_17_0: bool = fn_state.gs_61764;
    ...
    fn block_18<T: Tracer>(
        ...
        let s_18_0: i64 = 64;
        // C s_18_1: const #15608u : u32
        let s_18_1: u32 = 15608;
        ...
        // D s_18_3: call __get_GCSCRE0_EL1(s_18_2)
        let s_18_3: ProductType5c790c8ef59cc8b2 = u__get_GCSCRE0_EL1(
            state,
            tracer,
            s_18_2,
        );
        // D s_18_4: write-var ga#65759 <= s_18_3
        fn_state.ga_65759 = s_18_3;
        // D s_18_5: read-var ga#65759.0:struct
        let s_18_5: u64 = fn_state.ga_65759._0;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#61766 <= s_20_0
        fn_state.gs_61766 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#61766:u8
        let s_21_0: bool = fn_state.gs_61766;
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_5: write-var gs#61766 <= s_24_4
        fn_state.gs_61766 = s_24_4;
        // N s_24_6: jump b21
        return block_21(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_5: write-var gs#61764 <= s_25_4
        fn_state.gs_61764 = s_25_4;
        // N s_25_6: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_5: write-var gs#61763 <= s_27_4
        fn_state.gs_61763 = s_27_4;
        // N s_27_6: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_2: write-var gs#61762 <= s_28_1
        fn_state.gs_61762 = s_28_1;
        // N s_28_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_5: write-var gs#61761 <= s_29_4
        fn_state.gs_61761 = s_29_4;
        // N s_29_6: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_4: write-var gs#61760 <= s_30_3
        fn_state.gs_61760 = s_30_3;
        // N s_30_5: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_1: write-var gs#61767 <= s_32_0
        fn_state.gs_61767 = s_32_0;
        // N s_32_2: jump b33
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var gs#61767:u8
        let s_33_0: bool = fn_state.gs_61767;
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_1: write-var gs#61768 <= s_34_0
        fn_state.gs_61768 = s_34_0;
        // N s_34_2: jump b35
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_0: read-var gs#61768:u8
        let s_35_0: bool = fn_state.gs_61768;
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_1: write-var gs#61769 <= s_36_0
        fn_state.gs_61769 = s_36_0;
        // N s_36_2: jump b37
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_0: read-var gs#61769:u8
        let s_37_0: bool = fn_state.gs_61769;
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_1: write-var gs#61770 <= s_38_0
        fn_state.gs_61770 = s_38_0;
        // N s_38_2: jump b39
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_0: read-var gs#61770:u8
        let s_39_0: bool = fn_state.gs_61770;
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_1: write-var gs#61771 <= s_41_0
        fn_state.gs_61771 = s_41_0;
        // N s_41_2: jump b42
    ...
    fn block_42<T: Tracer>(
        ...
        // D s_42_0: read-var gs#61771:u8
        let s_42_0: bool = fn_state.gs_61771;
    ...
    fn block_43<T: Tracer>(
        ...
        // D s_43_1: write-var gs#61773 <= s_43_0
        fn_state.gs_61773 = s_43_0;
        // N s_43_2: jump b44
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_0: read-var gs#61773:u8
        let s_44_0: bool = fn_state.gs_61773;
    ...
    fn block_45<T: Tracer>(
        ...
        // D s_45_1: write-var gs#61774 <= s_45_0
        fn_state.gs_61774 = s_45_0;
        // N s_45_2: jump b46
    ...
    fn block_46<T: Tracer>(
        ...
        // D s_46_0: read-var gs#61774:u8
        let s_46_0: bool = fn_state.gs_61774;
    ...
    fn block_48<T: Tracer>(
        ...
        // D s_48_1: write-var gs#61775 <= s_48_0
        fn_state.gs_61775 = s_48_0;
        // N s_48_2: jump b49
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_0: read-var gs#61775:u8
        let s_49_0: bool = fn_state.gs_61775;
    ...
    fn block_50<T: Tracer>(
        ...
        let s_50_0: i64 = 64;
        // C s_50_1: const #15608u : u32
        let s_50_1: u32 = 15608;
        ...
        // D s_50_3: call __get_GCSCRE0_EL1(s_50_2)
        let s_50_3: ProductType5c790c8ef59cc8b2 = u__get_GCSCRE0_EL1(
            state,
            tracer,
            s_50_2,
        );
        // D s_50_4: write-var ga#65743 <= s_50_3
        fn_state.ga_65743 = s_50_3;
        // D s_50_5: read-var ga#65743.0:struct
        let s_50_5: u64 = fn_state.ga_65743._0;
    ...
    fn block_52<T: Tracer>(
        ...
        // D s_52_1: write-var gs#61777 <= s_52_0
        fn_state.gs_61777 = s_52_0;
        // N s_52_2: jump b53
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_0: read-var gs#61777:u8
        let s_53_0: bool = fn_state.gs_61777;
    ...
    fn block_56<T: Tracer>(
        ...
        // D s_56_5: write-var gs#61777 <= s_56_4
        fn_state.gs_61777 = s_56_4;
        // N s_56_6: jump b53
        return block_53(state, tracer, fn_state);
    }
    fn block_57<T: Tracer>(
        ...
        // D s_57_5: write-var gs#61775 <= s_57_4
        fn_state.gs_61775 = s_57_4;
        // N s_57_6: jump b49
        return block_49(state, tracer, fn_state);
    }
    ...
    fn block_59<T: Tracer>(
        ...
        // D s_59_5: write-var gs#61774 <= s_59_4
        fn_state.gs_61774 = s_59_4;
        // N s_59_6: jump b46
        return block_46(state, tracer, fn_state);
    }
    ...
    fn block_61<T: Tracer>(
        ...
        // D s_61_5: write-var gs#61772 <= s_61_4
        fn_state.gs_61772 = s_61_4;
        // N s_61_6: jump b62
    ...
    fn block_62<T: Tracer>(
        ...
        // D s_62_0: read-var gs#61772:u8
        let s_62_0: bool = fn_state.gs_61772;
        // D s_62_1: write-var gs#61773 <= s_62_0
        fn_state.gs_61773 = s_62_0;
        // N s_62_2: jump b44
        return block_44(state, tracer, fn_state);
    }
    fn block_63<T: Tracer>(
        ...
        // D s_63_1: write-var gs#61772 <= s_63_0
        fn_state.gs_61772 = s_63_0;
        // N s_63_2: jump b62
        return block_62(state, tracer, fn_state);
    }
    fn block_64<T: Tracer>(
        ...
        // D s_64_2: write-var gs#61771 <= s_64_1
        fn_state.gs_61771 = s_64_1;
        // N s_64_3: jump b42
        return block_42(state, tracer, fn_state);
    }
    ...
    fn block_66<T: Tracer>(
        ...
        // D s_66_5: write-var gs#61770 <= s_66_4
        fn_state.gs_61770 = s_66_4;
        // N s_66_6: jump b39
        return block_39(state, tracer, fn_state);
    }
    fn block_67<T: Tracer>(
        ...
        // D s_67_2: write-var gs#61769 <= s_67_1
        fn_state.gs_61769 = s_67_1;
        // N s_67_3: jump b37
        return block_37(state, tracer, fn_state);
    }
    fn block_68<T: Tracer>(
        ...
        // D s_68_5: write-var gs#61768 <= s_68_4
        fn_state.gs_61768 = s_68_4;
        // N s_68_6: jump b35
        return block_35(state, tracer, fn_state);
    }
    fn block_69<T: Tracer>(
        ...
        // D s_69_4: write-var gs#61767 <= s_69_3
        fn_state.gs_61767 = s_69_3;
        // N s_69_5: jump b33
        return block_33(state, tracer, fn_state);
    }
