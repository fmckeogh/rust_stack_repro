...
extern crate alloc;
use Mk_SCTLR_EL3_Type::*;
use common::*;
pub fn u__get_SCTLR_EL3<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #10941465397514389376u : u64
        let s_0_3: u64 = 10941465397514389376;
        ...
        let s_0_11: i128 = 64;
        // C s_0_12: const #814022704u : u32
        let s_0_12: u32 = 814022704;
        ...
        // D s_0_20: tail-call Mk_SCTLR_EL3_Type(s_0_19)
        return Mk_SCTLR_EL3_Type(state, tracer, s_0_19);
    }
}
