...
extern crate alloc;
use execute_LUTI2_Z_ZTZ__::*;
use CurrentVL_read::*;
use HaveSME2::*;
use common::*;
pub fn decode_LUTI2_Z_ZTZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i4: u8,
    size: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        fn_state.d = s_2_15;
        // D s_2_17: read-var i4:u8
        let s_2_17: u8 = fn_state.i4;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_4: const #2s : i64
        let s_3_4: i64 = 2;
        // C s_3_5: const #1s : i64
        let s_3_5: i64 = 1;
        // D s_3_6: read-var d:i64
        let s_3_6: i64 = fn_state.d;
        // D s_3_7: read-var imm:i64
        let s_3_7: i64 = fn_state.imm;
        // D s_3_8: read-var n:i64
        let s_3_8: i64 = fn_state.n;
        // D s_3_9: call execute_LUTI2_Z_ZTZ__(s_3_0, s_3_6, s_3_3, s_3_7, s_3_4, s_3_8, s_3_5)
        let s_3_9: () = execute_LUTI2_Z_ZTZ__(
            state,
            tracer,
            s_3_0,
            s_3_6,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_7: read-var imm:i64
        let s_5_7: i64 = fn_state.imm;
        // D s_5_8: read-var n:i64
        let s_5_8: i64 = fn_state.n;
        // D s_5_9: call execute_LUTI2_Z_ZTZ__(s_5_0, s_5_6, s_5_3, s_5_7, s_5_4, s_5_8, s_5_5)
        let s_5_9: () = execute_LUTI2_Z_ZTZ__(
            state,
            tracer,
            s_5_0,
            s_5_6,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_7: read-var imm:i64
        let s_7_7: i64 = fn_state.imm;
        // D s_7_8: read-var n:i64
        let s_7_8: i64 = fn_state.n;
        // D s_7_9: call execute_LUTI2_Z_ZTZ__(s_7_0, s_7_6, s_7_3, s_7_7, s_7_4, s_7_8, s_7_5)
        let s_7_9: () = execute_LUTI2_Z_ZTZ__(
            state,
            tracer,
            s_7_0,
            s_7_6,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_7: read-var imm:i64
        let s_9_7: i64 = fn_state.imm;
        // D s_9_8: read-var n:i64
        let s_9_8: i64 = fn_state.n;
        // D s_9_9: call execute_LUTI2_Z_ZTZ__(s_9_0, s_9_6, s_9_3, s_9_7, s_9_4, s_9_8, s_9_5)
        let s_9_9: () = execute_LUTI2_Z_ZTZ__(
            state,
            tracer,
            s_9_0,
            s_9_6,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_7: read-var imm:i64
        let s_11_7: i64 = fn_state.imm;
        // D s_11_8: read-var n:i64
        let s_11_8: i64 = fn_state.n;
        // D s_11_9: call execute_LUTI2_Z_ZTZ__(s_11_0, s_11_6, s_11_3, s_11_7, s_11_4, s_11_8, s_11_5)
        let s_11_9: () = execute_LUTI2_Z_ZTZ__(
            state,
            tracer,
            s_11_0,
            s_11_6,
