...
use ConditionPassed::*;
use BitCount::*;
use execute_aarch32_instrs_LDM_u_Op_AS_txt::*;
use common::*;
pub fn decode_aarch32_instrs_LDM_u_A1enc_AS_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    P: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var registers:u15
        let s_3_0: u16 = fn_state.registers;
        // D s_3_1: cast zx s_3_0 -> bv
        let s_3_1: Bits = Bits::new(s_3_0 as u128, 15u16);
        ...
        // D s_3_5: write-var gs#323288 <= s_3_4
        fn_state.gs_323288 = s_3_4;
        // N s_3_6: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#323288:u8
        let s_4_0: bool = fn_state.gs_323288;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_2: read-var registers:u15
        let s_5_2: u16 = fn_state.registers;
        // D s_5_3: read-var wordhigher:u8
        let s_5_3: bool = fn_state.wordhigher;
        // D s_5_4: call execute_aarch32_instrs_LDM_u_Op_AS_txt(s_5_0, s_5_1, s_5_2, s_5_3)
        let s_5_4: () = execute_aarch32_instrs_LDM_u_Op_AS_txt(
            state,
            tracer,
            s_5_0,
            s_5_1,
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #1u : u8
        let s_7_0: bool = true;
        // D s_7_1: write-var gs#323288 <= s_7_0
        fn_state.gs_323288 = s_7_0;
        // N s_7_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
