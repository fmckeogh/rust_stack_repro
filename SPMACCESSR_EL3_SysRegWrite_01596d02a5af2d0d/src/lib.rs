...
extern crate alloc;
use X_read::*;
use Mk_SPMACCESSR_EL3_Type::*;
use common::*;
pub fn SPMACCESSR_EL3_SysRegWrite_01596d02a5af2d0d<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_SPMACCESSR_EL3_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_SPMACCESSR_EL3_Type(
            state,
            tracer,
            s_5_3,
        );
        // C s_5_5: const #13688u : u32
        let s_5_5: u32 = 13688;
