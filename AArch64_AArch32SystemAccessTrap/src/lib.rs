...
extern crate alloc;
use ThisInstrAddr::*;
use AArch64_AArch32SystemAccessTrapSyndrome::*;
use ThisInstr::*;
use AArch64_TakeException::*;
use common::*;
pub fn AArch64_AArch32SystemAccessTrap<T: Tracer>(
    state: &mut State,
    tracer: &T,
    target_el: u8,
    ec: i128,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#25049 <= s_1_0
        fn_state.gs_25049 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#25049:u8
        let s_2_0: bool = fn_state.gs_25049;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#25050 <= s_3_0
        fn_state.gs_25050 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#25050:u8
        let s_4_0: bool = fn_state.gs_25050;
        ...
        // C s_4_10: const #() : ()
        let s_4_10: () = ();
        // S s_4_11: call ThisInstr(s_4_10)
        let s_4_11: u32 = ThisInstr(state, tracer, s_4_10);
        // D s_4_12: read-var ec:i
        let s_4_12: i128 = fn_state.ec;
        // D s_4_13: call AArch64_AArch32SystemAccessTrapSyndrome(s_4_11, s_4_12)
        let s_4_13: ProductTypeb7f99f96751e17c4 = AArch64_AArch32SystemAccessTrapSyndrome(
            state,
            tracer,
            s_4_11,
            s_4_12,
        );
        // C s_4_14: cast zx s_4_9 -> i
        let s_4_14: i128 = (i128::try_from(s_4_9).unwrap());
        // D s_4_15: read-var target_el:u8
        let s_4_15: u8 = fn_state.target_el;
        // D s_4_16: call AArch64_TakeException(s_4_15, s_4_13, s_4_5, s_4_14)
        let s_4_16: () = AArch64_TakeException(
            state,
            tracer,
            s_4_15,
            s_4_13,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_12: write-var gs#25050 <= s_5_11
        fn_state.gs_25050 = s_5_11;
        // N s_5_13: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_6<T: Tracer>(
        ...
        // D s_6_6: write-var gs#25049 <= s_6_5
        fn_state.gs_25049 = s_6_5;
        // N s_6_7: jump b2
        return block_2(state, tracer, fn_state);
    }
}
