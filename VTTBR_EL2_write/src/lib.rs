...
extern crate alloc;
use common::*;
pub fn VTTBR_EL2_write<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_5: const #18448u : u32
        let s_0_5: u32 = 18448;
        // N s_0_6: write-reg s_0_5 <= s_0_0
        let s_0_6: () = {
            state.write_register::<ProductType782ac6922b48c20d>(s_0_5 as isize, s_0_0);
