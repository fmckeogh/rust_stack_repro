...
use R_read::*;
use common::*;
pub fn execute_aarch32_instrs_TST_r_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    m: i64,
    n: i64,
    ...
    struct FunctionState {
        gs_887365: ProductTypef506aa96a892fe52,
        m: i64,
        n: i64,
        shift_n: i128,
        shift_t: u32,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_9: write-var gs#887365 <= s_0_8
        fn_state.gs_887365 = s_0_8;
        // D s_0_10: read-var gs#887365.0:struct
        let s_0_10: Bits = fn_state.gs_887365._0;
        // D s_0_11: cast reint s_0_10 -> u32
        let s_0_11: u32 = (s_0_10.value() as u32);
        // D s_0_12: read-var gs#887365.1:struct
        let s_0_12: bool = fn_state.gs_887365._1;
