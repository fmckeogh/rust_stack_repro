...
use CurrentVL_read::*;
use HaveSME2::*;
use execute_USMLALL_ZA_ZZW_S4x4::*;
use common::*;
pub fn decode_USMLALL_ZA_ZZW_S4x4<T: Tracer>(
    state: &mut State,
    tracer: &T,
    sz: bool,
    Zm: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        fn_state.n = s_1_32;
        // D s_1_34: read-var Zm:u8
        let s_1_34: u8 = fn_state.Zm;
        ...
        // D s_1_68: read-var VL:i64
        let s_1_68: i64 = fn_state.VL;
        // C s_1_69: const #128s : i
        let s_1_69: i128 = 128;
        // D s_1_70: cast zx s_1_68 -> i
        let s_1_70: i128 = (i128::try_from(s_1_68).unwrap());
        // D s_1_71: cmp-eq s_1_70 s_1_69
        let s_1_71: bool = ((s_1_70) == (s_1_69));
        // D s_1_72: not s_1_71
        let s_1_72: bool = !s_1_71;
        // N s_1_73: branch s_1_72 b3 b2
        if s_1_72 {
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_7: call execute_USMLALL_ZA_ZZW_S4x4(s_2_0, s_2_1, s_2_2, s_2_3, s_2_4, s_2_5, s_2_6)
        let s_2_7: () = execute_USMLALL_ZA_ZZW_S4x4(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_7: call execute_USMLALL_ZA_ZZW_S4x4(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5, s_4_6)
        let s_4_7: () = execute_USMLALL_ZA_ZZW_S4x4(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_7: call execute_USMLALL_ZA_ZZW_S4x4(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5, s_6_6)
        let s_6_7: () = execute_USMLALL_ZA_ZZW_S4x4(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_7: call execute_USMLALL_ZA_ZZW_S4x4(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5, s_8_6)
        let s_8_7: () = execute_USMLALL_ZA_ZZW_S4x4(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_7: call execute_USMLALL_ZA_ZZW_S4x4(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5, s_10_6)
        let s_10_7: () = execute_USMLALL_ZA_ZZW_S4x4(
            state,
            tracer,
            s_10_0,
            s_10_1,
