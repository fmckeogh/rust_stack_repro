...
use common::*;
pub fn u__get_ICC_IGRPEN0_EL1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #18446744073709551614u : u64
        let s_0_3: u64 = 18446744073709551614;
        ...
        // D s_0_11: tail-call Mk_ICC_IGRPEN0_EL1_Type(s_0_10)
        return Mk_ICC_IGRPEN0_EL1_Type(state, tracer, s_0_10);
    }
}
