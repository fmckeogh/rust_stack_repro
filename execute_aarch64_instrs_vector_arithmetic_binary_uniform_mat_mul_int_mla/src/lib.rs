...
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_binary_uniform_mat_mul_int_mla<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_17: cast zx s_1_4 -> bv
        let s_1_17: Bits = Bits::new(s_1_4 as u128, 128u16);
        // D s_1_18: cast zx s_1_9 -> bv
        let s_1_18: Bits = Bits::new(s_1_9 as u128, 128u16);
        // D s_1_19: read-var op1_unsigned:u8
        let s_1_19: bool = fn_state.op1_unsigned;
        // D s_1_20: read-var op2_unsigned:u8
        let s_1_20: bool = fn_state.op2_unsigned;
        // D s_1_21: call MatMulAdd(s_1_16, s_1_17, s_1_18, s_1_19, s_1_20)
        let s_1_21: Bits = MatMulAdd(
            state,
            tracer,
            s_1_16,
            s_1_17,
        ...
        // D s_1_25: cast zx s_1_22 -> bv
        let s_1_25: Bits = Bits::new(s_1_22 as u128, 128u16);
        // D s_1_26: call V_set(s_1_24, s_1_15, s_1_25)
        let s_1_26: () = V_set(state, tracer, s_1_24, s_1_15, s_1_25);
        // N s_1_27: return
        return;
    }
}
