...
use common::*;
pub fn decode_aarch32_instrs_BFI_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    imm3: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_15: read-var imm3:u8
        let s_3_15: u8 = fn_state.imm3;
        // D s_3_16: cast zx s_3_15 -> bv
        let s_3_16: Bits = Bits::new(s_3_15 as u128, 3u16);
        // D s_3_17: read-var imm2:u8
        let s_3_17: u8 = fn_state.imm2;
        // D s_3_18: cast zx s_3_17 -> bv
        let s_3_18: Bits = Bits::new(s_3_17 as u128, 2u16);
        ...
        // D s_3_31: write-var lsbit <= s_3_30
        fn_state.lsbit = s_3_30;
