...
use FPRoundIntN::*;
use common::*;
pub fn execute_aarch64_instrs_float_arithmetic_round_frint_32_64<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    esize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#1429 <= s_0_2
        fn_state.esizeshadow_1429 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var esizeshadow#1429:i64
        let s_3_0: i64 = fn_state.esizeshadow_1429;
        ...
        // D s_3_6: read-var esizeshadow#1429:i64
        let s_3_6: i64 = fn_state.esizeshadow_1429;
        // D s_3_7: cast zx s_3_6 -> i
        let s_3_7: i128 = (i128::try_from(s_3_6).unwrap());
        // D s_3_8: cast reint s_3_7 -> i64
        let s_3_8: i64 = (s_3_7 as i64);
        // D s_3_9: write-var ga#256263 <= s_3_8
        fn_state.ga_256263 = s_3_8;
        // D s_3_10: read-var intsize:i64
        let s_3_10: i64 = fn_state.intsize;
        // D s_3_11: cast zx s_3_10 -> i
        let s_3_11: i128 = (i128::try_from(s_3_10).unwrap());
        // D s_3_12: read-var fpcr:struct
        let s_3_12: ProductType5c790c8ef59cc8b2 = fn_state.fpcr;
        // D s_3_13: read-var rounding:u32
        let s_3_13: u32 = fn_state.rounding;
        // D s_3_14: call FPRoundIntN(s_3_5, s_3_12, s_3_13, s_3_11)
        let s_3_14: Bits = FPRoundIntN(state, tracer, s_3_5, s_3_12, s_3_13, s_3_11);
        // D s_3_15: write-var ga#256264 <= s_3_14
        fn_state.ga_256264 = s_3_14;
        // N s_3_16: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_3: read-var ga#256263:i64
        let s_4_3: i64 = fn_state.ga_256263;
        // D s_4_4: cast zx s_4_3 -> i
        let s_4_4: i128 = (i128::try_from(s_4_3).unwrap());
        // D s_4_5: read-var ga#256264:bv
        let s_4_5: Bits = fn_state.ga_256264;
