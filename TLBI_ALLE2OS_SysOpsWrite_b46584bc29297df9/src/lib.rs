...
use common::*;
pub fn TLBI_ALLE2OS_SysOpsWrite_b46584bc29297df9<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#101978 <= s_14_0
        fn_state.gs_101978 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#101978:u8
        let s_15_0: bool = fn_state.gs_101978;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_5: write-var gs#101978 <= s_18_4
        fn_state.gs_101978 = s_18_4;
        // N s_18_6: jump b15
        return block_15(state, tracer, fn_state);
    }
