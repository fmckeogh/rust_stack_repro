...
use common::*;
pub fn decode_aarch32_instrs_ADD_SP_i_T2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm7: u8,
) -> () {
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_10: call execute_aarch32_instrs_ADD_SP_i_Op_A_txt(s_2_0, s_2_9, s_2_1)
        let s_2_10: () = execute_aarch32_instrs_ADD_SP_i_Op_A_txt(
            state,
            tracer,
            s_2_0,
            s_2_9,
