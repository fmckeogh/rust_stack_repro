...
extern crate alloc;
use common::*;
pub fn AMEVTYPER0_read<T: Tracer>(
    state: &mut State,
    tracer: &T,
    n: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_0: const #11752u : u32
        let s_0_0: u32 = 11752;
        // D s_0_1: read-reg s_0_0:[struct; 4]
        let s_0_1: [ProductType700c18a878c5601b; 4usize] = {
            let value = state
                .read_register::<[ProductType700c18a878c5601b; 4usize]>(s_0_0 as isize);
