...
use TTBR0_write::*;
use common::*;
pub fn TTBR0_EL1_write<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    struct FunctionState {
        ...
        ga_28823: ProductType5c790c8ef59cc8b2,
        value_name: ProductType782ac6922b48c20d,
    }
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_2: const #() : ()
        let s_0_2: () = ();
        // S s_0_3: call TTBR0_read(s_0_2)
        let s_0_3: ProductType5c790c8ef59cc8b2 = TTBR0_read(state, tracer, s_0_2);
        // D s_0_4: write-var ga#28823 <= s_0_3
        fn_state.ga_28823 = s_0_3;
        // D s_0_5: read-var ga#28823.0:struct
        let s_0_5: u64 = fn_state.ga_28823._0;
        ...
        // D s_0_27: call Mk_TTBR0_Type(s_0_26)
        let s_0_27: ProductType5c790c8ef59cc8b2 = Mk_TTBR0_Type(state, tracer, s_0_26);
        // D s_0_28: call TTBR0_write(s_0_27)
        let s_0_28: () = TTBR0_write(state, tracer, s_0_27);
        // C s_0_29: const #14528u : u32
        let s_0_29: u32 = 14528;
