...
extern crate alloc;
use HaveSVE::*;
use execute_INDEX_Z_II__::*;
use CurrentVL_read::*;
use HaveSME::*;
use common::*;
pub fn decode_INDEX_Z_II__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    imm5b: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#193987 <= s_1_0
        fn_state.gs_193987 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#193987:u8
        let s_2_0: bool = fn_state.gs_193987;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_7: read-var Zd:u8
        let s_3_7: u8 = fn_state.Zd;
        ...
        // D s_3_14: cast sx s_3_13 -> i
        let s_3_14: i128 = {
            let sign_bit = s_3_13.length() - 1;
            let mut result = s_3_13.value() as i128;
        ...
        // D s_3_16: write-var imm1 <= s_3_15
        fn_state.imm1 = s_3_15;
        // D s_3_17: read-var imm5b:u8
        let s_3_17: u8 = fn_state.imm5b;
        // D s_3_18: cast zx s_3_17 -> bv
        let s_3_18: Bits = Bits::new(s_3_17 as u128, 5u16);
        // D s_3_19: cast sx s_3_18 -> i
        let s_3_19: i128 = {
            let sign_bit = s_3_18.length() - 1;
            let mut result = s_3_18.value() as i128;
            if ((result >> sign_bit) & 1) == 1 {
                let cleared_bit = result & !(1 << sign_bit);
                result = cleared_bit - (1 << sign_bit);
            }
        ...
        // D s_3_21: write-var imm2 <= s_3_20
        fn_state.imm2 = s_3_20;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: read-var imm1:i64
        let s_4_4: i64 = fn_state.imm1;
        // D s_4_5: cast zx s_4_4 -> i
        let s_4_5: i128 = (i128::try_from(s_4_4).unwrap());
        // D s_4_6: read-var imm2:i64
        let s_4_6: i64 = fn_state.imm2;
        // D s_4_7: cast zx s_4_6 -> i
        let s_4_7: i128 = (i128::try_from(s_4_6).unwrap());
        // D s_4_8: read-var d:i64
        let s_4_8: i64 = fn_state.d;
        // D s_4_9: call execute_INDEX_Z_II__(s_4_0, s_4_8, s_4_3, s_4_5, s_4_7)
        let s_4_9: () = execute_INDEX_Z_II__(
            state,
            tracer,
            s_4_0,
            s_4_8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: read-var imm1:i64
        let s_6_4: i64 = fn_state.imm1;
        // D s_6_5: cast zx s_6_4 -> i
        let s_6_5: i128 = (i128::try_from(s_6_4).unwrap());
        // D s_6_6: read-var imm2:i64
        let s_6_6: i64 = fn_state.imm2;
        // D s_6_7: cast zx s_6_6 -> i
        let s_6_7: i128 = (i128::try_from(s_6_6).unwrap());
        // D s_6_8: read-var d:i64
        let s_6_8: i64 = fn_state.d;
        // D s_6_9: call execute_INDEX_Z_II__(s_6_0, s_6_8, s_6_3, s_6_5, s_6_7)
        let s_6_9: () = execute_INDEX_Z_II__(
            state,
            tracer,
            s_6_0,
            s_6_8,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: read-var imm1:i64
        let s_8_4: i64 = fn_state.imm1;
        // D s_8_5: cast zx s_8_4 -> i
        let s_8_5: i128 = (i128::try_from(s_8_4).unwrap());
        // D s_8_6: read-var imm2:i64
        let s_8_6: i64 = fn_state.imm2;
        // D s_8_7: cast zx s_8_6 -> i
        let s_8_7: i128 = (i128::try_from(s_8_6).unwrap());
        // D s_8_8: read-var d:i64
        let s_8_8: i64 = fn_state.d;
        // D s_8_9: call execute_INDEX_Z_II__(s_8_0, s_8_8, s_8_3, s_8_5, s_8_7)
        let s_8_9: () = execute_INDEX_Z_II__(
            state,
            tracer,
            s_8_0,
            s_8_8,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: read-var imm1:i64
        let s_10_4: i64 = fn_state.imm1;
        // D s_10_5: cast zx s_10_4 -> i
        let s_10_5: i128 = (i128::try_from(s_10_4).unwrap());
        // D s_10_6: read-var imm2:i64
        let s_10_6: i64 = fn_state.imm2;
        // D s_10_7: cast zx s_10_6 -> i
        let s_10_7: i128 = (i128::try_from(s_10_6).unwrap());
        // D s_10_8: read-var d:i64
        let s_10_8: i64 = fn_state.d;
        // D s_10_9: call execute_INDEX_Z_II__(s_10_0, s_10_8, s_10_3, s_10_5, s_10_7)
        let s_10_9: () = execute_INDEX_Z_II__(
            state,
            tracer,
            s_10_0,
            s_10_8,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_4: read-var imm1:i64
        let s_12_4: i64 = fn_state.imm1;
        // D s_12_5: cast zx s_12_4 -> i
        let s_12_5: i128 = (i128::try_from(s_12_4).unwrap());
        // D s_12_6: read-var imm2:i64
        let s_12_6: i64 = fn_state.imm2;
        // D s_12_7: cast zx s_12_6 -> i
        let s_12_7: i128 = (i128::try_from(s_12_6).unwrap());
        // D s_12_8: read-var d:i64
        let s_12_8: i64 = fn_state.d;
        // D s_12_9: call execute_INDEX_Z_II__(s_12_0, s_12_8, s_12_3, s_12_5, s_12_7)
        let s_12_9: () = execute_INDEX_Z_II__(
            state,
            tracer,
            s_12_0,
            s_12_8,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#193987 <= s_15_2
        fn_state.gs_193987 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
