...
use common::*;
pub fn decode_fmul_advsimd_elt_aarch64_instrs_vector_arithmetic_binary_element_mul_fp16_simd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#255937 <= s_1_0
        fn_state.ga_255937 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#255937:i64
        let s_2_0: i64 = fn_state.ga_255937;
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 64;
        // D s_3_1: write-var ga#255945 <= s_3_0
        fn_state.ga_255945 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#255945:i64
        let s_4_0: i64 = fn_state.ga_255945;
        // C s_4_1: const #16s : i
        let s_4_1: i128 = 16;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 128;
        // D s_5_1: write-var ga#255945 <= s_5_0
        fn_state.ga_255945 = s_5_0;
        // N s_5_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 128;
        // D s_6_1: write-var ga#255937 <= s_6_0
        fn_state.ga_255937 = s_6_0;
        // N s_6_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
