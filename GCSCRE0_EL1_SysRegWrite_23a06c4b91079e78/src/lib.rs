...
use u_get_HFGWTR_EL2_Type_nGCS_EL0::*;
use X_read::*;
use AArch64_SystemAccessTrap::*;
use u__IMPDEF_boolean::*;
use Mk_GCSCRE0_EL1_Type::*;
use EDSCR_read::*;
use common::*;
pub fn GCSCRE0_EL1_SysRegWrite_23a06c4b91079e78<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_17: call _get_HFGWTR_EL2_Type_nGCS_EL0(s_0_16)
        let s_0_17: bool = u_get_HFGWTR_EL2_Type_nGCS_EL0(state, tracer, s_0_16);
        // D s_0_18: write-var __HFGWTR_EL2_nGCS_EL0 <= s_0_17
        fn_state.u__HFGWTR_EL2_nGCS_EL0 = s_0_17;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_GCSCRE0_EL1_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_GCSCRE0_EL1_Type(
            state,
            tracer,
            s_5_3,
        );
        // C s_5_5: const #15608u : u32
        let s_5_5: u32 = 15608;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#85575 <= s_7_0
        fn_state.gs_85575 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#85575:u8
        let s_8_0: bool = fn_state.gs_85575;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#85576 <= s_9_0
        fn_state.gs_85576 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#85576:u8
        let s_10_0: bool = fn_state.gs_85576;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#85577 <= s_11_0
        fn_state.gs_85577 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#85577:u8
        let s_12_0: bool = fn_state.gs_85577;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#85578 <= s_13_0
        fn_state.gs_85578 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#85578:u8
        let s_14_0: bool = fn_state.gs_85578;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#85579 <= s_16_0
        fn_state.gs_85579 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#85579:u8
        let s_17_0: bool = fn_state.gs_85579;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_4: call Mk_GCSCRE0_EL1_Type(s_18_3)
        let s_18_4: ProductType5c790c8ef59cc8b2 = Mk_GCSCRE0_EL1_Type(
            state,
            tracer,
            s_18_3,
        );
        // C s_18_5: const #15608u : u32
        let s_18_5: u32 = 15608;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#85581 <= s_20_0
        fn_state.gs_85581 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#85581:u8
        let s_21_0: bool = fn_state.gs_85581;
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_5: write-var gs#85581 <= s_24_4
        fn_state.gs_85581 = s_24_4;
        // N s_24_6: jump b21
        return block_21(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_5: write-var gs#85579 <= s_25_4
        fn_state.gs_85579 = s_25_4;
        // N s_25_6: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_5: write-var gs#85578 <= s_27_4
        fn_state.gs_85578 = s_27_4;
        // N s_27_6: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_2: write-var gs#85577 <= s_28_1
        fn_state.gs_85577 = s_28_1;
        // N s_28_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_5: write-var gs#85576 <= s_29_4
        fn_state.gs_85576 = s_29_4;
        // N s_29_6: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_4: write-var gs#85575 <= s_30_3
        fn_state.gs_85575 = s_30_3;
        // N s_30_5: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_1: write-var gs#85582 <= s_32_0
        fn_state.gs_85582 = s_32_0;
        // N s_32_2: jump b33
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var gs#85582:u8
        let s_33_0: bool = fn_state.gs_85582;
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_1: write-var gs#85583 <= s_34_0
        fn_state.gs_85583 = s_34_0;
        // N s_34_2: jump b35
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_0: read-var gs#85583:u8
        let s_35_0: bool = fn_state.gs_85583;
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_1: write-var gs#85584 <= s_36_0
        fn_state.gs_85584 = s_36_0;
        // N s_36_2: jump b37
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_0: read-var gs#85584:u8
        let s_37_0: bool = fn_state.gs_85584;
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_1: write-var gs#85585 <= s_38_0
        fn_state.gs_85585 = s_38_0;
        // N s_38_2: jump b39
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_0: read-var gs#85585:u8
        let s_39_0: bool = fn_state.gs_85585;
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_1: write-var gs#85586 <= s_41_0
        fn_state.gs_85586 = s_41_0;
        // N s_41_2: jump b42
    ...
    fn block_42<T: Tracer>(
        ...
        // D s_42_0: read-var gs#85586:u8
        let s_42_0: bool = fn_state.gs_85586;
    ...
    fn block_43<T: Tracer>(
        ...
        // D s_43_1: write-var gs#85588 <= s_43_0
        fn_state.gs_85588 = s_43_0;
        // N s_43_2: jump b44
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_0: read-var gs#85588:u8
        let s_44_0: bool = fn_state.gs_85588;
    ...
    fn block_45<T: Tracer>(
        ...
        // D s_45_1: write-var gs#85589 <= s_45_0
        fn_state.gs_85589 = s_45_0;
        // N s_45_2: jump b46
    ...
    fn block_46<T: Tracer>(
        ...
        // D s_46_0: read-var gs#85589:u8
        let s_46_0: bool = fn_state.gs_85589;
    ...
    fn block_48<T: Tracer>(
        ...
        // D s_48_1: write-var gs#85590 <= s_48_0
        fn_state.gs_85590 = s_48_0;
        // N s_48_2: jump b49
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_0: read-var gs#85590:u8
        let s_49_0: bool = fn_state.gs_85590;
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_4: call Mk_GCSCRE0_EL1_Type(s_50_3)
        let s_50_4: ProductType5c790c8ef59cc8b2 = Mk_GCSCRE0_EL1_Type(
            state,
            tracer,
            s_50_3,
        );
        // C s_50_5: const #15608u : u32
        let s_50_5: u32 = 15608;
    ...
    fn block_52<T: Tracer>(
        ...
        // D s_52_1: write-var gs#85592 <= s_52_0
        fn_state.gs_85592 = s_52_0;
        // N s_52_2: jump b53
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_0: read-var gs#85592:u8
        let s_53_0: bool = fn_state.gs_85592;
    ...
    fn block_56<T: Tracer>(
        ...
        // D s_56_5: write-var gs#85592 <= s_56_4
        fn_state.gs_85592 = s_56_4;
        // N s_56_6: jump b53
        return block_53(state, tracer, fn_state);
    }
    fn block_57<T: Tracer>(
        ...
        // D s_57_5: write-var gs#85590 <= s_57_4
        fn_state.gs_85590 = s_57_4;
        // N s_57_6: jump b49
        return block_49(state, tracer, fn_state);
    }
    ...
    fn block_59<T: Tracer>(
        ...
        // D s_59_0: read-var __HFGWTR_EL2_nGCS_EL0:u8
        let s_59_0: bool = fn_state.u__HFGWTR_EL2_nGCS_EL0;
        ...
        // D s_59_5: write-var gs#85589 <= s_59_4
        fn_state.gs_85589 = s_59_4;
        // N s_59_6: jump b46
        return block_46(state, tracer, fn_state);
    }
    ...
    fn block_61<T: Tracer>(
        ...
        // D s_61_5: write-var gs#85587 <= s_61_4
        fn_state.gs_85587 = s_61_4;
        // N s_61_6: jump b62
    ...
    fn block_62<T: Tracer>(
        ...
        // D s_62_0: read-var gs#85587:u8
        let s_62_0: bool = fn_state.gs_85587;
        // D s_62_1: write-var gs#85588 <= s_62_0
        fn_state.gs_85588 = s_62_0;
        // N s_62_2: jump b44
        return block_44(state, tracer, fn_state);
    }
    fn block_63<T: Tracer>(
        ...
        // D s_63_1: write-var gs#85587 <= s_63_0
        fn_state.gs_85587 = s_63_0;
        // N s_63_2: jump b62
        return block_62(state, tracer, fn_state);
    }
    fn block_64<T: Tracer>(
        ...
        // D s_64_2: write-var gs#85586 <= s_64_1
        fn_state.gs_85586 = s_64_1;
        // N s_64_3: jump b42
        return block_42(state, tracer, fn_state);
    }
    ...
    fn block_66<T: Tracer>(
        ...
        // D s_66_5: write-var gs#85585 <= s_66_4
        fn_state.gs_85585 = s_66_4;
        // N s_66_6: jump b39
        return block_39(state, tracer, fn_state);
    }
    fn block_67<T: Tracer>(
        ...
        // D s_67_2: write-var gs#85584 <= s_67_1
        fn_state.gs_85584 = s_67_1;
        // N s_67_3: jump b37
        return block_37(state, tracer, fn_state);
    }
    fn block_68<T: Tracer>(
        ...
        // D s_68_5: write-var gs#85583 <= s_68_4
        fn_state.gs_85583 = s_68_4;
        // N s_68_6: jump b35
        return block_35(state, tracer, fn_state);
    }
    fn block_69<T: Tracer>(
        ...
        // D s_69_4: write-var gs#85582 <= s_69_3
        fn_state.gs_85582 = s_69_3;
        // N s_69_5: jump b33
        return block_33(state, tracer, fn_state);
    }
