...
extern crate alloc;
use HaveCSSC::*;
use execute_aarch64_instrs_integer_arithmetic_max_min_smin_reg::*;
use common::*;
pub fn decode_smin_reg_aarch64_instrs_integer_arithmetic_max_min_smin_reg<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_20: call execute_aarch64_instrs_integer_arithmetic_max_min_smin_reg(s_1_17, s_1_19, s_1_13, s_1_9)
        let s_1_20: () = execute_aarch64_instrs_integer_arithmetic_max_min_smin_reg(
            state,
            tracer,
            s_1_17,
            s_1_19,
