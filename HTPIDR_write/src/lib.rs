...
extern crate alloc;
use common::*;
pub fn HTPIDR_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #11976u : u32
        let s_0_23: u32 = 11976;
        ...
        // C s_0_25: const #20384u : u32
        let s_0_25: u32 = 20384;
