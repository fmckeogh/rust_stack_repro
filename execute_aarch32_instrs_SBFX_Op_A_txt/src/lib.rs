...
use R_set::*;
use common::*;
pub fn execute_aarch32_instrs_SBFX_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    lsbit: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#300563 <= s_1_0
        fn_state.gs_300563 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#300563:u8
        let s_2_0: bool = fn_state.gs_300563;
        ...
        // D s_2_10: call sext_subrange(s_2_5, s_2_6, s_2_9, s_2_8)
        let s_2_10: Bits = sext_subrange(state, tracer, s_2_5, s_2_6, s_2_9, s_2_8);
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#300563 <= s_3_3
        fn_state.gs_300563 = s_3_3;
        // N s_3_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
