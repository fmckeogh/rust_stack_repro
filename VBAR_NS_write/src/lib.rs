...
extern crate alloc;
use common::*;
pub fn VBAR_NS_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #17152u : u32
        let s_0_23: u32 = 17152;
        ...
        // C s_0_25: const #19096u : u32
        let s_0_25: u32 = 19096;
