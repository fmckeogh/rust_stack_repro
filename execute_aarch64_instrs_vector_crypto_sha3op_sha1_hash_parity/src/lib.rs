...
use Elem_read::*;
use common::*;
pub fn execute_aarch64_instrs_vector_crypto_sha3op_sha1_hash_parity<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_27: call SHAparity(s_3_8, s_3_17, s_3_26)
        let s_3_27: u32 = SHAparity(state, tracer, s_3_8, s_3_17, s_3_26);
        // C s_3_28: const #0s : i
        let s_3_28: i128 = 0;
