...
use common::*;
pub fn AMEVTYPER1_SysRegWrite32_1c15a0e3b00864c2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var gs#123965 <= s_2_0
        fn_state.gs_123965 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#123965:u8
        let s_3_0: bool = fn_state.gs_123965;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#123966 <= s_4_0
        fn_state.gs_123966 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#123966:u8
        let s_5_0: bool = fn_state.gs_123966;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#123967 <= s_6_0
        fn_state.gs_123967 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#123967:u8
        let s_7_0: bool = fn_state.gs_123967;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#123968 <= s_9_0
        fn_state.gs_123968 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#123968:u8
        let s_10_0: bool = fn_state.gs_123968;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#123969 <= s_11_0
        fn_state.gs_123969 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#123969:u8
        let s_12_0: bool = fn_state.gs_123969;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#123970 <= s_13_0
        fn_state.gs_123970 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#123970:u8
        let s_14_0: bool = fn_state.gs_123970;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#123971 <= s_16_0
        fn_state.gs_123971 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#123971:u8
        let s_17_0: bool = fn_state.gs_123971;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_3: write-var gs#123971 <= s_20_2
        fn_state.gs_123971 = s_20_2;
        // N s_20_4: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_5: write-var gs#123970 <= s_22_4
        fn_state.gs_123970 = s_22_4;
        // N s_22_6: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_23<T: Tracer>(
        ...
        // D s_23_3: write-var gs#123969 <= s_23_2
        fn_state.gs_123969 = s_23_2;
        // N s_23_4: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_24<T: Tracer>(
        ...
        // D s_24_2: write-var gs#123968 <= s_24_1
        fn_state.gs_123968 = s_24_1;
        // N s_24_3: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_5: write-var gs#123967 <= s_26_4
        fn_state.gs_123967 = s_26_4;
        // N s_26_6: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_27<T: Tracer>(
        ...
        // D s_27_4: write-var gs#123966 <= s_27_3
        fn_state.gs_123966 = s_27_3;
        // N s_27_5: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_2: write-var gs#123965 <= s_28_1
        fn_state.gs_123965 = s_28_1;
        // N s_28_3: jump b3
        return block_3(state, tracer, fn_state);
    }
