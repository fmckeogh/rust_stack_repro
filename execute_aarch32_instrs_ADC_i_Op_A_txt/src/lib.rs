...
use AddWithCarry::*;
use common::*;
pub fn execute_aarch32_instrs_ADC_i_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    imm32: u32,
    ...
    struct FunctionState {
        result: u32,
        nzcv: u8,
        gs_877591: ProductTyped54bc449dd09e5bd,
        d: i64,
        imm32: u32,
        n: i64,
        setflags: bool,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_6: read-var imm32:u32
        let s_0_6: u32 = fn_state.imm32;
        // D s_0_7: cast zx s_0_6 -> bv
        let s_0_7: Bits = Bits::new(s_0_6 as u128, 32u16);
        // D s_0_8: call AddWithCarry(s_0_5, s_0_7, s_0_4)
        let s_0_8: ProductTyped54bc449dd09e5bd = AddWithCarry(
            state,
            tracer,
            s_0_5,
            s_0_7,
        ...
        // D s_0_9: write-var gs#877591 <= s_0_8
        fn_state.gs_877591 = s_0_8;
        // D s_0_10: read-var gs#877591.0:struct
        let s_0_10: Bits = fn_state.gs_877591._0;
        // D s_0_11: cast reint s_0_10 -> u32
        let s_0_11: u32 = (s_0_10.value() as u32);
        // D s_0_12: read-var gs#877591.1:struct
        let s_0_12: u8 = fn_state.gs_877591._1;
        // D s_0_13: write-var result <= s_0_11
        fn_state.result = s_0_11;
        // D s_0_14: write-var nzcv <= s_0_12
        fn_state.nzcv = s_0_12;
