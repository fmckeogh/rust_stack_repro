...
use TLBI::*;
use common::*;
pub fn AArch64_TLBI_VA<T: Tracer>(
    state: &mut State,
    tracer: &T,
    security: u32,
    regime: u32,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_7: write-var gs#26547 <= s_2_6
        fn_state.gs_26547 = s_2_6;
        // N s_2_8: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#26547:u8
        let s_3_0: bool = fn_state.gs_26547;
        // D s_3_1: write-var gs#26548 <= s_3_0
        fn_state.gs_26548 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#26548:u8
        let s_4_0: bool = fn_state.gs_26548;
        ...
        let s_4_26: i128 = 44;
        // D s_4_27: read-var Xt:u64
        let s_4_27: u64 = fn_state.Xt;
        ...
        let s_4_36: i128 = 64;
        // C s_4_37: const #43s : i
        let s_4_37: i128 = 43;
        // C s_4_38: const #0s : i
        let s_4_38: i128 = 0;
        // C s_4_39: const #12s : i
        let s_4_39: i128 = 12;
        // D s_4_40: read-var Xt:u64
        let s_4_40: u64 = fn_state.Xt;
        // D s_4_41: cast zx s_4_40 -> bv
        let s_4_41: Bits = Bits::new(s_4_40 as u128, 64u16);
        ...
        // C s_4_45: const #1u : u8
        let s_4_45: bool = true;
        // D s_4_46: write-var r.4 <= s_4_45
        fn_state.r._4 = s_4_45;
        // D s_4_47: read-var r.13:struct
        let s_4_47: u8 = fn_state.r._13;
        // C s_4_48: const #2s : i
        let s_4_48: i128 = 2;
        // D s_4_49: cast zx s_4_47 -> bv
        let s_4_49: Bits = Bits::new(s_4_47 as u128, 4u16);
        ...
        // D s_4_56: cast zx s_4_55 -> bv
        let s_4_56: Bits = Bits::new(s_4_55 as u128, 2u16);
        // C s_4_57: const #0u : u8
        let s_4_57: u8 = 0;
        // C s_4_58: cast zx s_4_57 -> bv
        let s_4_58: Bits = Bits::new(s_4_57 as u128, 2u16);
        // D s_4_59: cmp-eq s_4_56 s_4_58
        let s_4_59: bool = ((s_4_56) == (s_4_58));
        // D s_4_60: not s_4_59
        let s_4_60: bool = !s_4_59;
        // N s_4_61: branch s_4_60 b9 b5
        if s_4_60 {
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_0: const #1u : u8
        let s_5_0: bool = true;
        // D s_5_1: write-var gs#26558 <= s_5_0
        fn_state.gs_26558 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#26558:u8
        let s_6_0: bool = fn_state.gs_26558;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#26558 <= s_9_0
        fn_state.gs_26558 = s_9_0;
        // N s_9_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#26547 <= s_10_0
        fn_state.gs_26547 = s_10_0;
        // N s_10_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#26548 <= s_11_0
        fn_state.gs_26548 = s_11_0;
        // N s_11_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
