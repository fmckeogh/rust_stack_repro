...
use MemAtomicRCW::*;
use common::*;
pub fn execute_aarch64_instrs_memory_rcws_cas<T: Tracer>(
    state: &mut State,
    tracer: &T,
    acquire: bool,
    n: i64,
    ...
    struct FunctionState {
        compdata: u64,
        address: u64,
        gs_708310: ProductType42c31f3d0ab6eb17,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_10: cast reint s_1_9 -> u64
        let s_1_10: u64 = (s_1_9.value() as u64);
        // D s_1_11: write-var compdata <= s_1_10
        fn_state.compdata = s_1_10;
        // C s_1_12: const #10u : u32
        let s_1_12: u32 = 10;
        // D s_1_13: read-var soft:u8
        let s_1_13: bool = fn_state.soft;
        // D s_1_14: read-var acquire:u8
        let s_1_14: bool = fn_state.acquire;
        // D s_1_15: read-var release:u8
        let s_1_15: bool = fn_state.release;
        // D s_1_16: read-var tagchecked:u8
        let s_1_16: bool = fn_state.tagchecked;
        // D s_1_17: call CreateAccDescRCW(s_1_12, s_1_13, s_1_14, s_1_15, s_1_16)
        let s_1_17: ProductType9878976b5bcce9c9 = CreateAccDescRCW(
            state,
            tracer,
            s_1_12,
            s_1_13,
        ...
        // D s_1_18: write-var accdesc <= s_1_17
        fn_state.accdesc = s_1_17;
        ...
        // D s_1_22: cmp-eq s_1_21 s_1_19
        let s_1_22: bool = ((s_1_21) == (s_1_19));
        // N s_1_23: branch s_1_22 b5 b2
        if s_1_22 {
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var compdata:u64
        let s_3_0: u64 = fn_state.compdata;
        // D s_3_1: cast zx s_3_0 -> bv
        let s_3_1: Bits = Bits::new(s_3_0 as u128, 64u16);
        // D s_3_2: read-var newdata:u64
        let s_3_2: u64 = fn_state.newdata;
        // D s_3_3: cast zx s_3_2 -> bv
        let s_3_3: Bits = Bits::new(s_3_2 as u128, 64u16);
        // D s_3_4: read-var address:u64
        let s_3_4: u64 = fn_state.address;
        // D s_3_5: read-var accdesc:struct
        let s_3_5: ProductType9878976b5bcce9c9 = fn_state.accdesc;
        // D s_3_6: call MemAtomicRCW(s_3_4, s_3_1, s_3_3, s_3_5)
        let s_3_6: ProductType42c31f3d0ab6eb17 = MemAtomicRCW(
            state,
            tracer,
            s_3_4,
            s_3_1,
        ...
        // D s_3_7: write-var gs#708310 <= s_3_6
        fn_state.gs_708310 = s_3_6;
        // N s_3_8: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#708310.0:struct
        let s_4_0: u8 = fn_state.gs_708310._0;
        // D s_4_1: read-var gs#708310.1:struct
        let s_4_1: Bits = fn_state.gs_708310._1;
        ...
        let s_4_43: i64 = 64;
        // D s_4_44: read-var s:i64
        let s_4_44: i64 = fn_state.s;
