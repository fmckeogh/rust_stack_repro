...
extern crate alloc;
use execute_aarch64_instrs_vector_crypto_sha3op_sha1_sched0::*;
use HaveSHA1Ext::*;
use common::*;
pub fn decode_sha1su0_advsimd_aarch64_instrs_vector_crypto_sha3op_sha1_sched0<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_3: call execute_aarch64_instrs_vector_crypto_sha3op_sha1_sched0(s_1_0, s_1_1, s_1_2)
        let s_1_3: () = execute_aarch64_instrs_vector_crypto_sha3op_sha1_sched0(
            state,
            tracer,
            s_1_0,
            s_1_1,
