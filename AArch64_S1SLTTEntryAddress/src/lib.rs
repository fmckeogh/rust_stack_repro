...
use AArch64_IASize::*;
use common::*;
pub fn AArch64_S1SLTTEntryAddress<T: Tracer>(
    state: &mut State,
    tracer: &T,
    level: i128,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 3;
        // D s_1_1: write-var ga#13699 <= s_1_0
        fn_state.ga_13699 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#13699:i64
        let s_2_0: i64 = fn_state.ga_13699;
        ...
        // D s_2_9: read-var level:i
        let s_2_9: i128 = fn_state.level;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#18238 <= s_3_0
        fn_state.gs_18238 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#18238:u8
        let s_4_0: bool = fn_state.gs_18238;
        ...
        let s_4_28: i128 = 56;
        // D s_4_29: read-var ia:u64
        let s_4_29: u64 = fn_state.ia;
        // D s_4_30: cast zx s_4_29 -> bv
        let s_4_30: Bits = Bits::new(s_4_29 as u128, 64u16);
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#18237 <= s_6_0
        fn_state.gs_18237 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#18237:u8
        let s_7_0: bool = fn_state.gs_18237;
        // D s_7_1: write-var gs#18238 <= s_7_0
        fn_state.gs_18238 = s_7_0;
        // N s_7_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: write-var gs#18237 <= s_8_3
        fn_state.gs_18237 = s_8_3;
        // N s_8_5: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
        ...
        let s_9_0: i64 = 4;
        // D s_9_1: write-var ga#13699 <= s_9_0
        fn_state.ga_13699 = s_9_0;
        // N s_9_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
