...
use ZAvector_read::*;
use common::*;
pub fn execute_SVDOT_ZA32_ZZi_2xi<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    esize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#6314 <= s_0_2
        fn_state.VLshadow_6314 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#6314:i64
        let s_1_0: i64 = fn_state.VLshadow_6314;
        // D s_1_1: write-var VLshadow#6315 <= s_1_0
        fn_state.VLshadow_6315 = s_1_0;
        // D s_1_2: read-var VLshadow#6315:i64
        let s_1_2: i64 = fn_state.VLshadow_6315;
        ...
        // C s_1_9: const #8s : i
        let s_1_9: i128 = 8;
        // D s_1_10: read-var VLshadow#6315:i64
        let s_1_10: i64 = fn_state.VLshadow_6315;
        ...
        fn_state.vec = s_1_41;
        // D s_1_43: read-var VLshadow#6315:i64
        let s_1_43: i64 = fn_state.VLshadow_6315;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: read-var VLshadow#6315:i64
        let s_3_1: i64 = fn_state.VLshadow_6315;
        ...
        // D s_3_13: write-var gs#276411 <= s_3_12
        fn_state.gs_276411 = s_3_12;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#276411:i64
        let s_4_1: i64 = fn_state.gs_276411;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_6: read-var VLshadow#6315:i64
        let s_7_6: i64 = fn_state.VLshadow_6315;
        ...
        let s_7_33: Bits = Bits::new(s_7_32 as u128, 16u16);
        ...
        // D s_7_57: cast reint s_7_56 -> u16
        let s_7_57: u16 = (s_7_56.value() as u16);
        // D s_7_58: cast zx s_7_57 -> bv
        let s_7_58: Bits = Bits::new(s_7_57 as u128, 16u16);
        // D s_7_59: cast sx s_7_58 -> i
        let s_7_59: i128 = {
            let sign_bit = s_7_58.length() - 1;
            let mut result = s_7_58.value() as i128;
            if ((result >> sign_bit) & 1) == 1 {
                let cleared_bit = result & !(1 << sign_bit);
                result = cleared_bit - (1 << sign_bit);
            }
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: read-var VLshadow#6315:i64
        let s_9_1: i64 = fn_state.VLshadow_6315;
