...
use PMSELR_read::*;
use common::*;
pub fn u__set_selected_PMEVCNTR<T: Tracer>(
    state: &mut State,
    tracer: &T,
    value_name: u32,
) -> () {
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_10: read-var value_name:u32
        let s_0_10: u32 = fn_state.value_name;
        // D s_0_11: call PMEVCNTR_set(s_0_5, s_0_10)
        let s_0_11: () = PMEVCNTR_set(state, tracer, s_0_5, s_0_10);
        // N s_0_12: return
        return;
    }
}
