...
use AArch32_ITLBI_ALL::*;
use AArch32_TakeHypTrapException::*;
use common::*;
pub fn ITLBIALL_SysRegWrite32_58b4810189599a79<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_5: u32 = 0;
        // D s_5_6: call AArch32_ITLBI_ALL(s_5_2, s_5_3, s_5_4, s_5_5)
        let s_5_6: () = AArch32_ITLBI_ALL(state, tracer, s_5_2, s_5_3, s_5_4, s_5_5);
        // N s_5_7: return
        return;
    }
    fn block_6<T: Tracer>(
        ...
        // C s_6_3: const #4u : u32
        let s_6_3: u32 = 4;
        // C s_6_4: const #0u : u32
        let s_6_4: u32 = 0;
        // C s_6_5: const #0u : u32
        let s_6_5: u32 = 0;
        // D s_6_6: call AArch32_ITLBI_ALL(s_6_2, s_6_3, s_6_4, s_6_5)
        let s_6_6: () = AArch32_ITLBI_ALL(state, tracer, s_6_2, s_6_3, s_6_4, s_6_5);
        // N s_6_7: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#129527 <= s_8_0
        fn_state.gs_129527 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#129527:u8
        let s_9_0: bool = fn_state.gs_129527;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#129528 <= s_10_0
        fn_state.gs_129528 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#129528:u8
        let s_11_0: bool = fn_state.gs_129528;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#129529 <= s_13_0
        fn_state.gs_129529 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#129529:u8
        let s_14_0: bool = fn_state.gs_129529;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#129530 <= s_15_0
        fn_state.gs_129530 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#129530:u8
        let s_16_0: bool = fn_state.gs_129530;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#129531 <= s_18_0
        fn_state.gs_129531 = s_18_0;
        // N s_18_2: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#129531:u8
        let s_19_0: bool = fn_state.gs_129531;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#129532 <= s_20_0
        fn_state.gs_129532 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#129532:u8
        let s_21_0: bool = fn_state.gs_129532;
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_1: write-var gs#129533 <= s_23_0
        fn_state.gs_129533 = s_23_0;
        // N s_23_2: jump b24
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_0: read-var gs#129533:u8
        let s_24_0: bool = fn_state.gs_129533;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#129534 <= s_25_0
        fn_state.gs_129534 = s_25_0;
        // N s_25_2: jump b26
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var gs#129534:u8
        let s_26_0: bool = fn_state.gs_129534;
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_1: write-var gs#129535 <= s_28_0
        fn_state.gs_129535 = s_28_0;
        // N s_28_2: jump b29
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_0: read-var gs#129535:u8
        let s_29_0: bool = fn_state.gs_129535;
    ...
    fn block_30<T: Tracer>(
        ...
        // D s_30_1: write-var gs#129536 <= s_30_0
        fn_state.gs_129536 = s_30_0;
        // N s_30_2: jump b31
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_0: read-var gs#129536:u8
        let s_31_0: bool = fn_state.gs_129536;
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_1: write-var gs#129537 <= s_32_0
        fn_state.gs_129537 = s_32_0;
        // N s_32_2: jump b33
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var gs#129537:u8
        let s_33_0: bool = fn_state.gs_129537;
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_1: write-var gs#129538 <= s_34_0
        fn_state.gs_129538 = s_34_0;
        // N s_34_2: jump b35
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_0: read-var gs#129538:u8
        let s_35_0: bool = fn_state.gs_129538;
    ...
    fn block_36<T: Tracer>(
        ...
        // C s_36_3: const #4u : u32
        let s_36_3: u32 = 4;
        // C s_36_4: const #0u : u32
        let s_36_4: u32 = 0;
        // C s_36_5: const #0u : u32
        let s_36_5: u32 = 0;
        // D s_36_6: call AArch32_ITLBI_ALL(s_36_2, s_36_3, s_36_4, s_36_5)
        let s_36_6: () = AArch32_ITLBI_ALL(
            state,
            tracer,
            s_36_2,
            s_36_3,
    ...
    fn block_37<T: Tracer>(
        ...
        // C s_37_3: const #4u : u32
        let s_37_3: u32 = 4;
        // C s_37_4: const #0u : u32
        let s_37_4: u32 = 0;
        // C s_37_5: const #1u : u32
        let s_37_5: u32 = 1;
        // D s_37_6: call AArch32_ITLBI_ALL(s_37_2, s_37_3, s_37_4, s_37_5)
        let s_37_6: () = AArch32_ITLBI_ALL(
            state,
            tracer,
            s_37_2,
            s_37_3,
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_5: write-var gs#129538 <= s_38_4
        fn_state.gs_129538 = s_38_4;
        // N s_38_6: jump b35
        return block_35(state, tracer, fn_state);
    }
    fn block_39<T: Tracer>(
        ...
        // D s_39_2: write-var gs#129537 <= s_39_1
        fn_state.gs_129537 = s_39_1;
        // N s_39_3: jump b33
        return block_33(state, tracer, fn_state);
    }
    fn block_40<T: Tracer>(
        ...
        // D s_40_2: write-var gs#129536 <= s_40_1
        fn_state.gs_129536 = s_40_1;
        // N s_40_3: jump b31
        return block_31(state, tracer, fn_state);
    }
    fn block_41<T: Tracer>(
        ...
        // D s_41_4: write-var gs#129535 <= s_41_3
        fn_state.gs_129535 = s_41_3;
        // N s_41_5: jump b29
        return block_29(state, tracer, fn_state);
    }
    ...
    fn block_43<T: Tracer>(
        ...
        // D s_43_5: write-var gs#129534 <= s_43_4
        fn_state.gs_129534 = s_43_4;
        // N s_43_6: jump b26
        return block_26(state, tracer, fn_state);
    }
    fn block_44<T: Tracer>(
        ...
        // D s_44_3: write-var gs#129533 <= s_44_2
        fn_state.gs_129533 = s_44_2;
        // N s_44_4: jump b24
        return block_24(state, tracer, fn_state);
    }
    ...
    fn block_46<T: Tracer>(
        ...
        // D s_46_5: write-var gs#129532 <= s_46_4
        fn_state.gs_129532 = s_46_4;
        // N s_46_6: jump b21
        return block_21(state, tracer, fn_state);
    }
    fn block_47<T: Tracer>(
        ...
        // D s_47_4: write-var gs#129531 <= s_47_3
        fn_state.gs_129531 = s_47_3;
        // N s_47_5: jump b19
        return block_19(state, tracer, fn_state);
    }
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_5: write-var gs#129530 <= s_49_4
        fn_state.gs_129530 = s_49_4;
        // N s_49_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_50<T: Tracer>(
        ...
        // D s_50_3: write-var gs#129529 <= s_50_2
        fn_state.gs_129529 = s_50_2;
        // N s_50_4: jump b14
        return block_14(state, tracer, fn_state);
    }
    ...
    fn block_52<T: Tracer>(
        ...
        // D s_52_5: write-var gs#129528 <= s_52_4
        fn_state.gs_129528 = s_52_4;
        // N s_52_6: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_53<T: Tracer>(
        ...
        // D s_53_4: write-var gs#129527 <= s_53_3
        fn_state.gs_129527 = s_53_3;
        // N s_53_5: jump b9
        return block_9(state, tracer, fn_state);
    }
