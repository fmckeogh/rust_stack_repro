...
use CurrentVL_read::*;
use HaveSVE2::*;
use execute_CDOT_Z_ZZZi_D::*;
use HaveSME::*;
use common::*;
pub fn decode_CDOT_Z_ZZZi_D<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    i1: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#216841 <= s_1_0
        fn_state.gs_216841 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#216841:u8
        let s_2_0: bool = fn_state.gs_216841;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_105: cmp-eq s_3_103 s_3_104
        let s_3_105: bool = ((s_3_103) == (s_3_104));
        // D s_3_106: write-var sub_i <= s_3_105
        fn_state.sub_i = s_3_105;
        // D s_3_107: read-var VL:i64
        let s_3_107: i64 = fn_state.VL;
        // C s_3_108: const #128s : i
        let s_3_108: i128 = 128;
        // D s_3_109: cast zx s_3_107 -> i
        let s_3_109: i128 = (i128::try_from(s_3_107).unwrap());
        // D s_3_110: cmp-eq s_3_109 s_3_108
        let s_3_110: bool = ((s_3_109) == (s_3_108));
        // D s_3_111: not s_3_110
        let s_3_111: bool = !s_3_110;
        // N s_3_112: branch s_3_111 b5 b4
        if s_3_111 {
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_9: call execute_CDOT_Z_ZZZi_D(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5, s_4_6, s_4_7, s_4_8)
        let s_4_9: () = execute_CDOT_Z_ZZZi_D(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_9: call execute_CDOT_Z_ZZZi_D(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5, s_6_6, s_6_7, s_6_8)
        let s_6_9: () = execute_CDOT_Z_ZZZi_D(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_9: call execute_CDOT_Z_ZZZi_D(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5, s_8_6, s_8_7, s_8_8)
        let s_8_9: () = execute_CDOT_Z_ZZZi_D(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_9: call execute_CDOT_Z_ZZZi_D(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5, s_10_6, s_10_7, s_10_8)
        let s_10_9: () = execute_CDOT_Z_ZZZi_D(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_9: call execute_CDOT_Z_ZZZi_D(s_12_0, s_12_1, s_12_2, s_12_3, s_12_4, s_12_5, s_12_6, s_12_7, s_12_8)
        let s_12_9: () = execute_CDOT_Z_ZZZi_D(
            state,
            tracer,
            s_12_0,
            s_12_1,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#216841 <= s_15_2
        fn_state.gs_216841 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
