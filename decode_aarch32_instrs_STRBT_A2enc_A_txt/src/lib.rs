...
use common::*;
pub fn decode_aarch32_instrs_STRBT_A2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    U: bool,
    ...
    struct FunctionState {
        ...
        m: i64,
        gs_302466: bool,
        ga_347882: ProductType396b95aa74979079,
        t: i64,
        imm32: u32,
        shift_nshadow_7276: i128,
        n: i64,
        add: bool,
        shift_t: u32,
        gs_302464: bool,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_30: write-var ga#347882 <= s_2_29
        fn_state.ga_347882 = s_2_29;
        // D s_2_31: read-var ga#347882.0:struct
        let s_2_31: u32 = fn_state.ga_347882._0;
        // D s_2_32: read-var ga#347882.1:struct
        let s_2_32: i128 = fn_state.ga_347882._1;
        // D s_2_33: write-var shift_t <= s_2_31
        fn_state.shift_t = s_2_31;
        // D s_2_34: write-var shift_nshadow#7276 <= s_2_32
        fn_state.shift_nshadow_7276 = s_2_32;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#302463 <= s_3_3
        fn_state.gs_302463 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#302463:u8
        let s_4_0: bool = fn_state.gs_302463;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_5: write-var gs#302464 <= s_5_4
        fn_state.gs_302464 = s_5_4;
        // N s_5_6: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#302464:u8
        let s_6_0: bool = fn_state.gs_302464;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#302466 <= s_7_3
        fn_state.gs_302466 = s_7_3;
        // N s_7_5: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#302466:u8
        let s_8_0: bool = fn_state.gs_302466;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_2: read-var shift_nshadow#7276:i
        let s_9_2: i128 = fn_state.shift_nshadow_7276;
        ...
        // D s_9_10: call execute_aarch32_instrs_STRBT_Op_A_txt(s_9_5, s_9_0, s_9_4, s_9_6, s_9_7, s_9_8, s_9_2, s_9_1, s_9_9)
        let s_9_10: () = execute_aarch32_instrs_STRBT_Op_A_txt(
            state,
            tracer,
            s_9_5,
            s_9_0,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#302466 <= s_11_0
        fn_state.gs_302466 = s_11_0;
        // N s_11_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#302464 <= s_12_0
        fn_state.gs_302464 = s_12_0;
        // N s_12_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#302463 <= s_13_0
        fn_state.gs_302463 = s_13_0;
        // N s_13_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
