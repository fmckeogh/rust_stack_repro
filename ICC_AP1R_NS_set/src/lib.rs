...
extern crate alloc;
use common::*;
pub fn ICC_AP1R_NS_set<T: Tracer>(
    state: &mut State,
    tracer: &T,
    n: i64,
    value_name: u32,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_13: const #11536u : u32
        let s_0_13: u32 = 11536;
        ...
        // C s_0_15: const #12848u : u32
        let s_0_15: u32 = 12848;
        // D s_0_16: read-reg s_0_15:[u32; 4]
        let s_0_16: [u32; 4usize] = {
            let value = state.read_register::<[u32; 4usize]>(s_0_15 as isize);
        ...
        let s_0_19: [u32; 4usize] = {
            let mut local = s_0_16.clone();
            local[(s_0_18) as usize] = s_0_0;
            local
        };
        // D s_0_20: cast cvt s_0_19 -> [u32; 0]
        let s_0_20: alloc::vec::Vec<u32> = alloc::vec::Vec::from(s_0_19);
        // D s_0_21: cast cvt s_0_20 -> [u32; 4]
        let s_0_21: [u32; 4usize] = {
            let mut buf = [Default::default(); 4usize];
            buf.copy_from_slice(&s_0_20);
            buf
        };
        // C s_0_22: const #12848u : u32
        let s_0_22: u32 = 12848;
        // N s_0_23: write-reg s_0_22 <= s_0_21
        let s_0_23: () = {
            state.write_register::<[u32; 4usize]>(s_0_22 as isize, s_0_21);
