...
extern crate alloc;
use HaveSM4Ext::*;
use execute_aarch64_instrs_vector_crypto_sm4_sm4enc::*;
use common::*;
pub fn decode_sm4e_advsimd_aarch64_instrs_vector_crypto_sm4_sm4enc<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_8: call execute_aarch64_instrs_vector_crypto_sm4_sm4enc(s_1_3, s_1_7)
        let s_1_8: () = execute_aarch64_instrs_vector_crypto_sm4_sm4enc(
            state,
            tracer,
            s_1_3,
            s_1_7,
