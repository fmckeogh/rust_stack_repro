...
use R_read::*;
use common::*;
pub fn execute_aarch32_instrs_QADD_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        gs_882297: ProductTypef506aa96a892fe52,
        d: i64,
        m: i64,
        n: i64,
    }
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_20: write-var gs#882297 <= s_0_19
        fn_state.gs_882297 = s_0_19;
        // D s_0_21: read-var gs#882297.0:struct
        let s_0_21: Bits = fn_state.gs_882297._0;
        // D s_0_22: cast reint s_0_21 -> u32
        let s_0_22: u32 = (s_0_21.value() as u32);
        // D s_0_23: read-var gs#882297.1:struct
        let s_0_23: bool = fn_state.gs_882297._1;
