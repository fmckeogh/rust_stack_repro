...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_VCGT_i_Op_A_txt::*;
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_VCGT_i_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    size: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#307214 <= s_4_0
        fn_state.gs_307214 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#307214:u8
        let s_5_0: bool = fn_state.gs_307214;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#307215 <= s_7_0
        fn_state.gs_307215 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#307215:u8
        let s_8_0: bool = fn_state.gs_307215;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#307216 <= s_9_0
        fn_state.gs_307216 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#307216:u8
        let s_10_0: bool = fn_state.gs_307216;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#307222 <= s_12_0
        fn_state.gs_307222 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#307222:u8
        let s_13_0: bool = fn_state.gs_307222;
    ...
    fn block_15<T: Tracer>(
        ...
        let s_15_0: i64 = 2;
        // D s_15_1: write-var ga#351722 <= s_15_0
        fn_state.ga_351722 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var ga#351722:i64
        let s_16_0: i64 = fn_state.ga_351722;
        ...
        // D s_16_9: call execute_aarch32_instrs_VCGT_i_Op_A_txt(s_16_6, s_16_5, s_16_3, s_16_7, s_16_8, s_16_0)
        let s_16_9: () = execute_aarch32_instrs_VCGT_i_Op_A_txt(
            state,
            tracer,
            s_16_6,
            s_16_5,
    ...
    fn block_17<T: Tracer>(
        ...
        let s_17_0: i64 = 1;
        // D s_17_1: write-var ga#351722 <= s_17_0
        fn_state.ga_351722 = s_17_0;
        // N s_17_2: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_22: write-var gs#307221 <= s_20_21
        fn_state.gs_307221 = s_20_21;
        // N s_20_23: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#307221:u8
        let s_21_0: bool = fn_state.gs_307221;
        // D s_21_1: write-var gs#307222 <= s_21_0
        fn_state.gs_307222 = s_21_0;
        // N s_21_2: jump b13
        return block_13(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#307221 <= s_22_0
        fn_state.gs_307221 = s_22_0;
        // N s_22_2: jump b21
        return block_21(state, tracer, fn_state);
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_2: write-var gs#307216 <= s_24_1
        fn_state.gs_307216 = s_24_1;
        // N s_24_3: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_5: write-var gs#307215 <= s_25_4
        fn_state.gs_307215 = s_25_4;
        // N s_25_6: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_5: write-var gs#307214 <= s_27_4
        fn_state.gs_307214 = s_27_4;
        // N s_27_6: jump b5
        return block_5(state, tracer, fn_state);
    }
