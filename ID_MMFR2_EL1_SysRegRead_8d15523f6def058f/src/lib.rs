...
use common::*;
pub fn ID_MMFR2_EL1_SysRegRead_8d15523f6def058f<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // C s_5_1: const #103160u : u32
        let s_5_1: u32 = 103160;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 64;
        // C s_6_1: const #103160u : u32
        let s_6_1: u32 = 103160;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#62872 <= s_8_0
        fn_state.gs_62872 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#62872:u8
        let s_9_0: bool = fn_state.gs_62872;
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 64;
        // C s_10_1: const #103160u : u32
        let s_10_1: u32 = 103160;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#62872 <= s_12_4
        fn_state.gs_62872 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#62874 <= s_16_0
        fn_state.gs_62874 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#62874:u8
        let s_17_0: bool = fn_state.gs_62874;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_5: write-var gs#62874 <= s_20_4
        fn_state.gs_62874 = s_20_4;
        // N s_20_6: jump b17
        return block_17(state, tracer, fn_state);
    }
}
