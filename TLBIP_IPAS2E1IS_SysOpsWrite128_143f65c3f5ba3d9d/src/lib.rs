...
use common::*;
pub fn TLBIP_IPAS2E1IS_SysOpsWrite128_143f65c3f5ba3d9d<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#138107 <= s_10_0
        fn_state.gs_138107 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#138107:u8
        let s_11_0: bool = fn_state.gs_138107;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_5: write-var gs#138107 <= s_14_4
        fn_state.gs_138107 = s_14_4;
        // N s_14_6: jump b11
        return block_11(state, tracer, fn_state);
    }
