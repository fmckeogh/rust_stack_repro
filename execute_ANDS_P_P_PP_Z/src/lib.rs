...
use common::*;
pub fn execute_ANDS_P_P_PP_Z<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_46: write-var gs#198113 <= s_1_45
        fn_state.gs_198113 = s_1_45;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#198113:i64
        let s_2_1: i64 = fn_state.gs_198113;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: read-var element1:u8
        let s_6_3: bool = fn_state.element1;
        // D s_6_4: cast zx s_6_3 -> bv
        let s_6_4: Bits = Bits::new(s_6_3 as u128, 1u16);
        // D s_6_5: read-var element2:u8
        let s_6_5: bool = fn_state.element2;
        // D s_6_6: cast zx s_6_5 -> bv
        let s_6_6: Bits = Bits::new(s_6_5 as u128, 1u16);
        // D s_6_7: and s_6_4 s_6_6
        let s_6_7: Bits = ((s_6_4) & (s_6_6));
        ...
        // D s_6_10: read-var psize:i64
        let s_6_10: i64 = fn_state.psize;
        // D s_6_11: cast zx s_6_10 -> i
        let s_6_11: i128 = (i128::try_from(s_6_10).unwrap());
        // D s_6_12: bits-cast zx s_6_9 -> bv length s_6_11
        let s_6_12: Bits = s_6_9.zero_extend(s_6_11);
        ...
        // D s_6_16: cast zx s_6_2 -> i
        let s_6_16: i128 = (i128::try_from(s_6_2).unwrap());
        // D s_6_17: cast zx s_6_13 -> bv
        let s_6_17: Bits = Bits::new(s_6_13 as u128, 1u16);
        // D s_6_18: read-var result:bv
        let s_6_18: Bits = fn_state.result;
        // D s_6_19: call Elem_set(s_6_18, s_6_15, s_6_16, s_6_17)
        let s_6_19: Bits = Elem_set(state, tracer, s_6_18, s_6_15, s_6_16, s_6_17);
