...
use Z_set::*;
use common::*;
pub fn execute_ORR_Z_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#2507 <= s_0_2
        fn_state.VLshadow_2507 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#2507:i64
        let s_1_0: i64 = fn_state.VLshadow_2507;
