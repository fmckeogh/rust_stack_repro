...
use common::*;
pub fn decode_aarch32_instrs_SMLALBB_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    RdLo: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        fn_state.m = s_2_18;
        // D s_2_20: read-var N:u8
        let s_2_20: bool = fn_state.N;
        ...
        // D s_2_25: write-var n_high <= s_2_24
        fn_state.n_high = s_2_24;
        // D s_2_26: read-var M:u8
        let s_2_26: bool = fn_state.M;
        ...
        // D s_2_31: write-var m_high <= s_2_30
        fn_state.m_high = s_2_30;
        // C s_2_32: const #15s : i
        let s_2_32: i128 = 15;
        // D s_2_33: read-var dLo:i64
        let s_2_33: i64 = fn_state.dLo;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#301242 <= s_3_3
        fn_state.gs_301242 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#301242:u8
        let s_4_0: bool = fn_state.gs_301242;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#301244 <= s_5_3
        fn_state.gs_301244 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#301244:u8
        let s_6_0: bool = fn_state.gs_301244;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#301246 <= s_7_3
        fn_state.gs_301246 = s_7_3;
        // N s_7_5: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#301246:u8
        let s_8_0: bool = fn_state.gs_301246;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#301246 <= s_13_0
        fn_state.gs_301246 = s_13_0;
        // N s_13_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#301244 <= s_14_0
        fn_state.gs_301244 = s_14_0;
        // N s_14_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#301242 <= s_15_0
        fn_state.gs_301242 = s_15_0;
        // N s_15_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
