...
use common::*;
pub fn TLBI_RVALE2IS_SysOpsWrite_ca640565cc2dea92<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#102565 <= s_15_0
        fn_state.gs_102565 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#102565:u8
        let s_16_0: bool = fn_state.gs_102565;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_5: write-var gs#102565 <= s_19_4
        fn_state.gs_102565 = s_19_4;
        // N s_19_6: jump b16
        return block_16(state, tracer, fn_state);
    }
