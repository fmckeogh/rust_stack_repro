...
extern crate alloc;
use neq_int::*;
use execute_aarch64_instrs_memory_rcw_swp::*;
use HaveTHExt::*;
use common::*;
pub fn decode_rcwswp_aarch64_instrs_memory_rcw_swp<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var gs#166494 <= s_2_0
        fn_state.gs_166494 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#166494:u8
        let s_3_0: bool = fn_state.gs_166494;
        ...
        // D s_3_14: call execute_aarch64_instrs_memory_rcw_swp(s_3_0, s_3_10, s_3_5, s_3_11, s_3_12, s_3_13, s_3_9)
        let s_3_14: () = execute_aarch64_instrs_memory_rcw_swp(
            state,
            tracer,
            s_3_0,
            s_3_10,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_5: write-var gs#166494 <= s_4_4
        fn_state.gs_166494 = s_4_4;
        // N s_4_6: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_5<T: Tracer>(
