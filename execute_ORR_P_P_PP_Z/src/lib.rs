...
use common::*;
pub fn execute_ORR_P_P_PP_Z<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_46: write-var gs#198806 <= s_1_45
        fn_state.gs_198806 = s_1_45;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#198806:i64
        let s_2_1: i64 = fn_state.gs_198806;
