...
extern crate alloc;
use u_get_MPAM2_EL2_Type_PMG_D::*;
use u_get_MPAM1_EL1_Type_PMG_D::*;
use u_get_MPAM0_EL1_Type_PMG_I::*;
use u_get_MPAMSM_EL1_Type_PMG_D::*;
use MPAM3_EL3_read::*;
use u_get_MPAM3_EL3_Type_PMG_I::*;
use u_get_MPAM1_EL1_Type_PMG_I::*;
use u_get_MPAM3_EL3_Type_PMG_D::*;
use u_get_MPAM0_EL1_Type_PMG_D::*;
use MPAM1_EL1_read::*;
use Zeros::*;
use EL2Enabled::*;
use u__UNKNOWN_PMGtype::*;
use u_get_MPAM2_EL2_Type_PMG_I::*;
use common::*;
pub fn getMPAM_PMG<T: Tracer>(
    state: &mut State,
    tracer: &T,
    MPAMn: u8,
    InD: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // S s_3_2: call _get_MPAM3_EL3_Type_PMG_D(s_3_1)
        let s_3_2: u8 = u_get_MPAM3_EL3_Type_PMG_D(state, tracer, s_3_1);
        // D s_3_3: write-var pmg <= s_3_2
        fn_state.pmg = s_3_2;
        // N s_3_4: jump b4
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var pmg:u8
        let s_5_0: u8 = fn_state.pmg;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: u8 = fn_state.return_value;
    ...
    fn block_9<T: Tracer>(
        ...
        // S s_9_2: cast reint s_9_1 -> u8
        let s_9_2: u8 = (s_9_1.value() as u8);
        // D s_9_3: write-var pmg <= s_9_2
        fn_state.pmg = s_9_2;
        // N s_9_4: jump b10
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_2: call _get_MPAM2_EL2_Type_PMG_D(s_11_1)
        let s_11_2: u8 = u_get_MPAM2_EL2_Type_PMG_D(state, tracer, s_11_1);
        // D s_11_3: write-var pmg <= s_11_2
        fn_state.pmg = s_11_2;
        // N s_11_4: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_13<T: Tracer>(
        ...
        // S s_13_2: call _get_MPAM1_EL1_Type_PMG_D(s_13_1)
        let s_13_2: u8 = u_get_MPAM1_EL1_Type_PMG_D(state, tracer, s_13_1);
        // D s_13_3: write-var pmg <= s_13_2
        fn_state.pmg = s_13_2;
        // N s_13_4: jump b4
        return block_4(state, tracer, fn_state);
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_2: call _get_MPAM0_EL1_Type_PMG_D(s_15_1)
        let s_15_2: u8 = u_get_MPAM0_EL1_Type_PMG_D(state, tracer, s_15_1);
        // D s_15_3: write-var pmg <= s_15_2
        fn_state.pmg = s_15_2;
        // N s_15_4: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_16<T: Tracer>(
        ...
        // C s_16_0: const #() : ()
        let s_16_0: () = ();
        // S s_16_1: call __UNKNOWN_PMGtype(s_16_0)
        let s_16_1: u8 = u__UNKNOWN_PMGtype(state, tracer, s_16_0);
        // D s_16_2: write-var pmg <= s_16_1
        fn_state.pmg = s_16_1;
        // N s_16_3: jump b4
        return block_4(state, tracer, fn_state);
    }
    ...
    fn block_18<T: Tracer>(
        ...
        // S s_18_2: call _get_MPAM3_EL3_Type_PMG_I(s_18_1)
        let s_18_2: u8 = u_get_MPAM3_EL3_Type_PMG_I(state, tracer, s_18_1);
        // D s_18_3: write-var pmg <= s_18_2
        fn_state.pmg = s_18_2;
        // N s_18_4: jump b19
    ...
    fn block_22<T: Tracer>(
        ...
        // S s_22_2: cast reint s_22_1 -> u8
        let s_22_2: u8 = (s_22_1.value() as u8);
        // D s_22_3: write-var pmg <= s_22_2
        fn_state.pmg = s_22_2;
        // N s_22_4: jump b23
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_2: call _get_MPAM2_EL2_Type_PMG_I(s_24_1)
        let s_24_2: u8 = u_get_MPAM2_EL2_Type_PMG_I(state, tracer, s_24_1);
        // D s_24_3: write-var pmg <= s_24_2
        fn_state.pmg = s_24_2;
        // N s_24_4: jump b23
        return block_23(state, tracer, fn_state);
    }
    ...
    fn block_26<T: Tracer>(
        ...
        // S s_26_2: call _get_MPAM1_EL1_Type_PMG_I(s_26_1)
        let s_26_2: u8 = u_get_MPAM1_EL1_Type_PMG_I(state, tracer, s_26_1);
        // D s_26_3: write-var pmg <= s_26_2
        fn_state.pmg = s_26_2;
        // N s_26_4: jump b19
        return block_19(state, tracer, fn_state);
    }
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_2: call _get_MPAM0_EL1_Type_PMG_I(s_28_1)
        let s_28_2: u8 = u_get_MPAM0_EL1_Type_PMG_I(state, tracer, s_28_1);
        // D s_28_3: write-var pmg <= s_28_2
        fn_state.pmg = s_28_2;
        // N s_28_4: jump b19
        return block_19(state, tracer, fn_state);
    }
    fn block_29<T: Tracer>(
        ...
        // C s_29_0: const #() : ()
        let s_29_0: () = ();
        // S s_29_1: call __UNKNOWN_PMGtype(s_29_0)
        let s_29_1: u8 = u__UNKNOWN_PMGtype(state, tracer, s_29_0);
        // D s_29_2: write-var pmg <= s_29_1
        fn_state.pmg = s_29_1;
        // N s_29_3: jump b19
        return block_19(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_2: call _get_MPAMSM_EL1_Type_PMG_D(s_30_1)
        let s_30_2: u8 = u_get_MPAMSM_EL1_Type_PMG_D(state, tracer, s_30_1);
        // D s_30_3: write-var pmg <= s_30_2
        fn_state.pmg = s_30_2;
        // D s_30_4: read-var pmg:u8
        let s_30_4: u8 = fn_state.pmg;
