...
use common::*;
pub fn decode_aarch32_instrs_AESE_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    size: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_22: write-var gs#323795 <= s_5_21
        fn_state.gs_323795 = s_5_21;
        // N s_5_23: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#323795:u8
        let s_6_0: bool = fn_state.gs_323795;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_32: call execute_aarch32_instrs_AESE_Op_A_txt(s_7_15, s_7_31)
        let s_7_32: () = execute_aarch32_instrs_AESE_Op_A_txt(
            state,
            tracer,
            s_7_15,
            s_7_31,
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#323795 <= s_9_0
        fn_state.gs_323795 = s_9_0;
        // N s_9_2: jump b6
        return block_6(state, tracer, fn_state);
    }
