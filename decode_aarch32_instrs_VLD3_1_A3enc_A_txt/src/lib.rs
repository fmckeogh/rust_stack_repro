...
use neq_int::*;
use ConditionPassed::*;
use execute_aarch32_instrs_VLD3_1_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_VLD3_1_A3enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_12: cmp-ne s_3_9 s_3_11
        let s_3_12: bool = ((s_3_9) != (s_3_11));
        // N s_3_13: branch s_3_12 b16 b4
        if s_3_12 {
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 2;
        // D s_5_1: write-var ga#354388 <= s_5_0
        fn_state.ga_354388 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#354388:i64
        let s_6_0: i64 = fn_state.ga_354388;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#310770 <= s_7_0
        fn_state.gs_310770 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#310770:u8
        let s_8_0: bool = fn_state.gs_310770;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: write-var gs#310773 <= s_9_3
        fn_state.gs_310773 = s_9_3;
        // N s_9_5: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#310773:u8
        let s_10_0: bool = fn_state.gs_310773;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_11: call execute_aarch32_instrs_VLD3_1_Op_A_txt(s_11_4, s_11_1, s_11_3, s_11_5, s_11_6, s_11_7, s_11_8, s_11_9, s_11_10)
        let s_11_11: () = execute_aarch32_instrs_VLD3_1_Op_A_txt(
            state,
            tracer,
            s_11_4,
            s_11_1,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#310773 <= s_13_0
        fn_state.gs_310773 = s_13_0;
        // N s_13_2: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_14<T: Tracer>(
        ...
        // D s_14_4: write-var gs#310770 <= s_14_3
        fn_state.gs_310770 = s_14_3;
        // N s_14_5: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        let s_15_0: i64 = 1;
        // D s_15_1: write-var ga#354388 <= s_15_0
        fn_state.ga_354388 = s_15_0;
        // N s_15_2: jump b6
        return block_6(state, tracer, fn_state);
    }
