...
use EL2Enabled::*;
use common::*;
pub fn RMR_EL2_SysRegRead_0cc9a425a7ab6f44<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        gs_69064: bool,
        ga_84414: ProductType5c790c8ef59cc8b2,
        gs_69061: bool,
        u__HCR_EL2_NV: bool,
        gs_69062: bool,
        gs_69063: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#69061 <= s_1_0
        fn_state.gs_69061 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#69061:u8
        let s_2_0: bool = fn_state.gs_69061;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#69062 <= s_3_0
        fn_state.gs_69062 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#69062:u8
        let s_4_0: bool = fn_state.gs_69062;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#69063 <= s_5_0
        fn_state.gs_69063 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#69063:u8
        let s_6_0: bool = fn_state.gs_69063;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#69064 <= s_8_0
        fn_state.gs_69064 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#69064:u8
        let s_9_0: bool = fn_state.gs_69064;
    ...
    fn block_11<T: Tracer>(
        ...
        let s_11_0: i64 = 64;
        // C s_11_1: const #23120u : u32
        let s_11_1: u32 = 23120;
        ...
        // D s_11_3: call __get_RMR_EL2(s_11_2)
        let s_11_3: ProductType5c790c8ef59cc8b2 = u__get_RMR_EL2(state, tracer, s_11_2);
        // D s_11_4: write-var ga#84414 <= s_11_3
        fn_state.ga_84414 = s_11_3;
        // D s_11_5: read-var ga#84414.0:struct
        let s_11_5: u64 = fn_state.ga_84414._0;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_3: write-var gs#69064 <= s_12_2
        fn_state.gs_69064 = s_12_2;
        // N s_12_4: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_5: write-var gs#69063 <= s_14_4
        fn_state.gs_69063 = s_14_4;
        // N s_14_6: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#69062 <= s_15_2
        fn_state.gs_69062 = s_15_2;
        // N s_15_4: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_16<T: Tracer>(
        ...
        // D s_16_2: write-var gs#69061 <= s_16_1
        fn_state.gs_69061 = s_16_1;
        // N s_16_3: jump b2
        return block_2(state, tracer, fn_state);
    }
}
