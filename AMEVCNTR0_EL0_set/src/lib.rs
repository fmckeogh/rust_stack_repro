...
extern crate alloc;
use common::*;
pub fn AMEVCNTR0_EL0_set<T: Tracer>(
    state: &mut State,
    tracer: &T,
    n: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_13: const #14624u : u32
        let s_0_13: u32 = 14624;
        ...
        // C s_0_15: const #22024u : u32
        let s_0_15: u32 = 22024;
        // D s_0_16: read-reg s_0_15:[struct; 4]
        let s_0_16: [ProductType5c790c8ef59cc8b2; 4usize] = {
            let value = state
                .read_register::<[ProductType5c790c8ef59cc8b2; 4usize]>(s_0_15 as isize);
        ...
        let s_0_19: [ProductType5c790c8ef59cc8b2; 4usize] = {
        ...
        let s_0_21: [ProductType5c790c8ef59cc8b2; 4usize] = {
            let mut buf = [Default::default(); 4usize];
            buf.copy_from_slice(&s_0_20);
            buf
        };
        // C s_0_22: const #22024u : u32
        let s_0_22: u32 = 22024;
