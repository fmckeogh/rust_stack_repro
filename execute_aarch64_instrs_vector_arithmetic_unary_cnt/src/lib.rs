...
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_unary_cnt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    datasize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var datasizeshadow#1137 <= s_0_2
        fn_state.datasizeshadow_1137 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var datasizeshadow#1137:i64
        let s_1_0: i64 = fn_state.datasizeshadow_1137;
        ...
        // D s_1_13: write-var gs#146416 <= s_1_12
        fn_state.gs_146416 = s_1_12;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#146416:i64
        let s_2_1: i64 = fn_state.gs_146416;
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_9: Bits = Bits::new(s_3_8 as u128, 8u16);
        // D s_3_10: call BitCount(s_3_9)
        let s_3_10: i128 = BitCount(state, tracer, s_3_9);
        ...
        // C s_3_14: const #1s : i
        let s_3_14: i128 = 1;
        // D s_3_15: read-var esize:i64
        let s_3_15: i64 = fn_state.esize;
        ...
        // D s_3_21: call integer_subrange(s_3_10, s_3_20, s_3_19)
        let s_3_21: Bits = integer_subrange(state, tracer, s_3_10, s_3_20, s_3_19);
        // D s_3_22: read-var e:i64
        let s_3_22: i64 = fn_state.e;
        // D s_3_23: cast zx s_3_22 -> i
        let s_3_23: i128 = (i128::try_from(s_3_22).unwrap());
        // D s_3_24: cast zx s_3_13 -> i
        let s_3_24: i128 = (i128::try_from(s_3_13).unwrap());
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var datasizeshadow#1137:i64
        let s_4_0: i64 = fn_state.datasizeshadow_1137;
