...
use CurrentVL_read::*;
use HaveSME2::*;
use execute_UQRSHR_Z_MZ2__::*;
use common::*;
pub fn decode_UQRSHR_Z_MZ2__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm4: u8,
    Zn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_6: call execute_UQRSHR_Z_MZ2__(s_2_0, s_2_3, s_2_4, s_2_5, s_2_2)
        let s_2_6: () = execute_UQRSHR_Z_MZ2__(
            state,
            tracer,
            s_2_0,
            s_2_3,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_6: call execute_UQRSHR_Z_MZ2__(s_4_0, s_4_3, s_4_4, s_4_5, s_4_2)
        let s_4_6: () = execute_UQRSHR_Z_MZ2__(
            state,
            tracer,
            s_4_0,
            s_4_3,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_6: call execute_UQRSHR_Z_MZ2__(s_6_0, s_6_3, s_6_4, s_6_5, s_6_2)
        let s_6_6: () = execute_UQRSHR_Z_MZ2__(
            state,
            tracer,
            s_6_0,
            s_6_3,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_6: call execute_UQRSHR_Z_MZ2__(s_8_0, s_8_3, s_8_4, s_8_5, s_8_2)
        let s_8_6: () = execute_UQRSHR_Z_MZ2__(
            state,
            tracer,
            s_8_0,
            s_8_3,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_6: call execute_UQRSHR_Z_MZ2__(s_10_0, s_10_3, s_10_4, s_10_5, s_10_2)
        let s_10_6: () = execute_UQRSHR_Z_MZ2__(
            state,
            tracer,
            s_10_0,
            s_10_3,
