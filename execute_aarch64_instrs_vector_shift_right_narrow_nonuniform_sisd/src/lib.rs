...
use common::*;
pub fn execute_aarch64_instrs_vector_shift_right_narrow_nonuniform_sisd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    datasize: i64,
    ...
    struct FunctionState {
        operand: Bits,
        e: i64,
        ga_268285: ProductTypef506aa96a892fe52,
        esizeshadow_1953: i64,
        gs_171895: i64,
        result: Bits,
        datasizeshadow_1954: i64,
        d: i64,
        datasize: i64,
        elements: i128,
        esize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#1953 <= s_0_2
        fn_state.esizeshadow_1953 = s_0_2;
        ...
        // D s_0_7: write-var datasizeshadow#1954 <= s_0_6
        fn_state.datasizeshadow_1954 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // C s_1_0: const #2s : i
        let s_1_0: i128 = 2;
        // D s_1_1: read-var datasizeshadow#1954:i64
        let s_1_1: i64 = fn_state.datasizeshadow_1954;
        ...
        // D s_1_16: write-var gs#171895 <= s_1_15
        fn_state.gs_171895 = s_1_15;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#171895:i64
        let s_2_1: i64 = fn_state.gs_171895;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_0: const #2s : i
        let s_3_0: i128 = 2;
        // D s_3_1: read-var esizeshadow#1953:i64
        let s_3_1: i64 = fn_state.esizeshadow_1953;
        ...
        // D s_3_16: read-var esizeshadow#1953:i64
        let s_3_16: i64 = fn_state.esizeshadow_1953;
        ...
        // D s_3_20: call UnsignedSatQ(s_3_15, s_3_19)
        let s_3_20: ProductTypef506aa96a892fe52 = UnsignedSatQ(
            state,
            tracer,
            s_3_15,
            s_3_19,
        );
        // D s_3_21: write-var ga#268285 <= s_3_20
        fn_state.ga_268285 = s_3_20;
        // D s_3_22: read-var ga#268285.0:struct
        let s_3_22: Bits = fn_state.ga_268285._0;
        // D s_3_23: read-var ga#268285.1:struct
        let s_3_23: bool = fn_state.ga_268285._1;
        // D s_3_24: read-var esizeshadow#1953:i64
        let s_3_24: i64 = fn_state.esizeshadow_1953;
        ...
        // D s_3_31: call Elem_set(s_3_30, s_3_28, s_3_29, s_3_22)
        let s_3_31: Bits = Elem_set(state, tracer, s_3_30, s_3_28, s_3_29, s_3_22);
        // D s_3_32: write-var result <= s_3_31
        fn_state.result = s_3_31;
        // N s_3_33: branch s_3_23 b6 b4
        if s_3_23 {
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var datasizeshadow#1954:i64
        let s_7_0: i64 = fn_state.datasizeshadow_1954;
