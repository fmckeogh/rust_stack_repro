...
use EDSCR_read::*;
use common::*;
pub fn AMEVCNTVOFF0_EL2_SysRegRead_48d575ae64c47181<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#48363 <= s_1_0
        fn_state.gs_48363 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#48363:u8
        let s_2_0: bool = fn_state.gs_48363;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: write-var gs#48363 <= s_6_2
        fn_state.gs_48363 = s_6_2;
        // N s_6_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
