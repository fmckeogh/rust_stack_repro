...
use common::*;
pub fn u__get_PMEVTYPER<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #32s : i
        let s_0_3: i128 = 32;
        // C s_0_4: const #983040u : u20
        let s_0_4: u32 = 983040;
        ...
        // D s_0_15: tail-call Mk_PMEVTYPER_Type(s_0_14)
        return Mk_PMEVTYPER_Type(state, tracer, s_0_14);
    }
}
