...
use common::*;
pub fn decode_fmls_advsimd_elt_aarch64_instrs_vector_arithmetic_binary_element_mul_acc_fp16_sisd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#255526 <= s_1_0
        fn_state.ga_255526 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#255526:i64
        let s_2_0: i64 = fn_state.ga_255526;
        ...
        // D s_2_41: read-var o2:u8
        let s_2_41: bool = fn_state.o2;
        ...
        // C s_2_50: const #1s : i
        let s_2_50: i128 = 1;
        // D s_2_51: call execute_aarch64_instrs_vector_arithmetic_binary_element_mul_acc_fp16_sisd(s_2_12, s_2_46, s_2_50, s_2_47, s_2_49, s_2_40, s_2_8, s_2_4, s_2_45)
        let s_2_51: () = execute_aarch64_instrs_vector_arithmetic_binary_element_mul_acc_fp16_sisd(
            state,
            tracer,
            s_2_12,
            s_2_46,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 128;
        // D s_3_1: write-var ga#255526 <= s_3_0
        fn_state.ga_255526 = s_3_0;
        // N s_3_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
