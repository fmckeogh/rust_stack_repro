...
extern crate alloc;
use HaveSVE::*;
use execute_UQDECW_R_RS_UW::*;
use HaveSME::*;
use common::*;
pub fn decode_UQDECW_R_RS_UW<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    sf: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#191572 <= s_1_0
        fn_state.gs_191572 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#191572:u8
        let s_2_0: bool = fn_state.gs_191572;
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_15: i64 = 32;
        // D s_3_16: call execute_UQDECW_R_RS_UW(s_3_4, s_3_0, s_3_13, s_3_5, s_3_15, s_3_14)
        let s_3_16: () = execute_UQDECW_R_RS_UW(
            state,
            tracer,
            s_3_4,
            s_3_0,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: write-var gs#191572 <= s_5_2
        fn_state.gs_191572 = s_5_2;
        // N s_5_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
