...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_binary_element_mul_int::*;
use common::*;
pub fn decode_mul_advsimd_elt_aarch64_instrs_vector_arithmetic_binary_element_mul_int<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#263733 <= s_1_0
        fn_state.ga_263733 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#263733:i64
        let s_2_0: i64 = fn_state.ga_263733;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: write-var indexshadow#1773 <= s_4_1
        fn_state.indexshadow_1773 = s_4_1;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // D s_5_1: write-var ga#263745 <= s_5_0
        fn_state.ga_263745 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#263745:i64
        let s_6_0: i64 = fn_state.ga_263745;
        ...
        // D s_6_6: cast zx s_6_0 -> i
        let s_6_6: i128 = (i128::try_from(s_6_0).unwrap());
        ...
        // D s_6_11: read-var idxdsize:i64
        let s_6_11: i64 = fn_state.idxdsize;
        ...
        // D s_6_15: read-var d:i64
        let s_6_15: i64 = fn_state.d;
        // D s_6_16: read-var indexshadow#1773:i64
        let s_6_16: i64 = fn_state.indexshadow_1773;
        // D s_6_17: read-var m:i64
        let s_6_17: i64 = fn_state.m;
        // D s_6_18: read-var n:i64
        let s_6_18: i64 = fn_state.n;
        // D s_6_19: call execute_aarch64_instrs_vector_arithmetic_binary_element_mul_int(s_6_15, s_6_7, s_6_14, s_6_10, s_6_13, s_6_16, s_6_17, s_6_18)
        let s_6_19: () = execute_aarch64_instrs_vector_arithmetic_binary_element_mul_int(
            state,
            tracer,
            s_6_15,
            s_6_7,
    ...
    fn block_7<T: Tracer>(
        ...
        let s_7_0: i64 = 128;
        // D s_7_1: write-var ga#263745 <= s_7_0
        fn_state.ga_263745 = s_7_0;
        // N s_7_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
    ...
    fn block_11<T: Tracer>(
        ...
        let s_11_0: i64 = 128;
        // D s_11_1: write-var ga#263733 <= s_11_0
        fn_state.ga_263733 = s_11_0;
        // N s_11_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
