...
use Mem_set::*;
use common::*;
pub fn execute_STNT1H_Z_P_AR_S_x32_unscaled<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    esize: i64,
    ...
    struct FunctionState {
        e: i64,
        base: Bits,
        offsetshadow_5253: u64,
        mbytes: i64,
        VLshadow_5250: i64,
        accdesc: ProductType9878976b5bcce9c9,
        elements: i64,
        baseshadow_5254: Bits,
        offset: u64,
        srcshadow_5252: Bits,
        gs_249087: i64,
        VLshadow_5251: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#5250 <= s_0_2
        fn_state.VLshadow_5250 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#5250:i64
        let s_1_0: i64 = fn_state.VLshadow_5250;
        // D s_1_1: write-var VLshadow#5251 <= s_1_0
        fn_state.VLshadow_5251 = s_1_0;
        // C s_1_2: const #8s : i
        let s_1_2: i128 = 8;
        // D s_1_3: read-var VLshadow#5251:i64
        let s_1_3: i64 = fn_state.VLshadow_5251;
        ...
        // D s_1_7: read-var VLshadow#5251:i64
        let s_1_7: i64 = fn_state.VLshadow_5251;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var srcshadow#5252 <= s_3_0
        fn_state.srcshadow_5252 = s_3_0;
        // D s_3_2: read-var offset:u64
        let s_3_2: u64 = fn_state.offset;
        // D s_3_3: write-var offsetshadow#5253 <= s_3_2
        fn_state.offsetshadow_5253 = s_3_2;
        // D s_3_4: read-var base:bv
        let s_3_4: Bits = fn_state.base;
        // D s_3_5: write-var baseshadow#5254 <= s_3_4
        fn_state.baseshadow_5254 = s_3_4;
        ...
        // D s_3_12: write-var gs#249087 <= s_3_11
        fn_state.gs_249087 = s_3_11;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#249087:i64
        let s_4_1: i64 = fn_state.gs_249087;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_6: read-var baseshadow#5254:bv
        let s_8_6: Bits = fn_state.baseshadow_5254;
        ...
        // D s_8_14: read-var offsetshadow#5253:u64
        let s_8_14: u64 = fn_state.offsetshadow_5253;
        ...
        // D s_8_24: read-var srcshadow#5252:bv
        let s_8_24: Bits = fn_state.srcshadow_5252;
        // D s_8_25: call Elem_read(s_8_24, s_8_22, s_8_23)
        let s_8_25: Bits = Elem_read(state, tracer, s_8_24, s_8_22, s_8_23);
        // D s_8_26: cast reint s_8_25 -> u32
        let s_8_26: u32 = (s_8_25.value() as u32);
        // C s_8_27: const #0s : i
        let s_8_27: i128 = 0;
        // C s_8_28: const #16s : i
        let s_8_28: i128 = 16;
        // D s_8_29: cast zx s_8_26 -> bv
        let s_8_29: Bits = Bits::new(s_8_26 as u128, 32u16);
        // D s_8_30: bit-extract s_8_29 s_8_27 s_8_28
        let s_8_30: Bits = (Bits::new(
            ((s_8_29) >> (s_8_27)).value(),
            u16::try_from(s_8_28).unwrap(),
        ));
        // D s_8_31: cast reint s_8_30 -> u16
        let s_8_31: u16 = (s_8_30.value() as u16);
        ...
        let s_8_34: Bits = Bits::new(s_8_31 as u128, 16u16);
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var VLshadow#5251:i64
        let s_10_0: i64 = fn_state.VLshadow_5251;
        ...
        // D s_10_14: read-var VLshadow#5251:i64
        let s_10_14: i64 = fn_state.VLshadow_5251;
