...
use SP_read::*;
use common::*;
pub fn execute_aarch64_instrs_integer_pac_autib_dp_1src<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    n: i64,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_11: call AuthIB(s_3_4, s_3_9, s_3_10)
        let s_3_11: u64 = AuthIB(state, tracer, s_3_4, s_3_9, s_3_10);
        // D s_3_12: write-var ga#249701 <= s_3_11
        fn_state.ga_249701 = s_3_11;
        // N s_3_13: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: read-var ga#249701:u64
        let s_4_2: u64 = fn_state.ga_249701;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_8: call AuthIB(s_5_4, s_5_6, s_5_7)
        let s_5_8: u64 = AuthIB(state, tracer, s_5_4, s_5_6, s_5_7);
        // D s_5_9: write-var ga#249695 <= s_5_8
        fn_state.ga_249695 = s_5_8;
        // N s_5_10: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: read-var ga#249695:u64
        let s_6_2: u64 = fn_state.ga_249695;
