...
use common::*;
pub fn PRRR_SysRegWrite32_d60dcdae1cc2429d<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#134000 <= s_6_0
        fn_state.gs_134000 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#134000:u8
        let s_7_0: bool = fn_state.gs_134000;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#134001 <= s_9_0
        fn_state.gs_134001 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#134001:u8
        let s_10_0: bool = fn_state.gs_134001;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_2: call Mk_PRRR_Type(s_13_1)
        let s_13_2: ProductType700c18a878c5601b = Mk_PRRR_Type(state, tracer, s_13_1);
        // D s_13_3: call PRRR_NS_write(s_13_2)
        let s_13_3: () = PRRR_NS_write(state, tracer, s_13_2);
        // N s_13_4: return
        return;
    }
    fn block_14<T: Tracer>(
        ...
        // D s_14_2: call Mk_PRRR_Type(s_14_1)
        let s_14_2: ProductType700c18a878c5601b = Mk_PRRR_Type(state, tracer, s_14_1);
        // C s_14_3: const #19984u : u32
        let s_14_3: u32 = 19984;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_2: call Mk_MAIR0_Type(s_16_1)
        let s_16_2: ProductType700c18a878c5601b = Mk_MAIR0_Type(state, tracer, s_16_1);
        // D s_16_3: call MAIR0_NS_write(s_16_2)
        let s_16_3: () = MAIR0_NS_write(state, tracer, s_16_2);
        // N s_16_4: return
        return;
    }
    fn block_17<T: Tracer>(
        ...
        // D s_17_2: call Mk_MAIR0_Type(s_17_1)
        let s_17_2: ProductType700c18a878c5601b = Mk_MAIR0_Type(state, tracer, s_17_1);
        // D s_17_3: call MAIR0_S_write(s_17_2)
        let s_17_3: () = MAIR0_S_write(state, tracer, s_17_2);
        // N s_17_4: return
        return;
    }
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_4: write-var gs#134001 <= s_19_3
        fn_state.gs_134001 = s_19_3;
        // N s_19_5: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_4: write-var gs#134000 <= s_21_3
        fn_state.gs_134000 = s_21_3;
        // N s_21_5: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_1: write-var gs#134002 <= s_23_0
        fn_state.gs_134002 = s_23_0;
        // N s_23_2: jump b24
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_0: read-var gs#134002:u8
        let s_24_0: bool = fn_state.gs_134002;
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_2: call Mk_PRRR_Type(s_26_1)
        let s_26_2: ProductType700c18a878c5601b = Mk_PRRR_Type(state, tracer, s_26_1);
        // D s_26_3: call PRRR_write(s_26_2)
        let s_26_3: () = PRRR_write(state, tracer, s_26_2);
        // N s_26_4: return
        return;
    }
    fn block_27<T: Tracer>(
        ...
        // D s_27_2: call Mk_MAIR0_Type(s_27_1)
        let s_27_2: ProductType700c18a878c5601b = Mk_MAIR0_Type(state, tracer, s_27_1);
        // D s_27_3: call MAIR0_write(s_27_2)
        let s_27_3: () = MAIR0_write(state, tracer, s_27_2);
        // N s_27_4: return
        return;
    }
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_2: call Mk_PRRR_Type(s_29_1)
        let s_29_2: ProductType700c18a878c5601b = Mk_PRRR_Type(state, tracer, s_29_1);
        // D s_29_3: call PRRR_NS_write(s_29_2)
        let s_29_3: () = PRRR_NS_write(state, tracer, s_29_2);
        // N s_29_4: return
        return;
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_2: call Mk_MAIR0_Type(s_30_1)
        let s_30_2: ProductType700c18a878c5601b = Mk_MAIR0_Type(state, tracer, s_30_1);
        // D s_30_3: call MAIR0_NS_write(s_30_2)
        let s_30_3: () = MAIR0_NS_write(state, tracer, s_30_2);
        // N s_30_4: return
        return;
    }
    fn block_31<T: Tracer>(
        ...
        // D s_31_3: write-var gs#134002 <= s_31_2
        fn_state.gs_134002 = s_31_2;
        // N s_31_4: jump b24
        return block_24(state, tracer, fn_state);
    }
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_1: write-var gs#134003 <= s_33_0
        fn_state.gs_134003 = s_33_0;
        // N s_33_2: jump b34
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_0: read-var gs#134003:u8
        let s_34_0: bool = fn_state.gs_134003;
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_1: write-var gs#134004 <= s_35_0
        fn_state.gs_134004 = s_35_0;
        // N s_35_2: jump b36
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_0: read-var gs#134004:u8
        let s_36_0: bool = fn_state.gs_134004;
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_1: write-var gs#134005 <= s_38_0
        fn_state.gs_134005 = s_38_0;
        // N s_38_2: jump b39
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_0: read-var gs#134005:u8
        let s_39_0: bool = fn_state.gs_134005;
    ...
    fn block_40<T: Tracer>(
        ...
        // D s_40_1: write-var gs#134006 <= s_40_0
        fn_state.gs_134006 = s_40_0;
        // N s_40_2: jump b41
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_0: read-var gs#134006:u8
        let s_41_0: bool = fn_state.gs_134006;
    ...
    fn block_43<T: Tracer>(
        ...
        // D s_43_1: write-var gs#134007 <= s_43_0
        fn_state.gs_134007 = s_43_0;
        // N s_43_2: jump b44
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_0: read-var gs#134007:u8
        let s_44_0: bool = fn_state.gs_134007;
    ...
    fn block_45<T: Tracer>(
        ...
        // D s_45_1: write-var gs#134008 <= s_45_0
        fn_state.gs_134008 = s_45_0;
        // N s_45_2: jump b46
    ...
    fn block_46<T: Tracer>(
        ...
        // D s_46_0: read-var gs#134008:u8
        let s_46_0: bool = fn_state.gs_134008;
    ...
    fn block_48<T: Tracer>(
        ...
        // D s_48_1: write-var gs#134009 <= s_48_0
        fn_state.gs_134009 = s_48_0;
        // N s_48_2: jump b49
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_0: read-var gs#134009:u8
        let s_49_0: bool = fn_state.gs_134009;
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_1: write-var gs#134010 <= s_50_0
        fn_state.gs_134010 = s_50_0;
        // N s_50_2: jump b51
    ...
    fn block_51<T: Tracer>(
        ...
        // D s_51_0: read-var gs#134010:u8
        let s_51_0: bool = fn_state.gs_134010;
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_1: write-var gs#134011 <= s_53_0
        fn_state.gs_134011 = s_53_0;
        // N s_53_2: jump b54
    ...
    fn block_54<T: Tracer>(
        ...
        // D s_54_0: read-var gs#134011:u8
        let s_54_0: bool = fn_state.gs_134011;
    ...
    fn block_56<T: Tracer>(
        ...
        // D s_56_2: call Mk_PRRR_Type(s_56_1)
        let s_56_2: ProductType700c18a878c5601b = Mk_PRRR_Type(state, tracer, s_56_1);
        // D s_56_3: call PRRR_write(s_56_2)
        let s_56_3: () = PRRR_write(state, tracer, s_56_2);
        // N s_56_4: return
        return;
    }
    fn block_57<T: Tracer>(
        ...
        // D s_57_2: call Mk_MAIR0_Type(s_57_1)
        let s_57_2: ProductType700c18a878c5601b = Mk_MAIR0_Type(state, tracer, s_57_1);
        // D s_57_3: call MAIR0_write(s_57_2)
        let s_57_3: () = MAIR0_write(state, tracer, s_57_2);
        // N s_57_4: return
        return;
    }
    ...
    fn block_59<T: Tracer>(
        ...
        // D s_59_2: call Mk_PRRR_Type(s_59_1)
        let s_59_2: ProductType700c18a878c5601b = Mk_PRRR_Type(state, tracer, s_59_1);
        // D s_59_3: call PRRR_NS_write(s_59_2)
        let s_59_3: () = PRRR_NS_write(state, tracer, s_59_2);
        // N s_59_4: return
        return;
    }
    fn block_60<T: Tracer>(
        ...
        // D s_60_2: call Mk_MAIR0_Type(s_60_1)
        let s_60_2: ProductType700c18a878c5601b = Mk_MAIR0_Type(state, tracer, s_60_1);
        // D s_60_3: call MAIR0_NS_write(s_60_2)
        let s_60_3: () = MAIR0_NS_write(state, tracer, s_60_2);
        // N s_60_4: return
        return;
    }
    fn block_61<T: Tracer>(
        ...
        // D s_61_3: write-var gs#134011 <= s_61_2
        fn_state.gs_134011 = s_61_2;
        // N s_61_4: jump b54
        return block_54(state, tracer, fn_state);
    }
    ...
    fn block_63<T: Tracer>(
        ...
        // D s_63_5: write-var gs#134010 <= s_63_4
        fn_state.gs_134010 = s_63_4;
        // N s_63_6: jump b51
        return block_51(state, tracer, fn_state);
    }
    fn block_64<T: Tracer>(
        ...
        // D s_64_3: write-var gs#134009 <= s_64_2
        fn_state.gs_134009 = s_64_2;
        // N s_64_4: jump b49
        return block_49(state, tracer, fn_state);
    }
    ...
    fn block_66<T: Tracer>(
        ...
        // D s_66_5: write-var gs#134008 <= s_66_4
        fn_state.gs_134008 = s_66_4;
        // N s_66_6: jump b46
        return block_46(state, tracer, fn_state);
    }
    fn block_67<T: Tracer>(
        ...
        // D s_67_4: write-var gs#134007 <= s_67_3
        fn_state.gs_134007 = s_67_3;
        // N s_67_5: jump b44
        return block_44(state, tracer, fn_state);
    }
    ...
    fn block_69<T: Tracer>(
        ...
        // D s_69_5: write-var gs#134006 <= s_69_4
        fn_state.gs_134006 = s_69_4;
        // N s_69_6: jump b41
        return block_41(state, tracer, fn_state);
    }
    fn block_70<T: Tracer>(
        ...
        // D s_70_3: write-var gs#134005 <= s_70_2
        fn_state.gs_134005 = s_70_2;
        // N s_70_4: jump b39
        return block_39(state, tracer, fn_state);
    }
    ...
    fn block_72<T: Tracer>(
        ...
        // D s_72_5: write-var gs#134004 <= s_72_4
        fn_state.gs_134004 = s_72_4;
        // N s_72_6: jump b36
        return block_36(state, tracer, fn_state);
    }
    fn block_73<T: Tracer>(
        ...
        // D s_73_4: write-var gs#134003 <= s_73_3
        fn_state.gs_134003 = s_73_3;
        // N s_73_5: jump b34
        return block_34(state, tracer, fn_state);
    }
