...
pub fn u__get_VDFSR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4261412864u : u32
        let s_0_3: u32 = 4261412864;
        ...
        // D s_0_11: tail-call Mk_VDFSR_Type(s_0_10)
        return Mk_VDFSR_Type(state, tracer, s_0_10);
    }
}
