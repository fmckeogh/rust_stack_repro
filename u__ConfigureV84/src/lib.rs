...
use u__ConfigureV83::*;
use common::*;
pub fn u__ConfigureV84<T: Tracer>(state: &mut State, tracer: &T, enabled: bool) -> () {
    #[derive(Default)]
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: call __ConfigureV83(s_2_0)
        let s_2_1: () = u__ConfigureV83(state, tracer, s_2_0);
        // N s_2_2: return
        return;
    }
}
