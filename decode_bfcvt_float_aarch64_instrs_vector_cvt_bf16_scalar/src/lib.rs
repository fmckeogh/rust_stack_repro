...
extern crate alloc;
use execute_aarch64_instrs_vector_cvt_bf16_scalar::*;
use HaveBF16Ext::*;
use common::*;
pub fn decode_bfcvt_float_aarch64_instrs_vector_cvt_bf16_scalar<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_8: call execute_aarch64_instrs_vector_cvt_bf16_scalar(s_1_7, s_1_3)
        let s_1_8: () = execute_aarch64_instrs_vector_cvt_bf16_scalar(
            state,
            tracer,
            s_1_7,
            s_1_3,
