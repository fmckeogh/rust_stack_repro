...
use CurrentVL_read::*;
use HaveSME2::*;
use execute_BFVDOT_ZA_ZZi_2xi::*;
use common::*;
pub fn decode_BFVDOT_ZA_ZZi_2xi<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Zm: u8,
    Rv: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        fn_state.m = s_1_49;
        // D s_1_51: read-var off3:u8
        let s_1_51: u8 = fn_state.off3;
        // D s_1_52: cast zx s_1_51 -> bv
        let s_1_52: Bits = Bits::new(s_1_51 as u128, 3u16);
        ...
        // D s_1_56: read-var i2:u8
        let s_1_56: u8 = fn_state.i2;
        // D s_1_57: cast zx s_1_56 -> bv
        let s_1_57: Bits = Bits::new(s_1_56 as u128, 2u16);
        // D s_1_58: cast zx s_1_57 -> i
        let s_1_58: i128 = (s_1_57.value() as i128);
        // D s_1_59: cast reint s_1_58 -> i64
        let s_1_59: i64 = (s_1_58 as i64);
        // D s_1_60: write-var index <= s_1_59
        fn_state.index = s_1_59;
        // D s_1_61: read-var VL:i64
        let s_1_61: i64 = fn_state.VL;
        // C s_1_62: const #128s : i
        let s_1_62: i128 = 128;
        // D s_1_63: cast zx s_1_61 -> i
        let s_1_63: i128 = (i128::try_from(s_1_61).unwrap());
        // D s_1_64: cmp-eq s_1_63 s_1_62
        let s_1_64: bool = ((s_1_63) == (s_1_62));
        // D s_1_65: not s_1_64
        let s_1_65: bool = !s_1_64;
        // N s_1_66: branch s_1_65 b3 b2
        if s_1_65 {
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_5: read-var v:i64
        let s_2_5: i64 = fn_state.v;
        // D s_2_6: call execute_BFVDOT_ZA_ZZi_2xi(s_2_0, s_2_1, s_2_2, s_2_3, s_2_4, s_2_5)
        let s_2_6: () = execute_BFVDOT_ZA_ZZi_2xi(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_5: read-var v:i64
        let s_4_5: i64 = fn_state.v;
        // D s_4_6: call execute_BFVDOT_ZA_ZZi_2xi(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5)
        let s_4_6: () = execute_BFVDOT_ZA_ZZi_2xi(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: read-var v:i64
        let s_6_5: i64 = fn_state.v;
        // D s_6_6: call execute_BFVDOT_ZA_ZZi_2xi(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5)
        let s_6_6: () = execute_BFVDOT_ZA_ZZi_2xi(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_5: read-var v:i64
        let s_8_5: i64 = fn_state.v;
        // D s_8_6: call execute_BFVDOT_ZA_ZZi_2xi(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5)
        let s_8_6: () = execute_BFVDOT_ZA_ZZi_2xi(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: read-var v:i64
        let s_10_5: i64 = fn_state.v;
        // D s_10_6: call execute_BFVDOT_ZA_ZZi_2xi(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5)
        let s_10_6: () = execute_BFVDOT_ZA_ZZi_2xi(
            state,
            tracer,
            s_10_0,
            s_10_1,
