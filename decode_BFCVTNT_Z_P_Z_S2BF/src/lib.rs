...
use CurrentVL_read::*;
use HaveBF16Ext::*;
use execute_BFCVTNT_Z_P_Z_S2BF::*;
use HaveSME::*;
use common::*;
pub fn decode_BFCVTNT_Z_P_Z_S2BF<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Pg: u8,
    Zn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#183300 <= s_1_0
        fn_state.gs_183300 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#183300:u8
        let s_2_0: bool = fn_state.gs_183300;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_3: write-var gs#183301 <= s_3_2
        fn_state.gs_183301 = s_3_2;
        // N s_3_4: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#183301:u8
        let s_4_0: bool = fn_state.gs_183301;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var Pg:u8
        let s_5_0: u8 = fn_state.Pg;
        ...
        fn_state.n = s_5_8;
        // D s_5_10: read-var Zd:u8
        let s_5_10: u8 = fn_state.Zd;
        ...
        // D s_5_14: write-var d <= s_5_13
        fn_state.d = s_5_13;
        // D s_5_15: read-var VL:i64
        let s_5_15: i64 = fn_state.VL;
        // C s_5_16: const #128s : i
        let s_5_16: i128 = 128;
        // D s_5_17: cast zx s_5_15 -> i
        let s_5_17: i128 = (i128::try_from(s_5_15).unwrap());
        // D s_5_18: cmp-eq s_5_17 s_5_16
        let s_5_18: bool = ((s_5_17) == (s_5_16));
        // D s_5_19: not s_5_18
        let s_5_19: bool = !s_5_18;
        // N s_5_20: branch s_5_19 b7 b6
        if s_5_19 {
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call execute_BFCVTNT_Z_P_Z_S2BF(s_6_0, s_6_1, s_6_2, s_6_3)
        let s_6_4: () = execute_BFCVTNT_Z_P_Z_S2BF(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: call execute_BFCVTNT_Z_P_Z_S2BF(s_8_0, s_8_1, s_8_2, s_8_3)
        let s_8_4: () = execute_BFCVTNT_Z_P_Z_S2BF(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: call execute_BFCVTNT_Z_P_Z_S2BF(s_10_0, s_10_1, s_10_2, s_10_3)
        let s_10_4: () = execute_BFCVTNT_Z_P_Z_S2BF(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_4: call execute_BFCVTNT_Z_P_Z_S2BF(s_12_0, s_12_1, s_12_2, s_12_3)
        let s_12_4: () = execute_BFCVTNT_Z_P_Z_S2BF(
            state,
            tracer,
            s_12_0,
            s_12_1,
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_2: read-var g:i64
        let s_14_2: i64 = fn_state.g;
        // D s_14_3: read-var n:i64
        let s_14_3: i64 = fn_state.n;
        // D s_14_4: call execute_BFCVTNT_Z_P_Z_S2BF(s_14_0, s_14_1, s_14_2, s_14_3)
        let s_14_4: () = execute_BFCVTNT_Z_P_Z_S2BF(
            state,
            tracer,
            s_14_0,
            s_14_1,
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#183301 <= s_17_0
        fn_state.gs_183301 = s_17_0;
        // N s_17_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_18<T: Tracer>(
        ...
        // D s_18_3: write-var gs#183300 <= s_18_2
        fn_state.gs_183300 = s_18_2;
        // N s_18_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
