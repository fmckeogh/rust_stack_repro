...
use common::*;
pub fn TLBI_ALLE1IS_SysOpsWrite_03d7588893774850<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_5: u32 = 1;
        // D s_6_6: call AArch64_TLBI_ALL(s_6_2, s_6_3, s_6_4, s_6_5)
        let s_6_6: () = AArch64_TLBI_ALL(state, tracer, s_6_2, s_6_3, s_6_4, s_6_5);
        // N s_6_7: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#101969 <= s_9_0
        fn_state.gs_101969 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#101969:u8
        let s_10_0: bool = fn_state.gs_101969;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_5: write-var gs#101969 <= s_13_4
        fn_state.gs_101969 = s_13_4;
        // N s_13_6: jump b10
        return block_10(state, tracer, fn_state);
    }
