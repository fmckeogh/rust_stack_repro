...
use common::*;
pub fn decode_aarch32_instrs_VINS_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Vd: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_7: write-var gs#312780 <= s_5_6
        fn_state.gs_312780 = s_5_6;
        // N s_5_8: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#312780:u8
        let s_6_0: bool = fn_state.gs_312780;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_32: call execute_aarch32_instrs_VINS_Op_A_txt(s_7_15, s_7_31)
        let s_7_32: () = execute_aarch32_instrs_VINS_Op_A_txt(
            state,
            tracer,
            s_7_15,
            s_7_31,
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#312780 <= s_9_0
        fn_state.gs_312780 = s_9_0;
        // N s_9_2: jump b6
        return block_6(state, tracer, fn_state);
    }
