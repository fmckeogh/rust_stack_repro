...
extern crate alloc;
use AArch64_HaveS2TG::*;
use u__IMPDEF_bits::*;
use common::*;
pub fn AArch64_S2DecodeTG0<T: Tracer>(state: &mut State, tracer: &T, tg0_in: u8) -> u32 {
    #[derive(Default)]
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: call AArch64_HaveS2TG(s_4_0)
        let s_4_1: bool = AArch64_HaveS2TG(state, tracer, s_4_0);
        // D s_4_2: not s_4_1
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_5: write-var ga#13732 <= s_7_4
        fn_state.ga_13732 = s_7_4;
        // D s_7_6: read-var ga#13732:u8
        let s_7_6: u8 = fn_state.ga_13732;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var ga#13732:u8
        let s_10_0: u8 = fn_state.ga_13732;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var ga#13732:u8
        let s_12_0: u8 = fn_state.ga_13732;
