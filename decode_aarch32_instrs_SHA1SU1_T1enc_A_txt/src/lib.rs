...
extern crate alloc;
use execute_aarch32_instrs_SHA1SU1_Op_A_txt::*;
use HaveSHA1Ext::*;
use ConditionPassed::*;
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_SHA1SU1_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    size: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_22: write-var gs#324605 <= s_6_21
        fn_state.gs_324605 = s_6_21;
        // N s_6_23: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#324605:u8
        let s_7_0: bool = fn_state.gs_324605;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_32: call execute_aarch32_instrs_SHA1SU1_Op_A_txt(s_8_15, s_8_31)
        let s_8_32: () = execute_aarch32_instrs_SHA1SU1_Op_A_txt(
            state,
            tracer,
            s_8_15,
            s_8_31,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#324605 <= s_10_0
        fn_state.gs_324605 = s_10_0;
        // N s_10_2: jump b7
        return block_7(state, tracer, fn_state);
    }
