...
use common::*;
pub fn decode_neg_advsimd_aarch64_instrs_vector_arithmetic_unary_diff_neg_int_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, size: u8, U: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_18: call execute_aarch64_instrs_vector_arithmetic_unary_diff_neg_int_sisd(s_1_16, s_1_12, s_1_15, s_1_14, s_1_17, s_1_10)
        let s_1_18: () = execute_aarch64_instrs_vector_arithmetic_unary_diff_neg_int_sisd(
            state,
            tracer,
            s_1_16,
            s_1_12,
