...
use Zeros::*;
use common::*;
pub fn UAO_SysRegRead_4c61cdd9d285c8cc<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // S s_5_3: cast reint s_5_2 -> u40
        let s_5_3: u64 = (s_5_2.value() as u64);
        // C s_5_4: const #16995u : u32
        let s_5_4: u32 = 16995;
        ...
        let s_5_6: Bits = Bits::new(s_5_3 as u128, 40u16);
    ...
    fn block_6<T: Tracer>(
        ...
        // S s_6_3: cast reint s_6_2 -> u40
        let s_6_3: u64 = (s_6_2.value() as u64);
        // C s_6_4: const #16995u : u32
        let s_6_4: u32 = 16995;
        ...
        let s_6_6: Bits = Bits::new(s_6_3 as u128, 40u16);
    ...
    fn block_7<T: Tracer>(
        ...
        // S s_7_3: cast reint s_7_2 -> u40
        let s_7_3: u64 = (s_7_2.value() as u64);
        // C s_7_4: const #16995u : u32
        let s_7_4: u32 = 16995;
        ...
        let s_7_6: Bits = Bits::new(s_7_3 as u128, 40u16);
