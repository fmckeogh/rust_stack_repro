...
use FPRecpX::*;
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_unary_special_frecpx_fp16<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    esize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#1426 <= s_0_2
        fn_state.esizeshadow_1426 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var esizeshadow#1426:i64
        let s_1_0: i64 = fn_state.esizeshadow_1426;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var esizeshadow#1426:i64
        let s_3_0: i64 = fn_state.esizeshadow_1426;
        // D s_3_1: cast zx s_3_0 -> i
        let s_3_1: i128 = (i128::try_from(s_3_0).unwrap());
        // D s_3_2: cast reint s_3_1 -> i64
        let s_3_2: i64 = (s_3_1 as i64);
        // D s_3_3: write-var ga#256165 <= s_3_2
        fn_state.ga_256165 = s_3_2;
        // D s_3_4: read-var operand:bv
        let s_3_4: Bits = fn_state.operand;
        // D s_3_5: read-var fpcr:struct
        let s_3_5: ProductType5c790c8ef59cc8b2 = fn_state.fpcr;
        // D s_3_6: call FPRecpX(s_3_4, s_3_5)
        let s_3_6: Bits = FPRecpX(state, tracer, s_3_4, s_3_5);
        // D s_3_7: write-var ga#256166 <= s_3_6
        fn_state.ga_256166 = s_3_6;
        // N s_3_8: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_3: read-var ga#256165:i64
        let s_4_3: i64 = fn_state.ga_256165;
        // D s_4_4: cast zx s_4_3 -> i
        let s_4_4: i128 = (i128::try_from(s_4_3).unwrap());
        // D s_4_5: read-var ga#256166:bv
        let s_4_5: Bits = fn_state.ga_256166;
