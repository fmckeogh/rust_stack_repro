...
use HaveSME2::*;
use Halted::*;
use execute_MOVT_R_ZT__::*;
use common::*;
pub fn decode_MOVT_R_ZT__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    off3: u8,
    Rt: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_3: write-var gs#289970 <= s_1_2
        fn_state.gs_289970 = s_1_2;
        // N s_1_4: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#289970:u8
        let s_2_0: bool = fn_state.gs_289970;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_8: call execute_MOVT_R_ZT__(s_3_7, s_3_3)
        let s_3_8: () = execute_MOVT_R_ZT__(state, tracer, s_3_7, s_3_3);
        // N s_3_9: return
        return;
    }
    fn block_4<T: Tracer>(
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_0: const #1u : u8
        let s_5_0: bool = true;
        // D s_5_1: write-var gs#289970 <= s_5_0
        fn_state.gs_289970 = s_5_0;
        // N s_5_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
