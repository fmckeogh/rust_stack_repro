...
extern crate alloc;
use Mk_ID_AA64PFR1_EL1_Type::*;
use common::*;
pub fn u__get_ID_AA64PFR1_EL1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #64s : i
        let s_0_3: i128 = 64;
        // C s_0_4: const #15728640u : u24
        let s_0_4: u32 = 15728640;
        // C s_0_5: cast zx s_0_4 -> bv
        let s_0_5: Bits = Bits::new(s_0_4 as u128, 24u16);
        ...
        // D s_0_15: tail-call Mk_ID_AA64PFR1_EL1_Type(s_0_14)
        return Mk_ID_AA64PFR1_EL1_Type(state, tracer, s_0_14);
    }
}
