...
extern crate alloc;
use HaveFCADDExt::*;
use execute_aarch64_instrs_vector_arithmetic_binary_uniform_mul_fp_complex::*;
use common::*;
pub fn decode_fcmla_advsimd_vec_aarch64_instrs_vector_arithmetic_binary_uniform_mul_fp_complex<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#149630 <= s_3_0
        fn_state.gs_149630 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#149630:u8
        let s_4_0: bool = fn_state.gs_149630;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 64;
        // D s_6_1: write-var ga#253430 <= s_6_0
        fn_state.ga_253430 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var ga#253430:i64
        let s_7_0: i64 = fn_state.ga_253430;
        ...
        let s_7_15: u8 = fn_state.rot;
        // D s_7_16: call execute_aarch64_instrs_vector_arithmetic_binary_uniform_mul_fp_complex(s_7_12, s_7_7, s_7_11, s_7_10, s_7_13, s_7_14, s_7_15)
        let s_7_16: () = execute_aarch64_instrs_vector_arithmetic_binary_uniform_mul_fp_complex(
            state,
            tracer,
            s_7_12,
            s_7_7,
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 128;
        // D s_8_1: write-var ga#253430 <= s_8_0
        fn_state.ga_253430 = s_8_0;
        // N s_8_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: write-var gs#149630 <= s_10_4
        fn_state.gs_149630 = s_10_4;
        // N s_10_6: jump b4
        return block_4(state, tracer, fn_state);
    }
