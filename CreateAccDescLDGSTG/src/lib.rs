...
use HaveTME::*;
use common::*;
pub fn CreateAccDescLDGSTG<T: Tracer>(
    state: &mut State,
    tracer: &T,
    memop: u32,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_14: write-var accdesc.27 <= s_0_13
        fn_state.accdesc._27 = s_0_13;
        // C s_0_15: const #() : ()
        let s_0_15: () = ();
        // S s_0_16: call HaveTME(s_0_15)
        let s_0_16: bool = HaveTME(state, tracer, s_0_15);
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#7207 <= s_1_0
        fn_state.gs_7207 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#7207:u8
        let s_2_0: bool = fn_state.gs_7207;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#7207 <= s_3_3
        fn_state.gs_7207 = s_3_3;
        // N s_3_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
