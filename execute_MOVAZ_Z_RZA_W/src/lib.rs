...
use Z_set::*;
use common::*;
pub fn execute_MOVAZ_Z_RZA_W<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#6896 <= s_0_2
        fn_state.VLshadow_6896 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#6896:i64
        let s_1_0: i64 = fn_state.VLshadow_6896;
