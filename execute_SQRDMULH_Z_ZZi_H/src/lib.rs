...
use Z_set::*;
use common::*;
pub fn execute_SQRDMULH_Z_ZZi_H<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#3982 <= s_0_2
        fn_state.VLshadow_3982 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#3982:i64
        let s_1_0: i64 = fn_state.VLshadow_3982;
        // D s_1_1: write-var VLshadow#3983 <= s_1_0
        fn_state.VLshadow_3983 = s_1_0;
        // D s_1_2: read-var VLshadow#3983:i64
        let s_1_2: i64 = fn_state.VLshadow_3983;
        ...
        // D s_1_14: read-var VLshadow#3983:i64
        let s_1_14: i64 = fn_state.VLshadow_3983;
        ...
        // D s_1_22: read-var VLshadow#3983:i64
        let s_1_22: i64 = fn_state.VLshadow_3983;
        ...
        // D s_1_35: write-var gs#214074 <= s_1_34
        fn_state.gs_214074 = s_1_34;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#214074:i64
        let s_2_1: i64 = fn_state.gs_214074;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_68: cast reint s_3_67 -> u16
        let s_3_68: u16 = (s_3_67.value() as u16);
        // D s_3_69: read-var e:i64
        let s_3_69: i64 = fn_state.e;
        // D s_3_70: cast zx s_3_69 -> i
        let s_3_70: i128 = (i128::try_from(s_3_69).unwrap());
        // D s_3_71: cast zx s_3_49 -> i
        let s_3_71: i128 = (i128::try_from(s_3_49).unwrap());
        // D s_3_72: cast zx s_3_68 -> bv
        let s_3_72: Bits = Bits::new(s_3_68 as u128, 16u16);
        // D s_3_73: read-var result:bv
        let s_3_73: Bits = fn_state.result;
        // D s_3_74: call Elem_set(s_3_73, s_3_70, s_3_71, s_3_72)
        let s_3_74: Bits = Elem_set(state, tracer, s_3_73, s_3_70, s_3_71, s_3_72);
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#3983:i64
        let s_4_0: i64 = fn_state.VLshadow_3983;
