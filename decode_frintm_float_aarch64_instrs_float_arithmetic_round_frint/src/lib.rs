...
use FPCR_read::*;
use common::*;
pub fn decode_frintm_float_aarch64_instrs_float_arithmetic_round_frint<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var esizeshadow#1455 <= s_2_0
        fn_state.esizeshadow_1455 = s_2_0;
        // C s_2_2: const #0u : u8
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var esizeshadow#1455:i64
        let s_4_1: i64 = fn_state.esizeshadow_1455;
