...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_binary_disparate_add_sub_wide::*;
use common::*;
pub fn decode_ssubw_advsimd_aarch64_instrs_vector_arithmetic_binary_disparate_add_sub_wide<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_31: call execute_aarch64_instrs_vector_arithmetic_binary_disparate_add_sub_wide(s_1_28, s_1_26, s_1_27, s_1_25, s_1_29, s_1_30, s_1_9, s_1_18, s_1_23)
        let s_1_31: () = execute_aarch64_instrs_vector_arithmetic_binary_disparate_add_sub_wide(
            state,
            tracer,
            s_1_28,
            s_1_26,
