...
use common::*;
pub fn ICH_HCR_EL2_SysRegWrite_d09a9dfdfbf35716<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call Mk_ICH_HCR_EL2_Type(s_6_3)
        let s_6_4: ProductType5c790c8ef59cc8b2 = Mk_ICH_HCR_EL2_Type(
            state,
            tracer,
            s_6_3,
        );
        // C s_6_5: const #20992u : u32
        let s_6_5: u32 = 20992;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: call Mk_ICH_HCR_EL2_Type(s_9_3)
        let s_9_4: ProductType5c790c8ef59cc8b2 = Mk_ICH_HCR_EL2_Type(
            state,
            tracer,
            s_9_3,
        );
        // C s_9_5: const #20992u : u32
        let s_9_5: u32 = 20992;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#86238 <= s_12_0
        fn_state.gs_86238 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#86238:u8
        let s_13_0: bool = fn_state.gs_86238;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#86239 <= s_15_0
        fn_state.gs_86239 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#86239:u8
        let s_16_0: bool = fn_state.gs_86239;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_5: write-var gs#86239 <= s_19_4
        fn_state.gs_86239 = s_19_4;
        // N s_19_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_21: write-var gs#86238 <= s_21_20
        fn_state.gs_86238 = s_21_20;
        // N s_21_22: jump b13
        return block_13(state, tracer, fn_state);
    }
