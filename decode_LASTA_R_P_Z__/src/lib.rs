...
extern crate alloc;
use HaveSVE::*;
use execute_LASTA_R_P_Z__::*;
use CurrentVL_read::*;
use HaveSME::*;
use common::*;
pub fn decode_LASTA_R_P_Z__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    B: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#196786 <= s_1_0
        fn_state.gs_196786 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#196786:u8
        let s_2_0: bool = fn_state.gs_196786;
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 64;
        // D s_4_1: write-var ga#284672 <= s_4_0
        fn_state.ga_284672 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var ga#284672:i64
        let s_5_0: i64 = fn_state.ga_284672;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_11: call execute_LASTA_R_P_Z__(s_6_0, s_6_7, s_6_3, s_6_8, s_6_9, s_6_10, s_6_6)
        let s_6_11: () = execute_LASTA_R_P_Z__(
            state,
            tracer,
            s_6_0,
            s_6_7,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_11: call execute_LASTA_R_P_Z__(s_8_0, s_8_7, s_8_3, s_8_8, s_8_9, s_8_10, s_8_6)
        let s_8_11: () = execute_LASTA_R_P_Z__(
            state,
            tracer,
            s_8_0,
            s_8_7,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_11: call execute_LASTA_R_P_Z__(s_10_0, s_10_7, s_10_3, s_10_8, s_10_9, s_10_10, s_10_6)
        let s_10_11: () = execute_LASTA_R_P_Z__(
            state,
            tracer,
            s_10_0,
            s_10_7,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_11: call execute_LASTA_R_P_Z__(s_12_0, s_12_7, s_12_3, s_12_8, s_12_9, s_12_10, s_12_6)
        let s_12_11: () = execute_LASTA_R_P_Z__(
            state,
            tracer,
            s_12_0,
            s_12_7,
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_11: call execute_LASTA_R_P_Z__(s_14_0, s_14_7, s_14_3, s_14_8, s_14_9, s_14_10, s_14_6)
        let s_14_11: () = execute_LASTA_R_P_Z__(
            state,
            tracer,
            s_14_0,
            s_14_7,
    ...
    fn block_16<T: Tracer>(
        ...
        let s_16_0: i64 = 32;
        // D s_16_1: write-var ga#284672 <= s_16_0
        fn_state.ga_284672 = s_16_0;
        // N s_16_2: jump b5
        return block_5(state, tracer, fn_state);
    }
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_3: write-var gs#196786 <= s_18_2
        fn_state.gs_196786 = s_18_2;
        // N s_18_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
