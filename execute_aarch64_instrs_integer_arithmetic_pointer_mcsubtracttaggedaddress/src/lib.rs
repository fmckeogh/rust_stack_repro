...
use AddWithCarry::*;
use common::*;
pub fn execute_aarch64_instrs_integer_arithmetic_pointer_mcsubtracttaggedaddress<
    T: Tracer,
>(state: &mut State, tracer: &T, d: i64, m: i64, n: i64, setflags: bool) -> () {
    #[derive(Default)]
    struct FunctionState {
        gs_718596: ProductTyped54bc449dd09e5bd,
        nzcv: u8,
        result: u64,
        operand1: u64,
        operand2: u64,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_35: write-var gs#718596 <= s_4_34
        fn_state.gs_718596 = s_4_34;
        // D s_4_36: read-var gs#718596.0:struct
        let s_4_36: Bits = fn_state.gs_718596._0;
        // D s_4_37: cast reint s_4_36 -> u64
        let s_4_37: u64 = (s_4_36.value() as u64);
        // D s_4_38: read-var gs#718596.1:struct
        let s_4_38: u8 = fn_state.gs_718596._1;
