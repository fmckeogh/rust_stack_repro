...
use common::*;
pub fn ICC_BPR1_EL1_read<T: Tracer>(
    state: &mut State,
    tracer: &T,
    gs_33285: (),
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#33286 <= s_1_0
        fn_state.gs_33286 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#33286:u8
        let s_2_0: bool = fn_state.gs_33286;
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_0: const #102528u : u32
        let s_5_0: u32 = 102528;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: write-var gs#33286 <= s_6_3
        fn_state.gs_33286 = s_6_3;
        // N s_6_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
