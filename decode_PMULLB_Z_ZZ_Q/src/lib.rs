...
extern crate alloc;
use CurrentVL_read::*;
use execute_PMULLB_Z_ZZ_Q::*;
use HaveSVE2PMULL128::*;
use common::*;
pub fn decode_PMULLB_Z_ZZ_Q<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Zm: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #() : ()
        let s_0_3: () = ();
        // S s_0_4: call HaveSVE2PMULL128(s_0_3)
        let s_0_4: bool = HaveSVE2PMULL128(state, tracer, s_0_3);
        // S s_0_5: not s_0_4
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_5: call execute_PMULLB_Z_ZZ_Q(s_2_0, s_2_1, s_2_2, s_2_3, s_2_4)
        let s_2_5: () = execute_PMULLB_Z_ZZ_Q(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_5: call execute_PMULLB_Z_ZZ_Q(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4)
        let s_4_5: () = execute_PMULLB_Z_ZZ_Q(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: call execute_PMULLB_Z_ZZ_Q(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4)
        let s_6_5: () = execute_PMULLB_Z_ZZ_Q(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_5: call execute_PMULLB_Z_ZZ_Q(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4)
        let s_8_5: () = execute_PMULLB_Z_ZZ_Q(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: call execute_PMULLB_Z_ZZ_Q(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4)
        let s_10_5: () = execute_PMULLB_Z_ZZ_Q(
            state,
            tracer,
            s_10_0,
            s_10_1,
