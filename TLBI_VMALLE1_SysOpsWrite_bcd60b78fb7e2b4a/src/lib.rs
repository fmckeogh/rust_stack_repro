...
use u_get_HFGITR_EL2_Type_TLBIVMALLE1::*;
...
use AArch64_TLBI_VMALL::*;
use SecurityStateAtEL::*;
use u_get_HCR_EL2_Type_TGE::*;
use EL2Enabled::*;
use u_get_HCR_EL2_Type_FB::*;
use common::*;
pub fn TLBI_VMALLE1_SysOpsWrite_bcd60b78fb7e2b4a<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        gs_103077: bool,
        u__HFGITR_EL2_TLBIVMALLE1: bool,
        gs_103073: bool,
        gs_103080: bool,
        gs_103078: bool,
        u__HCR_EL2_FB: bool,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_13: call _get_HFGITR_EL2_Type_TLBIVMALLE1(s_0_12)
        let s_0_13: bool = u_get_HFGITR_EL2_Type_TLBIVMALLE1(state, tracer, s_0_12);
        // D s_0_14: write-var __HFGITR_EL2_TLBIVMALLE1 <= s_0_13
        fn_state.u__HFGITR_EL2_TLBIVMALLE1 = s_0_13;
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_5: const #4u : u32
        let s_7_5: u32 = 4;
        // C s_7_6: const #0u : u32
        let s_7_6: u32 = 0;
        // C s_7_7: const #1u : u32
        let s_7_7: u32 = 1;
        // D s_7_8: call AArch64_TLBI_VMALL(s_7_2, s_7_5, s_7_4, s_7_6, s_7_7)
        let s_7_8: () = AArch64_TLBI_VMALL(
            state,
            tracer,
            s_7_2,
            s_7_5,
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_3: const #3u : u32
        let s_8_3: u32 = 3;
        // C s_8_4: const #1080u : u32
        let s_8_4: u32 = 1080;
        // D s_8_5: read-reg s_8_4:u16
        let s_8_5: u16 = {
            let value = state.read_register::<u16>(s_8_4 as isize);
            tracer.read_register(s_8_4 as isize, value);
            value
        };
        // C s_8_6: const #0u : u32
        let s_8_6: u32 = 0;
        // C s_8_7: const #1u : u32
        let s_8_7: u32 = 1;
        // D s_8_8: call AArch64_TLBI_VMALL(s_8_2, s_8_3, s_8_5, s_8_6, s_8_7)
        let s_8_8: () = AArch64_TLBI_VMALL(
            state,
            tracer,
            s_8_2,
            s_8_3,
    ...
    fn block_10<T: Tracer>(
        ...
        // C s_10_5: const #4u : u32
        let s_10_5: u32 = 4;
        // C s_10_6: const #0u : u32
        let s_10_6: u32 = 0;
        // C s_10_7: const #1u : u32
        let s_10_7: u32 = 1;
        // D s_10_8: call AArch64_TLBI_VMALL(s_10_2, s_10_5, s_10_4, s_10_6, s_10_7)
        let s_10_8: () = AArch64_TLBI_VMALL(
            state,
            tracer,
            s_10_2,
            s_10_5,
    ...
    fn block_11<T: Tracer>(
        ...
        let s_11_3: u32 = 3;
        // C s_11_4: const #1080u : u32
        let s_11_4: u32 = 1080;
        // D s_11_5: read-reg s_11_4:u16
        let s_11_5: u16 = {
            let value = state.read_register::<u16>(s_11_4 as isize);
            tracer.read_register(s_11_4 as isize, value);
            value
        };
        // C s_11_6: const #0u : u32
        let s_11_6: u32 = 0;
        // C s_11_7: const #1u : u32
        let s_11_7: u32 = 1;
        // D s_11_8: call AArch64_TLBI_VMALL(s_11_2, s_11_3, s_11_5, s_11_6, s_11_7)
        let s_11_8: () = AArch64_TLBI_VMALL(
            state,
            tracer,
            s_11_2,
            s_11_3,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#103072 <= s_13_0
        fn_state.gs_103072 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#103072:u8
        let s_14_0: bool = fn_state.gs_103072;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#103073 <= s_16_0
        fn_state.gs_103073 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#103073:u8
        let s_17_0: bool = fn_state.gs_103073;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#103075 <= s_18_0
        fn_state.gs_103075 = s_18_0;
        // N s_18_2: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#103075:u8
        let s_19_0: bool = fn_state.gs_103075;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#103076 <= s_20_0
        fn_state.gs_103076 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#103076:u8
        let s_21_0: bool = fn_state.gs_103076;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#103078 <= s_22_0
        fn_state.gs_103078 = s_22_0;
        // N s_22_2: jump b23
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_0: read-var gs#103078:u8
        let s_23_0: bool = fn_state.gs_103078;
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_1: write-var gs#103079 <= s_24_0
        fn_state.gs_103079 = s_24_0;
        // N s_24_2: jump b25
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_0: read-var gs#103079:u8
        let s_25_0: bool = fn_state.gs_103079;
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_1: write-var gs#103080 <= s_27_0
        fn_state.gs_103080 = s_27_0;
        // N s_27_2: jump b28
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_0: read-var gs#103080:u8
        let s_28_0: bool = fn_state.gs_103080;
    ...
    fn block_29<T: Tracer>(
        ...
        // C s_29_5: const #4u : u32
        let s_29_5: u32 = 4;
        // C s_29_6: const #0u : u32
        let s_29_6: u32 = 0;
        // C s_29_7: const #1u : u32
        let s_29_7: u32 = 1;
        // D s_29_8: call AArch64_TLBI_VMALL(s_29_2, s_29_5, s_29_4, s_29_6, s_29_7)
        let s_29_8: () = AArch64_TLBI_VMALL(
            state,
            tracer,
            s_29_2,
            s_29_5,
    ...
    fn block_30<T: Tracer>(
        ...
        // C s_30_5: const #4u : u32
        let s_30_5: u32 = 4;
        // C s_30_6: const #1u : u32
        let s_30_6: u32 = 1;
        // C s_30_7: const #1u : u32
        let s_30_7: u32 = 1;
        // D s_30_8: call AArch64_TLBI_VMALL(s_30_2, s_30_5, s_30_4, s_30_6, s_30_7)
        let s_30_8: () = AArch64_TLBI_VMALL(
            state,
            tracer,
            s_30_2,
            s_30_5,
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_5: write-var gs#103080 <= s_31_4
        fn_state.gs_103080 = s_31_4;
        // N s_31_6: jump b28
        return block_28(state, tracer, fn_state);
    }
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var __HFGITR_EL2_TLBIVMALLE1:u8
        let s_33_0: bool = fn_state.u__HFGITR_EL2_TLBIVMALLE1;
        ...
        // D s_33_5: write-var gs#103079 <= s_33_4
        fn_state.gs_103079 = s_33_4;
        // N s_33_6: jump b25
        return block_25(state, tracer, fn_state);
    }
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_5: write-var gs#103077 <= s_35_4
        fn_state.gs_103077 = s_35_4;
        // N s_35_6: jump b36
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_0: read-var gs#103077:u8
        let s_36_0: bool = fn_state.gs_103077;
        // D s_36_1: write-var gs#103078 <= s_36_0
        fn_state.gs_103078 = s_36_0;
        // N s_36_2: jump b23
        return block_23(state, tracer, fn_state);
    }
    fn block_37<T: Tracer>(
        ...
        // D s_37_1: write-var gs#103077 <= s_37_0
        fn_state.gs_103077 = s_37_0;
        // N s_37_2: jump b36
        return block_36(state, tracer, fn_state);
    }
    fn block_38<T: Tracer>(
        ...
        // D s_38_2: write-var gs#103076 <= s_38_1
        fn_state.gs_103076 = s_38_1;
        // N s_38_3: jump b21
        return block_21(state, tracer, fn_state);
    }
    ...
    fn block_40<T: Tracer>(
        ...
        // D s_40_7: write-var gs#103074 <= s_40_6
        fn_state.gs_103074 = s_40_6;
        // N s_40_8: jump b41
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_0: read-var gs#103074:u8
        let s_41_0: bool = fn_state.gs_103074;
        // D s_41_1: write-var gs#103075 <= s_41_0
        fn_state.gs_103075 = s_41_0;
        // N s_41_2: jump b19
        return block_19(state, tracer, fn_state);
    }
    fn block_42<T: Tracer>(
        ...
        // D s_42_1: write-var gs#103074 <= s_42_0
        fn_state.gs_103074 = s_42_0;
        // N s_42_2: jump b41
        return block_41(state, tracer, fn_state);
    }
    fn block_43<T: Tracer>(
        ...
        // D s_43_2: write-var gs#103073 <= s_43_1
        fn_state.gs_103073 = s_43_1;
        // N s_43_3: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_45<T: Tracer>(
        ...
        // D s_45_5: write-var gs#103072 <= s_45_4
        fn_state.gs_103072 = s_45_4;
        // N s_45_6: jump b14
        return block_14(state, tracer, fn_state);
    }
