...
use u__get_SPSR_irq::*;
use common::*;
pub fn SPSR_irq_SysRegRead_3f8614ad01700094<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_98675: ProductType5c790c8ef59cc8b2,
        u__PSTATE_EL: u8,
        ga_98671: ProductType5c790c8ef59cc8b2,
        u__HCR_EL2_NV: bool,
        gs_74083: bool,
        el: u8,
        op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call __get_SPSR_irq(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_SPSR_irq(state, tracer, s_5_2);
        // D s_5_4: write-var ga#98675 <= s_5_3
        fn_state.ga_98675 = s_5_3;
        // D s_5_5: read-var ga#98675.0:struct
        let s_5_5: u64 = fn_state.ga_98675._0;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_SPSR_irq(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_SPSR_irq(state, tracer, s_6_2);
        // D s_6_4: write-var ga#98671 <= s_6_3
        fn_state.ga_98671 = s_6_3;
        // D s_6_5: read-var ga#98671.0:struct
        let s_6_5: u64 = fn_state.ga_98671._0;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#74083 <= s_8_0
        fn_state.gs_74083 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#74083:u8
        let s_9_0: bool = fn_state.gs_74083;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#74083 <= s_12_4
        fn_state.gs_74083 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
