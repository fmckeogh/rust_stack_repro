...
use common::*;
pub fn TLBI_ALLE2OS_SysOpsWrite_1134fdc29a86072a<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_9<T: Tracer>(
        ...
        let s_9_3: u32 = 3;
        // C s_9_4: const #2u : u32
        let s_9_4: u32 = 2;
        // C s_9_5: const #1u : u32
        let s_9_5: u32 = 1;
        // D s_9_6: call AArch64_TLBI_ALL(s_9_2, s_9_3, s_9_4, s_9_5)
        let s_9_6: () = AArch64_TLBI_ALL(state, tracer, s_9_2, s_9_3, s_9_4, s_9_5);
        // N s_9_7: return
        return;
    }
    ...
    fn block_12<T: Tracer>(
        ...
        // C s_12_3: const #2u : u32
        let s_12_3: u32 = 2;
        // C s_12_4: const #2u : u32
        let s_12_4: u32 = 2;
        // C s_12_5: const #1u : u32
        let s_12_5: u32 = 1;
    ...
    fn block_13<T: Tracer>(
        ...
        // C s_13_3: const #3u : u32
        let s_13_3: u32 = 3;
        // C s_13_4: const #2u : u32
        let s_13_4: u32 = 2;
        // C s_13_5: const #1u : u32
        let s_13_5: u32 = 1;
        // D s_13_6: call AArch64_TLBI_ALL(s_13_2, s_13_3, s_13_4, s_13_5)
        let s_13_6: () = AArch64_TLBI_ALL(state, tracer, s_13_2, s_13_3, s_13_4, s_13_5);
        // N s_13_7: return
        return;
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#101977 <= s_15_0
        fn_state.gs_101977 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#101977:u8
        let s_16_0: bool = fn_state.gs_101977;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_5: write-var gs#101977 <= s_19_4
        fn_state.gs_101977 = s_19_4;
        // N s_19_6: jump b16
        return block_16(state, tracer, fn_state);
    }
