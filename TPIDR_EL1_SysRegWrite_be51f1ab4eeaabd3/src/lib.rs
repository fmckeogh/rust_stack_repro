...
use X_read::*;
use u_get_HFGWTR_EL2_Type_TPIDR_EL1::*;
use EL2Enabled::*;
use AArch64_SystemAccessTrap::*;
use common::*;
pub fn TPIDR_EL1_SysRegWrite_be51f1ab4eeaabd3<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_9: call _get_HFGWTR_EL2_Type_TPIDR_EL1(s_0_8)
        let s_0_9: bool = u_get_HFGWTR_EL2_Type_TPIDR_EL1(state, tracer, s_0_8);
        // D s_0_10: write-var __HFGWTR_EL2_TPIDR_EL1 <= s_0_9
        fn_state.u__HFGWTR_EL2_TPIDR_EL1 = s_0_9;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#96837 <= s_8_0
        fn_state.gs_96837 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#96837:u8
        let s_9_0: bool = fn_state.gs_96837;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#96839 <= s_10_0
        fn_state.gs_96839 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#96839:u8
        let s_11_0: bool = fn_state.gs_96839;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#96840 <= s_12_0
        fn_state.gs_96840 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#96840:u8
        let s_13_0: bool = fn_state.gs_96840;
    ...
    fn block_14<T: Tracer>(
        ...
        // C s_14_4: const #14280u : u32
        let s_14_4: u32 = 14280;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var __HFGWTR_EL2_TPIDR_EL1:u8
        let s_16_0: bool = fn_state.u__HFGWTR_EL2_TPIDR_EL1;
        ...
        // D s_16_5: write-var gs#96840 <= s_16_4
        fn_state.gs_96840 = s_16_4;
        // N s_16_6: jump b13
        return block_13(state, tracer, fn_state);
    }
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_5: write-var gs#96838 <= s_18_4
        fn_state.gs_96838 = s_18_4;
        // N s_18_6: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#96838:u8
        let s_19_0: bool = fn_state.gs_96838;
        // D s_19_1: write-var gs#96839 <= s_19_0
        fn_state.gs_96839 = s_19_0;
        // N s_19_2: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#96838 <= s_20_0
        fn_state.gs_96838 = s_20_0;
        // N s_20_2: jump b19
        return block_19(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_2: write-var gs#96837 <= s_21_1
        fn_state.gs_96837 = s_21_1;
        // N s_21_3: jump b9
        return block_9(state, tracer, fn_state);
    }
