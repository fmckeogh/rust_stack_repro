...
use AArch64_AutoGen_SysOpsWrite128::*;
use common::*;
pub fn AArch64_SysInstr128<T: Tracer>(
    state: &mut State,
    tracer: &T,
    op0: i128,
    op1: i128,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_29: call AArch64_AutoGen_SysOpsWrite128(s_0_1, s_0_6, s_0_11, s_0_16, s_0_21, s_0_26, s_0_27, s_0_28)
        let s_0_29: () = AArch64_AutoGen_SysOpsWrite128(
            state,
            tracer,
            s_0_1,
            s_0_6,
