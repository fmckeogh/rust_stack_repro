...
use Z_set::*;
use common::*;
pub fn execute_SQRDMLAH_Z_ZZZi_S<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    da: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#3990 <= s_0_2
        fn_state.VLshadow_3990 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#3990:i64
        let s_1_0: i64 = fn_state.VLshadow_3990;
        // D s_1_1: write-var VLshadow#3991 <= s_1_0
        fn_state.VLshadow_3991 = s_1_0;
        // D s_1_2: read-var VLshadow#3991:i64
        let s_1_2: i64 = fn_state.VLshadow_3991;
        ...
        // D s_1_14: read-var VLshadow#3991:i64
        let s_1_14: i64 = fn_state.VLshadow_3991;
        ...
        // D s_1_22: read-var VLshadow#3991:i64
        let s_1_22: i64 = fn_state.VLshadow_3991;
        ...
        // D s_1_30: read-var VLshadow#3991:i64
        let s_1_30: i64 = fn_state.VLshadow_3991;
        ...
        // D s_1_43: write-var gs#214320 <= s_1_42
        fn_state.gs_214320 = s_1_42;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#214320:i64
        let s_2_1: i64 = fn_state.gs_214320;
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_48: Bits = Bits::new(s_3_47 as u128, 32u16);
        ...
        // D s_3_60: cast zx s_3_38 -> i
        let s_3_60: i128 = (i128::try_from(s_3_38).unwrap());
        // D s_3_61: mul s_3_59 s_3_60
        let s_3_61: i128 = ((s_3_59) * (s_3_60));
        // D s_3_62: add s_3_54 s_3_61
        let s_3_62: i128 = (s_3_54 + s_3_61);
        // D s_3_63: read-var esize:i64
        let s_3_63: i64 = fn_state.esize;
        ...
        // D s_3_69: sub s_3_68 s_3_66
        let s_3_69: i128 = ((s_3_68) - (s_3_66));
        // D s_3_70: cast reint s_3_69 -> i64
        let s_3_70: i64 = (s_3_69 as i64);
        // C s_3_71: const #1s : i
        let s_3_71: i128 = 1;
        // D s_3_72: cast zx s_3_70 -> i
        let s_3_72: i128 = (i128::try_from(s_3_70).unwrap());
        // D s_3_73: lsl s_3_71 s_3_72
        let s_3_73: i128 = s_3_71 << s_3_72;
        // D s_3_74: add s_3_62 s_3_73
        let s_3_74: i128 = (s_3_62 + s_3_73);
        // D s_3_75: read-var esize:i64
        let s_3_75: i64 = fn_state.esize;
        // D s_3_76: cast zx s_3_75 -> i
        let s_3_76: i128 = (i128::try_from(s_3_75).unwrap());
        // D s_3_77: lsr s_3_74 s_3_76
        let s_3_77: i128 = s_3_74 >> s_3_76;
        // D s_3_78: read-var esize:i64
        let s_3_78: i64 = fn_state.esize;
        ...
        // D s_3_82: call SignedSat(s_3_77, s_3_81)
        let s_3_82: Bits = SignedSat(state, tracer, s_3_77, s_3_81);
        // D s_3_83: cast reint s_3_82 -> u32
        let s_3_83: u32 = (s_3_82.value() as u32);
        // D s_3_84: read-var e:i64
        let s_3_84: i64 = fn_state.e;
        // D s_3_85: cast zx s_3_84 -> i
        let s_3_85: i128 = (i128::try_from(s_3_84).unwrap());
        // D s_3_86: cast zx s_3_65 -> i
        let s_3_86: i128 = (i128::try_from(s_3_65).unwrap());
        // D s_3_87: cast zx s_3_83 -> bv
        let s_3_87: Bits = Bits::new(s_3_83 as u128, 32u16);
        // D s_3_88: read-var result:bv
        let s_3_88: Bits = fn_state.result;
        // D s_3_89: call Elem_set(s_3_88, s_3_85, s_3_86, s_3_87)
        let s_3_89: Bits = Elem_set(state, tracer, s_3_88, s_3_85, s_3_86, s_3_87);
        // D s_3_90: write-var result <= s_3_89
        fn_state.result = s_3_89;
        // D s_3_91: read-var e:i64
        let s_3_91: i64 = fn_state.e;
        // C s_3_92: const #1s : i64
        let s_3_92: i64 = 1;
        // D s_3_93: add s_3_91 s_3_92
        let s_3_93: i64 = (s_3_91 + s_3_92);
        // D s_3_94: write-var e <= s_3_93
        fn_state.e = s_3_93;
        // N s_3_95: jump b2
        return block_2(state, tracer, fn_state);
    }
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#3991:i64
        let s_4_0: i64 = fn_state.VLshadow_3991;
