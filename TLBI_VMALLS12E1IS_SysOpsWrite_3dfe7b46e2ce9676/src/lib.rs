...
use common::*;
pub fn TLBI_VMALLS12E1IS_SysOpsWrite_3dfe7b46e2ce9676<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_7: u32 = 0;
        // D s_6_8: call AArch64_TLBI_VMALLS12(s_6_2, s_6_5, s_6_4, s_6_6, s_6_7)
        let s_6_8: () = AArch64_TLBI_VMALLS12(
            state,
            tracer,
            s_6_2,
            s_6_5,
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_6: u32 = 1;
        // C s_8_7: const #0u : u32
        let s_8_7: u32 = 0;
        // D s_8_8: call AArch64_TLBI_VMALLS12(s_8_2, s_8_5, s_8_4, s_8_6, s_8_7)
        let s_8_8: () = AArch64_TLBI_VMALLS12(
            state,
            tracer,
            s_8_2,
            s_8_5,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#103093 <= s_10_0
        fn_state.gs_103093 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#103093:u8
        let s_11_0: bool = fn_state.gs_103093;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_5: write-var gs#103093 <= s_14_4
        fn_state.gs_103093 = s_14_4;
        // N s_14_6: jump b11
        return block_11(state, tracer, fn_state);
    }
