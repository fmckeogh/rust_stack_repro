...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_binary_disparate_mul_double_sisd::*;
use common::*;
pub fn decode_sqdmull_advsimd_vec_aarch64_instrs_vector_arithmetic_binary_disparate_mul_double_simd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, Rm: u8, size: u8, Q: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_5: write-var gs#171013 <= s_1_4
        fn_state.gs_171013 = s_1_4;
        // N s_1_6: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#171013:u8
        let s_2_0: bool = fn_state.gs_171013;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_19: read-var m:i64
        let s_3_19: i64 = fn_state.m;
        // D s_3_20: read-var n:i64
        let s_3_20: i64 = fn_state.n;
        // D s_3_21: call execute_aarch64_instrs_vector_arithmetic_binary_disparate_mul_double_sisd(s_3_18, s_3_14, s_3_17, s_3_16, s_3_19, s_3_20, s_3_9)
        let s_3_21: () = execute_aarch64_instrs_vector_arithmetic_binary_disparate_mul_double_sisd(
            state,
            tracer,
            s_3_18,
            s_3_14,
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_0: const #1u : u8
        let s_5_0: bool = true;
        // D s_5_1: write-var gs#171013 <= s_5_0
        fn_state.gs_171013 = s_5_0;
        // N s_5_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
