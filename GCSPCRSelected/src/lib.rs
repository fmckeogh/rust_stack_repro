...
extern crate alloc;
use u_get_GCSCR_EL2_Type_PCRSEL::*;
use u_get_GCSCR_EL3_Type_PCRSEL::*;
use u_get_GCSCR_EL1_Type_PCRSEL::*;
use u_get_GCSCRE0_EL1_Type_PCRSEL::*;
use Unreachable::*;
use common::*;
pub fn GCSPCRSelected<T: Tracer>(state: &mut State, tracer: &T, el: u8) -> bool {
    #[derive(Default)]
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_2: call _get_GCSCRE0_EL1_Type_PCRSEL(s_1_1)
        let s_1_2: bool = u_get_GCSCRE0_EL1_Type_PCRSEL(state, tracer, s_1_1);
    ...
    fn block_4<T: Tracer>(
        ...
        // C s_4_0: const #101056u : u32
        let s_4_0: u32 = 101056;
        ...
        // D s_4_2: call _get_GCSCR_EL1_Type_PCRSEL(s_4_1)
        let s_4_2: bool = u_get_GCSCR_EL1_Type_PCRSEL(state, tracer, s_4_1);
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call _get_GCSCR_EL2_Type_PCRSEL(s_6_1)
        let s_6_2: bool = u_get_GCSCR_EL2_Type_PCRSEL(state, tracer, s_6_1);
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_2: call _get_GCSCR_EL3_Type_PCRSEL(s_8_1)
        let s_8_2: bool = u_get_GCSCR_EL3_Type_PCRSEL(state, tracer, s_8_1);
