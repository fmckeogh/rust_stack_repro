...
use common::*;
pub fn decode_aarch32_instrs_BFC_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm3: u8,
    Rd: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        fn_state.d = s_2_3;
        // D s_2_5: read-var msb:u8
        let s_2_5: u8 = fn_state.msb;
        ...
        // D s_2_9: write-var msbit <= s_2_8
        fn_state.msbit = s_2_8;
