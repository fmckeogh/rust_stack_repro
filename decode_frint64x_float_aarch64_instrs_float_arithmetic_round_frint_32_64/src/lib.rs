...
use common::*;
pub fn decode_frint64x_float_aarch64_instrs_float_arithmetic_round_frint_32_64<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, op: u8, ftype: u8) -> () {
    #[derive(Default)]
    struct FunctionState {
        esizeshadow_1432: i64,
        esize: i64,
        n: i64,
        d: i64,
        intsize: i64,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var esizeshadow#1432 <= s_3_0
        fn_state.esizeshadow_1432 = s_3_0;
        // C s_3_2: const #1s : i
        let s_3_2: i128 = 1;
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 64;
        // D s_4_1: write-var ga#256307 <= s_4_0
        fn_state.ga_256307 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var ga#256307:i64
        let s_5_0: i64 = fn_state.ga_256307;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var esizeshadow#1432:i64
        let s_7_0: i64 = fn_state.esizeshadow_1432;
    ...
    fn block_9<T: Tracer>(
        ...
        let s_9_0: i64 = 32;
        // D s_9_1: write-var ga#256307 <= s_9_0
        fn_state.ga_256307 = s_9_0;
        // N s_9_2: jump b5
        return block_5(state, tracer, fn_state);
    }
