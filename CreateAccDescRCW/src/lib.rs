...
use HaveTME::*;
use common::*;
pub fn CreateAccDescRCW<T: Tracer>(
    state: &mut State,
    tracer: &T,
    modop: u32,
    soft: bool,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_7: const #1u : u8
        let s_0_7: bool = true;
        // D s_0_8: write-var accdesc.21 <= s_0_7
        fn_state.accdesc._21 = s_0_7;
        // D s_0_9: read-var soft:u8
        let s_0_9: bool = fn_state.soft;
        // D s_0_10: write-var accdesc.22 <= s_0_9
        fn_state.accdesc._22 = s_0_9;
        // C s_0_11: const #1u : u8
        let s_0_11: bool = true;
        // D s_0_12: write-var accdesc.4 <= s_0_11
        fn_state.accdesc._4 = s_0_11;
        // D s_0_13: read-var modop:u32
        let s_0_13: u32 = fn_state.modop;
        // D s_0_14: write-var accdesc.14 <= s_0_13
        fn_state.accdesc._14 = s_0_13;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#7244 <= s_1_0
        fn_state.gs_7244 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#7244:u8
        let s_2_0: bool = fn_state.gs_7244;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#7244 <= s_3_3
        fn_state.gs_7244 = s_3_3;
        // N s_3_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
