...
extern crate alloc;
use execute_ADDSPL_R_RI__::*;
use CurrentSVL_read::*;
use HaveSME::*;
use common::*;
pub fn decode_ADDSPL_R_RI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    imm6: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        fn_state.n = s_1_3;
        // D s_1_5: read-var Rd:u8
        let s_1_5: u8 = fn_state.Rd;
        ...
        // D s_1_9: write-var d <= s_1_8
        fn_state.d = s_1_8;
        // D s_1_10: read-var imm6:u8
        let s_1_10: u8 = fn_state.imm6;
        // D s_1_11: cast zx s_1_10 -> bv
        let s_1_11: Bits = Bits::new(s_1_10 as u128, 6u16);
        // D s_1_12: cast sx s_1_11 -> i
        let s_1_12: i128 = {
            let sign_bit = s_1_11.length() - 1;
            let mut result = s_1_11.value() as i128;
        ...
        // D s_1_14: write-var imm <= s_1_13
        fn_state.imm = s_1_13;
        // D s_1_15: read-var SVL:i64
        let s_1_15: i64 = fn_state.SVL;
        // C s_1_16: const #128s : i
        let s_1_16: i128 = 128;
        // D s_1_17: cast zx s_1_15 -> i
        let s_1_17: i128 = (i128::try_from(s_1_15).unwrap());
        // D s_1_18: cmp-eq s_1_17 s_1_16
        let s_1_18: bool = ((s_1_17) == (s_1_16));
        // D s_1_19: not s_1_18
        let s_1_19: bool = !s_1_18;
        // N s_1_20: branch s_1_19 b3 b2
        if s_1_19 {
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 128;
        // D s_2_1: read-var imm:i64
        let s_2_1: i64 = fn_state.imm;
        ...
        // D s_2_5: call execute_ADDSPL_R_RI__(s_2_0, s_2_3, s_2_2, s_2_4)
        let s_2_5: () = execute_ADDSPL_R_RI__(state, tracer, s_2_0, s_2_3, s_2_2, s_2_4);
        // N s_2_6: return
        return;
    }
    fn block_3<T: Tracer>(
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_5: call execute_ADDSPL_R_RI__(s_4_0, s_4_3, s_4_2, s_4_4)
        let s_4_5: () = execute_ADDSPL_R_RI__(state, tracer, s_4_0, s_4_3, s_4_2, s_4_4);
        // N s_4_6: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: call execute_ADDSPL_R_RI__(s_6_0, s_6_3, s_6_2, s_6_4)
        let s_6_5: () = execute_ADDSPL_R_RI__(state, tracer, s_6_0, s_6_3, s_6_2, s_6_4);
        // N s_6_6: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_5: call execute_ADDSPL_R_RI__(s_8_0, s_8_3, s_8_2, s_8_4)
        let s_8_5: () = execute_ADDSPL_R_RI__(state, tracer, s_8_0, s_8_3, s_8_2, s_8_4);
        // N s_8_6: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: call execute_ADDSPL_R_RI__(s_10_0, s_10_3, s_10_2, s_10_4)
        let s_10_5: () = execute_ADDSPL_R_RI__(
            state,
            tracer,
            s_10_0,
            s_10_3,
