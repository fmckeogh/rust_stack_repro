...
use common::*;
pub fn decode_aarch32_instrs_VLD3_1_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Rn: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#310803 <= s_5_0
        fn_state.gs_310803 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#310803:u8
        let s_6_0: bool = fn_state.gs_310803;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#310806 <= s_7_3
        fn_state.gs_310806 = s_7_3;
        // N s_7_5: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#310806:u8
        let s_8_0: bool = fn_state.gs_310806;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#310806 <= s_11_0
        fn_state.gs_310806 = s_11_0;
        // N s_11_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_12<T: Tracer>(
        ...
        // D s_12_4: write-var gs#310803 <= s_12_3
        fn_state.gs_310803 = s_12_3;
        // N s_12_5: jump b6
        return block_6(state, tracer, fn_state);
    }
