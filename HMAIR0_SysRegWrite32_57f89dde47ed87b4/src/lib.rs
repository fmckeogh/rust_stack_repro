...
use common::*;
pub fn HMAIR0_SysRegWrite32_57f89dde47ed87b4<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call Mk_HMAIR0_Type(s_6_1)
        let s_6_2: ProductType700c18a878c5601b = Mk_HMAIR0_Type(state, tracer, s_6_1);
        // D s_6_3: call HMAIR0_write(s_6_2)
        let s_6_3: () = HMAIR0_write(state, tracer, s_6_2);
        // N s_6_4: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_2: call Mk_HMAIR0_Type(s_8_1)
        let s_8_2: ProductType700c18a878c5601b = Mk_HMAIR0_Type(state, tracer, s_8_1);
        // D s_8_3: call HMAIR0_write(s_8_2)
        let s_8_3: () = HMAIR0_write(state, tracer, s_8_2);
        // N s_8_4: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#128451 <= s_10_0
        fn_state.gs_128451 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#128451:u8
        let s_11_0: bool = fn_state.gs_128451;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#128452 <= s_12_0
        fn_state.gs_128452 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#128452:u8
        let s_13_0: bool = fn_state.gs_128452;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#128453 <= s_15_0
        fn_state.gs_128453 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#128453:u8
        let s_16_0: bool = fn_state.gs_128453;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#128454 <= s_17_0
        fn_state.gs_128454 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#128454:u8
        let s_18_0: bool = fn_state.gs_128454;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_5: write-var gs#128454 <= s_21_4
        fn_state.gs_128454 = s_21_4;
        // N s_21_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        // D s_22_3: write-var gs#128453 <= s_22_2
        fn_state.gs_128453 = s_22_2;
        // N s_22_4: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_5: write-var gs#128452 <= s_24_4
        fn_state.gs_128452 = s_24_4;
        // N s_24_6: jump b13
        return block_13(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_4: write-var gs#128451 <= s_25_3
        fn_state.gs_128451 = s_25_3;
        // N s_25_5: jump b11
        return block_11(state, tracer, fn_state);
    }
