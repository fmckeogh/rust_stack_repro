...
use common::*;
pub fn decode_fmaxp_advsimd_vec_aarch64_instrs_vector_arithmetic_binary_uniform_max_min_fp16_1985<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#255111 <= s_1_0
        fn_state.ga_255111 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#255111:i64
        let s_2_0: i64 = fn_state.ga_255111;
        // C s_2_1: const #16s : i
        let s_2_1: i128 = 16;
        ...
        // D s_2_10: read-var o1:u8
        let s_2_10: bool = fn_state.o1;
        ...
        // D s_2_22: call execute_aarch64_instrs_vector_arithmetic_binary_uniform_max_min_fp16_1985(s_2_19, s_2_16, s_2_18, s_2_17, s_2_20, s_2_14, s_2_21, s_2_9)
        let s_2_22: () = execute_aarch64_instrs_vector_arithmetic_binary_uniform_max_min_fp16_1985(
            state,
            tracer,
            s_2_19,
            s_2_16,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 128;
        // D s_3_1: write-var ga#255111 <= s_3_0
        fn_state.ga_255111 = s_3_0;
        // N s_3_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
