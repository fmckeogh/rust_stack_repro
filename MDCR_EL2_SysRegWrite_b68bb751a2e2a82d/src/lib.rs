...
use X_read::*;
use Mk_MDCR_EL2_Type::*;
use AArch64_SystemAccessTrap::*;
use u__IMPDEF_boolean::*;
use EDSCR_read::*;
use EL2Enabled::*;
use common::*;
pub fn MDCR_EL2_SysRegWrite_b68bb751a2e2a82d<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_MDCR_EL2_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_MDCR_EL2_Type(state, tracer, s_5_3);
        // C s_5_5: const #104880u : u32
        let s_5_5: u32 = 104880;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#86664 <= s_7_0
        fn_state.gs_86664 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#86664:u8
        let s_8_0: bool = fn_state.gs_86664;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#86665 <= s_9_0
        fn_state.gs_86665 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#86665:u8
        let s_10_0: bool = fn_state.gs_86665;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#86666 <= s_11_0
        fn_state.gs_86666 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#86666:u8
        let s_12_0: bool = fn_state.gs_86666;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#86667 <= s_13_0
        fn_state.gs_86667 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#86667:u8
        let s_14_0: bool = fn_state.gs_86667;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#86668 <= s_16_0
        fn_state.gs_86668 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#86668:u8
        let s_17_0: bool = fn_state.gs_86668;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_4: call Mk_MDCR_EL2_Type(s_18_3)
        let s_18_4: ProductType5c790c8ef59cc8b2 = Mk_MDCR_EL2_Type(
            state,
            tracer,
            s_18_3,
        );
        // C s_18_5: const #104880u : u32
        let s_18_5: u32 = 104880;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#86670 <= s_20_0
        fn_state.gs_86670 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#86670:u8
        let s_21_0: bool = fn_state.gs_86670;
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_5: write-var gs#86670 <= s_24_4
        fn_state.gs_86670 = s_24_4;
        // N s_24_6: jump b21
        return block_21(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_5: write-var gs#86668 <= s_25_4
        fn_state.gs_86668 = s_25_4;
        // N s_25_6: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_5: write-var gs#86667 <= s_27_4
        fn_state.gs_86667 = s_27_4;
        // N s_27_6: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_2: write-var gs#86666 <= s_28_1
        fn_state.gs_86666 = s_28_1;
        // N s_28_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_5: write-var gs#86665 <= s_29_4
        fn_state.gs_86665 = s_29_4;
        // N s_29_6: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_4: write-var gs#86664 <= s_30_3
        fn_state.gs_86664 = s_30_3;
        // N s_30_5: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_1: write-var gs#86671 <= s_32_0
        fn_state.gs_86671 = s_32_0;
        // N s_32_2: jump b33
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var gs#86671:u8
        let s_33_0: bool = fn_state.gs_86671;
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_5: write-var gs#86671 <= s_36_4
        fn_state.gs_86671 = s_36_4;
        // N s_36_6: jump b33
        return block_33(state, tracer, fn_state);
    }
