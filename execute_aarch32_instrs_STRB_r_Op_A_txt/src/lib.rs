...
use MemU_set::*;
use common::*;
pub fn execute_aarch32_instrs_STRB_r_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    add: bool,
    index: bool,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#302361 <= s_5_0
        fn_state.gs_302361 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#302361:u8
        let s_6_0: bool = fn_state.gs_302361;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_4: write-var gs#302361 <= s_13_3
        fn_state.gs_302361 = s_13_3;
        // N s_13_5: jump b6
        return block_6(state, tracer, fn_state);
    }
