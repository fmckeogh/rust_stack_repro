...
use common::*;
pub fn decode_fabd_advsimd_aarch64_instrs_vector_arithmetic_binary_uniform_sub_fp_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, Rm: u8, sz: bool) -> () {
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_24: call execute_aarch64_instrs_vector_arithmetic_binary_uniform_sub_fp16_sisd(s_0_23, s_0_3, s_0_19, s_0_22, s_0_21, s_0_11, s_0_7)
        let s_0_24: () = execute_aarch64_instrs_vector_arithmetic_binary_uniform_sub_fp16_sisd(
            state,
            tracer,
            s_0_23,
            s_0_3,
