...
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_SUB_i_T2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rdn: u8,
    imm8: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_11: i128 = 32;
        // D s_2_12: read-var imm8:u8
        let s_2_12: u8 = fn_state.imm8;
        ...
        // D s_2_16: call execute_aarch32_instrs_SUB_i_Op_A_txt(s_2_3, s_2_15, s_2_7, s_2_10)
        let s_2_16: () = execute_aarch32_instrs_SUB_i_Op_A_txt(
            state,
            tracer,
            s_2_3,
            s_2_15,
