...
use common::*;
pub fn decode_aarch32_instrs_STRT_A2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    U: bool,
    ...
    struct FunctionState {
        m: i64,
        ga_348333: ProductType396b95aa74979079,
        t: i64,
        imm32: u32,
        shift_nshadow_7299: i128,
        gs_303112: bool,
        shift_t: u32,
        gs_303110: bool,
        n: i64,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_30: write-var ga#348333 <= s_2_29
        fn_state.ga_348333 = s_2_29;
        // D s_2_31: read-var ga#348333.0:struct
        let s_2_31: u32 = fn_state.ga_348333._0;
        // D s_2_32: read-var ga#348333.1:struct
        let s_2_32: i128 = fn_state.ga_348333._1;
        // D s_2_33: write-var shift_t <= s_2_31
        fn_state.shift_t = s_2_31;
        // D s_2_34: write-var shift_nshadow#7299 <= s_2_32
        fn_state.shift_nshadow_7299 = s_2_32;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_5: write-var gs#303110 <= s_3_4
        fn_state.gs_303110 = s_3_4;
        // N s_3_6: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#303110:u8
        let s_4_0: bool = fn_state.gs_303110;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#303112 <= s_5_3
        fn_state.gs_303112 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#303112:u8
        let s_6_0: bool = fn_state.gs_303112;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var imm32:u32
        let s_7_0: u32 = fn_state.imm32;
        // D s_7_1: read-var shift_t:u32
        let s_7_1: u32 = fn_state.shift_t;
        // D s_7_2: read-var shift_nshadow#7299:i
        let s_7_2: i128 = fn_state.shift_nshadow_7299;
        // D s_7_3: read-var m:i64
        let s_7_3: i64 = fn_state.m;
        // D s_7_4: cast zx s_7_3 -> i
        let s_7_4: i128 = (i128::try_from(s_7_3).unwrap());
        // D s_7_5: read-var add:u8
        let s_7_5: bool = fn_state.add;
        ...
        // D s_7_10: call execute_aarch32_instrs_STRT_Op_A_txt(s_7_5, s_7_0, s_7_4, s_7_6, s_7_7, s_7_8, s_7_2, s_7_1, s_7_9)
        let s_7_10: () = execute_aarch32_instrs_STRT_Op_A_txt(
            state,
            tracer,
            s_7_5,
            s_7_0,
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#303112 <= s_9_0
        fn_state.gs_303112 = s_9_0;
        // N s_9_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#303110 <= s_10_0
        fn_state.gs_303110 = s_10_0;
        // N s_10_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
