...
extern crate alloc;
use execute_aarch64_instrs_vector_shift_right_insert_sisd::*;
use HighestSetBit::*;
use u_shl_int_general::*;
use fdiv_int::*;
use common::*;
pub fn decode_sri_advsimd_aarch64_instrs_vector_shift_right_insert_simd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 64;
        // D s_3_1: write-var ga#268882 <= s_3_0
        fn_state.ga_268882 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#268882:i64
        let s_4_0: i64 = fn_state.ga_268882;
        ...
        // D s_4_25: cast zx s_4_0 -> i
        let s_4_25: i128 = (i128::try_from(s_4_0).unwrap());
        // D s_4_26: cast reint s_4_25 -> i64
        let s_4_26: i64 = (s_4_25 as i64);
        // D s_4_27: read-var esize:i
        let s_4_27: i128 = fn_state.esize;
        ...
        // D s_4_31: call execute_aarch64_instrs_vector_shift_right_insert_sisd(s_4_29, s_4_28, s_4_3, s_4_27, s_4_30, s_4_24)
        let s_4_31: () = execute_aarch64_instrs_vector_shift_right_insert_sisd(
            state,
            tracer,
            s_4_29,
            s_4_28,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 128;
        // D s_5_1: write-var ga#268882 <= s_5_0
        fn_state.ga_268882 = s_5_0;
        // N s_5_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_6<T: Tracer>(
