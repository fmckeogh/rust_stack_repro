...
use CurrentVL_read::*;
use HaveSME2::*;
use execute_LUTI4_MZ2_ZTZ_1::*;
use common::*;
pub fn decode_LUTI4_MZ2_ZTZ_1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i2: u8,
    size: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_10: call execute_LUTI4_MZ2_ZTZ_1(s_3_0, s_3_7, s_3_4, s_3_3, s_3_8, s_3_5, s_3_9, s_3_6)
        let s_3_10: () = execute_LUTI4_MZ2_ZTZ_1(
            state,
            tracer,
            s_3_0,
            s_3_7,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_10: call execute_LUTI4_MZ2_ZTZ_1(s_5_0, s_5_7, s_5_4, s_5_3, s_5_8, s_5_5, s_5_9, s_5_6)
        let s_5_10: () = execute_LUTI4_MZ2_ZTZ_1(
            state,
            tracer,
            s_5_0,
            s_5_7,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_10: call execute_LUTI4_MZ2_ZTZ_1(s_7_0, s_7_7, s_7_4, s_7_3, s_7_8, s_7_5, s_7_9, s_7_6)
        let s_7_10: () = execute_LUTI4_MZ2_ZTZ_1(
            state,
            tracer,
            s_7_0,
            s_7_7,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_10: call execute_LUTI4_MZ2_ZTZ_1(s_9_0, s_9_7, s_9_4, s_9_3, s_9_8, s_9_5, s_9_9, s_9_6)
        let s_9_10: () = execute_LUTI4_MZ2_ZTZ_1(
            state,
            tracer,
            s_9_0,
            s_9_7,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_10: call execute_LUTI4_MZ2_ZTZ_1(s_11_0, s_11_7, s_11_4, s_11_3, s_11_8, s_11_5, s_11_9, s_11_6)
        let s_11_10: () = execute_LUTI4_MZ2_ZTZ_1(
            state,
            tracer,
            s_11_0,
            s_11_7,
