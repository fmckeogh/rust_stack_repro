...
use Z_set::*;
use common::*;
pub fn execute_SMLSLB_Z_ZZZi_D<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    da: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#3938 <= s_0_2
        fn_state.VLshadow_3938 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#3938:i64
        let s_1_0: i64 = fn_state.VLshadow_3938;
        // D s_1_1: write-var VLshadow#3939 <= s_1_0
        fn_state.VLshadow_3939 = s_1_0;
        // C s_1_2: const #2s : i
        let s_1_2: i128 = 2;
        ...
        // D s_1_7: read-var VLshadow#3939:i64
        let s_1_7: i64 = fn_state.VLshadow_3939;
        ...
        // D s_1_22: read-var VLshadow#3939:i64
        let s_1_22: i64 = fn_state.VLshadow_3939;
        ...
        // D s_1_30: read-var VLshadow#3939:i64
        let s_1_30: i64 = fn_state.VLshadow_3939;
        ...
        // D s_1_38: read-var VLshadow#3939:i64
        let s_1_38: i64 = fn_state.VLshadow_3939;
        ...
        // D s_1_51: write-var gs#212579 <= s_1_50
        fn_state.gs_212579 = s_1_50;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#212579:i64
        let s_2_1: i64 = fn_state.gs_212579;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_81: const #1s : i
        let s_3_81: i128 = 1;
        // D s_3_82: cast zx s_3_80 -> i
        let s_3_82: i128 = (i128::try_from(s_3_80).unwrap());
        // D s_3_83: sub s_3_82 s_3_81
        let s_3_83: i128 = ((s_3_82) - (s_3_81));
        // D s_3_84: cast reint s_3_83 -> i64
        let s_3_84: i64 = (s_3_83 as i64);
        // C s_3_85: const #0s : i
        let s_3_85: i128 = 0;
        // D s_3_86: cast zx s_3_75 -> i
        let s_3_86: i128 = (i128::try_from(s_3_75).unwrap());
        // D s_3_87: cast zx s_3_84 -> i
        let s_3_87: i128 = (i128::try_from(s_3_84).unwrap());
        // D s_3_88: call integer_subrange(s_3_86, s_3_87, s_3_85)
        let s_3_88: Bits = integer_subrange(state, tracer, s_3_86, s_3_87, s_3_85);
        // D s_3_89: cast zx s_3_71 -> bv
        let s_3_89: Bits = Bits::new(s_3_71 as u128, 64u16);
        // D s_3_90: sub s_3_89 s_3_88
        let s_3_90: Bits = ((s_3_89) - (s_3_88));
        // D s_3_91: cast reint s_3_90 -> u64
        let s_3_91: u64 = (s_3_90.value() as u64);
        // D s_3_92: read-var e:i64
        let s_3_92: i64 = fn_state.e;
        // D s_3_93: cast zx s_3_92 -> i
        let s_3_93: i128 = (i128::try_from(s_3_92).unwrap());
        // D s_3_94: cast zx s_3_58 -> i
        let s_3_94: i128 = (i128::try_from(s_3_58).unwrap());
        // D s_3_95: cast zx s_3_91 -> bv
        let s_3_95: Bits = Bits::new(s_3_91 as u128, 64u16);
        // D s_3_96: read-var result:bv
        let s_3_96: Bits = fn_state.result;
        // D s_3_97: call Elem_set(s_3_96, s_3_93, s_3_94, s_3_95)
        let s_3_97: Bits = Elem_set(state, tracer, s_3_96, s_3_93, s_3_94, s_3_95);
        // D s_3_98: write-var result <= s_3_97
        fn_state.result = s_3_97;
        // D s_3_99: read-var e:i64
        let s_3_99: i64 = fn_state.e;
        // C s_3_100: const #1s : i64
        let s_3_100: i64 = 1;
        // D s_3_101: add s_3_99 s_3_100
        let s_3_101: i64 = (s_3_99 + s_3_100);
        // D s_3_102: write-var e <= s_3_101
        fn_state.e = s_3_101;
        // N s_3_103: jump b2
        return block_2(state, tracer, fn_state);
    }
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#3939:i64
        let s_4_0: i64 = fn_state.VLshadow_3939;
