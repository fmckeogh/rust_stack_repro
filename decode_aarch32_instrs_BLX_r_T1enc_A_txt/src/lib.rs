...
use LastInITBlock::*;
use ConditionPassed::*;
use execute_aarch32_instrs_BLX_r_Op_A_txt::*;
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_BLX_r_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rm: u8,
) -> () {
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#296183 <= s_4_0
        fn_state.gs_296183 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#296183:u8
        let s_5_0: bool = fn_state.gs_296183;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: call execute_aarch32_instrs_BLX_r_Op_A_txt(s_6_0)
        let s_6_1: () = execute_aarch32_instrs_BLX_r_Op_A_txt(state, tracer, s_6_0);
        // N s_6_2: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_3: write-var gs#296183 <= s_8_2
        fn_state.gs_296183 = s_8_2;
        // N s_8_4: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
