...
use Z_set::*;
use common::*;
pub fn execute_SQINCW_Z_ZS__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    dn: i64,
    ...
    struct FunctionState {
        ...
        gs_192424: i64,
        VLshadow_2760: i64,
        gs_742945: ProductTypef506aa96a892fe52,
        result: Bits,
        operand1: Bits,
        VL: i64,
        dn: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#2760 <= s_0_2
        fn_state.VLshadow_2760 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#2760:i64
        let s_1_0: i64 = fn_state.VLshadow_2760;
        // D s_1_1: write-var VLshadow#2761 <= s_1_0
        fn_state.VLshadow_2761 = s_1_0;
        // D s_1_2: read-var VLshadow#2761:i64
        let s_1_2: i64 = fn_state.VLshadow_2761;
        ...
        // D s_1_13: read-var VLshadow#2761:i64
        let s_1_13: i64 = fn_state.VLshadow_2761;
        ...
        // D s_1_26: write-var gs#192424 <= s_1_25
        fn_state.gs_192424 = s_1_25;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#192424:i64
        let s_2_1: i64 = fn_state.gs_192424;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_23: write-var gs#742945 <= s_3_22
        fn_state.gs_742945 = s_3_22;
        // D s_3_24: read-var gs#742945.0:struct
        let s_3_24: Bits = fn_state.gs_742945._0;
        // D s_3_25: cast reint s_3_24 -> u32
        let s_3_25: u32 = (s_3_24.value() as u32);
        // D s_3_26: cast zx s_3_25 -> bv
        let s_3_26: Bits = Bits::new(s_3_25 as u128, 32u16);
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#2761:i64
        let s_4_0: i64 = fn_state.VLshadow_2761;
