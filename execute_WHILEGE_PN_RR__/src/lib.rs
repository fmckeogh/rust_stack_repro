...
use EncodePredCount::*;
use common::*;
pub fn execute_WHILEGE_PN_RR__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#223883 <= s_7_0
        fn_state.gs_223883 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#223883:u8
        let s_8_0: bool = fn_state.gs_223883;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#223883 <= s_12_0
        fn_state.gs_223883 = s_12_0;
        // N s_12_2: jump b8
        return block_8(state, tracer, fn_state);
    }
