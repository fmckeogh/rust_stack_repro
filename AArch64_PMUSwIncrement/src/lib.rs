...
use common::*;
pub fn AArch64_PMUSwIncrement<T: Tracer>(
    state: &mut State,
    tracer: &T,
    sw_incr: u32,
) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#25413 <= s_1_0
        fn_state.gs_25413 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#25413:u8
        let s_2_0: bool = fn_state.gs_25413;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_0: const #() : ()
        let s_3_0: () = ();
        // S s_3_1: call AArch64_GetNumEventCountersAccessible(s_3_0)
        let s_3_1: i128 = AArch64_GetNumEventCountersAccessible(state, tracer, s_3_0);
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_5: write-var gs#25421 <= s_5_4
        fn_state.gs_25421 = s_5_4;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: read-var gs#25421:i64
        let s_6_1: i64 = fn_state.gs_25421;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#25426 <= s_8_0
        fn_state.gs_25426 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#25426:u8
        let s_9_0: bool = fn_state.gs_25426;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_5: write-var gs#25426 <= s_13_4
        fn_state.gs_25426 = s_13_4;
        // N s_13_6: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_16<T: Tracer>(
        ...
        // C s_16_0: const #104880u : u32
        let s_16_0: u32 = 104880;
        ...
        // D s_16_2: call _get_MDCR_EL2_Type_HPME(s_16_1)
        let s_16_2: bool = u_get_MDCR_EL2_Type_HPME(state, tracer, s_16_1);
        ...
        // D s_16_7: write-var gs#25413 <= s_16_6
        fn_state.gs_25413 = s_16_6;
        // N s_16_8: jump b2
        return block_2(state, tracer, fn_state);
    }
}
