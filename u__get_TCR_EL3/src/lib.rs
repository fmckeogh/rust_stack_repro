...
use Mk_TCR_EL3_Type::*;
use common::*;
pub fn u__get_TCR_EL3<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #18446728130791473344u : u64
        let s_0_3: u64 = 18446728130791473344;
        ...
        let s_0_11: i128 = 64;
        // C s_0_12: const #2155872256u : u32
        let s_0_12: u32 = 2155872256;
        ...
        // D s_0_20: tail-call Mk_TCR_EL3_Type(s_0_19)
        return Mk_TCR_EL3_Type(state, tracer, s_0_19);
    }
}
