...
use common::*;
pub fn SCTLR_SysRegRead32_e01eef2d08d9809d<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    struct FunctionState {
        ...
        gs_117332: bool,
        gs_117329: bool,
        ga_197020: ProductType700c18a878c5601b,
        u__HCR_TRVM: bool,
        ga_197010: ProductType700c18a878c5601b,
        gs_117328: bool,
        ga_197004: ProductType700c18a878c5601b,
        gs_117333: bool,
        u__HSTR_EL2_T1: bool,
        ga_197017: ProductType700c18a878c5601b,
        gs_117334: bool,
        u__PSTATE_EL: u8,
        u__HSTR_T1: bool,
        ...
        gs_117330: bool,
        gs_117335: bool,
        ga_197001: ProductType700c18a878c5601b,
        ga_197013: ProductType700c18a878c5601b,
        el: u8,
        coproc: u8,
        opc1: u8,
        CRn: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #() : ()
        let s_6_0: () = ();
        // S s_6_1: call SCTLR_NS_read(s_6_0)
        let s_6_1: ProductType700c18a878c5601b = SCTLR_NS_read(state, tracer, s_6_0);
        // S s_6_2: call __get_SCTLR_NS(s_6_1)
        let s_6_2: ProductType700c18a878c5601b = u__get_SCTLR_NS(state, tracer, s_6_1);
        // D s_6_3: write-var ga#197020 <= s_6_2
        fn_state.ga_197020 = s_6_2;
        // D s_6_4: read-var ga#197020.0:struct
        let s_6_4: u32 = fn_state.ga_197020._0;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_2: call __get_SCTLR_S(s_7_1)
        let s_7_2: ProductType700c18a878c5601b = u__get_SCTLR_S(state, tracer, s_7_1);
        // D s_7_3: write-var ga#197017 <= s_7_2
        fn_state.ga_197017 = s_7_2;
        // D s_7_4: read-var ga#197017.0:struct
        let s_7_4: u32 = fn_state.ga_197017._0;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#117327 <= s_9_0
        fn_state.gs_117327 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#117327:u8
        let s_10_0: bool = fn_state.gs_117327;
    ...
    fn block_11<T: Tracer>(
        ...
        // S s_11_2: call __get_SCTLR(s_11_1)
        let s_11_2: ProductType700c18a878c5601b = u__get_SCTLR(state, tracer, s_11_1);
        // D s_11_3: write-var ga#197013 <= s_11_2
        fn_state.ga_197013 = s_11_2;
        // D s_11_4: read-var ga#197013.0:struct
        let s_11_4: u32 = fn_state.ga_197013._0;
    ...
    fn block_12<T: Tracer>(
        ...
        // C s_12_0: const #() : ()
        let s_12_0: () = ();
        // S s_12_1: call SCTLR_NS_read(s_12_0)
        let s_12_1: ProductType700c18a878c5601b = SCTLR_NS_read(state, tracer, s_12_0);
        // S s_12_2: call __get_SCTLR_NS(s_12_1)
        let s_12_2: ProductType700c18a878c5601b = u__get_SCTLR_NS(state, tracer, s_12_1);
        // D s_12_3: write-var ga#197010 <= s_12_2
        fn_state.ga_197010 = s_12_2;
        // D s_12_4: read-var ga#197010.0:struct
        let s_12_4: u32 = fn_state.ga_197010._0;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_3: write-var gs#117327 <= s_13_2
        fn_state.gs_117327 = s_13_2;
        // N s_13_4: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#117328 <= s_15_0
        fn_state.gs_117328 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#117328:u8
        let s_16_0: bool = fn_state.gs_117328;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#117329 <= s_17_0
        fn_state.gs_117329 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#117329:u8
        let s_18_0: bool = fn_state.gs_117329;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#117330 <= s_20_0
        fn_state.gs_117330 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#117330:u8
        let s_21_0: bool = fn_state.gs_117330;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#117331 <= s_22_0
        fn_state.gs_117331 = s_22_0;
        // N s_22_2: jump b23
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_0: read-var gs#117331:u8
        let s_23_0: bool = fn_state.gs_117331;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#117332 <= s_25_0
        fn_state.gs_117332 = s_25_0;
        // N s_25_2: jump b26
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var gs#117332:u8
        let s_26_0: bool = fn_state.gs_117332;
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_1: write-var gs#117333 <= s_27_0
        fn_state.gs_117333 = s_27_0;
        // N s_27_2: jump b28
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_0: read-var gs#117333:u8
        let s_28_0: bool = fn_state.gs_117333;
    ...
    fn block_30<T: Tracer>(
        ...
        // D s_30_1: write-var gs#117334 <= s_30_0
        fn_state.gs_117334 = s_30_0;
        // N s_30_2: jump b31
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_0: read-var gs#117334:u8
        let s_31_0: bool = fn_state.gs_117334;
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_1: write-var gs#117335 <= s_32_0
        fn_state.gs_117335 = s_32_0;
        // N s_32_2: jump b33
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var gs#117335:u8
        let s_33_0: bool = fn_state.gs_117335;
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_1: write-var gs#117336 <= s_35_0
        fn_state.gs_117336 = s_35_0;
        // N s_35_2: jump b36
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_0: read-var gs#117336:u8
        let s_36_0: bool = fn_state.gs_117336;
    ...
    fn block_37<T: Tracer>(
        ...
        // C s_37_0: const #() : ()
        let s_37_0: () = ();
        // S s_37_1: call SCTLR_read__2(s_37_0)
        let s_37_1: ProductType700c18a878c5601b = SCTLR_read__2(state, tracer, s_37_0);
        // S s_37_2: call __get_SCTLR(s_37_1)
        let s_37_2: ProductType700c18a878c5601b = u__get_SCTLR(state, tracer, s_37_1);
        // D s_37_3: write-var ga#197004 <= s_37_2
        fn_state.ga_197004 = s_37_2;
        // D s_37_4: read-var ga#197004.0:struct
        let s_37_4: u32 = fn_state.ga_197004._0;
    ...
    fn block_38<T: Tracer>(
        ...
        // C s_38_0: const #() : ()
        let s_38_0: () = ();
        // S s_38_1: call SCTLR_NS_read(s_38_0)
        let s_38_1: ProductType700c18a878c5601b = SCTLR_NS_read(state, tracer, s_38_0);
        // S s_38_2: call __get_SCTLR_NS(s_38_1)
        let s_38_2: ProductType700c18a878c5601b = u__get_SCTLR_NS(state, tracer, s_38_1);
        // D s_38_3: write-var ga#197001 <= s_38_2
        fn_state.ga_197001 = s_38_2;
        // D s_38_4: read-var ga#197001.0:struct
        let s_38_4: u32 = fn_state.ga_197001._0;
        // D s_38_5: read-var t:i
        let s_38_5: i128 = fn_state.t;
        // D s_38_6: call R_set(s_38_5, s_38_4)
        let s_38_6: () = R_set(state, tracer, s_38_5, s_38_4);
        // N s_38_7: return
        return;
    }
    fn block_39<T: Tracer>(
        ...
        // D s_39_3: write-var gs#117336 <= s_39_2
        fn_state.gs_117336 = s_39_2;
        // N s_39_4: jump b36
        return block_36(state, tracer, fn_state);
    }
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_5: write-var gs#117335 <= s_41_4
        fn_state.gs_117335 = s_41_4;
        // N s_41_6: jump b33
        return block_33(state, tracer, fn_state);
    }
    fn block_42<T: Tracer>(
        ...
        // D s_42_3: write-var gs#117334 <= s_42_2
        fn_state.gs_117334 = s_42_2;
        // N s_42_4: jump b31
        return block_31(state, tracer, fn_state);
    }
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_5: write-var gs#117333 <= s_44_4
        fn_state.gs_117333 = s_44_4;
        // N s_44_6: jump b28
        return block_28(state, tracer, fn_state);
    }
    fn block_45<T: Tracer>(
        ...
        // D s_45_4: write-var gs#117332 <= s_45_3
        fn_state.gs_117332 = s_45_3;
        // N s_45_5: jump b26
        return block_26(state, tracer, fn_state);
    }
    ...
    fn block_47<T: Tracer>(
        ...
        // D s_47_0: read-var __HSTR_T1:u8
        let s_47_0: bool = fn_state.u__HSTR_T1;
        ...
        // D s_47_5: write-var gs#117331 <= s_47_4
        fn_state.gs_117331 = s_47_4;
        // N s_47_6: jump b23
        return block_23(state, tracer, fn_state);
    }
    fn block_48<T: Tracer>(
        ...
        // D s_48_3: write-var gs#117330 <= s_48_2
        fn_state.gs_117330 = s_48_2;
        // N s_48_4: jump b21
        return block_21(state, tracer, fn_state);
    }
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_0: read-var __HSTR_EL2_T1:u8
        let s_50_0: bool = fn_state.u__HSTR_EL2_T1;
        ...
        // D s_50_5: write-var gs#117329 <= s_50_4
        fn_state.gs_117329 = s_50_4;
        // N s_50_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    fn block_51<T: Tracer>(
        ...
        // D s_51_4: write-var gs#117328 <= s_51_3
        fn_state.gs_117328 = s_51_3;
        // N s_51_5: jump b16
        return block_16(state, tracer, fn_state);
    }
