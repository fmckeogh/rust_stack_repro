...
use common::*;
pub fn execute_SQDECP_R_P_R_X<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    dn: i64,
    ...
    struct FunctionState {
        ...
        result: Bits,
        operand1: Bits,
        gs_741153: ProductTypef506aa96a892fe52,
        operand2: Bits,
        VL: i64,
        dn: i64,
        esize: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_31: write-var gs#190426 <= s_1_30
        fn_state.gs_190426 = s_1_30;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#190426:i64
        let s_2_1: i64 = fn_state.gs_190426;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_11: write-var gs#741153 <= s_7_10
        fn_state.gs_741153 = s_7_10;
        // D s_7_12: read-var gs#741153.0:struct
        let s_7_12: Bits = fn_state.gs_741153._0;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: write-var ga#280754 <= s_8_3
        fn_state.ga_280754 = s_8_3;
        // N s_8_5: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_2: read-var ga#280754:u64
        let s_9_2: u64 = fn_state.ga_280754;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: write-var ga#280754 <= s_10_3
        fn_state.ga_280754 = s_10_3;
        // N s_10_5: jump b9
        return block_9(state, tracer, fn_state);
    }
}
