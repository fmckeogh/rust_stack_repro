...
extern crate alloc;
use common::*;
pub fn HAIFSR_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #15400u : u32
        let s_0_23: u32 = 15400;
        ...
        // C s_0_25: const #14088u : u32
        let s_0_25: u32 = 14088;
