...
use common::*;
pub fn VBAR_EL2_SysRegRead_369573c45c9746cf<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call __get_VBAR_EL2(s_5_2)
        let s_5_3: u64 = u__get_VBAR_EL2(state, tracer, s_5_2);
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_VBAR_EL2(s_6_2)
        let s_6_3: u64 = u__get_VBAR_EL2(state, tracer, s_6_2);
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#74544 <= s_8_0
        fn_state.gs_74544 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#74544:u8
        let s_9_0: bool = fn_state.gs_74544;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#74544 <= s_12_4
        fn_state.gs_74544 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
