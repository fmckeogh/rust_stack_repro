...
use Z_set::*;
use common::*;
pub fn execute_SQCVTUN_Z_MZ2__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#4343 <= s_0_2
        fn_state.VLshadow_4343 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#4343:i64
        let s_1_0: i64 = fn_state.VLshadow_4343;
        // D s_1_1: write-var VLshadow#4344 <= s_1_0
        fn_state.VLshadow_4344 = s_1_0;
        // C s_1_2: const #2s : i
        let s_1_2: i128 = 2;
        ...
        // D s_1_7: read-var VLshadow#4344:i64
        let s_1_7: i64 = fn_state.VLshadow_4344;
        ...
        // D s_1_17: write-var gs#219990 <= s_1_16
        fn_state.gs_219990 = s_1_16;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#219990:i64
        let s_2_1: i64 = fn_state.gs_219990;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_6: read-var VLshadow#4344:i64
        let s_5_6: i64 = fn_state.VLshadow_4344;
        ...
        // D s_5_25: cast sx s_5_24 -> i
        let s_5_25: i128 = {
            let sign_bit = s_5_24.length() - 1;
            let mut result = s_5_24.value() as i128;
        ...
        // D s_5_40: read-var esize:i64
        let s_5_40: i64 = fn_state.esize;
        ...
        // D s_5_43: cast zx s_5_26 -> i
        let s_5_43: i128 = (i128::try_from(s_5_26).unwrap());
        // D s_5_44: cast zx s_5_42 -> i
        let s_5_44: i128 = (i128::try_from(s_5_42).unwrap());
        // D s_5_45: call UnsignedSat(s_5_43, s_5_44)
        let s_5_45: Bits = UnsignedSat(state, tracer, s_5_43, s_5_44);
        // D s_5_46: cast reint s_5_45 -> u16
        let s_5_46: u16 = (s_5_45.value() as u16);
        // D s_5_47: cast zx s_5_36 -> i
        let s_5_47: i128 = (i128::try_from(s_5_36).unwrap());
        // D s_5_48: cast zx s_5_39 -> i
        let s_5_48: i128 = (i128::try_from(s_5_39).unwrap());
        // D s_5_49: cast zx s_5_46 -> bv
        let s_5_49: Bits = Bits::new(s_5_46 as u128, 16u16);
        // D s_5_50: read-var result:bv
        let s_5_50: Bits = fn_state.result;
        // D s_5_51: call Elem_set(s_5_50, s_5_47, s_5_48, s_5_49)
        let s_5_51: Bits = Elem_set(state, tracer, s_5_50, s_5_47, s_5_48, s_5_49);
        // D s_5_52: write-var result <= s_5_51
        fn_state.result = s_5_51;
        // D s_5_53: read-var i:i64
        let s_5_53: i64 = fn_state.i;
        // C s_5_54: const #1s : i64
        let s_5_54: i64 = 1;
        // D s_5_55: add s_5_53 s_5_54
        let s_5_55: i64 = (s_5_53 + s_5_54);
        // D s_5_56: write-var i <= s_5_55
        fn_state.i = s_5_55;
        // N s_5_57: jump b4
        return block_4(state, tracer, fn_state);
    }
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var VLshadow#4344:i64
        let s_7_0: i64 = fn_state.VLshadow_4344;
