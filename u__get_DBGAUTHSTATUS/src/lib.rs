...
use common::*;
pub fn u__get_DBGAUTHSTATUS<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4043247360u : u32
        let s_0_3: u32 = 4043247360;
        ...
        // D s_0_11: tail-call Mk_DBGAUTHSTATUS_Type(s_0_10)
        return Mk_DBGAUTHSTATUS_Type(state, tracer, s_0_10);
    }
}
