...
use Z_set::*;
use common::*;
pub fn execute_UMULLB_Z_ZZi_D<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#3914 <= s_0_2
        fn_state.VLshadow_3914 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#3914:i64
        let s_1_0: i64 = fn_state.VLshadow_3914;
        // D s_1_1: write-var VLshadow#3915 <= s_1_0
        fn_state.VLshadow_3915 = s_1_0;
        // C s_1_2: const #2s : i
        let s_1_2: i128 = 2;
        ...
        // D s_1_7: read-var VLshadow#3915:i64
        let s_1_7: i64 = fn_state.VLshadow_3915;
        ...
        // D s_1_22: read-var VLshadow#3915:i64
        let s_1_22: i64 = fn_state.VLshadow_3915;
        ...
        // D s_1_30: read-var VLshadow#3915:i64
        let s_1_30: i64 = fn_state.VLshadow_3915;
        ...
        // D s_1_43: write-var gs#211748 <= s_1_42
        fn_state.gs_211748 = s_1_42;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#211748:i64
        let s_2_1: i64 = fn_state.gs_211748;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_52: cast zx s_3_31 -> i
        let s_3_52: i128 = (i128::try_from(s_3_31).unwrap());
        ...
        // D s_3_65: mul s_3_62 s_3_64
        let s_3_65: i128 = ((s_3_62) * (s_3_64));
        ...
        // D s_3_73: call integer_subrange(s_3_54, s_3_72, s_3_71)
        let s_3_73: Bits = integer_subrange(state, tracer, s_3_54, s_3_72, s_3_71);
        // D s_3_74: read-var e:i64
        let s_3_74: i64 = fn_state.e;
        // D s_3_75: cast zx s_3_74 -> i
        let s_3_75: i128 = (i128::try_from(s_3_74).unwrap());
        // D s_3_76: cast zx s_3_61 -> i
        let s_3_76: i128 = (i128::try_from(s_3_61).unwrap());
        // D s_3_77: read-var result:bv
        let s_3_77: Bits = fn_state.result;
        // D s_3_78: call Elem_set(s_3_77, s_3_75, s_3_76, s_3_73)
        let s_3_78: Bits = Elem_set(state, tracer, s_3_77, s_3_75, s_3_76, s_3_73);
        // D s_3_79: write-var result <= s_3_78
        fn_state.result = s_3_78;
        // D s_3_80: read-var e:i64
        let s_3_80: i64 = fn_state.e;
        // C s_3_81: const #1s : i64
        let s_3_81: i64 = 1;
        // D s_3_82: add s_3_80 s_3_81
        let s_3_82: i64 = (s_3_80 + s_3_81);
        // D s_3_83: write-var e <= s_3_82
        fn_state.e = s_3_82;
        // N s_3_84: jump b2
        return block_2(state, tracer, fn_state);
    }
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#3915:i64
        let s_4_0: i64 = fn_state.VLshadow_3915;
