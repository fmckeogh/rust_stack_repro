...
use common::*;
pub fn decode_aarch32_instrs_VMOVX_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Vd: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_7: write-var gs#312750 <= s_4_6
        fn_state.gs_312750 = s_4_6;
        // N s_4_8: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#312750:u8
        let s_5_0: bool = fn_state.gs_312750;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_32: call execute_aarch32_instrs_VMOVX_Op_A_txt(s_6_15, s_6_31)
        let s_6_32: () = execute_aarch32_instrs_VMOVX_Op_A_txt(
            state,
            tracer,
            s_6_15,
            s_6_31,
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #1u : u8
        let s_8_0: bool = true;
        // D s_8_1: write-var gs#312750 <= s_8_0
        fn_state.gs_312750 = s_8_0;
        // N s_8_2: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
