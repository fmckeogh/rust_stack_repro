...
use execute_aarch64_instrs_memory_rcw_ld_128_rcwsetp::*;
use common::*;
pub fn decode_rcwsetp_aarch64_instrs_memory_rcw_ld_128_rcwsetp<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_3: write-var gs#166285 <= s_1_2
        fn_state.gs_166285 = s_1_2;
        // N s_1_4: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#166285:u8
        let s_2_0: bool = fn_state.gs_166285;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_11: call execute_aarch64_instrs_memory_rcw_ld_128_rcwsetp(s_7_4, s_7_5, s_7_6, s_7_7, s_7_8, s_7_9, s_7_10, s_7_3)
        let s_7_11: () = execute_aarch64_instrs_memory_rcw_ld_128_rcwsetp(
            state,
            tracer,
            s_7_4,
            s_7_5,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#166285 <= s_12_0
        fn_state.gs_166285 = s_12_0;
        // N s_12_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
