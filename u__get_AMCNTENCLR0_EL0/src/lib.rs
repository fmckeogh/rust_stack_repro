...
extern crate alloc;
use Mk_AMCNTENCLR0_EL0_Type::*;
use common::*;
pub fn u__get_AMCNTENCLR0_EL0<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_11: tail-call Mk_AMCNTENCLR0_EL0_Type(s_0_10)
        return Mk_AMCNTENCLR0_EL0_Type(state, tracer, s_0_10);
    }
}
