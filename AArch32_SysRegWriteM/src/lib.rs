...
use common::*;
pub fn AArch32_SysRegWriteM<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cp_num: i128,
    instr: u32,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#142214 <= s_1_0
        fn_state.gs_142214 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#142214:u8
        let s_2_0: bool = fn_state.gs_142214;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_7: call AArch32_LDC(s_4_4, s_4_5, s_4_6)
        let s_4_7: () = AArch32_LDC(state, tracer, s_4_4, s_4_5, s_4_6);
        // N s_4_8: return
        return;
    }
    fn block_5<T: Tracer>(
        ...
        // D s_5_7: write-var gs#142214 <= s_5_6
        fn_state.gs_142214 = s_5_6;
        // N s_5_8: jump b2
        return block_2(state, tracer, fn_state);
    }
}
