...
use common::*;
pub fn decode_aarch32_instrs_MOV_i_T3enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i: bool,
    imm4: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_42: const #32s : i
        let s_2_42: i128 = 32;
        // D s_2_43: cast zx s_2_41 -> bv
        let s_2_43: Bits = Bits::new(s_2_41 as u128, 16u16);
        // D s_2_44: bits-cast zx s_2_43 -> bv length s_2_42
        let s_2_44: Bits = s_2_43.zero_extend(s_2_42);
        // D s_2_45: cast reint s_2_44 -> u32
        let s_2_45: u32 = (s_2_44.value() as u32);
        // D s_2_46: write-var imm32 <= s_2_45
