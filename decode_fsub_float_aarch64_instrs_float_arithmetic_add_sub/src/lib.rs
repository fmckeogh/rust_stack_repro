...
extern crate alloc;
use execute_aarch64_instrs_float_arithmetic_add_sub::*;
use common::*;
pub fn decode_fsub_float_aarch64_instrs_float_arithmetic_add_sub<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_11: call execute_aarch64_instrs_float_arithmetic_add_sub(s_2_8, s_2_7, s_2_9, s_2_10, s_2_5)
        let s_2_11: () = execute_aarch64_instrs_float_arithmetic_add_sub(
            state,
            tracer,
            s_2_8,
            s_2_7,
