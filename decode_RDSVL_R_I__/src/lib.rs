...
extern crate alloc;
use execute_RDSVL_R_I__::*;
use CurrentSVL_read::*;
use HaveSME::*;
use common::*;
pub fn decode_RDSVL_R_I__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm6: u8,
    Rd: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        fn_state.d = s_1_3;
        // D s_1_5: read-var imm6:u8
        let s_1_5: u8 = fn_state.imm6;
        // D s_1_6: cast zx s_1_5 -> bv
        let s_1_6: Bits = Bits::new(s_1_5 as u128, 6u16);
        // D s_1_7: cast sx s_1_6 -> i
        let s_1_7: i128 = {
            let sign_bit = s_1_6.length() - 1;
            let mut result = s_1_6.value() as i128;
        ...
        // D s_1_9: write-var imm <= s_1_8
        fn_state.imm = s_1_8;
        // D s_1_10: read-var SVL:i64
        let s_1_10: i64 = fn_state.SVL;
        // C s_1_11: const #128s : i
        let s_1_11: i128 = 128;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_4: call execute_RDSVL_R_I__(s_2_0, s_2_3, s_2_2)
        let s_2_4: () = execute_RDSVL_R_I__(state, tracer, s_2_0, s_2_3, s_2_2);
        // N s_2_5: return
        return;
    }
    fn block_3<T: Tracer>(
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: call execute_RDSVL_R_I__(s_4_0, s_4_3, s_4_2)
        let s_4_4: () = execute_RDSVL_R_I__(state, tracer, s_4_0, s_4_3, s_4_2);
        // N s_4_5: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call execute_RDSVL_R_I__(s_6_0, s_6_3, s_6_2)
        let s_6_4: () = execute_RDSVL_R_I__(state, tracer, s_6_0, s_6_3, s_6_2);
        // N s_6_5: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: call execute_RDSVL_R_I__(s_8_0, s_8_3, s_8_2)
        let s_8_4: () = execute_RDSVL_R_I__(state, tracer, s_8_0, s_8_3, s_8_2);
        // N s_8_5: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: call execute_RDSVL_R_I__(s_10_0, s_10_3, s_10_2)
        let s_10_4: () = execute_RDSVL_R_I__(state, tracer, s_10_0, s_10_3, s_10_2);
        // N s_10_5: return
        return;
    }
