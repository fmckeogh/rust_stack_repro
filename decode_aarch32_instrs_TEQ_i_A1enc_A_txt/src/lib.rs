...
use common::*;
pub fn decode_aarch32_instrs_TEQ_i_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    Rn: u8,
    ...
    struct FunctionState {
        ga_348702: ProductType4813027798de1e98,
        cond: u8,
        Rn: u8,
        imm12: u16,
    }
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_14: write-var ga#348702 <= s_2_13
        fn_state.ga_348702 = s_2_13;
        // D s_2_15: read-var ga#348702.0:struct
        let s_2_15: u32 = fn_state.ga_348702._0;
        // D s_2_16: read-var ga#348702.1:struct
        let s_2_16: bool = fn_state.ga_348702._1;
        // D s_2_17: call execute_aarch32_instrs_TEQ_i_Op_A_txt(s_2_16, s_2_15, s_2_9)
        let s_2_17: () = execute_aarch32_instrs_TEQ_i_Op_A_txt(
            state,
            tracer,
            s_2_16,
            s_2_15,
