...
use HaveSVE::*;
use CurrentVL_read::*;
use execute_SETFFR_F__::*;
use common::*;
pub fn decode_SETFFR_F__<T: Tracer>(state: &mut State, tracer: &T, gs_197428: ()) -> () {
    #[derive(Default)]
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 128;
        // S s_2_1: call execute_SETFFR_F__(s_2_0)
        let s_2_1: () = execute_SETFFR_F__(state, tracer, s_2_0);
        // N s_2_2: return
        return;
    }
    fn block_3<T: Tracer>(
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 256;
        // S s_4_1: call execute_SETFFR_F__(s_4_0)
        let s_4_1: () = execute_SETFFR_F__(state, tracer, s_4_0);
        // N s_4_2: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 512;
        // S s_6_1: call execute_SETFFR_F__(s_6_0)
        let s_6_1: () = execute_SETFFR_F__(state, tracer, s_6_0);
        // N s_6_2: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 1024;
        // S s_8_1: call execute_SETFFR_F__(s_8_0)
        let s_8_1: () = execute_SETFFR_F__(state, tracer, s_8_0);
        // N s_8_2: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 2048;
        // S s_10_1: call execute_SETFFR_F__(s_10_0)
        let s_10_1: () = execute_SETFFR_F__(state, tracer, s_10_0);
        // N s_10_2: return
        return;
    }
