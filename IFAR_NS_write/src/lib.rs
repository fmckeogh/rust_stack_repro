...
extern crate alloc;
use common::*;
pub fn IFAR_NS_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #16256u : u32
        let s_0_23: u32 = 16256;
        ...
        // C s_0_25: const #14080u : u32
        let s_0_25: u32 = 14080;
