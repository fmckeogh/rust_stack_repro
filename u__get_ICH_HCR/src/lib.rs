...
use Mk_ICH_HCR_Type::*;
use common::*;
pub fn u__get_ICH_HCR<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #32s : i
        let s_0_3: i128 = 32;
        // C s_0_4: const #134152704u : u28
        let s_0_4: u32 = 134152704;
        ...
        // D s_0_15: tail-call Mk_ICH_HCR_Type(s_0_14)
        return Mk_ICH_HCR_Type(state, tracer, s_0_14);
    }
}
