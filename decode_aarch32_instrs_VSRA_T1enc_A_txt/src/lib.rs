...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_VSRA_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_VSRA_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    U: bool,
    D: bool,
    ...
    struct FunctionState {
        ...
        m: i64,
        ga_361169: i64,
        esizeshadow_7842: i64,
        gs_319727: bool,
        esize: i64,
        shift_amountshadow_7841: i128,
        ga_361155: u8,
        elementsshadow_7843: i64,
        regs: i64,
        d: i64,
        elements: i64,
        is_unsigned: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_0: const #1u : u8
        let s_3_0: bool = true;
        // D s_3_1: write-var gs#319718 <= s_3_0
        fn_state.gs_319718 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#319718:u8
        let s_4_0: bool = fn_state.gs_319718;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#319728 <= s_6_0
        fn_state.gs_319728 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#319728:u8
        let s_7_0: bool = fn_state.gs_319728;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_17: write-var ga#361155 <= s_8_16
        fn_state.ga_361155 = s_8_16;
        // D s_8_18: read-var ga#361155:u8
        let s_8_18: u8 = fn_state.ga_361155;
        // C s_8_19: const #3s : i
        let s_8_19: i128 = 3;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var shift_amountshadow#7841 <= s_10_0
        fn_state.shift_amountshadow_7841 = s_10_0;
        // D s_10_2: read-var esize:i64
        let s_10_2: i64 = fn_state.esize;
        // D s_10_3: write-var esizeshadow#7842 <= s_10_2
        fn_state.esizeshadow_7842 = s_10_2;
        // D s_10_4: read-var elements:i64
        let s_10_4: i64 = fn_state.elements;
        // D s_10_5: write-var elementsshadow#7843 <= s_10_4
        fn_state.elementsshadow_7843 = s_10_4;
    ...
    fn block_11<T: Tracer>(
        ...
        let s_11_0: i64 = 2;
        // D s_11_1: write-var ga#361169 <= s_11_0
        fn_state.ga_361169 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var ga#361169:i64
        let s_12_0: i64 = fn_state.ga_361169;
        // D s_12_1: write-var regs <= s_12_0
        fn_state.regs = s_12_0;
        // D s_12_2: read-var esizeshadow#7842:i64
        let s_12_2: i64 = fn_state.esizeshadow_7842;
        // C s_12_3: const #8s : i
        let s_12_3: i128 = 8;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_2: read-var elementsshadow#7843:i64
        let s_13_2: i64 = fn_state.elementsshadow_7843;
        // D s_13_3: read-var m:i64
        let s_13_3: i64 = fn_state.m;
        // D s_13_4: read-var regs:i64
        let s_13_4: i64 = fn_state.regs;
        // D s_13_5: read-var shift_amountshadow#7841:i
        let s_13_5: i128 = fn_state.shift_amountshadow_7841;
        // D s_13_6: read-var is_unsigned:u8
        let s_13_6: bool = fn_state.is_unsigned;
        // D s_13_7: call execute_aarch32_instrs_VSRA_Op_A_txt(s_13_1, s_13_2, s_13_0, s_13_3, s_13_4, s_13_5, s_13_6)
        let s_13_7: () = execute_aarch32_instrs_VSRA_Op_A_txt(
            state,
            tracer,
            s_13_1,
            s_13_2,
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var esizeshadow#7842:i64
        let s_14_0: i64 = fn_state.esizeshadow_7842;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_2: read-var elementsshadow#7843:i64
        let s_15_2: i64 = fn_state.elementsshadow_7843;
        // D s_15_3: read-var m:i64
        let s_15_3: i64 = fn_state.m;
        // D s_15_4: read-var regs:i64
        let s_15_4: i64 = fn_state.regs;
        // D s_15_5: read-var shift_amountshadow#7841:i
        let s_15_5: i128 = fn_state.shift_amountshadow_7841;
        // D s_15_6: read-var is_unsigned:u8
        let s_15_6: bool = fn_state.is_unsigned;
        // D s_15_7: call execute_aarch32_instrs_VSRA_Op_A_txt(s_15_1, s_15_2, s_15_0, s_15_3, s_15_4, s_15_5, s_15_6)
        let s_15_7: () = execute_aarch32_instrs_VSRA_Op_A_txt(
            state,
            tracer,
            s_15_1,
            s_15_2,
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var esizeshadow#7842:i64
        let s_16_0: i64 = fn_state.esizeshadow_7842;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_2: read-var elementsshadow#7843:i64
        let s_17_2: i64 = fn_state.elementsshadow_7843;
        // D s_17_3: read-var m:i64
        let s_17_3: i64 = fn_state.m;
        // D s_17_4: read-var regs:i64
        let s_17_4: i64 = fn_state.regs;
        // D s_17_5: read-var shift_amountshadow#7841:i
        let s_17_5: i128 = fn_state.shift_amountshadow_7841;
        // D s_17_6: read-var is_unsigned:u8
        let s_17_6: bool = fn_state.is_unsigned;
        // D s_17_7: call execute_aarch32_instrs_VSRA_Op_A_txt(s_17_1, s_17_2, s_17_0, s_17_3, s_17_4, s_17_5, s_17_6)
        let s_17_7: () = execute_aarch32_instrs_VSRA_Op_A_txt(
            state,
            tracer,
            s_17_1,
            s_17_2,
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var esizeshadow#7842:i64
        let s_18_0: i64 = fn_state.esizeshadow_7842;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_2: read-var elementsshadow#7843:i64
        let s_19_2: i64 = fn_state.elementsshadow_7843;
        // D s_19_3: read-var m:i64
        let s_19_3: i64 = fn_state.m;
        // D s_19_4: read-var regs:i64
        let s_19_4: i64 = fn_state.regs;
        // D s_19_5: read-var shift_amountshadow#7841:i
        let s_19_5: i128 = fn_state.shift_amountshadow_7841;
        // D s_19_6: read-var is_unsigned:u8
        let s_19_6: bool = fn_state.is_unsigned;
        // D s_19_7: call execute_aarch32_instrs_VSRA_Op_A_txt(s_19_1, s_19_2, s_19_0, s_19_3, s_19_4, s_19_5, s_19_6)
        let s_19_7: () = execute_aarch32_instrs_VSRA_Op_A_txt(
            state,
            tracer,
            s_19_1,
            s_19_2,
    ...
    fn block_21<T: Tracer>(
        ...
        let s_21_0: i64 = 1;
        // D s_21_1: write-var ga#361169 <= s_21_0
        fn_state.ga_361169 = s_21_0;
        // N s_21_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        // D s_22_0: read-var ga#361155:u8
        let s_22_0: u8 = fn_state.ga_361155;
        // C s_22_1: const #4s : i
        let s_22_1: i128 = 4;
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_0: read-var ga#361155:u8
        let s_24_0: u8 = fn_state.ga_361155;
        // C s_24_1: const #5s : i
        let s_24_1: i128 = 5;
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var ga#361155:u8
        let s_26_0: u8 = fn_state.ga_361155;
        // C s_26_1: const #6s : i
        let s_26_1: i128 = 6;
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_22: write-var gs#319727 <= s_31_21
        fn_state.gs_319727 = s_31_21;
        // N s_31_23: jump b32
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_0: read-var gs#319727:u8
        let s_32_0: bool = fn_state.gs_319727;
        // D s_32_1: write-var gs#319728 <= s_32_0
        fn_state.gs_319728 = s_32_0;
        // N s_32_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_33<T: Tracer>(
        ...
        // D s_33_1: write-var gs#319727 <= s_33_0
        fn_state.gs_319727 = s_33_0;
        // N s_33_2: jump b32
        return block_32(state, tracer, fn_state);
    }
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_1: write-var gs#319718 <= s_35_0
        fn_state.gs_319718 = s_35_0;
        // N s_35_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
