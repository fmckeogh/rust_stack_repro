...
use common::*;
pub fn decode_aarch32_instrs_STRH_i_T2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    Rt: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_6: call execute_aarch32_instrs_STRH_i_OpT_A_txt(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5)
        let s_4_6: () = execute_aarch32_instrs_STRH_i_OpT_A_txt(
            state,
            tracer,
            s_4_0,
            s_4_1,
