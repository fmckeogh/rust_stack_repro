...
extern crate alloc;
use HaveSVE::*;
use execute_BRKA_P_P_P__::*;
use CurrentVL_read::*;
use HaveSME::*;
use common::*;
pub fn decode_BRKA_P_P_P__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    B: bool,
    S: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#197822 <= s_1_0
        fn_state.gs_197822 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#197822:u8
        let s_2_0: bool = fn_state.gs_197822;
    ...
    fn block_3<T: Tracer>(
        ...
        fn_state.n = s_3_8;
        // D s_3_10: read-var Pd:u8
        let s_3_10: u8 = fn_state.Pd;
        ...
        fn_state.d = s_3_13;
        // D s_3_15: read-var M:u8
        let s_3_15: bool = fn_state.M;
        ...
        // D s_3_20: write-var merging <= s_3_19
        fn_state.merging = s_3_19;
        // D s_3_21: read-var VL:i64
        let s_3_21: i64 = fn_state.VL;
        // C s_3_22: const #128s : i
        let s_3_22: i128 = 128;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: read-var merging:u8
        let s_4_4: bool = fn_state.merging;
        // D s_4_5: read-var n:i64
        let s_4_5: i64 = fn_state.n;
        // C s_4_6: const #0u : u8
        let s_4_6: bool = false;
        // D s_4_7: call execute_BRKA_P_P_P__(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5, s_4_6)
        let s_4_7: () = execute_BRKA_P_P_P__(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: read-var merging:u8
        let s_6_4: bool = fn_state.merging;
        // D s_6_5: read-var n:i64
        let s_6_5: i64 = fn_state.n;
        // C s_6_6: const #0u : u8
        let s_6_6: bool = false;
        // D s_6_7: call execute_BRKA_P_P_P__(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5, s_6_6)
        let s_6_7: () = execute_BRKA_P_P_P__(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: read-var merging:u8
        let s_8_4: bool = fn_state.merging;
        // D s_8_5: read-var n:i64
        let s_8_5: i64 = fn_state.n;
        // C s_8_6: const #0u : u8
        let s_8_6: bool = false;
        // D s_8_7: call execute_BRKA_P_P_P__(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5, s_8_6)
        let s_8_7: () = execute_BRKA_P_P_P__(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: read-var merging:u8
        let s_10_4: bool = fn_state.merging;
        // D s_10_5: read-var n:i64
        let s_10_5: i64 = fn_state.n;
        // C s_10_6: const #0u : u8
        let s_10_6: bool = false;
        // D s_10_7: call execute_BRKA_P_P_P__(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5, s_10_6)
        let s_10_7: () = execute_BRKA_P_P_P__(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_4: read-var merging:u8
        let s_12_4: bool = fn_state.merging;
        // D s_12_5: read-var n:i64
        let s_12_5: i64 = fn_state.n;
        // C s_12_6: const #0u : u8
        let s_12_6: bool = false;
        // D s_12_7: call execute_BRKA_P_P_P__(s_12_0, s_12_1, s_12_2, s_12_3, s_12_4, s_12_5, s_12_6)
        let s_12_7: () = execute_BRKA_P_P_P__(
            state,
            tracer,
            s_12_0,
            s_12_1,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#197822 <= s_15_2
        fn_state.gs_197822 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
