...
use common::*;
pub fn decode_sqxtn_advsimd_aarch64_instrs_vector_arithmetic_unary_extract_sat_simd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, size: u8, U: bool, Q: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_24: read-var n:i64
        let s_1_24: i64 = fn_state.n;
        // D s_1_25: call execute_aarch64_instrs_vector_arithmetic_unary_extract_sat_sisd(s_1_23, s_1_19, s_1_22, s_1_21, s_1_24, s_1_9, s_1_18)
        let s_1_25: () = execute_aarch64_instrs_vector_arithmetic_unary_extract_sat_sisd(
            state,
            tracer,
            s_1_23,
            s_1_19,
