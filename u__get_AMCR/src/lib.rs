...
pub fn u__get_AMCR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4294835199u : u32
        let s_0_3: u32 = 4294835199;
        ...
        // D s_0_11: tail-call Mk_AMCR_Type(s_0_10)
        return Mk_AMCR_Type(state, tracer, s_0_10);
    }
}
