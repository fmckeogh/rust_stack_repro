...
extern crate alloc;
use common::*;
pub fn u_get_PMEVTYPER_Type_evtCount<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        let s_0_9: u32 = fn_state.v._0;
        // C s_0_10: const #0s : i
        let s_0_10: i128 = 0;
        // D s_0_11: cast zx s_0_9 -> bv
        let s_0_11: Bits = Bits::new(s_0_9 as u128, 32u16);
        ...
        // D s_0_17: cast reint s_0_16 -> u10
        let s_0_17: u16 = (s_0_16.value() as u16);
        // D s_0_18: cast zx s_0_8 -> bv
        let s_0_18: Bits = Bits::new(s_0_8 as u128, 6u16);
        // D s_0_19: cast zx s_0_17 -> bv
        let s_0_19: Bits = Bits::new(s_0_17 as u128, 10u16);
        ...
        // D s_0_28: cast reint s_0_27 -> u16
        let s_0_28: u16 = (s_0_27.value() as u16);
