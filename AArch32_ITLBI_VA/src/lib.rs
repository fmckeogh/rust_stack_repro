...
use Zeros::*;
use common::*;
pub fn AArch32_ITLBI_VA<T: Tracer>(
    state: &mut State,
    tracer: &T,
    security: u32,
    regime: u32,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_7: write-var gs#32375 <= s_2_6
        fn_state.gs_32375 = s_2_6;
        // N s_2_8: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#32375:u8
        let s_3_0: bool = fn_state.gs_32375;
        // D s_3_1: write-var gs#32376 <= s_3_0
        fn_state.gs_32376 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#32376:u8
        let s_4_0: bool = fn_state.gs_32376;
        // N s_4_1: assert s_4_0
        let s_4_1: () = assert!(s_4_0);
        // C s_4_2: const #5u : u32
        let s_4_2: u32 = 5;
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #1u : u8
        let s_7_0: bool = true;
        // D s_7_1: write-var gs#32375 <= s_7_0
        fn_state.gs_32375 = s_7_0;
        // N s_7_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #1u : u8
        let s_8_0: bool = true;
        // D s_8_1: write-var gs#32376 <= s_8_0
        fn_state.gs_32376 = s_8_0;
        // N s_8_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
