...
extern crate alloc;
use execute_RSHRNT_Z_ZI__::*;
use CurrentVL_read::*;
use HaveSVE2::*;
use HaveSME::*;
use common::*;
pub fn decode_RSHRNT_Z_ZI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    tszh: bool,
    tszl: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#203653 <= s_1_0
        fn_state.gs_203653 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#203653:u8
        let s_2_0: bool = fn_state.gs_203653;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var esizeshadow#3411 <= s_7_0
        fn_state.esizeshadow_3411 = s_7_0;
        ...
        // C s_7_12: const #2s : i
        let s_7_12: i128 = 2;
        // D s_7_13: read-var esizeshadow#3411:i64
        let s_7_13: i64 = fn_state.esizeshadow_3411;
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 128;
        // D s_8_1: read-var esizeshadow#3411:i64
        let s_8_1: i64 = fn_state.esizeshadow_3411;
        ...
        // D s_8_8: call execute_RSHRNT_Z_ZI__(s_8_0, s_8_6, s_8_3, s_8_7, s_8_5)
        let s_8_8: () = execute_RSHRNT_Z_ZI__(
            state,
            tracer,
            s_8_0,
            s_8_6,
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 256;
        // D s_10_1: read-var esizeshadow#3411:i64
        let s_10_1: i64 = fn_state.esizeshadow_3411;
        ...
        // D s_10_8: call execute_RSHRNT_Z_ZI__(s_10_0, s_10_6, s_10_3, s_10_7, s_10_5)
        let s_10_8: () = execute_RSHRNT_Z_ZI__(
            state,
            tracer,
            s_10_0,
            s_10_6,
    ...
    fn block_12<T: Tracer>(
        ...
        let s_12_0: i64 = 512;
        // D s_12_1: read-var esizeshadow#3411:i64
        let s_12_1: i64 = fn_state.esizeshadow_3411;
        ...
        // D s_12_8: call execute_RSHRNT_Z_ZI__(s_12_0, s_12_6, s_12_3, s_12_7, s_12_5)
        let s_12_8: () = execute_RSHRNT_Z_ZI__(
            state,
            tracer,
            s_12_0,
            s_12_6,
    ...
    fn block_14<T: Tracer>(
        ...
        let s_14_0: i64 = 1024;
        // D s_14_1: read-var esizeshadow#3411:i64
        let s_14_1: i64 = fn_state.esizeshadow_3411;
        ...
        // D s_14_8: call execute_RSHRNT_Z_ZI__(s_14_0, s_14_6, s_14_3, s_14_7, s_14_5)
        let s_14_8: () = execute_RSHRNT_Z_ZI__(
            state,
            tracer,
            s_14_0,
            s_14_6,
    ...
    fn block_16<T: Tracer>(
        ...
        let s_16_0: i64 = 2048;
        // D s_16_1: read-var esizeshadow#3411:i64
        let s_16_1: i64 = fn_state.esizeshadow_3411;
        ...
        // D s_16_8: call execute_RSHRNT_Z_ZI__(s_16_0, s_16_6, s_16_3, s_16_7, s_16_5)
        let s_16_8: () = execute_RSHRNT_Z_ZI__(
            state,
            tracer,
            s_16_0,
            s_16_6,
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_3: write-var gs#203653 <= s_22_2
        fn_state.gs_203653 = s_22_2;
        // N s_22_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
