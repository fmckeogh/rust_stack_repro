...
use LastActive::*;
use common::*;
pub fn execute_BRKPA_P_P_PP__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_47: write-var gs#201381 <= s_1_46
        fn_state.gs_201381 = s_1_46;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#201381:i64
        let s_2_1: i64 = fn_state.gs_201381;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#201391 <= s_9_0
        fn_state.gs_201391 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#201391:u8
        let s_10_0: bool = fn_state.gs_201391;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_6: write-var gs#201391 <= s_11_5
        fn_state.gs_201391 = s_11_5;
        // N s_11_7: jump b10
        return block_10(state, tracer, fn_state);
    }
