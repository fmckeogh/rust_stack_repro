...
use common::*;
pub fn IsTMEEnabled<T: Tracer>(state: &mut State, tracer: &T, gs_24552: ()) -> bool {
    #[derive(Default)]
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_7: write-var gs#24553 <= s_2_6
        fn_state.gs_24553 = s_2_6;
        // N s_2_8: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#24553:u8
        let s_3_0: bool = fn_state.gs_24553;
        // D s_3_1: write-var gs#24554 <= s_3_0
        fn_state.gs_24554 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#24554:u8
        let s_4_0: bool = fn_state.gs_24554;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#24555 <= s_5_0
        fn_state.gs_24555 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#24555:u8
        let s_6_0: bool = fn_state.gs_24555;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_7: write-var gs#24556 <= s_9_6
        fn_state.gs_24556 = s_9_6;
        // N s_9_8: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#24556:u8
        let s_10_0: bool = fn_state.gs_24556;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#24557 <= s_11_0
        fn_state.gs_24557 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#24557:u8
        let s_12_0: bool = fn_state.gs_24557;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_2: call _get_HCR_EL2_Type_TME(s_16_1)
        let s_16_2: bool = u_get_HCR_EL2_Type_TME(state, tracer, s_16_1);
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_2: write-var gs#24557 <= s_19_1
        fn_state.gs_24557 = s_19_1;
        // N s_19_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#24556 <= s_20_0
        fn_state.gs_24556 = s_20_0;
        // N s_20_2: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_2: call _get_SCR_EL3_Type_TME(s_21_1)
        let s_21_2: bool = u_get_SCR_EL3_Type_TME(state, tracer, s_21_1);
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_4: write-var gs#24555 <= s_24_3
        fn_state.gs_24555 = s_24_3;
        // N s_24_5: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#24553 <= s_25_0
        fn_state.gs_24553 = s_25_0;
        // N s_25_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_26<T: Tracer>(
        ...
        // D s_26_1: write-var gs#24554 <= s_26_0
        fn_state.gs_24554 = s_26_0;
        // N s_26_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
