...
use common::*;
pub fn execute_aarch32_instrs_LDAEXB_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    n: i64,
    t: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_9: write-var gs#913482 <= s_1_8
        fn_state.gs_913482 = s_1_8;
        // N s_1_10: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#913482:bv
        let s_2_0: Bits = fn_state.gs_913482;
        // D s_2_1: cast reint s_2_0 -> u8
        let s_2_1: u8 = (s_2_0.value() as u8);
        // C s_2_2: const #32s : i
        let s_2_2: i128 = 32;
        // D s_2_3: cast zx s_2_1 -> bv
        let s_2_3: Bits = Bits::new(s_2_1 as u128, 8u16);
