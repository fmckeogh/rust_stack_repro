...
use ConditionPassed::*;
use HaveSHA256Ext::*;
use execute_aarch32_instrs_SHA256SU1_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_SHA256SU1_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Vn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_0: const #() : ()
        let s_2_0: () = ();
        // S s_2_1: call HaveSHA256Ext(s_2_0)
        let s_2_1: bool = HaveSHA256Ext(state, tracer, s_2_0);
        // S s_2_2: not s_2_1
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_22: write-var gs#324804 <= s_5_21
        fn_state.gs_324804 = s_5_21;
        // N s_5_23: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#324804:u8
        let s_6_0: bool = fn_state.gs_324804;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_22: write-var gs#324807 <= s_7_21
        fn_state.gs_324807 = s_7_21;
        // N s_7_23: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#324807:u8
        let s_8_0: bool = fn_state.gs_324807;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_48: call execute_aarch32_instrs_SHA256SU1_Op_A_txt(s_9_15, s_9_47, s_9_31)
        let s_9_48: () = execute_aarch32_instrs_SHA256SU1_Op_A_txt(
            state,
            tracer,
            s_9_15,
            s_9_47,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#324807 <= s_11_0
        fn_state.gs_324807 = s_11_0;
        // N s_11_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#324804 <= s_12_0
        fn_state.gs_324804 = s_12_0;
        // N s_12_2: jump b6
        return block_6(state, tracer, fn_state);
    }
