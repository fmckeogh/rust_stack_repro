...
use common::*;
pub fn decode_fminnmp_advsimd_pair_aarch64_instrs_vector_reduce_fp_maxnm_sisd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_9: call execute_aarch64_instrs_vector_reduce_fp16_maxnm_sisd(s_2_6, s_2_2, s_2_5, s_2_7, s_2_8)
        let s_2_9: () = execute_aarch64_instrs_vector_reduce_fp16_maxnm_sisd(
            state,
            tracer,
            s_2_6,
            s_2_2,
