...
use common::*;
pub fn decode_fmla_advsimd_elt_aarch64_instrs_vector_arithmetic_binary_element_mul_acc_fp_sisd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#255476 <= s_1_0
        fn_state.ga_255476 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#255476:i64
        let s_2_0: i64 = fn_state.ga_255476;
        ...
        // D s_2_17: write-var ga#255477 <= s_2_16
        fn_state.ga_255477 = s_2_16;
        // D s_2_18: read-var ga#255477:u8
        let s_2_18: u8 = fn_state.ga_255477;
        // C s_2_19: const #1s : i
        let s_2_19: i128 = 1;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var ga#255477:u8
        let s_5_0: u8 = fn_state.ga_255477;
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 128;
        // D s_8_1: write-var ga#255476 <= s_8_0
        fn_state.ga_255476 = s_8_0;
        // N s_8_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
