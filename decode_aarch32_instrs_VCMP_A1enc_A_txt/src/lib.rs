...
use common::*;
pub fn decode_aarch32_instrs_VCMP_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    D: bool,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#307705 <= s_4_0
        fn_state.gs_307705 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#307705:u8
        let s_5_0: bool = fn_state.gs_307705;
        // D s_5_1: write-var gs#307706 <= s_5_0
        fn_state.gs_307706 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#307706:u8
        let s_6_0: bool = fn_state.gs_307706;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#307707 <= s_8_0
        fn_state.gs_307707 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#307707:u8
        let s_9_0: bool = fn_state.gs_307707;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_5: write-var gs#307707 <= s_19_4
        fn_state.gs_307707 = s_19_4;
        // N s_19_6: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_3: write-var gs#307705 <= s_21_2
        fn_state.gs_307705 = s_21_2;
        // N s_21_4: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#307706 <= s_22_0
        fn_state.gs_307706 = s_22_0;
        // N s_22_2: jump b6
        return block_6(state, tracer, fn_state);
    }
}
