...
use X_read::*;
use common::*;
pub fn GCSSS1_SysOpsWrite_5eb47650d9a586f4<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call GCSSS1(s_5_3)
        let s_5_4: () = GCSSS1(state, tracer, s_5_3);
        // N s_5_5: return
        return;
    }
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call GCSSS1(s_6_3)
        let s_6_4: () = GCSSS1(state, tracer, s_6_3);
        // N s_6_5: return
        return;
    }
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: call GCSSS1(s_7_3)
        let s_7_4: () = GCSSS1(state, tracer, s_7_3);
        // N s_7_5: return
        return;
    }
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: call GCSSS1(s_8_3)
        let s_8_4: () = GCSSS1(state, tracer, s_8_3);
        // N s_8_5: return
        return;
    }
}
