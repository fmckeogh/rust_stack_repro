...
use common::*;
pub fn u__set_CNTP_CTL<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#36678 <= s_1_0
        fn_state.gs_36678 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#36678:u8
        let s_2_0: bool = fn_state.gs_36678;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: call __set_CNTP_CTL_NS(s_3_0)
        let s_3_1: () = u__set_CNTP_CTL_NS(state, tracer, s_3_0);
        // N s_3_2: return
        return;
    }
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: call __set_CNTP_CTL_S(s_4_0)
        let s_4_1: () = u__set_CNTP_CTL_S(state, tracer, s_4_0);
        // N s_4_2: return
        return;
    }
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#36678 <= s_5_3
        fn_state.gs_36678 = s_5_3;
        // N s_5_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
