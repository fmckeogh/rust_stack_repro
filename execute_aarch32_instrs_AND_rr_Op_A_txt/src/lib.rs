...
use IsZeroBit::*;
use common::*;
pub fn execute_aarch32_instrs_AND_rr_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        carry: bool,
        gs_878147: ProductTypef506aa96a892fe52,
        result: u32,
        d: i64,
        m: i64,
        n: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_23: write-var gs#878147 <= s_0_22
        fn_state.gs_878147 = s_0_22;
        // D s_0_24: read-var gs#878147.0:struct
        let s_0_24: Bits = fn_state.gs_878147._0;
        // D s_0_25: cast reint s_0_24 -> u32
        let s_0_25: u32 = (s_0_24.value() as u32);
        // D s_0_26: read-var gs#878147.1:struct
        let s_0_26: bool = fn_state.gs_878147._1;
