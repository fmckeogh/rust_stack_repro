...
use EL2Enabled::*;
use common::*;
pub fn TTBR0_EL2_SysRegRead_46a02b83889584ea<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_99760: ProductType782ac6922b48c20d,
        u__PSTATE_EL: u8,
        u__HCR_EL2_NV: bool,
        gs_74476: bool,
        ga_99766: ProductType782ac6922b48c20d,
        el: u8,
        op0: u8,
        op1: u8,
        CRn: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_1: const #() : ()
        let s_5_1: () = ();
        // S s_5_2: call TTBR0_EL2_read(s_5_1)
        let s_5_2: ProductType782ac6922b48c20d = TTBR0_EL2_read(state, tracer, s_5_1);
        // S s_5_3: call __get_TTBR0_EL2(s_5_2)
        let s_5_3: ProductType782ac6922b48c20d = u__get_TTBR0_EL2(state, tracer, s_5_2);
        // D s_5_4: write-var ga#99766 <= s_5_3
        fn_state.ga_99766 = s_5_3;
        // D s_5_5: read-var ga#99766.0:struct
        let s_5_5: u128 = fn_state.ga_99766._0;
        // C s_5_6: const #0s : i
        let s_5_6: i128 = 0;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_1: const #() : ()
        let s_6_1: () = ();
        // S s_6_2: call TTBR0_EL2_read(s_6_1)
        let s_6_2: ProductType782ac6922b48c20d = TTBR0_EL2_read(state, tracer, s_6_1);
        // S s_6_3: call __get_TTBR0_EL2(s_6_2)
        let s_6_3: ProductType782ac6922b48c20d = u__get_TTBR0_EL2(state, tracer, s_6_2);
        // D s_6_4: write-var ga#99760 <= s_6_3
        fn_state.ga_99760 = s_6_3;
        // D s_6_5: read-var ga#99760.0:struct
        let s_6_5: u128 = fn_state.ga_99760._0;
        // C s_6_6: const #0s : i
        let s_6_6: i128 = 0;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#74476 <= s_8_0
        fn_state.gs_74476 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#74476:u8
        let s_9_0: bool = fn_state.gs_74476;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#74476 <= s_12_4
        fn_state.gs_74476 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
