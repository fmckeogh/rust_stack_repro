...
use common::*;
pub fn u__get_SCTLR_EL1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #64s : i
        let s_0_3: i128 = 64;
        // C s_0_4: const #17180000256u : u36
        let s_0_4: u64 = 17180000256;
        // C s_0_5: cast zx s_0_4 -> bv
        let s_0_5: Bits = Bits::new(s_0_4 as u128, 36u16);
        ...
        // D s_0_15: call Mk_SCTLR_EL1_Type(s_0_14)
        let s_0_15: ProductType5c790c8ef59cc8b2 = Mk_SCTLR_EL1_Type(
            state,
            tracer,
            s_0_14,
        );
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_13: call Mk_SCTLR_EL1_Type(s_5_12)
        let s_5_13: ProductType5c790c8ef59cc8b2 = Mk_SCTLR_EL1_Type(
            state,
            tracer,
            s_5_12,
        );
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_17: cast reint s_6_16 -> u64
        let s_6_17: u64 = (s_6_16.value() as u64);
        // D s_6_18: cast zx s_6_12 -> bv
        let s_6_18: Bits = Bits::new(s_6_12 as u128, 64u16);
        ...
        // D s_6_22: call Mk_SCTLR_EL1_Type(s_6_21)
        let s_6_22: ProductType5c790c8ef59cc8b2 = Mk_SCTLR_EL1_Type(
            state,
            tracer,
            s_6_21,
        );
