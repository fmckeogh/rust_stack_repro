...
use CurrentVL_read::*;
use HaveSME2p1::*;
use execute_MOVAZ_MZ4_ZA_B1::*;
use common::*;
pub fn decode_MOVAZ_MZ4_ZA_B1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    V: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        fn_state.d = s_1_32;
        // D s_1_34: read-var off2:u8
        let s_1_34: u8 = fn_state.off2;
        // D s_1_35: cast zx s_1_34 -> bv
        let s_1_35: Bits = Bits::new(s_1_34 as u128, 2u16);
        // C s_1_36: const #0u : u8
        let s_1_36: u8 = 0;
        // C s_1_37: cast zx s_1_36 -> bv
        ...
        // C s_1_40: cast reint s_1_37 -> u128
        ...
        let s_1_47: Bits = Bits::new(s_1_46 as u128, 4u16);
        // D s_1_48: cast zx s_1_47 -> i
        let s_1_48: i128 = (s_1_47.value() as i128);
        // D s_1_49: cast reint s_1_48 -> i64
        let s_1_49: i64 = (s_1_48 as i64);
        // D s_1_50: write-var offset <= s_1_49
        fn_state.offset = s_1_49;
        // D s_1_51: read-var V:u8
        let s_1_51: bool = fn_state.V;
        // D s_1_52: cast zx s_1_51 -> bv
        let s_1_52: Bits = Bits::new(s_1_51 as u128, 1u16);
        // C s_1_53: const #1u : u8
        let s_1_53: bool = true;
        // C s_1_54: cast zx s_1_53 -> bv
        let s_1_54: Bits = Bits::new(s_1_53 as u128, 1u16);
        // D s_1_55: cmp-eq s_1_52 s_1_54
        let s_1_55: bool = ((s_1_52) == (s_1_54));
        // D s_1_56: write-var vertical <= s_1_55
        fn_state.vertical = s_1_55;
        // D s_1_57: read-var VL:i64
        let s_1_57: i64 = fn_state.VL;
        // C s_1_58: const #128s : i
        let s_1_58: i128 = 128;
        // D s_1_59: cast zx s_1_57 -> i
        let s_1_59: i128 = (i128::try_from(s_1_57).unwrap());
        // D s_1_60: cmp-eq s_1_59 s_1_58
        let s_1_60: bool = ((s_1_59) == (s_1_58));
        // D s_1_61: not s_1_60
        let s_1_61: bool = !s_1_60;
        // N s_1_62: branch s_1_61 b3 b2
        if s_1_61 {
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_8: call execute_MOVAZ_MZ4_ZA_B1(s_2_0, s_2_1, s_2_2, s_2_3, s_2_4, s_2_5, s_2_6, s_2_7)
        let s_2_8: () = execute_MOVAZ_MZ4_ZA_B1(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_8: call execute_MOVAZ_MZ4_ZA_B1(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5, s_4_6, s_4_7)
        let s_4_8: () = execute_MOVAZ_MZ4_ZA_B1(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_8: call execute_MOVAZ_MZ4_ZA_B1(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5, s_6_6, s_6_7)
        let s_6_8: () = execute_MOVAZ_MZ4_ZA_B1(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_8: call execute_MOVAZ_MZ4_ZA_B1(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5, s_8_6, s_8_7)
        let s_8_8: () = execute_MOVAZ_MZ4_ZA_B1(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_8: call execute_MOVAZ_MZ4_ZA_B1(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5, s_10_6, s_10_7)
        let s_10_8: () = execute_MOVAZ_MZ4_ZA_B1(
            state,
            tracer,
            s_10_0,
            s_10_1,
