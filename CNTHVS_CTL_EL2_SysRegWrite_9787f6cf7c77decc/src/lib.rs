...
use common::*;
pub fn CNTHVS_CTL_EL2_SysRegWrite_9787f6cf7c77decc<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call Mk_CNTHVS_CTL_EL2_Type(s_6_3)
        let s_6_4: ProductType5c790c8ef59cc8b2 = Mk_CNTHVS_CTL_EL2_Type(
            state,
            tracer,
            s_6_3,
        );
        // D s_6_5: call __set_CNTHVS_CTL_EL2(s_6_4)
        let s_6_5: () = u__set_CNTHVS_CTL_EL2(state, tracer, s_6_4);
        // N s_6_6: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: call Mk_CNTHVS_CTL_EL2_Type(s_9_3)
        let s_9_4: ProductType5c790c8ef59cc8b2 = Mk_CNTHVS_CTL_EL2_Type(
            state,
            tracer,
            s_9_3,
        );
        // D s_9_5: call __set_CNTHVS_CTL_EL2(s_9_4)
        let s_9_5: () = u__set_CNTHVS_CTL_EL2(state, tracer, s_9_4);
        // N s_9_6: return
        return;
    }
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#81651 <= s_13_0
        fn_state.gs_81651 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#81651:u8
        let s_14_0: bool = fn_state.gs_81651;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_5: write-var gs#81651 <= s_17_4
        fn_state.gs_81651 = s_17_4;
        // N s_17_6: jump b14
        return block_14(state, tracer, fn_state);
    }
