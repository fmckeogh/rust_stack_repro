...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_unary_extract_nosat::*;
use common::*;
pub fn decode_xtn_advsimd_aarch64_instrs_vector_arithmetic_unary_extract_nosat<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, size: u8, Q: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_14: cast zx s_1_5 -> i
        let s_1_14: i128 = (i128::try_from(s_1_5).unwrap());
        ...
        // D s_1_20: call execute_aarch64_instrs_vector_arithmetic_unary_extract_nosat(s_1_18, s_1_16, s_1_17, s_1_15, s_1_19, s_1_9)
        let s_1_20: () = execute_aarch64_instrs_vector_arithmetic_unary_extract_nosat(
            state,
            tracer,
            s_1_18,
            s_1_16,
