...
use u_get_HCR_Type_TID1::*;
use HSTR_read::*;
use EL2Enabled::*;
use AArch32_TakeHypTrapException::*;
use common::*;
pub fn TCMTR_SysRegRead32_88195aa504d1c43a<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_13: call _get_HCR_EL2_Type_TID1(s_0_12)
        let s_0_13: bool = u_get_HCR_EL2_Type_TID1(state, tracer, s_0_12);
        // D s_0_14: write-var __HCR_EL2_TID1 <= s_0_13
        fn_state.u__HCR_EL2_TID1 = s_0_13;
        // C s_0_15: const #() : ()
        let s_0_15: () = ();
        // S s_0_16: call HCR_read(s_0_15)
        let s_0_16: ProductType700c18a878c5601b = HCR_read(state, tracer, s_0_15);
        // S s_0_17: call _get_HCR_Type_TID1(s_0_16)
        let s_0_17: bool = u_get_HCR_Type_TID1(state, tracer, s_0_16);
        // D s_0_18: write-var __HCR_TID1 <= s_0_17
        fn_state.u__HCR_TID1 = s_0_17;
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_1: const #17016u : u32
        let s_5_1: u32 = 17016;
        // D s_5_2: read-reg s_5_1:u32
        let s_5_2: u32 = {
            let value = state.read_register::<u32>(s_5_1 as isize);
            tracer.read_register(s_5_1 as isize, value);
            value
        };
        // D s_5_3: call R_set(s_5_0, s_5_2)
        let s_5_3: () = R_set(state, tracer, s_5_0, s_5_2);
        // N s_5_4: return
        return;
    }
    fn block_6<T: Tracer>(
        ...
        // C s_6_1: const #17016u : u32
        let s_6_1: u32 = 17016;
        // D s_6_2: read-reg s_6_1:u32
        let s_6_2: u32 = {
            let value = state.read_register::<u32>(s_6_1 as isize);
            tracer.read_register(s_6_1 as isize, value);
            value
        };
        // D s_6_3: call R_set(s_6_0, s_6_2)
        let s_6_3: () = R_set(state, tracer, s_6_0, s_6_2);
        // N s_6_4: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#117351 <= s_8_0
        fn_state.gs_117351 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#117351:u8
        let s_9_0: bool = fn_state.gs_117351;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#117352 <= s_10_0
        fn_state.gs_117352 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#117352:u8
        let s_11_0: bool = fn_state.gs_117352;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#117353 <= s_13_0
        fn_state.gs_117353 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#117353:u8
        let s_14_0: bool = fn_state.gs_117353;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#117354 <= s_15_0
        fn_state.gs_117354 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#117354:u8
        let s_16_0: bool = fn_state.gs_117354;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#117355 <= s_18_0
        fn_state.gs_117355 = s_18_0;
        // N s_18_2: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#117355:u8
        let s_19_0: bool = fn_state.gs_117355;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#117356 <= s_20_0
        fn_state.gs_117356 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#117356:u8
        let s_21_0: bool = fn_state.gs_117356;
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_1: write-var gs#117357 <= s_23_0
        fn_state.gs_117357 = s_23_0;
        // N s_23_2: jump b24
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_0: read-var gs#117357:u8
        let s_24_0: bool = fn_state.gs_117357;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#117358 <= s_25_0
        fn_state.gs_117358 = s_25_0;
        // N s_25_2: jump b26
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var gs#117358:u8
        let s_26_0: bool = fn_state.gs_117358;
    ...
    fn block_27<T: Tracer>(
        ...
        // C s_27_1: const #17016u : u32
        let s_27_1: u32 = 17016;
        // D s_27_2: read-reg s_27_1:u32
        let s_27_2: u32 = {
            let value = state.read_register::<u32>(s_27_1 as isize);
            tracer.read_register(s_27_1 as isize, value);
            value
        };
        // D s_27_3: call R_set(s_27_0, s_27_2)
        let s_27_3: () = R_set(state, tracer, s_27_0, s_27_2);
        // N s_27_4: return
        return;
    }
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_0: read-var __HCR_TID1:u8
        let s_29_0: bool = fn_state.u__HCR_TID1;
        ...
        // D s_29_5: write-var gs#117358 <= s_29_4
        fn_state.gs_117358 = s_29_4;
        // N s_29_6: jump b26
        return block_26(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_3: write-var gs#117357 <= s_30_2
        fn_state.gs_117357 = s_30_2;
        // N s_30_4: jump b24
        return block_24(state, tracer, fn_state);
    }
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_0: read-var __HCR_EL2_TID1:u8
        let s_32_0: bool = fn_state.u__HCR_EL2_TID1;
        ...
        // D s_32_5: write-var gs#117356 <= s_32_4
        fn_state.gs_117356 = s_32_4;
        // N s_32_6: jump b21
        return block_21(state, tracer, fn_state);
    }
    fn block_33<T: Tracer>(
        ...
        // D s_33_4: write-var gs#117355 <= s_33_3
        fn_state.gs_117355 = s_33_3;
        // N s_33_5: jump b19
        return block_19(state, tracer, fn_state);
    }
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_5: write-var gs#117354 <= s_35_4
        fn_state.gs_117354 = s_35_4;
        // N s_35_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_36<T: Tracer>(
        ...
        // D s_36_3: write-var gs#117353 <= s_36_2
        fn_state.gs_117353 = s_36_2;
        // N s_36_4: jump b14
        return block_14(state, tracer, fn_state);
    }
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_5: write-var gs#117352 <= s_38_4
        fn_state.gs_117352 = s_38_4;
        // N s_38_6: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_39<T: Tracer>(
        ...
        // D s_39_4: write-var gs#117351 <= s_39_3
        fn_state.gs_117351 = s_39_3;
        // N s_39_5: jump b9
        return block_9(state, tracer, fn_state);
    }
