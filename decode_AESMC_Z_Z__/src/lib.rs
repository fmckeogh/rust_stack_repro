...
use HaveSVE2AES::*;
use CurrentVL_read::*;
use execute_AESMC_Z_Z__::*;
use common::*;
pub fn decode_AESMC_Z_Z__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Zdn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_3: write-var gs#217926 <= s_1_2
        fn_state.gs_217926 = s_1_2;
        // N s_1_4: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#217926:u8
        let s_2_0: bool = fn_state.gs_217926;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: call execute_AESMC_Z_Z__(s_4_0, s_4_1)
        let s_4_2: () = execute_AESMC_Z_Z__(state, tracer, s_4_0, s_4_1);
        // N s_4_3: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call execute_AESMC_Z_Z__(s_6_0, s_6_1)
        let s_6_2: () = execute_AESMC_Z_Z__(state, tracer, s_6_0, s_6_1);
        // N s_6_3: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_2: call execute_AESMC_Z_Z__(s_8_0, s_8_1)
        let s_8_2: () = execute_AESMC_Z_Z__(state, tracer, s_8_0, s_8_1);
        // N s_8_3: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_2: call execute_AESMC_Z_Z__(s_10_0, s_10_1)
        let s_10_2: () = execute_AESMC_Z_Z__(state, tracer, s_10_0, s_10_1);
        // N s_10_3: return
        return;
    }
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_2: call execute_AESMC_Z_Z__(s_12_0, s_12_1)
        let s_12_2: () = execute_AESMC_Z_Z__(state, tracer, s_12_0, s_12_1);
        // N s_12_3: return
        return;
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#217926 <= s_15_0
        fn_state.gs_217926 = s_15_0;
        // N s_15_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
