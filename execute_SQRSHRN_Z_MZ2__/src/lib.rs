...
use Z_set::*;
use common::*;
pub fn execute_SQRSHRN_Z_MZ2__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#4335 <= s_0_2
        fn_state.VLshadow_4335 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#4335:i64
        let s_1_0: i64 = fn_state.VLshadow_4335;
        // D s_1_1: write-var VLshadow#4336 <= s_1_0
        fn_state.VLshadow_4336 = s_1_0;
        // C s_1_2: const #2s : i
        let s_1_2: i128 = 2;
        ...
        // D s_1_7: read-var VLshadow#4336:i64
        let s_1_7: i64 = fn_state.VLshadow_4336;
        ...
        // D s_1_17: write-var gs#219754 <= s_1_16
        fn_state.gs_219754 = s_1_16;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#219754:i64
        let s_2_1: i64 = fn_state.gs_219754;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_6: read-var VLshadow#4336:i64
        let s_5_6: i64 = fn_state.VLshadow_4336;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var VLshadow#4336:i64
        let s_7_0: i64 = fn_state.VLshadow_4336;
