...
use HaveSME::*;
use CurrentVL_read::*;
use execute_PTRUES_P_S__::*;
use common::*;
pub fn decode_PTRUES_P_S__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    S: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#197542 <= s_1_0
        fn_state.gs_197542 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#197542:u8
        let s_2_0: bool = fn_state.gs_197542;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_7: read-var Pd:u8
        let s_3_7: u8 = fn_state.Pd;
        ...
        fn_state.d = s_3_10;
        // D s_3_12: read-var pattern:u8
        let s_3_12: u8 = fn_state.pattern;
        // D s_3_13: write-var pat <= s_3_12
        fn_state.pat = s_3_12;
        // D s_3_14: read-var VL:i64
        let s_3_14: i64 = fn_state.VL;
        // C s_3_15: const #128s : i
        let s_3_15: i128 = 128;
        // D s_3_16: cast zx s_3_14 -> i
        let s_3_16: i128 = (i128::try_from(s_3_14).unwrap());
        // D s_3_17: cmp-eq s_3_16 s_3_15
        let s_3_17: bool = ((s_3_16) == (s_3_15));
        // D s_3_18: not s_3_17
        let s_3_18: bool = !s_3_17;
        // N s_3_19: branch s_3_18 b5 b4
        if s_3_18 {
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_3: read-var pat:u8
        let s_4_3: u8 = fn_state.pat;
        // C s_4_4: const #1u : u8
        let s_4_4: bool = true;
        // D s_4_5: call execute_PTRUES_P_S__(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4)
        let s_4_5: () = execute_PTRUES_P_S__(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: read-var pat:u8
        let s_6_3: u8 = fn_state.pat;
        // C s_6_4: const #1u : u8
        let s_6_4: bool = true;
        // D s_6_5: call execute_PTRUES_P_S__(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4)
        let s_6_5: () = execute_PTRUES_P_S__(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_3: read-var pat:u8
        let s_8_3: u8 = fn_state.pat;
        // C s_8_4: const #1u : u8
        let s_8_4: bool = true;
        // D s_8_5: call execute_PTRUES_P_S__(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4)
        let s_8_5: () = execute_PTRUES_P_S__(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_3: read-var pat:u8
        let s_10_3: u8 = fn_state.pat;
        // C s_10_4: const #1u : u8
        let s_10_4: bool = true;
        // D s_10_5: call execute_PTRUES_P_S__(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4)
        let s_10_5: () = execute_PTRUES_P_S__(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_3: read-var pat:u8
        let s_12_3: u8 = fn_state.pat;
        // C s_12_4: const #1u : u8
        let s_12_4: bool = true;
        // D s_12_5: call execute_PTRUES_P_S__(s_12_0, s_12_1, s_12_2, s_12_3, s_12_4)
        let s_12_5: () = execute_PTRUES_P_S__(
            state,
            tracer,
            s_12_0,
            s_12_1,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#197542 <= s_15_2
        fn_state.gs_197542 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
