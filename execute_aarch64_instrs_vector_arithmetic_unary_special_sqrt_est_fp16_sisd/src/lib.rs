...
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_unary_special_sqrt_est_fp16_sisd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    struct FunctionState {
        operand: Bits,
        esizeshadow_1465: i64,
        datasizeshadow_1466: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#1465 <= s_0_2
        fn_state.esizeshadow_1465 = s_0_2;
        ...
        // D s_0_7: write-var datasizeshadow#1466 <= s_0_6
        fn_state.datasizeshadow_1466 = s_0_6;
        // C s_0_8: const #1s : i
        let s_0_8: i128 = 1;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var datasizeshadow#1466:i64
        let s_2_0: i64 = fn_state.datasizeshadow_1466;
        ...
        // D s_2_6: write-var operand <= s_2_5
        fn_state.operand = s_2_5;
        // C s_2_7: const #() : ()
        let s_2_7: () = ();
        // S s_2_8: call FPCR_read(s_2_7)
        let s_2_8: ProductType5c790c8ef59cc8b2 = FPCR_read(state, tracer, s_2_7);
        // D s_2_9: write-var fpcr <= s_2_8
        fn_state.fpcr = s_2_8;
        // C s_2_10: const #1s : i
        let s_2_10: i128 = 1;
        // D s_2_11: read-var elements:i
        let s_2_11: i128 = fn_state.elements;
        // D s_2_12: cmp-eq s_2_11 s_2_10
        let s_2_12: bool = ((s_2_11) == (s_2_10));
        // N s_2_13: branch s_2_12 b12 b3
        if s_2_12 {
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#154786 <= s_3_0
        fn_state.gs_154786 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#154786:u8
        let s_4_0: bool = fn_state.gs_154786;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: write-var gs#154792 <= s_6_4
        fn_state.gs_154792 = s_6_4;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: read-var gs#154792:i64
        let s_7_1: i64 = fn_state.gs_154792;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var esizeshadow#1465:i64
        let s_8_0: i64 = fn_state.esizeshadow_1465;
        ...
        // D s_8_8: read-var esizeshadow#1465:i64
        let s_8_8: i64 = fn_state.esizeshadow_1465;
        // D s_8_9: cast zx s_8_8 -> i
        let s_8_9: i128 = (i128::try_from(s_8_8).unwrap());
        // D s_8_10: cast reint s_8_9 -> i64
        let s_8_10: i64 = (s_8_9 as i64);
        // D s_8_11: write-var ga#256635 <= s_8_10
        fn_state.ga_256635 = s_8_10;
        // D s_8_12: read-var fpcr:struct
        let s_8_12: ProductType5c790c8ef59cc8b2 = fn_state.fpcr;
        // D s_8_13: call FPRSqrtEstimate(s_8_7, s_8_12)
        let s_8_13: Bits = FPRSqrtEstimate(state, tracer, s_8_7, s_8_12);
        // D s_8_14: write-var ga#256636 <= s_8_13
        fn_state.ga_256636 = s_8_13;
        // N s_8_15: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: read-var ga#256635:i64
        let s_9_4: i64 = fn_state.ga_256635;
        // D s_9_5: cast zx s_9_4 -> i
        let s_9_5: i128 = (i128::try_from(s_9_4).unwrap());
        // D s_9_6: read-var ga#256636:bv
        let s_9_6: Bits = fn_state.ga_256636;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_2: write-var gs#154786 <= s_12_1
        fn_state.gs_154786 = s_12_1;
        // N s_12_3: jump b4
        return block_4(state, tracer, fn_state);
    }
