...
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_RFE_T2enc_AS_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    W: bool,
    Rn: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#323563 <= s_4_0
        fn_state.gs_323563 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#323563:u8
        let s_5_0: bool = fn_state.gs_323563;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_3: write-var gs#323563 <= s_8_2
        fn_state.gs_323563 = s_8_2;
        // N s_8_4: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
