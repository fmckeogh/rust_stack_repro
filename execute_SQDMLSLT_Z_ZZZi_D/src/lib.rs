...
use Z_set::*;
use common::*;
pub fn execute_SQDMLSLT_Z_ZZZi_D<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    da: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#3974 <= s_0_2
        fn_state.VLshadow_3974 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#3974:i64
        let s_1_0: i64 = fn_state.VLshadow_3974;
        // D s_1_1: write-var VLshadow#3975 <= s_1_0
        fn_state.VLshadow_3975 = s_1_0;
        // C s_1_2: const #2s : i
        let s_1_2: i128 = 2;
        ...
        // D s_1_7: read-var VLshadow#3975:i64
        let s_1_7: i64 = fn_state.VLshadow_3975;
        ...
        // D s_1_22: read-var VLshadow#3975:i64
        let s_1_22: i64 = fn_state.VLshadow_3975;
        ...
        // D s_1_30: read-var VLshadow#3975:i64
        let s_1_30: i64 = fn_state.VLshadow_3975;
        ...
        // D s_1_38: read-var VLshadow#3975:i64
        let s_1_38: i64 = fn_state.VLshadow_3975;
        ...
        // D s_1_51: write-var gs#213863 <= s_1_50
        fn_state.gs_213863 = s_1_50;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#213863:i64
        let s_2_1: i64 = fn_state.gs_213863;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_64: cast reint s_3_63 -> u64
        let s_3_64: u64 = (s_3_63.value() as u64);
        // D s_3_65: cast zx s_3_64 -> bv
        let s_3_65: Bits = Bits::new(s_3_64 as u128, 64u16);
        ...
        // D s_3_83: call SignedSat(s_3_74, s_3_82)
        let s_3_83: Bits = SignedSat(state, tracer, s_3_74, s_3_82);
        // D s_3_84: cast reint s_3_83 -> u64
        let s_3_84: u64 = (s_3_83.value() as u64);
        // D s_3_85: cast zx s_3_84 -> bv
        let s_3_85: Bits = Bits::new(s_3_84 as u128, 64u16);
        // D s_3_86: cast sx s_3_85 -> i
        let s_3_86: i128 = {
            let sign_bit = s_3_85.length() - 1;
            let mut result = s_3_85.value() as i128;
            if ((result >> sign_bit) & 1) == 1 {
                let cleared_bit = result & !(1 << sign_bit);
                result = cleared_bit - (1 << sign_bit);
            }
        ...
        // D s_3_87: cast reint s_3_86 -> i64
        let s_3_87: i64 = (s_3_86 as i64);
        // D s_3_88: cast zx s_3_67 -> i
        let s_3_88: i128 = (i128::try_from(s_3_67).unwrap());
        // D s_3_89: cast zx s_3_87 -> i
        let s_3_89: i128 = (i128::try_from(s_3_87).unwrap());
        // D s_3_90: sub s_3_88 s_3_89
        let s_3_90: i128 = ((s_3_88) - (s_3_89));
        // C s_3_91: const #2s : i
        let s_3_91: i128 = 2;
        // D s_3_92: read-var esize:i64
        let s_3_92: i64 = fn_state.esize;
        // D s_3_93: cast zx s_3_92 -> i
        let s_3_93: i128 = (i128::try_from(s_3_92).unwrap());
        // D s_3_94: mul s_3_91 s_3_93
        let s_3_94: i128 = ((s_3_91) * (s_3_93));
        // D s_3_95: cast reint s_3_94 -> i64
        let s_3_95: i64 = (s_3_94 as i64);
        ...
        // C s_3_98: const #2s : i
        let s_3_98: i128 = 2;
        // D s_3_99: read-var esize:i64
        let s_3_99: i64 = fn_state.esize;
        // D s_3_100: cast zx s_3_99 -> i
        let s_3_100: i128 = (i128::try_from(s_3_99).unwrap());
        // D s_3_101: mul s_3_98 s_3_100
        let s_3_101: i128 = ((s_3_98) * (s_3_100));
        ...
        // D s_3_104: cast reint s_3_103 -> i64
        let s_3_104: i64 = (s_3_103 as i64);
        // D s_3_105: cast zx s_3_104 -> i
        let s_3_105: i128 = (i128::try_from(s_3_104).unwrap());
        // D s_3_106: call SignedSat(s_3_90, s_3_105)
        let s_3_106: Bits = SignedSat(state, tracer, s_3_90, s_3_105);
        // D s_3_107: cast reint s_3_106 -> u64
        let s_3_107: u64 = (s_3_106.value() as u64);
        // D s_3_108: read-var e:i64
        let s_3_108: i64 = fn_state.e;
        // D s_3_109: cast zx s_3_108 -> i
        let s_3_109: i128 = (i128::try_from(s_3_108).unwrap());
        // D s_3_110: cast zx s_3_97 -> i
        let s_3_110: i128 = (i128::try_from(s_3_97).unwrap());
        // D s_3_111: cast zx s_3_107 -> bv
        let s_3_111: Bits = Bits::new(s_3_107 as u128, 64u16);
        // D s_3_112: read-var result:bv
        let s_3_112: Bits = fn_state.result;
        // D s_3_113: call Elem_set(s_3_112, s_3_109, s_3_110, s_3_111)
        let s_3_113: Bits = Elem_set(state, tracer, s_3_112, s_3_109, s_3_110, s_3_111);
        // D s_3_114: write-var result <= s_3_113
        fn_state.result = s_3_113;
        // D s_3_115: read-var e:i64
        let s_3_115: i64 = fn_state.e;
        // C s_3_116: const #1s : i64
        let s_3_116: i64 = 1;
        // D s_3_117: add s_3_115 s_3_116
        let s_3_117: i64 = (s_3_115 + s_3_116);
        // D s_3_118: write-var e <= s_3_117
        fn_state.e = s_3_117;
        // N s_3_119: jump b2
        return block_2(state, tracer, fn_state);
    }
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#3975:i64
        let s_4_0: i64 = fn_state.VLshadow_3975;
