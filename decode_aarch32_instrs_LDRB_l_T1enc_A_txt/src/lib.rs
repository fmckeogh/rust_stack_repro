...
use common::*;
pub fn decode_aarch32_instrs_LDRB_l_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    U: bool,
    Rt: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_18: call execute_aarch32_instrs_LDRB_l_Op_A_txt(s_3_17, s_3_12, s_3_3)
        let s_3_18: () = execute_aarch32_instrs_LDRB_l_Op_A_txt(
            state,
            tracer,
            s_3_17,
            s_3_12,
