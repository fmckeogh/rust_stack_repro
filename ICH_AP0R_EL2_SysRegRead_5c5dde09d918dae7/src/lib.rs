...
use u__get_ICH_AP0R_EL2::*;
use u_get_HCR_EL2_Type_NV2::*;
use common::*;
pub fn ICH_AP0R_EL2_SysRegRead_5c5dde09d918dae7<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ...
        ga_68022: u64,
        gs_62379: bool,
        ga_68038: ProductType5c790c8ef59cc8b2,
        ga_68031: ProductType5c790c8ef59cc8b2,
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_1: const #0s : i
        let s_8_1: i128 = 0;
        // C s_8_2: const #14832u : u32
        let s_8_2: u32 = 14832;
        // D s_8_3: read-reg s_8_2:[struct; 4]
        let s_8_3: [ProductType5c790c8ef59cc8b2; 4usize] = {
            let value = state
                .read_register::<[ProductType5c790c8ef59cc8b2; 4usize]>(s_8_2 as isize);
            tracer.read_register(s_8_2 as isize, value);
            value
        };
        // D s_8_4: read-element s_8_3[s_8_1]
        let s_8_4: ProductType5c790c8ef59cc8b2 = s_8_3[(s_8_1) as usize];
        // D s_8_5: call __get_ICH_AP0R_EL2(s_8_4)
        let s_8_5: ProductType5c790c8ef59cc8b2 = u__get_ICH_AP0R_EL2(
            state,
            tracer,
            s_8_4,
        );
        // D s_8_6: write-var ga#68038 <= s_8_5
        fn_state.ga_68038 = s_8_5;
        // D s_8_7: read-var ga#68038.0:struct
        let s_8_7: u64 = fn_state.ga_68038._0;
        // D s_8_8: cast zx s_8_7 -> bv
        let s_8_8: Bits = Bits::new(s_8_7 as u128, 64u16);
        // D s_8_9: read-var t:i
        let s_8_9: i128 = fn_state.t;
        // D s_8_10: call X_set(s_8_9, s_8_0, s_8_8)
        let s_8_10: () = X_set(state, tracer, s_8_9, s_8_0, s_8_8);
        // N s_8_11: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_11<T: Tracer>(
        ...
        // C s_11_1: const #0s : i
        let s_11_1: i128 = 0;
        // C s_11_2: const #14832u : u32
        let s_11_2: u32 = 14832;
        // D s_11_3: read-reg s_11_2:[struct; 4]
        let s_11_3: [ProductType5c790c8ef59cc8b2; 4usize] = {
            let value = state
                .read_register::<[ProductType5c790c8ef59cc8b2; 4usize]>(s_11_2 as isize);
            tracer.read_register(s_11_2 as isize, value);
            value
        };
        // D s_11_4: read-element s_11_3[s_11_1]
        let s_11_4: ProductType5c790c8ef59cc8b2 = s_11_3[(s_11_1) as usize];
        // D s_11_5: call __get_ICH_AP0R_EL2(s_11_4)
        let s_11_5: ProductType5c790c8ef59cc8b2 = u__get_ICH_AP0R_EL2(
            state,
            tracer,
            s_11_4,
        );
        // D s_11_6: write-var ga#68031 <= s_11_5
        fn_state.ga_68031 = s_11_5;
        // D s_11_7: read-var ga#68031.0:struct
        let s_11_7: u64 = fn_state.ga_68031._0;
        // D s_11_8: cast zx s_11_7 -> bv
        let s_11_8: Bits = Bits::new(s_11_7 as u128, 64u16);
        // D s_11_9: read-var t:i
        let s_11_9: i128 = fn_state.t;
        // D s_11_10: call X_set(s_11_9, s_11_0, s_11_8)
        let s_11_10: () = X_set(state, tracer, s_11_9, s_11_0, s_11_8);
        // N s_11_11: return
        return;
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#62379 <= s_14_0
        fn_state.gs_62379 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#62379:u8
        let s_15_0: bool = fn_state.gs_62379;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#62380 <= s_17_0
        fn_state.gs_62380 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#62380:u8
        let s_18_0: bool = fn_state.gs_62380;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_5: write-var gs#62380 <= s_21_4
        fn_state.gs_62380 = s_21_4;
        // N s_21_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        // S s_22_10: call NVMem_read(s_22_9)
        let s_22_10: u64 = NVMem_read(state, tracer, s_22_9);
        // D s_22_11: write-var ga#68022 <= s_22_10
        fn_state.ga_68022 = s_22_10;
        // N s_22_12: jump b23
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_0: read-var ga#68022:u64
        let s_23_0: u64 = fn_state.ga_68022;
        // D s_23_1: cast zx s_23_0 -> bv
        let s_23_1: Bits = Bits::new(s_23_0 as u128, 64u16);
        // D s_23_2: read-var t:i
        let s_23_2: i128 = fn_state.t;
        // C s_23_3: const #64s : i64
        let s_23_3: i64 = 64;
        // D s_23_4: call X_set(s_23_2, s_23_3, s_23_1)
        let s_23_4: () = X_set(state, tracer, s_23_2, s_23_3, s_23_1);
        // N s_23_5: return
        return;
    }
    fn block_24<T: Tracer>(
        ...
        // D s_24_5: call _get_HCR_EL2_Type_NV(s_24_4)
        let s_24_5: bool = u_get_HCR_EL2_Type_NV(state, tracer, s_24_4);
        // D s_24_6: cast zx s_24_2 -> bv
        let s_24_6: Bits = Bits::new(s_24_2 as u128, 1u16);
        // D s_24_7: cast zx s_24_5 -> bv
        let s_24_7: Bits = Bits::new(s_24_5 as u128, 1u16);
        // D s_24_8: cast reint s_24_6 -> u128
        let s_24_8: u128 = (s_24_6.value() as u128);
        // D s_24_9: size-of s_24_6
        let s_24_9: u16 = s_24_6.length();
        // D s_24_10: cast reint s_24_7 -> u128
        let s_24_10: u128 = (s_24_7.value() as u128);
        // D s_24_11: size-of s_24_7
        let s_24_11: u16 = s_24_7.length();
        // D s_24_12: lsl s_24_8 s_24_11
        let s_24_12: u128 = s_24_8 << s_24_11;
        // D s_24_13: or s_24_12 s_24_10
        let s_24_13: u128 = ((s_24_12) | (s_24_10));
        // D s_24_14: add s_24_9 s_24_11
        let s_24_14: u16 = (s_24_9 + s_24_11);
        // D s_24_15: create-bits s_24_13 s_24_14
        let s_24_15: Bits = Bits::new(s_24_13, s_24_14);
        // D s_24_16: cast reint s_24_15 -> u8
        let s_24_16: u8 = (s_24_15.value() as u8);
        // D s_24_17: cast zx s_24_16 -> bv
        let s_24_17: Bits = Bits::new(s_24_16 as u128, 2u16);
        // C s_24_18: const #3u : u8
        let s_24_18: u8 = 3;
        // C s_24_19: cast zx s_24_18 -> bv
        let s_24_19: Bits = Bits::new(s_24_18 as u128, 2u16);
        // D s_24_20: cmp-eq s_24_17 s_24_19
        let s_24_20: bool = ((s_24_17) == (s_24_19));
        // D s_24_21: write-var gs#62379 <= s_24_20
        fn_state.gs_62379 = s_24_20;
        // N s_24_22: jump b15
        return block_15(state, tracer, fn_state);
    }
