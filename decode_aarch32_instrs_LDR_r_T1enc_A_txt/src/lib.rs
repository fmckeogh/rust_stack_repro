...
use common::*;
pub fn decode_aarch32_instrs_LDR_r_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rm: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_12: const #0s : i
        let s_2_12: i128 = 0;
        // C s_2_13: const #0u : u32
        let s_2_13: u32 = 0;
        // D s_2_14: create-product struct = ["s_2_13", "s_2_12"]
        let s_2_14: ProductType396b95aa74979079 = ProductType396b95aa74979079 {
            _0: s_2_13,
            _1: s_2_12,
        };
        // D s_2_15: extract-field s_2_14.0
        let s_2_15: u32 = s_2_14._0;
        // C s_2_16: const #0u : u32
        let s_2_16: u32 = 0;
        // D s_2_17: create-product struct = ["s_2_16", "s_2_12"]
        let s_2_17: ProductType396b95aa74979079 = ProductType396b95aa74979079 {
            _0: s_2_16,
            _1: s_2_12,
        };
        // D s_2_18: extract-field s_2_17.1
        let s_2_18: i128 = s_2_17._1;
        ...
        // D s_2_21: call execute_aarch32_instrs_LDR_r_OpT_A_txt(s_2_11, s_2_7, s_2_20, s_2_15, s_2_3)
        let s_2_21: () = execute_aarch32_instrs_LDR_r_OpT_A_txt(
            state,
            tracer,
            s_2_11,
            s_2_7,
