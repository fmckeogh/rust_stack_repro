...
use common::*;
pub fn decode_sqdmulh_advsimd_vec_aarch64_instrs_vector_arithmetic_binary_uniform_mul_int_doubling_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, Rm: u8, size: u8, U: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_5: write-var gs#170783 <= s_1_4
        fn_state.gs_170783 = s_1_4;
        // N s_1_6: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#170783:u8
        let s_2_0: bool = fn_state.gs_170783;
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_0: const #1u : u8
        let s_5_0: bool = true;
        // D s_5_1: write-var gs#170783 <= s_5_0
        fn_state.gs_170783 = s_5_0;
        // N s_5_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
