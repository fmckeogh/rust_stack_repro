...
use common::*;
pub fn CONTEXTIDR_EL2_SysRegRead_dc0e6b987e373678<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_57141: ProductType5c790c8ef59cc8b2,
        ga_57137: ProductType5c790c8ef59cc8b2,
        u__PSTATE_EL: u8,
        u__HCR_EL2_NV: bool,
        gs_58190: bool,
        el: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call __get_CONTEXTIDR_EL2(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_CONTEXTIDR_EL2(
            state,
            tracer,
            s_5_2,
        );
        // D s_5_4: write-var ga#57141 <= s_5_3
        fn_state.ga_57141 = s_5_3;
        // D s_5_5: read-var ga#57141.0:struct
        let s_5_5: u64 = fn_state.ga_57141._0;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_CONTEXTIDR_EL2(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_CONTEXTIDR_EL2(
            state,
            tracer,
            s_6_2,
        );
        // D s_6_4: write-var ga#57137 <= s_6_3
        fn_state.ga_57137 = s_6_3;
        // D s_6_5: read-var ga#57137.0:struct
        let s_6_5: u64 = fn_state.ga_57137._0;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#58190 <= s_8_0
        fn_state.gs_58190 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#58190:u8
        let s_9_0: bool = fn_state.gs_58190;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#58190 <= s_12_4
        fn_state.gs_58190 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
