...
extern crate alloc;
use CurrentVL_read::*;
use execute_NMATCH_P_P_ZZ__::*;
use HaveSVE2::*;
use common::*;
pub fn decode_NMATCH_P_P_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Zm: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_2: Bits = Bits::new(s_1_0 as u128, 2u16);
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_0: const #1u : u8
        let s_2_0: bool = true;
        // D s_2_1: write-var gs#216041 <= s_2_0
        fn_state.gs_216041 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#216041:u8
        let s_3_0: bool = fn_state.gs_216041;
    ...
    fn block_4<T: Tracer>(
        ...
        fn_state.g = s_4_10;
        // D s_4_12: read-var Pd:u8
        let s_4_12: u8 = fn_state.Pd;
        ...
        fn_state.d = s_4_15;
        // D s_4_17: read-var Zn:u8
        let s_4_17: u8 = fn_state.Zn;
        ...
        // D s_4_21: write-var n <= s_4_20
        fn_state.n = s_4_20;
        // D s_4_22: read-var Zm:u8
        let s_4_22: u8 = fn_state.Zm;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_8: call execute_NMATCH_P_P_ZZ__(s_5_0, s_5_4, s_5_3, s_5_5, s_5_6, s_5_7)
        let s_5_8: () = execute_NMATCH_P_P_ZZ__(
            state,
            tracer,
            s_5_0,
            s_5_4,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_8: call execute_NMATCH_P_P_ZZ__(s_7_0, s_7_4, s_7_3, s_7_5, s_7_6, s_7_7)
        let s_7_8: () = execute_NMATCH_P_P_ZZ__(
            state,
            tracer,
            s_7_0,
            s_7_4,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_8: call execute_NMATCH_P_P_ZZ__(s_9_0, s_9_4, s_9_3, s_9_5, s_9_6, s_9_7)
        let s_9_8: () = execute_NMATCH_P_P_ZZ__(
            state,
            tracer,
            s_9_0,
            s_9_4,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_8: call execute_NMATCH_P_P_ZZ__(s_11_0, s_11_4, s_11_3, s_11_5, s_11_6, s_11_7)
        let s_11_8: () = execute_NMATCH_P_P_ZZ__(
            state,
            tracer,
            s_11_0,
            s_11_4,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_8: call execute_NMATCH_P_P_ZZ__(s_13_0, s_13_4, s_13_3, s_13_5, s_13_6, s_13_7)
        let s_13_8: () = execute_NMATCH_P_P_ZZ__(
            state,
            tracer,
            s_13_0,
            s_13_4,
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#216041 <= s_16_0
        fn_state.gs_216041 = s_16_0;
        // N s_16_2: jump b3
        return block_3(state, tracer, fn_state);
    }
