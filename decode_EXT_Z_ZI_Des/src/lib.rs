...
use HaveSVE::*;
use CurrentVL_read::*;
use execute_EXT_Z_ZI_Des::*;
use HaveSME::*;
use common::*;
pub fn decode_EXT_Z_ZI_Des<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm8h: u8,
    imm8l: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#196461 <= s_1_0
        fn_state.gs_196461 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#196461:u8
        let s_2_0: bool = fn_state.gs_196461;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var Zdn:u8
        let s_3_0: u8 = fn_state.Zdn;
        ...
        fn_state.dst = s_3_3;
        // D s_3_5: read-var dst:i64
        let s_3_5: i64 = fn_state.dst;
        // D s_3_6: write-var s1 <= s_3_5
        fn_state.s1 = s_3_5;
        // D s_3_7: read-var Zm:u8
        let s_3_7: u8 = fn_state.Zm;
        ...
        // D s_3_11: write-var s2 <= s_3_10
        fn_state.s2 = s_3_10;
        // D s_3_12: read-var imm8h:u8
        let s_3_12: u8 = fn_state.imm8h;
        // D s_3_13: cast zx s_3_12 -> bv
        let s_3_13: Bits = Bits::new(s_3_12 as u128, 5u16);
        // D s_3_14: read-var imm8l:u8
        let s_3_14: u8 = fn_state.imm8l;
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 128;
        // D s_4_1: read-var dst:i64
        let s_4_1: i64 = fn_state.dst;
        // C s_4_2: const #8s : i64
        let s_4_2: i64 = 8;
        // D s_4_3: read-var position:i64
        let s_4_3: i64 = fn_state.position;
        // D s_4_4: read-var s1:i64
        let s_4_4: i64 = fn_state.s1;
        // D s_4_5: read-var s2:i64
        let s_4_5: i64 = fn_state.s2;
        // D s_4_6: call execute_EXT_Z_ZI_Des(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5)
        let s_4_6: () = execute_EXT_Z_ZI_Des(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 256;
        // D s_6_1: read-var dst:i64
        let s_6_1: i64 = fn_state.dst;
        // C s_6_2: const #8s : i64
        let s_6_2: i64 = 8;
        // D s_6_3: read-var position:i64
        let s_6_3: i64 = fn_state.position;
        // D s_6_4: read-var s1:i64
        let s_6_4: i64 = fn_state.s1;
        // D s_6_5: read-var s2:i64
        let s_6_5: i64 = fn_state.s2;
        // D s_6_6: call execute_EXT_Z_ZI_Des(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5)
        let s_6_6: () = execute_EXT_Z_ZI_Des(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 512;
        // D s_8_1: read-var dst:i64
        let s_8_1: i64 = fn_state.dst;
        // C s_8_2: const #8s : i64
        let s_8_2: i64 = 8;
        // D s_8_3: read-var position:i64
        let s_8_3: i64 = fn_state.position;
        // D s_8_4: read-var s1:i64
        let s_8_4: i64 = fn_state.s1;
        // D s_8_5: read-var s2:i64
        let s_8_5: i64 = fn_state.s2;
        // D s_8_6: call execute_EXT_Z_ZI_Des(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5)
        let s_8_6: () = execute_EXT_Z_ZI_Des(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 1024;
        // D s_10_1: read-var dst:i64
        let s_10_1: i64 = fn_state.dst;
        // C s_10_2: const #8s : i64
        let s_10_2: i64 = 8;
        // D s_10_3: read-var position:i64
        let s_10_3: i64 = fn_state.position;
        // D s_10_4: read-var s1:i64
        let s_10_4: i64 = fn_state.s1;
        // D s_10_5: read-var s2:i64
        let s_10_5: i64 = fn_state.s2;
        // D s_10_6: call execute_EXT_Z_ZI_Des(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5)
        let s_10_6: () = execute_EXT_Z_ZI_Des(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        let s_12_0: i64 = 2048;
        // D s_12_1: read-var dst:i64
        let s_12_1: i64 = fn_state.dst;
        // C s_12_2: const #8s : i64
        let s_12_2: i64 = 8;
        // D s_12_3: read-var position:i64
        let s_12_3: i64 = fn_state.position;
        // D s_12_4: read-var s1:i64
        let s_12_4: i64 = fn_state.s1;
        // D s_12_5: read-var s2:i64
        let s_12_5: i64 = fn_state.s2;
        // D s_12_6: call execute_EXT_Z_ZI_Des(s_12_0, s_12_1, s_12_2, s_12_3, s_12_4, s_12_5)
        let s_12_6: () = execute_EXT_Z_ZI_Des(
            state,
            tracer,
            s_12_0,
            s_12_1,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#196461 <= s_15_2
        fn_state.gs_196461 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
