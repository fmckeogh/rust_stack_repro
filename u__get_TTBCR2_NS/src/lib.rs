...
use Mk_TTBCR2_Type::*;
use common::*;
pub fn u__get_TTBCR2_NS<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #3221225480u : u32
        let s_0_3: u32 = 3221225480;
        ...
        // D s_0_11: tail-call Mk_TTBCR2_Type(s_0_10)
        return Mk_TTBCR2_Type(state, tracer, s_0_10);
    }
}
