...
use place_slice::*;
use common::*;
pub fn decode_subs_addsub_imm_aarch64_instrs_integer_arithmetic_add_sub_immediate<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 32;
        // D s_1_1: write-var ga#249164 <= s_1_0
        fn_state.ga_249164 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#249164:i64
        let s_2_0: i64 = fn_state.ga_249164;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 64;
        // D s_6_1: write-var ga#249164 <= s_6_0
        fn_state.ga_249164 = s_6_0;
        // N s_6_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
