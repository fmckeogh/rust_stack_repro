...
use common::*;
pub fn decode_aarch32_instrs_SXTB16_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    Rd: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#303542 <= s_3_3
        fn_state.gs_303542 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#303542:u8
        let s_4_0: bool = fn_state.gs_303542;
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #1u : u8
        let s_7_0: bool = true;
        // D s_7_1: write-var gs#303542 <= s_7_0
        fn_state.gs_303542 = s_7_0;
        // N s_7_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
