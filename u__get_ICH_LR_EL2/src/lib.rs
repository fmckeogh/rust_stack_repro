...
use common::*;
pub fn u__get_ICH_LR_EL2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #64s : i
        let s_0_3: i128 = 64;
        // C s_0_4: const #504649448870117376u : u60
        let s_0_4: u64 = 504649448870117376;
        ...
        // D s_0_15: tail-call Mk_ICH_LR_EL2_Type(s_0_14)
        return Mk_ICH_LR_EL2_Type(state, tracer, s_0_14);
    }
}
