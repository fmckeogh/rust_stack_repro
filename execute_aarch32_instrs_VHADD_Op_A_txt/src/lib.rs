...
use common::*;
pub fn execute_aarch32_instrs_VHADD_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    add: bool,
    d__arg: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#7480 <= s_0_2
        fn_state.esizeshadow_7480 = s_0_2;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_6: write-var gs#309154 <= s_1_5
        fn_state.gs_309154 = s_1_5;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#309154:i64
        let s_2_1: i64 = fn_state.gs_309154;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_5: write-var gs#309160 <= s_3_4
        fn_state.gs_309160 = s_3_4;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#309160:i64
        let s_4_1: i64 = fn_state.gs_309160;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_8: read-var esizeshadow#7480:i64
        let s_5_8: i64 = fn_state.esizeshadow_7480;
        ...
        // D s_5_27: read-var esizeshadow#7480:i64
        let s_5_27: i64 = fn_state.esizeshadow_7480;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_9: read-var esizeshadow#7480:i64
        let s_7_9: i64 = fn_state.esizeshadow_7480;
        ...
        // C s_7_12: const #1s : i
        let s_7_12: i128 = 1;
        // D s_7_13: read-var esizeshadow#7480:i64
        let s_7_13: i64 = fn_state.esizeshadow_7480;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_5: write-var result <= s_8_4
        fn_state.result = s_8_4;
        // N s_8_6: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
