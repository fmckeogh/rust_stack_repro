...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_VCLS_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_VCLS_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    size: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#307504 <= s_4_0
        fn_state.gs_307504 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#307504:u8
        let s_5_0: bool = fn_state.gs_307504;
    ...
    fn block_7<T: Tracer>(
        ...
        let s_7_0: i64 = 2;
        // D s_7_1: write-var ga#351952 <= s_7_0
        fn_state.ga_351952 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var ga#351952:i64
        let s_8_0: i64 = fn_state.ga_351952;
        ...
        // D s_8_8: call execute_aarch32_instrs_VCLS_Op_A_txt(s_8_6, s_8_5, s_8_3, s_8_7, s_8_0)
        let s_8_8: () = execute_aarch32_instrs_VCLS_Op_A_txt(
            state,
            tracer,
            s_8_6,
            s_8_5,
    ...
    fn block_9<T: Tracer>(
        ...
        let s_9_0: i64 = 1;
        // D s_9_1: write-var ga#351952 <= s_9_0
        fn_state.ga_351952 = s_9_0;
        // N s_9_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_22: write-var gs#307503 <= s_12_21
        fn_state.gs_307503 = s_12_21;
        // N s_12_23: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#307503:u8
        let s_13_0: bool = fn_state.gs_307503;
        // D s_13_1: write-var gs#307504 <= s_13_0
        fn_state.gs_307504 = s_13_0;
        // N s_13_2: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#307503 <= s_14_0
        fn_state.gs_307503 = s_14_0;
        // N s_14_2: jump b13
        return block_13(state, tracer, fn_state);
    }
