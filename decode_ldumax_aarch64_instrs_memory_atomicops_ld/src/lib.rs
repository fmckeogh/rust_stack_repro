...
use common::*;
pub fn decode_ldumax_aarch64_instrs_memory_atomicops_ld<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 32;
        // D s_2_1: write-var ga#258630 <= s_2_0
        fn_state.ga_258630 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#258630:i64
        let s_3_0: i64 = fn_state.ga_258630;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#158207 <= s_4_0
        fn_state.gs_158207 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#158207:u8
        let s_5_0: bool = fn_state.gs_158207;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_5: write-var gs#158207 <= s_21_4
        fn_state.gs_158207 = s_21_4;
        // N s_21_6: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        let s_22_0: i64 = 64;
        // D s_22_1: write-var ga#258630 <= s_22_0
        fn_state.ga_258630 = s_22_0;
        // N s_22_2: jump b3
        return block_3(state, tracer, fn_state);
    }
