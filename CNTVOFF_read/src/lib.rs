...
extern crate alloc;
use common::*;
pub fn CNTVOFF_read<T: Tracer>(state: &mut State, tracer: &T, gs_33671: ()) -> u64 {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        let s_0_10: Bits = Bits::new(s_0_1 as u128, 64u16);
        // D s_0_11: cast zx s_0_8 -> bv
        let s_0_11: Bits = Bits::new(s_0_8 as u128, 64u16);
