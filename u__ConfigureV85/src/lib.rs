...
use u__ConfigureV84::*;
use common::*;
pub fn u__ConfigureV85<T: Tracer>(state: &mut State, tracer: &T, enabled: bool) -> () {
    #[derive(Default)]
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: call __ConfigureV84(s_2_0)
        let s_2_1: () = u__ConfigureV84(state, tracer, s_2_0);
        // N s_2_2: return
        return;
    }
}
