...
extern crate alloc;
use AArch64_AutoGen_SysInstrWithResult::*;
use integer_subrange::*;
use common::*;
pub fn AArch64_SysInstrWithResult<T: Tracer>(
    state: &mut State,
    tracer: &T,
    op0: i128,
    op1: i128,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_28: call AArch64_AutoGen_SysInstrWithResult(s_0_1, s_0_6, s_0_11, s_0_16, s_0_21, s_0_26, s_0_27)
        let s_0_28: () = AArch64_AutoGen_SysInstrWithResult(
            state,
            tracer,
            s_0_1,
            s_0_6,
