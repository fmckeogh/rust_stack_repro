...
use common::*;
pub fn decode_movn_aarch64_instrs_integer_ins_ext_insert_movewide<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    imm16: u16,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 32;
        // D s_1_1: write-var ga#263483 <= s_1_0
        fn_state.ga_263483 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#263483:i64
        let s_2_0: i64 = fn_state.ga_263483;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var opcodeshadow#1764 <= s_4_0
        fn_state.opcodeshadow_1764 = s_4_0;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#165189 <= s_5_0
        fn_state.gs_165189 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#165189:u8
        let s_6_0: bool = fn_state.gs_165189;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_21: read-var opcodeshadow#1764:u32
        let s_7_21: u32 = fn_state.opcodeshadow_1764;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_22: write-var gs#165189 <= s_9_21
        fn_state.gs_165189 = s_9_21;
        // N s_9_23: jump b6
        return block_6(state, tracer, fn_state);
    }
    ...
    fn block_15<T: Tracer>(
        ...
        let s_15_0: i64 = 64;
        // D s_15_1: write-var ga#263483 <= s_15_0
        fn_state.ga_263483 = s_15_0;
        // N s_15_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
