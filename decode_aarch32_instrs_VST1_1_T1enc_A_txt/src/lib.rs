...
use ConditionPassed::*;
use common::*;
pub fn decode_aarch32_instrs_VST1_1_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Rn: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#320086 <= s_5_0
        fn_state.gs_320086 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#320086:u8
        let s_6_0: bool = fn_state.gs_320086;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_8: call execute_aarch32_instrs_VST1_1_Op_A_txt(s_7_0, s_7_1, s_7_2, s_7_3, s_7_4, s_7_5, s_7_6, s_7_7)
        let s_7_8: () = execute_aarch32_instrs_VST1_1_Op_A_txt(
            state,
            tracer,
            s_7_0,
            s_7_1,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: write-var gs#320086 <= s_9_3
        fn_state.gs_320086 = s_9_3;
        // N s_9_5: jump b6
        return block_6(state, tracer, fn_state);
    }
