...
use common::*;
pub fn ICH_VMCR_EL2_SysRegRead_7485c707cb4a586a<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ...
        gs_62616: bool,
        ga_68857: ProductType5c790c8ef59cc8b2,
        u__ICC_SRE_EL3_SRE: bool,
        u__PSTATE_EL: u8,
        u__HCR_EL2_NV: bool,
        ga_68843: u64,
        gs_62615: bool,
        ga_68851: ProductType5c790c8ef59cc8b2,
        el: u8,
        op0: u8,
        op1: u8,
        CRn: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_ICH_VMCR_EL2(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_ICH_VMCR_EL2(
            state,
            tracer,
            s_6_2,
        );
        // D s_6_4: write-var ga#68857 <= s_6_3
        fn_state.ga_68857 = s_6_3;
        // D s_6_5: read-var ga#68857.0:struct
        let s_6_5: u64 = fn_state.ga_68857._0;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_3: call __get_ICH_VMCR_EL2(s_9_2)
        let s_9_3: ProductType5c790c8ef59cc8b2 = u__get_ICH_VMCR_EL2(
            state,
            tracer,
            s_9_2,
        );
        // D s_9_4: write-var ga#68851 <= s_9_3
        fn_state.ga_68851 = s_9_3;
        // D s_9_5: read-var ga#68851.0:struct
        let s_9_5: u64 = fn_state.ga_68851._0;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#62615 <= s_12_0
        fn_state.gs_62615 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#62615:u8
        let s_13_0: bool = fn_state.gs_62615;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#62616 <= s_15_0
        fn_state.gs_62616 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#62616:u8
        let s_16_0: bool = fn_state.gs_62616;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_5: write-var gs#62616 <= s_19_4
        fn_state.gs_62616 = s_19_4;
        // N s_19_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // S s_20_5: call NVMem_read(s_20_4)
        let s_20_5: u64 = NVMem_read(state, tracer, s_20_4);
        // D s_20_6: write-var ga#68843 <= s_20_5
        fn_state.ga_68843 = s_20_5;
        // N s_20_7: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var ga#68843:u64
        let s_21_0: u64 = fn_state.ga_68843;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_21: write-var gs#62615 <= s_22_20
        fn_state.gs_62615 = s_22_20;
        // N s_22_22: jump b13
        return block_13(state, tracer, fn_state);
    }
