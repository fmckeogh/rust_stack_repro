...
use ConditionPassed::*;
use DecodeImmShift::*;
use execute_aarch32_instrs_TST_r_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_TST_r_T2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    imm3: u8,
    ...
    struct FunctionState {
        m: i64,
        shift_nshadow_7322: i128,
        gs_303788: bool,
        shift_t: u32,
        ga_348779: ProductType396b95aa74979079,
        n: i64,
        Rn: u8,
        imm3: u8,
        imm2: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_25: write-var ga#348779 <= s_2_24
        fn_state.ga_348779 = s_2_24;
        // D s_2_26: read-var ga#348779.0:struct
        let s_2_26: u32 = fn_state.ga_348779._0;
        // D s_2_27: read-var ga#348779.1:struct
        let s_2_27: i128 = fn_state.ga_348779._1;
        // D s_2_28: write-var shift_t <= s_2_26
        fn_state.shift_t = s_2_26;
        // D s_2_29: write-var shift_nshadow#7322 <= s_2_27
        fn_state.shift_nshadow_7322 = s_2_27;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#303788 <= s_3_3
        fn_state.gs_303788 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#303788:u8
        let s_4_0: bool = fn_state.gs_303788;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: read-var shift_nshadow#7322:i
        let s_5_1: i128 = fn_state.shift_nshadow_7322;
        // D s_5_2: read-var m:i64
        let s_5_2: i64 = fn_state.m;
        // D s_5_3: read-var n:i64
        let s_5_3: i64 = fn_state.n;
        // D s_5_4: call execute_aarch32_instrs_TST_r_Op_A_txt(s_5_2, s_5_3, s_5_1, s_5_0)
        let s_5_4: () = execute_aarch32_instrs_TST_r_Op_A_txt(
            state,
            tracer,
            s_5_2,
            s_5_3,
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #1u : u8
        let s_7_0: bool = true;
        // D s_7_1: write-var gs#303788 <= s_7_0
        fn_state.gs_303788 = s_7_0;
        // N s_7_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
