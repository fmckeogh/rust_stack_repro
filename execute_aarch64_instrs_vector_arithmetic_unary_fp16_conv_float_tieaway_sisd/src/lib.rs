...
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_unary_fp16_conv_float_tieaway_sisd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    struct FunctionState {
        operand: Bits,
        esizeshadow_1294: i64,
        fpcr: ProductType5c790c8ef59cc8b2,
        e: i64,
        ga_253646: Bits,
        gs_149941: bool,
        result: u128,
        datasizeshadow_1295: i64,
        gs_149947: i64,
        ga_253645: i64,
        d: i64,
        datasize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#1294 <= s_0_2
        fn_state.esizeshadow_1294 = s_0_2;
        ...
        // D s_0_7: write-var datasizeshadow#1295 <= s_0_6
        fn_state.datasizeshadow_1295 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var datasizeshadow#1295:i64
        let s_1_0: i64 = fn_state.datasizeshadow_1295;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var gs#149941 <= s_2_0
        fn_state.gs_149941 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#149941:u8
        let s_3_0: bool = fn_state.gs_149941;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_5: write-var gs#149947 <= s_5_4
        fn_state.gs_149947 = s_5_4;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: read-var gs#149947:i64
        let s_6_1: i64 = fn_state.gs_149947;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var esizeshadow#1294:i64
        let s_7_0: i64 = fn_state.esizeshadow_1294;
        ...
        // D s_7_8: read-var esizeshadow#1294:i64
        let s_7_8: i64 = fn_state.esizeshadow_1294;
        // D s_7_9: cast zx s_7_8 -> i
        let s_7_9: i128 = (i128::try_from(s_7_8).unwrap());
        // D s_7_10: cast reint s_7_9 -> i64
        let s_7_10: i64 = (s_7_9 as i64);
        // D s_7_11: write-var ga#253645 <= s_7_10
        fn_state.ga_253645 = s_7_10;
        // D s_7_12: read-var esizeshadow#1294:i64
        let s_7_12: i64 = fn_state.esizeshadow_1294;
        ...
        // D s_7_20: write-var ga#253646 <= s_7_19
        fn_state.ga_253646 = s_7_19;
        // N s_7_21: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: read-var ga#253645:i64
        let s_8_4: i64 = fn_state.ga_253645;
        // D s_8_5: cast zx s_8_4 -> i
        let s_8_5: i128 = (i128::try_from(s_8_4).unwrap());
        // D s_8_6: read-var ga#253646:bv
        let s_8_6: Bits = fn_state.ga_253646;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_2: write-var gs#149941 <= s_11_1
        fn_state.gs_149941 = s_11_1;
        // N s_11_3: jump b3
        return block_3(state, tracer, fn_state);
    }
}
