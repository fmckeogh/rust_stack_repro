...
pub fn u__get_AMCFGR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #32s : i
        let s_0_3: i128 = 32;
        // C s_0_4: const #251641856u : u28
        let s_0_4: u32 = 251641856;
        ...
        // D s_0_15: tail-call Mk_AMCFGR_Type(s_0_14)
        return Mk_AMCFGR_Type(state, tracer, s_0_14);
    }
}
