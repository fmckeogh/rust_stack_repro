...
use Z_set::*;
use common::*;
pub fn execute_SQDMULLB_Z_ZZi_S<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#3952 <= s_0_2
        fn_state.VLshadow_3952 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#3952:i64
        let s_1_0: i64 = fn_state.VLshadow_3952;
        // D s_1_1: write-var VLshadow#3953 <= s_1_0
        fn_state.VLshadow_3953 = s_1_0;
        // C s_1_2: const #2s : i
        let s_1_2: i128 = 2;
        ...
        // D s_1_7: read-var VLshadow#3953:i64
        let s_1_7: i64 = fn_state.VLshadow_3953;
        ...
        // D s_1_22: read-var VLshadow#3953:i64
        let s_1_22: i64 = fn_state.VLshadow_3953;
        ...
        // D s_1_30: read-var VLshadow#3953:i64
        let s_1_30: i64 = fn_state.VLshadow_3953;
        ...
        // D s_1_43: write-var gs#213062 <= s_1_42
        fn_state.gs_213062 = s_1_42;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#213062:i64
        let s_2_1: i64 = fn_state.gs_213062;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_63: mul s_3_60 s_3_62
        let s_3_63: i128 = ((s_3_60) * (s_3_62));
        ...
        // C s_3_67: const #2s : i
        let s_3_67: i128 = 2;
        // D s_3_68: read-var esize:i64
        let s_3_68: i64 = fn_state.esize;
        // D s_3_69: cast zx s_3_68 -> i
        let s_3_69: i128 = (i128::try_from(s_3_68).unwrap());
        // D s_3_70: mul s_3_67 s_3_69
        let s_3_70: i128 = ((s_3_67) * (s_3_69));
        ...
        // D s_3_73: cast reint s_3_72 -> i64
        let s_3_73: i64 = (s_3_72 as i64);
        // D s_3_74: cast zx s_3_59 -> i
        let s_3_74: i128 = (i128::try_from(s_3_59).unwrap());
        // D s_3_75: cast zx s_3_73 -> i
        let s_3_75: i128 = (i128::try_from(s_3_73).unwrap());
        // D s_3_76: call SignedSat(s_3_74, s_3_75)
        let s_3_76: Bits = SignedSat(state, tracer, s_3_74, s_3_75);
        // D s_3_77: cast reint s_3_76 -> u32
        let s_3_77: u32 = (s_3_76.value() as u32);
        // D s_3_78: read-var e:i64
        let s_3_78: i64 = fn_state.e;
        // D s_3_79: cast zx s_3_78 -> i
        let s_3_79: i128 = (i128::try_from(s_3_78).unwrap());
        // D s_3_80: cast zx s_3_66 -> i
        let s_3_80: i128 = (i128::try_from(s_3_66).unwrap());
        // D s_3_81: cast zx s_3_77 -> bv
        let s_3_81: Bits = Bits::new(s_3_77 as u128, 32u16);
        // D s_3_82: read-var result:bv
        let s_3_82: Bits = fn_state.result;
        // D s_3_83: call Elem_set(s_3_82, s_3_79, s_3_80, s_3_81)
        let s_3_83: Bits = Elem_set(state, tracer, s_3_82, s_3_79, s_3_80, s_3_81);
        // D s_3_84: write-var result <= s_3_83
        fn_state.result = s_3_83;
        // D s_3_85: read-var e:i64
        let s_3_85: i64 = fn_state.e;
        // C s_3_86: const #1s : i64
        let s_3_86: i64 = 1;
        // D s_3_87: add s_3_85 s_3_86
        let s_3_87: i64 = (s_3_85 + s_3_86);
        // D s_3_88: write-var e <= s_3_87
        fn_state.e = s_3_87;
        // N s_3_89: jump b2
        return block_2(state, tracer, fn_state);
    }
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#3953:i64
        let s_4_0: i64 = fn_state.VLshadow_3953;
