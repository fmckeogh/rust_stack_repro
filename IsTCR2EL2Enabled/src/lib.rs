...
use HaveFeatTCR2::*;
use common::*;
pub fn IsTCR2EL2Enabled<T: Tracer>(state: &mut State, tracer: &T, gs_13699: ()) -> bool {
    #[derive(Default)]
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var gs#13700 <= s_2_0
        fn_state.gs_13700 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#13700:u8
        let s_3_0: bool = fn_state.gs_13700;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_2: call _get_SCR_EL3_Type_TCR2En(s_7_1)
        let s_7_2: bool = u_get_SCR_EL3_Type_TCR2En(state, tracer, s_7_1);
        ...
        // D s_7_7: write-var gs#13700 <= s_7_6
        fn_state.gs_13700 = s_7_6;
        // N s_7_8: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
