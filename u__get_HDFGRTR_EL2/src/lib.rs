...
use common::*;
pub fn u__get_HDFGRTR_EL2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #64s : i
        let s_0_3: i128 = 64;
        // C s_0_4: const #143557460805812480u : u60
        let s_0_4: u64 = 143557460805812480;
        // C s_0_5: cast zx s_0_4 -> bv
        let s_0_5: Bits = Bits::new(s_0_4 as u128, 60u16);
        ...
        // D s_0_15: tail-call Mk_HDFGRTR_EL2_Type(s_0_14)
        return Mk_HDFGRTR_EL2_Type(state, tracer, s_0_14);
    }
}
