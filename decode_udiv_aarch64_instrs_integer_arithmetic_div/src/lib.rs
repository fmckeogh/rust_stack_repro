...
extern crate alloc;
use execute_aarch64_instrs_integer_arithmetic_div::*;
use common::*;
pub fn decode_udiv_aarch64_instrs_integer_arithmetic_div<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 32;
        // D s_1_1: write-var ga#265199 <= s_1_0
        fn_state.ga_265199 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#265199:i64
        let s_2_0: i64 = fn_state.ga_265199;
        ...
        // D s_2_9: read-var m:i64
        let s_2_9: i64 = fn_state.m;
        // D s_2_10: read-var n:i64
        let s_2_10: i64 = fn_state.n;
        // D s_2_11: call execute_aarch64_instrs_integer_arithmetic_div(s_2_8, s_2_7, s_2_9, s_2_10, s_2_5)
        let s_2_11: () = execute_aarch64_instrs_integer_arithmetic_div(
            state,
            tracer,
            s_2_8,
            s_2_7,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 64;
        // D s_3_1: write-var ga#265199 <= s_3_0
        fn_state.ga_265199 = s_3_0;
        // N s_3_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
