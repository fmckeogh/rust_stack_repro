...
extern crate alloc;
use execute_aarch64_instrs_vector_transfer_vector_permute_zip::*;
use common::*;
pub fn decode_zip1_advsimd_aarch64_instrs_vector_transfer_vector_permute_zip<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 64;
        // D s_2_1: write-var ga#270319 <= s_2_0
        fn_state.ga_270319 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#270319:i64
        let s_3_0: i64 = fn_state.ga_270319;
        ...
        // D s_3_23: call execute_aarch64_instrs_vector_transfer_vector_permute_zip(s_3_20, s_3_15, s_3_18, s_3_21, s_3_22, s_3_19, s_3_9)
        let s_3_23: () = execute_aarch64_instrs_vector_transfer_vector_permute_zip(
            state,
            tracer,
            s_3_20,
            s_3_15,
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 128;
        // D s_4_1: write-var ga#270319 <= s_4_0
        fn_state.ga_270319 = s_4_0;
        // N s_4_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_5<T: Tracer>(
