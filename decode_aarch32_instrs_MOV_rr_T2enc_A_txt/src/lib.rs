...
use DecodeRegShift::*;
use common::*;
pub fn decode_aarch32_instrs_MOV_rr_T2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    stype: u8,
    S: bool,
    ...
    fn block_2<T: Tracer>(
        ...
        fn_state.m = s_2_8;
        // D s_2_10: read-var Rs:u8
        let s_2_10: u8 = fn_state.Rs;
        ...
        // D s_2_21: read-var stype:u8
        let s_2_21: u8 = fn_state.stype;
        // D s_2_22: call DecodeRegShift(s_2_21)
        let s_2_22: u32 = DecodeRegShift(state, tracer, s_2_21);
        // D s_2_23: write-var shift_t <= s_2_22
        fn_state.shift_t = s_2_22;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#298706 <= s_3_3
        fn_state.gs_298706 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#298706:u8
        let s_4_0: bool = fn_state.gs_298706;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#298708 <= s_5_3
        fn_state.gs_298708 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#298708:u8
        let s_6_0: bool = fn_state.gs_298708;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_5: call execute_aarch32_instrs_MOV_rr_Op_A_txt(s_7_0, s_7_1, s_7_2, s_7_3, s_7_4)
        let s_7_5: () = execute_aarch32_instrs_MOV_rr_Op_A_txt(
            state,
            tracer,
            s_7_0,
            s_7_1,
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#298708 <= s_9_0
        fn_state.gs_298708 = s_9_0;
        // N s_9_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#298706 <= s_10_0
        fn_state.gs_298706 = s_10_0;
        // N s_10_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
