...
extern crate alloc;
use execute_aarch64_instrs_vector_crypto_sha3op_sha1_hash_parity::*;
use HaveSHA1Ext::*;
use common::*;
pub fn decode_sha1p_advsimd_aarch64_instrs_vector_crypto_sha3op_sha1_hash_parity<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, Rm: u8) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_3: call execute_aarch64_instrs_vector_crypto_sha3op_sha1_hash_parity(s_1_0, s_1_1, s_1_2)
        let s_1_3: () = execute_aarch64_instrs_vector_crypto_sha3op_sha1_hash_parity(
            state,
            tracer,
            s_1_0,
            s_1_1,
