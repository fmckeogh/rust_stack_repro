...
use ALUWritePC::*;
use common::*;
pub fn execute_aarch32_instrs_MOV_r_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        carry: bool,
        result: u32,
        gs_881377: ProductTypef506aa96a892fe52,
        d: i64,
        m: i64,
        setflags: bool,
        shift_n: i128,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_9: write-var gs#881377 <= s_0_8
        fn_state.gs_881377 = s_0_8;
        // D s_0_10: read-var gs#881377.0:struct
        let s_0_10: Bits = fn_state.gs_881377._0;
        // D s_0_11: cast reint s_0_10 -> u32
        let s_0_11: u32 = (s_0_10.value() as u32);
        // D s_0_12: read-var gs#881377.1:struct
        let s_0_12: bool = fn_state.gs_881377._1;
        // D s_0_13: write-var carry <= s_0_12
        fn_state.carry = s_0_12;
        // D s_0_14: write-var result <= s_0_11
