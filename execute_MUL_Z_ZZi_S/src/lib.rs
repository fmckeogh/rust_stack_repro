...
use Z_set::*;
use common::*;
pub fn execute_MUL_Z_ZZi_S<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#3888 <= s_0_2
        fn_state.VLshadow_3888 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#3888:i64
        let s_1_0: i64 = fn_state.VLshadow_3888;
        // D s_1_1: write-var VLshadow#3889 <= s_1_0
        fn_state.VLshadow_3889 = s_1_0;
        // D s_1_2: read-var VLshadow#3889:i64
        let s_1_2: i64 = fn_state.VLshadow_3889;
        ...
        // D s_1_14: read-var VLshadow#3889:i64
        let s_1_14: i64 = fn_state.VLshadow_3889;
        ...
        // D s_1_22: read-var VLshadow#3889:i64
        let s_1_22: i64 = fn_state.VLshadow_3889;
        ...
        // D s_1_35: write-var gs#210904 <= s_1_34
        fn_state.gs_210904 = s_1_34;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#210904:i64
        let s_2_1: i64 = fn_state.gs_210904;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_52: call integer_subrange(s_3_41, s_3_51, s_3_50)
        let s_3_52: Bits = integer_subrange(state, tracer, s_3_41, s_3_51, s_3_50);
        // D s_3_53: read-var e:i64
        let s_3_53: i64 = fn_state.e;
        // D s_3_54: cast zx s_3_53 -> i
        let s_3_54: i128 = (i128::try_from(s_3_53).unwrap());
        // D s_3_55: cast zx s_3_44 -> i
        let s_3_55: i128 = (i128::try_from(s_3_44).unwrap());
        // D s_3_56: read-var result:bv
        let s_3_56: Bits = fn_state.result;
        // D s_3_57: call Elem_set(s_3_56, s_3_54, s_3_55, s_3_52)
        let s_3_57: Bits = Elem_set(state, tracer, s_3_56, s_3_54, s_3_55, s_3_52);
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#3889:i64
        let s_4_0: i64 = fn_state.VLshadow_3889;
