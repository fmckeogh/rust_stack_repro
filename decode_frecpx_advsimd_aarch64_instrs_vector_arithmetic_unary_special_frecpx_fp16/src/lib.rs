...
use common::*;
pub fn decode_frecpx_advsimd_aarch64_instrs_vector_arithmetic_unary_special_frecpx_fp16<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // C s_1_10: cast reint s_1_9 -> i64
        let s_1_10: i64 = (s_1_9 as i64);
        // D s_1_11: call execute_aarch64_instrs_vector_arithmetic_unary_special_frecpx_fp16(s_1_3, s_1_10, s_1_7)
        let s_1_11: () = execute_aarch64_instrs_vector_arithmetic_unary_special_frecpx_fp16(
            state,
            tracer,
            s_1_3,
            s_1_10,
