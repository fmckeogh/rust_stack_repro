...
use R_read::*;
use common::*;
pub fn execute_aarch32_instrs_MSR_r_Op_AS_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    mask: u8,
    n: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_3: read-var mask:u8
        let s_1_3: u8 = fn_state.mask;
        // D s_1_4: call CPSRWriteByInstr(s_1_2, s_1_3)
        let s_1_4: () = CPSRWriteByInstr(state, tracer, s_1_2, s_1_3);
        // N s_1_5: return
        return;
    }
    fn block_2<T: Tracer>(
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_7: write-var gs#323524 <= s_3_6
        fn_state.gs_323524 = s_3_6;
        // N s_3_8: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#323524:u8
        let s_4_0: bool = fn_state.gs_323524;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: read-var mask:u8
        let s_5_3: u8 = fn_state.mask;
        // D s_5_4: call SPSRWriteByInstr(s_5_2, s_5_3)
        let s_5_4: () = SPSRWriteByInstr(state, tracer, s_5_2, s_5_3);
        // N s_5_5: return
        return;
    }
    fn block_6<T: Tracer>(
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #1u : u8
        let s_7_0: bool = true;
        // D s_7_1: write-var gs#323524 <= s_7_0
        fn_state.gs_323524 = s_7_0;
        // N s_7_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
