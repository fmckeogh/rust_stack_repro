...
extern crate alloc;
use u_get_BRBCR_EL1_Type_CC::*;
use u_get_BRBCR_EL2_Type_CC::*;
use common::*;
pub fn BRBCycleCountingEnabled<T: Tracer>(
    state: &mut State,
    tracer: &T,
    gs_3238: (),
) -> bool {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#3239 <= s_1_0
        fn_state.gs_3239 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#3239:u8
        let s_2_0: bool = fn_state.gs_3239;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_2: call _get_BRBCR_EL1_Type_CC(s_3_1)
        let s_3_2: bool = u_get_BRBCR_EL1_Type_CC(state, tracer, s_3_1);
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_2: call _get_BRBCR_EL2_Type_CC(s_8_1)
        let s_8_2: bool = u_get_BRBCR_EL2_Type_CC(state, tracer, s_8_1);
        ...
        // D s_8_7: write-var gs#3239 <= s_8_6
        fn_state.gs_3239 = s_8_6;
        // N s_8_8: jump b2
        return block_2(state, tracer, fn_state);
    }
}
