...
use common::*;
pub fn u__get_DBGDCCINT<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #2684354559u : u32
        let s_0_3: u32 = 2684354559;
        ...
        // D s_0_11: tail-call Mk_DBGDCCINT_Type(s_0_10)
        return Mk_DBGDCCINT_Type(state, tracer, s_0_10);
    }
}
