...
use Zeros::*;
use common::*;
pub fn execute_PFALSE_P__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_8: call Zeros(s_1_7)
        let s_1_8: Bits = Zeros(state, tracer, s_1_7);
        ...
        // D s_1_12: call P_set(s_1_10, s_1_11, s_1_8)
        let s_1_12: () = P_set(state, tracer, s_1_10, s_1_11, s_1_8);
        // N s_1_13: return
        return;
    }
}
