...
use common::*;
pub fn decode_aarch32_instrs_SMLABB_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    Ra: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        fn_state.a = s_3_18;
        // D s_3_20: read-var N:u8
        let s_3_20: bool = fn_state.N;
        ...
        // D s_3_25: write-var n_high <= s_3_24
        fn_state.n_high = s_3_24;
        // D s_3_26: read-var M:u8
        let s_3_26: bool = fn_state.M;
        ...
        // D s_3_31: write-var m_high <= s_3_30
        fn_state.m_high = s_3_30;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: write-var gs#301088 <= s_4_3
        fn_state.gs_301088 = s_4_3;
        // N s_4_5: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#301088:u8
        let s_5_0: bool = fn_state.gs_301088;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: write-var gs#301090 <= s_6_3
        fn_state.gs_301090 = s_6_3;
        // N s_6_5: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#301090:u8
        let s_7_0: bool = fn_state.gs_301090;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_3: read-var m_high:u8
        let s_8_3: bool = fn_state.m_high;
        // D s_8_4: read-var n:i64
        let s_8_4: i64 = fn_state.n;
        // D s_8_5: read-var n_high:u8
        let s_8_5: bool = fn_state.n_high;
        // D s_8_6: call execute_aarch32_instrs_SMLABB_Op_A_txt(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5)
        let s_8_6: () = execute_aarch32_instrs_SMLABB_Op_A_txt(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#301090 <= s_10_0
        fn_state.gs_301090 = s_10_0;
        // N s_10_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#301088 <= s_11_0
        fn_state.gs_301088 = s_11_0;
        // N s_11_2: jump b5
        return block_5(state, tracer, fn_state);
    }
