...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_unary_shift::*;
use common::*;
pub fn decode_shll_advsimd_aarch64_instrs_vector_arithmetic_unary_shift<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_21: call execute_aarch64_instrs_vector_arithmetic_unary_shift(s_1_18, s_1_16, s_1_17, s_1_15, s_1_19, s_1_9, s_1_5, s_1_20)
        let s_1_21: () = execute_aarch64_instrs_vector_arithmetic_unary_shift(
            state,
            tracer,
            s_1_18,
            s_1_16,
