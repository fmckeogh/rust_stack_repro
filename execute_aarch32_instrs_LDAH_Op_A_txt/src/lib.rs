...
use R_set::*;
use common::*;
pub fn execute_aarch32_instrs_LDAH_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    n: i64,
    t: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var gs#913562:bv
        let s_1_0: Bits = fn_state.gs_913562;
        // D s_1_1: cast reint s_1_0 -> u16
        let s_1_1: u16 = (s_1_0.value() as u16);
        // C s_1_2: const #32s : i
        let s_1_2: i128 = 32;
        // D s_1_3: cast zx s_1_1 -> bv
        let s_1_3: Bits = Bits::new(s_1_1 as u128, 16u16);
