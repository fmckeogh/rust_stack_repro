...
use FPCR_read::*;
use common::*;
pub fn decode_frinti_advsimd_aarch64_instrs_vector_arithmetic_unary_float_round<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 64;
        // D s_2_1: write-var ga#256389 <= s_2_0
        fn_state.ga_256389 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#256389:i64
        let s_3_0: i64 = fn_state.ga_256389;
        ...
        // D s_3_36: write-var ga#256392 <= s_3_35
        fn_state.ga_256392 = s_3_35;
        // D s_3_37: read-var ga#256392:u8
        let s_3_37: u8 = fn_state.ga_256392;
        // C s_3_38: const #2s : i
        let s_3_38: i128 = 2;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#256392:u8
        let s_6_0: u8 = fn_state.ga_256392;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var ga#256392:u8
        let s_8_0: u8 = fn_state.ga_256392;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var ga#256392:u8
        let s_10_0: u8 = fn_state.ga_256392;
    ...
    fn block_13<T: Tracer>(
        ...
        let s_13_0: i64 = 128;
        // D s_13_1: write-var ga#256389 <= s_13_0
        fn_state.ga_256389 = s_13_0;
        // N s_13_2: jump b3
        return block_3(state, tracer, fn_state);
    }
