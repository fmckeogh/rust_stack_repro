...
use common::*;
pub fn AT_S1E2W_SysOpsWrite_f45a5d407163b4bd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_7: u32 = 1;
        // D s_8_8: call AArch64_AT(s_8_3, s_8_4, s_8_6, s_8_7)
        let s_8_8: () = AArch64_AT(state, tracer, s_8_3, s_8_4, s_8_6, s_8_7);
        // N s_8_9: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#101258 <= s_10_0
        fn_state.gs_101258 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#101258:u8
        let s_11_0: bool = fn_state.gs_101258;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_5: write-var gs#101258 <= s_14_4
        fn_state.gs_101258 = s_14_4;
        // N s_14_6: jump b11
        return block_11(state, tracer, fn_state);
    }
