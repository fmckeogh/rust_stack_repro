...
use CurrentVL_read::*;
use HaveSME2::*;
use execute_PEXT_PP_RR__::*;
use common::*;
pub fn decode_PEXT_PP_RR__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    i1: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#221666 <= s_1_0
        fn_state.gs_221666 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#221666:u8
        let s_2_0: bool = fn_state.gs_221666;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_9: read-var PNn:u8
        let s_3_9: u8 = fn_state.PNn;
        // D s_3_10: cast zx s_3_9 -> bv
        let s_3_10: Bits = Bits::new(s_3_9 as u128, 3u16);
        // C s_3_11: cast reint s_3_8 -> u128
        let s_3_11: u128 = (s_3_8.value() as u128);
        // D s_3_12: size-of s_3_8
        let s_3_12: u16 = s_3_8.length();
        // D s_3_13: cast reint s_3_10 -> u128
        let s_3_13: u128 = (s_3_10.value() as u128);
        // D s_3_14: size-of s_3_10
        let s_3_14: u16 = s_3_10.length();
        // D s_3_15: lsl s_3_11 s_3_14
        let s_3_15: u128 = s_3_11 << s_3_14;
        // D s_3_16: or s_3_15 s_3_13
        let s_3_16: u128 = ((s_3_15) | (s_3_13));
        // D s_3_17: add s_3_12 s_3_14
        let s_3_17: u16 = (s_3_12 + s_3_14);
        // D s_3_18: create-bits s_3_16 s_3_17
        let s_3_18: Bits = Bits::new(s_3_16, s_3_17);
        // D s_3_19: cast reint s_3_18 -> u8
        let s_3_19: u8 = (s_3_18.value() as u8);
        // D s_3_20: cast zx s_3_19 -> bv
        let s_3_20: Bits = Bits::new(s_3_19 as u128, 4u16);
        // D s_3_21: cast zx s_3_20 -> i
        let s_3_21: i128 = (s_3_20.value() as i128);
        // D s_3_22: cast reint s_3_21 -> i64
        let s_3_22: i64 = (s_3_21 as i64);
        // D s_3_23: write-var n <= s_3_22
        fn_state.n = s_3_22;
        ...
        // D s_3_28: write-var d0 <= s_3_27
        fn_state.d0 = s_3_27;
        // D s_3_29: read-var Pd:u8
        let s_3_29: u8 = fn_state.Pd;
        ...
        // C s_3_37: const #16s : i
        let s_3_37: i128 = 16;
        // D s_3_38: cast zx s_3_36 -> i
        let s_3_38: i128 = (i128::try_from(s_3_36).unwrap());
        // D s_3_39: mod s_3_38 s_3_37
        let s_3_39: i128 = ((s_3_38) % (s_3_37));
        // D s_3_40: cast reint s_3_39 -> i64
        let s_3_40: i64 = (s_3_39 as i64);
        // D s_3_41: write-var d1 <= s_3_40
        fn_state.d1 = s_3_40;
        // D s_3_42: read-var i1:u8
        let s_3_42: bool = fn_state.i1;
        // D s_3_43: cast zx s_3_42 -> bv
        let s_3_43: Bits = Bits::new(s_3_42 as u128, 1u16);
        // D s_3_44: cast zx s_3_43 -> i
        let s_3_44: i128 = (s_3_43.value() as i128);
        // D s_3_45: cast reint s_3_44 -> i64
        let s_3_45: i64 = (s_3_44 as i64);
        // D s_3_46: write-var part <= s_3_45
        fn_state.part = s_3_45;
        // D s_3_47: read-var VL:i64
        let s_3_47: i64 = fn_state.VL;
        // C s_3_48: const #128s : i
        let s_3_48: i128 = 128;
        // D s_3_49: cast zx s_3_47 -> i
        let s_3_49: i128 = (i128::try_from(s_3_47).unwrap());
        // D s_3_50: cmp-eq s_3_49 s_3_48
        let s_3_50: bool = ((s_3_49) == (s_3_48));
        // D s_3_51: not s_3_50
        let s_3_51: bool = !s_3_50;
        // N s_3_52: branch s_3_51 b5 b4
        if s_3_51 {
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 128;
        // D s_4_1: read-var d1:i64
        let s_4_1: i64 = fn_state.d1;
        // D s_4_2: cast zx s_4_1 -> i
        let s_4_2: i128 = (i128::try_from(s_4_1).unwrap());
        // D s_4_3: read-var d0:i64
        let s_4_3: i64 = fn_state.d0;
        // D s_4_4: read-var esize:i64
        let s_4_4: i64 = fn_state.esize;
        // D s_4_5: read-var n:i64
        let s_4_5: i64 = fn_state.n;
        // D s_4_6: read-var part:i64
        let s_4_6: i64 = fn_state.part;
        // D s_4_7: call execute_PEXT_PP_RR__(s_4_0, s_4_3, s_4_2, s_4_4, s_4_5, s_4_6)
        let s_4_7: () = execute_PEXT_PP_RR__(
            state,
            tracer,
            s_4_0,
            s_4_3,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 256;
        // D s_6_1: read-var d1:i64
        let s_6_1: i64 = fn_state.d1;
        // D s_6_2: cast zx s_6_1 -> i
        let s_6_2: i128 = (i128::try_from(s_6_1).unwrap());
        // D s_6_3: read-var d0:i64
        let s_6_3: i64 = fn_state.d0;
        // D s_6_4: read-var esize:i64
        let s_6_4: i64 = fn_state.esize;
        // D s_6_5: read-var n:i64
        let s_6_5: i64 = fn_state.n;
        // D s_6_6: read-var part:i64
        let s_6_6: i64 = fn_state.part;
        // D s_6_7: call execute_PEXT_PP_RR__(s_6_0, s_6_3, s_6_2, s_6_4, s_6_5, s_6_6)
        let s_6_7: () = execute_PEXT_PP_RR__(
            state,
            tracer,
            s_6_0,
            s_6_3,
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 512;
        // D s_8_1: read-var d1:i64
        let s_8_1: i64 = fn_state.d1;
        ...
        // D s_8_6: read-var part:i64
        let s_8_6: i64 = fn_state.part;
        // D s_8_7: call execute_PEXT_PP_RR__(s_8_0, s_8_3, s_8_2, s_8_4, s_8_5, s_8_6)
        let s_8_7: () = execute_PEXT_PP_RR__(
            state,
            tracer,
            s_8_0,
            s_8_3,
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 1024;
        // D s_10_1: read-var d1:i64
        let s_10_1: i64 = fn_state.d1;
        // D s_10_2: cast zx s_10_1 -> i
        let s_10_2: i128 = (i128::try_from(s_10_1).unwrap());
        // D s_10_3: read-var d0:i64
        let s_10_3: i64 = fn_state.d0;
        // D s_10_4: read-var esize:i64
        let s_10_4: i64 = fn_state.esize;
        // D s_10_5: read-var n:i64
        let s_10_5: i64 = fn_state.n;
        // D s_10_6: read-var part:i64
        let s_10_6: i64 = fn_state.part;
        // D s_10_7: call execute_PEXT_PP_RR__(s_10_0, s_10_3, s_10_2, s_10_4, s_10_5, s_10_6)
        let s_10_7: () = execute_PEXT_PP_RR__(
            state,
            tracer,
            s_10_0,
            s_10_3,
    ...
    fn block_12<T: Tracer>(
        ...
        let s_12_0: i64 = 2048;
        // D s_12_1: read-var d1:i64
        let s_12_1: i64 = fn_state.d1;
        // D s_12_2: cast zx s_12_1 -> i
        let s_12_2: i128 = (i128::try_from(s_12_1).unwrap());
        // D s_12_3: read-var d0:i64
        let s_12_3: i64 = fn_state.d0;
        // D s_12_4: read-var esize:i64
        let s_12_4: i64 = fn_state.esize;
        // D s_12_5: read-var n:i64
        let s_12_5: i64 = fn_state.n;
        // D s_12_6: read-var part:i64
        let s_12_6: i64 = fn_state.part;
        // D s_12_7: call execute_PEXT_PP_RR__(s_12_0, s_12_3, s_12_2, s_12_4, s_12_5, s_12_6)
        let s_12_7: () = execute_PEXT_PP_RR__(
            state,
            tracer,
            s_12_0,
            s_12_3,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#221666 <= s_15_2
        fn_state.gs_221666 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
