...
use SignedSat::*;
use common::*;
pub fn execute_aarch32_instrs_QADD16_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_70: call SignedSat(s_0_68, s_0_69)
        let s_0_70: Bits = SignedSat(state, tracer, s_0_68, s_0_69);
        ...
        // D s_0_96: call SignedSat(s_0_94, s_0_95)
        let s_0_96: Bits = SignedSat(state, tracer, s_0_94, s_0_95);
