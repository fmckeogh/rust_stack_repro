...
use ROR::*;
use common::*;
pub fn execute_XAR_Z_ZZI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    dn: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#4262 <= s_0_2
        fn_state.esizeshadow_4262 = s_0_2;
        ...
        // D s_0_7: write-var VLshadow#4263 <= s_0_6
        fn_state.VLshadow_4263 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#4263:i64
        let s_1_0: i64 = fn_state.VLshadow_4263;
        // D s_1_1: write-var VLshadow#4264 <= s_1_0
        fn_state.VLshadow_4264 = s_1_0;
        // D s_1_2: read-var VLshadow#4264:i64
        let s_1_2: i64 = fn_state.VLshadow_4264;
        // D s_1_3: cast zx s_1_2 -> i
        let s_1_3: i128 = (i128::try_from(s_1_2).unwrap());
        // D s_1_4: read-var esizeshadow#4262:i64
        let s_1_4: i64 = fn_state.esizeshadow_4262;
        ...
        // D s_1_8: read-var VLshadow#4264:i64
        let s_1_8: i64 = fn_state.VLshadow_4264;
        ...
        // D s_1_16: read-var VLshadow#4264:i64
        let s_1_16: i64 = fn_state.VLshadow_4264;
        ...
        // D s_1_29: write-var gs#218186 <= s_1_28
        fn_state.gs_218186 = s_1_28;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#218186:i64
        let s_2_1: i64 = fn_state.gs_218186;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var esizeshadow#4262:i64
        let s_3_0: i64 = fn_state.esizeshadow_4262;
        ...
        // D s_3_8: read-var esizeshadow#4262:i64
        let s_3_8: i64 = fn_state.esizeshadow_4262;
        ...
        // D s_3_16: read-var rot:i
        let s_3_16: i128 = fn_state.rot;
        // D s_3_17: call __id(s_3_16)
        let s_3_17: i128 = u__id(state, tracer, s_3_16);
        // C s_3_18: const #0s : i
        let s_3_18: i128 = 0;
        // D s_3_19: cmp-ge s_3_17 s_3_18
        let s_3_19: bool = ((s_3_17) >= (s_3_18));
        // N s_3_20: assert s_3_19
        let s_3_20: () = assert!(s_3_19);
        // D s_3_21: read-var esizeshadow#4262:i64
        let s_3_21: i64 = fn_state.esizeshadow_4262;
        ...
        // D s_3_24: xor s_3_7 s_3_15
        let s_3_24: Bits = ((s_3_7) ^ (s_3_15));
        // D s_3_25: read-var rot:i
        let s_3_25: i128 = fn_state.rot;
        // D s_3_26: call ROR(s_3_24, s_3_25)
        let s_3_26: Bits = ROR(state, tracer, s_3_24, s_3_25);
        // D s_3_27: read-var e:i64
        let s_3_27: i64 = fn_state.e;
        // D s_3_28: cast zx s_3_27 -> i
        let s_3_28: i128 = (i128::try_from(s_3_27).unwrap());
        // D s_3_29: cast zx s_3_23 -> i
        let s_3_29: i128 = (i128::try_from(s_3_23).unwrap());
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#4264:i64
        let s_4_0: i64 = fn_state.VLshadow_4264;
