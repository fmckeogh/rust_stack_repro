...
use T32ExpandImm::*;
use common::*;
pub fn decode_aarch32_instrs_ADD_SP_i_T3enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i: bool,
    S: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#295653 <= s_3_0
        fn_state.gs_295653 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#295653:u8
        let s_4_0: bool = fn_state.gs_295653;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#295657 <= s_6_0
        fn_state.gs_295657 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#295657:u8
        let s_7_0: bool = fn_state.gs_295657;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_3: call execute_aarch32_instrs_ADD_SP_i_Op_A_txt(s_8_0, s_8_1, s_8_2)
        let s_8_3: () = execute_aarch32_instrs_ADD_SP_i_Op_A_txt(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_2: write-var gs#295657 <= s_10_1
        fn_state.gs_295657 = s_10_1;
        // N s_10_3: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#295653 <= s_12_4
        fn_state.gs_295653 = s_12_4;
        // N s_12_6: jump b4
        return block_4(state, tracer, fn_state);
    }
}
