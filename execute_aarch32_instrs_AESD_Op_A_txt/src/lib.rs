...
use AESInvSubBytes::*;
use common::*;
pub fn execute_aarch32_instrs_AESD_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_17: call AESInvShiftRows(s_1_16)
        let s_1_17: u128 = AESInvShiftRows(state, tracer, s_1_16);
        // D s_1_18: call AESInvSubBytes(s_1_17)
        let s_1_18: u128 = AESInvSubBytes(state, tracer, s_1_17);
