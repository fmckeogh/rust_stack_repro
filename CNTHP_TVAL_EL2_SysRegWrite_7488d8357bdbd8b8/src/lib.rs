...
use EL2Enabled::*;
use common::*;
pub fn CNTHP_TVAL_EL2_SysRegWrite_7488d8357bdbd8b8<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_22: call Mk_CNTHP_CVAL_EL2_Type(s_5_21)
        let s_5_22: ProductType5c790c8ef59cc8b2 = Mk_CNTHP_CVAL_EL2_Type(
            state,
            tracer,
            s_5_21,
        );
        // C s_5_23: const #16640u : u32
        let s_5_23: u32 = 16640;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_22: call Mk_CNTHP_CVAL_EL2_Type(s_6_21)
        let s_6_22: ProductType5c790c8ef59cc8b2 = Mk_CNTHP_CVAL_EL2_Type(
            state,
            tracer,
            s_6_21,
        );
        // C s_6_23: const #16640u : u32
        let s_6_23: u32 = 16640;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#81648 <= s_8_0
        fn_state.gs_81648 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#81648:u8
        let s_9_0: bool = fn_state.gs_81648;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#81648 <= s_12_4
        fn_state.gs_81648 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
