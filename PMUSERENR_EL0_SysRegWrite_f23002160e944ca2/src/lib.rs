...
use Halted::*;
use u_get_HDFGWTR_EL2_Type_PMUSERENR_EL0::*;
use u_get_EDSCR_Type_SDD::*;
use X_read::*;
use AArch64_SystemAccessTrap::*;
use Mk_PMUSERENR_EL0_Type::*;
use u__IMPDEF_boolean::*;
use EDSCR_read::*;
use u_get_MDCR_EL3_Type_TPM::*;
use common::*;
pub fn PMUSERENR_EL0_SysRegWrite_f23002160e944ca2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ...
        gs_91392: bool,
        u__PSTATE_EL: u8,
        u__HDFGWTR_EL2_PMUSERENR_EL0: bool,
        gs_91388: bool,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_17: call _get_HDFGWTR_EL2_Type_PMUSERENR_EL0(s_0_16)
        let s_0_17: bool = u_get_HDFGWTR_EL2_Type_PMUSERENR_EL0(state, tracer, s_0_16);
        // D s_0_18: write-var __HDFGWTR_EL2_PMUSERENR_EL0 <= s_0_17
        fn_state.u__HDFGWTR_EL2_PMUSERENR_EL0 = s_0_17;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_PMUSERENR_EL0_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_PMUSERENR_EL0_Type(
            state,
            tracer,
            s_5_3,
        );
        // C s_5_5: const #102624u : u32
        let s_5_5: u32 = 102624;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#91380 <= s_7_0
        fn_state.gs_91380 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#91380:u8
        let s_8_0: bool = fn_state.gs_91380;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#91381 <= s_9_0
        fn_state.gs_91381 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#91381:u8
        let s_10_0: bool = fn_state.gs_91381;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#91382 <= s_11_0
        fn_state.gs_91382 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#91382:u8
        let s_12_0: bool = fn_state.gs_91382;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#91383 <= s_13_0
        fn_state.gs_91383 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#91383:u8
        let s_14_0: bool = fn_state.gs_91383;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#91384 <= s_16_0
        fn_state.gs_91384 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#91384:u8
        let s_17_0: bool = fn_state.gs_91384;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_4: call Mk_PMUSERENR_EL0_Type(s_18_3)
        let s_18_4: ProductType5c790c8ef59cc8b2 = Mk_PMUSERENR_EL0_Type(
            state,
            tracer,
            s_18_3,
        );
        // C s_18_5: const #102624u : u32
        let s_18_5: u32 = 102624;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#91386 <= s_20_0
        fn_state.gs_91386 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#91386:u8
        let s_21_0: bool = fn_state.gs_91386;
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_5: write-var gs#91386 <= s_24_4
        fn_state.gs_91386 = s_24_4;
        // N s_24_6: jump b21
        return block_21(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_5: write-var gs#91384 <= s_25_4
        fn_state.gs_91384 = s_25_4;
        // N s_25_6: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_5: write-var gs#91383 <= s_27_4
        fn_state.gs_91383 = s_27_4;
        // N s_27_6: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_2: write-var gs#91382 <= s_28_1
        fn_state.gs_91382 = s_28_1;
        // N s_28_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_5: write-var gs#91381 <= s_29_4
        fn_state.gs_91381 = s_29_4;
        // N s_29_6: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_4: write-var gs#91380 <= s_30_3
        fn_state.gs_91380 = s_30_3;
        // N s_30_5: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_1: write-var gs#91387 <= s_32_0
        fn_state.gs_91387 = s_32_0;
        // N s_32_2: jump b33
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var gs#91387:u8
        let s_33_0: bool = fn_state.gs_91387;
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_1: write-var gs#91388 <= s_34_0
        fn_state.gs_91388 = s_34_0;
        // N s_34_2: jump b35
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_0: read-var gs#91388:u8
        let s_35_0: bool = fn_state.gs_91388;
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_1: write-var gs#91389 <= s_36_0
        fn_state.gs_91389 = s_36_0;
        // N s_36_2: jump b37
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_0: read-var gs#91389:u8
        let s_37_0: bool = fn_state.gs_91389;
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_1: write-var gs#91390 <= s_38_0
        fn_state.gs_91390 = s_38_0;
        // N s_38_2: jump b39
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_0: read-var gs#91390:u8
        let s_39_0: bool = fn_state.gs_91390;
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_1: write-var gs#91391 <= s_41_0
        fn_state.gs_91391 = s_41_0;
        // N s_41_2: jump b42
    ...
    fn block_42<T: Tracer>(
        ...
        // D s_42_0: read-var gs#91391:u8
        let s_42_0: bool = fn_state.gs_91391;
    ...
    fn block_43<T: Tracer>(
        ...
        // D s_43_1: write-var gs#91393 <= s_43_0
        fn_state.gs_91393 = s_43_0;
        // N s_43_2: jump b44
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_0: read-var gs#91393:u8
        let s_44_0: bool = fn_state.gs_91393;
    ...
    fn block_45<T: Tracer>(
        ...
        // D s_45_1: write-var gs#91394 <= s_45_0
        fn_state.gs_91394 = s_45_0;
        // N s_45_2: jump b46
    ...
    fn block_46<T: Tracer>(
        ...
        // D s_46_0: read-var gs#91394:u8
        let s_46_0: bool = fn_state.gs_91394;
    ...
    fn block_48<T: Tracer>(
        ...
        // D s_48_1: write-var gs#91395 <= s_48_0
        fn_state.gs_91395 = s_48_0;
        // N s_48_2: jump b49
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_0: read-var gs#91395:u8
        let s_49_0: bool = fn_state.gs_91395;
    ...
    fn block_51<T: Tracer>(
        ...
        // D s_51_1: write-var gs#91396 <= s_51_0
        fn_state.gs_91396 = s_51_0;
        // N s_51_2: jump b52
    ...
    fn block_52<T: Tracer>(
        ...
        // D s_52_0: read-var gs#91396:u8
        let s_52_0: bool = fn_state.gs_91396;
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_4: call Mk_PMUSERENR_EL0_Type(s_53_3)
        let s_53_4: ProductType5c790c8ef59cc8b2 = Mk_PMUSERENR_EL0_Type(
            state,
            tracer,
            s_53_3,
        );
        // C s_53_5: const #102624u : u32
        let s_53_5: u32 = 102624;
    ...
    fn block_55<T: Tracer>(
        ...
        // D s_55_1: write-var gs#91398 <= s_55_0
        fn_state.gs_91398 = s_55_0;
        // N s_55_2: jump b56
    ...
    fn block_56<T: Tracer>(
        ...
        // D s_56_0: read-var gs#91398:u8
        let s_56_0: bool = fn_state.gs_91398;
    ...
    fn block_59<T: Tracer>(
        ...
        // D s_59_5: write-var gs#91398 <= s_59_4
        fn_state.gs_91398 = s_59_4;
        // N s_59_6: jump b56
        return block_56(state, tracer, fn_state);
    }
    fn block_60<T: Tracer>(
        ...
        // D s_60_5: write-var gs#91396 <= s_60_4
        fn_state.gs_91396 = s_60_4;
        // N s_60_6: jump b52
        return block_52(state, tracer, fn_state);
    }
    ...
    fn block_62<T: Tracer>(
        ...
        // D s_62_5: write-var gs#91395 <= s_62_4
        fn_state.gs_91395 = s_62_4;
        // N s_62_6: jump b49
        return block_49(state, tracer, fn_state);
    }
    ...
    fn block_64<T: Tracer>(
        ...
        // D s_64_0: read-var __HDFGWTR_EL2_PMUSERENR_EL0:u8
        let s_64_0: bool = fn_state.u__HDFGWTR_EL2_PMUSERENR_EL0;
        ...
        // D s_64_5: write-var gs#91394 <= s_64_4
        fn_state.gs_91394 = s_64_4;
        // N s_64_6: jump b46
        return block_46(state, tracer, fn_state);
    }
    ...
    fn block_66<T: Tracer>(
        ...
        // D s_66_5: write-var gs#91392 <= s_66_4
        fn_state.gs_91392 = s_66_4;
        // N s_66_6: jump b67
    ...
    fn block_67<T: Tracer>(
        ...
        // D s_67_0: read-var gs#91392:u8
        let s_67_0: bool = fn_state.gs_91392;
        // D s_67_1: write-var gs#91393 <= s_67_0
        fn_state.gs_91393 = s_67_0;
        // N s_67_2: jump b44
        return block_44(state, tracer, fn_state);
    }
    fn block_68<T: Tracer>(
        ...
        // D s_68_1: write-var gs#91392 <= s_68_0
        fn_state.gs_91392 = s_68_0;
        // N s_68_2: jump b67
        return block_67(state, tracer, fn_state);
    }
    fn block_69<T: Tracer>(
        ...
        // D s_69_2: write-var gs#91391 <= s_69_1
        fn_state.gs_91391 = s_69_1;
        // N s_69_3: jump b42
        return block_42(state, tracer, fn_state);
    }
    ...
    fn block_71<T: Tracer>(
        ...
        // D s_71_5: write-var gs#91390 <= s_71_4
        fn_state.gs_91390 = s_71_4;
        // N s_71_6: jump b39
        return block_39(state, tracer, fn_state);
    }
    fn block_72<T: Tracer>(
        ...
        // D s_72_2: write-var gs#91389 <= s_72_1
        fn_state.gs_91389 = s_72_1;
        // N s_72_3: jump b37
        return block_37(state, tracer, fn_state);
    }
    fn block_73<T: Tracer>(
        ...
        // D s_73_5: write-var gs#91388 <= s_73_4
        fn_state.gs_91388 = s_73_4;
        // N s_73_6: jump b35
        return block_35(state, tracer, fn_state);
    }
    fn block_74<T: Tracer>(
        ...
        // D s_74_4: write-var gs#91387 <= s_74_3
        fn_state.gs_91387 = s_74_3;
        // N s_74_5: jump b33
        return block_33(state, tracer, fn_state);
    }
