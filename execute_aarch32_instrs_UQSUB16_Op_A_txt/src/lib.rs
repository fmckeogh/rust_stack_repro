...
use R_set::*;
use common::*;
pub fn execute_aarch32_instrs_UQSUB16_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_67: const #16s : i64
        let s_0_67: i64 = 16;
        // D s_0_68: cast zx s_0_31 -> i
        let s_0_68: i128 = (i128::try_from(s_0_31).unwrap());
        // C s_0_69: cast zx s_0_67 -> i
        let s_0_69: i128 = (i128::try_from(s_0_67).unwrap());
        // D s_0_70: call UnsignedSat(s_0_68, s_0_69)
        let s_0_70: Bits = UnsignedSat(state, tracer, s_0_68, s_0_69);
        ...
        // C s_0_93: const #16s : i64
        let s_0_93: i64 = 16;
        // D s_0_94: cast zx s_0_63 -> i
        let s_0_94: i128 = (i128::try_from(s_0_63).unwrap());
        // C s_0_95: cast zx s_0_93 -> i
        let s_0_95: i128 = (i128::try_from(s_0_93).unwrap());
        // D s_0_96: call UnsignedSat(s_0_94, s_0_95)
        let s_0_96: Bits = UnsignedSat(state, tracer, s_0_94, s_0_95);
