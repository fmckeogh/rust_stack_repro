...
use EncodePredCount::*;
use common::*;
pub fn execute_WHILELE_PN_RR__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_41: write-var gs#222788 <= s_2_40
        fn_state.gs_222788 = s_2_40;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: read-var gs#222788:i64
        let s_3_1: i64 = fn_state.gs_222788;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#222795 <= s_7_0
        fn_state.gs_222795 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#222795:u8
        let s_8_0: bool = fn_state.gs_222795;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#222795 <= s_12_0
        fn_state.gs_222795 = s_12_0;
        // N s_12_2: jump b8
        return block_8(state, tracer, fn_state);
    }
