...
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_binary_disparate_add_sub_long<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    datasize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#1806 <= s_0_2
        fn_state.esizeshadow_1806 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_25: write-var gs#167156 <= s_1_24
        fn_state.gs_167156 = s_1_24;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#167156:i64
        let s_2_1: i64 = fn_state.gs_167156;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var esizeshadow#1806:i64
        let s_3_0: i64 = fn_state.esizeshadow_1806;
        ...
        // D s_3_11: read-var esizeshadow#1806:i64
        let s_3_11: i64 = fn_state.esizeshadow_1806;
        ...
        // D s_3_22: read-var sub_op:u8
        let s_3_22: bool = fn_state.sub_op;
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_0: const #2s : i
        let s_5_0: i128 = 2;
        // D s_5_1: read-var esizeshadow#1806:i64
        let s_5_1: i64 = fn_state.esizeshadow_1806;
        ...
        // C s_5_7: const #2s : i
        let s_5_7: i128 = 2;
        // D s_5_8: read-var esizeshadow#1806:i64
        let s_5_8: i64 = fn_state.esizeshadow_1806;
