...
pub fn u__get_HDCR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #32s : i
        let s_0_3: i128 = 32;
        // C s_0_4: const #57999360u : u28
        let s_0_4: u32 = 57999360;
        ...
        // D s_0_15: tail-call Mk_HDCR_Type(s_0_14)
        return Mk_HDCR_Type(state, tracer, s_0_14);
    }
}
