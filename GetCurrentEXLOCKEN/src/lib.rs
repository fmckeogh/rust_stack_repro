...
extern crate alloc;
use u_get_GCSCR_EL1_Type_EXLOCKEN::*;
use u_get_GCSCR_EL3_Type_EXLOCKEN::*;
use u_get_GCSCR_EL2_Type_EXLOCKEN::*;
use Unreachable::*;
use common::*;
pub fn GetCurrentEXLOCKEN<T: Tracer>(
    state: &mut State,
    tracer: &T,
    gs_4799: (),
) -> bool {
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_2: write-var ga#3192 <= s_0_1
        fn_state.ga_3192 = s_0_1;
        // D s_0_3: read-var ga#3192:u8
        let s_0_3: u8 = fn_state.ga_3192;
    ...
    fn block_1<T: Tracer>(
        ...
        // C s_1_0: const #() : ()
        let s_1_0: () = ();
        // S s_1_1: call Unreachable(s_1_0)
        let s_1_1: () = Unreachable(state, tracer, s_1_0);
        // D s_1_2: read-var ga#3193:u8
        let s_1_2: bool = fn_state.ga_3193;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#3192:u8
        let s_3_0: u8 = fn_state.ga_3192;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: call _get_GCSCR_EL1_Type_EXLOCKEN(s_4_1)
        let s_4_2: bool = u_get_GCSCR_EL1_Type_EXLOCKEN(state, tracer, s_4_1);
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var ga#3192:u8
        let s_5_0: u8 = fn_state.ga_3192;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call _get_GCSCR_EL2_Type_EXLOCKEN(s_6_1)
        let s_6_2: bool = u_get_GCSCR_EL2_Type_EXLOCKEN(state, tracer, s_6_1);
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var ga#3192:u8
        let s_7_0: u8 = fn_state.ga_3192;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_2: call _get_GCSCR_EL3_Type_EXLOCKEN(s_8_1)
        let s_8_2: bool = u_get_GCSCR_EL3_Type_EXLOCKEN(state, tracer, s_8_1);
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var ga#3200:u8
        let s_9_0: bool = fn_state.ga_3200;
