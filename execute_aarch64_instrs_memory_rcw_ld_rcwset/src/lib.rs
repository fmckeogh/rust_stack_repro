...
use MemAtomicRCW::*;
use common::*;
pub fn execute_aarch64_instrs_memory_rcw_ld_rcwset<T: Tracer>(
    state: &mut State,
    tracer: &T,
    acquire: bool,
    n: i64,
    ...
    struct FunctionState {
        gs_708536: ProductType42c31f3d0ab6eb17,
        address: u64,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_10: write-var gs#708536 <= s_3_9
        fn_state.gs_708536 = s_3_9;
        // N s_3_11: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#708536.0:struct
        let s_4_0: u8 = fn_state.gs_708536._0;
        // D s_4_1: read-var gs#708536.1:struct
        let s_4_1: Bits = fn_state.gs_708536._1;
