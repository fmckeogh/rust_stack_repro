...
use HaveFP16Ext::*;
use common::*;
pub fn decode_aarch32_instrs_VCVT_iv_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    opc2: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var opc2:u8
        let s_2_0: u8 = fn_state.opc2;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#308186 <= s_3_0
        fn_state.gs_308186 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#308186:u8
        let s_4_0: bool = fn_state.gs_308186;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#308187 <= s_7_0
        fn_state.gs_308187 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#308187:u8
        let s_8_0: bool = fn_state.gs_308187;
        // D s_8_1: write-var gs#308188 <= s_8_0
        fn_state.gs_308188 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#308188:u8
        let s_9_0: bool = fn_state.gs_308188;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#308189 <= s_11_0
        fn_state.gs_308189 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#308189:u8
        let s_12_0: bool = fn_state.gs_308189;
    ...
    fn block_35<T: Tracer>(
        ...
        // C s_35_0: const #() : ()
        let s_35_0: () = ();
        // S s_35_1: call InITBlock(s_35_0)
        let s_35_1: bool = InITBlock(state, tracer, s_35_0);
        // D s_35_2: write-var gs#308189 <= s_35_1
        fn_state.gs_308189 = s_35_1;
        // N s_35_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_3: write-var gs#308187 <= s_37_2
        fn_state.gs_308187 = s_37_2;
        // N s_37_4: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_38<T: Tracer>(
        ...
        // D s_38_1: write-var gs#308188 <= s_38_0
        fn_state.gs_308188 = s_38_0;
        // N s_38_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_1: write-var gs#308181 <= s_41_0
        fn_state.gs_308181 = s_41_0;
        // N s_41_2: jump b42
    ...
    fn block_42<T: Tracer>(
        ...
        // D s_42_0: read-var gs#308181:u8
        let s_42_0: bool = fn_state.gs_308181;
        // D s_42_1: not s_42_0
        let s_42_1: bool = !s_42_0;
        // D s_42_2: write-var gs#308186 <= s_42_1
        fn_state.gs_308186 = s_42_1;
        // N s_42_3: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_43<T: Tracer>(
        ...
        // D s_43_1: write-var gs#308181 <= s_43_0
        fn_state.gs_308181 = s_43_0;
        // N s_43_2: jump b42
        return block_42(state, tracer, fn_state);
    }
}
