...
use u__get_ICC_IGRPEN1_EL3::*;
use common::*;
pub fn ICC_IGRPEN1_EL3_SysRegRead_36d699c35dbd8f69<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_67683: ProductType5c790c8ef59cc8b2,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_5: call _get_ICC_SRE_EL3_Type_SRE(s_0_4)
        let s_0_5: bool = u_get_ICC_SRE_EL3_Type_SRE(state, tracer, s_0_4);
        // D s_0_6: write-var __ICC_SRE_EL3_SRE <= s_0_5
        fn_state.u__ICC_SRE_EL3_SRE = s_0_5;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_ICC_IGRPEN1_EL3(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_ICC_IGRPEN1_EL3(
            state,
            tracer,
            s_6_2,
        );
        // D s_6_4: write-var ga#67683 <= s_6_3
        fn_state.ga_67683 = s_6_3;
        // D s_6_5: read-var ga#67683.0:struct
        let s_6_5: u64 = fn_state.ga_67683._0;
