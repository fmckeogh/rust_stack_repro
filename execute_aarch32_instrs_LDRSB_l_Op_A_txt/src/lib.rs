...
use Align_bits::*;
use common::*;
pub fn execute_aarch32_instrs_LDRSB_l_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    add: bool,
    imm32: u32,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_3: write-var gs#880636 <= s_4_2
        fn_state.gs_880636 = s_4_2;
        // N s_4_4: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#880636:bv
        let s_5_0: Bits = fn_state.gs_880636;
        // D s_5_1: cast reint s_5_0 -> u8
        let s_5_1: u8 = (s_5_0.value() as u8);
        // C s_5_2: const #32s : i
        let s_5_2: i128 = 32;
        // D s_5_3: cast zx s_5_1 -> bv
        let s_5_3: Bits = Bits::new(s_5_1 as u128, 8u16);
        // D s_5_4: bits-cast sx s_5_3 -> bv length s_5_2
        let s_5_4: Bits = s_5_3.sign_extend(s_5_2);
