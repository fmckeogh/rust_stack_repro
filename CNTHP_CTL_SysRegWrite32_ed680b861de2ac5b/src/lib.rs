...
use u__set_CNTHP_CTL::*;
use common::*;
pub fn CNTHP_CTL_SysRegWrite32_ed680b861de2ac5b<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call Mk_CNTHP_CTL_Type(s_6_1)
        let s_6_2: ProductType700c18a878c5601b = Mk_CNTHP_CTL_Type(state, tracer, s_6_1);
        // D s_6_3: call __set_CNTHP_CTL(s_6_2)
        let s_6_3: () = u__set_CNTHP_CTL(state, tracer, s_6_2);
        // N s_6_4: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_2: call Mk_CNTHP_CTL_Type(s_8_1)
        let s_8_2: ProductType700c18a878c5601b = Mk_CNTHP_CTL_Type(state, tracer, s_8_1);
        // D s_8_3: call __set_CNTHP_CTL(s_8_2)
        let s_8_3: () = u__set_CNTHP_CTL(state, tracer, s_8_2);
        // N s_8_4: return
        return;
    }
    fn block_9<T: Tracer>(
