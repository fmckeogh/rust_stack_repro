...
extern crate alloc;
use common::*;
pub fn CNTFRQ_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #22912u : u32
        let s_0_23: u32 = 22912;
        ...
        // C s_0_25: const #22888u : u32
        let s_0_25: u32 = 22888;
