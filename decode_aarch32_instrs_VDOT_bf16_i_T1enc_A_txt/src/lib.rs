...
use common::*;
pub fn decode_aarch32_instrs_VDOT_bf16_i_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Vn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#326948 <= s_3_0
        fn_state.gs_326948 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#326948:u8
        let s_4_0: bool = fn_state.gs_326948;
    ...
    fn block_5<T: Tracer>(
        ...
        fn_state.n = s_5_32;
        // D s_5_34: read-var Vm:u8
        let s_5_34: u8 = fn_state.Vm;
        // D s_5_35: cast zx s_5_34 -> bv
        let s_5_35: Bits = Bits::new(s_5_34 as u128, 4u16);
        // D s_5_36: cast zx s_5_35 -> i
        let s_5_36: i128 = (s_5_35.value() as i128);
        // D s_5_37: cast reint s_5_36 -> i64
        let s_5_37: i64 = (s_5_36 as i64);
        // D s_5_38: write-var m <= s_5_37
        fn_state.m = s_5_37;
        // D s_5_39: read-var M:u8
        let s_5_39: bool = fn_state.M;
        ...
        // D s_5_43: write-var i <= s_5_42
        fn_state.i = s_5_42;
        // D s_5_44: read-var Q:u8
        let s_5_44: bool = fn_state.Q;
        // D s_5_45: cast zx s_5_44 -> bv
        let s_5_45: Bits = Bits::new(s_5_44 as u128, 1u16);
        // C s_5_46: const #1u : u8
        let s_5_46: bool = true;
        // C s_5_47: cast zx s_5_46 -> bv
        let s_5_47: Bits = Bits::new(s_5_46 as u128, 1u16);
        // D s_5_48: cmp-eq s_5_45 s_5_47
        let s_5_48: bool = ((s_5_45) == (s_5_47));
        // N s_5_49: branch s_5_48 b8 b6
        if s_5_48 {
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 1;
        // D s_6_1: write-var ga#367124 <= s_6_0
        fn_state.ga_367124 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var ga#367124:i64
        let s_7_0: i64 = fn_state.ga_367124;
        ...
        // D s_7_5: call execute_aarch32_instrs_VDOT_bf16_i_Op_A_txt(s_7_1, s_7_2, s_7_3, s_7_4, s_7_0)
        let s_7_5: () = execute_aarch32_instrs_VDOT_bf16_i_Op_A_txt(
            state,
            tracer,
            s_7_1,
            s_7_2,
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 2;
        // D s_8_1: write-var ga#367124 <= s_8_0
        fn_state.ga_367124 = s_8_0;
        // N s_8_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_22: write-var gs#326947 <= s_11_21
        fn_state.gs_326947 = s_11_21;
        // N s_11_23: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#326947:u8
        let s_12_0: bool = fn_state.gs_326947;
        // D s_12_1: write-var gs#326948 <= s_12_0
        fn_state.gs_326948 = s_12_0;
        // N s_12_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#326947 <= s_13_0
        fn_state.gs_326947 = s_13_0;
        // N s_13_2: jump b12
        return block_12(state, tracer, fn_state);
    }
