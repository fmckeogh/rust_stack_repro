...
use LastActive::*;
use common::*;
pub fn execute_BRKPB_P_P_PP__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_47: write-var gs#201517 <= s_1_46
        fn_state.gs_201517 = s_1_46;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#201517:i64
        let s_2_1: i64 = fn_state.gs_201517;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#201524 <= s_7_0
        fn_state.gs_201524 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#201524:u8
        let s_8_0: bool = fn_state.gs_201524;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_6: write-var gs#201524 <= s_12_5
        fn_state.gs_201524 = s_12_5;
        // N s_12_7: jump b8
        return block_8(state, tracer, fn_state);
    }
