...
use Mk_SMCR_EL3_Type::*;
use common::*;
pub fn SMCR_EL3_SysRegWrite_f161cc4d183ca3de<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call Mk_SMCR_EL3_Type(s_6_3)
        let s_6_4: ProductType5c790c8ef59cc8b2 = Mk_SMCR_EL3_Type(state, tracer, s_6_3);
        // C s_6_5: const #90960u : u32
        let s_6_5: u32 = 90960;
