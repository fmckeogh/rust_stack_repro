...
use common::*;
pub fn decode_frecpe_advsimd_aarch64_instrs_vector_arithmetic_unary_special_recip_float_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, sz: bool) -> () {
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_18: const #1s : i
        let s_0_18: i128 = 1;
        // D s_0_19: call execute_aarch64_instrs_vector_arithmetic_unary_special_recip_fp16_sisd(s_0_3, s_0_15, s_0_18, s_0_17, s_0_7)
        let s_0_19: () = execute_aarch64_instrs_vector_arithmetic_unary_special_recip_fp16_sisd(
            state,
            tracer,
            s_0_3,
            s_0_15,
