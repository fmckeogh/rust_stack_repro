...
use ALUWritePC::*;
use common::*;
pub fn execute_aarch32_instrs_SUB_SP_r_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        gs_886922: ProductTyped54bc449dd09e5bd,
        result: u32,
        nzcv: u8,
        d: i64,
        m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_10: const #13s : i
        let s_0_10: i128 = 13;
        // S s_0_11: call R_read(s_0_10)
        let s_0_11: u32 = R_read(state, tracer, s_0_10);
        // D s_0_12: cast zx s_0_9 -> bv
        let s_0_12: Bits = Bits::new(s_0_9 as u128, 32u16);
        // D s_0_13: not s_0_12
        let s_0_13: Bits = !s_0_12;
        // D s_0_14: cast reint s_0_13 -> u32
        let s_0_14: u32 = (s_0_13.value() as u32);
        // S s_0_15: cast zx s_0_11 -> bv
        let s_0_15: Bits = Bits::new(s_0_11 as u128, 32u16);
        // D s_0_16: cast zx s_0_14 -> bv
        let s_0_16: Bits = Bits::new(s_0_14 as u128, 32u16);
        // C s_0_17: const #1u : u8
        let s_0_17: bool = true;
        // D s_0_18: call AddWithCarry(s_0_15, s_0_16, s_0_17)
        let s_0_18: ProductTyped54bc449dd09e5bd = AddWithCarry(
            state,
            tracer,
            s_0_15,
            s_0_16,
        ...
        // D s_0_19: write-var gs#886922 <= s_0_18
        fn_state.gs_886922 = s_0_18;
        // D s_0_20: read-var gs#886922.0:struct
        let s_0_20: Bits = fn_state.gs_886922._0;
        // D s_0_21: cast reint s_0_20 -> u32
        let s_0_21: u32 = (s_0_20.value() as u32);
        // D s_0_22: read-var gs#886922.1:struct
        let s_0_22: u8 = fn_state.gs_886922._1;
        // D s_0_23: write-var result <= s_0_21
        fn_state.result = s_0_21;
        // D s_0_24: write-var nzcv <= s_0_22
        fn_state.nzcv = s_0_22;
        // C s_0_25: const #15s : i
        let s_0_25: i128 = 15;
        // D s_0_26: read-var d:i64
        let s_0_26: i64 = fn_state.d;
        // D s_0_27: cast zx s_0_26 -> i
        let s_0_27: i128 = (i128::try_from(s_0_26).unwrap());
        // D s_0_28: cmp-eq s_0_27 s_0_25
        let s_0_28: bool = ((s_0_27) == (s_0_25));
