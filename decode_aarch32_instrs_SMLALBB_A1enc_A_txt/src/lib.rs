...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_SMLALBB_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_SMLALBB_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    RdHi: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        fn_state.m = s_2_24;
        // D s_2_26: read-var N:u8
        let s_2_26: bool = fn_state.N;
        ...
        // D s_2_31: write-var n_high <= s_2_30
        fn_state.n_high = s_2_30;
        // D s_2_32: read-var M:u8
        let s_2_32: bool = fn_state.M;
        // D s_2_33: cast zx s_2_32 -> bv
        let s_2_33: Bits = Bits::new(s_2_32 as u128, 1u16);
        // C s_2_34: const #1u : u8
        let s_2_34: bool = true;
        // C s_2_35: cast zx s_2_34 -> bv
        let s_2_35: Bits = Bits::new(s_2_34 as u128, 1u16);
        // D s_2_36: cmp-eq s_2_33 s_2_35
        let s_2_36: bool = ((s_2_33) == (s_2_35));
        // D s_2_37: write-var m_high <= s_2_36
        fn_state.m_high = s_2_36;
        // C s_2_38: const #15s : i
        let s_2_38: i128 = 15;
        // D s_2_39: read-var dLo:i64
        let s_2_39: i64 = fn_state.dLo;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#301224 <= s_3_3
        fn_state.gs_301224 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#301224:u8
        let s_4_0: bool = fn_state.gs_301224;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#301226 <= s_5_3
        fn_state.gs_301226 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#301226:u8
        let s_6_0: bool = fn_state.gs_301226;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#301228 <= s_7_3
        fn_state.gs_301228 = s_7_3;
        // N s_7_5: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#301228:u8
        let s_8_0: bool = fn_state.gs_301228;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_3: read-var m_high:u8
        let s_10_3: bool = fn_state.m_high;
        // D s_10_4: read-var n:i64
        let s_10_4: i64 = fn_state.n;
        // D s_10_5: read-var n_high:u8
        let s_10_5: bool = fn_state.n_high;
        // D s_10_6: call execute_aarch32_instrs_SMLALBB_Op_A_txt(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5)
        let s_10_6: () = execute_aarch32_instrs_SMLALBB_Op_A_txt(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#301228 <= s_13_0
        fn_state.gs_301228 = s_13_0;
        // N s_13_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#301226 <= s_14_0
        fn_state.gs_301226 = s_14_0;
        // N s_14_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#301224 <= s_15_0
        fn_state.gs_301224 = s_15_0;
        // N s_15_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
