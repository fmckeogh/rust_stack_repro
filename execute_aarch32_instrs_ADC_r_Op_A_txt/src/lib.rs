...
use ALUWritePC::*;
use common::*;
pub fn execute_aarch32_instrs_ADC_r_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        result: u32,
        nzcv: u8,
        gs_877630: ProductTyped54bc449dd09e5bd,
        d: i64,
        m: i64,
        n: i64,
        setflags: bool,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_13: const #16971u : u32
        let s_0_13: u32 = 16971;
        // D s_0_14: read-reg s_0_13:u8
        let s_0_14: bool = {
            let value = state.read_register::<bool>(s_0_13 as isize);
            tracer.read_register(s_0_13 as isize, value);
            value
        };
        // D s_0_15: cast zx s_0_12 -> bv
        let s_0_15: Bits = Bits::new(s_0_12 as u128, 32u16);
        // D s_0_16: cast zx s_0_9 -> bv
        let s_0_16: Bits = Bits::new(s_0_9 as u128, 32u16);
        // D s_0_17: call AddWithCarry(s_0_15, s_0_16, s_0_14)
        let s_0_17: ProductTyped54bc449dd09e5bd = AddWithCarry(
            state,
            tracer,
            s_0_15,
            s_0_16,
        ...
        // D s_0_18: write-var gs#877630 <= s_0_17
        fn_state.gs_877630 = s_0_17;
        // D s_0_19: read-var gs#877630.0:struct
        let s_0_19: Bits = fn_state.gs_877630._0;
        // D s_0_20: cast reint s_0_19 -> u32
        let s_0_20: u32 = (s_0_19.value() as u32);
        // D s_0_21: read-var gs#877630.1:struct
        let s_0_21: u8 = fn_state.gs_877630._1;
        // D s_0_22: write-var result <= s_0_20
        fn_state.result = s_0_20;
        // D s_0_23: write-var nzcv <= s_0_21
        fn_state.nzcv = s_0_21;
        // C s_0_24: const #15s : i
        let s_0_24: i128 = 15;
        // D s_0_25: read-var d:i64
        let s_0_25: i64 = fn_state.d;
        // D s_0_26: cast zx s_0_25 -> i
        let s_0_26: i128 = (i128::try_from(s_0_25).unwrap());
        // D s_0_27: cmp-eq s_0_26 s_0_24
        let s_0_27: bool = ((s_0_26) == (s_0_24));
        // N s_0_28: branch s_0_27 b4 b1
        if s_0_27 {
