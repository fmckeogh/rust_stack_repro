...
use Mk_DACR32_EL2_Type::*;
use AArch64_SystemAccessTrap::*;
use common::*;
pub fn DACR32_EL2_SysRegWrite_94b89018206732e0<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call Mk_DACR32_EL2_Type(s_6_3)
        let s_6_4: ProductType5c790c8ef59cc8b2 = Mk_DACR32_EL2_Type(
            state,
            tracer,
            s_6_3,
        );
        // C s_6_5: const #16584u : u32
        let s_6_5: u32 = 16584;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: call Mk_DACR32_EL2_Type(s_7_3)
        let s_7_4: ProductType5c790c8ef59cc8b2 = Mk_DACR32_EL2_Type(
            state,
            tracer,
            s_7_3,
        );
        // C s_7_5: const #16584u : u32
        let s_7_5: u32 = 16584;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#82050 <= s_9_0
        fn_state.gs_82050 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#82050:u8
        let s_10_0: bool = fn_state.gs_82050;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_5: write-var gs#82050 <= s_13_4
        fn_state.gs_82050 = s_13_4;
        // N s_13_6: jump b10
        return block_10(state, tracer, fn_state);
    }
