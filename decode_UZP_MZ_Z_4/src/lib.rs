...
use CurrentVL_read::*;
use HaveSME2::*;
use execute_UZP_MZ_Z_4::*;
use common::*;
pub fn decode_UZP_MZ_Z_4<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Zn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_6: call execute_UZP_MZ_Z_4(s_2_0, s_2_4, s_2_3, s_2_5)
        let s_2_6: () = execute_UZP_MZ_Z_4(state, tracer, s_2_0, s_2_4, s_2_3, s_2_5);
        // N s_2_7: return
        return;
    }
    fn block_3<T: Tracer>(
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_6: call execute_UZP_MZ_Z_4(s_4_0, s_4_4, s_4_3, s_4_5)
        let s_4_6: () = execute_UZP_MZ_Z_4(state, tracer, s_4_0, s_4_4, s_4_3, s_4_5);
        // N s_4_7: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_6: call execute_UZP_MZ_Z_4(s_6_0, s_6_4, s_6_3, s_6_5)
        let s_6_6: () = execute_UZP_MZ_Z_4(state, tracer, s_6_0, s_6_4, s_6_3, s_6_5);
        // N s_6_7: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_6: call execute_UZP_MZ_Z_4(s_8_0, s_8_4, s_8_3, s_8_5)
        let s_8_6: () = execute_UZP_MZ_Z_4(state, tracer, s_8_0, s_8_4, s_8_3, s_8_5);
        // N s_8_7: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_6: call execute_UZP_MZ_Z_4(s_10_0, s_10_4, s_10_3, s_10_5)
        let s_10_6: () = execute_UZP_MZ_Z_4(
            state,
            tracer,
            s_10_0,
            s_10_4,
