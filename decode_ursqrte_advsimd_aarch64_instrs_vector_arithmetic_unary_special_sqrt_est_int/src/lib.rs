...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_unary_special_sqrt_est_int::*;
use common::*;
pub fn decode_ursqrte_advsimd_aarch64_instrs_vector_arithmetic_unary_special_sqrt_est_int<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, sz: bool, Q: bool) -> () {
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 64;
        // D s_2_1: write-var ga#270151 <= s_2_0
        fn_state.ga_270151 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#270151:i64
        let s_3_0: i64 = fn_state.ga_270151;
        // C s_3_1: const #32s : i
        let s_3_1: i128 = 32;
        ...
        // D s_3_10: call execute_aarch64_instrs_vector_arithmetic_unary_special_sqrt_est_int(s_3_8, s_3_6, s_3_7, s_3_9)
        let s_3_10: () = execute_aarch64_instrs_vector_arithmetic_unary_special_sqrt_est_int(
            state,
            tracer,
            s_3_8,
            s_3_6,
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 128;
        // D s_4_1: write-var ga#270151 <= s_4_0
        fn_state.ga_270151 = s_4_0;
        // N s_4_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_5<T: Tracer>(
