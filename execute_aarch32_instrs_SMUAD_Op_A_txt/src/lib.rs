...
use ROR::*;
use common::*;
pub fn execute_aarch32_instrs_SMUAD_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_62: add s_2_60 s_2_61
        let s_2_62: i128 = (s_2_60 + s_2_61);
        // D s_2_63: cast reint s_2_62 -> i64
        let s_2_63: i64 = (s_2_62 as i64);
        // C s_2_64: const #31s : i
        let s_2_64: i128 = 31;
        // C s_2_65: const #0s : i
        let s_2_65: i128 = 0;
        // D s_2_66: cast zx s_2_63 -> i
        let s_2_66: i128 = (i128::try_from(s_2_63).unwrap());
        // D s_2_67: call integer_subrange(s_2_66, s_2_64, s_2_65)
        let s_2_67: Bits = integer_subrange(state, tracer, s_2_66, s_2_64, s_2_65);
        // D s_2_68: cast reint s_2_67 -> u32
        let s_2_68: u32 = (s_2_67.value() as u32);
        // D s_2_69: read-var d:i64
        let s_2_69: i64 = fn_state.d;
        // D s_2_70: cast zx s_2_69 -> i
        let s_2_70: i128 = (i128::try_from(s_2_69).unwrap());
        // D s_2_71: call R_set(s_2_70, s_2_68)
        let s_2_71: () = R_set(state, tracer, s_2_70, s_2_68);
        // C s_2_72: const #31s : i
        let s_2_72: i128 = 31;
        // C s_2_73: const #0s : i
        let s_2_73: i128 = 0;
        // D s_2_74: cast zx s_2_63 -> i
        let s_2_74: i128 = (i128::try_from(s_2_63).unwrap());
        // D s_2_75: call integer_subrange(s_2_74, s_2_72, s_2_73)
        let s_2_75: Bits = integer_subrange(state, tracer, s_2_74, s_2_72, s_2_73);
        // D s_2_76: cast reint s_2_75 -> u32
        let s_2_76: u32 = (s_2_75.value() as u32);
        // D s_2_77: cast zx s_2_76 -> bv
        let s_2_77: Bits = Bits::new(s_2_76 as u128, 32u16);
        // D s_2_78: cast sx s_2_77 -> i
        let s_2_78: i128 = {
            let sign_bit = s_2_77.length() - 1;
            let mut result = s_2_77.value() as i128;
            if ((result >> sign_bit) & 1) == 1 {
                let cleared_bit = result & !(1 << sign_bit);
                result = cleared_bit - (1 << sign_bit);
            }
        ...
        // D s_2_79: cast reint s_2_78 -> i64
        let s_2_79: i64 = (s_2_78 as i64);
        // D s_2_80: cast zx s_2_63 -> i
        let s_2_80: i128 = (i128::try_from(s_2_63).unwrap());
        // D s_2_81: cast zx s_2_79 -> i
        let s_2_81: i128 = (i128::try_from(s_2_79).unwrap());
        // D s_2_82: call neq_int(s_2_80, s_2_81)
        let s_2_82: bool = neq_int(state, tracer, s_2_80, s_2_81);
        // N s_2_83: branch s_2_82 b4 b3
        if s_2_82 {
