...
use DecodeRegExtend::*;
use common::*;
pub fn decode_add_addsub_ext_aarch64_instrs_integer_arithmetic_add_sub_extendedreg<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 32;
        // D s_1_1: write-var ga#249180 <= s_1_0
        fn_state.ga_249180 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#249180:i64
        let s_2_0: i64 = fn_state.ga_249180;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // D s_5_1: write-var ga#249180 <= s_5_0
        fn_state.ga_249180 = s_5_0;
        // N s_5_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
