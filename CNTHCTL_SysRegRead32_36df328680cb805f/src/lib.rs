...
use R_set::*;
use common::*;
pub fn CNTHCTL_SysRegRead32_36df328680cb805f<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    struct FunctionState {
        u__SCR_NS: bool,
        ga_166404: ProductType700c18a878c5601b,
        u__PSTATE_EL: u8,
        ga_166398: ProductType700c18a878c5601b,
        el: u8,
        coproc: u8,
        opc1: u8,
        CRn: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #() : ()
        let s_6_0: () = ();
        // S s_6_1: call CNTHCTL_read(s_6_0)
        let s_6_1: ProductType700c18a878c5601b = CNTHCTL_read(state, tracer, s_6_0);
        // S s_6_2: call __get_CNTHCTL(s_6_1)
        let s_6_2: ProductType700c18a878c5601b = u__get_CNTHCTL(state, tracer, s_6_1);
        // D s_6_3: write-var ga#166404 <= s_6_2
        fn_state.ga_166404 = s_6_2;
        // D s_6_4: read-var ga#166404.0:struct
        let s_6_4: u32 = fn_state.ga_166404._0;
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #() : ()
        let s_8_0: () = ();
        // S s_8_1: call CNTHCTL_read(s_8_0)
        let s_8_1: ProductType700c18a878c5601b = CNTHCTL_read(state, tracer, s_8_0);
        // S s_8_2: call __get_CNTHCTL(s_8_1)
        let s_8_2: ProductType700c18a878c5601b = u__get_CNTHCTL(state, tracer, s_8_1);
        // D s_8_3: write-var ga#166398 <= s_8_2
        fn_state.ga_166398 = s_8_2;
        // D s_8_4: read-var ga#166398.0:struct
        let s_8_4: u32 = fn_state.ga_166398._0;
