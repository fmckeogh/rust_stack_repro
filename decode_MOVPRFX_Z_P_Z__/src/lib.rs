...
use HaveSVE::*;
use CurrentVL_read::*;
use execute_MOVPRFX_Z_P_Z__::*;
use HaveSME::*;
use common::*;
pub fn decode_MOVPRFX_Z_P_Z__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    M: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#194594 <= s_1_0
        fn_state.gs_194594 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#194594:u8
        let s_2_0: bool = fn_state.gs_194594;
    ...
    fn block_3<T: Tracer>(
        ...
        fn_state.d = s_3_20;
        // D s_3_22: read-var M:u8
        let s_3_22: bool = fn_state.M;
        ...
        // D s_3_27: write-var merging <= s_3_26
        fn_state.merging = s_3_26;
        // D s_3_28: read-var VL:i64
        let s_3_28: i64 = fn_state.VL;
        // C s_3_29: const #128s : i
        let s_3_29: i128 = 128;
        ...
        // D s_3_32: not s_3_31
        let s_3_32: bool = !s_3_31;
        // N s_3_33: branch s_3_32 b5 b4
        if s_3_32 {
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_6: read-var merging:u8
        let s_4_6: bool = fn_state.merging;
        // D s_4_7: read-var n:i64
        let s_4_7: i64 = fn_state.n;
        // D s_4_8: call execute_MOVPRFX_Z_P_Z__(s_4_0, s_4_4, s_4_3, s_4_5, s_4_6, s_4_7)
        let s_4_8: () = execute_MOVPRFX_Z_P_Z__(
            state,
            tracer,
            s_4_0,
            s_4_4,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_6: read-var merging:u8
        let s_6_6: bool = fn_state.merging;
        // D s_6_7: read-var n:i64
        let s_6_7: i64 = fn_state.n;
        // D s_6_8: call execute_MOVPRFX_Z_P_Z__(s_6_0, s_6_4, s_6_3, s_6_5, s_6_6, s_6_7)
        let s_6_8: () = execute_MOVPRFX_Z_P_Z__(
            state,
            tracer,
            s_6_0,
            s_6_4,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_6: read-var merging:u8
        let s_8_6: bool = fn_state.merging;
        // D s_8_7: read-var n:i64
        let s_8_7: i64 = fn_state.n;
        // D s_8_8: call execute_MOVPRFX_Z_P_Z__(s_8_0, s_8_4, s_8_3, s_8_5, s_8_6, s_8_7)
        let s_8_8: () = execute_MOVPRFX_Z_P_Z__(
            state,
            tracer,
            s_8_0,
            s_8_4,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_6: read-var merging:u8
        let s_10_6: bool = fn_state.merging;
        // D s_10_7: read-var n:i64
        let s_10_7: i64 = fn_state.n;
        // D s_10_8: call execute_MOVPRFX_Z_P_Z__(s_10_0, s_10_4, s_10_3, s_10_5, s_10_6, s_10_7)
        let s_10_8: () = execute_MOVPRFX_Z_P_Z__(
            state,
            tracer,
            s_10_0,
            s_10_4,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_6: read-var merging:u8
        let s_12_6: bool = fn_state.merging;
        // D s_12_7: read-var n:i64
        let s_12_7: i64 = fn_state.n;
        // D s_12_8: call execute_MOVPRFX_Z_P_Z__(s_12_0, s_12_4, s_12_3, s_12_5, s_12_6, s_12_7)
        let s_12_8: () = execute_MOVPRFX_Z_P_Z__(
            state,
            tracer,
            s_12_0,
            s_12_4,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#194594 <= s_15_2
        fn_state.gs_194594 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
