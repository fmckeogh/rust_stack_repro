...
use MemAtomicRCW::*;
use common::*;
pub fn execute_aarch64_instrs_memory_rcw_ld_128_rcwsetp<T: Tracer>(
    state: &mut State,
    tracer: &T,
    acquire: bool,
    n: i64,
    ...
    struct FunctionState {
        ...
        gs_708584: ProductType42c31f3d0ab6eb17,
        newdata: u128,
        acquire: bool,
        n: i64,
        op: u32,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_10: write-var gs#708584 <= s_5_9
        fn_state.gs_708584 = s_5_9;
        // N s_5_11: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#708584.0:struct
        let s_6_0: u8 = fn_state.gs_708584._0;
        // D s_6_1: read-var gs#708584.1:struct
        let s_6_1: Bits = fn_state.gs_708584._1;
