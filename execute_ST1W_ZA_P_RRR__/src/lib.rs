...
use Mem_set::*;
use common::*;
pub fn execute_ST1W_ZA_P_RRR__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    esize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#5529 <= s_0_2
        fn_state.VLshadow_5529 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#5529:i64
        let s_1_0: i64 = fn_state.VLshadow_5529;
        // D s_1_1: write-var VLshadow#5530 <= s_1_0
        fn_state.VLshadow_5530 = s_1_0;
        // C s_1_2: const #8s : i
        let s_1_2: i128 = 8;
        // D s_1_3: read-var VLshadow#5530:i64
        let s_1_3: i64 = fn_state.VLshadow_5530;
        ...
        // D s_1_7: read-var VLshadow#5530:i64
        let s_1_7: i64 = fn_state.VLshadow_5530;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_3: read-var VLshadow#5530:i64
        let s_3_3: i64 = fn_state.VLshadow_5530;
        ...
        // D s_3_21: write-var gs#257694 <= s_3_20
        fn_state.gs_257694 = s_3_20;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#257694:i64
        let s_4_1: i64 = fn_state.gs_257694;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_2: write-var gs#257689 <= s_11_1
        fn_state.gs_257689 = s_11_1;
        // N s_11_3: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#257689:u8
        let s_12_0: bool = fn_state.gs_257689;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#257689 <= s_16_0
        fn_state.gs_257689 = s_16_0;
        // N s_16_2: jump b12
        return block_12(state, tracer, fn_state);
    }
}
