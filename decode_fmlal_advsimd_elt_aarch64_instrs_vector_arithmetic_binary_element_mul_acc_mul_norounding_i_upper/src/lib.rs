...
use common::*;
pub fn decode_fmlal_advsimd_elt_aarch64_instrs_vector_arithmetic_binary_element_mul_acc_mul_norounding_i_upper<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 64;
        // D s_3_1: write-var ga#255682 <= s_3_0
        fn_state.ga_255682 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#255682:i64
        let s_4_0: i64 = fn_state.ga_255682;
        // C s_4_1: const #32s : i
        let s_4_1: i128 = 32;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 128;
        // D s_5_1: write-var ga#255682 <= s_5_0
        fn_state.ga_255682 = s_5_0;
        // N s_5_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_6<T: Tracer>(
