...
use Z_set::*;
use common::*;
pub fn execute_DECD_Z_ZS__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    dn: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#2744 <= s_0_2
        fn_state.VLshadow_2744 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#2744:i64
        let s_1_0: i64 = fn_state.VLshadow_2744;
        // D s_1_1: write-var VLshadow#2745 <= s_1_0
        fn_state.VLshadow_2745 = s_1_0;
        // D s_1_2: read-var VLshadow#2745:i64
        let s_1_2: i64 = fn_state.VLshadow_2745;
        ...
        // D s_1_13: read-var VLshadow#2745:i64
        let s_1_13: i64 = fn_state.VLshadow_2745;
        ...
        // D s_1_26: write-var gs#192056 <= s_1_25
        fn_state.gs_192056 = s_1_25;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#192056:i64
        let s_2_1: i64 = fn_state.gs_192056;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_11: cast reint s_3_10 -> u64
        let s_3_11: u64 = (s_3_10.value() as u64);
        ...
        let s_3_16: Bits = Bits::new(s_3_11 as u128, 64u16);
        // D s_3_17: cast cvt s_3_15 -> bv
        let s_3_17: Bits = Bits::new(s_3_15 as u128, 128);
        // D s_3_18: sub s_3_16 s_3_17
        let s_3_18: Bits = ((s_3_16) - (s_3_17));
        // D s_3_19: cast reint s_3_18 -> u64
        let s_3_19: u64 = (s_3_18.value() as u64);
        ...
        let s_3_23: Bits = Bits::new(s_3_19 as u128, 64u16);
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#2745:i64
        let s_4_0: i64 = fn_state.VLshadow_2745;
