...
use common::*;
pub fn CNTHV_CVAL_EL2_SysRegRead_7bb539c281c21387<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // C s_5_1: const #103152u : u32
        let s_5_1: u32 = 103152;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#57881 <= s_8_0
        fn_state.gs_57881 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#57881:u8
        let s_9_0: bool = fn_state.gs_57881;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#57881 <= s_12_4
        fn_state.gs_57881 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
