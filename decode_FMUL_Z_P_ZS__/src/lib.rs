...
use CurrentVL_read::*;
use u__id::*;
use execute_FMUL_Z_P_ZS__::*;
use FPPointFive::*;
use HaveSME::*;
use common::*;
pub fn decode_FMUL_Z_P_ZS__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Pg: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#174634 <= s_1_0
        fn_state.gs_174634 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#174634:u8
        let s_2_0: bool = fn_state.gs_174634;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_7: write-var gs#174643 <= s_6_6
        fn_state.gs_174643 = s_6_6;
        // N s_6_8: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#174643:u8
        let s_7_0: bool = fn_state.gs_174643;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_7: write-var gs#174645 <= s_8_6
        fn_state.gs_174645 = s_8_6;
        // N s_8_8: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#174645:u8
        let s_9_0: bool = fn_state.gs_174645;
        ...
        // D s_9_6: call FPTwo(s_9_5, s_9_4)
        let s_9_6: Bits = FPTwo(state, tracer, s_9_5, s_9_4);
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_7: call execute_FMUL_Z_P_ZS__(s_11_0, s_11_4, s_11_3, s_11_5, s_11_6)
        let s_11_7: () = execute_FMUL_Z_P_ZS__(
            state,
            tracer,
            s_11_0,
            s_11_4,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_7: call execute_FMUL_Z_P_ZS__(s_13_0, s_13_4, s_13_3, s_13_5, s_13_6)
        let s_13_7: () = execute_FMUL_Z_P_ZS__(
            state,
            tracer,
            s_13_0,
            s_13_4,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_7: call execute_FMUL_Z_P_ZS__(s_15_0, s_15_4, s_15_3, s_15_5, s_15_6)
        let s_15_7: () = execute_FMUL_Z_P_ZS__(
            state,
            tracer,
            s_15_0,
            s_15_4,
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_7: call execute_FMUL_Z_P_ZS__(s_17_0, s_17_4, s_17_3, s_17_5, s_17_6)
        let s_17_7: () = execute_FMUL_Z_P_ZS__(
            state,
            tracer,
            s_17_0,
            s_17_4,
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_7: call execute_FMUL_Z_P_ZS__(s_19_0, s_19_4, s_19_3, s_19_5, s_19_6)
        let s_19_7: () = execute_FMUL_Z_P_ZS__(
            state,
            tracer,
            s_19_0,
            s_19_4,
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#174645 <= s_21_0
        fn_state.gs_174645 = s_21_0;
        // N s_21_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#174643 <= s_22_0
        fn_state.gs_174643 = s_22_0;
        // N s_22_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_7: write-var gs#174649 <= s_24_6
        fn_state.gs_174649 = s_24_6;
        // N s_24_8: jump b25
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_0: read-var gs#174649:u8
        let s_25_0: bool = fn_state.gs_174649;
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_7: write-var gs#174651 <= s_26_6
        fn_state.gs_174651 = s_26_6;
        // N s_26_8: jump b27
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_0: read-var gs#174651:u8
        let s_27_0: bool = fn_state.gs_174651;
        // N s_27_1: assert s_27_0
        let s_27_1: () = assert!(s_27_0);
        // D s_27_2: read-var esize:i64
        let s_27_2: i64 = fn_state.esize;
        ...
        // C s_27_5: const #0u : u8
        let s_27_5: bool = false;
        // D s_27_6: call FPPointFive(s_27_5, s_27_4)
        let s_27_6: Bits = FPPointFive(state, tracer, s_27_5, s_27_4);
        // D s_27_7: write-var imm <= s_27_6
        fn_state.imm = s_27_6;
        // N s_27_8: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_1: write-var gs#174651 <= s_28_0
        fn_state.gs_174651 = s_28_0;
        // N s_28_2: jump b27
        return block_27(state, tracer, fn_state);
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_1: write-var gs#174649 <= s_29_0
        fn_state.gs_174649 = s_29_0;
        // N s_29_2: jump b25
        return block_25(state, tracer, fn_state);
    }
    ...
    fn block_32<T: Tracer>(
        ...
        // C s_32_0: const #() : ()
        let s_32_0: () = ();
        // S s_32_1: call HaveSME(s_32_0)
        let s_32_1: bool = HaveSME(state, tracer, s_32_0);
        // S s_32_2: not s_32_1
        let s_32_2: bool = !s_32_1;
        // D s_32_3: write-var gs#174634 <= s_32_2
        fn_state.gs_174634 = s_32_2;
        // N s_32_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
