...
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_SUB_r_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rm: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_24: call execute_aarch32_instrs_SUB_r_Op_A_txt(s_2_3, s_2_11, s_2_7, s_2_14, s_2_23, s_2_18)
        let s_2_24: () = execute_aarch32_instrs_SUB_r_Op_A_txt(
            state,
            tracer,
            s_2_3,
            s_2_11,
