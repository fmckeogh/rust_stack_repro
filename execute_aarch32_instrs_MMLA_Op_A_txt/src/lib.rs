...
use Q_set::*;
use common::*;
pub fn execute_aarch32_instrs_MMLA_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_18: cast zx s_1_14 -> bv
        let s_1_18: Bits = Bits::new(s_1_14 as u128, 128u16);
        // D s_1_19: cast zx s_1_4 -> bv
        let s_1_19: Bits = Bits::new(s_1_4 as u128, 128u16);
        // D s_1_20: cast zx s_1_9 -> bv
        let s_1_20: Bits = Bits::new(s_1_9 as u128, 128u16);
        // D s_1_21: read-var op1_unsigned:u8
        let s_1_21: bool = fn_state.op1_unsigned;
        // D s_1_22: read-var op2_unsigned:u8
        let s_1_22: bool = fn_state.op2_unsigned;
        // D s_1_23: call MatMulAdd(s_1_18, s_1_19, s_1_20, s_1_21, s_1_22)
        let s_1_23: Bits = MatMulAdd(
            state,
            tracer,
            s_1_18,
            s_1_19,
        ...
        // D s_1_25: cast zx s_1_17 -> i
        let s_1_25: i128 = (i128::try_from(s_1_17).unwrap());
        // D s_1_26: call Q_set(s_1_25, s_1_24)
        let s_1_26: () = Q_set(state, tracer, s_1_25, s_1_24);
        // N s_1_27: return
        return;
    }
}
