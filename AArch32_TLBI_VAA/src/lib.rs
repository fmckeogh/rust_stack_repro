...
use Zeros::*;
use common::*;
pub fn AArch32_TLBI_VAA<T: Tracer>(
    state: &mut State,
    tracer: &T,
    security: u32,
    regime: u32,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_7: write-var gs#32455 <= s_2_6
        fn_state.gs_32455 = s_2_6;
        // N s_2_8: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#32455:u8
        let s_3_0: bool = fn_state.gs_32455;
        // D s_3_1: write-var gs#32456 <= s_3_0
        fn_state.gs_32456 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#32456:u8
        let s_4_0: bool = fn_state.gs_32456;
        ...
        // C s_4_16: const #32s : i
        let s_4_16: i128 = 32;
        // S s_4_17: call Zeros(s_4_16)
        let s_4_17: Bits = Zeros(state, tracer, s_4_16);
        // S s_4_18: cast reint s_4_17 -> u32
        let s_4_18: u32 = (s_4_17.value() as u32);
        // C s_4_19: const #12s : i
        let s_4_19: i128 = 12;
        ...
        // D s_4_27: cast reint s_4_26 -> u20
        let s_4_27: u32 = (s_4_26.value() as u32);
        // S s_4_28: cast zx s_4_18 -> bv
        let s_4_28: Bits = Bits::new(s_4_18 as u128, 32u16);
        // D s_4_29: cast zx s_4_27 -> bv
        let s_4_29: Bits = Bits::new(s_4_27 as u128, 20u16);
        ...
        // D s_4_38: cast reint s_4_37 -> u52
        let s_4_38: u64 = (s_4_37.value() as u64);
        // C s_4_39: const #12s : i
        let s_4_39: i128 = 12;
        // S s_4_40: call Zeros(s_4_39)
        let s_4_40: Bits = Zeros(state, tracer, s_4_39);
        // S s_4_41: cast reint s_4_40 -> u12
        let s_4_41: u16 = (s_4_40.value() as u16);
        // D s_4_42: cast zx s_4_38 -> bv
        let s_4_42: Bits = Bits::new(s_4_38 as u128, 52u16);
        // S s_4_43: cast zx s_4_41 -> bv
        let s_4_43: Bits = Bits::new(s_4_41 as u128, 12u16);
        // D s_4_44: cast reint s_4_42 -> u128
        let s_4_44: u128 = (s_4_42.value() as u128);
        // D s_4_45: size-of s_4_42
        let s_4_45: u16 = s_4_42.length();
        // S s_4_46: cast reint s_4_43 -> u128
        ...
        // D s_4_53: write-var r.0 <= s_4_52
        fn_state.r._0 = s_4_52;
        // D s_4_54: read-var r:struct
        let s_4_54: ProductTypefb7b2cabacce34a2 = fn_state.r;
        // D s_4_55: read-var shareability:u32
        let s_4_55: u32 = fn_state.shareability;
        // D s_4_56: call TLBI(s_4_54, s_4_55)
        let s_4_56: () = TLBI(state, tracer, s_4_54, s_4_55);
        // D s_4_57: read-var shareability:u32
        let s_4_57: u32 = fn_state.shareability;
        // C s_4_58: const #0u : u32
        let s_4_58: u32 = 0;
        // D s_4_59: cmp-eq s_4_57 s_4_58
        let s_4_59: bool = ((s_4_57) == (s_4_58));
        // N s_4_60: branch s_4_59 b6 b5
        if s_4_59 {
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #1u : u8
        let s_7_0: bool = true;
        // D s_7_1: write-var gs#32455 <= s_7_0
        fn_state.gs_32455 = s_7_0;
        // N s_7_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #1u : u8
        let s_8_0: bool = true;
        // D s_8_1: write-var gs#32456 <= s_8_0
        fn_state.gs_32456 = s_8_0;
        // N s_8_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
