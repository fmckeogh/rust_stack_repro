...
extern crate alloc;
use execute_ADD_ZA_ZW_2x2::*;
use CurrentVL_read::*;
use HaveSME2::*;
use HaveSMEI16I64::*;
use common::*;
pub fn decode_ADD_ZA_ZW_2x2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    sz: bool,
    Rv: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var gs#271726 <= s_2_0
        fn_state.gs_271726 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#271726:u8
        let s_3_0: bool = fn_state.gs_271726;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_8: call execute_ADD_ZA_ZW_2x2(s_5_0, s_5_3, s_5_5, s_5_4, s_5_6, s_5_7)
        let s_5_8: () = execute_ADD_ZA_ZW_2x2(
            state,
            tracer,
            s_5_0,
            s_5_3,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_8: call execute_ADD_ZA_ZW_2x2(s_7_0, s_7_3, s_7_5, s_7_4, s_7_6, s_7_7)
        let s_7_8: () = execute_ADD_ZA_ZW_2x2(
            state,
            tracer,
            s_7_0,
            s_7_3,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_8: call execute_ADD_ZA_ZW_2x2(s_9_0, s_9_3, s_9_5, s_9_4, s_9_6, s_9_7)
        let s_9_8: () = execute_ADD_ZA_ZW_2x2(
            state,
            tracer,
            s_9_0,
            s_9_3,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_8: call execute_ADD_ZA_ZW_2x2(s_11_0, s_11_3, s_11_5, s_11_4, s_11_6, s_11_7)
        let s_11_8: () = execute_ADD_ZA_ZW_2x2(
            state,
            tracer,
            s_11_0,
            s_11_3,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_8: call execute_ADD_ZA_ZW_2x2(s_13_0, s_13_3, s_13_5, s_13_4, s_13_6, s_13_7)
        let s_13_8: () = execute_ADD_ZA_ZW_2x2(
            state,
            tracer,
            s_13_0,
            s_13_3,
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_3: write-var gs#271726 <= s_16_2
        fn_state.gs_271726 = s_16_2;
        // N s_16_4: jump b3
        return block_3(state, tracer, fn_state);
    }
