...
use common::*;
pub fn CNTVOFF_SysRegWrite64_772809c07f941c73<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_15: call CNTVOFF_write(s_6_14)
        let s_6_15: () = CNTVOFF_write(state, tracer, s_6_14);
        // N s_6_16: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_15: call CNTVOFF_write(s_8_14)
        let s_8_15: () = CNTVOFF_write(state, tracer, s_8_14);
        // N s_8_16: return
        return;
    }
    fn block_9<T: Tracer>(
