...
extern crate alloc;
use execute_MOVA_ZA_P_RZ_B::*;
use CurrentVL_read::*;
use HaveSME::*;
use common::*;
pub fn decode_MOVA_ZA_P_RZ_B<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Q: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        fn_state.n = s_1_25;
        // D s_1_27: read-var off4:u8
        let s_1_27: u8 = fn_state.off4;
        // D s_1_28: cast zx s_1_27 -> bv
        let s_1_28: Bits = Bits::new(s_1_27 as u128, 4u16);
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_8: call execute_MOVA_ZA_P_RZ_B(s_2_0, s_2_1, s_2_2, s_2_3, s_2_4, s_2_5, s_2_6, s_2_7)
        let s_2_8: () = execute_MOVA_ZA_P_RZ_B(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_8: call execute_MOVA_ZA_P_RZ_B(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5, s_4_6, s_4_7)
        let s_4_8: () = execute_MOVA_ZA_P_RZ_B(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_8: call execute_MOVA_ZA_P_RZ_B(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5, s_6_6, s_6_7)
        let s_6_8: () = execute_MOVA_ZA_P_RZ_B(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_8: call execute_MOVA_ZA_P_RZ_B(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5, s_8_6, s_8_7)
        let s_8_8: () = execute_MOVA_ZA_P_RZ_B(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_8: call execute_MOVA_ZA_P_RZ_B(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5, s_10_6, s_10_7)
        let s_10_8: () = execute_MOVA_ZA_P_RZ_B(
            state,
            tracer,
            s_10_0,
            s_10_1,
