...
use common::*;
pub fn decode_aarch32_instrs_PLD_i_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    U: bool,
    R: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_18: read-var R:u8
        let s_3_18: bool = fn_state.R;
        // D s_3_19: cast zx s_3_18 -> bv
        let s_3_19: Bits = Bits::new(s_3_18 as u128, 1u16);
        // C s_3_20: const #0u : u8
        let s_3_20: bool = false;
        ...
        // D s_3_23: call execute_aarch32_instrs_PLD_i_Op_A_txt(s_3_17, s_3_12, s_3_22, s_3_3)
        let s_3_23: () = execute_aarch32_instrs_PLD_i_Op_A_txt(
            state,
            tracer,
            s_3_17,
            s_3_12,
