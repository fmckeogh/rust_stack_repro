...
extern crate alloc;
use HaveAESExt::*;
use execute_aarch64_instrs_vector_crypto_aes_mix::*;
use common::*;
pub fn decode_aesimc_advsimd_aarch64_instrs_vector_crypto_aes_mix<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_7: call execute_aarch64_instrs_vector_crypto_aes_mix(s_1_5, s_1_4, s_1_6)
        let s_1_7: () = execute_aarch64_instrs_vector_crypto_aes_mix(
            state,
            tracer,
            s_1_5,
            s_1_4,
