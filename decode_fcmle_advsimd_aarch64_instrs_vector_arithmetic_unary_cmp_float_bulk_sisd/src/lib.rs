...
use common::*;
pub fn decode_fcmle_advsimd_aarch64_instrs_vector_arithmetic_unary_cmp_float_bulk_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, op: bool, sz: bool, U: bool) -> () {
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_32: write-var ga#253305 <= s_0_31
        fn_state.ga_253305 = s_0_31;
        // D s_0_33: read-var ga#253305:u8
        let s_0_33: u8 = fn_state.ga_253305;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#253305:u8
        let s_3_0: u8 = fn_state.ga_253305;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var ga#253305:u8
        let s_5_0: u8 = fn_state.ga_253305;
