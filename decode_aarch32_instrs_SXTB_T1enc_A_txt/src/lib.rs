...
use common::*;
pub fn decode_aarch32_instrs_SXTB_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rm: u8,
    Rd: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_8: i64 = 0;
        // D s_2_9: call execute_aarch32_instrs_SXTB_Op_A_txt(s_2_3, s_2_7, s_2_8)
        let s_2_9: () = execute_aarch32_instrs_SXTB_Op_A_txt(
            state,
            tracer,
            s_2_3,
            s_2_7,
