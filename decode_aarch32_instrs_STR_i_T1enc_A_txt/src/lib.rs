...
use common::*;
pub fn decode_aarch32_instrs_STR_i_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm5: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_19: call execute_aarch32_instrs_STR_i_OpT_A_txt(s_2_17, s_2_15, s_2_16, s_2_7, s_2_3, s_2_18)
        let s_2_19: () = execute_aarch32_instrs_STR_i_OpT_A_txt(
            state,
            tracer,
            s_2_17,
            s_2_15,
