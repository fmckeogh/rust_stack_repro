...
extern crate alloc;
use HaveSVE::*;
use execute_ST1D_Z_P_BZ_D_x32_scaled::*;
use CurrentVL_read::*;
use common::*;
pub fn decode_ST1D_Z_P_BZ_D_x32_scaled<T: Tracer>(
    state: &mut State,
    tracer: &T,
    msz: u8,
    Zm: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_10: call execute_ST1D_Z_P_BZ_D_x32_scaled(s_2_0, s_2_1, s_2_2, s_2_3, s_2_4, s_2_5, s_2_6, s_2_7, s_2_8, s_2_9)
        let s_2_10: () = execute_ST1D_Z_P_BZ_D_x32_scaled(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_10: call execute_ST1D_Z_P_BZ_D_x32_scaled(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5, s_4_6, s_4_7, s_4_8, s_4_9)
        let s_4_10: () = execute_ST1D_Z_P_BZ_D_x32_scaled(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_10: call execute_ST1D_Z_P_BZ_D_x32_scaled(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5, s_6_6, s_6_7, s_6_8, s_6_9)
        let s_6_10: () = execute_ST1D_Z_P_BZ_D_x32_scaled(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_10: call execute_ST1D_Z_P_BZ_D_x32_scaled(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5, s_8_6, s_8_7, s_8_8, s_8_9)
        let s_8_10: () = execute_ST1D_Z_P_BZ_D_x32_scaled(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_10: call execute_ST1D_Z_P_BZ_D_x32_scaled(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5, s_10_6, s_10_7, s_10_8, s_10_9)
        let s_10_10: () = execute_ST1D_Z_P_BZ_D_x32_scaled(
            state,
            tracer,
            s_10_0,
            s_10_1,
