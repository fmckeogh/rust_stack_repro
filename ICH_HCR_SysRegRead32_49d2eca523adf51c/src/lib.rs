...
use common::*;
pub fn ICH_HCR_SysRegRead32_49d2eca523adf51c<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    struct FunctionState {
        gs_111730: bool,
        ga_180551: ProductType700c18a878c5601b,
        ...
        u__PSTATE_EL: u8,
        gs_111731: bool,
        ga_180545: ProductType700c18a878c5601b,
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #() : ()
        let s_6_0: () = ();
        // S s_6_1: call ICH_HCR_read(s_6_0)
        let s_6_1: ProductType700c18a878c5601b = ICH_HCR_read(state, tracer, s_6_0);
        // S s_6_2: call __get_ICH_HCR(s_6_1)
        let s_6_2: ProductType700c18a878c5601b = u__get_ICH_HCR(state, tracer, s_6_1);
        // D s_6_3: write-var ga#180551 <= s_6_2
        fn_state.ga_180551 = s_6_2;
        // D s_6_4: read-var ga#180551.0:struct
        let s_6_4: u32 = fn_state.ga_180551._0;
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #() : ()
        let s_9_0: () = ();
        // S s_9_1: call ICH_HCR_read(s_9_0)
        let s_9_1: ProductType700c18a878c5601b = ICH_HCR_read(state, tracer, s_9_0);
        // S s_9_2: call __get_ICH_HCR(s_9_1)
        let s_9_2: ProductType700c18a878c5601b = u__get_ICH_HCR(state, tracer, s_9_1);
        // D s_9_3: write-var ga#180545 <= s_9_2
        fn_state.ga_180545 = s_9_2;
        // D s_9_4: read-var ga#180545.0:struct
        let s_9_4: u32 = fn_state.ga_180545._0;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#111729 <= s_12_0
        fn_state.gs_111729 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#111729:u8
        let s_13_0: bool = fn_state.gs_111729;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#111730 <= s_14_0
        fn_state.gs_111730 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#111730:u8
        let s_15_0: bool = fn_state.gs_111730;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#111731 <= s_17_0
        fn_state.gs_111731 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#111731:u8
        let s_18_0: bool = fn_state.gs_111731;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#111732 <= s_19_0
        fn_state.gs_111732 = s_19_0;
        // N s_19_2: jump b20
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_0: read-var gs#111732:u8
        let s_20_0: bool = fn_state.gs_111732;
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_5: write-var gs#111732 <= s_23_4
        fn_state.gs_111732 = s_23_4;
        // N s_23_6: jump b20
        return block_20(state, tracer, fn_state);
    }
    fn block_24<T: Tracer>(
        ...
        // D s_24_3: write-var gs#111731 <= s_24_2
        fn_state.gs_111731 = s_24_2;
        // N s_24_4: jump b18
        return block_18(state, tracer, fn_state);
    }
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_5: write-var gs#111730 <= s_26_4
        fn_state.gs_111730 = s_26_4;
        // N s_26_6: jump b15
        return block_15(state, tracer, fn_state);
    }
    fn block_27<T: Tracer>(
        ...
        // D s_27_4: write-var gs#111729 <= s_27_3
        fn_state.gs_111729 = s_27_3;
        // N s_27_5: jump b13
        return block_13(state, tracer, fn_state);
    }
