...
use common::*;
pub fn MVFR0_EL1_SysRegRead_dd15ac4d4e4917f3<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#63445 <= s_8_0
        fn_state.gs_63445 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#63445:u8
        let s_9_0: bool = fn_state.gs_63445;
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 64;
        // C s_10_1: const #90424u : u32
        let s_10_1: u32 = 90424;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#63445 <= s_12_4
        fn_state.gs_63445 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#63447 <= s_16_0
        fn_state.gs_63447 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#63447:u8
        let s_17_0: bool = fn_state.gs_63447;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_5: write-var gs#63447 <= s_20_4
        fn_state.gs_63447 = s_20_4;
        // N s_20_6: jump b17
        return block_17(state, tracer, fn_state);
    }
}
