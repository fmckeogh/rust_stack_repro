...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_SMLALD_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_SMLALD_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    RdHi: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#301281 <= s_3_3
        fn_state.gs_301281 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#301281:u8
        let s_4_0: bool = fn_state.gs_301281;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#301283 <= s_5_3
        fn_state.gs_301283 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#301283:u8
        let s_6_0: bool = fn_state.gs_301283;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#301285 <= s_7_3
        fn_state.gs_301285 = s_7_3;
        // N s_7_5: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#301285:u8
        let s_8_0: bool = fn_state.gs_301285;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: call execute_aarch32_instrs_SMLALD_Op_A_txt(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4)
        let s_10_5: () = execute_aarch32_instrs_SMLALD_Op_A_txt(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#301285 <= s_13_0
        fn_state.gs_301285 = s_13_0;
        // N s_13_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#301283 <= s_14_0
        fn_state.gs_301283 = s_14_0;
        // N s_14_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#301281 <= s_15_0
        fn_state.gs_301281 = s_15_0;
        // N s_15_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
