...
use common::*;
pub fn decode_aarch32_instrs_VCVT_hs_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    size: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#307977 <= s_4_0
        fn_state.gs_307977 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#307977:u8
        let s_5_0: bool = fn_state.gs_307977;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#307980 <= s_7_0
        fn_state.gs_307980 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#307980:u8
        let s_8_0: bool = fn_state.gs_307980;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_22: write-var gs#307980 <= s_11_21
        fn_state.gs_307980 = s_11_21;
        // N s_11_23: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_22: write-var gs#307977 <= s_13_21
        fn_state.gs_307977 = s_13_21;
        // N s_13_23: jump b5
        return block_5(state, tracer, fn_state);
    }
