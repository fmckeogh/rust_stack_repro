...
pub fn u__get_HSCTLR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #32s : i
        let s_0_3: i128 = 32;
        // C s_0_4: const #131584u : u20
        let s_0_4: u32 = 131584;
        ...
        // D s_0_15: call Mk_HSCTLR_Type(s_0_14)
        let s_0_15: ProductType700c18a878c5601b = Mk_HSCTLR_Type(state, tracer, s_0_14);
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_13: call Mk_HSCTLR_Type(s_5_12)
        let s_5_13: ProductType700c18a878c5601b = Mk_HSCTLR_Type(state, tracer, s_5_12);
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_22: call Mk_HSCTLR_Type(s_6_21)
        let s_6_22: ProductType700c18a878c5601b = Mk_HSCTLR_Type(state, tracer, s_6_21);
