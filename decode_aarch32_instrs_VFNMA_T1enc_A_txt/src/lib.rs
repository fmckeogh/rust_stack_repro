...
use execute_aarch32_instrs_VFNMA_Op_A_txt::*;
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_VFNMA_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Vn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_7: write-var gs#309116 <= s_3_6
        fn_state.gs_309116 = s_3_6;
        // N s_3_8: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#309116:u8
        let s_4_0: bool = fn_state.gs_309116;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#309117 <= s_7_0
        fn_state.gs_309117 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#309117:u8
        let s_8_0: bool = fn_state.gs_309117;
        // D s_8_1: write-var gs#309118 <= s_8_0
        fn_state.gs_309118 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#309118:u8
        let s_9_0: bool = fn_state.gs_309118;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#309119 <= s_11_0
        fn_state.gs_309119 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#309119:u8
        let s_12_0: bool = fn_state.gs_309119;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_5: write-var op1_neg <= s_13_4
        fn_state.op1_neg = s_13_4;
        // C s_13_6: const #16s : i64
        let s_13_6: i64 = 16;
        // D s_13_7: write-var esize <= s_13_6
        fn_state.esize = s_13_6;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_4: read-var op1_neg:u8
        let s_15_4: bool = fn_state.op1_neg;
        // D s_15_5: call execute_aarch32_instrs_VFNMA_Op_A_txt(s_15_3, s_15_2, s_15_1, s_15_0, s_15_4)
        let s_15_5: () = execute_aarch32_instrs_VFNMA_Op_A_txt(
            state,
            tracer,
            s_15_3,
            s_15_2,
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_2: write-var gs#309119 <= s_22_1
        fn_state.gs_309119 = s_22_1;
        // N s_22_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_3: write-var gs#309117 <= s_24_2
        fn_state.gs_309117 = s_24_2;
        // N s_24_4: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#309118 <= s_25_0
        fn_state.gs_309118 = s_25_0;
        // N s_25_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_1: write-var gs#309116 <= s_27_0
        fn_state.gs_309116 = s_27_0;
        // N s_27_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
