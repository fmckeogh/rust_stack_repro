...
use common::*;
pub fn decode_and_log_imm_aarch64_instrs_integer_logical_immediate<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    struct FunctionState {
        ...
        op: u32,
        n: i64,
        setflagsshadow_1041: bool,
        d: i64,
        ga_249395: ProductTypebc91b195b0b2a883,
        opshadow_1040: u32,
        datasize: i64,
        gs_143367: bool,
        Rd: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 32;
        // D s_1_1: write-var ga#249390 <= s_1_0
        fn_state.ga_249390 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#249390:i64
        let s_2_0: i64 = fn_state.ga_249390;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var opshadow#1040 <= s_4_0
        fn_state.opshadow_1040 = s_4_0;
        // D s_4_2: read-var setflags:u8
        let s_4_2: bool = fn_state.setflags;
        // D s_4_3: write-var setflagsshadow#1041 <= s_4_2
        fn_state.setflagsshadow_1041 = s_4_2;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#143367 <= s_5_0
        fn_state.gs_143367 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#143367:u8
        let s_6_0: bool = fn_state.gs_143367;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_9: write-var ga#249395 <= s_7_8
        fn_state.ga_249395 = s_7_8;
        // N s_7_10: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var ga#249395.0:struct
        let s_8_0: Bits = fn_state.ga_249395._0;
        ...
        // D s_8_6: read-var opshadow#1040:u32
        let s_8_6: u32 = fn_state.opshadow_1040;
        // D s_8_7: read-var setflagsshadow#1041:u8
        let s_8_7: bool = fn_state.setflagsshadow_1041;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: write-var gs#143367 <= s_10_4
        fn_state.gs_143367 = s_10_4;
        // N s_10_6: jump b6
        return block_6(state, tracer, fn_state);
    }
    ...
    fn block_16<T: Tracer>(
        ...
        let s_16_0: i64 = 64;
        // D s_16_1: write-var ga#249390 <= s_16_0
        fn_state.ga_249390 = s_16_0;
        // N s_16_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
