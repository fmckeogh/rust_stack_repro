...
use HaveSVE2p1::*;
use CurrentVL_read::*;
use execute_ST1Q_Z_P_AR_D_64_unscaled::*;
use common::*;
pub fn decode_ST1Q_Z_P_AR_D_64_unscaled<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rm: u8,
    Pg: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 128;
        // D s_2_1: read-var g:i64
        let s_2_1: i64 = fn_state.g;
        // D s_2_2: read-var m:i64
        let s_2_2: i64 = fn_state.m;
        // D s_2_3: read-var n:i64
        let s_2_3: i64 = fn_state.n;
        // D s_2_4: read-var t:i64
        let s_2_4: i64 = fn_state.t;
        // D s_2_5: call execute_ST1Q_Z_P_AR_D_64_unscaled(s_2_0, s_2_1, s_2_2, s_2_3, s_2_4)
        let s_2_5: () = execute_ST1Q_Z_P_AR_D_64_unscaled(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 256;
        // D s_4_1: read-var g:i64
        let s_4_1: i64 = fn_state.g;
        ...
        // D s_4_5: call execute_ST1Q_Z_P_AR_D_64_unscaled(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4)
        let s_4_5: () = execute_ST1Q_Z_P_AR_D_64_unscaled(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 512;
        // D s_6_1: read-var g:i64
        let s_6_1: i64 = fn_state.g;
        ...
        // D s_6_5: call execute_ST1Q_Z_P_AR_D_64_unscaled(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4)
        let s_6_5: () = execute_ST1Q_Z_P_AR_D_64_unscaled(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 1024;
        // D s_8_1: read-var g:i64
        let s_8_1: i64 = fn_state.g;
        ...
        // D s_8_5: call execute_ST1Q_Z_P_AR_D_64_unscaled(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4)
        let s_8_5: () = execute_ST1Q_Z_P_AR_D_64_unscaled(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 2048;
        // D s_10_1: read-var g:i64
        let s_10_1: i64 = fn_state.g;
        ...
        // D s_10_5: call execute_ST1Q_Z_P_AR_D_64_unscaled(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4)
        let s_10_5: () = execute_ST1Q_Z_P_AR_D_64_unscaled(
            state,
            tracer,
            s_10_0,
            s_10_1,
