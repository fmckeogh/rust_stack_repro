...
extern crate alloc;
use execute_aarch64_instrs_integer_tags_mcsettagpost::*;
use HaveMTEExt::*;
use common::*;
pub fn decode_stg_aarch64_instrs_integer_tags_mcsettagpost<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Xt: u8,
    Xn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_22: call execute_aarch64_instrs_integer_tags_mcsettagpost(s_1_3, s_1_18, s_1_20, s_1_7, s_1_19, s_1_21)
        let s_1_22: () = execute_aarch64_instrs_integer_tags_mcsettagpost(
            state,
            tracer,
            s_1_3,
            s_1_18,
