...
use D_read::*;
use common::*;
pub fn execute_aarch32_instrs_VRINTX_asimd_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d__arg: i64,
    elements: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#7946 <= s_0_2
        fn_state.esizeshadow_7946 = s_0_2;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_6: write-var gs#325563 <= s_1_5
        fn_state.gs_325563 = s_1_5;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#325563:i64
        let s_2_1: i64 = fn_state.gs_325563;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_6: write-var gs#325569 <= s_3_5
        fn_state.gs_325569 = s_3_5;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#325569:i64
        let s_4_1: i64 = fn_state.gs_325569;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_8: read-var esizeshadow#7946:i64
        let s_5_8: i64 = fn_state.esizeshadow_7946;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_9: read-var esizeshadow#7946:i64
        let s_6_9: i64 = fn_state.esizeshadow_7946;
