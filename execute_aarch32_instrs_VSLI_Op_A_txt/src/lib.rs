...
use D_read::*;
use common::*;
pub fn execute_aarch32_instrs_VSLI_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d__arg: i64,
    elements: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#7824 <= s_0_2
        fn_state.esizeshadow_7824 = s_0_2;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var esizeshadow#7824:i64
        let s_1_0: i64 = fn_state.esizeshadow_7824;
        // D s_1_1: cast zx s_1_0 -> i
        let s_1_1: i128 = (i128::try_from(s_1_0).unwrap());
        // D s_1_2: call Ones(s_1_1)
        let s_1_2: Bits = Ones(state, tracer, s_1_1);
        // D s_1_3: read-var shift_amount:i
        let s_1_3: i128 = fn_state.shift_amount;
        // D s_1_4: lsl s_1_2 s_1_3
        let s_1_4: Bits = s_1_2 << s_1_3;
        // D s_1_5: write-var mask <= s_1_4
        fn_state.mask = s_1_4;
        ...
        // D s_1_12: write-var gs#319381 <= s_1_11
        fn_state.gs_319381 = s_1_11;
        // D s_1_13: write-var r <= s_1_6
        fn_state.r = s_1_6;
        // N s_1_14: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#319381:i64
        let s_2_1: i64 = fn_state.gs_319381;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_6: write-var gs#319387 <= s_3_5
        fn_state.gs_319387 = s_3_5;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#319387:i64
        let s_4_1: i64 = fn_state.gs_319387;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_8: read-var esizeshadow#7824:i64
        let s_5_8: i64 = fn_state.esizeshadow_7824;
        ...
        // D s_5_30: read-var r:i64
        let s_5_30: i64 = fn_state.r;
        // D s_5_31: cast zx s_5_30 -> i
        let s_5_31: i128 = (i128::try_from(s_5_30).unwrap());
        // D s_5_32: read-var d:i
        let s_5_32: i128 = fn_state.d;
        // D s_5_33: add s_5_32 s_5_31
        let s_5_33: i128 = (s_5_32 + s_5_31);
        // D s_5_34: call D_read(s_5_33)
        let s_5_34: u64 = D_read(state, tracer, s_5_33);
        // D s_5_35: read-var esizeshadow#7824:i64
        let s_5_35: i64 = fn_state.esizeshadow_7824;
        ...
        // D s_5_38: cast zx s_5_34 -> bv
        let s_5_38: Bits = Bits::new(s_5_34 as u128, 64u16);
        // D s_5_39: read-var e:i64
        let s_5_39: i64 = fn_state.e;
        // D s_5_40: cast zx s_5_39 -> i
        let s_5_40: i128 = (i128::try_from(s_5_39).unwrap());
        // D s_5_41: cast zx s_5_37 -> i
        let s_5_41: i128 = (i128::try_from(s_5_37).unwrap());
        // D s_5_42: call Elem_read(s_5_38, s_5_40, s_5_41)
        let s_5_42: Bits = Elem_read(state, tracer, s_5_38, s_5_40, s_5_41);
        // D s_5_43: read-var mask:bv
        let s_5_43: Bits = fn_state.mask;
        // D s_5_44: not s_5_43
        let s_5_44: Bits = !s_5_43;
        // D s_5_45: and s_5_42 s_5_44
        let s_5_45: Bits = ((s_5_42) & (s_5_44));
        // D s_5_46: or s_5_45 s_5_17
        let s_5_46: Bits = ((s_5_45) | (s_5_17));
        // D s_5_47: cast zx s_5_26 -> bv
        let s_5_47: Bits = Bits::new(s_5_26 as u128, 64u16);
        // D s_5_48: read-var e:i64
        let s_5_48: i64 = fn_state.e;
        // D s_5_49: cast zx s_5_48 -> i
        let s_5_49: i128 = (i128::try_from(s_5_48).unwrap());
        // D s_5_50: cast zx s_5_29 -> i
        let s_5_50: i128 = (i128::try_from(s_5_29).unwrap());
        ...
        // D s_5_53: call D_set(s_5_21, s_5_52)
        let s_5_53: () = D_set(state, tracer, s_5_21, s_5_52);
