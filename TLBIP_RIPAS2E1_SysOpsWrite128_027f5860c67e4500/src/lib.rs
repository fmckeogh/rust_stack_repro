...
use common::*;
pub fn TLBIP_RIPAS2E1_SysOpsWrite128_027f5860c67e4500<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#138192 <= s_11_0
        fn_state.gs_138192 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#138192:u8
        let s_12_0: bool = fn_state.gs_138192;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_5: write-var gs#138192 <= s_15_4
        fn_state.gs_138192 = s_15_4;
        // N s_15_6: jump b12
        return block_12(state, tracer, fn_state);
    }
