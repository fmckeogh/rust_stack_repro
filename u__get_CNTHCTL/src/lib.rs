...
use Mk_CNTHCTL_Type::*;
use common::*;
pub fn u__get_CNTHCTL<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4293918720u : u32
        let s_0_3: u32 = 4293918720;
        ...
        // D s_0_11: tail-call Mk_CNTHCTL_Type(s_0_10)
        return Mk_CNTHCTL_Type(state, tracer, s_0_10);
    }
}
