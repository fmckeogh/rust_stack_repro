...
use common::*;
pub fn TLBIP_RIPAS2E1OS_SysOpsWrite128_7ffb607d8c97e12e<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#138182 <= s_11_0
        fn_state.gs_138182 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#138182:u8
        let s_12_0: bool = fn_state.gs_138182;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_5: write-var gs#138182 <= s_15_4
        fn_state.gs_138182 = s_15_4;
        // N s_15_6: jump b12
        return block_12(state, tracer, fn_state);
    }
