...
use common::*;
pub fn decode_aarch32_instrs_LDRBT_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    Rt: u8,
    ...
    struct FunctionState {
        ...
        t: i64,
        imm32: u32,
        shift_tshadow_7162: u32,
        shift_t: u32,
        n: i64,
        mshadow_7164: i128,
        shift_nshadow_7163: i128,
        Rn: u8,
        Rt: u8,
        imm8: u8,
    }
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var shift_tshadow#7162 <= s_3_0
        fn_state.shift_tshadow_7162 = s_3_0;
        // D s_3_2: read-var shift_n:i
        let s_3_2: i128 = fn_state.shift_n;
        // D s_3_3: write-var shift_nshadow#7163 <= s_3_2
        fn_state.shift_nshadow_7163 = s_3_2;
        // D s_3_4: read-var m:i
        let s_3_4: i128 = fn_state.m;
        // D s_3_5: write-var mshadow#7164 <= s_3_4
        fn_state.mshadow_7164 = s_3_4;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: read-var mshadow#7164:i
        let s_4_2: i128 = fn_state.mshadow_7164;
        ...
        // D s_4_6: read-var shift_nshadow#7163:i
        let s_4_6: i128 = fn_state.shift_nshadow_7163;
        // D s_4_7: read-var shift_tshadow#7162:u32
        let s_4_7: u32 = fn_state.shift_tshadow_7162;
        // D s_4_8: read-var t:i64
        let s_4_8: i64 = fn_state.t;
        // D s_4_9: call execute_aarch32_instrs_LDRBT_Op_A_txt(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5, s_4_6, s_4_7, s_4_8)
        let s_4_9: () = execute_aarch32_instrs_LDRBT_Op_A_txt(
            state,
            tracer,
            s_4_0,
            s_4_1,
