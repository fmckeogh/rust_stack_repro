...
use common::*;
pub fn IsHCRXEL2Enabled<T: Tracer>(state: &mut State, tracer: &T, gs_6780: ()) -> bool {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_0: const #() : ()
        let s_0_0: () = ();
        // S s_0_1: call HaveFeatHCX(s_0_0)
        let s_0_1: bool = HaveFeatHCX(state, tracer, s_0_0);
        // S s_0_2: not s_0_1
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var gs#6781 <= s_2_0
        fn_state.gs_6781 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#6781:u8
        let s_3_0: bool = fn_state.gs_6781;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_2: call _get_SCR_EL3_Type_HXEn(s_7_1)
        let s_7_2: bool = u_get_SCR_EL3_Type_HXEn(state, tracer, s_7_1);
        ...
        // D s_7_7: write-var gs#6781 <= s_7_6
        fn_state.gs_6781 = s_7_6;
        // N s_7_8: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
