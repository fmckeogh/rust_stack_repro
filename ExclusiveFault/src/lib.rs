...
use GPCNoFault::*;
use common::*;
pub fn ExclusiveFault<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#13522 <= s_1_0
        fn_state.gs_13522 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#13522:u8
        let s_2_0: bool = fn_state.gs_13522;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#13522 <= s_3_0
        fn_state.gs_13522 = s_3_0;
        // N s_3_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
