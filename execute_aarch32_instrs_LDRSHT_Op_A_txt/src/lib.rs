...
use common::*;
pub fn execute_aarch32_instrs_LDRSHT_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    add: bool,
    imm32: u32,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#298206 <= s_8_0
        fn_state.gs_298206 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#298206:u8
        let s_9_0: bool = fn_state.gs_298206;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#298207 <= s_10_0
        fn_state.gs_298207 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#298207:u8
        let s_11_0: bool = fn_state.gs_298207;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_3: write-var gs#881015 <= s_13_2
        fn_state.gs_881015 = s_13_2;
        // N s_13_4: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#881015:bv
        let s_14_0: Bits = fn_state.gs_881015;
    ...
    fn block_16<T: Tracer>(
        ...
        let s_16_0: i128 = 32;
        // D s_16_1: read-var data:u16
        let s_16_1: u16 = fn_state.data;
        // D s_16_2: cast zx s_16_1 -> bv
        let s_16_2: Bits = Bits::new(s_16_1 as u128, 16u16);
        // D s_16_3: bits-cast sx s_16_2 -> bv length s_16_0
        let s_16_3: Bits = s_16_2.sign_extend(s_16_0);
        // D s_16_4: cast reint s_16_3 -> u32
        let s_16_4: u32 = (s_16_3.value() as u32);
        // D s_16_5: read-var t:i64
        let s_16_5: i64 = fn_state.t;
        // D s_16_6: cast zx s_16_5 -> i
        let s_16_6: i128 = (i128::try_from(s_16_5).unwrap());
        // D s_16_7: call R_set(s_16_6, s_16_4)
        let s_16_7: () = R_set(state, tracer, s_16_6, s_16_4);
        // N s_16_8: return
        return;
    }
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_6: write-var gs#298207 <= s_19_5
        fn_state.gs_298207 = s_19_5;
        // N s_19_7: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_4: write-var gs#298206 <= s_20_3
        fn_state.gs_298206 = s_20_3;
        // N s_20_5: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_2: write-var offset <= s_23_1
        fn_state.offset = s_23_1;
        // N s_23_3: jump b3
        return block_3(state, tracer, fn_state);
    }
