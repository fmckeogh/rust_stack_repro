...
use X_read::*;
use common::*;
pub fn TCO_SysRegWrite_ad1525aaa3fbe60d<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_21: const #16994u : u32
        let s_5_21: u32 = 16994;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_21: const #16994u : u32
        let s_6_21: u32 = 16994;
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_21: const #16994u : u32
        let s_7_21: u32 = 16994;
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_21: const #16994u : u32
        let s_8_21: u32 = 16994;
