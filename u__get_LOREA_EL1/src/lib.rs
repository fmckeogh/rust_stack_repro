...
use common::*;
pub fn u__get_LOREA_EL1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #18374686479671689215u : u64
        let s_0_3: u64 = 18374686479671689215;
        ...
        // D s_0_11: tail-call Mk_LOREA_EL1_Type(s_0_10)
        return Mk_LOREA_EL1_Type(state, tracer, s_0_10);
    }
}
