...
use common::*;
pub fn decode_aarch32_instrs_STM_T2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    W: bool,
    Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_5: write-var gs#302170 <= s_3_4
        fn_state.gs_302170 = s_3_4;
        // N s_3_6: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#302170:u8
        let s_4_0: bool = fn_state.gs_302170;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#302172 <= s_6_0
        fn_state.gs_302172 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#302172:u8
        let s_7_0: bool = fn_state.gs_302172;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_3: call execute_aarch32_instrs_STM_Op_A_txt(s_10_0, s_10_1, s_10_2)
        let s_10_3: () = execute_aarch32_instrs_STM_Op_A_txt(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_23: write-var gs#302172 <= s_14_22
        fn_state.gs_302172 = s_14_22;
        // N s_14_24: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#302170 <= s_16_0
        fn_state.gs_302170 = s_16_0;
        // N s_16_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
