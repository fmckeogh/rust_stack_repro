...
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_B_T4enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    S: bool,
    imm10: u16,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#295968 <= s_3_0
        fn_state.gs_295968 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#295968:u8
        let s_4_0: bool = fn_state.gs_295968;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_3: write-var gs#295968 <= s_7_2
        fn_state.gs_295968 = s_7_2;
        // N s_7_4: jump b4
        return block_4(state, tracer, fn_state);
    }
}
