...
use common::*;
pub fn decode_fcvtzs_advsimd_fix_aarch64_instrs_vector_shift_conv_float_sisd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // C s_1_0: const #1u : u8
        let s_1_0: bool = true;
        // D s_1_1: write-var gs#152088 <= s_1_0
        fn_state.gs_152088 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#152088:u8
        let s_2_0: bool = fn_state.gs_152088;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#152093 <= s_3_0
        fn_state.gs_152093 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#152093:u8
        let s_4_0: bool = fn_state.gs_152093;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #1u : u8
        let s_6_0: bool = true;
        // D s_6_1: write-var gs#152095 <= s_6_0
        fn_state.gs_152095 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#152095:u8
        let s_7_0: bool = fn_state.gs_152095;
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#152100 <= s_9_0
        fn_state.gs_152100 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#152100:u8
        let s_10_0: bool = fn_state.gs_152100;
    ...
    fn block_11<T: Tracer>(
        ...
        let s_11_0: i64 = 16;
        // D s_11_1: write-var ga#254888 <= s_11_0
        fn_state.ga_254888 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var ga#254888:i64
        let s_12_0: i64 = fn_state.ga_254888;
        // C s_12_1: const #2s : i
        let s_12_1: i128 = 2;
    ...
    fn block_13<T: Tracer>(
        ...
        let s_13_0: i64 = 32;
        // D s_13_1: write-var ga#254888 <= s_13_0
        fn_state.ga_254888 = s_13_0;
        // N s_13_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#152100 <= s_14_0
        fn_state.gs_152100 = s_14_0;
        // N s_14_2: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        let s_15_0: i64 = 64;
        // D s_15_1: write-var ga#254888 <= s_15_0
        fn_state.ga_254888 = s_15_0;
        // N s_15_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#152095 <= s_16_0
        fn_state.gs_152095 = s_16_0;
        // N s_16_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#152093 <= s_18_0
        fn_state.gs_152093 = s_18_0;
        // N s_18_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#152088 <= s_19_0
        fn_state.gs_152088 = s_19_0;
        // N s_19_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
