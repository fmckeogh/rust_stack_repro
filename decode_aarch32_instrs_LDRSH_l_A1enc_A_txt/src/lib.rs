...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_LDRSH_l_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_LDRSH_l_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    P: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#298118 <= s_3_0
        fn_state.gs_298118 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#298118:u8
        let s_4_0: bool = fn_state.gs_298118;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_5: write-var gs#298123 <= s_6_4
        fn_state.gs_298123 = s_6_4;
        // N s_6_6: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#298123:u8
        let s_7_0: bool = fn_state.gs_298123;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#298125 <= s_8_0
        fn_state.gs_298125 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#298125:u8
        let s_9_0: bool = fn_state.gs_298125;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_3: call execute_aarch32_instrs_LDRSH_l_Op_A_txt(s_10_0, s_10_1, s_10_2)
        let s_10_3: () = execute_aarch32_instrs_LDRSH_l_Op_A_txt(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#298125 <= s_12_0
        fn_state.gs_298125 = s_12_0;
        // N s_12_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#298123 <= s_13_0
        fn_state.gs_298123 = s_13_0;
        // N s_13_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_5: write-var gs#298118 <= s_15_4
        fn_state.gs_298118 = s_15_4;
        // N s_15_6: jump b4
        return block_4(state, tracer, fn_state);
    }
}
