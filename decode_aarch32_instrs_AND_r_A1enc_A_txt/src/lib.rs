...
use common::*;
pub fn decode_aarch32_instrs_AND_r_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    S: bool,
    ...
    struct FunctionState {
        ga_343087: ProductType396b95aa74979079,
        cond: u8,
        S: bool,
        Rn: u8,
        Rd: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_26: write-var ga#343087 <= s_2_25
        fn_state.ga_343087 = s_2_25;
        // D s_2_27: read-var ga#343087.0:struct
        let s_2_27: u32 = fn_state.ga_343087._0;
        // D s_2_28: read-var ga#343087.1:struct
        let s_2_28: i128 = fn_state.ga_343087._1;
        // D s_2_29: call execute_aarch32_instrs_AND_r_Op_A_txt(s_2_9, s_2_17, s_2_13, s_2_22, s_2_28, s_2_27)
        let s_2_29: () = execute_aarch32_instrs_AND_r_Op_A_txt(
            state,
            tracer,
            s_2_9,
            s_2_17,
