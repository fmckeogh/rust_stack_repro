...
use common::*;
pub fn decode_sqrdmlsh_advsimd_vec_aarch64_instrs_vector_arithmetic_binary_uniform_mul_int_doubling_accum_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, S: bool, Rm: u8, size: u8) -> () {
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_5: write-var gs#171167 <= s_2_4
        fn_state.gs_171167 = s_2_4;
        // N s_2_6: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#171167:u8
        let s_3_0: bool = fn_state.gs_171167;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #1u : u8
        let s_6_0: bool = true;
        // D s_6_1: write-var gs#171167 <= s_6_0
        fn_state.gs_171167 = s_6_0;
        // N s_6_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_7<T: Tracer>(
