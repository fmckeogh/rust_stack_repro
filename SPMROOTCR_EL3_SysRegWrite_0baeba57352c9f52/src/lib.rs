...
use SPMROOTCR_EL3_set::*;
use X_read::*;
use common::*;
pub fn SPMROOTCR_EL3_SysRegWrite_0baeba57352c9f52<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_11: call SPMROOTCR_EL3_set(s_5_10, s_5_9)
        let s_5_11: () = SPMROOTCR_EL3_set(state, tracer, s_5_10, s_5_9);
        // N s_5_12: return
        return;
    }
    fn block_6<T: Tracer>(
