...
use common::*;
pub fn VTTBR_EL2_SysRegRead_1816600c5e2db377<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_100336: ProductType782ac6922b48c20d,
        gs_74632: bool,
        ga_100342: ProductType782ac6922b48c20d,
        u__PSTATE_EL: u8,
        u__HCR_EL2_NV: bool,
        ga_100329: u64,
        gs_74633: bool,
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_1: const #() : ()
        let s_5_1: () = ();
        // S s_5_2: call VTTBR_EL2_read(s_5_1)
        let s_5_2: ProductType782ac6922b48c20d = VTTBR_EL2_read(state, tracer, s_5_1);
        // S s_5_3: call __get_VTTBR_EL2(s_5_2)
        let s_5_3: ProductType782ac6922b48c20d = u__get_VTTBR_EL2(state, tracer, s_5_2);
        // D s_5_4: write-var ga#100342 <= s_5_3
        fn_state.ga_100342 = s_5_3;
        // D s_5_5: read-var ga#100342.0:struct
        let s_5_5: u128 = fn_state.ga_100342._0;
        // C s_5_6: const #0s : i
        let s_5_6: i128 = 0;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_1: const #() : ()
        let s_6_1: () = ();
        // S s_6_2: call VTTBR_EL2_read(s_6_1)
        let s_6_2: ProductType782ac6922b48c20d = VTTBR_EL2_read(state, tracer, s_6_1);
        // S s_6_3: call __get_VTTBR_EL2(s_6_2)
        let s_6_3: ProductType782ac6922b48c20d = u__get_VTTBR_EL2(state, tracer, s_6_2);
        // D s_6_4: write-var ga#100336 <= s_6_3
        fn_state.ga_100336 = s_6_3;
        // D s_6_5: read-var ga#100336.0:struct
        let s_6_5: u128 = fn_state.ga_100336._0;
        // C s_6_6: const #0s : i
        let s_6_6: i128 = 0;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#74632 <= s_8_0
        fn_state.gs_74632 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#74632:u8
        let s_9_0: bool = fn_state.gs_74632;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#74633 <= s_11_0
        fn_state.gs_74633 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#74633:u8
        let s_12_0: bool = fn_state.gs_74633;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_5: write-var gs#74633 <= s_15_4
        fn_state.gs_74633 = s_15_4;
        // N s_15_6: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_16<T: Tracer>(
        ...
        // D s_16_6: write-var ga#100329 <= s_16_5
        fn_state.ga_100329 = s_16_5;
        // N s_16_7: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var ga#100329:u64
        let s_17_0: u64 = fn_state.ga_100329;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_21: write-var gs#74632 <= s_18_20
        fn_state.gs_74632 = s_18_20;
        // N s_18_22: jump b9
        return block_9(state, tracer, fn_state);
    }
