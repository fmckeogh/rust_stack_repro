...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_STREX_Op_A_txt::*;
use Zeros::*;
use common::*;
pub fn decode_aarch32_instrs_STREX_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        fn_state.n = s_2_19;
        // C s_2_21: const #32s : i
        let s_2_21: i128 = 32;
        // S s_2_22: call Zeros(s_2_21)
        let s_2_22: Bits = Zeros(state, tracer, s_2_21);
        // S s_2_23: cast reint s_2_22 -> u32
        let s_2_23: u32 = (s_2_22.value() as u32);
        // D s_2_24: write-var imm32 <= s_2_23
        fn_state.imm32 = s_2_23;
        // C s_2_25: const #15s : i
        let s_2_25: i128 = 15;
        // D s_2_26: read-var d:i64
        let s_2_26: i64 = fn_state.d;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#302603 <= s_3_3
        fn_state.gs_302603 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#302603:u8
        let s_4_0: bool = fn_state.gs_302603;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#302605 <= s_5_3
        fn_state.gs_302605 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#302605:u8
        let s_6_0: bool = fn_state.gs_302605;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_5: write-var gs#302606 <= s_8_4
        fn_state.gs_302606 = s_8_4;
        // N s_8_6: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#302606:u8
        let s_9_0: bool = fn_state.gs_302606;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: call execute_aarch32_instrs_STREX_Op_A_txt(s_10_0, s_10_1, s_10_2, s_10_3)
        let s_10_4: () = execute_aarch32_instrs_STREX_Op_A_txt(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#302606 <= s_12_0
        fn_state.gs_302606 = s_12_0;
        // N s_12_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#302605 <= s_14_0
        fn_state.gs_302605 = s_14_0;
        // N s_14_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#302603 <= s_15_0
        fn_state.gs_302603 = s_15_0;
        // N s_15_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
