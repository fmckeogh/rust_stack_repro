...
use P_set::*;
use common::*;
pub fn execute_PMOV_P_ZI_B<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#4404 <= s_0_2
        fn_state.VLshadow_4404 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#4404:i64
        let s_1_0: i64 = fn_state.VLshadow_4404;
        // C s_1_1: const #8s : i
        let s_1_1: i128 = 8;
        ...
        // D s_1_31: write-var gs#221389 <= s_1_30
        fn_state.gs_221389 = s_1_30;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#221389:i64
        let s_2_1: i64 = fn_state.gs_221389;
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_39: Bits = Bits::new(s_3_35 as u128, 1u16);
