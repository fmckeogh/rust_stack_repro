...
use Split::*;
use common::*;
pub fn TTBR1_EL2_SysRegRead128_712360e50061655a<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ...
        u__EDSCR_SDD: bool,
        gs_671096: ProductTypebc91b195b0b2a883,
        gs_137410: bool,
        gs_137409: bool,
        gs_137406: bool,
        gs_671080: ProductTypebc91b195b0b2a883,
        u__PSTATE_EL: u8,
        u__HCR_EL2_NV: bool,
        gs_137408: bool,
        gs_137419: bool,
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_4: cast zx s_5_2 -> i
        let s_5_4: i128 = (i128::try_from(s_5_2).unwrap());
        // D s_5_5: call Split(s_5_3, s_5_4)
        let s_5_5: ProductTypebc91b195b0b2a883 = Split(state, tracer, s_5_3, s_5_4);
        // D s_5_6: write-var gs#671080 <= s_5_5
        fn_state.gs_671080 = s_5_5;
        // D s_5_7: read-var gs#671080.0:struct
        let s_5_7: Bits = fn_state.gs_671080._0;
        // D s_5_8: cast reint s_5_7 -> u64
        let s_5_8: u64 = (s_5_7.value() as u64);
        // D s_5_9: read-var gs#671080.1:struct
        let s_5_9: Bits = fn_state.gs_671080._1;
        ...
        // D s_5_13: add s_5_12 s_5_11
        let s_5_13: i128 = (s_5_12 + s_5_11);
        // C s_5_14: const #64s : i64
        let s_5_14: i64 = 64;
        // D s_5_15: cast zx s_5_8 -> bv
        let s_5_15: Bits = Bits::new(s_5_8 as u128, 64u16);
        // D s_5_16: call X_set(s_5_13, s_5_14, s_5_15)
        let s_5_16: () = X_set(state, tracer, s_5_13, s_5_14, s_5_15);
        // C s_5_17: const #64s : i64
        let s_5_17: i64 = 64;
        // D s_5_18: cast zx s_5_10 -> bv
        let s_5_18: Bits = Bits::new(s_5_10 as u128, 64u16);
        // D s_5_19: read-var t:i
        let s_5_19: i128 = fn_state.t;
        // D s_5_20: call X_set(s_5_19, s_5_17, s_5_18)
        let s_5_20: () = X_set(state, tracer, s_5_19, s_5_17, s_5_18);
        // N s_5_21: return
        return;
    }
    fn block_6<T: Tracer>(
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#137406 <= s_7_0
        fn_state.gs_137406 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#137406:u8
        let s_8_0: bool = fn_state.gs_137406;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#137407 <= s_9_0
        fn_state.gs_137407 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#137407:u8
        let s_10_0: bool = fn_state.gs_137407;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#137408 <= s_11_0
        fn_state.gs_137408 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#137408:u8
        let s_12_0: bool = fn_state.gs_137408;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#137409 <= s_13_0
        fn_state.gs_137409 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#137409:u8
        let s_14_0: bool = fn_state.gs_137409;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#137410 <= s_16_0
        fn_state.gs_137410 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#137410:u8
        let s_17_0: bool = fn_state.gs_137410;
    ...
    fn block_18<T: Tracer>(
        ...
        // C s_18_0: const #18432u : u32
        let s_18_0: u32 = 18432;
        // D s_18_1: read-reg s_18_0:u128
        let s_18_1: u128 = {
            let value = state.read_register::<u128>(s_18_0 as isize);
            tracer.read_register(s_18_0 as isize, value);
            value
        };
        // C s_18_2: const #64s : i64
        let s_18_2: i64 = 64;
        // D s_18_3: cast zx s_18_1 -> bv
        let s_18_3: Bits = Bits::new(s_18_1 as u128, 128u16);
        // C s_18_4: cast zx s_18_2 -> i
        let s_18_4: i128 = (i128::try_from(s_18_2).unwrap());
        // D s_18_5: call Split(s_18_3, s_18_4)
        let s_18_5: ProductTypebc91b195b0b2a883 = Split(state, tracer, s_18_3, s_18_4);
        // D s_18_6: write-var gs#671096 <= s_18_5
        fn_state.gs_671096 = s_18_5;
        // D s_18_7: read-var gs#671096.0:struct
        let s_18_7: Bits = fn_state.gs_671096._0;
        // D s_18_8: cast reint s_18_7 -> u64
        let s_18_8: u64 = (s_18_7.value() as u64);
        // D s_18_9: read-var gs#671096.1:struct
        let s_18_9: Bits = fn_state.gs_671096._1;
        ...
        // D s_18_13: add s_18_12 s_18_11
        let s_18_13: i128 = (s_18_12 + s_18_11);
        // C s_18_14: const #64s : i64
        let s_18_14: i64 = 64;
        // D s_18_15: cast zx s_18_8 -> bv
        let s_18_15: Bits = Bits::new(s_18_8 as u128, 64u16);
        // D s_18_16: call X_set(s_18_13, s_18_14, s_18_15)
        let s_18_16: () = X_set(state, tracer, s_18_13, s_18_14, s_18_15);
        // C s_18_17: const #64s : i64
        let s_18_17: i64 = 64;
        // D s_18_18: cast zx s_18_10 -> bv
        let s_18_18: Bits = Bits::new(s_18_10 as u128, 64u16);
        // D s_18_19: read-var t:i
        let s_18_19: i128 = fn_state.t;
        // D s_18_20: call X_set(s_18_19, s_18_17, s_18_18)
        let s_18_20: () = X_set(state, tracer, s_18_19, s_18_17, s_18_18);
        // N s_18_21: return
        return;
    }
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#137418 <= s_20_0
        fn_state.gs_137418 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#137418:u8
        let s_21_0: bool = fn_state.gs_137418;
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_5: write-var gs#137418 <= s_24_4
        fn_state.gs_137418 = s_24_4;
        // N s_24_6: jump b21
        return block_21(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_5: write-var gs#137410 <= s_25_4
        fn_state.gs_137410 = s_25_4;
        // N s_25_6: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_5: write-var gs#137409 <= s_27_4
        fn_state.gs_137409 = s_27_4;
        // N s_27_6: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_2: write-var gs#137408 <= s_28_1
        fn_state.gs_137408 = s_28_1;
        // N s_28_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_5: write-var gs#137407 <= s_29_4
        fn_state.gs_137407 = s_29_4;
        // N s_29_6: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_4: write-var gs#137406 <= s_30_3
        fn_state.gs_137406 = s_30_3;
        // N s_30_5: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_1: write-var gs#137419 <= s_32_0
        fn_state.gs_137419 = s_32_0;
        // N s_32_2: jump b33
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var gs#137419:u8
        let s_33_0: bool = fn_state.gs_137419;
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_5: write-var gs#137419 <= s_36_4
        fn_state.gs_137419 = s_36_4;
        // N s_36_6: jump b33
        return block_33(state, tracer, fn_state);
    }
