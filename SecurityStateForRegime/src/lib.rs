...
use common::*;
pub fn SecurityStateForRegime<T: Tracer>(
    state: &mut State,
    tracer: &T,
    regime: u32,
) -> u32 {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_2: call SecurityStateAtEL(s_1_1)
        let s_1_2: u32 = SecurityStateAtEL(state, tracer, s_1_1);
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var ga#10042:u32
        let s_11_0: u32 = fn_state.ga_10042;
