...
use common::*;
pub fn TLBI_IPAS2E1_SysOpsWrite_97895c8e9b4d80f7<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#102088 <= s_10_0
        fn_state.gs_102088 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#102088:u8
        let s_11_0: bool = fn_state.gs_102088;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_5: write-var gs#102088 <= s_14_4
        fn_state.gs_102088 = s_14_4;
        // N s_14_6: jump b11
        return block_11(state, tracer, fn_state);
    }
