...
extern crate alloc;
use X_read::*;
use Mk_SPSR_und_Type::*;
use EL2Enabled::*;
use u_get_HCR_EL2_Type_NV::*;
use AArch64_SystemAccessTrap::*;
use common::*;
pub fn SPSR_und_SysRegWrite_684160009ec60b5e<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_SPSR_und_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_SPSR_und_Type(state, tracer, s_5_3);
        // C s_5_5: const #18424u : u32
        let s_5_5: u32 = 18424;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call Mk_SPSR_und_Type(s_6_3)
        let s_6_4: ProductType5c790c8ef59cc8b2 = Mk_SPSR_und_Type(state, tracer, s_6_3);
        // C s_6_5: const #18424u : u32
        let s_6_5: u32 = 18424;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#96542 <= s_8_0
        fn_state.gs_96542 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#96542:u8
        let s_9_0: bool = fn_state.gs_96542;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#96542 <= s_12_4
        fn_state.gs_96542 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
