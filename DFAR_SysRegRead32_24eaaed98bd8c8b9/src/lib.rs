...
use DFAR_NS_read::*;
use u_get_HSTR_Type_T6::*;
use R_set::*;
use ELUsingAArch32::*;
use EL2Enabled::*;
use AArch32_TakeHypTrapException::*;
use common::*;
pub fn DFAR_SysRegRead32_24eaaed98bd8c8b9<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_5: call _get_HSTR_EL2_Type_T6(s_0_4)
        let s_0_5: bool = u_get_HSTR_EL2_Type_T6(state, tracer, s_0_4);
        // D s_0_6: write-var __HSTR_EL2_T6 <= s_0_5
        fn_state.u__HSTR_EL2_T6 = s_0_5;
        // C s_0_7: const #() : ()
        let s_0_7: () = ();
        // S s_0_8: call HSTR_read(s_0_7)
        let s_0_8: ProductType700c18a878c5601b = HSTR_read(state, tracer, s_0_7);
        // S s_0_9: call _get_HSTR_Type_T6(s_0_8)
        let s_0_9: bool = u_get_HSTR_Type_T6(state, tracer, s_0_8);
        // D s_0_10: write-var __HSTR_T6 <= s_0_9
        fn_state.u__HSTR_T6 = s_0_9;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #() : ()
        let s_6_0: () = ();
        // S s_6_1: call DFAR_NS_read(s_6_0)
        let s_6_1: u32 = DFAR_NS_read(state, tracer, s_6_0);
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #() : ()
        let s_7_0: () = ();
        // S s_7_1: call DFAR_S_read(s_7_0)
        let s_7_1: u32 = DFAR_S_read(state, tracer, s_7_0);
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#110432 <= s_9_0
        fn_state.gs_110432 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#110432:u8
        let s_10_0: bool = fn_state.gs_110432;
    ...
    fn block_11<T: Tracer>(
        ...
        // C s_11_0: const #() : ()
        let s_11_0: () = ();
        // S s_11_1: call DFAR_read(s_11_0)
        let s_11_1: u32 = DFAR_read(state, tracer, s_11_0);
    ...
    fn block_12<T: Tracer>(
        ...
        // C s_12_0: const #() : ()
        let s_12_0: () = ();
        // S s_12_1: call DFAR_NS_read(s_12_0)
        let s_12_1: u32 = DFAR_NS_read(state, tracer, s_12_0);
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_3: write-var gs#110432 <= s_13_2
        fn_state.gs_110432 = s_13_2;
        // N s_13_4: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#110433 <= s_15_0
        fn_state.gs_110433 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#110433:u8
        let s_16_0: bool = fn_state.gs_110433;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#110434 <= s_17_0
        fn_state.gs_110434 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#110434:u8
        let s_18_0: bool = fn_state.gs_110434;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#110435 <= s_20_0
        fn_state.gs_110435 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#110435:u8
        let s_21_0: bool = fn_state.gs_110435;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#110436 <= s_22_0
        fn_state.gs_110436 = s_22_0;
        // N s_22_2: jump b23
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_0: read-var gs#110436:u8
        let s_23_0: bool = fn_state.gs_110436;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#110437 <= s_25_0
        fn_state.gs_110437 = s_25_0;
        // N s_25_2: jump b26
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var gs#110437:u8
        let s_26_0: bool = fn_state.gs_110437;
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_1: write-var gs#110438 <= s_27_0
        fn_state.gs_110438 = s_27_0;
        // N s_27_2: jump b28
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_0: read-var gs#110438:u8
        let s_28_0: bool = fn_state.gs_110438;
    ...
    fn block_30<T: Tracer>(
        ...
        // D s_30_1: write-var gs#110439 <= s_30_0
        fn_state.gs_110439 = s_30_0;
        // N s_30_2: jump b31
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_0: read-var gs#110439:u8
        let s_31_0: bool = fn_state.gs_110439;
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_1: write-var gs#110440 <= s_32_0
        fn_state.gs_110440 = s_32_0;
        // N s_32_2: jump b33
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var gs#110440:u8
        let s_33_0: bool = fn_state.gs_110440;
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_1: write-var gs#110441 <= s_35_0
        fn_state.gs_110441 = s_35_0;
        // N s_35_2: jump b36
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_0: read-var gs#110441:u8
        let s_36_0: bool = fn_state.gs_110441;
    ...
    fn block_37<T: Tracer>(
        ...
        // C s_37_0: const #() : ()
        let s_37_0: () = ();
        // S s_37_1: call DFAR_read(s_37_0)
        let s_37_1: u32 = DFAR_read(state, tracer, s_37_0);
    ...
    fn block_38<T: Tracer>(
        ...
        // C s_38_0: const #() : ()
        let s_38_0: () = ();
        // S s_38_1: call DFAR_NS_read(s_38_0)
        let s_38_1: u32 = DFAR_NS_read(state, tracer, s_38_0);
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_3: write-var gs#110441 <= s_39_2
        fn_state.gs_110441 = s_39_2;
        // N s_39_4: jump b36
        return block_36(state, tracer, fn_state);
    }
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_5: write-var gs#110440 <= s_41_4
        fn_state.gs_110440 = s_41_4;
        // N s_41_6: jump b33
        return block_33(state, tracer, fn_state);
    }
    fn block_42<T: Tracer>(
        ...
        // D s_42_3: write-var gs#110439 <= s_42_2
        fn_state.gs_110439 = s_42_2;
        // N s_42_4: jump b31
        return block_31(state, tracer, fn_state);
    }
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_5: write-var gs#110438 <= s_44_4
        fn_state.gs_110438 = s_44_4;
        // N s_44_6: jump b28
        return block_28(state, tracer, fn_state);
    }
    fn block_45<T: Tracer>(
        ...
        // D s_45_4: write-var gs#110437 <= s_45_3
        fn_state.gs_110437 = s_45_3;
        // N s_45_5: jump b26
        return block_26(state, tracer, fn_state);
    }
    ...
    fn block_47<T: Tracer>(
        ...
        // D s_47_0: read-var __HSTR_T6:u8
        let s_47_0: bool = fn_state.u__HSTR_T6;
        ...
        // D s_47_5: write-var gs#110436 <= s_47_4
        fn_state.gs_110436 = s_47_4;
        // N s_47_6: jump b23
        return block_23(state, tracer, fn_state);
    }
    fn block_48<T: Tracer>(
        ...
        // D s_48_3: write-var gs#110435 <= s_48_2
        fn_state.gs_110435 = s_48_2;
        // N s_48_4: jump b21
        return block_21(state, tracer, fn_state);
    }
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_0: read-var __HSTR_EL2_T6:u8
        let s_50_0: bool = fn_state.u__HSTR_EL2_T6;
        ...
        // D s_50_5: write-var gs#110434 <= s_50_4
        fn_state.gs_110434 = s_50_4;
        // N s_50_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    fn block_51<T: Tracer>(
        ...
        // D s_51_4: write-var gs#110433 <= s_51_3
        fn_state.gs_110433 = s_51_3;
        // N s_51_5: jump b16
        return block_16(state, tracer, fn_state);
    }
