...
use BFSub::*;
use common::*;
pub fn execute_BFSUB_Z_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#2433 <= s_0_2
        fn_state.VLshadow_2433 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#2433:i64
        let s_1_0: i64 = fn_state.VLshadow_2433;
        // D s_1_1: write-var VLshadow#2434 <= s_1_0
        fn_state.VLshadow_2434 = s_1_0;
        // C s_1_2: const #16s : i
        let s_1_2: i128 = 16;
        // D s_1_3: read-var VLshadow#2434:i64
        let s_1_3: i64 = fn_state.VLshadow_2434;
        ...
        // D s_1_7: read-var VLshadow#2434:i64
        let s_1_7: i64 = fn_state.VLshadow_2434;
        ...
        // D s_1_15: read-var VLshadow#2434:i64
        let s_1_15: i64 = fn_state.VLshadow_2434;
        ...
        // D s_1_28: write-var gs#184474 <= s_1_27
        fn_state.gs_184474 = s_1_27;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#184474:i64
        let s_2_1: i64 = fn_state.gs_184474;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_14: const #() : ()
        let s_3_14: () = ();
        // S s_3_15: call FPCR_read(s_3_14)
        let s_3_15: ProductType5c790c8ef59cc8b2 = FPCR_read(state, tracer, s_3_14);
        // D s_3_16: cast zx s_3_6 -> bv
        let s_3_16: Bits = Bits::new(s_3_6 as u128, 16u16);
        // D s_3_17: cast zx s_3_13 -> bv
        let s_3_17: Bits = Bits::new(s_3_13 as u128, 16u16);
        // D s_3_18: call BFSub(s_3_16, s_3_17, s_3_15)
        let s_3_18: Bits = BFSub(state, tracer, s_3_16, s_3_17, s_3_15);
        // D s_3_19: write-var gs#733689 <= s_3_18
        fn_state.gs_733689 = s_3_18;
        // N s_3_20: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#733689:bv
        let s_4_0: Bits = fn_state.gs_733689;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var VLshadow#2434:i64
        let s_5_0: i64 = fn_state.VLshadow_2434;
