...
use ROR::*;
use common::*;
pub fn execute_aarch32_instrs_SXTAB16_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_32: bits-cast sx s_0_31 -> bv length s_0_30
        let s_0_32: Bits = s_0_31.sign_extend(s_0_30);
        ...
        // D s_0_80: bits-cast sx s_0_79 -> bv length s_0_78
        let s_0_80: Bits = s_0_79.sign_extend(s_0_78);
