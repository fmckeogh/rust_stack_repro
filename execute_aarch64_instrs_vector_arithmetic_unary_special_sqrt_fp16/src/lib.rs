...
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_unary_special_sqrt_fp16<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    datasize: i64,
    ...
    struct FunctionState {
        ...
        e: i64,
        ga_256722: Bits,
        esizeshadow_1469: i64,
        result: Bits,
        datasizeshadow_1470: i64,
        ga_256721: i64,
        gs_154928: i64,
        d: i64,
        datasize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#1469 <= s_0_2
        fn_state.esizeshadow_1469 = s_0_2;
        ...
        // D s_0_7: write-var datasizeshadow#1470 <= s_0_6
        fn_state.datasizeshadow_1470 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var datasizeshadow#1470:i64
        let s_1_0: i64 = fn_state.datasizeshadow_1470;
        ...
        // D s_1_12: write-var gs#154928 <= s_1_11
        fn_state.gs_154928 = s_1_11;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#154928:i64
        let s_2_1: i64 = fn_state.gs_154928;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var esizeshadow#1469:i64
        let s_3_0: i64 = fn_state.esizeshadow_1469;
        ...
        // D s_3_8: read-var esizeshadow#1469:i64
        let s_3_8: i64 = fn_state.esizeshadow_1469;
        // D s_3_9: cast zx s_3_8 -> i
        let s_3_9: i128 = (i128::try_from(s_3_8).unwrap());
        // D s_3_10: cast reint s_3_9 -> i64
        let s_3_10: i64 = (s_3_9 as i64);
        // D s_3_11: write-var ga#256721 <= s_3_10
        fn_state.ga_256721 = s_3_10;
        // C s_3_12: const #() : ()
        let s_3_12: () = ();
        // S s_3_13: call FPCR_read(s_3_12)
        let s_3_13: ProductType5c790c8ef59cc8b2 = FPCR_read(state, tracer, s_3_12);
        // D s_3_14: call FPSqrt(s_3_7, s_3_13)
        let s_3_14: Bits = FPSqrt(state, tracer, s_3_7, s_3_13);
        // D s_3_15: write-var ga#256722 <= s_3_14
        fn_state.ga_256722 = s_3_14;
        // N s_3_16: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: read-var ga#256721:i64
        let s_4_2: i64 = fn_state.ga_256721;
        // D s_4_3: cast zx s_4_2 -> i
        let s_4_3: i128 = (i128::try_from(s_4_2).unwrap());
        // D s_4_4: read-var result:bv
        let s_4_4: Bits = fn_state.result;
        // D s_4_5: read-var ga#256722:bv
        let s_4_5: Bits = fn_state.ga_256722;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var datasizeshadow#1470:i64
        let s_5_0: i64 = fn_state.datasizeshadow_1470;
