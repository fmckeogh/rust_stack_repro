...
use common::*;
pub fn decode_sli_advsimd_aarch64_instrs_vector_shift_left_insert_sisd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_28: call execute_aarch64_instrs_vector_shift_left_insert_sisd(s_1_26, s_1_23, s_1_22, s_1_24, s_1_27, s_1_25)
        let s_1_28: () = execute_aarch64_instrs_vector_shift_left_insert_sisd(
            state,
            tracer,
            s_1_26,
            s_1_23,
