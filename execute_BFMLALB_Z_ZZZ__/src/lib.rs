...
use BFMulAddH::*;
use common::*;
pub fn execute_BFMLALB_Z_ZZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    da: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#2358 <= s_0_2
        fn_state.VLshadow_2358 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#2358:i64
        let s_1_0: i64 = fn_state.VLshadow_2358;
        // D s_1_1: write-var VLshadow#2359 <= s_1_0
        fn_state.VLshadow_2359 = s_1_0;
        // C s_1_2: const #32s : i
        let s_1_2: i128 = 32;
        // D s_1_3: read-var VLshadow#2359:i64
        let s_1_3: i64 = fn_state.VLshadow_2359;
        ...
        // D s_1_7: read-var VLshadow#2359:i64
        let s_1_7: i64 = fn_state.VLshadow_2359;
        ...
        // D s_1_15: read-var VLshadow#2359:i64
        let s_1_15: i64 = fn_state.VLshadow_2359;
        ...
        // D s_1_23: read-var VLshadow#2359:i64
        let s_1_23: i64 = fn_state.VLshadow_2359;
        ...
        // D s_1_36: write-var gs#182533 <= s_1_35
        fn_state.gs_182533 = s_1_35;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#182533:i64
        let s_2_1: i64 = fn_state.gs_182533;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_37: const #() : ()
        let s_3_37: () = ();
        // S s_3_38: call FPCR_read(s_3_37)
        let s_3_38: ProductType5c790c8ef59cc8b2 = FPCR_read(state, tracer, s_3_37);
        // D s_3_39: cast zx s_3_36 -> bv
        let s_3_39: Bits = Bits::new(s_3_36 as u128, 32u16);
        // D s_3_40: cast zx s_3_14 -> bv
        let s_3_40: Bits = Bits::new(s_3_14 as u128, 16u16);
        // D s_3_41: cast zx s_3_29 -> bv
        let s_3_41: Bits = Bits::new(s_3_29 as u128, 16u16);
        // D s_3_42: call BFMulAddH(s_3_39, s_3_40, s_3_41, s_3_38)
        let s_3_42: Bits = BFMulAddH(state, tracer, s_3_39, s_3_40, s_3_41, s_3_38);
        // D s_3_43: write-var gs#731200 <= s_3_42
        fn_state.gs_731200 = s_3_42;
        // N s_3_44: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#731200:bv
        let s_4_0: Bits = fn_state.gs_731200;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var VLshadow#2359:i64
        let s_5_0: i64 = fn_state.VLshadow_2359;
