...
use Unreachable::*;
use common::*;
pub fn DecodePGS<T: Tracer>(state: &mut State, tracer: &T, pgs: u8) -> u32 {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_0: read-var pgs:u8
        let s_0_0: u8 = fn_state.pgs;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var pgs:u8
        let s_3_0: u8 = fn_state.pgs;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var pgs:u8
        let s_5_0: u8 = fn_state.pgs;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_2: read-var ga#9817:u32
        let s_7_2: u32 = fn_state.ga_9817;
