...
extern crate alloc;
use X_set::*;
use u__get_GCSCR_EL3::*;
use common::*;
pub fn GCSCR_EL3_SysRegRead_f722c361b12a49bd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_65907: ProductType5c790c8ef59cc8b2,
        u__PSTATE_EL: u8,
        el: u8,
        op0: u8,
        op1: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call __get_GCSCR_EL3(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_GCSCR_EL3(state, tracer, s_5_2);
        // D s_5_4: write-var ga#65907 <= s_5_3
        fn_state.ga_65907 = s_5_3;
        // D s_5_5: read-var ga#65907.0:struct
        let s_5_5: u64 = fn_state.ga_65907._0;
