...
extern crate alloc;
use CurrentVL_read::*;
use execute_UQXTNT_Z_ZZ__::*;
use HaveSVE2::*;
use HaveSME::*;
use common::*;
pub fn decode_UQXTNT_Z_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    tszh: bool,
    tszl: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#205769 <= s_1_0
        fn_state.gs_205769 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#205769:u8
        let s_2_0: bool = fn_state.gs_205769;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var esizeshadow#3615 <= s_5_0
        fn_state.esizeshadow_3615 = s_5_0;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 128;
        // D s_6_1: read-var esizeshadow#3615:i64
        let s_6_1: i64 = fn_state.esizeshadow_3615;
        ...
        // D s_6_6: call execute_UQXTNT_Z_ZZ__(s_6_0, s_6_4, s_6_3, s_6_5)
        let s_6_6: () = execute_UQXTNT_Z_ZZ__(state, tracer, s_6_0, s_6_4, s_6_3, s_6_5);
        // N s_6_7: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 256;
        // D s_8_1: read-var esizeshadow#3615:i64
        let s_8_1: i64 = fn_state.esizeshadow_3615;
        ...
        // D s_8_6: call execute_UQXTNT_Z_ZZ__(s_8_0, s_8_4, s_8_3, s_8_5)
        let s_8_6: () = execute_UQXTNT_Z_ZZ__(state, tracer, s_8_0, s_8_4, s_8_3, s_8_5);
        // N s_8_7: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 512;
        // D s_10_1: read-var esizeshadow#3615:i64
        let s_10_1: i64 = fn_state.esizeshadow_3615;
        ...
        // D s_10_6: call execute_UQXTNT_Z_ZZ__(s_10_0, s_10_4, s_10_3, s_10_5)
        let s_10_6: () = execute_UQXTNT_Z_ZZ__(
            state,
            tracer,
            s_10_0,
            s_10_4,
    ...
    fn block_12<T: Tracer>(
        ...
        let s_12_0: i64 = 1024;
        // D s_12_1: read-var esizeshadow#3615:i64
        let s_12_1: i64 = fn_state.esizeshadow_3615;
        ...
        // D s_12_6: call execute_UQXTNT_Z_ZZ__(s_12_0, s_12_4, s_12_3, s_12_5)
        let s_12_6: () = execute_UQXTNT_Z_ZZ__(
            state,
            tracer,
            s_12_0,
            s_12_4,
    ...
    fn block_14<T: Tracer>(
        ...
        let s_14_0: i64 = 2048;
        // D s_14_1: read-var esizeshadow#3615:i64
        let s_14_1: i64 = fn_state.esizeshadow_3615;
        ...
        // D s_14_6: call execute_UQXTNT_Z_ZZ__(s_14_0, s_14_4, s_14_3, s_14_5)
        let s_14_6: () = execute_UQXTNT_Z_ZZ__(
            state,
            tracer,
            s_14_0,
            s_14_4,
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_3: write-var gs#205769 <= s_22_2
        fn_state.gs_205769 = s_22_2;
        // N s_22_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
