...
use common::*;
pub fn execute_aarch64_instrs_memory_atomicops_ld_128_ldclrp<T: Tracer>(
    state: &mut State,
    tracer: &T,
    acquire: bool,
    n: i64,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_10: write-var gs#702696 <= s_4_9
        fn_state.gs_702696 = s_4_9;
        // N s_4_11: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#702696:bv
        let s_5_0: Bits = fn_state.gs_702696;
