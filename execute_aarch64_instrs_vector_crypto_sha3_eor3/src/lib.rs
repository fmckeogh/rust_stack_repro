...
use common::*;
pub fn execute_aarch64_instrs_vector_crypto_sha3_eor3<T: Tracer>(
    state: &mut State,
    tracer: &T,
    a: i64,
    d: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_18: xor s_1_16 s_1_17
        let s_1_18: Bits = ((s_1_16) ^ (s_1_17));
        // D s_1_19: cast reint s_1_18 -> u128
        let s_1_19: u128 = (s_1_18.value() as u128);
        // D s_1_20: cast zx s_1_19 -> bv
        let s_1_20: Bits = Bits::new(s_1_19 as u128, 128u16);
        // D s_1_21: cast zx s_1_14 -> bv
        let s_1_21: Bits = Bits::new(s_1_14 as u128, 128u16);
        ...
        // D s_1_26: cast zx s_1_23 -> bv
        let s_1_26: Bits = Bits::new(s_1_23 as u128, 128u16);
        // D s_1_27: call V_set(s_1_25, s_1_15, s_1_26)
        let s_1_27: () = V_set(state, tracer, s_1_25, s_1_15, s_1_26);
        // N s_1_28: return
        return;
    }
}
