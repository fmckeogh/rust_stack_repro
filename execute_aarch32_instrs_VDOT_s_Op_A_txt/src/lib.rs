...
use D_read::*;
use common::*;
pub fn execute_aarch32_instrs_VDOT_s_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    esize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_2: call D_read(s_0_1)
        let s_0_2: u64 = D_read(state, tracer, s_0_1);
        // D s_0_3: write-var operand2 <= s_0_2
        fn_state.operand2 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_6: write-var gs#326094 <= s_1_5
        fn_state.gs_326094 = s_1_5;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#326094:i64
        let s_2_1: i64 = fn_state.gs_326094;
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_26: const #4s : i
        let s_8_26: i128 = 4;
        // D s_8_27: read-var index:i64
        let s_8_27: i64 = fn_state.index;
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_26: i128 = 4;
        // D s_10_27: read-var index:i64
        let s_10_27: i64 = fn_state.index;
