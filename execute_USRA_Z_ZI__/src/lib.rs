...
use Z_set::*;
use common::*;
pub fn execute_USRA_Z_ZI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    da: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#4224 <= s_0_2
        fn_state.esizeshadow_4224 = s_0_2;
        ...
        // D s_0_7: write-var VLshadow#4225 <= s_0_6
        fn_state.VLshadow_4225 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#4225:i64
        let s_1_0: i64 = fn_state.VLshadow_4225;
        // D s_1_1: write-var VLshadow#4226 <= s_1_0
        fn_state.VLshadow_4226 = s_1_0;
        // D s_1_2: read-var VLshadow#4226:i64
        let s_1_2: i64 = fn_state.VLshadow_4226;
        // D s_1_3: cast zx s_1_2 -> i
        let s_1_3: i128 = (i128::try_from(s_1_2).unwrap());
        // D s_1_4: read-var esizeshadow#4224:i64
        let s_1_4: i64 = fn_state.esizeshadow_4224;
        ...
        // D s_1_8: read-var VLshadow#4226:i64
        let s_1_8: i64 = fn_state.VLshadow_4226;
        ...
        // D s_1_16: read-var VLshadow#4226:i64
        let s_1_16: i64 = fn_state.VLshadow_4226;
        ...
        // D s_1_29: write-var gs#217650 <= s_1_28
        fn_state.gs_217650 = s_1_28;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#217650:i64
        let s_2_1: i64 = fn_state.gs_217650;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var esizeshadow#4224:i64
        let s_3_0: i64 = fn_state.esizeshadow_4224;
        ...
        // D s_3_9: read-var shift:i
        let s_3_9: i128 = fn_state.shift;
        // D s_3_10: call _shr_int_general(s_3_8, s_3_9)
        let s_3_10: i128 = u_shr_int_general(state, tracer, s_3_8, s_3_9);
        // D s_3_11: read-var esizeshadow#4224:i64
        let s_3_11: i64 = fn_state.esizeshadow_4224;
        // D s_3_12: cast zx s_3_11 -> i
        let s_3_12: i128 = (i128::try_from(s_3_11).unwrap());
        // D s_3_13: cast reint s_3_12 -> i64
        let s_3_13: i64 = (s_3_12 as i64);
        // D s_3_14: read-var esizeshadow#4224:i64
        let s_3_14: i64 = fn_state.esizeshadow_4224;
        ...
        // D s_3_19: cast zx s_3_16 -> i
        let s_3_19: i128 = (i128::try_from(s_3_16).unwrap());
        // D s_3_20: read-var operand2:bv
        let s_3_20: Bits = fn_state.operand2;
        // D s_3_21: call Elem_read(s_3_20, s_3_18, s_3_19)
        let s_3_21: Bits = Elem_read(state, tracer, s_3_20, s_3_18, s_3_19);
        // C s_3_22: const #1s : i
        let s_3_22: i128 = 1;
        // D s_3_23: read-var esizeshadow#4224:i64
        let s_3_23: i64 = fn_state.esizeshadow_4224;
        ...
        // D s_3_29: call integer_subrange(s_3_10, s_3_28, s_3_27)
        let s_3_29: Bits = integer_subrange(state, tracer, s_3_10, s_3_28, s_3_27);
        // D s_3_30: add s_3_21 s_3_29
        let s_3_30: Bits = (s_3_21 + s_3_29);
        // D s_3_31: read-var e:i64
        let s_3_31: i64 = fn_state.e;
        // D s_3_32: cast zx s_3_31 -> i
        let s_3_32: i128 = (i128::try_from(s_3_31).unwrap());
        // D s_3_33: cast zx s_3_13 -> i
        let s_3_33: i128 = (i128::try_from(s_3_13).unwrap());
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#4226:i64
        let s_4_0: i64 = fn_state.VLshadow_4226;
