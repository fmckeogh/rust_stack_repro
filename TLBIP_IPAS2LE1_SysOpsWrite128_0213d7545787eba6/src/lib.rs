...
use common::*;
pub fn TLBIP_IPAS2LE1_SysOpsWrite128_0213d7545787eba6<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#138157 <= s_11_0
        fn_state.gs_138157 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#138157:u8
        let s_12_0: bool = fn_state.gs_138157;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_5: write-var gs#138157 <= s_15_4
        fn_state.gs_138157 = s_15_4;
        // N s_15_6: jump b12
        return block_12(state, tracer, fn_state);
    }
