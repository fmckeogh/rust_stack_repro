...
use EL2Enabled::*;
use common::*;
pub fn SDER32_EL2_SysRegWrite_cf03546943dc260a<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_3: write-var gs#91905 <= s_1_2
        fn_state.gs_91905 = s_1_2;
        // N s_1_4: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#91905:u8
        let s_2_0: bool = fn_state.gs_91905;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#91906 <= s_3_3
        fn_state.gs_91906 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#91906:u8
        let s_4_0: bool = fn_state.gs_91906;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_4: call Mk_SDER32_EL2_Type(s_11_3)
        let s_11_4: ProductType5c790c8ef59cc8b2 = Mk_SDER32_EL2_Type(
            state,
            tracer,
            s_11_3,
        );
        // C s_11_5: const #21112u : u32
        let s_11_5: u32 = 21112;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#91908 <= s_15_0
        fn_state.gs_91908 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#91908:u8
        let s_16_0: bool = fn_state.gs_91908;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_4: call Mk_SDER32_EL2_Type(s_17_3)
        let s_17_4: ProductType5c790c8ef59cc8b2 = Mk_SDER32_EL2_Type(
            state,
            tracer,
            s_17_3,
        );
        // C s_17_5: const #21112u : u32
        let s_17_5: u32 = 21112;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_5: write-var gs#91908 <= s_19_4
        fn_state.gs_91908 = s_19_4;
        // N s_19_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_1: write-var gs#91910 <= s_23_0
        fn_state.gs_91910 = s_23_0;
        // N s_23_2: jump b24
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_0: read-var gs#91910:u8
        let s_24_0: bool = fn_state.gs_91910;
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_5: write-var gs#91910 <= s_27_4
        fn_state.gs_91910 = s_27_4;
        // N s_27_6: jump b24
        return block_24(state, tracer, fn_state);
    }
    ...
    fn block_31<T: Tracer>(
        ...
        // D s_31_1: write-var gs#91906 <= s_31_0
        fn_state.gs_91906 = s_31_0;
        // N s_31_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_32<T: Tracer>(
        ...
        // D s_32_1: write-var gs#91905 <= s_32_0
        fn_state.gs_91905 = s_32_0;
        // N s_32_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
