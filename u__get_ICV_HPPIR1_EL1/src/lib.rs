...
extern crate alloc;
use Mk_ICV_HPPIR1_EL1_Type::*;
use common::*;
pub fn u__get_ICV_HPPIR1_EL1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_11: tail-call Mk_ICV_HPPIR1_EL1_Type(s_0_10)
        return Mk_ICV_HPPIR1_EL1_Type(state, tracer, s_0_10);
    }
}
