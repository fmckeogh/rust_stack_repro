...
use HaveSVE::*;
use CurrentVL_read::*;
use execute_ST1H_Z_P_BI__::*;
use HaveSME::*;
use common::*;
pub fn decode_ST1H_Z_P_BI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    msz: u8,
    size: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#246541 <= s_1_0
        fn_state.gs_246541 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#246541:u8
        let s_2_0: bool = fn_state.gs_246541;
    ...
    fn block_4<T: Tracer>(
        ...
        fn_state.n = s_4_8;
        // D s_4_10: read-var Pg:u8
        let s_4_10: u8 = fn_state.Pg;
        ...
        // D s_4_14: write-var g <= s_4_13
        fn_state.g = s_4_13;
        // D s_4_15: read-var size:u8
        let s_4_15: u8 = fn_state.size;
        ...
        // D s_4_21: write-var esize <= s_4_20
        fn_state.esize = s_4_20;
        // D s_4_22: read-var imm4:u8
        let s_4_22: u8 = fn_state.imm4;
        // D s_4_23: cast zx s_4_22 -> bv
        let s_4_23: Bits = Bits::new(s_4_22 as u128, 4u16);
        // D s_4_24: cast sx s_4_23 -> i
        let s_4_24: i128 = {
            let sign_bit = s_4_23.length() - 1;
            let mut result = s_4_23.value() as i128;
        ...
        // D s_4_26: write-var offset <= s_4_25
        fn_state.offset = s_4_25;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_4: i64 = 16;
        // D s_5_5: read-var offset:i64
        let s_5_5: i64 = fn_state.offset;
        // D s_5_6: cast zx s_5_5 -> i
        let s_5_6: i128 = (i128::try_from(s_5_5).unwrap());
        // D s_5_7: read-var g:i64
        let s_5_7: i64 = fn_state.g;
        // D s_5_8: read-var n:i64
        let s_5_8: i64 = fn_state.n;
        // D s_5_9: read-var t:i64
        let s_5_9: i64 = fn_state.t;
        // D s_5_10: call execute_ST1H_Z_P_BI__(s_5_0, s_5_3, s_5_7, s_5_4, s_5_8, s_5_6, s_5_9)
        let s_5_10: () = execute_ST1H_Z_P_BI__(
            state,
            tracer,
            s_5_0,
            s_5_3,
    ...
    fn block_7<T: Tracer>(
        ...
        let s_7_4: i64 = 16;
        // D s_7_5: read-var offset:i64
        let s_7_5: i64 = fn_state.offset;
        // D s_7_6: cast zx s_7_5 -> i
        let s_7_6: i128 = (i128::try_from(s_7_5).unwrap());
        // D s_7_7: read-var g:i64
        let s_7_7: i64 = fn_state.g;
        // D s_7_8: read-var n:i64
        let s_7_8: i64 = fn_state.n;
        // D s_7_9: read-var t:i64
        let s_7_9: i64 = fn_state.t;
        // D s_7_10: call execute_ST1H_Z_P_BI__(s_7_0, s_7_3, s_7_7, s_7_4, s_7_8, s_7_6, s_7_9)
        let s_7_10: () = execute_ST1H_Z_P_BI__(
            state,
            tracer,
            s_7_0,
            s_7_3,
    ...
    fn block_9<T: Tracer>(
        ...
        let s_9_4: i64 = 16;
        // D s_9_5: read-var offset:i64
        let s_9_5: i64 = fn_state.offset;
        // D s_9_6: cast zx s_9_5 -> i
        let s_9_6: i128 = (i128::try_from(s_9_5).unwrap());
        // D s_9_7: read-var g:i64
        let s_9_7: i64 = fn_state.g;
        // D s_9_8: read-var n:i64
        let s_9_8: i64 = fn_state.n;
        // D s_9_9: read-var t:i64
        let s_9_9: i64 = fn_state.t;
        // D s_9_10: call execute_ST1H_Z_P_BI__(s_9_0, s_9_3, s_9_7, s_9_4, s_9_8, s_9_6, s_9_9)
        let s_9_10: () = execute_ST1H_Z_P_BI__(
            state,
            tracer,
            s_9_0,
            s_9_3,
    ...
    fn block_11<T: Tracer>(
        ...
        // C s_11_4: const #16s : i64
        let s_11_4: i64 = 16;
        // D s_11_5: read-var offset:i64
        let s_11_5: i64 = fn_state.offset;
        // D s_11_6: cast zx s_11_5 -> i
        let s_11_6: i128 = (i128::try_from(s_11_5).unwrap());
        // D s_11_7: read-var g:i64
        let s_11_7: i64 = fn_state.g;
        // D s_11_8: read-var n:i64
        let s_11_8: i64 = fn_state.n;
        // D s_11_9: read-var t:i64
        let s_11_9: i64 = fn_state.t;
        // D s_11_10: call execute_ST1H_Z_P_BI__(s_11_0, s_11_3, s_11_7, s_11_4, s_11_8, s_11_6, s_11_9)
        let s_11_10: () = execute_ST1H_Z_P_BI__(
            state,
            tracer,
            s_11_0,
            s_11_3,
    ...
    fn block_13<T: Tracer>(
        ...
        let s_13_4: i64 = 16;
        // D s_13_5: read-var offset:i64
        let s_13_5: i64 = fn_state.offset;
        // D s_13_6: cast zx s_13_5 -> i
        let s_13_6: i128 = (i128::try_from(s_13_5).unwrap());
        // D s_13_7: read-var g:i64
        let s_13_7: i64 = fn_state.g;
        // D s_13_8: read-var n:i64
        let s_13_8: i64 = fn_state.n;
        // D s_13_9: read-var t:i64
        let s_13_9: i64 = fn_state.t;
        // D s_13_10: call execute_ST1H_Z_P_BI__(s_13_0, s_13_3, s_13_7, s_13_4, s_13_8, s_13_6, s_13_9)
        let s_13_10: () = execute_ST1H_Z_P_BI__(
            state,
            tracer,
            s_13_0,
            s_13_3,
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_3: write-var gs#246541 <= s_17_2
        fn_state.gs_246541 = s_17_2;
        // N s_17_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
