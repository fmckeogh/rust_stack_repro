...
use common::*;
pub fn decode_aarch32_instrs_MRC_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    opc1: u8,
    CRn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 15;
        // D s_3_1: write-var ga#345180 <= s_3_0
        fn_state.ga_345180 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#345180:i64
        let s_4_0: i64 = fn_state.ga_345180;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 14;
        // D s_5_1: write-var ga#345180 <= s_5_0
        fn_state.ga_345180 = s_5_0;
        // N s_5_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
