...
use common::*;
pub fn decode_fcmgt_advsimd_zero_aarch64_instrs_vector_arithmetic_unary_cmp_fp16_bulk_simd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, op: bool, U: bool, Q: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#253275 <= s_1_0
        fn_state.ga_253275 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#253275:i64
        let s_2_0: i64 = fn_state.ga_253275;
        ...
        // D s_2_21: write-var ga#253277 <= s_2_20
        fn_state.ga_253277 = s_2_20;
        // D s_2_22: read-var ga#253277:u8
        let s_2_22: u8 = fn_state.ga_253277;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var ga#253277:u8
        let s_5_0: u8 = fn_state.ga_253277;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var ga#253277:u8
        let s_7_0: u8 = fn_state.ga_253277;
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 128;
        // D s_10_1: write-var ga#253275 <= s_10_0
        fn_state.ga_253275 = s_10_0;
        // N s_10_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
