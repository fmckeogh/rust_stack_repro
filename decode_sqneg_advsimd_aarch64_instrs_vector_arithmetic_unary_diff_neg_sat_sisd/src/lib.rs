...
use common::*;
pub fn decode_sqneg_advsimd_aarch64_instrs_vector_arithmetic_unary_diff_neg_sat_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, size: u8, U: bool) -> () {
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #1s : i
        let s_0_23: i128 = 1;
        // D s_0_24: call execute_aarch64_instrs_vector_arithmetic_unary_diff_neg_sat_sisd(s_0_3, s_0_20, s_0_23, s_0_22, s_0_7, s_0_18)
        let s_0_24: () = execute_aarch64_instrs_vector_arithmetic_unary_diff_neg_sat_sisd(
            state,
            tracer,
            s_0_3,
            s_0_20,
