...
extern crate alloc;
use Mk_ICH_VTR_EL2_Type::*;
use common::*;
pub fn u__get_ICH_VTR_EL2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #18446744069414846432u : u64
        let s_0_3: u64 = 18446744069414846432;
        ...
        // D s_0_11: tail-call Mk_ICH_VTR_EL2_Type(s_0_10)
        return Mk_ICH_VTR_EL2_Type(state, tracer, s_0_10);
    }
}
