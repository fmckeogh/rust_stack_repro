...
use HaveSVE::*;
use CurrentVL_read::*;
use execute_WRFFR_F_P__::*;
use common::*;
pub fn decode_WRFFR_F_P__<T: Tracer>(state: &mut State, tracer: &T, Pn: u8) -> () {
    #[derive(Default)]
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_2: call execute_WRFFR_F_P__(s_2_0, s_2_1)
        let s_2_2: () = execute_WRFFR_F_P__(state, tracer, s_2_0, s_2_1);
        // N s_2_3: return
        return;
    }
    fn block_3<T: Tracer>(
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: call execute_WRFFR_F_P__(s_4_0, s_4_1)
        let s_4_2: () = execute_WRFFR_F_P__(state, tracer, s_4_0, s_4_1);
        // N s_4_3: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call execute_WRFFR_F_P__(s_6_0, s_6_1)
        let s_6_2: () = execute_WRFFR_F_P__(state, tracer, s_6_0, s_6_1);
        // N s_6_3: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_2: call execute_WRFFR_F_P__(s_8_0, s_8_1)
        let s_8_2: () = execute_WRFFR_F_P__(state, tracer, s_8_0, s_8_1);
        // N s_8_3: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_2: call execute_WRFFR_F_P__(s_10_0, s_10_1)
        let s_10_2: () = execute_WRFFR_F_P__(state, tracer, s_10_0, s_10_1);
        // N s_10_3: return
        return;
    }
