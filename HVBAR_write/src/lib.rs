...
extern crate alloc;
use common::*;
pub fn HVBAR_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #22816u : u32
        let s_0_23: u32 = 22816;
        ...
        // C s_0_25: const #12096u : u32
        let s_0_25: u32 = 12096;
