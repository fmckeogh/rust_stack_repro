...
use Z_set::*;
use common::*;
pub fn execute_SMULLB_Z_ZZi_D<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#3906 <= s_0_2
        fn_state.VLshadow_3906 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#3906:i64
        let s_1_0: i64 = fn_state.VLshadow_3906;
        // D s_1_1: write-var VLshadow#3907 <= s_1_0
        fn_state.VLshadow_3907 = s_1_0;
        // C s_1_2: const #2s : i
        let s_1_2: i128 = 2;
        ...
        // D s_1_7: read-var VLshadow#3907:i64
        let s_1_7: i64 = fn_state.VLshadow_3907;
        ...
        // D s_1_22: read-var VLshadow#3907:i64
        let s_1_22: i64 = fn_state.VLshadow_3907;
        ...
        // D s_1_30: read-var VLshadow#3907:i64
        let s_1_30: i64 = fn_state.VLshadow_3907;
        ...
        // D s_1_43: write-var gs#211468 <= s_1_42
        fn_state.gs_211468 = s_1_42;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#211468:i64
        let s_2_1: i64 = fn_state.gs_211468;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_63: const #2s : i
        let s_3_63: i128 = 2;
        // D s_3_64: read-var esize:i64
        let s_3_64: i64 = fn_state.esize;
        ...
        // C s_3_68: const #1s : i
        let s_3_68: i128 = 1;
        // D s_3_69: cast zx s_3_67 -> i
        let s_3_69: i128 = (i128::try_from(s_3_67).unwrap());
        // D s_3_70: sub s_3_69 s_3_68
        let s_3_70: i128 = ((s_3_69) - (s_3_68));
        ...
        // D s_3_74: cast zx s_3_71 -> i
        let s_3_74: i128 = (i128::try_from(s_3_71).unwrap());
        // D s_3_75: call integer_subrange(s_3_73, s_3_74, s_3_72)
        let s_3_75: Bits = integer_subrange(state, tracer, s_3_73, s_3_74, s_3_72);
        // D s_3_76: read-var e:i64
        let s_3_76: i64 = fn_state.e;
        // D s_3_77: cast zx s_3_76 -> i
        let s_3_77: i128 = (i128::try_from(s_3_76).unwrap());
        // D s_3_78: cast zx s_3_62 -> i
        let s_3_78: i128 = (i128::try_from(s_3_62).unwrap());
        // D s_3_79: read-var result:bv
        let s_3_79: Bits = fn_state.result;
        // D s_3_80: call Elem_set(s_3_79, s_3_77, s_3_78, s_3_75)
        let s_3_80: Bits = Elem_set(state, tracer, s_3_79, s_3_77, s_3_78, s_3_75);
        // D s_3_81: write-var result <= s_3_80
        fn_state.result = s_3_80;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#3907:i64
        let s_4_0: i64 = fn_state.VLshadow_3907;
