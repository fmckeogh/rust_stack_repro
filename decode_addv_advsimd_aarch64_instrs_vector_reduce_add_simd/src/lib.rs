...
extern crate alloc;
use execute_aarch64_instrs_vector_reduce_add_simd::*;
use common::*;
pub fn decode_addv_advsimd_aarch64_instrs_vector_reduce_add_simd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 64;
        // D s_3_1: write-var ga#249334 <= s_3_0
        fn_state.ga_249334 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#249334:i64
        let s_4_0: i64 = fn_state.ga_249334;
        ...
        let s_4_8: u32 = 5;
        // D s_4_9: call execute_aarch64_instrs_vector_reduce_add_simd(s_4_6, s_4_2, s_4_5, s_4_7, s_4_8)
        let s_4_9: () = execute_aarch64_instrs_vector_reduce_add_simd(
            state,
            tracer,
            s_4_6,
            s_4_2,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 128;
        // D s_5_1: write-var ga#249334 <= s_5_0
        fn_state.ga_249334 = s_5_0;
        // N s_5_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_6<T: Tracer>(
