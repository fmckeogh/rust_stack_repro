...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_unary_rbit::*;
use common::*;
pub fn decode_rbit_advsimd_aarch64_instrs_vector_arithmetic_unary_rbit<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#264009 <= s_1_0
        fn_state.ga_264009 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#264009:i64
        let s_2_0: i64 = fn_state.ga_264009;
        // C s_2_1: const #8s : i
        let s_2_1: i128 = 8;
        ...
        // D s_2_10: call execute_aarch64_instrs_vector_arithmetic_unary_rbit(s_2_8, s_2_6, s_2_4, s_2_7, s_2_9)
        let s_2_10: () = execute_aarch64_instrs_vector_arithmetic_unary_rbit(
            state,
            tracer,
            s_2_8,
            s_2_6,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 128;
        // D s_3_1: write-var ga#264009 <= s_3_0
        fn_state.ga_264009 = s_3_0;
        // N s_3_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
