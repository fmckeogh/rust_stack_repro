...
extern crate alloc;
use execute_aarch64_instrs_float_move_fp_select::*;
use common::*;
pub fn decode_fcsel_float_aarch64_instrs_float_move_fp_select<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        let s_0_15: i64 = 16;
        // D s_0_16: write-var datasize <= s_0_15
        fn_state.datasize = s_0_15;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_7: call execute_aarch64_instrs_float_move_fp_select(s_2_1, s_2_4, s_2_3, s_2_5, s_2_6)
        let s_2_7: () = execute_aarch64_instrs_float_move_fp_select(
            state,
            tracer,
            s_2_1,
            s_2_4,
