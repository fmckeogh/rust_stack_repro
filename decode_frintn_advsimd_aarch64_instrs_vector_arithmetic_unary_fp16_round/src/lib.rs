...
use FPCR_read::*;
use common::*;
pub fn decode_frintn_advsimd_aarch64_instrs_vector_arithmetic_unary_fp16_round<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#256436 <= s_1_0
        fn_state.ga_256436 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#256436:i64
        let s_2_0: i64 = fn_state.ga_256436;
        ...
        // D s_2_35: write-var ga#256439 <= s_2_34
        fn_state.ga_256439 = s_2_34;
        // D s_2_36: read-var ga#256439:u8
        let s_2_36: u8 = fn_state.ga_256439;
        // C s_2_37: const #2s : i
        let s_2_37: i128 = 2;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var ga#256439:u8
        let s_5_0: u8 = fn_state.ga_256439;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var ga#256439:u8
        let s_7_0: u8 = fn_state.ga_256439;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var ga#256439:u8
        let s_9_0: u8 = fn_state.ga_256439;
    ...
    fn block_12<T: Tracer>(
        ...
        let s_12_0: i64 = 128;
        // D s_12_1: write-var ga#256436 <= s_12_0
        fn_state.ga_256436 = s_12_0;
        // N s_12_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
