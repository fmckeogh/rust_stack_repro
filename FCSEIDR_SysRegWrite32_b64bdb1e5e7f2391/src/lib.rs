...
use common::*;
pub fn FCSEIDR_SysRegWrite32_b64bdb1e5e7f2391<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_2: const #16568u : u32
        let s_6_2: u32 = 16568;
        // N s_6_3: write-reg s_6_2 <= s_6_1
        let s_6_3: () = {
            state.write_register::<u32>(s_6_2 as isize, s_6_1);
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#128379 <= s_8_0
        fn_state.gs_128379 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#128379:u8
        let s_9_0: bool = fn_state.gs_128379;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#128380 <= s_10_0
        fn_state.gs_128380 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#128380:u8
        let s_11_0: bool = fn_state.gs_128380;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#128381 <= s_13_0
        fn_state.gs_128381 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#128381:u8
        let s_14_0: bool = fn_state.gs_128381;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#128382 <= s_15_0
        fn_state.gs_128382 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#128382:u8
        let s_16_0: bool = fn_state.gs_128382;
    ...
    fn block_17<T: Tracer>(
        ...
        // C s_17_2: const #16568u : u32
        let s_17_2: u32 = 16568;
        // N s_17_3: write-reg s_17_2 <= s_17_1
        let s_17_3: () = {
            state.write_register::<u32>(s_17_2 as isize, s_17_1);
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_5: write-var gs#128382 <= s_19_4
        fn_state.gs_128382 = s_19_4;
        // N s_19_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_3: write-var gs#128381 <= s_20_2
        fn_state.gs_128381 = s_20_2;
        // N s_20_4: jump b14
        return block_14(state, tracer, fn_state);
    }
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_5: write-var gs#128380 <= s_22_4
        fn_state.gs_128380 = s_22_4;
        // N s_22_6: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_23<T: Tracer>(
        ...
        // D s_23_4: write-var gs#128379 <= s_23_3
        fn_state.gs_128379 = s_23_3;
        // N s_23_5: jump b9
        return block_9(state, tracer, fn_state);
    }
