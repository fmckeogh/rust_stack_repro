...
pub fn u__get_PMMIR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4026531840u : u32
        let s_0_3: u32 = 4026531840;
        ...
        // D s_0_11: tail-call Mk_PMMIR_Type(s_0_10)
        return Mk_PMMIR_Type(state, tracer, s_0_10);
    }
}
