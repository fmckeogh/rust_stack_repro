...
use common::*;
pub fn execute_PRFB_I_P_BR_S<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    esize: i64,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var offsetshadow#4494 <= s_3_0
        fn_state.offsetshadow_4494 = s_3_0;
        // D s_3_2: read-var base:u64
        let s_3_2: u64 = fn_state.base;
        // D s_3_3: write-var baseshadow#4495 <= s_3_2
        fn_state.baseshadow_4495 = s_3_2;
        ...
        // D s_3_10: write-var gs#226072 <= s_3_9
        fn_state.gs_226072 = s_3_9;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#226072:i64
        let s_4_1: i64 = fn_state.gs_226072;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var offsetshadow#4494:u64
        let s_8_0: u64 = fn_state.offsetshadow_4494;
        ...
        // D s_8_5: add s_8_2 s_8_4
        let s_8_5: i128 = (s_8_2 + s_8_4);
        // D s_8_6: read-var scale:i64
        let s_8_6: i64 = fn_state.scale;
        // D s_8_7: cast zx s_8_6 -> i
        let s_8_7: i128 = (i128::try_from(s_8_6).unwrap());
        // D s_8_8: lsl s_8_5 s_8_7
        let s_8_8: i128 = s_8_5 << s_8_7;
        // D s_8_9: read-var baseshadow#4495:u64
        let s_8_9: u64 = fn_state.baseshadow_4495;
        // D s_8_10: cast zx s_8_9 -> bv
        let s_8_10: Bits = Bits::new(s_8_9 as u128, 64u16);
        // D s_8_11: cast cvt s_8_8 -> bv
        let s_8_11: Bits = Bits::new(s_8_8 as u128, 128);
        // D s_8_12: add s_8_10 s_8_11
        let s_8_12: Bits = (s_8_10 + s_8_11);
        // D s_8_13: cast reint s_8_12 -> u64
        let s_8_13: u64 = (s_8_12.value() as u64);
        // D s_8_14: read-var level:i64
        let s_8_14: i64 = fn_state.level;
        // D s_8_15: cast zx s_8_14 -> i
        let s_8_15: i128 = (i128::try_from(s_8_14).unwrap());
        // D s_8_16: read-var pref_hint:u32
        let s_8_16: u32 = fn_state.pref_hint;
        // D s_8_17: read-var stream:u8
        let s_8_17: bool = fn_state.stream;
        // D s_8_18: call Hint_Prefetch(s_8_13, s_8_16, s_8_15, s_8_17)
        let s_8_18: () = Hint_Prefetch(state, tracer, s_8_13, s_8_16, s_8_15, s_8_17);
        // N s_8_19: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_3: call X_read(s_12_2, s_12_0)
        let s_12_3: Bits = X_read(state, tracer, s_12_2, s_12_0);
        // D s_12_4: cast reint s_12_3 -> u64
        let s_12_4: u64 = (s_12_3.value() as u64);
        // D s_12_5: write-var offset <= s_12_4
        fn_state.offset = s_12_4;
        // N s_12_6: jump b3
        return block_3(state, tracer, fn_state);
    }
