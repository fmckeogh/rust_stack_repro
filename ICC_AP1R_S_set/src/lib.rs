...
extern crate alloc;
use common::*;
pub fn ICC_AP1R_S_set<T: Tracer>(
    state: &mut State,
    tracer: &T,
    n: i64,
    value_name: u32,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_15: const #22864u : u32
        let s_0_15: u32 = 22864;
        ...
        // C s_0_22: const #22864u : u32
        let s_0_22: u32 = 22864;
