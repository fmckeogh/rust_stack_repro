...
extern crate alloc;
use common::*;
pub fn ERXMISC6_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #12936u : u32
        let s_0_23: u32 = 12936;
        ...
        // C s_0_25: const #90952u : u32
        let s_0_25: u32 = 90952;
