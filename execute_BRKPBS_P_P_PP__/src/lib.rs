...
use LastActive::*;
use common::*;
pub fn execute_BRKPBS_P_P_PP__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_47: write-var gs#201585 <= s_1_46
        fn_state.gs_201585 = s_1_46;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#201585:i64
        let s_2_1: i64 = fn_state.gs_201585;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#201592 <= s_7_0
        fn_state.gs_201592 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#201592:u8
        let s_8_0: bool = fn_state.gs_201592;
    ...
    fn block_10<T: Tracer>(
        ...
        // C s_10_1: const #1s : i
        let s_10_1: i128 = 1;
        // D s_10_2: read-var pbit:u8
        let s_10_2: bool = fn_state.pbit;
        // D s_10_3: cast zx s_10_2 -> bv
        let s_10_3: Bits = Bits::new(s_10_2 as u128, 1u16);
        // D s_10_4: bits-cast zx s_10_3 -> bv length s_10_1
        let s_10_4: Bits = s_10_3.zero_extend(s_10_1);
        ...
        // C s_10_8: cast zx s_10_0 -> i
        let s_10_8: i128 = (i128::try_from(s_10_0).unwrap());
        // D s_10_9: cast zx s_10_5 -> bv
        let s_10_9: Bits = Bits::new(s_10_5 as u128, 1u16);
        // D s_10_10: read-var result:bv
        let s_10_10: Bits = fn_state.result;
        // D s_10_11: call Elem_set(s_10_10, s_10_7, s_10_8, s_10_9)
        let s_10_11: Bits = Elem_set(state, tracer, s_10_10, s_10_7, s_10_8, s_10_9);
        // D s_10_12: write-var result <= s_10_11
        fn_state.result = s_10_11;
        // N s_10_13: jump b5
        return block_5(state, tracer, fn_state);
    }
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_3: read-var operand2:bv
        let s_12_3: Bits = fn_state.operand2;
        // D s_12_4: call ActivePredicateElement(s_12_3, s_12_2, s_12_0)
        let s_12_4: bool = ActivePredicateElement(state, tracer, s_12_3, s_12_2, s_12_0);
        // D s_12_5: not s_12_4
        let s_12_5: bool = !s_12_4;
        // D s_12_6: write-var gs#201592 <= s_12_5
        fn_state.gs_201592 = s_12_5;
        // N s_12_7: jump b8
        return block_8(state, tracer, fn_state);
    }
