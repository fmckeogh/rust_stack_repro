...
use EDSCR2_read::*;
use u_get_DBGWCR_EL1_Type_E::*;
use common::*;
pub fn IsWatchpointEnabled<T: Tracer>(state: &mut State, tracer: &T, n: i64) -> bool {
    #[derive(Default)]
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#16670 <= s_1_0
        fn_state.gs_16670 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#16670:u8
        let s_2_0: bool = fn_state.gs_16670;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_0: const #103984u : u32
        let s_3_0: u32 = 103984;
        ...
        // D s_3_5: call _get_DBGWCR_EL1_Type_E(s_3_4)
        let s_3_5: bool = u_get_DBGWCR_EL1_Type_E(state, tracer, s_3_4);
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#16667 <= s_7_0
        fn_state.gs_16667 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#16667:u8
        let s_8_0: bool = fn_state.gs_16667;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#16668 <= s_10_0
        fn_state.gs_16668 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#16668:u8
        let s_11_0: bool = fn_state.gs_16668;
        // D s_11_1: write-var gs#16669 <= s_11_0
        fn_state.gs_16669 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#16669:u8
        let s_12_0: bool = fn_state.gs_16669;
        // D s_12_1: write-var gs#16670 <= s_12_0
        fn_state.gs_16670 = s_12_0;
        // N s_12_2: jump b2
        return block_2(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_7: write-var gs#16668 <= s_13_6
        fn_state.gs_16668 = s_13_6;
        // N s_13_8: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#16669 <= s_14_0
        fn_state.gs_16669 = s_14_0;
        // N s_14_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#16667 <= s_15_2
        fn_state.gs_16667 = s_15_2;
        // N s_15_4: jump b8
        return block_8(state, tracer, fn_state);
    }
}
