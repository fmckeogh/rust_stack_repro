...
use common::*;
pub fn u__get_HFGITR_EL2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #16140901064495857664u : u64
        let s_0_3: u64 = 16140901064495857664;
        ...
        // D s_0_11: tail-call Mk_HFGITR_EL2_Type(s_0_10)
        return Mk_HFGITR_EL2_Type(state, tracer, s_0_10);
    }
}
