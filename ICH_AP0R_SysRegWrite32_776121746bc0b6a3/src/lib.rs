...
use common::*;
pub fn ICH_AP0R_SysRegWrite32_776121746bc0b6a3<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_2: call Mk_ICH_AP0R_Type(s_8_1)
        let s_8_2: ProductType700c18a878c5601b = Mk_ICH_AP0R_Type(state, tracer, s_8_1);
        // C s_8_3: const #0s : i64
        let s_8_3: i64 = 0;
        // D s_8_4: call ICH_AP0R_set(s_8_3, s_8_2)
        let s_8_4: () = ICH_AP0R_set(state, tracer, s_8_3, s_8_2);
        // N s_8_5: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_2: call Mk_ICH_AP0R_Type(s_11_1)
        let s_11_2: ProductType700c18a878c5601b = Mk_ICH_AP0R_Type(
            state,
            tracer,
            s_11_1,
        );
        ...
        let s_11_3: i64 = 0;
        // D s_11_4: call ICH_AP0R_set(s_11_3, s_11_2)
        let s_11_4: () = ICH_AP0R_set(state, tracer, s_11_3, s_11_2);
        // N s_11_5: return
        return;
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#128824 <= s_14_0
        fn_state.gs_128824 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#128824:u8
        let s_15_0: bool = fn_state.gs_128824;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#128825 <= s_16_0
        fn_state.gs_128825 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#128825:u8
        let s_17_0: bool = fn_state.gs_128825;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#128826 <= s_19_0
        fn_state.gs_128826 = s_19_0;
        // N s_19_2: jump b20
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_0: read-var gs#128826:u8
        let s_20_0: bool = fn_state.gs_128826;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#128827 <= s_21_0
        fn_state.gs_128827 = s_21_0;
        // N s_21_2: jump b22
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_0: read-var gs#128827:u8
        let s_22_0: bool = fn_state.gs_128827;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_5: write-var gs#128827 <= s_25_4
        fn_state.gs_128827 = s_25_4;
        // N s_25_6: jump b22
        return block_22(state, tracer, fn_state);
    }
    fn block_26<T: Tracer>(
        ...
        // D s_26_3: write-var gs#128826 <= s_26_2
        fn_state.gs_128826 = s_26_2;
        // N s_26_4: jump b20
        return block_20(state, tracer, fn_state);
    }
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_5: write-var gs#128825 <= s_28_4
        fn_state.gs_128825 = s_28_4;
        // N s_28_6: jump b17
        return block_17(state, tracer, fn_state);
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_4: write-var gs#128824 <= s_29_3
        fn_state.gs_128824 = s_29_3;
        // N s_29_5: jump b15
        return block_15(state, tracer, fn_state);
    }
