...
use common::*;
pub fn execute_aarch64_instrs_integer_tags_mcsubtag<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ADD: bool,
    d: i64,
    ...
    struct FunctionState {
        start_tag: u8,
        rtag: u8,
        gs_718564: ProductTyped54bc449dd09e5bd,
        result: u64,
        resultshadow_1985: u64,
        operand1: u64,
        exclude: u16,
        gs_718559: ProductTyped54bc449dd09e5bd,
        ADD: bool,
        d: i64,
        n: i64,
        offset: u64,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_9: write-var gs#718559 <= s_5_8
        fn_state.gs_718559 = s_5_8;
        // D s_5_10: read-var gs#718559.0:struct
        let s_5_10: Bits = fn_state.gs_718559._0;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: write-var resultshadow#1985 <= s_6_2
        fn_state.resultshadow_1985 = s_6_2;
        // C s_6_4: const #31s : i
        let s_6_4: i128 = 31;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_3: read-var resultshadow#1985:u64
        let s_7_3: u64 = fn_state.resultshadow_1985;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var resultshadow#1985:u64
        let s_8_0: u64 = fn_state.resultshadow_1985;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_6: write-var gs#718564 <= s_9_5
        fn_state.gs_718564 = s_9_5;
        // D s_9_7: read-var gs#718564.0:struct
        let s_9_7: Bits = fn_state.gs_718564._0;
