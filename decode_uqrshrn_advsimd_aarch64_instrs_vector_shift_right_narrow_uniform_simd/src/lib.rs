...
use fdiv_int::*;
use common::*;
pub fn decode_uqrshrn_advsimd_aarch64_instrs_vector_shift_right_narrow_uniform_simd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_43: read-var U:u8
        let s_2_43: bool = fn_state.U;
        // D s_2_44: cast zx s_2_43 -> bv
        let s_2_44: Bits = Bits::new(s_2_43 as u128, 1u16);
        // C s_2_45: const #1u : u8
        let s_2_45: bool = true;
        // C s_2_46: cast zx s_2_45 -> bv
        let s_2_46: Bits = Bits::new(s_2_45 as u128, 1u16);
        // D s_2_47: cmp-eq s_2_44 s_2_46
        let s_2_47: bool = ((s_2_44) == (s_2_46));
        // D s_2_48: write-var is_unsigned <= s_2_47
        fn_state.is_unsigned = s_2_47;
        // D s_2_49: read-var esize:i
        let s_2_49: i128 = fn_state.esize;
        // D s_2_50: call __id(s_2_49)
        let s_2_50: i128 = u__id(state, tracer, s_2_49);
        // C s_2_51: const #4s : i
        let s_2_51: i128 = 4;
        // D s_2_52: cmp-eq s_2_50 s_2_51
        let s_2_52: bool = ((s_2_50) == (s_2_51));
        // N s_2_53: branch s_2_52 b14 b3
        if s_2_52 {
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#171807 <= s_3_3
        fn_state.gs_171807 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#171807:u8
        let s_4_0: bool = fn_state.gs_171807;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#171809 <= s_5_3
        fn_state.gs_171809 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#171809:u8
        let s_6_0: bool = fn_state.gs_171809;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#171811 <= s_7_3
        fn_state.gs_171811 = s_7_3;
        // N s_7_5: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#171811:u8
        let s_8_0: bool = fn_state.gs_171811;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: write-var gs#171813 <= s_9_3
        fn_state.gs_171813 = s_9_3;
        // N s_9_5: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#171813:u8
        let s_10_0: bool = fn_state.gs_171813;
        // N s_10_1: assert s_10_0
        let s_10_1: () = assert!(s_10_0);
        // C s_10_2: const #64s : i64
        let s_10_2: i64 = 64;
        // D s_10_3: read-var esize:i
        let s_10_3: i128 = fn_state.esize;
        ...
        // D s_10_11: read-var is_unsigned:u8
        let s_10_11: bool = fn_state.is_unsigned;
        // D s_10_12: call execute_aarch64_instrs_vector_shift_right_narrow_uniform_sisd(s_10_5, s_10_2, s_10_6, s_10_4, s_10_7, s_10_8, s_10_9, s_10_10, s_10_11)
        let s_10_12: () = execute_aarch64_instrs_vector_shift_right_narrow_uniform_sisd(
            state,
            tracer,
            s_10_5,
            s_10_2,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#171813 <= s_11_0
        fn_state.gs_171813 = s_11_0;
        // N s_11_2: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#171811 <= s_12_0
        fn_state.gs_171811 = s_12_0;
        // N s_12_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#171809 <= s_13_0
        fn_state.gs_171809 = s_13_0;
        // N s_13_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#171807 <= s_14_0
        fn_state.gs_171807 = s_14_0;
        // N s_14_2: jump b4
        return block_4(state, tracer, fn_state);
    }
