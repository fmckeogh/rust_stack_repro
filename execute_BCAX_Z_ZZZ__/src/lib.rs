...
use Z_set::*;
use common::*;
pub fn execute_BCAX_Z_ZZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    dn: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#4286 <= s_0_2
        fn_state.VLshadow_4286 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#4286:i64
        let s_1_0: i64 = fn_state.VLshadow_4286;
        ...
        // D s_1_21: not s_1_18
        let s_1_21: Bits = !s_1_18;
        // D s_1_22: and s_1_12 s_1_21
        let s_1_22: Bits = ((s_1_12) & (s_1_21));
        // D s_1_23: xor s_1_6 s_1_22
        let s_1_23: Bits = ((s_1_6) ^ (s_1_22));
        // D s_1_24: read-var dn:i64
        let s_1_24: i64 = fn_state.dn;
        // D s_1_25: cast zx s_1_24 -> i
        let s_1_25: i128 = (i128::try_from(s_1_24).unwrap());
        // D s_1_26: cast zx s_1_20 -> i
        let s_1_26: i128 = (i128::try_from(s_1_20).unwrap());
        // D s_1_27: call Z_set(s_1_25, s_1_26, s_1_23)
        let s_1_27: () = Z_set(state, tracer, s_1_25, s_1_26, s_1_23);
        // N s_1_28: return
        return;
    }
}
