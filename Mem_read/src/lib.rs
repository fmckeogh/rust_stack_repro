...
pub fn Mem_read<T: Tracer>(
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_4: write-var gs#20254 <= s_1_3
        fn_state.gs_20254 = s_1_3;
        // N s_1_5: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#20254:u8
        let s_2_0: bool = fn_state.gs_20254;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#20256 <= s_3_3
        fn_state.gs_20256 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#20256:u8
        let s_4_0: bool = fn_state.gs_20256;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#20258 <= s_5_3
        fn_state.gs_20258 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#20258:u8
        let s_6_0: bool = fn_state.gs_20258;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#20260 <= s_7_3
        fn_state.gs_20260 = s_7_3;
        // N s_7_5: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#20260:u8
        let s_8_0: bool = fn_state.gs_20260;
        ...
        // D s_8_9: write-var ga#15698 <= s_8_8
        fn_state.ga_15698 = s_8_8;
        // N s_8_10: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var ga#15698:bv
        let s_9_0: Bits = fn_state.ga_15698;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#20260 <= s_10_0
        fn_state.gs_20260 = s_10_0;
        // N s_10_2: jump b8
        return block_8(state, tracer, fn_state);
    }
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#20258 <= s_11_0
        fn_state.gs_20258 = s_11_0;
        // N s_11_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#20256 <= s_12_0
        fn_state.gs_20256 = s_12_0;
        // N s_12_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#20254 <= s_13_0
        fn_state.gs_20254 = s_13_0;
        // N s_13_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
