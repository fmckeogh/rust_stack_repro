...
use AddPACIB::*;
use common::*;
pub fn execute_aarch64_instrs_integer_pac_pacib_dp_1src<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    n: i64,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_10: call AddPACIB(s_3_4, s_3_9)
        let s_3_10: u64 = AddPACIB(state, tracer, s_3_4, s_3_9);
        // D s_3_11: write-var ga#263869 <= s_3_10
        fn_state.ga_263869 = s_3_10;
        // N s_3_12: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: read-var ga#263869:u64
        let s_4_2: u64 = fn_state.ga_263869;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_7: call AddPACIB(s_5_4, s_5_6)
        let s_5_7: u64 = AddPACIB(state, tracer, s_5_4, s_5_6);
        // D s_5_8: write-var ga#263863 <= s_5_7
        fn_state.ga_263863 = s_5_7;
        // N s_5_9: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: read-var ga#263863:u64
        let s_6_2: u64 = fn_state.ga_263863;
