...
use common::*;
pub fn decode_aarch32_instrs_UADD8_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#303937 <= s_3_3
        fn_state.gs_303937 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#303937:u8
        let s_4_0: bool = fn_state.gs_303937;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#303939 <= s_5_3
        fn_state.gs_303939 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#303939:u8
        let s_6_0: bool = fn_state.gs_303939;
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#303939 <= s_9_0
        fn_state.gs_303939 = s_9_0;
        // N s_9_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#303937 <= s_10_0
        fn_state.gs_303937 = s_10_0;
        // N s_10_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
