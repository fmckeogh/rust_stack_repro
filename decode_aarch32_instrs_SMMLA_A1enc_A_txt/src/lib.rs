...
use common::*;
pub fn decode_aarch32_instrs_SMMLA_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    Rd: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: write-var gs#301482 <= s_4_3
        fn_state.gs_301482 = s_4_3;
        // N s_4_5: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#301482:u8
        let s_5_0: bool = fn_state.gs_301482;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: write-var gs#301484 <= s_6_3
        fn_state.gs_301484 = s_6_3;
        // N s_6_5: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#301484:u8
        let s_7_0: bool = fn_state.gs_301484;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#301484 <= s_10_0
        fn_state.gs_301484 = s_10_0;
        // N s_10_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#301482 <= s_11_0
        fn_state.gs_301482 = s_11_0;
        // N s_11_2: jump b5
        return block_5(state, tracer, fn_state);
    }
