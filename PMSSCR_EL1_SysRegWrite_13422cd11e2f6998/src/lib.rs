...
use u__set_PMSSCR_EL1::*;
use Halted::*;
use u_get_MDCR_EL3_Type_EnPMSS::*;
use u_get_SCR_EL3_Type_FGTEn2::*;
use u_get_EDSCR_Type_SDD::*;
use X_read::*;
use u_get_HDFGWTR2_EL2_Type_nPMSSCR_EL1::*;
use AArch64_SystemAccessTrap::*;
use u__IMPDEF_boolean::*;
use EDSCR_read::*;
use Mk_PMSSCR_EL1_Type::*;
use common::*;
pub fn PMSSCR_EL1_SysRegWrite_13422cd11e2f6998<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ...
        gs_91303: bool,
        gs_91302: bool,
        u__HDFGWTR2_EL2_nPMSSCR_EL1: bool,
        gs_91306: bool,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_17: call _get_HDFGWTR2_EL2_Type_nPMSSCR_EL1(s_0_16)
        let s_0_17: bool = u_get_HDFGWTR2_EL2_Type_nPMSSCR_EL1(state, tracer, s_0_16);
        // D s_0_18: write-var __HDFGWTR2_EL2_nPMSSCR_EL1 <= s_0_17
        fn_state.u__HDFGWTR2_EL2_nPMSSCR_EL1 = s_0_17;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_PMSSCR_EL1_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_PMSSCR_EL1_Type(
            state,
            tracer,
            s_5_3,
        );
        // D s_5_5: call __set_PMSSCR_EL1(s_5_4)
        let s_5_5: () = u__set_PMSSCR_EL1(state, tracer, s_5_4);
        // N s_5_6: return
        return;
    }
    fn block_6<T: Tracer>(
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#91290 <= s_7_0
        fn_state.gs_91290 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#91290:u8
        let s_8_0: bool = fn_state.gs_91290;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#91291 <= s_9_0
        fn_state.gs_91291 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#91291:u8
        let s_10_0: bool = fn_state.gs_91291;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#91292 <= s_11_0
        fn_state.gs_91292 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#91292:u8
        let s_12_0: bool = fn_state.gs_91292;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#91293 <= s_13_0
        fn_state.gs_91293 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#91293:u8
        let s_14_0: bool = fn_state.gs_91293;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#91294 <= s_16_0
        fn_state.gs_91294 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#91294:u8
        let s_17_0: bool = fn_state.gs_91294;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_4: call Mk_PMSSCR_EL1_Type(s_18_3)
        let s_18_4: ProductType5c790c8ef59cc8b2 = Mk_PMSSCR_EL1_Type(
            state,
            tracer,
            s_18_3,
        );
        // D s_18_5: call __set_PMSSCR_EL1(s_18_4)
        let s_18_5: () = u__set_PMSSCR_EL1(state, tracer, s_18_4);
        // N s_18_6: return
        return;
    }
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_1: write-var gs#91296 <= s_20_0
        fn_state.gs_91296 = s_20_0;
        // N s_20_2: jump b21
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var gs#91296:u8
        let s_21_0: bool = fn_state.gs_91296;
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_5: write-var gs#91296 <= s_24_4
        fn_state.gs_91296 = s_24_4;
        // N s_24_6: jump b21
        return block_21(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_5: write-var gs#91294 <= s_25_4
        fn_state.gs_91294 = s_25_4;
        // N s_25_6: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_5: write-var gs#91293 <= s_27_4
        fn_state.gs_91293 = s_27_4;
        // N s_27_6: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_28<T: Tracer>(
        ...
        // D s_28_2: write-var gs#91292 <= s_28_1
        fn_state.gs_91292 = s_28_1;
        // N s_28_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_5: write-var gs#91291 <= s_29_4
        fn_state.gs_91291 = s_29_4;
        // N s_29_6: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_4: write-var gs#91290 <= s_30_3
        fn_state.gs_91290 = s_30_3;
        // N s_30_5: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_32<T: Tracer>(
        ...
        // D s_32_1: write-var gs#91297 <= s_32_0
        fn_state.gs_91297 = s_32_0;
        // N s_32_2: jump b33
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_0: read-var gs#91297:u8
        let s_33_0: bool = fn_state.gs_91297;
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_1: write-var gs#91298 <= s_34_0
        fn_state.gs_91298 = s_34_0;
        // N s_34_2: jump b35
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_0: read-var gs#91298:u8
        let s_35_0: bool = fn_state.gs_91298;
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_1: write-var gs#91299 <= s_36_0
        fn_state.gs_91299 = s_36_0;
        // N s_36_2: jump b37
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_0: read-var gs#91299:u8
        let s_37_0: bool = fn_state.gs_91299;
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_1: write-var gs#91300 <= s_38_0
        fn_state.gs_91300 = s_38_0;
        // N s_38_2: jump b39
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_0: read-var gs#91300:u8
        let s_39_0: bool = fn_state.gs_91300;
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_1: write-var gs#91301 <= s_41_0
        fn_state.gs_91301 = s_41_0;
        // N s_41_2: jump b42
    ...
    fn block_42<T: Tracer>(
        ...
        // D s_42_0: read-var gs#91301:u8
        let s_42_0: bool = fn_state.gs_91301;
    ...
    fn block_43<T: Tracer>(
        ...
        // D s_43_1: write-var gs#91302 <= s_43_0
        fn_state.gs_91302 = s_43_0;
        // N s_43_2: jump b44
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_0: read-var gs#91302:u8
        let s_44_0: bool = fn_state.gs_91302;
    ...
    fn block_45<T: Tracer>(
        ...
        // D s_45_1: write-var gs#91303 <= s_45_0
        fn_state.gs_91303 = s_45_0;
        // N s_45_2: jump b46
    ...
    fn block_46<T: Tracer>(
        ...
        // D s_46_0: read-var gs#91303:u8
        let s_46_0: bool = fn_state.gs_91303;
    ...
    fn block_48<T: Tracer>(
        ...
        // D s_48_1: write-var gs#91304 <= s_48_0
        fn_state.gs_91304 = s_48_0;
        // N s_48_2: jump b49
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_0: read-var gs#91304:u8
        let s_49_0: bool = fn_state.gs_91304;
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_1: write-var gs#91305 <= s_50_0
        fn_state.gs_91305 = s_50_0;
        // N s_50_2: jump b51
    ...
    fn block_51<T: Tracer>(
        ...
        // D s_51_0: read-var gs#91305:u8
        let s_51_0: bool = fn_state.gs_91305;
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_1: write-var gs#91306 <= s_53_0
        fn_state.gs_91306 = s_53_0;
        // N s_53_2: jump b54
    ...
    fn block_54<T: Tracer>(
        ...
        // D s_54_0: read-var gs#91306:u8
        let s_54_0: bool = fn_state.gs_91306;
    ...
    fn block_55<T: Tracer>(
        ...
        // D s_55_4: call Mk_PMSSCR_EL1_Type(s_55_3)
        let s_55_4: ProductType5c790c8ef59cc8b2 = Mk_PMSSCR_EL1_Type(
            state,
            tracer,
            s_55_3,
        );
        // D s_55_5: call __set_PMSSCR_EL1(s_55_4)
        let s_55_5: () = u__set_PMSSCR_EL1(state, tracer, s_55_4);
        // N s_55_6: return
        return;
    }
    ...
    fn block_57<T: Tracer>(
        ...
        // D s_57_1: write-var gs#91308 <= s_57_0
        fn_state.gs_91308 = s_57_0;
        // N s_57_2: jump b58
    ...
    fn block_58<T: Tracer>(
        ...
        // D s_58_0: read-var gs#91308:u8
        let s_58_0: bool = fn_state.gs_91308;
    ...
    fn block_61<T: Tracer>(
        ...
        // D s_61_5: write-var gs#91308 <= s_61_4
        fn_state.gs_91308 = s_61_4;
        // N s_61_6: jump b58
        return block_58(state, tracer, fn_state);
    }
    fn block_62<T: Tracer>(
        ...
        // D s_62_5: write-var gs#91306 <= s_62_4
        fn_state.gs_91306 = s_62_4;
        // N s_62_6: jump b54
        return block_54(state, tracer, fn_state);
    }
    ...
    fn block_64<T: Tracer>(
        ...
        // D s_64_0: read-var __HDFGWTR2_EL2_nPMSSCR_EL1:u8
        let s_64_0: bool = fn_state.u__HDFGWTR2_EL2_nPMSSCR_EL1;
        ...
        // D s_64_5: write-var gs#91305 <= s_64_4
        fn_state.gs_91305 = s_64_4;
        // N s_64_6: jump b51
        return block_51(state, tracer, fn_state);
    }
    fn block_65<T: Tracer>(
        ...
        // D s_65_2: write-var gs#91304 <= s_65_1
        fn_state.gs_91304 = s_65_1;
        // N s_65_3: jump b49
        return block_49(state, tracer, fn_state);
    }
    ...
    fn block_67<T: Tracer>(
        ...
        // D s_67_5: write-var gs#91303 <= s_67_4
        fn_state.gs_91303 = s_67_4;
        // N s_67_6: jump b46
        return block_46(state, tracer, fn_state);
    }
    fn block_68<T: Tracer>(
        ...
        // D s_68_4: write-var gs#91302 <= s_68_3
        fn_state.gs_91302 = s_68_3;
        // N s_68_5: jump b44
        return block_44(state, tracer, fn_state);
    }
    fn block_69<T: Tracer>(
        ...
        // D s_69_2: write-var gs#91301 <= s_69_1
        fn_state.gs_91301 = s_69_1;
        // N s_69_3: jump b42
        return block_42(state, tracer, fn_state);
    }
    ...
    fn block_71<T: Tracer>(
        ...
        // D s_71_5: write-var gs#91300 <= s_71_4
        fn_state.gs_91300 = s_71_4;
        // N s_71_6: jump b39
        return block_39(state, tracer, fn_state);
    }
    fn block_72<T: Tracer>(
        ...
        // D s_72_2: write-var gs#91299 <= s_72_1
        fn_state.gs_91299 = s_72_1;
        // N s_72_3: jump b37
        return block_37(state, tracer, fn_state);
    }
    fn block_73<T: Tracer>(
        ...
        // D s_73_5: write-var gs#91298 <= s_73_4
        fn_state.gs_91298 = s_73_4;
        // N s_73_6: jump b35
        return block_35(state, tracer, fn_state);
    }
    fn block_74<T: Tracer>(
        ...
        // D s_74_4: write-var gs#91297 <= s_74_3
        fn_state.gs_91297 = s_74_3;
        // N s_74_5: jump b33
        return block_33(state, tracer, fn_state);
    }
