...
extern crate alloc;
use execute_SMLALL_ZA_ZZi_D::*;
use CurrentVL_read::*;
use HaveSME2::*;
use HaveSMEI16I64::*;
use common::*;
pub fn decode_SMLALL_ZA_ZZi_D<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Zm: u8,
    i3h: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#279575 <= s_1_0
        fn_state.gs_279575 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#279575:u8
        let s_2_0: bool = fn_state.gs_279575;
        // D s_2_1: not s_2_0
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_34: cast reint s_3_33 -> u8
        let s_3_34: u8 = (s_3_33.value() as u8);
        // D s_3_35: cast zx s_3_34 -> bv
        let s_3_35: Bits = Bits::new(s_3_34 as u128, 5u16);
        // D s_3_36: cast zx s_3_35 -> i
        let s_3_36: i128 = (s_3_35.value() as i128);
        // D s_3_37: cast reint s_3_36 -> i64
        let s_3_37: i64 = (s_3_36 as i64);
        // D s_3_38: write-var m <= s_3_37
        fn_state.m = s_3_37;
        // D s_3_39: read-var off2:u8
        let s_3_39: u8 = fn_state.off2;
        // D s_3_40: cast zx s_3_39 -> bv
        let s_3_40: Bits = Bits::new(s_3_39 as u128, 2u16);
        // C s_3_41: const #0u : u8
        let s_3_41: u8 = 0;
        // C s_3_42: cast zx s_3_41 -> bv
        let s_3_42: Bits = Bits::new(s_3_41 as u128, 2u16);
        // D s_3_43: cast reint s_3_40 -> u128
        let s_3_43: u128 = (s_3_40.value() as u128);
        // D s_3_44: size-of s_3_40
        let s_3_44: u16 = s_3_40.length();
        // C s_3_45: cast reint s_3_42 -> u128
        let s_3_45: u128 = (s_3_42.value() as u128);
        // D s_3_46: size-of s_3_42
        let s_3_46: u16 = s_3_42.length();
        // D s_3_47: lsl s_3_43 s_3_46
        let s_3_47: u128 = s_3_43 << s_3_46;
        // D s_3_48: or s_3_47 s_3_45
        let s_3_48: u128 = ((s_3_47) | (s_3_45));
        // D s_3_49: add s_3_44 s_3_46
        let s_3_49: u16 = (s_3_44 + s_3_46);
        // D s_3_50: create-bits s_3_48 s_3_49
        let s_3_50: Bits = Bits::new(s_3_48, s_3_49);
        // D s_3_51: cast reint s_3_50 -> u8
        let s_3_51: u8 = (s_3_50.value() as u8);
        // D s_3_52: cast zx s_3_51 -> bv
        let s_3_52: Bits = Bits::new(s_3_51 as u128, 4u16);
        ...
        // D s_3_56: read-var i3h:u8
        let s_3_56: bool = fn_state.i3h;
        // D s_3_57: cast zx s_3_56 -> bv
        let s_3_57: Bits = Bits::new(s_3_56 as u128, 1u16);
        // D s_3_58: read-var i3l:u8
        let s_3_58: u8 = fn_state.i3l;
        // D s_3_59: cast zx s_3_58 -> bv
        let s_3_59: Bits = Bits::new(s_3_58 as u128, 2u16);
        // D s_3_60: cast reint s_3_57 -> u128
        let s_3_60: u128 = (s_3_57.value() as u128);
        // D s_3_61: size-of s_3_57
        let s_3_61: u16 = s_3_57.length();
        // D s_3_62: cast reint s_3_59 -> u128
        let s_3_62: u128 = (s_3_59.value() as u128);
        // D s_3_63: size-of s_3_59
        let s_3_63: u16 = s_3_59.length();
        // D s_3_64: lsl s_3_60 s_3_63
        let s_3_64: u128 = s_3_60 << s_3_63;
        // D s_3_65: or s_3_64 s_3_62
        let s_3_65: u128 = ((s_3_64) | (s_3_62));
        // D s_3_66: add s_3_61 s_3_63
        let s_3_66: u16 = (s_3_61 + s_3_63);
        // D s_3_67: create-bits s_3_65 s_3_66
        let s_3_67: Bits = Bits::new(s_3_65, s_3_66);
        // D s_3_68: cast reint s_3_67 -> u8
        let s_3_68: u8 = (s_3_67.value() as u8);
        // D s_3_69: cast zx s_3_68 -> bv
        let s_3_69: Bits = Bits::new(s_3_68 as u128, 3u16);
        // D s_3_70: cast zx s_3_69 -> i
        let s_3_70: i128 = (s_3_69.value() as i128);
        // D s_3_71: cast reint s_3_70 -> i64
        let s_3_71: i64 = (s_3_70 as i64);
        // D s_3_72: write-var index <= s_3_71
        fn_state.index = s_3_71;
        // D s_3_73: read-var VL:i64
        let s_3_73: i64 = fn_state.VL;
        // C s_3_74: const #128s : i
        let s_3_74: i128 = 128;
        // D s_3_75: cast zx s_3_73 -> i
        let s_3_75: i128 = (i128::try_from(s_3_73).unwrap());
        // D s_3_76: cmp-eq s_3_75 s_3_74
        let s_3_76: bool = ((s_3_75) == (s_3_74));
        // D s_3_77: not s_3_76
        let s_3_77: bool = !s_3_76;
        // N s_3_78: branch s_3_77 b5 b4
        if s_3_77 {
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_8: call execute_SMLALL_ZA_ZZi_D(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5, s_4_6, s_4_7)
        let s_4_8: () = execute_SMLALL_ZA_ZZi_D(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_8: call execute_SMLALL_ZA_ZZi_D(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5, s_6_6, s_6_7)
        let s_6_8: () = execute_SMLALL_ZA_ZZi_D(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_8: call execute_SMLALL_ZA_ZZi_D(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5, s_8_6, s_8_7)
        let s_8_8: () = execute_SMLALL_ZA_ZZi_D(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_8: call execute_SMLALL_ZA_ZZi_D(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5, s_10_6, s_10_7)
        let s_10_8: () = execute_SMLALL_ZA_ZZi_D(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_8: call execute_SMLALL_ZA_ZZi_D(s_12_0, s_12_1, s_12_2, s_12_3, s_12_4, s_12_5, s_12_6, s_12_7)
        let s_12_8: () = execute_SMLALL_ZA_ZZi_D(
            state,
            tracer,
            s_12_0,
            s_12_1,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_2: write-var gs#279575 <= s_15_1
        fn_state.gs_279575 = s_15_1;
        // N s_15_3: jump b2
        return block_2(state, tracer, fn_state);
    }
}
