...
use common::*;
pub fn u__get_GPCCR_EL3<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #18446744073693561080u : u64
        let s_0_3: u64 = 18446744073693561080;
        ...
        // D s_0_11: tail-call Mk_GPCCR_EL3_Type(s_0_10)
        return Mk_GPCCR_EL3_Type(state, tracer, s_0_10);
    }
}
