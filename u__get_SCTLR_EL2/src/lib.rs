...
use common::*;
pub fn u__get_SCTLR_EL2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #64s : i
        let s_0_3: i128 = 64;
        // C s_0_4: const #17180000768u : u36
        let s_0_4: u64 = 17180000768;
        ...
        // D s_0_15: tail-call Mk_SCTLR_EL2_Type(s_0_14)
        return Mk_SCTLR_EL2_Type(state, tracer, s_0_14);
    }
}
