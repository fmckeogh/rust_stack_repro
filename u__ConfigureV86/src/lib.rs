...
use u__ConfigureV85::*;
use common::*;
pub fn u__ConfigureV86<T: Tracer>(state: &mut State, tracer: &T, enabled: bool) -> () {
    #[derive(Default)]
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: call __ConfigureV85(s_2_0)
        let s_2_1: () = u__ConfigureV85(state, tracer, s_2_0);
        // N s_2_2: return
        return;
    }
}
