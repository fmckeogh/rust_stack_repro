...
use Z_read::*;
use common::*;
pub fn execute_MOVA_ZA2_Z_D1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#5556 <= s_0_2
        fn_state.VLshadow_5556 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#5556:i64
        let s_1_0: i64 = fn_state.VLshadow_5556;
        // D s_1_1: write-var VLshadow#5557 <= s_1_0
        fn_state.VLshadow_5557 = s_1_0;
        // D s_1_2: read-var VLshadow#5557:i64
        let s_1_2: i64 = fn_state.VLshadow_5557;
        ...
        // D s_1_43: write-var gs#258346 <= s_1_42
        fn_state.gs_258346 = s_1_42;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#258346:i64
        let s_2_1: i64 = fn_state.gs_258346;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_6: read-var VLshadow#5557:i64
        let s_3_6: i64 = fn_state.VLshadow_5557;
        ...
        // D s_3_19: read-var VLshadow#5557:i64
        let s_3_19: i64 = fn_state.VLshadow_5557;
