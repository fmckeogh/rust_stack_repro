...
use common::*;
pub fn decode_sqrshl_advsimd_aarch64_instrs_vector_arithmetic_binary_uniform_shift_simd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 64;
        // D s_2_1: write-var ga#267847 <= s_2_0
        fn_state.ga_267847 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#267847:i64
        let s_3_0: i64 = fn_state.ga_267847;
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 128;
        // D s_4_1: write-var ga#267847 <= s_4_0
        fn_state.ga_267847 = s_4_0;
        // N s_4_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_5<T: Tracer>(
