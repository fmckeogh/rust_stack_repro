...
use fdiv_int::*;
use common::*;
pub fn execute_WHILEWR_P_RR__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_39: div s_1_38 s_1_36
        let s_1_39: i128 = ((s_1_38) / (s_1_36));
        ...
        // D s_1_42: call fdiv_int(s_1_35, s_1_41)
        let s_1_42: i128 = fdiv_int(state, tracer, s_1_35, s_1_41);
        // D s_1_43: write-var diff <= s_1_42
        fn_state.diff = s_1_42;
        // C s_1_44: const #0s : i64
        let s_1_44: i64 = 0;
        // C s_1_45: const #1s : i
        let s_1_45: i128 = 1;
        // D s_1_46: cast zx s_1_10 -> i
        let s_1_46: i128 = (i128::try_from(s_1_10).unwrap());
        // D s_1_47: sub s_1_46 s_1_45
        let s_1_47: i128 = ((s_1_46) - (s_1_45));
        // D s_1_48: cast reint s_1_47 -> i64
        let s_1_48: i64 = (s_1_47 as i64);
        // D s_1_49: write-var gs#216234 <= s_1_48
        fn_state.gs_216234 = s_1_48;
        // D s_1_50: write-var e <= s_1_44
        fn_state.e = s_1_44;
        // N s_1_51: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#216234:i64
        let s_2_1: i64 = fn_state.gs_216234;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: write-var gs#216238 <= s_4_3
        fn_state.gs_216238 = s_4_3;
        // N s_4_5: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#216238:u8
        let s_5_0: bool = fn_state.gs_216238;
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#216238 <= s_9_0
        fn_state.gs_216238 = s_9_0;
        // N s_9_2: jump b5
        return block_5(state, tracer, fn_state);
    }
