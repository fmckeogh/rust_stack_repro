...
use D_read::*;
use common::*;
pub fn execute_aarch32_instrs_VRINTZ_vfp_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    esize: i64,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_3: write-var ga#366093 <= s_2_2
        fn_state.ga_366093 = s_2_2;
        ...
        // D s_2_21: write-var gs#915599 <= s_2_20
        fn_state.gs_915599 = s_2_20;
        // N s_2_22: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#915599:bv
        let s_3_0: Bits = fn_state.gs_915599;
        // D s_3_1: cast reint s_3_0 -> u16
        let s_3_1: u16 = (s_3_0.value() as u16);
        // D s_3_2: read-var ga#366093:u16
        let s_3_2: u16 = fn_state.ga_366093;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_9: write-var gs#915606 <= s_5_8
        fn_state.gs_915606 = s_5_8;
        // N s_5_10: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#915606:bv
        let s_6_0: Bits = fn_state.gs_915606;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_9: write-var gs#915611 <= s_8_8
        fn_state.gs_915611 = s_8_8;
        // N s_8_10: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#915611:bv
        let s_9_0: Bits = fn_state.gs_915611;
