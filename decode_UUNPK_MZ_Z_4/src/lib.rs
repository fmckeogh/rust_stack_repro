...
use CurrentVL_read::*;
use HaveSME2::*;
use execute_UUNPK_MZ_Z_4::*;
use common::*;
pub fn decode_UUNPK_MZ_Z_4<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Zn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_13: cast reint s_2_10 -> u128
        let s_2_13: u128 = (s_2_10.value() as u128);
        // D s_2_14: size-of s_2_10
        let s_2_14: u16 = s_2_10.length();
        // D s_2_15: lsl s_2_11 s_2_14
        let s_2_15: u128 = s_2_11 << s_2_14;
        // D s_2_16: or s_2_15 s_2_13
        let s_2_16: u128 = ((s_2_15) | (s_2_13));
        // D s_2_17: add s_2_12 s_2_14
        let s_2_17: u16 = (s_2_12 + s_2_14);
        // D s_2_18: create-bits s_2_16 s_2_17
        let s_2_18: Bits = Bits::new(s_2_16, s_2_17);
        ...
        let s_2_21: i128 = (s_2_20.value() as i128);
        // D s_2_22: cast reint s_2_21 -> i64
        let s_2_22: i64 = (s_2_21 as i64);
        // D s_2_23: write-var n <= s_2_22
        fn_state.n = s_2_22;
        // D s_2_24: read-var Zd:u8
        let s_2_24: u8 = fn_state.Zd;
        // D s_2_25: cast zx s_2_24 -> bv
        let s_2_25: Bits = Bits::new(s_2_24 as u128, 3u16);
        // C s_2_26: const #0u : u8
        let s_2_26: u8 = 0;
        ...
        // C s_2_30: cast reint s_2_27 -> u128
        ...
        let s_2_37: Bits = Bits::new(s_2_36 as u128, 5u16);
        // D s_2_38: cast zx s_2_37 -> i
        let s_2_38: i128 = (s_2_37.value() as i128);
        // D s_2_39: cast reint s_2_38 -> i64
        let s_2_39: i64 = (s_2_38 as i64);
        // D s_2_40: write-var d <= s_2_39
        fn_state.d = s_2_39;
        // D s_2_41: read-var VL:i64
        let s_2_41: i64 = fn_state.VL;
        // C s_2_42: const #128s : i
        let s_2_42: i128 = 128;
        // D s_2_43: cast zx s_2_41 -> i
        let s_2_43: i128 = (i128::try_from(s_2_41).unwrap());
        // D s_2_44: cmp-eq s_2_43 s_2_42
        let s_2_44: bool = ((s_2_43) == (s_2_42));
        // D s_2_45: not s_2_44
        let s_2_45: bool = !s_2_44;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_4: const #4s : i64
        let s_3_4: i64 = 4;
        // D s_3_5: read-var d:i64
        let s_3_5: i64 = fn_state.d;
        // D s_3_6: read-var n:i64
        let s_3_6: i64 = fn_state.n;
        // C s_3_7: const #1u : u8
        let s_3_7: bool = true;
        // D s_3_8: call execute_UUNPK_MZ_Z_4(s_3_0, s_3_5, s_3_3, s_3_6, s_3_4, s_3_7)
        let s_3_8: () = execute_UUNPK_MZ_Z_4(
            state,
            tracer,
            s_3_0,
            s_3_5,
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_7: const #1u : u8
        let s_5_7: bool = true;
        // D s_5_8: call execute_UUNPK_MZ_Z_4(s_5_0, s_5_5, s_5_3, s_5_6, s_5_4, s_5_7)
        let s_5_8: () = execute_UUNPK_MZ_Z_4(
            state,
            tracer,
            s_5_0,
            s_5_5,
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_7: const #1u : u8
        let s_7_7: bool = true;
        // D s_7_8: call execute_UUNPK_MZ_Z_4(s_7_0, s_7_5, s_7_3, s_7_6, s_7_4, s_7_7)
        let s_7_8: () = execute_UUNPK_MZ_Z_4(
            state,
            tracer,
            s_7_0,
            s_7_5,
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_7: const #1u : u8
        let s_9_7: bool = true;
        // D s_9_8: call execute_UUNPK_MZ_Z_4(s_9_0, s_9_5, s_9_3, s_9_6, s_9_4, s_9_7)
        let s_9_8: () = execute_UUNPK_MZ_Z_4(
            state,
            tracer,
            s_9_0,
            s_9_5,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_8: call execute_UUNPK_MZ_Z_4(s_11_0, s_11_5, s_11_3, s_11_6, s_11_4, s_11_7)
        let s_11_8: () = execute_UUNPK_MZ_Z_4(
            state,
            tracer,
            s_11_0,
            s_11_5,
