...
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_VSUB_f_T2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Vn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_7: write-var gs#322511 <= s_3_6
        fn_state.gs_322511 = s_3_6;
        // N s_3_8: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#322511:u8
        let s_4_0: bool = fn_state.gs_322511;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#322512 <= s_6_0
        fn_state.gs_322512 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#322512:u8
        let s_7_0: bool = fn_state.gs_322512;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#322513 <= s_9_0
        fn_state.gs_322513 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#322513:u8
        let s_10_0: bool = fn_state.gs_322513;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_7: read-var ga#363203:i
        let s_13_7: i128 = fn_state.ga_363203;
        // D s_13_8: read-var ga#363205:i
        let s_13_8: i128 = fn_state.ga_363205;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_2: write-var gs#322513 <= s_20_1
        fn_state.gs_322513 = s_20_1;
        // N s_20_3: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#322512 <= s_22_0
        fn_state.gs_322512 = s_22_0;
        // N s_22_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_1: write-var gs#322511 <= s_24_0
        fn_state.gs_322511 = s_24_0;
        // N s_24_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
