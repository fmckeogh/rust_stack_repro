...
use common::*;
pub fn decode_frecps_advsimd_aarch64_instrs_vector_arithmetic_binary_uniform_recps_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, Rm: u8, sz: bool) -> () {
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_22: const #1s : i
        let s_0_22: i128 = 1;
        // D s_0_23: call execute_aarch64_instrs_vector_arithmetic_binary_uniform_recps_fp16_sisd(s_0_3, s_0_19, s_0_22, s_0_21, s_0_11, s_0_7)
        let s_0_23: () = execute_aarch64_instrs_vector_arithmetic_binary_uniform_recps_fp16_sisd(
            state,
            tracer,
            s_0_3,
            s_0_19,
