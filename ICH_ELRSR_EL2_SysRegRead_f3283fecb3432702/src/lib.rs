...
use EL2Enabled::*;
use common::*;
pub fn ICH_ELRSR_EL2_SysRegRead_f3283fecb3432702<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_68256: ProductType5c790c8ef59cc8b2,
        u__ICC_SRE_EL2_SRE: bool,
        gs_62428: bool,
        u__ICC_SRE_EL3_SRE: bool,
        u__PSTATE_EL: u8,
        ga_68250: ProductType5c790c8ef59cc8b2,
        u__HCR_EL2_NV: bool,
        el: u8,
        op0: u8,
        op1: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_ICH_ELRSR_EL2(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_ICH_ELRSR_EL2(
            state,
            tracer,
            s_6_2,
        );
        // D s_6_4: write-var ga#68256 <= s_6_3
        fn_state.ga_68256 = s_6_3;
        // D s_6_5: read-var ga#68256.0:struct
        let s_6_5: u64 = fn_state.ga_68256._0;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_3: call __get_ICH_ELRSR_EL2(s_9_2)
        let s_9_3: ProductType5c790c8ef59cc8b2 = u__get_ICH_ELRSR_EL2(
            state,
            tracer,
            s_9_2,
        );
        // D s_9_4: write-var ga#68250 <= s_9_3
        fn_state.ga_68250 = s_9_3;
        // D s_9_5: read-var ga#68250.0:struct
        let s_9_5: u64 = fn_state.ga_68250._0;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#62428 <= s_12_0
        fn_state.gs_62428 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#62428:u8
        let s_13_0: bool = fn_state.gs_62428;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_5: write-var gs#62428 <= s_16_4
        fn_state.gs_62428 = s_16_4;
        // N s_16_6: jump b13
        return block_13(state, tracer, fn_state);
    }
