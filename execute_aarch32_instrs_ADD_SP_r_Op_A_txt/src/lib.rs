...
use ALUWritePC::*;
use common::*;
pub fn execute_aarch32_instrs_ADD_SP_r_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        result: u32,
        nzcv: u8,
        gs_877966: ProductTyped54bc449dd09e5bd,
        d: i64,
        m: i64,
        setflags: bool,
        shift_n: i128,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_15: call AddWithCarry(s_0_12, s_0_13, s_0_14)
        let s_0_15: ProductTyped54bc449dd09e5bd = AddWithCarry(
            state,
            tracer,
            s_0_12,
            s_0_13,
        ...
        // D s_0_16: write-var gs#877966 <= s_0_15
        fn_state.gs_877966 = s_0_15;
        // D s_0_17: read-var gs#877966.0:struct
        let s_0_17: Bits = fn_state.gs_877966._0;
        // D s_0_18: cast reint s_0_17 -> u32
        let s_0_18: u32 = (s_0_17.value() as u32);
        // D s_0_19: read-var gs#877966.1:struct
        let s_0_19: u8 = fn_state.gs_877966._1;
        // D s_0_20: write-var result <= s_0_18
        fn_state.result = s_0_18;
        // D s_0_21: write-var nzcv <= s_0_19
        fn_state.nzcv = s_0_19;
        // C s_0_22: const #15s : i
        let s_0_22: i128 = 15;
