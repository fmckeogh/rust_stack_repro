...
use common::*;
pub fn CNTPS_CVAL_EL1_SysRegWrite_0efe14958ca47dee<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_CNTPS_CVAL_EL1_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_CNTPS_CVAL_EL1_Type(
            state,
            tracer,
            s_5_3,
        );
        // C s_5_5: const #14160u : u32
        let s_5_5: u32 = 14160;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#81823 <= s_8_0
        fn_state.gs_81823 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#81823:u8
        let s_9_0: bool = fn_state.gs_81823;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_4: call Mk_CNTPS_CVAL_EL1_Type(s_13_3)
        let s_13_4: ProductType5c790c8ef59cc8b2 = Mk_CNTPS_CVAL_EL1_Type(
            state,
            tracer,
            s_13_3,
        );
        // C s_13_5: const #14160u : u32
        let s_13_5: u32 = 14160;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_5: write-var gs#81823 <= s_16_4
        fn_state.gs_81823 = s_16_4;
        // N s_16_6: jump b9
        return block_9(state, tracer, fn_state);
    }
