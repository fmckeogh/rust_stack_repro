...
use u__get_IFSR32_EL2::*;
use common::*;
pub fn IFSR32_EL2_SysRegRead_bc5173df6fb29c65<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        gs_62916: bool,
        u__PSTATE_EL: u8,
        ga_69909: ProductType5c790c8ef59cc8b2,
        u__HCR_EL2_NV: bool,
        ga_69905: ProductType5c790c8ef59cc8b2,
        el: u8,
        op0: u8,
        op1: u8,
        CRn: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_IFSR32_EL2(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_IFSR32_EL2(state, tracer, s_6_2);
        // D s_6_4: write-var ga#69909 <= s_6_3
        fn_state.ga_69909 = s_6_3;
        // D s_6_5: read-var ga#69909.0:struct
        let s_6_5: u64 = fn_state.ga_69909._0;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_3: call __get_IFSR32_EL2(s_7_2)
        let s_7_3: ProductType5c790c8ef59cc8b2 = u__get_IFSR32_EL2(state, tracer, s_7_2);
        // D s_7_4: write-var ga#69905 <= s_7_3
        fn_state.ga_69905 = s_7_3;
        // D s_7_5: read-var ga#69905.0:struct
        let s_7_5: u64 = fn_state.ga_69905._0;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#62916 <= s_9_0
        fn_state.gs_62916 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#62916:u8
        let s_10_0: bool = fn_state.gs_62916;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_5: write-var gs#62916 <= s_13_4
        fn_state.gs_62916 = s_13_4;
        // N s_13_6: jump b10
        return block_10(state, tracer, fn_state);
    }
