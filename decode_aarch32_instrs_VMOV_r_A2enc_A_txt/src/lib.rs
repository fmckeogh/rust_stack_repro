...
use common::*;
pub fn decode_aarch32_instrs_VMOV_r_A2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    D: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_7: write-var gs#313186 <= s_3_6
        fn_state.gs_313186 = s_3_6;
        // N s_3_8: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#313186:u8
        let s_4_0: bool = fn_state.gs_313186;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#313186 <= s_10_0
        fn_state.gs_313186 = s_10_0;
        // N s_10_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
