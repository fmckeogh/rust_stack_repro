...
use D_read::*;
use common::*;
pub fn execute_aarch32_instrs_VABD_i_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d__arg: i64,
    elements: i128,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#7336 <= s_0_2
        fn_state.esizeshadow_7336 = s_0_2;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_6: write-var gs#305732 <= s_1_5
        fn_state.gs_305732 = s_1_5;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#305732:i64
        let s_2_1: i64 = fn_state.gs_305732;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_5: write-var gs#305738 <= s_3_4
        fn_state.gs_305738 = s_3_4;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#305738:i64
        let s_4_1: i64 = fn_state.gs_305738;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_8: read-var esizeshadow#7336:i64
        let s_5_8: i64 = fn_state.esizeshadow_7336;
        ...
        // D s_5_24: read-var esizeshadow#7336:i64
        let s_5_24: i64 = fn_state.esizeshadow_7336;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_9: read-var esizeshadow#7336:i64
        let s_6_9: i64 = fn_state.esizeshadow_7336;
        ...
        // C s_6_12: const #1s : i
        let s_6_12: i128 = 1;
        // D s_6_13: read-var esizeshadow#7336:i64
        let s_6_13: i64 = fn_state.esizeshadow_7336;
        // D s_6_14: cast zx s_6_13 -> i
        let s_6_14: i128 = (i128::try_from(s_6_13).unwrap());
        // D s_6_15: sub s_6_14 s_6_12
        ...
        // D s_6_19: read-var absdiff:i
        let s_6_19: i128 = fn_state.absdiff;
        // D s_6_20: call integer_subrange(s_6_19, s_6_18, s_6_17)
        let s_6_20: Bits = integer_subrange(state, tracer, s_6_19, s_6_18, s_6_17);
        // D s_6_21: cast zx s_6_8 -> bv
        let s_6_21: Bits = Bits::new(s_6_8 as u128, 64u16);
        // D s_6_22: read-var e:i64
        let s_6_22: i64 = fn_state.e;
        // D s_6_23: cast zx s_6_22 -> i
        let s_6_23: i128 = (i128::try_from(s_6_22).unwrap());
        // D s_6_24: cast zx s_6_11 -> i
        let s_6_24: i128 = (i128::try_from(s_6_11).unwrap());
        // D s_6_25: call Elem_set(s_6_21, s_6_23, s_6_24, s_6_20)
        let s_6_25: Bits = Elem_set(state, tracer, s_6_21, s_6_23, s_6_24, s_6_20);
        // D s_6_26: cast reint s_6_25 -> u64
        let s_6_26: u64 = (s_6_25.value() as u64);
        // D s_6_27: call D_set(s_6_3, s_6_26)
        let s_6_27: () = D_set(state, tracer, s_6_3, s_6_26);
        // N s_6_28: jump b7
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_7: const #2s : i
        let s_8_7: i128 = 2;
        // D s_8_8: read-var esizeshadow#7336:i64
        let s_8_8: i64 = fn_state.esizeshadow_7336;
        ...
        // C s_8_14: const #2s : i
        let s_8_14: i128 = 2;
        // D s_8_15: read-var esizeshadow#7336:i64
        let s_8_15: i64 = fn_state.esizeshadow_7336;
        ...
        // D s_8_21: sub s_8_20 s_8_19
        let s_8_21: i128 = ((s_8_20) - (s_8_19));
        // D s_8_22: cast reint s_8_21 -> i64
        let s_8_22: i64 = (s_8_21 as i64);
        // C s_8_23: const #0s : i
        let s_8_23: i128 = 0;
        // D s_8_24: cast zx s_8_22 -> i
        let s_8_24: i128 = (i128::try_from(s_8_22).unwrap());
        // D s_8_25: read-var absdiff:i
        let s_8_25: i128 = fn_state.absdiff;
        // D s_8_26: call integer_subrange(s_8_25, s_8_24, s_8_23)
        let s_8_26: Bits = integer_subrange(state, tracer, s_8_25, s_8_24, s_8_23);
        // D s_8_27: cast zx s_8_6 -> bv
        let s_8_27: Bits = Bits::new(s_8_6 as u128, 128u16);
        // D s_8_28: read-var e:i64
        let s_8_28: i64 = fn_state.e;
        // D s_8_29: cast zx s_8_28 -> i
        let s_8_29: i128 = (i128::try_from(s_8_28).unwrap());
        // D s_8_30: cast zx s_8_13 -> i
        let s_8_30: i128 = (i128::try_from(s_8_13).unwrap());
        // D s_8_31: call Elem_set(s_8_27, s_8_29, s_8_30, s_8_26)
        let s_8_31: Bits = Elem_set(state, tracer, s_8_27, s_8_29, s_8_30, s_8_26);
        // D s_8_32: cast reint s_8_31 -> u128
        let s_8_32: u128 = (s_8_31.value() as u128);
        // D s_8_33: call Q_set(s_8_2, s_8_32)
        let s_8_33: () = Q_set(state, tracer, s_8_2, s_8_32);
        // N s_8_34: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
