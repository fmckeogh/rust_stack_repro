...
use common::*;
pub fn decode_ldursh_aarch64_instrs_memory_single_general_immediate_signed_offset_normal<
    T: Tracer,
>(state: &mut State, tracer: &T, Rt: u8, Rn: u8, imm9: u16, opc: u8, size: u8) -> () {
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#164767 <= s_3_0
        fn_state.gs_164767 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#164767:u8
        let s_4_0: bool = fn_state.gs_164767;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var regsizeshadow#1743 <= s_8_0
        fn_state.regsizeshadow_1743 = s_8_0;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#164790 <= s_9_0
        fn_state.gs_164790 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#164790:u8
        let s_10_0: bool = fn_state.gs_164790;
        ...
        // D s_10_4: read-var regsizeshadow#1743:i64
        let s_10_4: i64 = fn_state.regsizeshadow_1743;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_4: write-var gs#164790 <= s_11_3
        fn_state.gs_164790 = s_11_3;
        // N s_11_5: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_22: write-var gs#164767 <= s_14_21
        fn_state.gs_164767 = s_14_21;
        // N s_14_23: jump b4
        return block_4(state, tracer, fn_state);
    }
