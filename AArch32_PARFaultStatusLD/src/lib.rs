...
use EncodeLDFSC::*;
use common::*;
pub fn AArch32_PARFaultStatusLD<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_3: write-var syndrome <= s_1_2
        fn_state.syndrome = s_1_2;
        // N s_1_4: jump b2
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_3: write-var gs#30356 <= s_4_2
        fn_state.gs_30356 = s_4_2;
        // N s_4_4: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#30356:u8
        let s_5_0: bool = fn_state.gs_30356;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #2u : u8
        let s_6_0: u8 = 2;
        // D s_6_1: write-var ga#23553 <= s_6_0
        fn_state.ga_23553 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #0s : i
        let s_7_0: i128 = 0;
        // D s_7_1: read-var syndrome:u8
        let s_7_1: u8 = fn_state.syndrome;
        // D s_7_2: cast zx s_7_1 -> bv
        let s_7_2: Bits = Bits::new(s_7_1 as u128, 6u16);
        // D s_7_3: read-var ga#23553:u8
        let s_7_3: u8 = fn_state.ga_23553;
        ...
        // D s_7_17: write-var syndrome <= s_7_16
        fn_state.syndrome = s_7_16;
        // C s_7_18: const #2s : i
        let s_7_18: i128 = 2;
        // D s_7_19: read-var syndrome:u8
        let s_7_19: u8 = fn_state.syndrome;
        ...
        // D s_7_35: write-var syndrome <= s_7_34
        fn_state.syndrome = s_7_34;
        // N s_7_36: jump b2
        return block_2(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #1u : u8
        let s_8_0: u8 = 1;
        // D s_8_1: write-var ga#23553 <= s_8_0
        fn_state.ga_23553 = s_8_0;
        // N s_8_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#30356 <= s_9_0
        fn_state.gs_30356 = s_9_0;
        // N s_9_2: jump b5
        return block_5(state, tracer, fn_state);
    }
}
