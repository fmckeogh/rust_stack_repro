...
use common::*;
pub fn ICC_IGRPEN1_EL1_write<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#32803 <= s_1_0
        fn_state.gs_32803 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#32803:u8
        let s_2_0: bool = fn_state.gs_32803;
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: ProductType5c790c8ef59cc8b2 = fn_state.r;
        // C s_3_1: const #17040u : u32
        let s_3_1: u32 = 17040;
        // N s_3_2: write-reg s_3_1 <= s_3_0
        let s_3_2: () = {
            state.write_register::<ProductType5c790c8ef59cc8b2>(s_3_1 as isize, s_3_0);
    ...
    fn block_4<T: Tracer>(
        ...
        // C s_4_1: const #101216u : u32
        let s_4_1: u32 = 101216;
        // N s_4_2: write-reg s_4_1 <= s_4_0
        let s_4_2: () = {
            state.write_register::<ProductType5c790c8ef59cc8b2>(s_4_1 as isize, s_4_0);
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#32803 <= s_5_3
        fn_state.gs_32803 = s_5_3;
        // N s_5_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
