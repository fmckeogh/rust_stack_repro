...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_binary_element_mul_acc_int::*;
use common::*;
pub fn decode_mla_advsimd_elt_aarch64_instrs_vector_arithmetic_binary_element_mul_acc_int<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#263425 <= s_1_0
        fn_state.ga_263425 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#263425:i64
        let s_2_0: i64 = fn_state.ga_263425;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: write-var indexshadow#1758 <= s_4_1
        fn_state.indexshadow_1758 = s_4_1;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // D s_5_1: write-var ga#263437 <= s_5_0
        fn_state.ga_263437 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#263437:i64
        let s_6_0: i64 = fn_state.ga_263437;
        ...
        // D s_6_6: read-var o2:u8
        let s_6_6: bool = fn_state.o2;
        ...
        // D s_6_21: read-var indexshadow#1758:i64
        let s_6_21: i64 = fn_state.indexshadow_1758;
        // D s_6_22: read-var m:i64
        let s_6_22: i64 = fn_state.m;
        // D s_6_23: read-var n:i64
        let s_6_23: i64 = fn_state.n;
        // D s_6_24: call execute_aarch64_instrs_vector_arithmetic_binary_element_mul_acc_int(s_6_20, s_6_12, s_6_19, s_6_15, s_6_18, s_6_21, s_6_22, s_6_23, s_6_10)
        let s_6_24: () = execute_aarch64_instrs_vector_arithmetic_binary_element_mul_acc_int(
            state,
            tracer,
            s_6_20,
            s_6_12,
    ...
    fn block_7<T: Tracer>(
        ...
        let s_7_0: i64 = 128;
        // D s_7_1: write-var ga#263437 <= s_7_0
        fn_state.ga_263437 = s_7_0;
        // N s_7_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
    ...
    fn block_11<T: Tracer>(
        ...
        let s_11_0: i64 = 128;
        // D s_11_1: write-var ga#263425 <= s_11_0
        fn_state.ga_263425 = s_11_0;
        // N s_11_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
