...
use ConditionPassed::*;
use neq_int::*;
use execute_aarch32_instrs_PLD_i_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_PLD_i_T2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    W: bool,
    Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_8: const #32s : i
        let s_3_8: i128 = 32;
        // D s_3_9: read-var imm8:u8
        let s_3_9: u8 = fn_state.imm8;
        // D s_3_10: cast zx s_3_9 -> bv
        let s_3_10: Bits = Bits::new(s_3_9 as u128, 8u16);
        ...
        // C s_3_13: const #0u : u8
        let s_3_13: bool = false;
        // D s_3_14: read-var W:u8
        let s_3_14: bool = fn_state.W;
        ...
        // D s_3_19: call execute_aarch32_instrs_PLD_i_Op_A_txt(s_3_13, s_3_12, s_3_18, s_3_3)
        let s_3_19: () = execute_aarch32_instrs_PLD_i_Op_A_txt(
            state,
            tracer,
            s_3_13,
            s_3_12,
