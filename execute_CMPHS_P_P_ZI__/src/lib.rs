...
use Z_read::*;
use common::*;
pub fn execute_CMPHS_P_P_ZI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#2616 <= s_0_2
        fn_state.esizeshadow_2616 = s_0_2;
        ...
        // D s_0_7: write-var VLshadow#2617 <= s_0_6
        fn_state.VLshadow_2617 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#2617:i64
        let s_1_0: i64 = fn_state.VLshadow_2617;
        // D s_1_1: write-var VLshadow#2618 <= s_1_0
        fn_state.VLshadow_2618 = s_1_0;
        // C s_1_2: const #8s : i
        let s_1_2: i128 = 8;
        // D s_1_3: read-var VLshadow#2618:i64
        let s_1_3: i64 = fn_state.VLshadow_2618;
        ...
        fn_state.PL = s_1_6;
        // D s_1_8: read-var VLshadow#2618:i64
        let s_1_8: i64 = fn_state.VLshadow_2618;
        // D s_1_9: cast zx s_1_8 -> i
        let s_1_9: i128 = (i128::try_from(s_1_8).unwrap());
        // D s_1_10: read-var esizeshadow#2616:i64
        let s_1_10: i64 = fn_state.esizeshadow_2616;
        ...
        // D s_1_23: read-var esizeshadow#2616:i64
        let s_1_23: i64 = fn_state.esizeshadow_2616;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var VLshadow#2618:i64
        let s_2_0: i64 = fn_state.VLshadow_2618;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_0: const #8s : i
        let s_3_0: i128 = 8;
        // D s_3_1: read-var esizeshadow#2616:i64
        let s_3_1: i64 = fn_state.esizeshadow_2616;
        ...
        // D s_3_12: write-var gs#188067 <= s_3_11
        fn_state.gs_188067 = s_3_11;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#188067:i64
        let s_4_1: i64 = fn_state.gs_188067;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var esizeshadow#2616:i64
        let s_5_0: i64 = fn_state.esizeshadow_2616;
        ...
        // D s_5_13: read-var esizeshadow#2616:i64
        let s_5_13: i64 = fn_state.esizeshadow_2616;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var imm:i64
        let s_9_0: i64 = fn_state.imm;
        // D s_9_1: cast zx s_9_0 -> i
        let s_9_1: i128 = (i128::try_from(s_9_0).unwrap());
        // D s_9_2: read-var element1:i
        let s_9_2: i128 = fn_state.element1;
        // D s_9_3: cmp-eq s_9_2 s_9_1
        let s_9_3: bool = ((s_9_2) == (s_9_1));
        // D s_9_4: write-var cond <= s_9_3
        fn_state.cond = s_9_3;
        // N s_9_5: jump b10
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var imm:i64
        let s_15_0: i64 = fn_state.imm;
        // D s_15_1: cast zx s_15_0 -> i
        let s_15_1: i128 = (i128::try_from(s_15_0).unwrap());
        // D s_15_2: read-var element1:i
        let s_15_2: i128 = fn_state.element1;
        // D s_15_3: call neq_int(s_15_2, s_15_1)
        let s_15_3: bool = neq_int(state, tracer, s_15_2, s_15_1);
        // D s_15_4: write-var cond <= s_15_3
        fn_state.cond = s_15_3;
        // N s_15_5: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var imm:i64
        let s_17_0: i64 = fn_state.imm;
        // D s_17_1: cast zx s_17_0 -> i
        let s_17_1: i128 = (i128::try_from(s_17_0).unwrap());
        // D s_17_2: read-var element1:i
        let s_17_2: i128 = fn_state.element1;
        // D s_17_3: cmp-ge s_17_2 s_17_1
        let s_17_3: bool = ((s_17_2) >= (s_17_1));
        // D s_17_4: write-var cond <= s_17_3
        fn_state.cond = s_17_3;
        // N s_17_5: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var imm:i64
        let s_19_0: i64 = fn_state.imm;
        // D s_19_1: cast zx s_19_0 -> i
        let s_19_1: i128 = (i128::try_from(s_19_0).unwrap());
        // D s_19_2: read-var element1:i
        let s_19_2: i128 = fn_state.element1;
        // D s_19_3: cmp-lt s_19_2 s_19_1
        let s_19_3: bool = ((s_19_2) < (s_19_1));
        // D s_19_4: write-var cond <= s_19_3
        fn_state.cond = s_19_3;
        // N s_19_5: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_0: read-var imm:i64
        let s_21_0: i64 = fn_state.imm;
        // D s_21_1: cast zx s_21_0 -> i
        let s_21_1: i128 = (i128::try_from(s_21_0).unwrap());
        // D s_21_2: read-var element1:i
        let s_21_2: i128 = fn_state.element1;
        // D s_21_3: cmp-gt s_21_2 s_21_1
        let s_21_3: bool = ((s_21_2) > (s_21_1));
        // D s_21_4: write-var cond <= s_21_3
        fn_state.cond = s_21_3;
        // N s_21_5: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_0: read-var imm:i64
        let s_23_0: i64 = fn_state.imm;
        // D s_23_1: cast zx s_23_0 -> i
        let s_23_1: i128 = (i128::try_from(s_23_0).unwrap());
        // D s_23_2: read-var element1:i
        let s_23_2: i128 = fn_state.element1;
        // D s_23_3: cmp-le s_23_2 s_23_1
        let s_23_3: bool = ((s_23_2) <= (s_23_1));
        // D s_23_4: write-var cond <= s_23_3
        fn_state.cond = s_23_3;
        // N s_23_5: jump b10
        return block_10(state, tracer, fn_state);
    }
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_0: read-var esizeshadow#2616:i64
        let s_25_0: i64 = fn_state.esizeshadow_2616;
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var VLshadow#2618:i64
        let s_26_0: i64 = fn_state.VLshadow_2618;
