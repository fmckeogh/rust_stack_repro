...
use common::*;
pub fn decode_uadalp_advsimd_aarch64_instrs_vector_arithmetic_unary_add_pairwise<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 64;
        // D s_2_1: write-var ga#264839 <= s_2_0
        fn_state.ga_264839 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#264839:i64
        let s_3_0: i64 = fn_state.ga_264839;
        // C s_3_1: const #2s : i
        let s_3_1: i128 = 2;
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 128;
        // D s_4_1: write-var ga#264839 <= s_4_0
        fn_state.ga_264839 = s_4_0;
        // N s_4_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_5<T: Tracer>(
