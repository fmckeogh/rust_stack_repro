...
use AddWithCarry::*;
use common::*;
pub fn execute_aarch32_instrs_SUB_i_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    imm32: u32,
    ...
    struct FunctionState {
        gs_886686: ProductTyped54bc449dd09e5bd,
        result: u32,
        nzcv: u8,
        d: i64,
        imm32: u32,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_11: write-var gs#886686 <= s_0_10
        fn_state.gs_886686 = s_0_10;
        // D s_0_12: read-var gs#886686.0:struct
        let s_0_12: Bits = fn_state.gs_886686._0;
        // D s_0_13: cast reint s_0_12 -> u32
        let s_0_13: u32 = (s_0_12.value() as u32);
        // D s_0_14: read-var gs#886686.1:struct
        let s_0_14: u8 = fn_state.gs_886686._1;
