...
use common::*;
pub fn decode_fcmlt_advsimd_aarch64_instrs_vector_arithmetic_unary_cmp_fp16_lessthan_simd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, Q: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#253584 <= s_1_0
        fn_state.ga_253584 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#253584:i64
        let s_2_0: i64 = fn_state.ga_253584;
        // C s_2_1: const #16s : i
        let s_2_1: i128 = 16;
        ...
        // C s_2_9: const #4u : u32
        let s_2_9: u32 = 4;
        // D s_2_10: read-var d:i64
        let s_2_10: i64 = fn_state.d;
        // D s_2_11: read-var n:i64
        let s_2_11: i64 = fn_state.n;
        // D s_2_12: call execute_aarch64_instrs_vector_arithmetic_unary_cmp_fp16_lessthan_sisd(s_2_9, s_2_10, s_2_6, s_2_8, s_2_7, s_2_11)
        let s_2_12: () = execute_aarch64_instrs_vector_arithmetic_unary_cmp_fp16_lessthan_sisd(
            state,
            tracer,
            s_2_9,
            s_2_10,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 128;
        // D s_3_1: write-var ga#253584 <= s_3_0
        fn_state.ga_253584 = s_3_0;
        // N s_3_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
