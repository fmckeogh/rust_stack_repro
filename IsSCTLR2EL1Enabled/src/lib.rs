...
use HaveFeatSCTLR2::*;
use common::*;
pub fn IsSCTLR2EL1Enabled<T: Tracer>(
    state: &mut State,
    tracer: &T,
    gs_9753: (),
) -> bool {
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: write-var gs#9755 <= s_2_0
        fn_state.gs_9755 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#9755:u8
        let s_3_0: bool = fn_state.gs_9755;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#9757 <= s_5_0
        fn_state.gs_9757 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#9757:u8
        let s_6_0: bool = fn_state.gs_9757;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_2: call _get_HCRX_EL2_Type_SCTLR2En(s_11_1)
        let s_11_2: bool = u_get_HCRX_EL2_Type_SCTLR2En(state, tracer, s_11_1);
        ...
        // D s_11_7: write-var gs#9756 <= s_11_6
        fn_state.gs_9756 = s_11_6;
        // N s_11_8: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#9756:u8
        let s_12_0: bool = fn_state.gs_9756;
        // D s_12_1: write-var gs#9757 <= s_12_0
        fn_state.gs_9757 = s_12_0;
        // N s_12_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#9756 <= s_13_0
        fn_state.gs_9756 = s_13_0;
        // N s_13_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_2: call _get_SCR_EL3_Type_SCTLR2En(s_15_1)
        let s_15_2: bool = u_get_SCR_EL3_Type_SCTLR2En(state, tracer, s_15_1);
        ...
        // D s_15_7: write-var gs#9755 <= s_15_6
        fn_state.gs_9755 = s_15_6;
        // N s_15_8: jump b3
        return block_3(state, tracer, fn_state);
    }
