...
use ShiftReg::*;
use common::*;
pub fn execute_aarch64_instrs_integer_arithmetic_add_sub_shiftedreg<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    datasize: i64,
    ...
    struct FunctionState {
        ...
        nzcv: u8,
        operand1: Bits,
        datasizeshadow_1023: i64,
        ga_249077: ProductTyped54bc449dd09e5bd,
        operand2: Bits,
        d: i64,
        datasize: i64,
        m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var datasizeshadow#1023 <= s_0_2
        fn_state.datasizeshadow_1023 = s_0_2;
        // D s_0_4: read-var datasizeshadow#1023:i64
        let s_0_4: i64 = fn_state.datasizeshadow_1023;
        ...
        // D s_0_11: read-var datasizeshadow#1023:i64
        let s_0_11: i64 = fn_state.datasizeshadow_1023;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var carry_in <= s_1_0
        fn_state.carry_in = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var operand1:bv
        let s_2_0: Bits = fn_state.operand1;
        // D s_2_1: read-var operand2:bv
        let s_2_1: Bits = fn_state.operand2;
        // D s_2_2: read-var carry_in:u8
        let s_2_2: bool = fn_state.carry_in;
        // D s_2_3: call AddWithCarry(s_2_0, s_2_1, s_2_2)
        let s_2_3: ProductTyped54bc449dd09e5bd = AddWithCarry(
            state,
            tracer,
            s_2_0,
            s_2_1,
        ...
        // D s_2_4: write-var ga#249077 <= s_2_3
        fn_state.ga_249077 = s_2_3;
        // D s_2_5: read-var ga#249077.0:struct
        let s_2_5: Bits = fn_state.ga_249077._0;
        // D s_2_6: read-var ga#249077.1:struct
        let s_2_6: u8 = fn_state.ga_249077._1;
        // D s_2_7: write-var result <= s_2_5
        fn_state.result = s_2_5;
        // D s_2_8: write-var nzcv <= s_2_6
        fn_state.nzcv = s_2_6;
        // D s_2_9: read-var setflags:u8
        let s_2_9: bool = fn_state.setflags;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var datasizeshadow#1023:i64
        let s_4_0: i64 = fn_state.datasizeshadow_1023;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_3: const #1u : u8
        let s_6_3: bool = true;
        // D s_6_4: write-var carry_in <= s_6_3
        fn_state.carry_in = s_6_3;
        // N s_6_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
