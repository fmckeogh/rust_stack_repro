...
use CurrentVL_read::*;
use HaveSME2::*;
use execute_LDNT1B_MZ_P_BI_4::*;
use common::*;
pub fn decode_LDNT1B_MZ_P_BI_4<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm4: u8,
    msz: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#253001 <= s_1_0
        fn_state.gs_253001 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#253001:u8
        let s_2_0: bool = fn_state.gs_253001;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_7: read-var PNg:u8
        let s_3_7: u8 = fn_state.PNg;
        // D s_3_8: cast zx s_3_7 -> bv
        let s_3_8: Bits = Bits::new(s_3_7 as u128, 3u16);
        // C s_3_9: cast reint s_3_6 -> u128
        let s_3_9: u128 = (s_3_6.value() as u128);
        // D s_3_10: size-of s_3_6
        let s_3_10: u16 = s_3_6.length();
        // D s_3_11: cast reint s_3_8 -> u128
        let s_3_11: u128 = (s_3_8.value() as u128);
        // D s_3_12: size-of s_3_8
        let s_3_12: u16 = s_3_8.length();
        // D s_3_13: lsl s_3_9 s_3_12
        let s_3_13: u128 = s_3_9 << s_3_12;
        // D s_3_14: or s_3_13 s_3_11
        let s_3_14: u128 = ((s_3_13) | (s_3_11));
        // D s_3_15: add s_3_10 s_3_12
        let s_3_15: u16 = (s_3_10 + s_3_12);
        // D s_3_16: create-bits s_3_14 s_3_15
        let s_3_16: Bits = Bits::new(s_3_14, s_3_15);
        // D s_3_17: cast reint s_3_16 -> u8
        let s_3_17: u8 = (s_3_16.value() as u8);
        ...
        // D s_3_21: write-var g <= s_3_20
        fn_state.g = s_3_20;
        // D s_3_22: read-var Zt:u8
        let s_3_22: u8 = fn_state.Zt;
        // D s_3_23: cast zx s_3_22 -> bv
        let s_3_23: Bits = Bits::new(s_3_22 as u128, 3u16);
        // C s_3_24: const #0u : u8
        let s_3_24: u8 = 0;
        // C s_3_25: cast zx s_3_24 -> bv
        let s_3_25: Bits = Bits::new(s_3_24 as u128, 2u16);
        ...
        // D s_3_38: write-var t <= s_3_37
        fn_state.t = s_3_37;
        // D s_3_39: read-var imm4:u8
        let s_3_39: u8 = fn_state.imm4;
        // D s_3_40: cast zx s_3_39 -> bv
        let s_3_40: Bits = Bits::new(s_3_39 as u128, 4u16);
        // D s_3_41: cast sx s_3_40 -> i
        let s_3_41: i128 = {
            let sign_bit = s_3_40.length() - 1;
            let mut result = s_3_40.value() as i128;
        ...
        // D s_3_43: write-var offset <= s_3_42
        fn_state.offset = s_3_42;
    ...
    fn block_4<T: Tracer>(
        ...
        // C s_4_3: const #8s : i64
        let s_4_3: i64 = 8;
        // D s_4_4: read-var g:i64
        let s_4_4: i64 = fn_state.g;
        // D s_4_5: read-var n:i64
        let s_4_5: i64 = fn_state.n;
        // C s_4_6: const #4s : i64
        let s_4_6: i64 = 4;
        // D s_4_7: read-var t:i64
        let s_4_7: i64 = fn_state.t;
        // D s_4_8: call execute_LDNT1B_MZ_P_BI_4(s_4_0, s_4_3, s_4_4, s_4_5, s_4_6, s_4_2, s_4_7)
        let s_4_8: () = execute_LDNT1B_MZ_P_BI_4(
            state,
            tracer,
            s_4_0,
            s_4_3,
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_3: const #8s : i64
        let s_6_3: i64 = 8;
        // D s_6_4: read-var g:i64
        let s_6_4: i64 = fn_state.g;
        // D s_6_5: read-var n:i64
        let s_6_5: i64 = fn_state.n;
        // C s_6_6: const #4s : i64
        let s_6_6: i64 = 4;
        // D s_6_7: read-var t:i64
        let s_6_7: i64 = fn_state.t;
        // D s_6_8: call execute_LDNT1B_MZ_P_BI_4(s_6_0, s_6_3, s_6_4, s_6_5, s_6_6, s_6_2, s_6_7)
        let s_6_8: () = execute_LDNT1B_MZ_P_BI_4(
            state,
            tracer,
            s_6_0,
            s_6_3,
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_3: const #8s : i64
        let s_8_3: i64 = 8;
        // D s_8_4: read-var g:i64
        let s_8_4: i64 = fn_state.g;
        // D s_8_5: read-var n:i64
        let s_8_5: i64 = fn_state.n;
        // C s_8_6: const #4s : i64
        let s_8_6: i64 = 4;
        // D s_8_7: read-var t:i64
        let s_8_7: i64 = fn_state.t;
        // D s_8_8: call execute_LDNT1B_MZ_P_BI_4(s_8_0, s_8_3, s_8_4, s_8_5, s_8_6, s_8_2, s_8_7)
        let s_8_8: () = execute_LDNT1B_MZ_P_BI_4(
            state,
            tracer,
            s_8_0,
            s_8_3,
    ...
    fn block_10<T: Tracer>(
        ...
        // C s_10_3: const #8s : i64
        let s_10_3: i64 = 8;
        // D s_10_4: read-var g:i64
        let s_10_4: i64 = fn_state.g;
        // D s_10_5: read-var n:i64
        let s_10_5: i64 = fn_state.n;
        // C s_10_6: const #4s : i64
        let s_10_6: i64 = 4;
        // D s_10_7: read-var t:i64
        let s_10_7: i64 = fn_state.t;
        // D s_10_8: call execute_LDNT1B_MZ_P_BI_4(s_10_0, s_10_3, s_10_4, s_10_5, s_10_6, s_10_2, s_10_7)
        let s_10_8: () = execute_LDNT1B_MZ_P_BI_4(
            state,
            tracer,
            s_10_0,
            s_10_3,
    ...
    fn block_12<T: Tracer>(
        ...
        // C s_12_3: const #8s : i64
        let s_12_3: i64 = 8;
        // D s_12_4: read-var g:i64
        let s_12_4: i64 = fn_state.g;
        // D s_12_5: read-var n:i64
        let s_12_5: i64 = fn_state.n;
        // C s_12_6: const #4s : i64
        let s_12_6: i64 = 4;
        // D s_12_7: read-var t:i64
        let s_12_7: i64 = fn_state.t;
        // D s_12_8: call execute_LDNT1B_MZ_P_BI_4(s_12_0, s_12_3, s_12_4, s_12_5, s_12_6, s_12_2, s_12_7)
        let s_12_8: () = execute_LDNT1B_MZ_P_BI_4(
            state,
            tracer,
            s_12_0,
            s_12_3,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#253001 <= s_15_2
        fn_state.gs_253001 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
