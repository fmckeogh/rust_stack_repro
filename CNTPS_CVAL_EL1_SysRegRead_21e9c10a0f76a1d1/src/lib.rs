...
use common::*;
pub fn CNTPS_CVAL_EL1_SysRegRead_21e9c10a0f76a1d1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#58017 <= s_8_0
        fn_state.gs_58017 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#58017:u8
        let s_9_0: bool = fn_state.gs_58017;
    ...
    fn block_13<T: Tracer>(
        ...
        let s_13_0: i64 = 64;
        // C s_13_1: const #14160u : u32
        let s_13_1: u32 = 14160;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_5: write-var gs#58017 <= s_16_4
        fn_state.gs_58017 = s_16_4;
        // N s_16_6: jump b9
        return block_9(state, tracer, fn_state);
    }
