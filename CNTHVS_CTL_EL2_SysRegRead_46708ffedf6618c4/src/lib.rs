...
use EL2Enabled::*;
use common::*;
pub fn CNTHVS_CTL_EL2_SysRegRead_46708ffedf6618c4<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_55924: ProductType5c790c8ef59cc8b2,
        ga_55918: ProductType5c790c8ef59cc8b2,
        u__PSTATE_EL: u8,
        gs_57865: bool,
        u__HCR_EL2_NV: bool,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_CNTHVS_CTL_EL2(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_CNTHVS_CTL_EL2(
            state,
            tracer,
            s_6_2,
        );
        // D s_6_4: write-var ga#55924 <= s_6_3
        fn_state.ga_55924 = s_6_3;
        // D s_6_5: read-var ga#55924.0:struct
        let s_6_5: u64 = fn_state.ga_55924._0;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_3: call __get_CNTHVS_CTL_EL2(s_9_2)
        let s_9_3: ProductType5c790c8ef59cc8b2 = u__get_CNTHVS_CTL_EL2(
            state,
            tracer,
            s_9_2,
        );
        // D s_9_4: write-var ga#55918 <= s_9_3
        fn_state.ga_55918 = s_9_3;
        // D s_9_5: read-var ga#55918.0:struct
        let s_9_5: u64 = fn_state.ga_55918._0;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#57865 <= s_13_0
        fn_state.gs_57865 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#57865:u8
        let s_14_0: bool = fn_state.gs_57865;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_5: write-var gs#57865 <= s_17_4
        fn_state.gs_57865 = s_17_4;
        // N s_17_6: jump b14
        return block_14(state, tracer, fn_state);
    }
