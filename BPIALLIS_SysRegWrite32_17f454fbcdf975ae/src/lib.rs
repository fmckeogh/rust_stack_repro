...
use common::*;
pub fn BPIALLIS_SysRegWrite32_17f454fbcdf975ae<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_0: const #() : ()
        let s_5_0: () = ();
        // S s_5_1: call BPIALLIS(s_5_0)
        let s_5_1: () = BPIALLIS(state, tracer, s_5_0);
        // N s_5_2: return
        return;
    }
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #() : ()
        let s_6_0: () = ();
        // S s_6_1: call BPIALLIS(s_6_0)
        let s_6_1: () = BPIALLIS(state, tracer, s_6_0);
        // N s_6_2: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#124207 <= s_8_0
        fn_state.gs_124207 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#124207:u8
        let s_9_0: bool = fn_state.gs_124207;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#124208 <= s_10_0
        fn_state.gs_124208 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#124208:u8
        let s_11_0: bool = fn_state.gs_124208;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#124209 <= s_13_0
        fn_state.gs_124209 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#124209:u8
        let s_14_0: bool = fn_state.gs_124209;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#124210 <= s_15_0
        fn_state.gs_124210 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#124210:u8
        let s_16_0: bool = fn_state.gs_124210;
    ...
    fn block_17<T: Tracer>(
        ...
        // C s_17_0: const #() : ()
        let s_17_0: () = ();
        // S s_17_1: call BPIALLIS(s_17_0)
        let s_17_1: () = BPIALLIS(state, tracer, s_17_0);
        // N s_17_2: return
        return;
    }
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_5: write-var gs#124210 <= s_19_4
        fn_state.gs_124210 = s_19_4;
        // N s_19_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_3: write-var gs#124209 <= s_20_2
        fn_state.gs_124209 = s_20_2;
        // N s_20_4: jump b14
        return block_14(state, tracer, fn_state);
    }
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_5: write-var gs#124208 <= s_22_4
        fn_state.gs_124208 = s_22_4;
        // N s_22_6: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_23<T: Tracer>(
        ...
        // D s_23_4: write-var gs#124207 <= s_23_3
        fn_state.gs_124207 = s_23_3;
        // N s_23_5: jump b9
        return block_9(state, tracer, fn_state);
    }
