...
pub fn u__get_TRFCR<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4294967196u : u32
        let s_0_3: u32 = 4294967196;
        ...
        // D s_0_11: tail-call Mk_TRFCR_Type(s_0_10)
        return Mk_TRFCR_Type(state, tracer, s_0_10);
    }
}
