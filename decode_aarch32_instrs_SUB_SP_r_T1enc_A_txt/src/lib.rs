...
use ConditionPassed::*;
use DecodeImmShift::*;
use execute_aarch32_instrs_SUB_SP_r_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_SUB_SP_r_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    S: bool,
    imm3: u8,
    ...
    struct FunctionState {
        gs_303401: bool,
        m: i64,
        shift_nshadow_7310: i128,
        gs_303399: bool,
        setflags: bool,
        ga_348499: ProductType396b95aa74979079,
        shift_t: u32,
        gs_303389: bool,
        d: i64,
        S: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#303389 <= s_3_0
        fn_state.gs_303389 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#303389:u8
        let s_4_0: bool = fn_state.gs_303389;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_31: write-var ga#348499 <= s_5_30
        fn_state.ga_348499 = s_5_30;
        // D s_5_32: read-var ga#348499.0:struct
        let s_5_32: u32 = fn_state.ga_348499._0;
        // D s_5_33: read-var ga#348499.1:struct
        let s_5_33: i128 = fn_state.ga_348499._1;
        // D s_5_34: write-var shift_t <= s_5_32
        fn_state.shift_t = s_5_32;
        // D s_5_35: write-var shift_nshadow#7310 <= s_5_33
        fn_state.shift_nshadow_7310 = s_5_33;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#303399 <= s_6_0
        fn_state.gs_303399 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#303399:u8
        let s_7_0: bool = fn_state.gs_303399;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: write-var gs#303401 <= s_8_3
        fn_state.gs_303401 = s_8_3;
        // N s_8_5: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#303401:u8
        let s_9_0: bool = fn_state.gs_303401;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_3: read-var shift_nshadow#7310:i
        let s_10_3: i128 = fn_state.shift_nshadow_7310;
        // D s_10_4: read-var shift_t:u32
        let s_10_4: u32 = fn_state.shift_t;
        // D s_10_5: call execute_aarch32_instrs_SUB_SP_r_Op_A_txt(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4)
        let s_10_5: () = execute_aarch32_instrs_SUB_SP_r_Op_A_txt(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#303401 <= s_12_0
        fn_state.gs_303401 = s_12_0;
        // N s_12_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    fn block_13<T: Tracer>(
        ...
        // D s_13_2: write-var gs#303399 <= s_13_1
        fn_state.gs_303399 = s_13_1;
        // N s_13_3: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_5: write-var gs#303389 <= s_15_4
        fn_state.gs_303389 = s_15_4;
        // N s_15_6: jump b4
        return block_4(state, tracer, fn_state);
    }
}
