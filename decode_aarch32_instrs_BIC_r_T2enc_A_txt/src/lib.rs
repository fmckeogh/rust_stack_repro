...
use ConditionPassed::*;
use DecodeImmShift::*;
use execute_aarch32_instrs_BIC_r_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_BIC_r_T2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    S: bool,
    Rn: u8,
    ...
    struct FunctionState {
        m: i64,
        setflags: bool,
        shift_nshadow_7129: i128,
        shift_t: u32,
        gs_296105: bool,
        n: i64,
        ga_343292: ProductType396b95aa74979079,
        d: i64,
        gs_296107: bool,
        S: bool,
        Rn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_36: write-var ga#343292 <= s_2_35
        fn_state.ga_343292 = s_2_35;
        // D s_2_37: read-var ga#343292.0:struct
        let s_2_37: u32 = fn_state.ga_343292._0;
        // D s_2_38: read-var ga#343292.1:struct
        let s_2_38: i128 = fn_state.ga_343292._1;
        // D s_2_39: write-var shift_t <= s_2_37
        fn_state.shift_t = s_2_37;
        // D s_2_40: write-var shift_nshadow#7129 <= s_2_38
        fn_state.shift_nshadow_7129 = s_2_38;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#296105 <= s_3_3
        fn_state.gs_296105 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#296105:u8
        let s_4_0: bool = fn_state.gs_296105;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#296107 <= s_5_3
        fn_state.gs_296107 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#296107:u8
        let s_6_0: bool = fn_state.gs_296107;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: read-var shift_nshadow#7129:i
        let s_7_1: i128 = fn_state.shift_nshadow_7129;
        ...
        // D s_7_6: call execute_aarch32_instrs_BIC_r_Op_A_txt(s_7_2, s_7_3, s_7_4, s_7_5, s_7_1, s_7_0)
        let s_7_6: () = execute_aarch32_instrs_BIC_r_Op_A_txt(
            state,
            tracer,
            s_7_2,
            s_7_3,
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#296107 <= s_9_0
        fn_state.gs_296107 = s_9_0;
        // N s_9_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#296105 <= s_10_0
        fn_state.gs_296105 = s_10_0;
        // N s_10_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
