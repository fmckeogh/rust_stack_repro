...
use common::*;
pub fn execute_aarch32_instrs_LDAEXH_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    n: i64,
    t: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_9: write-var gs#913541 <= s_1_8
        fn_state.gs_913541 = s_1_8;
        // N s_1_10: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#913541:bv
        let s_2_0: Bits = fn_state.gs_913541;
