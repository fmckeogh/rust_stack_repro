...
extern crate alloc;
use execute_aarch64_instrs_integer_tags_mcinsertrandomtag::*;
use HaveMTEExt::*;
use common::*;
pub fn decode_irg_aarch64_instrs_integer_tags_mcinsertrandomtag<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Xd: u8,
    Xn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_12: call execute_aarch64_instrs_integer_tags_mcinsertrandomtag(s_1_3, s_1_11, s_1_7)
        let s_1_12: () = execute_aarch64_instrs_integer_tags_mcinsertrandomtag(
            state,
            tracer,
            s_1_3,
            s_1_11,
