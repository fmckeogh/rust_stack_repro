...
use common::*;
pub fn decode_aarch32_instrs_VMOV_ss_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    op: bool,
    Rt2: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        fn_state.t2 = s_2_14;
        // D s_2_16: read-var Vm:u8
        let s_2_16: u8 = fn_state.Vm;
        // D s_2_17: cast zx s_2_16 -> bv
        let s_2_17: Bits = Bits::new(s_2_16 as u128, 4u16);
        // D s_2_18: read-var M:u8
        let s_2_18: bool = fn_state.M;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#313511 <= s_3_3
        fn_state.gs_313511 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#313511:u8
        let s_4_0: bool = fn_state.gs_313511;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#313513 <= s_5_3
        fn_state.gs_313513 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#313513:u8
        let s_6_0: bool = fn_state.gs_313513;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#313514 <= s_8_0
        fn_state.gs_313514 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#313514:u8
        let s_9_0: bool = fn_state.gs_313514;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#313514 <= s_12_4
        fn_state.gs_313514 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#313513 <= s_14_0
        fn_state.gs_313513 = s_14_0;
        // N s_14_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#313511 <= s_15_0
        fn_state.gs_313511 = s_15_0;
        // N s_15_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
