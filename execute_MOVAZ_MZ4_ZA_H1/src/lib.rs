...
use Z_set::*;
use common::*;
pub fn execute_MOVAZ_MZ4_ZA_H1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#6912 <= s_0_2
        fn_state.VLshadow_6912 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#6912:i64
        let s_1_0: i64 = fn_state.VLshadow_6912;
        // D s_1_1: write-var VLshadow#6913 <= s_1_0
        fn_state.VLshadow_6913 = s_1_0;
        // D s_1_2: read-var VLshadow#6913:i64
        let s_1_2: i64 = fn_state.VLshadow_6913;
        ...
        // D s_1_43: write-var gs#291343 <= s_1_42
        fn_state.gs_291343 = s_1_42;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#291343:i64
        let s_2_1: i64 = fn_state.gs_291343;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_7: read-var VLshadow#6913:i64
        let s_3_7: i64 = fn_state.VLshadow_6913;
        ...
        // D s_3_21: read-var slice_name:i
        let s_3_21: i128 = fn_state.slice_name;
        // D s_3_22: add s_3_21 s_3_20
        let s_3_22: i128 = (s_3_21 + s_3_20);
        // D s_3_23: read-var VLshadow#6913:i64
        let s_3_23: i64 = fn_state.VLshadow_6913;
        ...
        // D s_3_26: read-var VLshadow#6913:i64
        let s_3_26: i64 = fn_state.VLshadow_6913;
        // D s_3_27: cast zx s_3_26 -> i
        let s_3_27: i128 = (i128::try_from(s_3_26).unwrap());
        // D s_3_28: call Zeros(s_3_27)
        let s_3_28: Bits = Zeros(state, tracer, s_3_27);
        // D s_3_29: read-var n:i64
        let s_3_29: i64 = fn_state.n;
        // D s_3_30: cast zx s_3_29 -> i
        let s_3_30: i128 = (i128::try_from(s_3_29).unwrap());
        // D s_3_31: cast zx s_3_18 -> i
        let s_3_31: i128 = (i128::try_from(s_3_18).unwrap());
        // D s_3_32: cast zx s_3_25 -> i
        let s_3_32: i128 = (i128::try_from(s_3_25).unwrap());
        // D s_3_33: read-var vertical:u8
        let s_3_33: bool = fn_state.vertical;
        // D s_3_34: call ZAslice_set(s_3_30, s_3_31, s_3_33, s_3_22, s_3_32, s_3_28)
        let s_3_34: () = ZAslice_set(
            state,
            tracer,
            s_3_30,
            s_3_31,
        ...
        // D s_3_35: read-var d:i64
        let s_3_35: i64 = fn_state.d;
        // D s_3_36: cast zx s_3_35 -> i
        let s_3_36: i128 = (i128::try_from(s_3_35).unwrap());
        // D s_3_37: read-var r:i64
        let s_3_37: i64 = fn_state.r;
        ...
        // D s_3_41: read-var VLshadow#6913:i64
        let s_3_41: i64 = fn_state.VLshadow_6913;
        ...
        // D s_3_46: call Z_set(s_3_44, s_3_45, s_3_15)
        let s_3_46: () = Z_set(state, tracer, s_3_44, s_3_45, s_3_15);
        // D s_3_47: read-var r:i64
        let s_3_47: i64 = fn_state.r;
        // C s_3_48: const #1s : i64
        let s_3_48: i64 = 1;
        // D s_3_49: add s_3_47 s_3_48
        let s_3_49: i64 = (s_3_47 + s_3_48);
        // D s_3_50: write-var r <= s_3_49
        fn_state.r = s_3_49;
        // N s_3_51: jump b2
        return block_2(state, tracer, fn_state);
    }
