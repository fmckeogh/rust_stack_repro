...
extern crate alloc;
use common::*;
pub fn ICC_BPR1_S_write<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_1: const #102528u : u32
        let s_0_1: u32 = 102528;
        ...
        // C s_0_3: const #102528u : u32
        let s_0_3: u32 = 102528;
        ...
        // C s_0_5: const #104816u : u32
        let s_0_5: u32 = 104816;
