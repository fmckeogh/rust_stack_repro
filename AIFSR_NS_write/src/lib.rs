...
extern crate alloc;
use common::*;
pub fn AIFSR_NS_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #22688u : u32
        let s_0_23: u32 = 22688;
        ...
        // C s_0_25: const #11048u : u32
        let s_0_25: u32 = 11048;
