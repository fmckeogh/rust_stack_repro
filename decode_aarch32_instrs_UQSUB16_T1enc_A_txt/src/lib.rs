...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_UQSUB16_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_UQSUB16_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    Rd: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#304823 <= s_3_3
        fn_state.gs_304823 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#304823:u8
        let s_4_0: bool = fn_state.gs_304823;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#304825 <= s_5_3
        fn_state.gs_304825 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#304825:u8
        let s_6_0: bool = fn_state.gs_304825;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_3: call execute_aarch32_instrs_UQSUB16_Op_A_txt(s_7_0, s_7_1, s_7_2)
        let s_7_3: () = execute_aarch32_instrs_UQSUB16_Op_A_txt(
            state,
            tracer,
            s_7_0,
            s_7_1,
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#304825 <= s_9_0
        fn_state.gs_304825 = s_9_0;
        // N s_9_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#304823 <= s_10_0
        fn_state.gs_304823 = s_10_0;
        // N s_10_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
