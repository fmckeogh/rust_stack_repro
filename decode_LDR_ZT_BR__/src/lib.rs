...
extern crate alloc;
use HaveSME2::*;
use execute_LDR_ZT_BR__::*;
use common::*;
pub fn decode_LDR_ZT_BR__<T: Tracer>(state: &mut State, tracer: &T, Rn: u8) -> () {
    #[derive(Default)]
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_4: call execute_LDR_ZT_BR__(s_1_3)
        let s_1_4: () = execute_LDR_ZT_BR__(state, tracer, s_1_3);
        // N s_1_5: return
        return;
    }
    fn block_2<T: Tracer>(
