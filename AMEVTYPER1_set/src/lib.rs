...
extern crate alloc;
use common::*;
pub fn AMEVTYPER1_set<T: Tracer>(
    state: &mut State,
    tracer: &T,
    n: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_13: const #19152u : u32
        let s_0_13: u32 = 19152;
        ...
        // C s_0_15: const #13296u : u32
        let s_0_15: u32 = 13296;
        ...
        // C s_0_22: const #13296u : u32
        let s_0_22: u32 = 13296;
