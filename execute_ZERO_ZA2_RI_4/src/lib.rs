...
use ZAvector_set::*;
use common::*;
pub fn execute_ZERO_ZA2_RI_4<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    ngrp: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#6868 <= s_0_2
        fn_state.VLshadow_6868 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#6868:i64
        let s_1_0: i64 = fn_state.VLshadow_6868;
        // D s_1_1: write-var VLshadow#6869 <= s_1_0
        fn_state.VLshadow_6869 = s_1_0;
        // C s_1_2: const #8s : i
        let s_1_2: i128 = 8;
        // D s_1_3: read-var VLshadow#6869:i64
        let s_1_3: i64 = fn_state.VLshadow_6869;
        ...
        // D s_1_44: write-var gs#290310 <= s_1_43
        fn_state.gs_290310 = s_1_43;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#290310:i64
        let s_2_1: i64 = fn_state.gs_290310;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var vecshadow#6870 <= s_3_0
        fn_state.vecshadow_6870 = s_3_0;
        ...
        // D s_3_8: write-var gs#290317 <= s_3_7
        fn_state.gs_290317 = s_3_7;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#290317:i64
        let s_4_1: i64 = fn_state.gs_290317;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_2: read-var vecshadow#6870:i
        let s_5_2: i128 = fn_state.vecshadow_6870;
        // D s_5_3: add s_5_2 s_5_1
        let s_5_3: i128 = (s_5_2 + s_5_1);
        // D s_5_4: read-var VLshadow#6869:i64
        let s_5_4: i64 = fn_state.VLshadow_6869;
        // D s_5_5: cast zx s_5_4 -> i
        let s_5_5: i128 = (i128::try_from(s_5_4).unwrap());
        // D s_5_6: cast reint s_5_5 -> i64
        let s_5_6: i64 = (s_5_5 as i64);
        // D s_5_7: read-var VLshadow#6869:i64
        let s_5_7: i64 = fn_state.VLshadow_6869;
