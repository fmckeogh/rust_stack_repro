...
use common::*;
pub fn decode_aarch32_instrs_ADC_i_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    S: bool,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_21: call execute_aarch32_instrs_ADC_i_Op_A_txt(s_2_9, s_2_20, s_2_13, s_2_18)
        let s_2_21: () = execute_aarch32_instrs_ADC_i_Op_A_txt(
            state,
            tracer,
            s_2_9,
            s_2_20,
