...
extern crate alloc;
use HaveSVE::*;
use execute_MUL_Z_ZI__::*;
use CurrentVL_read::*;
use HaveSME::*;
use common::*;
pub fn decode_MUL_Z_ZI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    imm8: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#185488 <= s_1_0
        fn_state.gs_185488 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#185488:u8
        let s_2_0: bool = fn_state.gs_185488;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_7: read-var Zdn:u8
        let s_3_7: u8 = fn_state.Zdn;
        ...
        // D s_3_11: write-var dn <= s_3_10
        fn_state.dn = s_3_10;
        // D s_3_12: read-var imm8:u8
        let s_3_12: u8 = fn_state.imm8;
        // D s_3_13: cast zx s_3_12 -> bv
        let s_3_13: Bits = Bits::new(s_3_12 as u128, 8u16);
        ...
        // D s_3_16: write-var imm <= s_3_15
        fn_state.imm = s_3_15;
        // D s_3_17: read-var VL:i64
        let s_3_17: i64 = fn_state.VL;
        // C s_3_18: const #128s : i
        let s_3_18: i128 = 128;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_6: read-var dn:i64
        let s_4_6: i64 = fn_state.dn;
        // D s_4_7: call execute_MUL_Z_ZI__(s_4_0, s_4_6, s_4_3, s_4_5)
        let s_4_7: () = execute_MUL_Z_ZI__(state, tracer, s_4_0, s_4_6, s_4_3, s_4_5);
        // N s_4_8: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_6: read-var dn:i64
        let s_6_6: i64 = fn_state.dn;
        // D s_6_7: call execute_MUL_Z_ZI__(s_6_0, s_6_6, s_6_3, s_6_5)
        let s_6_7: () = execute_MUL_Z_ZI__(state, tracer, s_6_0, s_6_6, s_6_3, s_6_5);
        // N s_6_8: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_6: read-var dn:i64
        let s_8_6: i64 = fn_state.dn;
        // D s_8_7: call execute_MUL_Z_ZI__(s_8_0, s_8_6, s_8_3, s_8_5)
        let s_8_7: () = execute_MUL_Z_ZI__(state, tracer, s_8_0, s_8_6, s_8_3, s_8_5);
        // N s_8_8: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_6: read-var dn:i64
        let s_10_6: i64 = fn_state.dn;
        // D s_10_7: call execute_MUL_Z_ZI__(s_10_0, s_10_6, s_10_3, s_10_5)
        let s_10_7: () = execute_MUL_Z_ZI__(
            state,
            tracer,
            s_10_0,
            s_10_6,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_6: read-var dn:i64
        let s_12_6: i64 = fn_state.dn;
        // D s_12_7: call execute_MUL_Z_ZI__(s_12_0, s_12_6, s_12_3, s_12_5)
        let s_12_7: () = execute_MUL_Z_ZI__(
            state,
            tracer,
            s_12_0,
            s_12_6,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#185488 <= s_15_2
        fn_state.gs_185488 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
