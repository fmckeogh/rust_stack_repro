...
extern crate alloc;
use execute_aarch64_instrs_float_arithmetic_mul_add_sub::*;
use common::*;
pub fn decode_fnmadd_float_aarch64_instrs_float_arithmetic_mul_add_sub<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        fn_state.d = s_0_3;
        // D s_0_5: read-var Ra:u8
        let s_0_5: u8 = fn_state.Ra;
        ...
        // D s_0_9: write-var a <= s_0_8
        fn_state.a = s_0_8;
        // D s_0_10: read-var Rn:u8
        let s_0_10: u8 = fn_state.Rn;
        ...
        // D s_0_14: write-var n <= s_0_13
        fn_state.n = s_0_13;
        // D s_0_15: read-var Rm:u8
        let s_0_15: u8 = fn_state.Rm;
        ...
        // D s_0_19: write-var m <= s_0_18
        fn_state.m = s_0_18;
        // C s_0_20: const #16s : i64
        let s_0_20: i64 = 16;
        // D s_0_21: write-var esize <= s_0_20
        fn_state.esize = s_0_20;
        // D s_0_22: read-var ftype:u8
        let s_0_22: u8 = fn_state.ftype;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var o1:u8
        let s_2_1: bool = fn_state.o1;
        ...
        // D s_2_6: read-var o0:u8
        let s_2_6: bool = fn_state.o0;
        // D s_2_7: cast zx s_2_6 -> bv
        let s_2_7: Bits = Bits::new(s_2_6 as u128, 1u16);
        // D s_2_8: read-var o1:u8
        let s_2_8: bool = fn_state.o1;
        ...
        // D s_2_17: call execute_aarch64_instrs_float_arithmetic_mul_add_sub(s_2_13, s_2_14, s_2_12, s_2_15, s_2_16, s_2_10, s_2_5)
        let s_2_17: () = execute_aarch64_instrs_float_arithmetic_mul_add_sub(
            state,
            tracer,
            s_2_13,
            s_2_14,
