...
use Mk_RMR_Type::*;
use common::*;
pub fn RMR_SysRegWrite32_9dfdd4710efdf52a<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_2: call Mk_RMR_Type(s_7_1)
        let s_7_2: ProductType700c18a878c5601b = Mk_RMR_Type(state, tracer, s_7_1);
        // D s_7_3: call RMR_write(s_7_2)
        let s_7_3: () = RMR_write(state, tracer, s_7_2);
        // N s_7_4: return
        return;
    }
    fn block_8<T: Tracer>(
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_2: call IsHighestEL(s_11_1)
        let s_11_2: bool = IsHighestEL(state, tracer, s_11_1);
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_2: call Mk_RMR_Type(s_13_1)
        let s_13_2: ProductType700c18a878c5601b = Mk_RMR_Type(state, tracer, s_13_1);
        // D s_13_3: call RMR_write(s_13_2)
        let s_13_3: () = RMR_write(state, tracer, s_13_2);
        // N s_13_4: return
        return;
    }
