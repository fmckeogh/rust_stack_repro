...
use AddWithCarry::*;
use common::*;
pub fn execute_aarch32_instrs_ADD_i_OpA_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    imm32: u32,
    ...
    struct FunctionState {
        gs_877712: ProductTyped54bc449dd09e5bd,
        nzcv: u8,
        result: u32,
        d: i64,
        imm32: u32,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_8: write-var gs#877712 <= s_0_7
        fn_state.gs_877712 = s_0_7;
        // D s_0_9: read-var gs#877712.0:struct
        let s_0_9: Bits = fn_state.gs_877712._0;
        // D s_0_10: cast reint s_0_9 -> u32
        let s_0_10: u32 = (s_0_9.value() as u32);
        // D s_0_11: read-var gs#877712.1:struct
        let s_0_11: u8 = fn_state.gs_877712._1;
        // D s_0_12: write-var result <= s_0_10
        fn_state.result = s_0_10;
        // D s_0_13: write-var nzcv <= s_0_11
        fn_state.nzcv = s_0_11;
        // C s_0_14: const #15s : i
        let s_0_14: i128 = 15;
