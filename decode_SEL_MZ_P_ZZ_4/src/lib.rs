...
extern crate alloc;
use execute_SEL_MZ_P_ZZ_4::*;
use CurrentVL_read::*;
use HaveSME2::*;
use common::*;
pub fn decode_SEL_MZ_P_ZZ_4<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Zm: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_25: Bits = Bits::new(s_1_24 as u128, 3u16);
        ...
        // C s_1_30: cast reint s_1_27 -> u128
        ...
        fn_state.m = s_1_39;
        // D s_1_41: read-var Zd:u8
        let s_1_41: u8 = fn_state.Zd;
        // D s_1_42: cast zx s_1_41 -> bv
        let s_1_42: Bits = Bits::new(s_1_41 as u128, 3u16);
        // C s_1_43: const #0u : u8
        let s_1_43: u8 = 0;
        // C s_1_44: cast zx s_1_43 -> bv
        let s_1_44: Bits = Bits::new(s_1_43 as u128, 2u16);
        // D s_1_45: cast reint s_1_42 -> u128
        let s_1_45: u128 = (s_1_42.value() as u128);
        // D s_1_46: size-of s_1_42
        let s_1_46: u16 = s_1_42.length();
        // C s_1_47: cast reint s_1_44 -> u128
        let s_1_47: u128 = (s_1_44.value() as u128);
        // D s_1_48: size-of s_1_44
        let s_1_48: u16 = s_1_44.length();
        // D s_1_49: lsl s_1_45 s_1_48
        let s_1_49: u128 = s_1_45 << s_1_48;
        // D s_1_50: or s_1_49 s_1_47
        let s_1_50: u128 = ((s_1_49) | (s_1_47));
        // D s_1_51: add s_1_46 s_1_48
        let s_1_51: u16 = (s_1_46 + s_1_48);
        // D s_1_52: create-bits s_1_50 s_1_51
        let s_1_52: Bits = Bits::new(s_1_50, s_1_51);
        // D s_1_53: cast reint s_1_52 -> u8
        let s_1_53: u8 = (s_1_52.value() as u8);
        // D s_1_54: cast zx s_1_53 -> bv
        let s_1_54: Bits = Bits::new(s_1_53 as u128, 5u16);
        // D s_1_55: cast zx s_1_54 -> i
        let s_1_55: i128 = (s_1_54.value() as i128);
        // D s_1_56: cast reint s_1_55 -> i64
        let s_1_56: i64 = (s_1_55 as i64);
        // D s_1_57: write-var d <= s_1_56
        fn_state.d = s_1_56;
        // C s_1_58: const #1u : u8
        let s_1_58: bool = true;
        // C s_1_59: cast zx s_1_58 -> bv
        let s_1_59: Bits = Bits::new(s_1_58 as u128, 1u16);
        // D s_1_60: read-var PNg:u8
        let s_1_60: u8 = fn_state.PNg;
        // D s_1_61: cast zx s_1_60 -> bv
        let s_1_61: Bits = Bits::new(s_1_60 as u128, 3u16);
        // C s_1_62: cast reint s_1_59 -> u128
        let s_1_62: u128 = (s_1_59.value() as u128);
        // D s_1_63: size-of s_1_59
        let s_1_63: u16 = s_1_59.length();
        // D s_1_64: cast reint s_1_61 -> u128
        let s_1_64: u128 = (s_1_61.value() as u128);
        // D s_1_65: size-of s_1_61
        let s_1_65: u16 = s_1_61.length();
        // D s_1_66: lsl s_1_62 s_1_65
        let s_1_66: u128 = s_1_62 << s_1_65;
        // D s_1_67: or s_1_66 s_1_64
        let s_1_67: u128 = ((s_1_66) | (s_1_64));
        // D s_1_68: add s_1_63 s_1_65
        let s_1_68: u16 = (s_1_63 + s_1_65);
        // D s_1_69: create-bits s_1_67 s_1_68
        let s_1_69: Bits = Bits::new(s_1_67, s_1_68);
        // D s_1_70: cast reint s_1_69 -> u8
        let s_1_70: u8 = (s_1_69.value() as u8);
        // D s_1_71: cast zx s_1_70 -> bv
        let s_1_71: Bits = Bits::new(s_1_70 as u128, 4u16);
        // D s_1_72: cast zx s_1_71 -> i
        let s_1_72: i128 = (s_1_71.value() as i128);
        // D s_1_73: cast reint s_1_72 -> i64
        let s_1_73: i64 = (s_1_72 as i64);
        // D s_1_74: write-var g <= s_1_73
        fn_state.g = s_1_73;
        // D s_1_75: read-var VL:i64
        let s_1_75: i64 = fn_state.VL;
        // C s_1_76: const #128s : i
        let s_1_76: i128 = 128;
        // D s_1_77: cast zx s_1_75 -> i
        let s_1_77: i128 = (i128::try_from(s_1_75).unwrap());
        // D s_1_78: cmp-eq s_1_77 s_1_76
        let s_1_78: bool = ((s_1_77) == (s_1_76));
        // D s_1_79: not s_1_78
        let s_1_79: bool = !s_1_78;
        // N s_1_80: branch s_1_79 b3 b2
        if s_1_79 {
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_4: const #4s : i64
        let s_2_4: i64 = 4;
        // D s_2_5: read-var d:i64
        let s_2_5: i64 = fn_state.d;
        // D s_2_6: read-var g:i64
        let s_2_6: i64 = fn_state.g;
        // D s_2_7: read-var m:i64
        let s_2_7: i64 = fn_state.m;
        // D s_2_8: read-var n:i64
        let s_2_8: i64 = fn_state.n;
        // D s_2_9: call execute_SEL_MZ_P_ZZ_4(s_2_0, s_2_5, s_2_3, s_2_6, s_2_7, s_2_8, s_2_4)
        let s_2_9: () = execute_SEL_MZ_P_ZZ_4(
            state,
            tracer,
            s_2_0,
            s_2_5,
    ...
    fn block_4<T: Tracer>(
        ...
        // C s_4_4: const #4s : i64
        let s_4_4: i64 = 4;
        // D s_4_5: read-var d:i64
        let s_4_5: i64 = fn_state.d;
        // D s_4_6: read-var g:i64
        let s_4_6: i64 = fn_state.g;
        // D s_4_7: read-var m:i64
        let s_4_7: i64 = fn_state.m;
        // D s_4_8: read-var n:i64
        let s_4_8: i64 = fn_state.n;
        // D s_4_9: call execute_SEL_MZ_P_ZZ_4(s_4_0, s_4_5, s_4_3, s_4_6, s_4_7, s_4_8, s_4_4)
        let s_4_9: () = execute_SEL_MZ_P_ZZ_4(
            state,
            tracer,
            s_4_0,
            s_4_5,
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_4: const #4s : i64
        let s_6_4: i64 = 4;
        // D s_6_5: read-var d:i64
        let s_6_5: i64 = fn_state.d;
        // D s_6_6: read-var g:i64
        let s_6_6: i64 = fn_state.g;
        // D s_6_7: read-var m:i64
        let s_6_7: i64 = fn_state.m;
        // D s_6_8: read-var n:i64
        let s_6_8: i64 = fn_state.n;
        // D s_6_9: call execute_SEL_MZ_P_ZZ_4(s_6_0, s_6_5, s_6_3, s_6_6, s_6_7, s_6_8, s_6_4)
        let s_6_9: () = execute_SEL_MZ_P_ZZ_4(
            state,
            tracer,
            s_6_0,
            s_6_5,
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_4: const #4s : i64
        let s_8_4: i64 = 4;
        // D s_8_5: read-var d:i64
        let s_8_5: i64 = fn_state.d;
        // D s_8_6: read-var g:i64
        let s_8_6: i64 = fn_state.g;
        // D s_8_7: read-var m:i64
        let s_8_7: i64 = fn_state.m;
        // D s_8_8: read-var n:i64
        let s_8_8: i64 = fn_state.n;
        // D s_8_9: call execute_SEL_MZ_P_ZZ_4(s_8_0, s_8_5, s_8_3, s_8_6, s_8_7, s_8_8, s_8_4)
        let s_8_9: () = execute_SEL_MZ_P_ZZ_4(
            state,
            tracer,
            s_8_0,
            s_8_5,
    ...
    fn block_10<T: Tracer>(
        ...
        // C s_10_4: const #4s : i64
        let s_10_4: i64 = 4;
        // D s_10_5: read-var d:i64
        let s_10_5: i64 = fn_state.d;
        // D s_10_6: read-var g:i64
        let s_10_6: i64 = fn_state.g;
        // D s_10_7: read-var m:i64
        let s_10_7: i64 = fn_state.m;
        // D s_10_8: read-var n:i64
        let s_10_8: i64 = fn_state.n;
        // D s_10_9: call execute_SEL_MZ_P_ZZ_4(s_10_0, s_10_5, s_10_3, s_10_6, s_10_7, s_10_8, s_10_4)
        let s_10_9: () = execute_SEL_MZ_P_ZZ_4(
            state,
            tracer,
            s_10_0,
            s_10_5,
