...
use X_read::*;
use common::*;
pub fn TTBR0_EL3_SysRegWrite_3f52a3edf2b13467<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_TTBR0_EL3_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_TTBR0_EL3_Type(state, tracer, s_5_3);
        // C s_5_5: const #23176u : u32
        let s_5_5: u32 = 23176;
