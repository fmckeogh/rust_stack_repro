...
pub fn ICH_AP1R_set<T: Tracer>(
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_1: const #19904u : u32
        let s_0_1: u32 = 19904;
        // D s_0_2: read-reg s_0_1:[struct; 4]
        let s_0_2: [ProductType5c790c8ef59cc8b2; 4usize] = {
            let value = state
                .read_register::<[ProductType5c790c8ef59cc8b2; 4usize]>(s_0_1 as isize);
        ...
        // C s_0_6: const #19904u : u32
        let s_0_6: u32 = 19904;
        // D s_0_7: read-reg s_0_6:[struct; 4]
        let s_0_7: [ProductType5c790c8ef59cc8b2; 4usize] = {
            let value = state
                .read_register::<[ProductType5c790c8ef59cc8b2; 4usize]>(s_0_6 as isize);
        ...
        let s_0_10: [ProductType5c790c8ef59cc8b2; 4usize] = {
        ...
        // D s_0_12: cast cvt s_0_11 -> [struct; 4]
        let s_0_12: [ProductType5c790c8ef59cc8b2; 4usize] = {
            let mut buf = [Default::default(); 4usize];
            buf.copy_from_slice(&s_0_11);
            buf
        };
        // C s_0_13: const #19904u : u32
        let s_0_13: u32 = 19904;
        ...
        // C s_0_15: const #10008u : u32
        let s_0_15: u32 = 10008;
        // D s_0_16: read-reg s_0_15:[struct; 4]
        let s_0_16: [ProductType700c18a878c5601b; 4usize] = {
            let value = state
                .read_register::<[ProductType700c18a878c5601b; 4usize]>(s_0_15 as isize);
        ...
        let s_0_19: [ProductType700c18a878c5601b; 4usize] = {
            let mut local = s_0_16.clone();
            local[(s_0_18) as usize] = s_0_0;
            local
        };
        // D s_0_20: cast cvt s_0_19 -> [struct; 0]
        let s_0_20: alloc::vec::Vec<ProductType700c18a878c5601b> = alloc::vec::Vec::from(
            s_0_19,
        );
        // D s_0_21: cast cvt s_0_20 -> [struct; 4]
        let s_0_21: [ProductType700c18a878c5601b; 4usize] = {
            let mut buf = [Default::default(); 4usize];
            buf.copy_from_slice(&s_0_20);
            buf
        };
        // C s_0_22: const #10008u : u32
        let s_0_22: u32 = 10008;
        // N s_0_23: write-reg s_0_22 <= s_0_21
        let s_0_23: () = {
            state
                .write_register::<
                    [ProductType700c18a878c5601b; 4usize],
