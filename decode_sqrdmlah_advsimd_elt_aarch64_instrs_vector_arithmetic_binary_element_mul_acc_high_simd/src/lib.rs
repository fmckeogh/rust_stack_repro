...
use common::*;
pub fn decode_sqrdmlah_advsimd_elt_aarch64_instrs_vector_arithmetic_binary_element_mul_acc_high_simd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 64;
        // D s_2_1: write-var ga#267754 <= s_2_0
        fn_state.ga_267754 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#267754:i64
        let s_3_0: i64 = fn_state.ga_267754;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_2: write-var indexshadow#1942 <= s_5_1
        fn_state.indexshadow_1942 = s_5_1;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 64;
        // D s_6_1: write-var ga#267766 <= s_6_0
        fn_state.ga_267766 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var ga#267766:i64
        let s_7_0: i64 = fn_state.ga_267766;
        ...
        // D s_7_21: read-var indexshadow#1942:i64
        let s_7_21: i64 = fn_state.indexshadow_1942;
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_0: i64 = 128;
        // D s_8_1: write-var ga#267766 <= s_8_0
        fn_state.ga_267766 = s_8_0;
        // N s_8_2: jump b7
        return block_7(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
    ...
    fn block_12<T: Tracer>(
        ...
        let s_12_0: i64 = 128;
        // D s_12_1: write-var ga#267754 <= s_12_0
        fn_state.ga_267754 = s_12_0;
        // N s_12_2: jump b3
        return block_3(state, tracer, fn_state);
    }
