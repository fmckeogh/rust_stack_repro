...
use common::*;
pub fn AMCNTENSET0_SysRegWrite32_e19916620d98350a<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#123933 <= s_1_0
        fn_state.gs_123933 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#123933:u8
        let s_2_0: bool = fn_state.gs_123933;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#123934 <= s_3_0
        fn_state.gs_123934 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#123934:u8
        let s_4_0: bool = fn_state.gs_123934;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#123935 <= s_5_0
        fn_state.gs_123935 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#123935:u8
        let s_6_0: bool = fn_state.gs_123935;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#123936 <= s_8_0
        fn_state.gs_123936 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#123936:u8
        let s_9_0: bool = fn_state.gs_123936;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#123937 <= s_10_0
        fn_state.gs_123937 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#123937:u8
        let s_11_0: bool = fn_state.gs_123937;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#123938 <= s_12_0
        fn_state.gs_123938 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#123938:u8
        let s_13_0: bool = fn_state.gs_123938;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_2: call Mk_AMCNTENSET0_Type(s_16_1)
        let s_16_2: ProductType700c18a878c5601b = Mk_AMCNTENSET0_Type(
            state,
            tracer,
            s_16_1,
        );
        // D s_16_3: call AMCNTENSET0_write(s_16_2)
        let s_16_3: () = AMCNTENSET0_write(state, tracer, s_16_2);
        // N s_16_4: return
        return;
    }
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_5: write-var gs#123938 <= s_18_4
        fn_state.gs_123938 = s_18_4;
        // N s_18_6: jump b13
        return block_13(state, tracer, fn_state);
    }
    fn block_19<T: Tracer>(
        ...
        // D s_19_3: write-var gs#123937 <= s_19_2
        fn_state.gs_123937 = s_19_2;
        // N s_19_4: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_2: write-var gs#123936 <= s_20_1
        fn_state.gs_123936 = s_20_1;
        // N s_20_3: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_5: write-var gs#123935 <= s_22_4
        fn_state.gs_123935 = s_22_4;
        // N s_22_6: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_23<T: Tracer>(
        ...
        // D s_23_4: write-var gs#123934 <= s_23_3
        fn_state.gs_123934 = s_23_3;
        // N s_23_5: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_24<T: Tracer>(
        ...
        // D s_24_2: write-var gs#123933 <= s_24_1
        fn_state.gs_123933 = s_24_1;
        // N s_24_3: jump b2
        return block_2(state, tracer, fn_state);
    }
}
