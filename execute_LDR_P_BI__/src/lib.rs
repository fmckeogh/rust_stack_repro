...
use AlignmentFault::*;
use common::*;
pub fn execute_LDR_P_BI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    imm: i128,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#225707 <= s_4_0
        fn_state.gs_225707 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#225707:u8
        let s_5_0: bool = fn_state.gs_225707;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_6: write-var gs#225711 <= s_7_5
        fn_state.gs_225711 = s_7_5;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: read-var gs#225711:i64
        let s_8_1: i64 = fn_state.gs_225711;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_10: write-var gs#785770 <= s_9_9
        fn_state.gs_785770 = s_9_9;
        // N s_9_11: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#785770:bv
        let s_10_0: Bits = fn_state.gs_785770;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var PL:i64
        let s_11_0: i64 = fn_state.PL;
        ...
        // D s_11_7: call P_set(s_11_4, s_11_5, s_11_6)
        let s_11_7: () = P_set(state, tracer, s_11_4, s_11_5, s_11_6);
        // N s_11_8: return
        return;
    }
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_2: write-var gs#225707 <= s_13_1
        fn_state.gs_225707 = s_13_1;
        // N s_13_3: jump b5
        return block_5(state, tracer, fn_state);
    }
