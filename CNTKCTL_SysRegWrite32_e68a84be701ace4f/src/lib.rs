...
use R_read::*;
use common::*;
pub fn CNTKCTL_SysRegWrite32_e68a84be701ace4f<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_2: call Mk_CNTKCTL_Type(s_5_1)
        let s_5_2: ProductType700c18a878c5601b = Mk_CNTKCTL_Type(state, tracer, s_5_1);
        // D s_5_3: call CNTKCTL_write(s_5_2)
        let s_5_3: () = CNTKCTL_write(state, tracer, s_5_2);
        // N s_5_4: return
        return;
    }
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call Mk_CNTKCTL_Type(s_6_1)
        let s_6_2: ProductType700c18a878c5601b = Mk_CNTKCTL_Type(state, tracer, s_6_1);
        // D s_6_3: call CNTKCTL_write(s_6_2)
        let s_6_3: () = CNTKCTL_write(state, tracer, s_6_2);
        // N s_6_4: return
        return;
    }
    fn block_7<T: Tracer>(
        ...
        // D s_7_2: call Mk_CNTKCTL_Type(s_7_1)
        let s_7_2: ProductType700c18a878c5601b = Mk_CNTKCTL_Type(state, tracer, s_7_1);
        // D s_7_3: call CNTKCTL_write(s_7_2)
        let s_7_3: () = CNTKCTL_write(state, tracer, s_7_2);
        // N s_7_4: return
        return;
    }
    fn block_8<T: Tracer>(
