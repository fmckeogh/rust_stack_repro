...
use P_set::*;
use common::*;
pub fn execute_PTRUES_P_S__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_27: write-var gs#197519 <= s_1_26
        fn_state.gs_197519 = s_1_26;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#197519:i64
        let s_2_1: i64 = fn_state.gs_197519;
