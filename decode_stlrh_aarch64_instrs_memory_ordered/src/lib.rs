...
use common::*;
pub fn decode_stlrh_aarch64_instrs_memory_ordered<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 32;
        // D s_3_1: write-var ga#259373 <= s_3_0
        fn_state.ga_259373 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#259373:i64
        let s_4_0: i64 = fn_state.ga_259373;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // D s_5_1: write-var ga#259373 <= s_5_0
        fn_state.ga_259373 = s_5_0;
        // N s_5_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_6<T: Tracer>(
