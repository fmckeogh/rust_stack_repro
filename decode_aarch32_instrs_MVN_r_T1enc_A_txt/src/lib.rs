...
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_MVN_r_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rm: u8,
    Rd: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_12: u32 = 0;
        // D s_2_13: create-product struct = ["s_2_12", "s_2_11"]
        let s_2_13: ProductType396b95aa74979079 = ProductType396b95aa74979079 {
            _0: s_2_12,
            _1: s_2_11,
        };
        // D s_2_14: extract-field s_2_13.0
        let s_2_14: u32 = s_2_13._0;
        // C s_2_15: const #0u : u32
        let s_2_15: u32 = 0;
        // D s_2_16: create-product struct = ["s_2_15", "s_2_11"]
        let s_2_16: ProductType396b95aa74979079 = ProductType396b95aa74979079 {
            _0: s_2_15,
            _1: s_2_11,
        };
        // D s_2_17: extract-field s_2_16.1
        let s_2_17: i128 = s_2_16._1;
        ...
        // D s_2_20: call execute_aarch32_instrs_MVN_r_Op_A_txt(s_2_3, s_2_7, s_2_10, s_2_19, s_2_14)
        let s_2_20: () = execute_aarch32_instrs_MVN_r_Op_A_txt(
            state,
            tracer,
            s_2_3,
            s_2_7,
