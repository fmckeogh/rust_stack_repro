...
use execute_aarch32_instrs_VBIC_i_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_VBIC_i_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i: bool,
    D: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_13: write-var gs#306513 <= s_3_12
        fn_state.gs_306513 = s_3_12;
        // N s_3_14: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#306513:u8
        let s_4_0: bool = fn_state.gs_306513;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#306516 <= s_6_0
        fn_state.gs_306516 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#306516:u8
        let s_7_0: bool = fn_state.gs_306516;
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_25: const #1u : u8
        let s_8_25: bool = true;
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 2;
        // D s_10_1: write-var ga#351068 <= s_10_0
        fn_state.ga_351068 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var ga#351068:i64
        let s_11_0: i64 = fn_state.ga_351068;
        // D s_11_1: read-var d:i64
        let s_11_1: i64 = fn_state.d;
        // D s_11_2: read-var imm64:u64
        let s_11_2: u64 = fn_state.imm64;
        // D s_11_3: call execute_aarch32_instrs_VBIC_i_Op_A_txt(s_11_1, s_11_2, s_11_0)
        let s_11_3: () = execute_aarch32_instrs_VBIC_i_Op_A_txt(
            state,
            tracer,
            s_11_1,
            s_11_2,
    ...
    fn block_12<T: Tracer>(
        ...
        let s_12_0: i64 = 1;
        // D s_12_1: write-var ga#351068 <= s_12_0
        fn_state.ga_351068 = s_12_0;
        // N s_12_2: jump b11
        return block_11(state, tracer, fn_state);
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_22: write-var gs#306516 <= s_14_21
        fn_state.gs_306516 = s_14_21;
        // N s_14_23: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#306513 <= s_16_0
        fn_state.gs_306513 = s_16_0;
        // N s_16_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
