...
extern crate alloc;
use execute_aarch64_instrs_vector_arithmetic_unary_add_saturating_sisd::*;
use common::*;
pub fn decode_usqadd_advsimd_aarch64_instrs_vector_arithmetic_unary_add_saturating_simd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, size: u8, U: bool, Q: bool) -> () {
    #[derive(Default)]
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 64;
        // D s_2_1: write-var ga#269752 <= s_2_0
        fn_state.ga_269752 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#269752:i64
        let s_3_0: i64 = fn_state.ga_269752;
        ...
        // D s_3_16: cast zx s_3_5 -> i
        let s_3_16: i128 = (i128::try_from(s_3_5).unwrap());
        // D s_3_17: read-var d:i64
        let s_3_17: i64 = fn_state.d;
        // D s_3_18: read-var n:i64
        let s_3_18: i64 = fn_state.n;
        // D s_3_19: call execute_aarch64_instrs_vector_arithmetic_unary_add_saturating_sisd(s_3_17, s_3_12, s_3_16, s_3_15, s_3_18, s_3_10)
        let s_3_19: () = execute_aarch64_instrs_vector_arithmetic_unary_add_saturating_sisd(
            state,
            tracer,
            s_3_17,
            s_3_12,
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 128;
        // D s_4_1: write-var ga#269752 <= s_4_0
        fn_state.ga_269752 = s_4_0;
        // N s_4_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_5<T: Tracer>(
