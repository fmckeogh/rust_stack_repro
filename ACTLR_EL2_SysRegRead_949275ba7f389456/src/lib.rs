...
use common::*;
pub fn ACTLR_EL2_SysRegRead_949275ba7f389456<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#47010 <= s_8_0
        fn_state.gs_47010 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#47010:u8
        let s_9_0: bool = fn_state.gs_47010;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#47010 <= s_12_4
        fn_state.gs_47010 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
