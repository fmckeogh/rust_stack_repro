...
use common::*;
pub fn decode_frint64z_advsimd_aarch64_instrs_vector_arithmetic_unary_float_round_frint_32_64<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 64;
        // D s_3_1: write-var ga#256255 <= s_3_0
        fn_state.ga_256255 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var ga#256255:i64
        let s_4_0: i64 = fn_state.ga_256255;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // D s_5_1: write-var ga#256258 <= s_5_0
        fn_state.ga_256258 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#256258:i64
        let s_6_0: i64 = fn_state.ga_256258;
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 32;
        // D s_10_1: write-var ga#256258 <= s_10_0
        fn_state.ga_256258 = s_10_0;
        // N s_10_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_11<T: Tracer>(
        ...
        let s_11_0: i64 = 128;
        // D s_11_1: write-var ga#256255 <= s_11_0
        fn_state.ga_256255 = s_11_0;
        // N s_11_2: jump b4
        return block_4(state, tracer, fn_state);
    }
