...
use common::*;
pub fn decode_aarch32_instrs_MVN_i_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i: bool,
    S: bool,
    ...
    struct FunctionState {
        ...
        imm32: u32,
        setflags: bool,
        ga_345247: ProductType4813027798de1e98,
        d: i64,
        i: bool,
        S: bool,
        imm3: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_39: write-var ga#345247 <= s_2_38
        fn_state.ga_345247 = s_2_38;
        // D s_2_40: read-var ga#345247.0:struct
        let s_2_40: u32 = fn_state.ga_345247._0;
        // D s_2_41: read-var ga#345247.1:struct
        let s_2_41: bool = fn_state.ga_345247._1;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: call execute_aarch32_instrs_MVN_i_Op_A_txt(s_3_1, s_3_2, s_3_0, s_3_3)
        let s_3_4: () = execute_aarch32_instrs_MVN_i_Op_A_txt(
            state,
            tracer,
            s_3_1,
            s_3_2,
