...
use EncodePredCount::*;
use common::*;
pub fn execute_WHILEHI_PN_RR__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_2<T: Tracer>(
        ...
        // C s_2_35: const #1s : i
        let s_2_35: i128 = 1;
        // D s_2_36: read-var elements:i64
        let s_2_36: i64 = fn_state.elements;
        // D s_2_37: cast zx s_2_36 -> i
        let s_2_37: i128 = (i128::try_from(s_2_36).unwrap());
        // D s_2_38: sub s_2_37 s_2_35
        let s_2_38: i128 = ((s_2_37) - (s_2_35));
        // D s_2_39: cast reint s_2_38 -> i64
        let s_2_39: i64 = (s_2_38 as i64);
        // D s_2_40: write-var e <= s_2_39
        fn_state.e = s_2_39;
        // N s_2_41: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_1: const #0s : i64
        let s_3_1: i64 = 0;
        // D s_3_2: cmp-lt s_3_0 s_3_1
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#223067 <= s_7_0
        fn_state.gs_223067 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#223067:u8
        let s_8_0: bool = fn_state.gs_223067;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#223067 <= s_12_0
        fn_state.gs_223067 = s_12_0;
        // N s_12_2: jump b8
        return block_8(state, tracer, fn_state);
    }
