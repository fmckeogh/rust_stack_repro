...
use common::*;
pub fn decode_aarch32_instrs_BLX_r_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    Rm: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: call execute_aarch32_instrs_BLX_r_Op_A_txt(s_3_0)
        let s_3_1: () = execute_aarch32_instrs_BLX_r_Op_A_txt(state, tracer, s_3_0);
        // N s_3_2: return
        return;
    }
    fn block_4<T: Tracer>(
