...
use Zeros::*;
use common::*;
pub fn ALLINT_SysRegRead_ee53c92ec04c7280<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // S s_5_3: cast reint s_5_2 -> u50
        let s_5_3: u64 = (s_5_2.value() as u64);
        // C s_5_4: const #16969u : u32
        let s_5_4: u32 = 16969;
        ...
        let s_5_6: Bits = Bits::new(s_5_3 as u128, 50u16);
        ...
        // D s_5_16: cast reint s_5_15 -> u51
        ...
        // S s_5_19: cast reint s_5_18 -> u13
        let s_5_19: u16 = (s_5_18.value() as u16);
        // D s_5_20: cast zx s_5_16 -> bv
        let s_5_20: Bits = Bits::new(s_5_16 as u128, 51u16);
        // S s_5_21: cast zx s_5_19 -> bv
        let s_5_21: Bits = Bits::new(s_5_19 as u128, 13u16);
    ...
    fn block_6<T: Tracer>(
        ...
        // S s_6_3: cast reint s_6_2 -> u50
        let s_6_3: u64 = (s_6_2.value() as u64);
        // C s_6_4: const #16969u : u32
        let s_6_4: u32 = 16969;
        ...
        let s_6_6: Bits = Bits::new(s_6_3 as u128, 50u16);
    ...
    fn block_7<T: Tracer>(
        ...
        // S s_7_3: cast reint s_7_2 -> u50
        let s_7_3: u64 = (s_7_2.value() as u64);
        // C s_7_4: const #16969u : u32
        let s_7_4: u32 = 16969;
        ...
        let s_7_6: Bits = Bits::new(s_7_3 as u128, 50u16);
