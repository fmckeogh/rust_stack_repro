...
extern crate alloc;
use execute_BFMIN_MZ_ZZW_2x2::*;
use CurrentVL_read::*;
use HaveSMEB16B16::*;
use common::*;
pub fn decode_BFMIN_MZ_ZZW_2x2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Zm: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_3: i64 = 2;
        // D s_2_4: call execute_BFMIN_MZ_ZZW_2x2(s_2_0, s_2_1, s_2_2, s_2_3)
        let s_2_4: () = execute_BFMIN_MZ_ZZW_2x2(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_3: i64 = 2;
        // D s_4_4: call execute_BFMIN_MZ_ZZW_2x2(s_4_0, s_4_1, s_4_2, s_4_3)
        let s_4_4: () = execute_BFMIN_MZ_ZZW_2x2(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_3: i64 = 2;
        // D s_6_4: call execute_BFMIN_MZ_ZZW_2x2(s_6_0, s_6_1, s_6_2, s_6_3)
        let s_6_4: () = execute_BFMIN_MZ_ZZW_2x2(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_3: i64 = 2;
        // D s_8_4: call execute_BFMIN_MZ_ZZW_2x2(s_8_0, s_8_1, s_8_2, s_8_3)
        let s_8_4: () = execute_BFMIN_MZ_ZZW_2x2(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_3: i64 = 2;
        // D s_10_4: call execute_BFMIN_MZ_ZZW_2x2(s_10_0, s_10_1, s_10_2, s_10_3)
        let s_10_4: () = execute_BFMIN_MZ_ZZW_2x2(
            state,
            tracer,
            s_10_0,
            s_10_1,
