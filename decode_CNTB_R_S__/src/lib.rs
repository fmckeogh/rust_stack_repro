...
extern crate alloc;
use HaveSVE::*;
use execute_CNTB_R_S__::*;
use HaveSME::*;
use common::*;
pub fn decode_CNTB_R_S__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    imm4: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#191903 <= s_1_0
        fn_state.gs_191903 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#191903:u8
        let s_2_0: bool = fn_state.gs_191903;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_14: call execute_CNTB_R_S__(s_3_4, s_3_0, s_3_13, s_3_5)
        let s_3_14: () = execute_CNTB_R_S__(state, tracer, s_3_4, s_3_0, s_3_13, s_3_5);
        // N s_3_15: return
        return;
    }
    fn block_4<T: Tracer>(
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: write-var gs#191903 <= s_5_2
        fn_state.gs_191903 = s_5_2;
        // N s_5_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
