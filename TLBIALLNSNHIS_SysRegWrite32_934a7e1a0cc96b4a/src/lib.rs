...
use common::*;
pub fn TLBIALLNSNHIS_SysRegWrite32_934a7e1a0cc96b4a<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: u32 = 0;
        // C s_6_1: const #4u : u32
        let s_6_1: u32 = 4;
        // C s_6_2: const #1u : u32
        let s_6_2: u32 = 1;
        // C s_6_3: const #0u : u32
        let s_6_3: u32 = 0;
        // S s_6_4: call AArch32_TLBI_ALL(s_6_0, s_6_1, s_6_2, s_6_3)
        let s_6_4: () = AArch32_TLBI_ALL(state, tracer, s_6_0, s_6_1, s_6_2, s_6_3);
        // N s_6_5: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_3: const #4u : u32
        let s_8_3: u32 = 4;
        // C s_8_4: const #1u : u32
        let s_8_4: u32 = 1;
        // C s_8_5: const #0u : u32
        let s_8_5: u32 = 0;
        // D s_8_6: call AArch32_TLBI_ALL(s_8_2, s_8_3, s_8_4, s_8_5)
        let s_8_6: () = AArch32_TLBI_ALL(state, tracer, s_8_2, s_8_3, s_8_4, s_8_5);
        // N s_8_7: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#134068 <= s_10_0
        fn_state.gs_134068 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#134068:u8
        let s_11_0: bool = fn_state.gs_134068;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#134069 <= s_12_0
        fn_state.gs_134069 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#134069:u8
        let s_13_0: bool = fn_state.gs_134069;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#134070 <= s_15_0
        fn_state.gs_134070 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#134070:u8
        let s_16_0: bool = fn_state.gs_134070;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#134071 <= s_17_0
        fn_state.gs_134071 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#134071:u8
        let s_18_0: bool = fn_state.gs_134071;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_5: write-var gs#134071 <= s_21_4
        fn_state.gs_134071 = s_21_4;
        // N s_21_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        // D s_22_3: write-var gs#134070 <= s_22_2
        fn_state.gs_134070 = s_22_2;
        // N s_22_4: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_24<T: Tracer>(
        ...
        // D s_24_5: write-var gs#134069 <= s_24_4
        fn_state.gs_134069 = s_24_4;
        // N s_24_6: jump b13
        return block_13(state, tracer, fn_state);
    }
    fn block_25<T: Tracer>(
        ...
        // D s_25_4: write-var gs#134068 <= s_25_3
        fn_state.gs_134068 = s_25_3;
        // N s_25_5: jump b11
        return block_11(state, tracer, fn_state);
    }
