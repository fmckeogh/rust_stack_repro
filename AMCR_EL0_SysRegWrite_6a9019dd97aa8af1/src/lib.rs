...
use X_read::*;
use common::*;
pub fn AMCR_EL0_SysRegWrite_6a9019dd97aa8af1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_4: call Mk_AMCR_EL0_Type(s_2_3)
        let s_2_4: ProductType5c790c8ef59cc8b2 = Mk_AMCR_EL0_Type(state, tracer, s_2_3);
        // C s_2_5: const #15544u : u32
        let s_2_5: u32 = 15544;
