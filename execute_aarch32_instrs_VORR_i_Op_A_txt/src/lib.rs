...
use D_read::*;
use common::*;
pub fn execute_aarch32_instrs_VORR_i_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    imm64: u64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_6: write-var gs#314695 <= s_1_5
        fn_state.gs_314695 = s_1_5;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#314695:i64
        let s_2_1: i64 = fn_state.gs_314695;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_15: read-var imm64:u64
        let s_3_15: u64 = fn_state.imm64;
        // D s_3_16: cast zx s_3_15 -> bv
        let s_3_16: Bits = Bits::new(s_3_15 as u128, 64u16);
        // D s_3_17: or s_3_14 s_3_16
        let s_3_17: Bits = ((s_3_14) | (s_3_16));
        // D s_3_18: cast reint s_3_17 -> u64
        let s_3_18: u64 = (s_3_17.value() as u64);
        // D s_3_19: cast zx s_3_5 -> i
        let s_3_19: i128 = (i128::try_from(s_3_5).unwrap());
        // D s_3_20: call D_set(s_3_19, s_3_18)
        let s_3_20: () = D_set(state, tracer, s_3_19, s_3_18);
        // D s_3_21: read-var r:i64
        let s_3_21: i64 = fn_state.r;
        // C s_3_22: const #1s : i64
        let s_3_22: i64 = 1;
        // D s_3_23: add s_3_21 s_3_22
        let s_3_23: i64 = (s_3_21 + s_3_22);
        // D s_3_24: write-var r <= s_3_23
        fn_state.r = s_3_23;
        // N s_3_25: jump b2
        return block_2(state, tracer, fn_state);
    }
