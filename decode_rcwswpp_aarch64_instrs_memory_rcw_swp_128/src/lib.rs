...
extern crate alloc;
use neq_int::*;
use execute_aarch64_instrs_memory_rcw_swp_128::*;
use HaveTHExt::*;
use Have128BitDescriptorExt::*;
use common::*;
pub fn decode_rcwswpp_aarch64_instrs_memory_rcw_swp_128<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_3: write-var gs#166537 <= s_1_2
        fn_state.gs_166537 = s_1_2;
        // N s_1_4: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#166537:u8
        let s_2_0: bool = fn_state.gs_166537;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_30: call execute_aarch64_instrs_memory_rcw_swp_128(s_5_21, s_5_15, s_5_26, s_5_16, s_5_3, s_5_11, s_5_29)
        let s_5_30: () = execute_aarch64_instrs_memory_rcw_swp_128(
            state,
            tracer,
            s_5_21,
            s_5_15,
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#166537 <= s_9_0
        fn_state.gs_166537 = s_9_0;
        // N s_9_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
