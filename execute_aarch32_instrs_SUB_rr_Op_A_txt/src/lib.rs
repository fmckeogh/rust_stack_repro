...
use AddWithCarry::*;
use common::*;
pub fn execute_aarch32_instrs_SUB_rr_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        nzcv: u8,
        gs_886839: ProductTyped54bc449dd09e5bd,
        d: i64,
        m: i64,
        n: i64,
        s: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_34: write-var gs#886839 <= s_0_33
        fn_state.gs_886839 = s_0_33;
        // D s_0_35: read-var gs#886839.0:struct
        let s_0_35: Bits = fn_state.gs_886839._0;
        // D s_0_36: cast reint s_0_35 -> u32
        let s_0_36: u32 = (s_0_35.value() as u32);
        // D s_0_37: read-var gs#886839.1:struct
        let s_0_37: u8 = fn_state.gs_886839._1;
