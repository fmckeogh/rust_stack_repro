...
use Mk_CPTR_EL2_Type::*;
use NVMem_set::*;
use u_get_HCR_EL2_Type_NV1::*;
use u_get_HCR_EL2_Type_NV::*;
use u_get_HFGWTR_EL2_Type_CPACR_EL1::*;
use u_get_CPTR_EL3_Type_TCPAC::*;
use u_get_EDSCR_Type_SDD::*;
use Mk_CPACR_EL1_Type::*;
use EL2Enabled::*;
use EDSCR_read::*;
use u_get_HCR_EL2_Type_NV2::*;
use common::*;
pub fn CPACR_EL1_SysRegWrite_c63495641b6492df<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_21: call _get_HFGWTR_EL2_Type_CPACR_EL1(s_0_20)
        let s_0_21: bool = u_get_HFGWTR_EL2_Type_CPACR_EL1(state, tracer, s_0_20);
        // D s_0_22: write-var __HFGWTR_EL2_CPACR_EL1 <= s_0_21
        fn_state.u__HFGWTR_EL2_CPACR_EL1 = s_0_21;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_CPACR_EL1_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_CPACR_EL1_Type(state, tracer, s_5_3);
        // C s_5_5: const #12088u : u32
        let s_5_5: u32 = 12088;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#82007 <= s_7_0
        fn_state.gs_82007 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#82007:u8
        let s_8_0: bool = fn_state.gs_82007;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#82008 <= s_9_0
        fn_state.gs_82008 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#82008:u8
        let s_10_0: bool = fn_state.gs_82008;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#82009 <= s_11_0
        fn_state.gs_82009 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#82009:u8
        let s_12_0: bool = fn_state.gs_82009;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#82010 <= s_13_0
        fn_state.gs_82010 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#82010:u8
        let s_14_0: bool = fn_state.gs_82010;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#82011 <= s_16_0
        fn_state.gs_82011 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#82011:u8
        let s_17_0: bool = fn_state.gs_82011;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_4: call Mk_CPACR_EL1_Type(s_19_3)
        let s_19_4: ProductType5c790c8ef59cc8b2 = Mk_CPACR_EL1_Type(
            state,
            tracer,
            s_19_3,
        );
        // C s_19_5: const #12088u : u32
        let s_19_5: u32 = 12088;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_4: call Mk_CPTR_EL2_Type(s_20_3)
        let s_20_4: ProductType5c790c8ef59cc8b2 = Mk_CPTR_EL2_Type(
            state,
            tracer,
            s_20_3,
        );
        // C s_20_5: const #11088u : u32
        let s_20_5: u32 = 11088;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#82014 <= s_22_0
        fn_state.gs_82014 = s_22_0;
        // N s_22_2: jump b23
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_0: read-var gs#82014:u8
        let s_23_0: bool = fn_state.gs_82014;
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_5: write-var gs#82014 <= s_26_4
        fn_state.gs_82014 = s_26_4;
        // N s_26_6: jump b23
        return block_23(state, tracer, fn_state);
    }
    fn block_27<T: Tracer>(
        ...
        // D s_27_5: write-var gs#82011 <= s_27_4
        fn_state.gs_82011 = s_27_4;
        // N s_27_6: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_5: write-var gs#82010 <= s_29_4
        fn_state.gs_82010 = s_29_4;
        // N s_29_6: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_2: write-var gs#82009 <= s_30_1
        fn_state.gs_82009 = s_30_1;
        // N s_30_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_31<T: Tracer>(
        ...
        // D s_31_5: write-var gs#82008 <= s_31_4
        fn_state.gs_82008 = s_31_4;
        // N s_31_6: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_32<T: Tracer>(
        ...
        // D s_32_4: write-var gs#82007 <= s_32_3
        fn_state.gs_82007 = s_32_3;
        // N s_32_5: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_1: write-var gs#82015 <= s_34_0
        fn_state.gs_82015 = s_34_0;
        // N s_34_2: jump b35
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_0: read-var gs#82015:u8
        let s_35_0: bool = fn_state.gs_82015;
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_1: write-var gs#82016 <= s_36_0
        fn_state.gs_82016 = s_36_0;
        // N s_36_2: jump b37
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_0: read-var gs#82016:u8
        let s_37_0: bool = fn_state.gs_82016;
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_1: write-var gs#82017 <= s_38_0
        fn_state.gs_82017 = s_38_0;
        // N s_38_2: jump b39
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_0: read-var gs#82017:u8
        let s_39_0: bool = fn_state.gs_82017;
    ...
    fn block_40<T: Tracer>(
        ...
        // D s_40_1: write-var gs#82018 <= s_40_0
        fn_state.gs_82018 = s_40_0;
        // N s_40_2: jump b41
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_0: read-var gs#82018:u8
        let s_41_0: bool = fn_state.gs_82018;
    ...
    fn block_43<T: Tracer>(
        ...
        // D s_43_1: write-var gs#82019 <= s_43_0
        fn_state.gs_82019 = s_43_0;
        // N s_43_2: jump b44
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_0: read-var gs#82019:u8
        let s_44_0: bool = fn_state.gs_82019;
    ...
    fn block_46<T: Tracer>(
        ...
        // D s_46_1: write-var gs#82020 <= s_46_0
        fn_state.gs_82020 = s_46_0;
        // N s_46_2: jump b47
    ...
    fn block_47<T: Tracer>(
        ...
        // D s_47_0: read-var gs#82020:u8
        let s_47_0: bool = fn_state.gs_82020;
    ...
    fn block_48<T: Tracer>(
        ...
        // D s_48_1: write-var gs#82022 <= s_48_0
        fn_state.gs_82022 = s_48_0;
        // N s_48_2: jump b49
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_0: read-var gs#82022:u8
        let s_49_0: bool = fn_state.gs_82022;
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_1: write-var gs#82023 <= s_50_0
        fn_state.gs_82023 = s_50_0;
        // N s_50_2: jump b51
    ...
    fn block_51<T: Tracer>(
        ...
        // D s_51_0: read-var gs#82023:u8
        let s_51_0: bool = fn_state.gs_82023;
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_1: write-var gs#82024 <= s_53_0
        fn_state.gs_82024 = s_53_0;
        // N s_53_2: jump b54
    ...
    fn block_54<T: Tracer>(
        ...
        // D s_54_0: read-var gs#82024:u8
        let s_54_0: bool = fn_state.gs_82024;
    ...
    fn block_56<T: Tracer>(
        ...
        // D s_56_1: write-var gs#82025 <= s_56_0
        fn_state.gs_82025 = s_56_0;
        // N s_56_2: jump b57
    ...
    fn block_57<T: Tracer>(
        ...
        // D s_57_0: read-var gs#82025:u8
        let s_57_0: bool = fn_state.gs_82025;
    ...
    fn block_58<T: Tracer>(
        ...
        // D s_58_4: call Mk_CPACR_EL1_Type(s_58_3)
        let s_58_4: ProductType5c790c8ef59cc8b2 = Mk_CPACR_EL1_Type(
            state,
            tracer,
            s_58_3,
        );
        // C s_58_5: const #12088u : u32
        let s_58_5: u32 = 12088;
    ...
    fn block_60<T: Tracer>(
        ...
        // D s_60_35: write-var gs#82025 <= s_60_34
        fn_state.gs_82025 = s_60_34;
        // N s_60_36: jump b57
        return block_57(state, tracer, fn_state);
    }
    ...
    fn block_62<T: Tracer>(
        ...
        // D s_62_1: write-var gs#82028 <= s_62_0
        fn_state.gs_82028 = s_62_0;
        // N s_62_2: jump b63
    ...
    fn block_63<T: Tracer>(
        ...
        // D s_63_0: read-var gs#82028:u8
        let s_63_0: bool = fn_state.gs_82028;
    ...
    fn block_66<T: Tracer>(
        ...
        // D s_66_5: write-var gs#82028 <= s_66_4
        fn_state.gs_82028 = s_66_4;
        // N s_66_6: jump b63
        return block_63(state, tracer, fn_state);
    }
    fn block_67<T: Tracer>(
        ...
        // D s_67_0: read-var __CPTR_EL3_TCPAC:u8
        let s_67_0: bool = fn_state.u__CPTR_EL3_TCPAC;
        ...
        // D s_67_5: write-var gs#82024 <= s_67_4
        fn_state.gs_82024 = s_67_4;
        // N s_67_6: jump b54
        return block_54(state, tracer, fn_state);
    }
    ...
    fn block_69<T: Tracer>(
        ...
        // D s_69_0: read-var __HFGWTR_EL2_CPACR_EL1:u8
        let s_69_0: bool = fn_state.u__HFGWTR_EL2_CPACR_EL1;
        ...
        // D s_69_5: write-var gs#82023 <= s_69_4
        fn_state.gs_82023 = s_69_4;
        // N s_69_6: jump b51
        return block_51(state, tracer, fn_state);
    }
    ...
    fn block_71<T: Tracer>(
        ...
        // D s_71_5: write-var gs#82021 <= s_71_4
        fn_state.gs_82021 = s_71_4;
        // N s_71_6: jump b72
    ...
    fn block_72<T: Tracer>(
        ...
        // D s_72_0: read-var gs#82021:u8
        let s_72_0: bool = fn_state.gs_82021;
        // D s_72_1: write-var gs#82022 <= s_72_0
        fn_state.gs_82022 = s_72_0;
        // N s_72_2: jump b49
        return block_49(state, tracer, fn_state);
    }
    fn block_73<T: Tracer>(
        ...
        // D s_73_1: write-var gs#82021 <= s_73_0
        fn_state.gs_82021 = s_73_0;
        // N s_73_2: jump b72
        return block_72(state, tracer, fn_state);
    }
    fn block_74<T: Tracer>(
        ...
        // D s_74_2: write-var gs#82020 <= s_74_1
        fn_state.gs_82020 = s_74_1;
        // N s_74_3: jump b47
        return block_47(state, tracer, fn_state);
    }
    ...
    fn block_76<T: Tracer>(
        ...
        // D s_76_0: read-var __CPTR_EL2_TCPAC:u8
        let s_76_0: bool = fn_state.u__CPTR_EL2_TCPAC;
        ...
        // D s_76_5: write-var gs#82019 <= s_76_4
        fn_state.gs_82019 = s_76_4;
        // N s_76_6: jump b44
        return block_44(state, tracer, fn_state);
    }
    ...
    fn block_78<T: Tracer>(
        ...
        // D s_78_0: read-var __CPTR_EL3_TCPAC:u8
        let s_78_0: bool = fn_state.u__CPTR_EL3_TCPAC;
        ...
        // D s_78_5: write-var gs#82018 <= s_78_4
        fn_state.gs_82018 = s_78_4;
        // N s_78_6: jump b41
        return block_41(state, tracer, fn_state);
    }
    fn block_79<T: Tracer>(
        ...
        // D s_79_2: write-var gs#82017 <= s_79_1
        fn_state.gs_82017 = s_79_1;
        // N s_79_3: jump b39
        return block_39(state, tracer, fn_state);
    }
    fn block_80<T: Tracer>(
        ...
        // D s_80_5: write-var gs#82016 <= s_80_4
        fn_state.gs_82016 = s_80_4;
        // N s_80_6: jump b37
        return block_37(state, tracer, fn_state);
    }
    fn block_81<T: Tracer>(
        ...
        // D s_81_4: write-var gs#82015 <= s_81_3
        fn_state.gs_82015 = s_81_3;
        // N s_81_5: jump b35
        return block_35(state, tracer, fn_state);
    }
