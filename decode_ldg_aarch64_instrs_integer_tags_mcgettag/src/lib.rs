...
extern crate alloc;
use execute_aarch64_instrs_integer_tags_mcgettag::*;
use HaveMTEExt::*;
use common::*;
pub fn decode_ldg_aarch64_instrs_integer_tags_mcgettag<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Xt: u8,
    Xn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_19: call execute_aarch64_instrs_integer_tags_mcgettag(s_1_7, s_1_18, s_1_3)
        let s_1_19: () = execute_aarch64_instrs_integer_tags_mcgettag(
            state,
            tracer,
            s_1_7,
            s_1_18,
