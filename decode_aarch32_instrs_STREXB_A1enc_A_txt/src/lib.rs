...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_STREXB_Op_A_txt::*;
use common::*;
pub fn decode_aarch32_instrs_STREXB_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    Rn: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#302645 <= s_3_3
        fn_state.gs_302645 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#302645:u8
        let s_4_0: bool = fn_state.gs_302645;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: write-var gs#302647 <= s_5_3
        fn_state.gs_302647 = s_5_3;
        // N s_5_5: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#302647:u8
        let s_6_0: bool = fn_state.gs_302647;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_5: write-var gs#302648 <= s_8_4
        fn_state.gs_302648 = s_8_4;
        // N s_8_6: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#302648:u8
        let s_9_0: bool = fn_state.gs_302648;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_3: call execute_aarch32_instrs_STREXB_Op_A_txt(s_10_0, s_10_1, s_10_2)
        let s_10_3: () = execute_aarch32_instrs_STREXB_Op_A_txt(
            state,
            tracer,
            s_10_0,
            s_10_1,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#302648 <= s_12_0
        fn_state.gs_302648 = s_12_0;
        // N s_12_2: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#302647 <= s_14_0
        fn_state.gs_302647 = s_14_0;
        // N s_14_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#302645 <= s_15_0
        fn_state.gs_302645 = s_15_0;
        // N s_15_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
