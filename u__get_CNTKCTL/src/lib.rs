...
use Mk_CNTKCTL_Type::*;
use common::*;
pub fn u__get_CNTKCTL<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4294835200u : u32
        let s_0_3: u32 = 4294835200;
        ...
        // D s_0_11: tail-call Mk_CNTKCTL_Type(s_0_10)
        return Mk_CNTKCTL_Type(state, tracer, s_0_10);
    }
}
