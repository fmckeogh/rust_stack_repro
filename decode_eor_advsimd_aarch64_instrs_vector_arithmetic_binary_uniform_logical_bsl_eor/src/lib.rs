...
use common::*;
pub fn decode_eor_advsimd_aarch64_instrs_vector_arithmetic_binary_uniform_logical_bsl_eor<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, Rm: u8, opc2: u8, Q: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#250227 <= s_1_0
        fn_state.ga_250227 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#250227:i64
        let s_2_0: i64 = fn_state.ga_250227;
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i64 = 128;
        // D s_10_1: write-var ga#250227 <= s_10_0
        fn_state.ga_250227 = s_10_0;
        // N s_10_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
