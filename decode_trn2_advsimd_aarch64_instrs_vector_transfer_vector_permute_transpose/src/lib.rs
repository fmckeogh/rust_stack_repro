...
extern crate alloc;
use execute_aarch64_instrs_vector_transfer_vector_permute_transpose::*;
use common::*;
pub fn decode_trn2_advsimd_aarch64_instrs_vector_transfer_vector_permute_transpose<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 64;
        // D s_2_1: write-var ga#269980 <= s_2_0
        fn_state.ga_269980 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#269980:i64
        let s_3_0: i64 = fn_state.ga_269980;
        ...
        // D s_3_12: div s_3_11 s_3_10
        let s_3_12: i128 = ((s_3_11) / (s_3_10));
        // D s_3_13: cast reint s_3_12 -> i64
        let s_3_13: i64 = (s_3_12 as i64);
        // D s_3_14: cast zx s_3_0 -> i
        let s_3_14: i128 = (i128::try_from(s_3_0).unwrap());
        ...
        // D s_3_20: read-var d:i64
        let s_3_20: i64 = fn_state.d;
        // D s_3_21: read-var m:i64
        let s_3_21: i64 = fn_state.m;
        // D s_3_22: read-var n:i64
        let s_3_22: i64 = fn_state.n;
        // D s_3_23: call execute_aarch64_instrs_vector_transfer_vector_permute_transpose(s_3_20, s_3_15, s_3_18, s_3_21, s_3_22, s_3_19, s_3_9)
        let s_3_23: () = execute_aarch64_instrs_vector_transfer_vector_permute_transpose(
            state,
            tracer,
            s_3_20,
            s_3_15,
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_0: i64 = 128;
        // D s_4_1: write-var ga#269980 <= s_4_0
        fn_state.ga_269980 = s_4_0;
        // N s_4_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_5<T: Tracer>(
