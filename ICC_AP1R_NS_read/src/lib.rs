...
extern crate alloc;
use common::*;
pub fn ICC_AP1R_NS_read<T: Tracer>(state: &mut State, tracer: &T, n: i64) -> u32 {
    #[derive(Default)]
    struct FunctionState {
        ga_27455: ProductType5c790c8ef59cc8b2,
        n: i64,
    }
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_10: write-var ga#27455 <= s_0_9
        fn_state.ga_27455 = s_0_9;
        // D s_0_11: read-var ga#27455.0:struct
        let s_0_11: u64 = fn_state.ga_27455._0;
        // C s_0_12: const #0s : i
        let s_0_12: i128 = 0;
