...
use common::*;
pub fn execute_SEL_P_P_PP__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_46: write-var gs#198932 <= s_1_45
        fn_state.gs_198932 = s_1_45;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#198932:i64
        let s_2_1: i64 = fn_state.gs_198932;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_3: read-var element2:u8
        let s_4_3: bool = fn_state.element2;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_11: cast zx s_6_2 -> i
        let s_6_11: i128 = (i128::try_from(s_6_2).unwrap());
        // D s_6_12: cast zx s_6_8 -> bv
        let s_6_12: Bits = Bits::new(s_6_8 as u128, 1u16);
        // D s_6_13: read-var result:bv
        let s_6_13: Bits = fn_state.result;
        // D s_6_14: call Elem_set(s_6_13, s_6_10, s_6_11, s_6_12)
        let s_6_14: Bits = Elem_set(state, tracer, s_6_13, s_6_10, s_6_11, s_6_12);
