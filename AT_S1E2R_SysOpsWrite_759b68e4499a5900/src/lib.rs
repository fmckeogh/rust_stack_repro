...
use common::*;
pub fn AT_S1E2R_SysOpsWrite_759b68e4499a5900<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#101255 <= s_10_0
        fn_state.gs_101255 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#101255:u8
        let s_11_0: bool = fn_state.gs_101255;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_5: write-var gs#101255 <= s_14_4
        fn_state.gs_101255 = s_14_4;
        // N s_14_6: jump b11
        return block_11(state, tracer, fn_state);
    }
