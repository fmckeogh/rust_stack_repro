...
use common::*;
pub fn decode_usqadd_advsimd_aarch64_instrs_vector_arithmetic_unary_add_saturating_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, size: u8, U: bool) -> () {
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_8: read-var size:u8
        let s_0_8: u8 = fn_state.size;
        ...
        // C s_0_23: const #1s : i
        let s_0_23: i128 = 1;
        // D s_0_24: call execute_aarch64_instrs_vector_arithmetic_unary_add_saturating_sisd(s_0_3, s_0_20, s_0_23, s_0_22, s_0_7, s_0_18)
        let s_0_24: () = execute_aarch64_instrs_vector_arithmetic_unary_add_saturating_sisd(
            state,
            tracer,
            s_0_3,
            s_0_20,
