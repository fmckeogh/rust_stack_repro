...
use common::*;
pub fn decode_scvtf_advsimd_int_aarch64_instrs_vector_arithmetic_unary_fp16_conv_int_simd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, U: bool, Q: bool) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 64;
        // D s_1_1: write-var ga#265130 <= s_1_0
        fn_state.ga_265130 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#265130:i64
        let s_2_0: i64 = fn_state.ga_265130;
        // C s_2_1: const #16s : i
        let s_2_1: i128 = 16;
    ...
    fn block_3<T: Tracer>(
        ...
        let s_3_0: i64 = 128;
        // D s_3_1: write-var ga#265130 <= s_3_0
        fn_state.ga_265130 = s_3_0;
        // N s_3_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
