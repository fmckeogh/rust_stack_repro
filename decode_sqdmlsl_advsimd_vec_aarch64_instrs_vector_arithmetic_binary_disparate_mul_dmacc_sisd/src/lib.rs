...
use common::*;
pub fn decode_sqdmlsl_advsimd_vec_aarch64_instrs_vector_arithmetic_binary_disparate_mul_dmacc_sisd<
    T: Tracer,
>(state: &mut State, tracer: &T, Rd: u8, Rn: u8, o1: bool, Rm: u8, size: u8) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_5: write-var gs#170729 <= s_1_4
        fn_state.gs_170729 = s_1_4;
        // N s_1_6: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#170729:u8
        let s_2_0: bool = fn_state.gs_170729;
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_0: const #1u : u8
        let s_5_0: bool = true;
        // D s_5_1: write-var gs#170729 <= s_5_0
        fn_state.gs_170729 = s_5_0;
        // N s_5_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
