...
use common::*;
pub fn decode_sqrdmlsh_advsimd_vec_aarch64_instrs_vector_arithmetic_binary_uniform_mul_int_doubling_accum_simd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_5: write-var gs#171182 <= s_2_4
        fn_state.gs_171182 = s_2_4;
        // N s_2_6: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#171182:u8
        let s_3_0: bool = fn_state.gs_171182;
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // D s_5_1: write-var ga#267706 <= s_5_0
        fn_state.ga_267706 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var ga#267706:i64
        let s_6_0: i64 = fn_state.ga_267706;
    ...
    fn block_7<T: Tracer>(
        ...
        let s_7_0: i64 = 128;
        // D s_7_1: write-var ga#267706 <= s_7_0
        fn_state.ga_267706 = s_7_0;
        // N s_7_2: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_0: const #1u : u8
        let s_9_0: bool = true;
        // D s_9_1: write-var gs#171182 <= s_9_0
        fn_state.gs_171182 = s_9_0;
        // N s_9_2: jump b3
        return block_3(state, tracer, fn_state);
    }
