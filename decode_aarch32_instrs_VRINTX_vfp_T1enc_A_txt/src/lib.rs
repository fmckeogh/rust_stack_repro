...
use InITBlock::*;
use common::*;
pub fn decode_aarch32_instrs_VRINTX_vfp_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    Vd: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var gs#325689 <= s_4_0
        fn_state.gs_325689 = s_4_0;
        // N s_4_2: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#325689:u8
        let s_5_0: bool = fn_state.gs_325689;
        // D s_5_1: write-var gs#325690 <= s_5_0
        fn_state.gs_325690 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#325690:u8
        let s_6_0: bool = fn_state.gs_325690;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#325691 <= s_8_0
        fn_state.gs_325691 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#325691:u8
        let s_9_0: bool = fn_state.gs_325691;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_2: write-var gs#325691 <= s_19_1
        fn_state.gs_325691 = s_19_1;
        // N s_19_3: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_3: write-var gs#325689 <= s_21_2
        fn_state.gs_325689 = s_21_2;
        // N s_21_4: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#325690 <= s_22_0
        fn_state.gs_325690 = s_22_0;
        // N s_22_2: jump b6
        return block_6(state, tracer, fn_state);
    }
}
