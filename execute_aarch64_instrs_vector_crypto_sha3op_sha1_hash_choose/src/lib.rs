...
use Elem_read::*;
use common::*;
pub fn execute_aarch64_instrs_vector_crypto_sha3op_sha1_hash_choose<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_17: write-var w <= s_1_16
        fn_state.w = s_1_16;
        // C s_1_18: const #0s : i64
        let s_1_18: i64 = 0;
        // D s_1_19: write-var e <= s_1_18
        fn_state.e = s_1_18;
        // N s_1_20: jump b2
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_27: call SHAchoose(s_3_8, s_3_17, s_3_26)
        let s_3_27: u32 = SHAchoose(state, tracer, s_3_8, s_3_17, s_3_26);
        // C s_3_28: const #0s : i
        let s_3_28: i128 = 0;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_3: read-var x:u128
        let s_4_3: u128 = fn_state.x;
