...
use common::*;
pub fn decode_aarch32_instrs_LDMDB_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    W: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_5: write-var gs#296926 <= s_3_4
        fn_state.gs_296926 = s_3_4;
        // N s_3_6: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#296926:u8
        let s_4_0: bool = fn_state.gs_296926;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#296928 <= s_6_0
        fn_state.gs_296928 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#296928:u8
        let s_7_0: bool = fn_state.gs_296928;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_3: call execute_aarch32_instrs_LDMDB_Op_A_txt(s_8_0, s_8_1, s_8_2)
        let s_8_3: () = execute_aarch32_instrs_LDMDB_Op_A_txt(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_23: write-var gs#296928 <= s_10_22
        fn_state.gs_296928 = s_10_22;
        // N s_10_24: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#296926 <= s_12_0
        fn_state.gs_296926 = s_12_0;
        // N s_12_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
