...
use X_read::*;
use common::*;
pub fn SSBS_SysRegWrite_9913e9eaee3498e8<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_21: const #16992u : u32
        let s_5_21: u32 = 16992;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_21: const #16992u : u32
        let s_6_21: u32 = 16992;
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_21: const #16992u : u32
        let s_7_21: u32 = 16992;
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_6: u64 = 1;
        // D s_8_7: bit-extract s_8_5 s_8_4 s_8_6
        ...
        // C s_8_9: const #0s : i
        let s_8_9: i128 = 0;
        // C s_8_10: const #0u : u64
        let s_8_10: u64 = 0;
        // D s_8_11: cast zx s_8_8 -> u64
        let s_8_11: u64 = (s_8_8 as u64);
        // C s_8_12: const #1u : u64
        let s_8_12: u64 = 1;
        // D s_8_13: and s_8_11 s_8_12
        let s_8_13: u64 = ((s_8_11) & (s_8_12));
        // D s_8_14: cmp-eq s_8_13 s_8_12
        let s_8_14: bool = ((s_8_13) == (s_8_12));
        // D s_8_15: lsl s_8_11 s_8_9
        let s_8_15: u64 = s_8_11 << s_8_9;
        // D s_8_16: or s_8_10 s_8_15
        let s_8_16: u64 = ((s_8_10) | (s_8_15));
        // D s_8_17: cmpl s_8_15
        let s_8_17: u64 = !s_8_15;
        // D s_8_18: and s_8_10 s_8_17
        let s_8_18: u64 = ((s_8_10) & (s_8_17));
        // D s_8_19: select s_8_14 s_8_16 s_8_18
        let s_8_19: u64 = if s_8_14 { s_8_16 } else { s_8_18 };
        // D s_8_20: cast trunc s_8_19 -> u8
        let s_8_20: bool = ((s_8_19) != 0);
        // C s_8_21: const #16992u : u32
        let s_8_21: u32 = 16992;
        // N s_8_22: write-reg s_8_21 <= s_8_20
        let s_8_22: () = {
            state.write_register::<bool>(s_8_21 as isize, s_8_20);
            tracer.write_register(s_8_21 as isize, s_8_20);
        };
        // N s_8_23: return
        return;
    }
