...
use HaveSME::*;
use CurrentVL_read::*;
use execute_SPLICE_Z_P_ZZ_Des::*;
use common::*;
pub fn decode_SPLICE_Z_P_ZZ_Des<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Pv: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#196336 <= s_1_0
        fn_state.gs_196336 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#196336:u8
        let s_2_0: bool = fn_state.gs_196336;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_7: read-var Pv:u8
        let s_3_7: u8 = fn_state.Pv;
        ...
        // D s_3_11: write-var v <= s_3_10
        fn_state.v = s_3_10;
        // D s_3_12: read-var Zdn:u8
        let s_3_12: u8 = fn_state.Zdn;
        ...
        // D s_3_16: write-var dst <= s_3_15
        fn_state.dst = s_3_15;
        // D s_3_17: read-var dst:i64
        let s_3_17: i64 = fn_state.dst;
        // D s_3_18: write-var s1 <= s_3_17
        fn_state.s1 = s_3_17;
        // D s_3_19: read-var Zm:u8
        let s_3_19: u8 = fn_state.Zm;
        ...
        // D s_3_23: write-var s2 <= s_3_22
        fn_state.s2 = s_3_22;
        // D s_3_24: read-var VL:i64
        let s_3_24: i64 = fn_state.VL;
        // C s_3_25: const #128s : i
        let s_3_25: i128 = 128;
        // D s_3_26: cast zx s_3_24 -> i
        let s_3_26: i128 = (i128::try_from(s_3_24).unwrap());
        // D s_3_27: cmp-eq s_3_26 s_3_25
        let s_3_27: bool = ((s_3_26) == (s_3_25));
        // D s_3_28: not s_3_27
        let s_3_28: bool = !s_3_27;
        // N s_3_29: branch s_3_28 b5 b4
        if s_3_28 {
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: read-var dst:i64
        let s_4_4: i64 = fn_state.dst;
        // D s_4_5: read-var s1:i64
        let s_4_5: i64 = fn_state.s1;
        // D s_4_6: read-var s2:i64
        let s_4_6: i64 = fn_state.s2;
        // D s_4_7: read-var v:i64
        let s_4_7: i64 = fn_state.v;
        // D s_4_8: call execute_SPLICE_Z_P_ZZ_Des(s_4_0, s_4_4, s_4_3, s_4_5, s_4_6, s_4_7)
        let s_4_8: () = execute_SPLICE_Z_P_ZZ_Des(
            state,
            tracer,
            s_4_0,
            s_4_4,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: read-var dst:i64
        let s_6_4: i64 = fn_state.dst;
        // D s_6_5: read-var s1:i64
        let s_6_5: i64 = fn_state.s1;
        // D s_6_6: read-var s2:i64
        let s_6_6: i64 = fn_state.s2;
        // D s_6_7: read-var v:i64
        let s_6_7: i64 = fn_state.v;
        // D s_6_8: call execute_SPLICE_Z_P_ZZ_Des(s_6_0, s_6_4, s_6_3, s_6_5, s_6_6, s_6_7)
        let s_6_8: () = execute_SPLICE_Z_P_ZZ_Des(
            state,
            tracer,
            s_6_0,
            s_6_4,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: read-var dst:i64
        let s_8_4: i64 = fn_state.dst;
        // D s_8_5: read-var s1:i64
        let s_8_5: i64 = fn_state.s1;
        // D s_8_6: read-var s2:i64
        let s_8_6: i64 = fn_state.s2;
        // D s_8_7: read-var v:i64
        let s_8_7: i64 = fn_state.v;
        // D s_8_8: call execute_SPLICE_Z_P_ZZ_Des(s_8_0, s_8_4, s_8_3, s_8_5, s_8_6, s_8_7)
        let s_8_8: () = execute_SPLICE_Z_P_ZZ_Des(
            state,
            tracer,
            s_8_0,
            s_8_4,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: read-var dst:i64
        let s_10_4: i64 = fn_state.dst;
        // D s_10_5: read-var s1:i64
        let s_10_5: i64 = fn_state.s1;
        // D s_10_6: read-var s2:i64
        let s_10_6: i64 = fn_state.s2;
        // D s_10_7: read-var v:i64
        let s_10_7: i64 = fn_state.v;
        // D s_10_8: call execute_SPLICE_Z_P_ZZ_Des(s_10_0, s_10_4, s_10_3, s_10_5, s_10_6, s_10_7)
        let s_10_8: () = execute_SPLICE_Z_P_ZZ_Des(
            state,
            tracer,
            s_10_0,
            s_10_4,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_4: read-var dst:i64
        let s_12_4: i64 = fn_state.dst;
        // D s_12_5: read-var s1:i64
        let s_12_5: i64 = fn_state.s1;
        // D s_12_6: read-var s2:i64
        let s_12_6: i64 = fn_state.s2;
        // D s_12_7: read-var v:i64
        let s_12_7: i64 = fn_state.v;
        // D s_12_8: call execute_SPLICE_Z_P_ZZ_Des(s_12_0, s_12_4, s_12_3, s_12_5, s_12_6, s_12_7)
        let s_12_8: () = execute_SPLICE_Z_P_ZZ_Des(
            state,
            tracer,
            s_12_0,
            s_12_4,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#196336 <= s_15_2
        fn_state.gs_196336 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
