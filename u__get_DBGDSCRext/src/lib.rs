...
use common::*;
pub fn u__get_DBGDSCRext<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #319819650u : u32
        let s_0_3: u32 = 319819650;
        ...
        // D s_0_11: tail-call Mk_DBGDSCRext_Type(s_0_10)
        return Mk_DBGDSCRext_Type(state, tracer, s_0_10);
    }
}
