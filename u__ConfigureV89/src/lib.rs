...
use u__ConfigureV88::*;
use common::*;
pub fn u__ConfigureV89<T: Tracer>(state: &mut State, tracer: &T, enabled: bool) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_1: const #101856u : u32
        let s_0_1: u32 = 101856;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: call __ConfigureV88(s_2_0)
        let s_2_1: () = u__ConfigureV88(state, tracer, s_2_0);
        // N s_2_2: return
        return;
    }
}
