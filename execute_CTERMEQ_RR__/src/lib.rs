...
use X_read::*;
use common::*;
pub fn execute_CTERMEQ_RR__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    esize: i64,
    m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#2776 <= s_0_2
        fn_state.esizeshadow_2776 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var esizeshadow#2776:i64
        let s_1_0: i64 = fn_state.esizeshadow_2776;
        ...
        // D s_1_6: read-var esizeshadow#2776:i64
        let s_1_6: i64 = fn_state.esizeshadow_2776;
