...
use AArch64_TLBI_VA::*;
use common::*;
pub fn TLBI_VALE3OS_SysOpsWrite_af6269968bb4ec2c<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_7: u32 = 0;
        // C s_5_8: const #1080u : u32
        let s_5_8: u32 = 1080;
        // D s_5_9: read-reg s_5_8:u16
        let s_5_9: u16 = {
            let value = state.read_register::<u16>(s_5_8 as isize);
            tracer.read_register(s_5_8 as isize, value);
            value
        };
        // C s_5_10: const #2u : u32
        let s_5_10: u32 = 2;
        // C s_5_11: const #1u : u32
        let s_5_11: u32 = 1;
        // C s_5_12: const #0u : u32
        let s_5_12: u32 = 0;
        // D s_5_13: call AArch64_TLBI_VA(s_5_2, s_5_7, s_5_9, s_5_10, s_5_11, s_5_12, s_5_6)
        let s_5_13: () = AArch64_TLBI_VA(
            state,
            tracer,
            s_5_2,
            s_5_7,
