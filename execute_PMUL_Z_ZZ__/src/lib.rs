...
use Z_set::*;
use common::*;
pub fn execute_PMUL_Z_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#3716 <= s_0_2
        fn_state.VLshadow_3716 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#3716:i64
        let s_1_0: i64 = fn_state.VLshadow_3716;
        // D s_1_1: write-var VLshadow#3717 <= s_1_0
        fn_state.VLshadow_3717 = s_1_0;
        // D s_1_2: read-var VLshadow#3717:i64
        let s_1_2: i64 = fn_state.VLshadow_3717;
        ...
        // D s_1_8: read-var VLshadow#3717:i64
        let s_1_8: i64 = fn_state.VLshadow_3717;
        ...
        // D s_1_16: read-var VLshadow#3717:i64
        let s_1_16: i64 = fn_state.VLshadow_3717;
        ...
        // D s_1_29: write-var gs#207697 <= s_1_28
        fn_state.gs_207697 = s_1_28;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#207697:i64
        let s_2_1: i64 = fn_state.gs_207697;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_19: call PolynomialMult(s_3_7, s_3_15)
        let s_3_19: Bits = PolynomialMult(state, tracer, s_3_7, s_3_15);
        // C s_3_20: const #0s : i
        let s_3_20: i128 = 0;
        // C s_3_21: const #8s : i
        let s_3_21: i128 = 8;
        // D s_3_22: bit-extract s_3_19 s_3_20 s_3_21
        ...
        // D s_3_27: cast zx s_3_23 -> bv
        let s_3_27: Bits = Bits::new(s_3_23 as u128, 8u16);
        // D s_3_28: read-var result:bv
        let s_3_28: Bits = fn_state.result;
        // D s_3_29: call Elem_set(s_3_28, s_3_25, s_3_26, s_3_27)
        let s_3_29: Bits = Elem_set(state, tracer, s_3_28, s_3_25, s_3_26, s_3_27);
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#3717:i64
        let s_4_0: i64 = fn_state.VLshadow_3717;
