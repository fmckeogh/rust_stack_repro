...
use common::*;
pub fn ICH_LR_EL2_SysRegWrite_ada04edc200eb7de<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#86368 <= s_12_0
        fn_state.gs_86368 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#86368:u8
        let s_13_0: bool = fn_state.gs_86368;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#86369 <= s_15_0
        fn_state.gs_86369 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#86369:u8
        let s_16_0: bool = fn_state.gs_86369;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_5: write-var gs#86369 <= s_19_4
        fn_state.gs_86369 = s_19_4;
        // N s_19_6: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_21: write-var gs#86368 <= s_21_20
        fn_state.gs_86368 = s_21_20;
        // N s_21_22: jump b13
        return block_13(state, tracer, fn_state);
    }
