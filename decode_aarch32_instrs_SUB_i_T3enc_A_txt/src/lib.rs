...
use T32ExpandImm::*;
use common::*;
pub fn decode_aarch32_instrs_SUB_i_T3enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i: bool,
    S: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#303167 <= s_3_0
        fn_state.gs_303167 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#303167:u8
        let s_4_0: bool = fn_state.gs_303167;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#303173 <= s_7_0
        fn_state.gs_303173 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#303173:u8
        let s_8_0: bool = fn_state.gs_303173;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_4: write-var gs#303175 <= s_9_3
        fn_state.gs_303175 = s_9_3;
        // N s_9_5: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#303175:u8
        let s_10_0: bool = fn_state.gs_303175;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_4: call execute_aarch32_instrs_SUB_i_Op_A_txt(s_11_0, s_11_1, s_11_2, s_11_3)
        let s_11_4: () = execute_aarch32_instrs_SUB_i_Op_A_txt(
            state,
            tracer,
            s_11_0,
            s_11_1,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#303175 <= s_13_0
        fn_state.gs_303175 = s_13_0;
        // N s_13_2: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_14<T: Tracer>(
        ...
        // D s_14_2: write-var gs#303173 <= s_14_1
        fn_state.gs_303173 = s_14_1;
        // N s_14_3: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_5: write-var gs#303167 <= s_17_4
        fn_state.gs_303167 = s_17_4;
        // N s_17_6: jump b4
        return block_4(state, tracer, fn_state);
    }
}
