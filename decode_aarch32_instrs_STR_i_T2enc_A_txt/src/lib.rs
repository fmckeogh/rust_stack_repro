...
use common::*;
pub fn decode_aarch32_instrs_STR_i_T2enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    imm8: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_16: call execute_aarch32_instrs_STR_i_OpT_A_txt(s_2_14, s_2_12, s_2_13, s_2_4, s_2_3, s_2_15)
        let s_2_16: () = execute_aarch32_instrs_STR_i_OpT_A_txt(
            state,
            tracer,
            s_2_14,
            s_2_12,
