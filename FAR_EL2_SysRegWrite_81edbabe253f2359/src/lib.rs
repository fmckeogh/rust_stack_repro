...
use common::*;
pub fn FAR_EL2_SysRegWrite_81edbabe253f2359<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_4: const #102616u : u32
        let s_5_4: u32 = 102616;
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_4: const #102616u : u32
        let s_6_4: u32 = 102616;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#85424 <= s_8_0
        fn_state.gs_85424 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#85424:u8
        let s_9_0: bool = fn_state.gs_85424;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#85425 <= s_11_0
        fn_state.gs_85425 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#85425:u8
        let s_12_0: bool = fn_state.gs_85425;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_5: write-var gs#85425 <= s_15_4
        fn_state.gs_85425 = s_15_4;
        // N s_15_6: jump b12
        return block_12(state, tracer, fn_state);
    }
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_21: write-var gs#85424 <= s_17_20
        fn_state.gs_85424 = s_17_20;
        // N s_17_22: jump b9
        return block_9(state, tracer, fn_state);
    }
