...
pub fn PRRR_read<T: Tracer>(
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#27467 <= s_1_0
        fn_state.gs_27467 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#27467:u8
        let s_2_0: bool = fn_state.gs_27467;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_0: const #() : ()
        let s_3_0: () = ();
        // S s_3_1: call PRRR_NS_read(s_3_0)
        let s_3_1: ProductType700c18a878c5601b = PRRR_NS_read(state, tracer, s_3_0);
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: write-var gs#27467 <= s_6_3
        fn_state.gs_27467 = s_6_3;
        // N s_6_5: jump b2
        return block_2(state, tracer, fn_state);
    }
}
