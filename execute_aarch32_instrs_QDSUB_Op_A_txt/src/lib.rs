...
use R_read::*;
use common::*;
pub fn execute_aarch32_instrs_QDSUB_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        gs_882433: ProductTypef506aa96a892fe52,
        gs_882445: ProductTypef506aa96a892fe52,
        sat2: bool,
        gs_299586: bool,
        d: i64,
        m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_14: write-var gs#882433 <= s_0_13
        fn_state.gs_882433 = s_0_13;
        // D s_0_15: read-var gs#882433.0:struct
        let s_0_15: Bits = fn_state.gs_882433._0;
        // D s_0_16: cast reint s_0_15 -> u32
        let s_0_16: u32 = (s_0_15.value() as u32);
        // D s_0_17: read-var gs#882433.1:struct
        let s_0_17: bool = fn_state.gs_882433._1;
        ...
        // D s_0_35: write-var gs#882445 <= s_0_34
        fn_state.gs_882445 = s_0_34;
        // D s_0_36: read-var gs#882445.0:struct
        let s_0_36: Bits = fn_state.gs_882445._0;
        // D s_0_37: cast reint s_0_36 -> u32
        let s_0_37: u32 = (s_0_36.value() as u32);
        // D s_0_38: read-var gs#882445.1:struct
        let s_0_38: bool = fn_state.gs_882445._1;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#299586 <= s_1_0
        fn_state.gs_299586 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#299586:u8
        let s_2_0: bool = fn_state.gs_299586;
    ...
    fn block_5<T: Tracer>(
        ...
        // C s_5_0: const #1u : u8
        let s_5_0: bool = true;
        // D s_5_1: write-var gs#299586 <= s_5_0
        fn_state.gs_299586 = s_5_0;
        // N s_5_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
