...
extern crate alloc;
use CurrentSVL_read::*;
use execute_LDR_ZA_RI__::*;
use HaveSME::*;
use common::*;
pub fn decode_LDR_ZA_RI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rv: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_7: read-var Rv:u8
        let s_1_7: u8 = fn_state.Rv;
        ...
        // D s_1_21: write-var v <= s_1_20
        fn_state.v = s_1_20;
        // D s_1_22: read-var off4:u8
        let s_1_22: u8 = fn_state.off4;
        ...
        // D s_1_26: write-var offset <= s_1_25
        fn_state.offset = s_1_25;
        // D s_1_27: read-var SVL:i64
        let s_1_27: i64 = fn_state.SVL;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_2: read-var offset:i64
        let s_2_2: i64 = fn_state.offset;
        // D s_2_3: read-var v:i64
        let s_2_3: i64 = fn_state.v;
        // D s_2_4: call execute_LDR_ZA_RI__(s_2_0, s_2_1, s_2_2, s_2_3)
        let s_2_4: () = execute_LDR_ZA_RI__(state, tracer, s_2_0, s_2_1, s_2_2, s_2_3);
        // N s_2_5: return
        return;
    }
    fn block_3<T: Tracer>(
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_2: read-var offset:i64
        let s_4_2: i64 = fn_state.offset;
        // D s_4_3: read-var v:i64
        let s_4_3: i64 = fn_state.v;
        // D s_4_4: call execute_LDR_ZA_RI__(s_4_0, s_4_1, s_4_2, s_4_3)
        let s_4_4: () = execute_LDR_ZA_RI__(state, tracer, s_4_0, s_4_1, s_4_2, s_4_3);
        // N s_4_5: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: read-var offset:i64
        let s_6_2: i64 = fn_state.offset;
        // D s_6_3: read-var v:i64
        let s_6_3: i64 = fn_state.v;
        // D s_6_4: call execute_LDR_ZA_RI__(s_6_0, s_6_1, s_6_2, s_6_3)
        let s_6_4: () = execute_LDR_ZA_RI__(state, tracer, s_6_0, s_6_1, s_6_2, s_6_3);
        // N s_6_5: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_2: read-var offset:i64
        let s_8_2: i64 = fn_state.offset;
        // D s_8_3: read-var v:i64
        let s_8_3: i64 = fn_state.v;
        // D s_8_4: call execute_LDR_ZA_RI__(s_8_0, s_8_1, s_8_2, s_8_3)
        let s_8_4: () = execute_LDR_ZA_RI__(state, tracer, s_8_0, s_8_1, s_8_2, s_8_3);
        // N s_8_5: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_2: read-var offset:i64
        let s_10_2: i64 = fn_state.offset;
        // D s_10_3: read-var v:i64
        let s_10_3: i64 = fn_state.v;
        // D s_10_4: call execute_LDR_ZA_RI__(s_10_0, s_10_1, s_10_2, s_10_3)
        let s_10_4: () = execute_LDR_ZA_RI__(
            state,
            tracer,
            s_10_0,
            s_10_1,
