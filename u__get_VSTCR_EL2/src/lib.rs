...
use common::*;
pub fn u__get_VSTCR_EL2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #18446744061361471232u : u64
        let s_0_3: u64 = 18446744061361471232;
        ...
        // D s_0_20: tail-call Mk_VSTCR_EL2_Type(s_0_19)
        return Mk_VSTCR_EL2_Type(state, tracer, s_0_19);
    }
}
