...
use neq_int::*;
use HaveFeatLS64::*;
use execute_aarch64_instrs_memory_atomicops_st_acc_st64b::*;
use common::*;
pub fn decode_st64b_aarch64_instrs_memory_atomicops_st_acc_st64b<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    Rn: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_0: const #() : ()
        let s_0_0: () = ();
        // S s_0_1: call HaveFeatLS64(s_0_0)
        let s_0_1: bool = HaveFeatLS64(state, tracer, s_0_0);
        // S s_0_2: not s_0_1
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_22: write-var gs#173076 <= s_2_21
        fn_state.gs_173076 = s_2_21;
        // N s_2_23: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#173076:u8
        let s_3_0: bool = fn_state.gs_173076;
    ...
    fn block_4<T: Tracer>(
        ...
        // C s_4_9: const #31s : i
        let s_4_9: i128 = 31;
        // D s_4_10: cast zx s_4_3 -> i
        let s_4_10: i128 = (i128::try_from(s_4_3).unwrap());
        // D s_4_11: call neq_int(s_4_10, s_4_9)
        let s_4_11: bool = neq_int(state, tracer, s_4_10, s_4_9);
        // C s_4_12: const #1208u : u32
        let s_4_12: u32 = 1208;
        ...
        // D s_4_14: call execute_aarch64_instrs_memory_atomicops_st_acc_st64b(s_4_13, s_4_8, s_4_3, s_4_7, s_4_11)
        let s_4_14: () = execute_aarch64_instrs_memory_atomicops_st_acc_st64b(
            state,
            tracer,
            s_4_13,
            s_4_8,
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_0: const #1u : u8
        let s_6_0: bool = true;
        // D s_6_1: write-var gs#173076 <= s_6_0
        fn_state.gs_173076 = s_6_0;
        // N s_6_2: jump b3
        return block_3(state, tracer, fn_state);
    }
    fn block_7<T: Tracer>(
