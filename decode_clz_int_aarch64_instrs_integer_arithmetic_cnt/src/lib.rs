...
extern crate alloc;
use execute_aarch64_instrs_integer_arithmetic_cnt::*;
use common::*;
pub fn decode_clz_int_aarch64_instrs_integer_arithmetic_cnt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 32;
        // D s_1_1: write-var ga#251101 <= s_1_0
        fn_state.ga_251101 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#251101:i64
        let s_2_0: i64 = fn_state.ga_251101;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_5: read-var opcode:u32
        let s_4_5: u32 = fn_state.opcode;
        // D s_4_6: call execute_aarch64_instrs_integer_arithmetic_cnt(s_4_3, s_4_2, s_4_4, s_4_5)
        let s_4_6: () = execute_aarch64_instrs_integer_arithmetic_cnt(
            state,
            tracer,
            s_4_3,
            s_4_2,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: u32 = 0;
        // D s_5_1: write-var opcode <= s_5_0
        fn_state.opcode = s_5_0;
        // N s_5_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 64;
        // D s_6_1: write-var ga#251101 <= s_6_0
        fn_state.ga_251101 = s_6_0;
        // N s_6_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
