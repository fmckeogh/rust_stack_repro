...
use HaveTME::*;
use common::*;
pub fn CreateAccDescSVEFF<T: Tracer>(
    state: &mut State,
    tracer: &T,
    contiguous: bool,
    tagchecked: bool,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_7: const #1u : u8
        let s_0_7: bool = true;
        // D s_0_8: write-var accdesc.11 <= s_0_7
        fn_state.accdesc._11 = s_0_7;
        // C s_0_9: const #1u : u8
        let s_0_9: bool = true;
        // D s_0_10: write-var accdesc.10 <= s_0_9
        fn_state.accdesc._10 = s_0_9;
        // D s_0_11: read-var contiguous:u8
        let s_0_11: bool = fn_state.contiguous;
        // D s_0_12: write-var accdesc.7 <= s_0_11
        fn_state.accdesc._7 = s_0_11;
        // C s_0_13: const #() : ()
        let s_0_13: () = ();
        // S s_0_14: call InStreamingMode(s_0_13)
        let s_0_14: bool = InStreamingMode(state, tracer, s_0_13);
        // D s_0_15: write-var accdesc.26 <= s_0_14
        fn_state.accdesc._26 = s_0_14;
        // D s_0_16: read-var accdesc.26:struct
        let s_0_16: bool = fn_state.accdesc._26;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#7365 <= s_1_0
        fn_state.gs_7365 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#7365:u8
        let s_2_0: bool = fn_state.gs_7365;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#7367 <= s_5_0
        fn_state.gs_7367 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#7367:u8
        let s_6_0: bool = fn_state.gs_7367;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_4: write-var gs#7367 <= s_7_3
        fn_state.gs_7367 = s_7_3;
        // N s_7_5: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_8<T: Tracer>(
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_2: write-var gs#7365 <= s_9_1
        fn_state.gs_7365 = s_9_1;
        // N s_9_3: jump b2
        return block_2(state, tracer, fn_state);
    }
}
