...
extern crate alloc;
use common::*;
pub fn DLR_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #13360u : u32
        let s_0_23: u32 = 13360;
        ...
        // C s_0_25: const #21992u : u32
        let s_0_25: u32 = 21992;
