...
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_binary_uniform_add_wrapping_single_sisd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    struct FunctionState {
        datasizeshadow_1022: i64,
        element2: Bits,
        e: i64,
        element1: Bits,
        esizeshadow_1021: i64,
        result: Bits,
        operand1: Bits,
        gs_142811: i64,
        operand2: Bits,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#1021 <= s_0_2
        fn_state.esizeshadow_1021 = s_0_2;
        ...
        // D s_0_7: write-var datasizeshadow#1022 <= s_0_6
        fn_state.datasizeshadow_1022 = s_0_6;
        // C s_0_8: const #() : ()
        let s_0_8: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var datasizeshadow#1022:i64
        let s_1_0: i64 = fn_state.datasizeshadow_1022;
        ...
        // D s_1_7: read-var datasizeshadow#1022:i64
        let s_1_7: i64 = fn_state.datasizeshadow_1022;
        ...
        // D s_1_19: write-var gs#142811 <= s_1_18
        fn_state.gs_142811 = s_1_18;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#142811:i64
        let s_2_1: i64 = fn_state.gs_142811;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var esizeshadow#1021:i64
        let s_3_0: i64 = fn_state.esizeshadow_1021;
        ...
        // D s_3_9: read-var esizeshadow#1021:i64
        let s_3_9: i64 = fn_state.esizeshadow_1021;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var esizeshadow#1021:i64
        let s_4_0: i64 = fn_state.esizeshadow_1021;
        // D s_4_1: cast zx s_4_0 -> i
        let s_4_1: i128 = (i128::try_from(s_4_0).unwrap());
        // D s_4_2: cast reint s_4_1 -> i64
        let s_4_2: i64 = (s_4_1 as i64);
        // D s_4_3: read-var element1:bv
        let s_4_3: Bits = fn_state.element1;
        // D s_4_4: read-var element2:bv
        let s_4_4: Bits = fn_state.element2;
        // D s_4_5: add s_4_3 s_4_4
        let s_4_5: Bits = (s_4_3 + s_4_4);
        ...
        // D s_4_10: call Elem_set(s_4_9, s_4_7, s_4_8, s_4_5)
        let s_4_10: Bits = Elem_set(state, tracer, s_4_9, s_4_7, s_4_8, s_4_5);
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var esizeshadow#1021:i64
        let s_6_0: i64 = fn_state.esizeshadow_1021;
        ...
        // D s_6_4: read-var element2:bv
        let s_6_4: Bits = fn_state.element2;
        // D s_6_5: sub s_6_3 s_6_4
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var datasizeshadow#1022:i64
        let s_7_0: i64 = fn_state.datasizeshadow_1022;
