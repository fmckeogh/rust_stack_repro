...
use HaveFeatXS::*;
use common::*;
pub fn decode_dsb_aarch64_instrs_system_barriers_dsb_nxs<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm2: u8,
) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var imm2:u8
        let s_1_0: u8 = fn_state.imm2;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var imm2:u8
        let s_5_0: u8 = fn_state.imm2;
