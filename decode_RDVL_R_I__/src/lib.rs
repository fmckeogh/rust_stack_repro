...
use HaveSME::*;
use CurrentVL_read::*;
use execute_RDVL_R_I__::*;
use common::*;
pub fn decode_RDVL_R_I__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    imm6: u8,
    Rd: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#199110 <= s_1_0
        fn_state.gs_199110 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#199110:u8
        let s_2_0: bool = fn_state.gs_199110;
    ...
    fn block_3<T: Tracer>(
        ...
        fn_state.d = s_3_3;
        // D s_3_5: read-var imm6:u8
        let s_3_5: u8 = fn_state.imm6;
        // D s_3_6: cast zx s_3_5 -> bv
        let s_3_6: Bits = Bits::new(s_3_5 as u128, 6u16);
        // D s_3_7: cast sx s_3_6 -> i
        let s_3_7: i128 = {
            let sign_bit = s_3_6.length() - 1;
            let mut result = s_3_6.value() as i128;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: call execute_RDVL_R_I__(s_4_0, s_4_3, s_4_2)
        let s_4_4: () = execute_RDVL_R_I__(state, tracer, s_4_0, s_4_3, s_4_2);
        // N s_4_5: return
        return;
    }
    fn block_5<T: Tracer>(
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: call execute_RDVL_R_I__(s_6_0, s_6_3, s_6_2)
        let s_6_4: () = execute_RDVL_R_I__(state, tracer, s_6_0, s_6_3, s_6_2);
        // N s_6_5: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: call execute_RDVL_R_I__(s_8_0, s_8_3, s_8_2)
        let s_8_4: () = execute_RDVL_R_I__(state, tracer, s_8_0, s_8_3, s_8_2);
        // N s_8_5: return
        return;
    }
    fn block_9<T: Tracer>(
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: call execute_RDVL_R_I__(s_10_0, s_10_3, s_10_2)
        let s_10_4: () = execute_RDVL_R_I__(state, tracer, s_10_0, s_10_3, s_10_2);
        // N s_10_5: return
        return;
    }
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_4: call execute_RDVL_R_I__(s_12_0, s_12_3, s_12_2)
        let s_12_4: () = execute_RDVL_R_I__(state, tracer, s_12_0, s_12_3, s_12_2);
        // N s_12_5: return
        return;
    }
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#199110 <= s_15_2
        fn_state.gs_199110 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
