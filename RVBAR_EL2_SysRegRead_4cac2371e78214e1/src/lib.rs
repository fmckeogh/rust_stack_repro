...
use common::*;
pub fn RVBAR_EL2_SysRegRead_4cac2371e78214e1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#69092 <= s_1_0
        fn_state.gs_69092 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#69092:u8
        let s_2_0: bool = fn_state.gs_69092;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#69093 <= s_3_0
        fn_state.gs_69093 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#69093:u8
        let s_4_0: bool = fn_state.gs_69093;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#69094 <= s_5_0
        fn_state.gs_69094 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#69094:u8
        let s_6_0: bool = fn_state.gs_69094;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#69095 <= s_8_0
        fn_state.gs_69095 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#69095:u8
        let s_9_0: bool = fn_state.gs_69095;
    ...
    fn block_11<T: Tracer>(
        ...
        let s_11_0: i64 = 64;
        // C s_11_1: const #89592u : u32
        let s_11_1: u32 = 89592;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_3: write-var gs#69095 <= s_12_2
        fn_state.gs_69095 = s_12_2;
        // N s_12_4: jump b9
        return block_9(state, tracer, fn_state);
    }
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_5: write-var gs#69094 <= s_14_4
        fn_state.gs_69094 = s_14_4;
        // N s_14_6: jump b6
        return block_6(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#69093 <= s_15_2
        fn_state.gs_69093 = s_15_2;
        // N s_15_4: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_16<T: Tracer>(
        ...
        // D s_16_2: write-var gs#69092 <= s_16_1
        fn_state.gs_69092 = s_16_1;
        // N s_16_3: jump b2
        return block_2(state, tracer, fn_state);
    }
}
