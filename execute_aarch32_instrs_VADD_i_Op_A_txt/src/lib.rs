...
use D_read::*;
use common::*;
pub fn execute_aarch32_instrs_VADD_i_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d__arg: i64,
    elements: i128,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#7363 <= s_0_2
        fn_state.esizeshadow_7363 = s_0_2;
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_6: write-var gs#306323 <= s_1_5
        fn_state.gs_306323 = s_1_5;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#306323:i64
        let s_2_1: i64 = fn_state.gs_306323;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_5: write-var gs#306329 <= s_3_4
        fn_state.gs_306329 = s_3_4;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#306329:i64
        let s_4_1: i64 = fn_state.gs_306329;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_9: read-var esizeshadow#7363:i64
        let s_5_9: i64 = fn_state.esizeshadow_7363;
        ...
        // D s_5_20: read-var esizeshadow#7363:i64
        let s_5_20: i64 = fn_state.esizeshadow_7363;
        ...
        // D s_5_28: read-var m:i64
        let s_5_28: i64 = fn_state.m;
        ...
        // D s_5_35: call D_read(s_5_34)
        let s_5_35: u64 = D_read(state, tracer, s_5_34);
        // D s_5_36: read-var esizeshadow#7363:i64
        let s_5_36: i64 = fn_state.esizeshadow_7363;
        ...
        // D s_5_39: cast zx s_5_35 -> bv
        let s_5_39: Bits = Bits::new(s_5_35 as u128, 64u16);
        // D s_5_40: read-var e:i64
        let s_5_40: i64 = fn_state.e;
        // D s_5_41: cast zx s_5_40 -> i
        let s_5_41: i128 = (i128::try_from(s_5_40).unwrap());
        // D s_5_42: cast zx s_5_38 -> i
        let s_5_42: i128 = (i128::try_from(s_5_38).unwrap());
        // D s_5_43: call Elem_read(s_5_39, s_5_41, s_5_42)
        let s_5_43: Bits = Elem_read(state, tracer, s_5_39, s_5_41, s_5_42);
        // D s_5_44: add s_5_27 s_5_43
        let s_5_44: Bits = (s_5_27 + s_5_43);
        // D s_5_45: cast zx s_5_8 -> bv
        let s_5_45: Bits = Bits::new(s_5_8 as u128, 64u16);
        // D s_5_46: read-var e:i64
        let s_5_46: i64 = fn_state.e;
        // D s_5_47: cast zx s_5_46 -> i
        let s_5_47: i128 = (i128::try_from(s_5_46).unwrap());
        // D s_5_48: cast zx s_5_11 -> i
        let s_5_48: i128 = (i128::try_from(s_5_11).unwrap());
        // D s_5_49: call Elem_set(s_5_45, s_5_47, s_5_48, s_5_44)
        let s_5_49: Bits = Elem_set(state, tracer, s_5_45, s_5_47, s_5_48, s_5_44);
        // D s_5_50: cast reint s_5_49 -> u64
        let s_5_50: u64 = (s_5_49.value() as u64);
        // D s_5_51: call D_set(s_5_3, s_5_50)
        let s_5_51: () = D_set(state, tracer, s_5_3, s_5_50);
