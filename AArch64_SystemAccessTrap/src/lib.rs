...
use ThisInstrAddr::*;
use ThisInstr::*;
use AArch64_SystemAccessTrapSyndrome::*;
use AArch64_TakeException::*;
use common::*;
pub fn AArch64_SystemAccessTrap<T: Tracer>(
    state: &mut State,
    tracer: &T,
    target_el: u8,
    ec: i128,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#24895 <= s_1_0
        fn_state.gs_24895 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#24895:u8
        let s_2_0: bool = fn_state.gs_24895;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#24896 <= s_3_0
        fn_state.gs_24896 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#24896:u8
        let s_4_0: bool = fn_state.gs_24896;
        ...
        // D s_4_13: call AArch64_SystemAccessTrapSyndrome(s_4_11, s_4_12)
        let s_4_13: ProductTypeb7f99f96751e17c4 = AArch64_SystemAccessTrapSyndrome(
            state,
            tracer,
            s_4_11,
            s_4_12,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_12: write-var gs#24896 <= s_5_11
        fn_state.gs_24896 = s_5_11;
        // N s_5_13: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_6<T: Tracer>(
        ...
        // D s_6_6: write-var gs#24895 <= s_6_5
        fn_state.gs_24895 = s_6_5;
        // N s_6_7: jump b2
        return block_2(state, tracer, fn_state);
    }
}
