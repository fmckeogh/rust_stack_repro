...
extern crate alloc;
use HaveSHA3Ext::*;
use execute_aarch64_instrs_vector_crypto_sha3_rax1::*;
use common::*;
pub fn decode_rax1_advsimd_aarch64_instrs_vector_crypto_sha3_rax1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_12: call execute_aarch64_instrs_vector_crypto_sha3_rax1(s_1_3, s_1_11, s_1_7)
        let s_1_12: () = execute_aarch64_instrs_vector_crypto_sha3_rax1(
            state,
            tracer,
            s_1_3,
            s_1_11,
