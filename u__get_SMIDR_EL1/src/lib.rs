...
extern crate alloc;
use Mk_SMIDR_EL1_Type::*;
use common::*;
pub fn u__get_SMIDR_EL1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #18446744069414612992u : u64
        let s_0_3: u64 = 18446744069414612992;
        ...
        // D s_0_11: tail-call Mk_SMIDR_EL1_Type(s_0_10)
        return Mk_SMIDR_EL1_Type(state, tracer, s_0_10);
    }
}
