...
use common::*;
pub fn decode_sqrdmlsh_advsimd_elt_aarch64_instrs_vector_arithmetic_binary_element_mul_acc_high_sisd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_0: i64 = 64;
        // D s_2_1: write-var ga#267775 <= s_2_0
        fn_state.ga_267775 = s_2_0;
        // N s_2_2: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var ga#267775:i64
        let s_3_0: i64 = fn_state.ga_267775;
    ...
    fn block_9<T: Tracer>(
        ...
        let s_9_0: i64 = 128;
        // D s_9_1: write-var ga#267775 <= s_9_0
        fn_state.ga_267775 = s_9_0;
        // N s_9_2: jump b3
        return block_3(state, tracer, fn_state);
    }
