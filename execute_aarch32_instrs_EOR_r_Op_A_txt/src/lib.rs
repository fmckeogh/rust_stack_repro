...
use ALUWritePC::*;
use common::*;
pub fn execute_aarch32_instrs_EOR_r_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    m: i64,
    ...
    struct FunctionState {
        gs_878955: ProductTypef506aa96a892fe52,
        carry: bool,
        result: u32,
        d: i64,
        m: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_9: write-var gs#878955 <= s_0_8
        fn_state.gs_878955 = s_0_8;
        // D s_0_10: read-var gs#878955.0:struct
        let s_0_10: Bits = fn_state.gs_878955._0;
        // D s_0_11: cast reint s_0_10 -> u32
        let s_0_11: u32 = (s_0_10.value() as u32);
        // D s_0_12: read-var gs#878955.1:struct
        let s_0_12: bool = fn_state.gs_878955._1;
        ...
        // D s_0_18: cast zx s_0_11 -> bv
        let s_0_18: Bits = Bits::new(s_0_11 as u128, 32u16);
        // D s_0_19: xor s_0_17 s_0_18
        let s_0_19: Bits = ((s_0_17) ^ (s_0_18));
        // D s_0_20: cast reint s_0_19 -> u32
        let s_0_20: u32 = (s_0_19.value() as u32);
        // D s_0_21: write-var result <= s_0_20
