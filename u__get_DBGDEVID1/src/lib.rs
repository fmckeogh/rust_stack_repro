...
extern crate alloc;
use Mk_DBGDEVID1_Type::*;
use common::*;
pub fn u__get_DBGDEVID1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #4294967280u : u32
        let s_0_3: u32 = 4294967280;
        ...
        // D s_0_11: tail-call Mk_DBGDEVID1_Type(s_0_10)
        return Mk_DBGDEVID1_Type(state, tracer, s_0_10);
    }
}
