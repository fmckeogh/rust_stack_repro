...
use HaveSVE::*;
use CurrentVL_read::*;
use execute_FEXPA_Z_Z__::*;
use common::*;
pub fn decode_FEXPA_Z_Z__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    Zn: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        fn_state.d = s_2_15;
        // D s_2_17: read-var VL:i64
        let s_2_17: i64 = fn_state.VL;
        // C s_2_18: const #128s : i
        let s_2_18: i128 = 128;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_6: call execute_FEXPA_Z_Z__(s_3_0, s_3_4, s_3_3, s_3_5)
        let s_3_6: () = execute_FEXPA_Z_Z__(state, tracer, s_3_0, s_3_4, s_3_3, s_3_5);
        // N s_3_7: return
        return;
    }
    fn block_4<T: Tracer>(
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_6: call execute_FEXPA_Z_Z__(s_5_0, s_5_4, s_5_3, s_5_5)
        let s_5_6: () = execute_FEXPA_Z_Z__(state, tracer, s_5_0, s_5_4, s_5_3, s_5_5);
        // N s_5_7: return
        return;
    }
    fn block_6<T: Tracer>(
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_6: call execute_FEXPA_Z_Z__(s_7_0, s_7_4, s_7_3, s_7_5)
        let s_7_6: () = execute_FEXPA_Z_Z__(state, tracer, s_7_0, s_7_4, s_7_3, s_7_5);
        // N s_7_7: return
        return;
    }
    fn block_8<T: Tracer>(
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_6: call execute_FEXPA_Z_Z__(s_9_0, s_9_4, s_9_3, s_9_5)
        let s_9_6: () = execute_FEXPA_Z_Z__(state, tracer, s_9_0, s_9_4, s_9_3, s_9_5);
        // N s_9_7: return
        return;
    }
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_6: call execute_FEXPA_Z_Z__(s_11_0, s_11_4, s_11_3, s_11_5)
        let s_11_6: () = execute_FEXPA_Z_Z__(
            state,
            tracer,
            s_11_0,
            s_11_4,
