...
use common::*;
pub fn u__get_PMUSERENR_EL0<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #18446744073709551488u : u64
        let s_0_3: u64 = 18446744073709551488;
        ...
        // D s_0_11: tail-call Mk_PMUSERENR_EL0_Type(s_0_10)
        return Mk_PMUSERENR_EL0_Type(state, tracer, s_0_10);
    }
}
