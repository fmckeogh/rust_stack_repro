...
use Z_set::*;
use common::*;
pub fn execute_ORR_Z_ZI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    dn: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#2865 <= s_0_2
        fn_state.VLshadow_2865 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#2865:i64
        let s_1_0: i64 = fn_state.VLshadow_2865;
        // D s_1_1: write-var VLshadow#2866 <= s_1_0
        fn_state.VLshadow_2866 = s_1_0;
        // C s_1_2: const #64s : i
        let s_1_2: i128 = 64;
        // D s_1_3: read-var VLshadow#2866:i64
        let s_1_3: i64 = fn_state.VLshadow_2866;
        ...
        // D s_1_7: read-var VLshadow#2866:i64
        let s_1_7: i64 = fn_state.VLshadow_2866;
        ...
        // D s_1_20: write-var gs#194287 <= s_1_19
        fn_state.gs_194287 = s_1_19;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#194287:i64
        let s_2_1: i64 = fn_state.gs_194287;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var VLshadow#2866:i64
        let s_4_0: i64 = fn_state.VLshadow_2866;
