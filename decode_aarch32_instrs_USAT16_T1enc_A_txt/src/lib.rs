...
use common::*;
pub fn decode_aarch32_instrs_USAT16_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rn: u8,
    Rd: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_14: write-var saturate_to <= s_2_13
        fn_state.saturate_to = s_2_13;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_4: write-var gs#305055 <= s_3_3
        fn_state.gs_305055 = s_3_3;
        // N s_3_5: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#305055:u8
        let s_4_0: bool = fn_state.gs_305055;
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #1u : u8
        let s_7_0: bool = true;
        // D s_7_1: write-var gs#305055 <= s_7_0
        fn_state.gs_305055 = s_7_0;
        // N s_7_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
