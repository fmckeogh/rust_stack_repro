...
use common::*;
pub fn decode_aarch32_instrs_LDR_l_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rt: u8,
    imm8: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_13: call execute_aarch32_instrs_LDR_l_Op_A_txt(s_2_12, s_2_11, s_2_3)
        let s_2_13: () = execute_aarch32_instrs_LDR_l_Op_A_txt(
            state,
            tracer,
            s_2_12,
            s_2_11,
