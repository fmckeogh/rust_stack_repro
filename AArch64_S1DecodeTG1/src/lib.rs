...
use common::*;
pub fn AArch64_S1DecodeTG1<T: Tracer>(state: &mut State, tracer: &T, tg1_in: u8) -> u32 {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_0: read-var tg1_in:u8
        let s_0_0: u8 = fn_state.tg1_in;
        // D s_0_1: write-var tg1 <= s_0_0
        fn_state.tg1 = s_0_0;
        // D s_0_2: read-var tg1:u8
        let s_0_2: u8 = fn_state.tg1;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var tg1:u8
        let s_2_0: u8 = fn_state.tg1;
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_2: const #"TG1 encoded granule size" : str
        let s_7_2: &'static str = "TG1 encoded granule size";
        ...
        // D s_7_5: write-var ga#10118 <= s_7_4
        fn_state.ga_10118 = s_7_4;
        // D s_7_6: read-var ga#10118:u8
        let s_7_6: u8 = fn_state.ga_10118;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var ga#10118:u8
        let s_10_0: u8 = fn_state.ga_10118;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var ga#10118:u8
        let s_12_0: u8 = fn_state.ga_10118;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var tg1:u8
        let s_15_0: u8 = fn_state.tg1;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var tg1:u8
        let s_17_0: u8 = fn_state.tg1;
    ...
    fn block_20<T: Tracer>(
        ...
        // C s_20_2: const #"TG1 encoded granule size" : str
        let s_20_2: &'static str = "TG1 encoded granule size";
