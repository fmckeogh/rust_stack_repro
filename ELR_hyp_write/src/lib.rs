...
extern crate alloc;
use common::*;
pub fn ELR_hyp_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #17224u : u32
        let s_0_23: u32 = 17224;
        ...
        // C s_0_25: const #17088u : u32
        let s_0_25: u32 = 17088;
