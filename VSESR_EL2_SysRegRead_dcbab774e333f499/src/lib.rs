...
use u__get_VSESR_EL2::*;
use NVMem_read::*;
use AArch64_SystemAccessTrap::*;
use EL2Enabled::*;
use u_get_HCR_EL2_Type_NV2::*;
use common::*;
pub fn VSESR_EL2_SysRegRead_dcbab774e333f499<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        gs_74609: bool,
        ga_100227: ProductType5c790c8ef59cc8b2,
        ga_100231: ProductType5c790c8ef59cc8b2,
        ga_100221: u64,
        u__PSTATE_EL: u8,
        u__HCR_EL2_NV: bool,
        gs_74608: bool,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // C s_5_1: const #100824u : u32
        let s_5_1: u32 = 100824;
        ...
        // D s_5_3: call __get_VSESR_EL2(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_VSESR_EL2(state, tracer, s_5_2);
        // D s_5_4: write-var ga#100231 <= s_5_3
        fn_state.ga_100231 = s_5_3;
        // D s_5_5: read-var ga#100231.0:struct
        let s_5_5: u64 = fn_state.ga_100231._0;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 64;
        // C s_6_1: const #100824u : u32
        let s_6_1: u32 = 100824;
        ...
        // D s_6_3: call __get_VSESR_EL2(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_VSESR_EL2(state, tracer, s_6_2);
        // D s_6_4: write-var ga#100227 <= s_6_3
        fn_state.ga_100227 = s_6_3;
        // D s_6_5: read-var ga#100227.0:struct
        let s_6_5: u64 = fn_state.ga_100227._0;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#74608 <= s_8_0
        fn_state.gs_74608 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#74608:u8
        let s_9_0: bool = fn_state.gs_74608;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#74609 <= s_11_0
        fn_state.gs_74609 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#74609:u8
        let s_12_0: bool = fn_state.gs_74609;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_5: write-var gs#74609 <= s_15_4
        fn_state.gs_74609 = s_15_4;
        // N s_15_6: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_16<T: Tracer>(
        ...
        // D s_16_6: write-var ga#100221 <= s_16_5
        fn_state.ga_100221 = s_16_5;
        // N s_16_7: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var ga#100221:u64
        let s_17_0: u64 = fn_state.ga_100221;
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_21: write-var gs#74608 <= s_18_20
        fn_state.gs_74608 = s_18_20;
        // N s_18_22: jump b9
        return block_9(state, tracer, fn_state);
    }
