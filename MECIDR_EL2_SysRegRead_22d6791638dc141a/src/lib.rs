...
extern crate alloc;
use X_set::*;
use u__get_MECIDR_EL2::*;
use common::*;
pub fn MECIDR_EL2_SysRegRead_22d6791638dc141a<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_70848: ProductType5c790c8ef59cc8b2,
        ga_70852: ProductType5c790c8ef59cc8b2,
        u__PSTATE_EL: u8,
        el: u8,
        op0: u8,
        op1: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call __get_MECIDR_EL2(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_MECIDR_EL2(state, tracer, s_5_2);
        // D s_5_4: write-var ga#70852 <= s_5_3
        fn_state.ga_70852 = s_5_3;
        // D s_5_5: read-var ga#70852.0:struct
        let s_5_5: u64 = fn_state.ga_70852._0;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_3: call __get_MECIDR_EL2(s_6_2)
        let s_6_3: ProductType5c790c8ef59cc8b2 = u__get_MECIDR_EL2(state, tracer, s_6_2);
        // D s_6_4: write-var ga#70848 <= s_6_3
        fn_state.ga_70848 = s_6_3;
        // D s_6_5: read-var ga#70848.0:struct
        let s_6_5: u64 = fn_state.ga_70848._0;
