...
extern crate alloc;
use Mk_ICH_EISR_EL2_Type::*;
use common::*;
pub fn u__get_ICH_EISR_EL2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_11: tail-call Mk_ICH_EISR_EL2_Type(s_0_10)
        return Mk_ICH_EISR_EL2_Type(state, tracer, s_0_10);
    }
}
