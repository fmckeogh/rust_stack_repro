...
use common::*;
pub fn decode_aarch32_instrs_VRADDHN_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    size: u8,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_22: write-var gs#317513 <= s_4_21
        fn_state.gs_317513 = s_4_21;
        // N s_4_23: jump b5
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_0: read-var gs#317513:u8
        let s_5_0: bool = fn_state.gs_317513;
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_0: const #1u : u8
        let s_8_0: bool = true;
        // D s_8_1: write-var gs#317513 <= s_8_0
        fn_state.gs_317513 = s_8_0;
        // N s_8_2: jump b5
        return block_5(state, tracer, fn_state);
    }
    fn block_9<T: Tracer>(
