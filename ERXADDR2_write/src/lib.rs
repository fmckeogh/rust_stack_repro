...
extern crate alloc;
use common::*;
pub fn ERXADDR2_write<T: Tracer>(state: &mut State, tracer: &T, value_name: u32) -> () {
    #[derive(Default)]
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_23: const #10112u : u32
        let s_0_23: u32 = 10112;
        ...
        // C s_0_25: const #18408u : u32
        let s_0_25: u32 = 18408;
