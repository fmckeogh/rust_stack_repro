...
extern crate alloc;
use execute_LUTI4_MZ4_ZTZ_1::*;
use CurrentVL_read::*;
use HaveSME2::*;
use common::*;
pub fn decode_LUTI4_MZ4_ZTZ_1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    i1: bool,
    size: u8,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_5: write-var gs#289849 <= s_2_4
        fn_state.gs_289849 = s_2_4;
        // N s_2_6: jump b3
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_0: read-var gs#289849:u8
        let s_3_0: bool = fn_state.gs_289849;
    ...
    fn block_4<T: Tracer>(
        ...
        fn_state.d = s_4_27;
        // D s_4_29: read-var i1:u8
        let s_4_29: bool = fn_state.i1;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_10: call execute_LUTI4_MZ4_ZTZ_1(s_5_0, s_5_7, s_5_4, s_5_3, s_5_8, s_5_5, s_5_9, s_5_6)
        let s_5_10: () = execute_LUTI4_MZ4_ZTZ_1(
            state,
            tracer,
            s_5_0,
            s_5_7,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_10: call execute_LUTI4_MZ4_ZTZ_1(s_7_0, s_7_7, s_7_4, s_7_3, s_7_8, s_7_5, s_7_9, s_7_6)
        let s_7_10: () = execute_LUTI4_MZ4_ZTZ_1(
            state,
            tracer,
            s_7_0,
            s_7_7,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_10: call execute_LUTI4_MZ4_ZTZ_1(s_9_0, s_9_7, s_9_4, s_9_3, s_9_8, s_9_5, s_9_9, s_9_6)
        let s_9_10: () = execute_LUTI4_MZ4_ZTZ_1(
            state,
            tracer,
            s_9_0,
            s_9_7,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_10: call execute_LUTI4_MZ4_ZTZ_1(s_11_0, s_11_7, s_11_4, s_11_3, s_11_8, s_11_5, s_11_9, s_11_6)
        let s_11_10: () = execute_LUTI4_MZ4_ZTZ_1(
            state,
            tracer,
            s_11_0,
            s_11_7,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_10: call execute_LUTI4_MZ4_ZTZ_1(s_13_0, s_13_7, s_13_4, s_13_3, s_13_8, s_13_5, s_13_9, s_13_6)
        let s_13_10: () = execute_LUTI4_MZ4_ZTZ_1(
            state,
            tracer,
            s_13_0,
            s_13_7,
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#289849 <= s_16_0
        fn_state.gs_289849 = s_16_0;
        // N s_16_2: jump b3
        return block_3(state, tracer, fn_state);
    }
