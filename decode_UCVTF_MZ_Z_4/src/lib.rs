...
use HaveSME2::*;
use FPCR_read::*;
use execute_UCVTF_MZ_Z_4::*;
use common::*;
pub fn decode_UCVTF_MZ_Z_4<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Zn: u8,
    U: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // C s_1_34: const #() : ()
        let s_1_34: () = ();
        // S s_1_35: call FPCR_read(s_1_34)
        let s_1_35: ProductType5c790c8ef59cc8b2 = FPCR_read(state, tracer, s_1_34);
        // S s_1_36: call FPRoundingMode(s_1_35)
        let s_1_36: u32 = FPRoundingMode(state, tracer, s_1_35);
        // D s_1_37: write-var rounding <= s_1_36
        fn_state.rounding = s_1_36;
    ...
    fn block_2<T: Tracer>(
        ...
        let s_2_3: i64 = 4;
        // D s_2_4: read-var rounding:u32
        let s_2_4: u32 = fn_state.rounding;
        // C s_2_5: const #1u : u8
        let s_2_5: bool = true;
        // D s_2_6: call execute_UCVTF_MZ_Z_4(s_2_0, s_2_1, s_2_2, s_2_3, s_2_4, s_2_5)
        let s_2_6: () = execute_UCVTF_MZ_Z_4(
            state,
            tracer,
            s_2_0,
            s_2_1,
    ...
    fn block_4<T: Tracer>(
        ...
        let s_4_3: i64 = 4;
        // D s_4_4: read-var rounding:u32
        let s_4_4: u32 = fn_state.rounding;
        // C s_4_5: const #1u : u8
        let s_4_5: bool = true;
        // D s_4_6: call execute_UCVTF_MZ_Z_4(s_4_0, s_4_1, s_4_2, s_4_3, s_4_4, s_4_5)
        let s_4_6: () = execute_UCVTF_MZ_Z_4(
            state,
            tracer,
            s_4_0,
            s_4_1,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_3: i64 = 4;
        // D s_6_4: read-var rounding:u32
        let s_6_4: u32 = fn_state.rounding;
        // C s_6_5: const #1u : u8
        let s_6_5: bool = true;
        // D s_6_6: call execute_UCVTF_MZ_Z_4(s_6_0, s_6_1, s_6_2, s_6_3, s_6_4, s_6_5)
        let s_6_6: () = execute_UCVTF_MZ_Z_4(
            state,
            tracer,
            s_6_0,
            s_6_1,
    ...
    fn block_8<T: Tracer>(
        ...
        // C s_8_5: const #1u : u8
        let s_8_5: bool = true;
        // D s_8_6: call execute_UCVTF_MZ_Z_4(s_8_0, s_8_1, s_8_2, s_8_3, s_8_4, s_8_5)
        let s_8_6: () = execute_UCVTF_MZ_Z_4(
            state,
            tracer,
            s_8_0,
            s_8_1,
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_3: i64 = 4;
        // D s_10_4: read-var rounding:u32
        let s_10_4: u32 = fn_state.rounding;
        // C s_10_5: const #1u : u8
        let s_10_5: bool = true;
        // D s_10_6: call execute_UCVTF_MZ_Z_4(s_10_0, s_10_1, s_10_2, s_10_3, s_10_4, s_10_5)
        let s_10_6: () = execute_UCVTF_MZ_Z_4(
            state,
            tracer,
            s_10_0,
            s_10_1,
