...
extern crate alloc;
use X_set::*;
use u__get_ICC_SRE_EL3::*;
use common::*;
pub fn ICC_SRE_EL3_SysRegRead_7a177b6c72e9cd7e<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ga_67930: ProductType5c790c8ef59cc8b2,
        u__PSTATE_EL: u8,
        el: u8,
        op0: u8,
        op1: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call __get_ICC_SRE_EL3(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_ICC_SRE_EL3(
            state,
            tracer,
            s_5_2,
        );
        // D s_5_4: write-var ga#67930 <= s_5_3
        fn_state.ga_67930 = s_5_3;
        // D s_5_5: read-var ga#67930.0:struct
        let s_5_5: u64 = fn_state.ga_67930._0;
