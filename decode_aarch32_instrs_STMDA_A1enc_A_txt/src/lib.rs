...
extern crate alloc;
use ConditionPassed::*;
use execute_aarch32_instrs_STMDA_Op_A_txt::*;
use BitCount::*;
use common::*;
pub fn decode_aarch32_instrs_STMDA_A1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    cond: u8,
    W: bool,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_5: write-var gs#302212 <= s_3_4
        fn_state.gs_302212 = s_3_4;
        // N s_3_6: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#302212:u8
        let s_4_0: bool = fn_state.gs_302212;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call execute_aarch32_instrs_STMDA_Op_A_txt(s_5_0, s_5_1, s_5_2)
        let s_5_3: () = execute_aarch32_instrs_STMDA_Op_A_txt(
            state,
            tracer,
            s_5_0,
            s_5_1,
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #1u : u8
        let s_7_0: bool = true;
        // D s_7_1: write-var gs#302212 <= s_7_0
        fn_state.gs_302212 = s_7_0;
        // N s_7_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
