...
extern crate alloc;
use Mk_AMCNTENSET1_EL0_Type::*;
use common::*;
pub fn u__get_AMCNTENSET1_EL0<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_3: const #18446744073709486080u : u64
        let s_0_3: u64 = 18446744073709486080;
        ...
        // D s_0_11: tail-call Mk_AMCNTENSET1_EL0_Type(s_0_10)
        return Mk_AMCNTENSET1_EL0_Type(state, tracer, s_0_10);
    }
}
