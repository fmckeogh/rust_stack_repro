...
use common::*;
pub fn TTBR1_EL2_SysRegWrite_2b203badd6cd49c7<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // C s_6_3: const #18432u : u32
        let s_6_3: u32 = 18432;
        // D s_6_4: read-reg s_6_3:struct
        let s_6_4: ProductType782ac6922b48c20d = {
            let value = state
                .read_register::<ProductType782ac6922b48c20d>(s_6_3 as isize);
            tracer.read_register(s_6_3 as isize, value);
            value
        };
        // C s_6_5: const #18432u : u32
        let s_6_5: u32 = 18432;
        // N s_6_6: write-reg s_6_5 <= s_6_4
        let s_6_6: () = {
            state.write_register::<ProductType782ac6922b48c20d>(s_6_5 as isize, s_6_4);
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#96970 <= s_8_0
        fn_state.gs_96970 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#96970:u8
        let s_9_0: bool = fn_state.gs_96970;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_5: write-var gs#96970 <= s_12_4
        fn_state.gs_96970 = s_12_4;
        // N s_12_6: jump b9
        return block_9(state, tracer, fn_state);
    }
