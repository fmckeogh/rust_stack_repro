...
use common::*;
pub fn ACTLR_EL1_SysRegRead_cc5a0755f0205a72<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_5<T: Tracer>(
        ...
        let s_5_0: i64 = 64;
        // C s_5_1: const #104680u : u32
        let s_5_1: u32 = 104680;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: i64 = 64;
        // C s_6_1: const #104680u : u32
        let s_6_1: u32 = 104680;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#47004 <= s_8_0
        fn_state.gs_47004 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#47004:u8
        let s_9_0: bool = fn_state.gs_47004;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#47005 <= s_11_0
        fn_state.gs_47005 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#47005:u8
        let s_12_0: bool = fn_state.gs_47005;
    ...
    fn block_13<T: Tracer>(
        ...
        let s_13_0: i64 = 64;
        // C s_13_1: const #104680u : u32
        let s_13_1: u32 = 104680;
        ...
        // D s_13_5: call X_set(s_13_4, s_13_0, s_13_3)
        let s_13_5: () = X_set(state, tracer, s_13_4, s_13_0, s_13_3);
        // N s_13_6: return
        return;
    }
    fn block_14<T: Tracer>(
        ...
        // S s_14_5: call NVMem_read(s_14_4)
        let s_14_5: u64 = NVMem_read(state, tracer, s_14_4);
        // D s_14_6: write-var ga#37663 <= s_14_5
        fn_state.ga_37663 = s_14_5;
        // N s_14_7: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var ga#37663:u64
        let s_15_0: u64 = fn_state.ga_37663;
        // D s_15_1: cast zx s_15_0 -> bv
        let s_15_1: Bits = Bits::new(s_15_0 as u128, 64u16);
        // D s_15_2: read-var t:i
        let s_15_2: i128 = fn_state.t;
        // C s_15_3: const #64s : i64
        let s_15_3: i64 = 64;
        // D s_15_4: call X_set(s_15_2, s_15_3, s_15_1)
        let s_15_4: () = X_set(state, tracer, s_15_2, s_15_3, s_15_1);
        // N s_15_5: return
        return;
    }
    fn block_16<T: Tracer>(
        ...
        // D s_16_2: call _get_HCR_EL2_Type_NV2(s_16_1)
        let s_16_2: bool = u_get_HCR_EL2_Type_NV2(state, tracer, s_16_1);
        ...
        // D s_16_5: call _get_HCR_EL2_Type_NV(s_16_4)
        let s_16_5: bool = u_get_HCR_EL2_Type_NV(state, tracer, s_16_4);
        ...
        // D s_16_21: write-var gs#47005 <= s_16_20
        fn_state.gs_47005 = s_16_20;
        // N s_16_22: jump b12
        return block_12(state, tracer, fn_state);
    }
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var __HCR_EL2_TACR:u8
        let s_18_0: bool = fn_state.u__HCR_EL2_TACR;
        ...
        // D s_18_5: write-var gs#47004 <= s_18_4
        fn_state.gs_47004 = s_18_4;
        // N s_18_6: jump b9
        return block_9(state, tracer, fn_state);
    }
