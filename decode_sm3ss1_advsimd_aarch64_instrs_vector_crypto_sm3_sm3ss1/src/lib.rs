...
extern crate alloc;
use HaveSM3Ext::*;
use execute_aarch64_instrs_vector_crypto_sm3_sm3ss1::*;
use common::*;
pub fn decode_sm3ss1_advsimd_aarch64_instrs_vector_crypto_sm3_sm3ss1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_12: read-var Ra:u8
        let s_1_12: u8 = fn_state.Ra;
        ...
        // D s_1_16: call execute_aarch64_instrs_vector_crypto_sm3_sm3ss1(s_1_15, s_1_3, s_1_11, s_1_7)
        let s_1_16: () = execute_aarch64_instrs_vector_crypto_sm3_sm3ss1(
            state,
            tracer,
            s_1_15,
            s_1_3,
