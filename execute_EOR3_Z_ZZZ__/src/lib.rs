...
use Z_set::*;
use common::*;
pub fn execute_EOR3_Z_ZZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    dn: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#4288 <= s_0_2
        fn_state.VLshadow_4288 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#4288:i64
        let s_1_0: i64 = fn_state.VLshadow_4288;
        ...
        // D s_1_21: xor s_1_6 s_1_12
        let s_1_21: Bits = ((s_1_6) ^ (s_1_12));
        // D s_1_22: xor s_1_21 s_1_18
        let s_1_22: Bits = ((s_1_21) ^ (s_1_18));
        ...
        // D s_1_26: call Z_set(s_1_24, s_1_25, s_1_22)
        let s_1_26: () = Z_set(state, tracer, s_1_24, s_1_25, s_1_22);
        // N s_1_27: return
        return;
    }
}
