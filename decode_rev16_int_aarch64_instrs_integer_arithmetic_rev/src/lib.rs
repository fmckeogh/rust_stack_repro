...
use Unreachable::*;
use common::*;
pub fn decode_rev16_int_aarch64_instrs_integer_arithmetic_rev<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 32;
        // D s_1_1: write-var ga#264488 <= s_1_0
        fn_state.ga_264488 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#264488:i64
        let s_2_0: i64 = fn_state.ga_264488;
    ...
    fn block_12<T: Tracer>(
        ...
        let s_12_0: i64 = 64;
        // D s_12_1: write-var ga#264488 <= s_12_0
        fn_state.ga_264488 = s_12_0;
        // N s_12_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
