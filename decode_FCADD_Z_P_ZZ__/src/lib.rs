...
use HaveSVE::*;
use CurrentVL_read::*;
use execute_FCADD_Z_P_ZZ__::*;
use HaveSME::*;
use common::*;
pub fn decode_FCADD_Z_P_ZZ__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    rot: bool,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#180927 <= s_1_0
        fn_state.gs_180927 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#180927:u8
        let s_2_0: bool = fn_state.gs_180927;
    ...
    fn block_4<T: Tracer>(
        ...
        fn_state.m = s_4_20;
        // D s_4_22: read-var rot:u8
        let s_4_22: bool = fn_state.rot;
        ...
        // D s_4_27: write-var sub_i <= s_4_26
        fn_state.sub_i = s_4_26;
        // D s_4_28: read-var rot:u8
        let s_4_28: bool = fn_state.rot;
        ...
        // D s_4_33: write-var sub_r <= s_4_32
        fn_state.sub_r = s_4_32;
        // D s_4_34: read-var VL:i64
        let s_4_34: i64 = fn_state.VL;
        // C s_4_35: const #128s : i
        let s_4_35: i128 = 128;
        // D s_4_36: cast zx s_4_34 -> i
        let s_4_36: i128 = (i128::try_from(s_4_34).unwrap());
        // D s_4_37: cmp-eq s_4_36 s_4_35
        let s_4_37: bool = ((s_4_36) == (s_4_35));
        // D s_4_38: not s_4_37
        let s_4_38: bool = !s_4_37;
        // N s_4_39: branch s_4_38 b6 b5
        if s_4_38 {
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: read-var dn:i64
        let s_5_4: i64 = fn_state.dn;
        // D s_5_5: read-var g:i64
        let s_5_5: i64 = fn_state.g;
        // D s_5_6: read-var m:i64
        let s_5_6: i64 = fn_state.m;
        // D s_5_7: read-var sub_i:u8
        let s_5_7: bool = fn_state.sub_i;
        // D s_5_8: read-var sub_r:u8
        let s_5_8: bool = fn_state.sub_r;
        // D s_5_9: call execute_FCADD_Z_P_ZZ__(s_5_0, s_5_4, s_5_3, s_5_5, s_5_6, s_5_7, s_5_8)
        let s_5_9: () = execute_FCADD_Z_P_ZZ__(
            state,
            tracer,
            s_5_0,
            s_5_4,
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_7: read-var sub_i:u8
        let s_7_7: bool = fn_state.sub_i;
        // D s_7_8: read-var sub_r:u8
        let s_7_8: bool = fn_state.sub_r;
        // D s_7_9: call execute_FCADD_Z_P_ZZ__(s_7_0, s_7_4, s_7_3, s_7_5, s_7_6, s_7_7, s_7_8)
        let s_7_9: () = execute_FCADD_Z_P_ZZ__(
            state,
            tracer,
            s_7_0,
            s_7_4,
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_7: read-var sub_i:u8
        let s_9_7: bool = fn_state.sub_i;
        // D s_9_8: read-var sub_r:u8
        let s_9_8: bool = fn_state.sub_r;
        // D s_9_9: call execute_FCADD_Z_P_ZZ__(s_9_0, s_9_4, s_9_3, s_9_5, s_9_6, s_9_7, s_9_8)
        let s_9_9: () = execute_FCADD_Z_P_ZZ__(
            state,
            tracer,
            s_9_0,
            s_9_4,
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_7: read-var sub_i:u8
        let s_11_7: bool = fn_state.sub_i;
        // D s_11_8: read-var sub_r:u8
        let s_11_8: bool = fn_state.sub_r;
        // D s_11_9: call execute_FCADD_Z_P_ZZ__(s_11_0, s_11_4, s_11_3, s_11_5, s_11_6, s_11_7, s_11_8)
        let s_11_9: () = execute_FCADD_Z_P_ZZ__(
            state,
            tracer,
            s_11_0,
            s_11_4,
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_7: read-var sub_i:u8
        let s_13_7: bool = fn_state.sub_i;
        // D s_13_8: read-var sub_r:u8
        let s_13_8: bool = fn_state.sub_r;
        // D s_13_9: call execute_FCADD_Z_P_ZZ__(s_13_0, s_13_4, s_13_3, s_13_5, s_13_6, s_13_7, s_13_8)
        let s_13_9: () = execute_FCADD_Z_P_ZZ__(
            state,
            tracer,
            s_13_0,
            s_13_4,
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_3: write-var gs#180927 <= s_17_2
        fn_state.gs_180927 = s_17_2;
        // N s_17_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
