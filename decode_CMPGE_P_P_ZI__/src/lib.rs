...
extern crate alloc;
use HaveSVE::*;
use execute_CMPGE_P_P_ZI__::*;
use CurrentVL_read::*;
use HaveSME::*;
use common::*;
pub fn decode_CMPGE_P_P_ZI__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    size: u8,
    imm5: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#188396 <= s_1_0
        fn_state.gs_188396 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#188396:u8
        let s_2_0: bool = fn_state.gs_188396;
    ...
    fn block_3<T: Tracer>(
        ...
        fn_state.d = s_3_20;
        // D s_3_22: read-var imm5:u8
        let s_3_22: u8 = fn_state.imm5;
        // D s_3_23: cast zx s_3_22 -> bv
        let s_3_23: Bits = Bits::new(s_3_22 as u128, 5u16);
        // D s_3_24: cast sx s_3_23 -> i
        let s_3_24: i128 = {
            let sign_bit = s_3_23.length() - 1;
            let mut result = s_3_23.value() as i128;
        ...
        // D s_3_26: write-var imm <= s_3_25
        fn_state.imm = s_3_25;
        // D s_3_27: read-var VL:i64
        let s_3_27: i64 = fn_state.VL;
        // C s_3_28: const #128s : i
        let s_3_28: i128 = 128;
        ...
        // D s_3_31: not s_3_30
        let s_3_31: bool = !s_3_30;
        // N s_3_32: branch s_3_31 b5 b4
        if s_3_31 {
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_4: read-var imm:i64
        let s_4_4: i64 = fn_state.imm;
        // D s_4_5: cast zx s_4_4 -> i
        let s_4_5: i128 = (i128::try_from(s_4_4).unwrap());
        // D s_4_6: read-var d:i64
        let s_4_6: i64 = fn_state.d;
        // D s_4_7: read-var g:i64
        let s_4_7: i64 = fn_state.g;
        // D s_4_8: read-var n:i64
        let s_4_8: i64 = fn_state.n;
        // C s_4_9: const #2u : u32
        let s_4_9: u32 = 2;
        // C s_4_10: const #0u : u8
        let s_4_10: bool = false;
        // D s_4_11: call execute_CMPGE_P_P_ZI__(s_4_0, s_4_6, s_4_3, s_4_7, s_4_5, s_4_8, s_4_9, s_4_10)
        let s_4_11: () = execute_CMPGE_P_P_ZI__(
            state,
            tracer,
            s_4_0,
            s_4_6,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_4: read-var imm:i64
        let s_6_4: i64 = fn_state.imm;
        // D s_6_5: cast zx s_6_4 -> i
        let s_6_5: i128 = (i128::try_from(s_6_4).unwrap());
        // D s_6_6: read-var d:i64
        let s_6_6: i64 = fn_state.d;
        // D s_6_7: read-var g:i64
        let s_6_7: i64 = fn_state.g;
        // D s_6_8: read-var n:i64
        let s_6_8: i64 = fn_state.n;
        // C s_6_9: const #2u : u32
        let s_6_9: u32 = 2;
        // C s_6_10: const #0u : u8
        let s_6_10: bool = false;
        // D s_6_11: call execute_CMPGE_P_P_ZI__(s_6_0, s_6_6, s_6_3, s_6_7, s_6_5, s_6_8, s_6_9, s_6_10)
        let s_6_11: () = execute_CMPGE_P_P_ZI__(
            state,
            tracer,
            s_6_0,
            s_6_6,
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_4: read-var imm:i64
        let s_8_4: i64 = fn_state.imm;
        // D s_8_5: cast zx s_8_4 -> i
        let s_8_5: i128 = (i128::try_from(s_8_4).unwrap());
        // D s_8_6: read-var d:i64
        let s_8_6: i64 = fn_state.d;
        // D s_8_7: read-var g:i64
        let s_8_7: i64 = fn_state.g;
        // D s_8_8: read-var n:i64
        let s_8_8: i64 = fn_state.n;
        // C s_8_9: const #2u : u32
        let s_8_9: u32 = 2;
        // C s_8_10: const #0u : u8
        let s_8_10: bool = false;
        // D s_8_11: call execute_CMPGE_P_P_ZI__(s_8_0, s_8_6, s_8_3, s_8_7, s_8_5, s_8_8, s_8_9, s_8_10)
        let s_8_11: () = execute_CMPGE_P_P_ZI__(
            state,
            tracer,
            s_8_0,
            s_8_6,
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_4: read-var imm:i64
        let s_10_4: i64 = fn_state.imm;
        // D s_10_5: cast zx s_10_4 -> i
        let s_10_5: i128 = (i128::try_from(s_10_4).unwrap());
        // D s_10_6: read-var d:i64
        let s_10_6: i64 = fn_state.d;
        // D s_10_7: read-var g:i64
        let s_10_7: i64 = fn_state.g;
        // D s_10_8: read-var n:i64
        let s_10_8: i64 = fn_state.n;
        // C s_10_9: const #2u : u32
        let s_10_9: u32 = 2;
        // C s_10_10: const #0u : u8
        let s_10_10: bool = false;
        // D s_10_11: call execute_CMPGE_P_P_ZI__(s_10_0, s_10_6, s_10_3, s_10_7, s_10_5, s_10_8, s_10_9, s_10_10)
        let s_10_11: () = execute_CMPGE_P_P_ZI__(
            state,
            tracer,
            s_10_0,
            s_10_6,
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_4: read-var imm:i64
        let s_12_4: i64 = fn_state.imm;
        // D s_12_5: cast zx s_12_4 -> i
        let s_12_5: i128 = (i128::try_from(s_12_4).unwrap());
        // D s_12_6: read-var d:i64
        let s_12_6: i64 = fn_state.d;
        // D s_12_7: read-var g:i64
        let s_12_7: i64 = fn_state.g;
        // D s_12_8: read-var n:i64
        let s_12_8: i64 = fn_state.n;
        // C s_12_9: const #2u : u32
        let s_12_9: u32 = 2;
        // C s_12_10: const #0u : u8
        let s_12_10: bool = false;
        // D s_12_11: call execute_CMPGE_P_P_ZI__(s_12_0, s_12_6, s_12_3, s_12_7, s_12_5, s_12_8, s_12_9, s_12_10)
        let s_12_11: () = execute_CMPGE_P_P_ZI__(
            state,
            tracer,
            s_12_0,
            s_12_6,
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_3: write-var gs#188396 <= s_15_2
        fn_state.gs_188396 = s_15_2;
        // N s_15_4: jump b2
        return block_2(state, tracer, fn_state);
    }
}
