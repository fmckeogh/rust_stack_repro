...
use P_read::*;
use common::*;
pub fn execute_ZIP2_P_PP__<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    d: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_42: write-var gs#195029 <= s_1_41
        fn_state.gs_195029 = s_1_41;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#195029:i64
        let s_2_1: i64 = fn_state.gs_195029;
