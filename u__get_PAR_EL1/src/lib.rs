...
use Mk_PAR_EL1_Type::*;
use common::*;
pub fn u__get_PAR_EL1<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_0<T: Tracer>(
        ...
        // C s_0_5: const #18374686479671627774u : u64
        let s_0_5: u64 = 18374686479671627774;
        ...
        // D s_0_31: tail-call Mk_PAR_EL1_Type(s_0_30)
        return Mk_PAR_EL1_Type(state, tracer, s_0_30);
    }
}
