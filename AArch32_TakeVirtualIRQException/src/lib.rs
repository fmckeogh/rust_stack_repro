...
use common::*;
pub fn AArch32_TakeVirtualIRQException<T: Tracer>(
    state: &mut State,
    tracer: &T,
    gs_32047: (),
) -> () {
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_7: write-var gs#32048 <= s_1_6
        fn_state.gs_32048 = s_1_6;
        // N s_1_8: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#32048:u8
        let s_2_0: bool = fn_state.gs_32048;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#32049 <= s_3_0
        fn_state.gs_32049 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#32049:u8
        let s_4_0: bool = fn_state.gs_32049;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_1: write-var gs#32053 <= s_6_0
        fn_state.gs_32053 = s_6_0;
        // N s_6_2: jump b7
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_0: read-var gs#32053:u8
        let s_7_0: bool = fn_state.gs_32053;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#32050 <= s_9_0
        fn_state.gs_32050 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#32050:u8
        let s_10_0: bool = fn_state.gs_32050;
    ...
    fn block_13<T: Tracer>(
        ...
        // C s_13_0: const #() : ()
        let s_13_0: () = ();
        // S s_13_1: call AArch64_TakeVirtualIRQException(s_13_0)
        let s_13_1: () = AArch64_TakeVirtualIRQException(state, tracer, s_13_0);
        // N s_13_2: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_14<T: Tracer>(
        ...
        // D s_14_4: write-var gs#32050 <= s_14_3
        fn_state.gs_32050 = s_14_3;
        // N s_14_5: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_15<T: Tracer>(
        ...
        // D s_15_2: call _get_HCR_EL2_Type_IMO(s_15_1)
        let s_15_2: bool = u_get_HCR_EL2_Type_IMO(state, tracer, s_15_1);
        ...
        // D s_15_7: write-var gs#32053 <= s_15_6
        fn_state.gs_32053 = s_15_6;
        // N s_15_8: jump b7
        return block_7(state, tracer, fn_state);
    }
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#32054 <= s_17_0
        fn_state.gs_32054 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#32054:u8
        let s_18_0: bool = fn_state.gs_32054;
    ...
    fn block_19<T: Tracer>(
        ...
        // S s_19_2: call _get_HCR_Type_IMO(s_19_1)
        let s_19_2: bool = u_get_HCR_Type_IMO(state, tracer, s_19_1);
        ...
        // D s_19_7: write-var gs#32054 <= s_19_6
        fn_state.gs_32054 = s_19_6;
        // N s_19_8: jump b18
        return block_18(state, tracer, fn_state);
    }
    fn block_20<T: Tracer>(
        ...
        // D s_20_2: write-var gs#32049 <= s_20_1
        fn_state.gs_32049 = s_20_1;
        // N s_20_3: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#32048 <= s_21_0
        fn_state.gs_32048 = s_21_0;
        // N s_21_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
