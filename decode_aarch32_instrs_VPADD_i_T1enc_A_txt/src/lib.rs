...
use common::*;
pub fn decode_aarch32_instrs_VPADD_i_T1enc_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    D: bool,
    size: u8,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_5: write-var gs#314995 <= s_3_4
        fn_state.gs_314995 = s_3_4;
        // N s_3_6: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#314995:u8
        let s_4_0: bool = fn_state.gs_314995;
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_0: const #1u : u8
        let s_7_0: bool = true;
        // D s_7_1: write-var gs#314995 <= s_7_0
        fn_state.gs_314995 = s_7_0;
        // N s_7_2: jump b4
        return block_4(state, tracer, fn_state);
    }
}
