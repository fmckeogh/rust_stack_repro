...
use common::*;
pub fn execute_aarch64_instrs_vector_arithmetic_unary_extract_nosat<T: Tracer>(
    state: &mut State,
    tracer: &T,
    d: i64,
    datasize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var esizeshadow#2015 <= s_0_2
        fn_state.esizeshadow_2015 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_16: write-var gs#174404 <= s_1_15
        fn_state.gs_174404 = s_1_15;
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_1: read-var gs#174404:i64
        let s_2_1: i64 = fn_state.gs_174404;
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_0: const #2s : i
        let s_3_0: i128 = 2;
        // D s_3_1: read-var esizeshadow#2015:i64
        let s_3_1: i64 = fn_state.esizeshadow_2015;
        ...
        // D s_3_12: read-var esizeshadow#2015:i64
        let s_3_12: i64 = fn_state.esizeshadow_2015;
        ...
        // C s_3_15: const #1s : i
        let s_3_15: i128 = 1;
        // D s_3_16: read-var esizeshadow#2015:i64
        let s_3_16: i64 = fn_state.esizeshadow_2015;
        // D s_3_17: cast zx s_3_16 -> i
        let s_3_17: i128 = (i128::try_from(s_3_16).unwrap());
        // D s_3_18: sub s_3_17 s_3_15
        let s_3_18: i128 = ((s_3_17) - (s_3_15));
        ...
        // C s_3_22: const #1s : i64
        let s_3_22: i64 = 1;
        // C s_3_23: cast zx s_3_22 -> i
        let s_3_23: i128 = (i128::try_from(s_3_22).unwrap());
        // D s_3_24: sub s_3_21 s_3_20
        let s_3_24: i128 = ((s_3_21) - (s_3_20));
        // D s_3_25: add s_3_24 s_3_23
        let s_3_25: i128 = (s_3_24 + s_3_23);
        // D s_3_26: bit-extract s_3_11 s_3_20 s_3_25
        ...
        // D s_3_29: cast zx s_3_14 -> i
        let s_3_29: i128 = (i128::try_from(s_3_14).unwrap());
