...
use Mk_MAIR2_EL2_Type::*;
use u_get_HCR_EL2_Type_TVM::*;
use u_get_HCR_EL2_Type_NV::*;
use u_get_EDSCR_Type_SDD::*;
use EL2Enabled::*;
use Mk_MAIR2_EL1_Type::*;
use u_get_HFGWTR_EL2_Type_nMAIR2_EL1::*;
use EDSCR_read::*;
use common::*;
pub fn MAIR2_EL2_SysRegWrite_947c3848493bf9b8<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_9: call _get_SCR_EL3_Type_AIEn(s_0_8)
        let s_0_9: bool = u_get_SCR_EL3_Type_AIEn(state, tracer, s_0_8);
        // D s_0_10: write-var __SCR_EL3_AIEn <= s_0_9
        fn_state.u__SCR_EL3_AIEn = s_0_9;
        ...
        // D s_0_21: call _get_HFGWTR_EL2_Type_nMAIR2_EL1(s_0_20)
        let s_0_21: bool = u_get_HFGWTR_EL2_Type_nMAIR2_EL1(state, tracer, s_0_20);
        // D s_0_22: write-var __HFGWTR_EL2_nMAIR2_EL1 <= s_0_21
        fn_state.u__HFGWTR_EL2_nMAIR2_EL1 = s_0_21;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_4: call Mk_MAIR2_EL1_Type(s_5_3)
        let s_5_4: ProductType5c790c8ef59cc8b2 = Mk_MAIR2_EL1_Type(state, tracer, s_5_3);
        // C s_5_5: const #20048u : u32
        let s_5_5: u32 = 20048;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_1: write-var gs#86578 <= s_7_0
        fn_state.gs_86578 = s_7_0;
        // N s_7_2: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var gs#86578:u8
        let s_8_0: bool = fn_state.gs_86578;
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_1: write-var gs#86579 <= s_9_0
        fn_state.gs_86579 = s_9_0;
        // N s_9_2: jump b10
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_0: read-var gs#86579:u8
        let s_10_0: bool = fn_state.gs_86579;
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_1: write-var gs#86580 <= s_11_0
        fn_state.gs_86580 = s_11_0;
        // N s_11_2: jump b12
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_0: read-var gs#86580:u8
        let s_12_0: bool = fn_state.gs_86580;
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_1: write-var gs#86581 <= s_13_0
        fn_state.gs_86581 = s_13_0;
        // N s_13_2: jump b14
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_0: read-var gs#86581:u8
        let s_14_0: bool = fn_state.gs_86581;
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_1: write-var gs#86582 <= s_16_0
        fn_state.gs_86582 = s_16_0;
        // N s_16_2: jump b17
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_0: read-var gs#86582:u8
        let s_17_0: bool = fn_state.gs_86582;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_4: call Mk_MAIR2_EL1_Type(s_19_3)
        let s_19_4: ProductType5c790c8ef59cc8b2 = Mk_MAIR2_EL1_Type(
            state,
            tracer,
            s_19_3,
        );
        // C s_19_5: const #20048u : u32
        let s_19_5: u32 = 20048;
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_4: call Mk_MAIR2_EL2_Type(s_20_3)
        let s_20_4: ProductType5c790c8ef59cc8b2 = Mk_MAIR2_EL2_Type(
            state,
            tracer,
            s_20_3,
        );
        // C s_20_5: const #20928u : u32
        let s_20_5: u32 = 20928;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#86585 <= s_22_0
        fn_state.gs_86585 = s_22_0;
        // N s_22_2: jump b23
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_0: read-var gs#86585:u8
        let s_23_0: bool = fn_state.gs_86585;
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_5: write-var gs#86585 <= s_26_4
        fn_state.gs_86585 = s_26_4;
        // N s_26_6: jump b23
        return block_23(state, tracer, fn_state);
    }
    fn block_27<T: Tracer>(
        ...
        // D s_27_0: read-var __SCR_EL3_AIEn:u8
        let s_27_0: bool = fn_state.u__SCR_EL3_AIEn;
        ...
        // D s_27_5: write-var gs#86582 <= s_27_4
        fn_state.gs_86582 = s_27_4;
        // N s_27_6: jump b17
        return block_17(state, tracer, fn_state);
    }
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_0: read-var __SCR_EL3_AIEn:u8
        let s_29_0: bool = fn_state.u__SCR_EL3_AIEn;
        ...
        // D s_29_5: write-var gs#86581 <= s_29_4
        fn_state.gs_86581 = s_29_4;
        // N s_29_6: jump b14
        return block_14(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_2: write-var gs#86580 <= s_30_1
        fn_state.gs_86580 = s_30_1;
        // N s_30_3: jump b12
        return block_12(state, tracer, fn_state);
    }
    fn block_31<T: Tracer>(
        ...
        // D s_31_5: write-var gs#86579 <= s_31_4
        fn_state.gs_86579 = s_31_4;
        // N s_31_6: jump b10
        return block_10(state, tracer, fn_state);
    }
    fn block_32<T: Tracer>(
        ...
        // D s_32_4: write-var gs#86578 <= s_32_3
        fn_state.gs_86578 = s_32_3;
        // N s_32_5: jump b8
        return block_8(state, tracer, fn_state);
    }
    ...
    fn block_34<T: Tracer>(
        ...
        // D s_34_1: write-var gs#86586 <= s_34_0
        fn_state.gs_86586 = s_34_0;
        // N s_34_2: jump b35
    ...
    fn block_35<T: Tracer>(
        ...
        // D s_35_0: read-var gs#86586:u8
        let s_35_0: bool = fn_state.gs_86586;
    ...
    fn block_36<T: Tracer>(
        ...
        // D s_36_1: write-var gs#86587 <= s_36_0
        fn_state.gs_86587 = s_36_0;
        // N s_36_2: jump b37
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_0: read-var gs#86587:u8
        let s_37_0: bool = fn_state.gs_86587;
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_1: write-var gs#86588 <= s_38_0
        fn_state.gs_86588 = s_38_0;
        // N s_38_2: jump b39
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_0: read-var gs#86588:u8
        let s_39_0: bool = fn_state.gs_86588;
    ...
    fn block_40<T: Tracer>(
        ...
        // D s_40_1: write-var gs#86589 <= s_40_0
        fn_state.gs_86589 = s_40_0;
        // N s_40_2: jump b41
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_0: read-var gs#86589:u8
        let s_41_0: bool = fn_state.gs_86589;
    ...
    fn block_43<T: Tracer>(
        ...
        // D s_43_1: write-var gs#86590 <= s_43_0
        fn_state.gs_86590 = s_43_0;
        // N s_43_2: jump b44
    ...
    fn block_44<T: Tracer>(
        ...
        // D s_44_0: read-var gs#86590:u8
        let s_44_0: bool = fn_state.gs_86590;
    ...
    fn block_46<T: Tracer>(
        ...
        // D s_46_1: write-var gs#86591 <= s_46_0
        fn_state.gs_86591 = s_46_0;
        // N s_46_2: jump b47
    ...
    fn block_47<T: Tracer>(
        ...
        // D s_47_0: read-var gs#86591:u8
        let s_47_0: bool = fn_state.gs_86591;
    ...
    fn block_48<T: Tracer>(
        ...
        // D s_48_1: write-var gs#86593 <= s_48_0
        fn_state.gs_86593 = s_48_0;
        // N s_48_2: jump b49
    ...
    fn block_49<T: Tracer>(
        ...
        // D s_49_0: read-var gs#86593:u8
        let s_49_0: bool = fn_state.gs_86593;
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_1: write-var gs#86594 <= s_50_0
        fn_state.gs_86594 = s_50_0;
        // N s_50_2: jump b51
    ...
    fn block_51<T: Tracer>(
        ...
        // D s_51_0: read-var gs#86594:u8
        let s_51_0: bool = fn_state.gs_86594;
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_1: write-var gs#86595 <= s_53_0
        fn_state.gs_86595 = s_53_0;
        // N s_53_2: jump b54
    ...
    fn block_54<T: Tracer>(
        ...
        // D s_54_0: read-var gs#86595:u8
        let s_54_0: bool = fn_state.gs_86595;
    ...
    fn block_56<T: Tracer>(
        ...
        // D s_56_1: write-var gs#86596 <= s_56_0
        fn_state.gs_86596 = s_56_0;
        // N s_56_2: jump b57
    ...
    fn block_57<T: Tracer>(
        ...
        // D s_57_0: read-var gs#86596:u8
        let s_57_0: bool = fn_state.gs_86596;
    ...
    fn block_58<T: Tracer>(
        ...
        // D s_58_4: call Mk_MAIR2_EL1_Type(s_58_3)
        let s_58_4: ProductType5c790c8ef59cc8b2 = Mk_MAIR2_EL1_Type(
            state,
            tracer,
            s_58_3,
        );
        // C s_58_5: const #20048u : u32
        let s_58_5: u32 = 20048;
    ...
    fn block_60<T: Tracer>(
        ...
        // D s_60_35: write-var gs#86596 <= s_60_34
        fn_state.gs_86596 = s_60_34;
        // N s_60_36: jump b57
        return block_57(state, tracer, fn_state);
    }
    ...
    fn block_62<T: Tracer>(
        ...
        // D s_62_1: write-var gs#86599 <= s_62_0
        fn_state.gs_86599 = s_62_0;
        // N s_62_2: jump b63
    ...
    fn block_63<T: Tracer>(
        ...
        // D s_63_0: read-var gs#86599:u8
        let s_63_0: bool = fn_state.gs_86599;
    ...
    fn block_66<T: Tracer>(
        ...
        // D s_66_5: write-var gs#86599 <= s_66_4
        fn_state.gs_86599 = s_66_4;
        // N s_66_6: jump b63
        return block_63(state, tracer, fn_state);
    }
    fn block_67<T: Tracer>(
        ...
        // D s_67_0: read-var __SCR_EL3_AIEn:u8
        let s_67_0: bool = fn_state.u__SCR_EL3_AIEn;
        ...
        // D s_67_5: write-var gs#86595 <= s_67_4
        fn_state.gs_86595 = s_67_4;
        // N s_67_6: jump b54
        return block_54(state, tracer, fn_state);
    }
    ...
    fn block_69<T: Tracer>(
        ...
        // D s_69_0: read-var __HFGWTR_EL2_nMAIR2_EL1:u8
        let s_69_0: bool = fn_state.u__HFGWTR_EL2_nMAIR2_EL1;
        ...
        // D s_69_5: write-var gs#86594 <= s_69_4
        fn_state.gs_86594 = s_69_4;
        // N s_69_6: jump b51
        return block_51(state, tracer, fn_state);
    }
    ...
    fn block_71<T: Tracer>(
        ...
        // D s_71_5: write-var gs#86592 <= s_71_4
        fn_state.gs_86592 = s_71_4;
        // N s_71_6: jump b72
    ...
    fn block_72<T: Tracer>(
        ...
        // D s_72_0: read-var gs#86592:u8
        let s_72_0: bool = fn_state.gs_86592;
        // D s_72_1: write-var gs#86593 <= s_72_0
        fn_state.gs_86593 = s_72_0;
        // N s_72_2: jump b49
        return block_49(state, tracer, fn_state);
    }
    fn block_73<T: Tracer>(
        ...
        // D s_73_1: write-var gs#86592 <= s_73_0
        fn_state.gs_86592 = s_73_0;
        // N s_73_2: jump b72
        return block_72(state, tracer, fn_state);
    }
    fn block_74<T: Tracer>(
        ...
        // D s_74_2: write-var gs#86591 <= s_74_1
        fn_state.gs_86591 = s_74_1;
        // N s_74_3: jump b47
        return block_47(state, tracer, fn_state);
    }
    ...
    fn block_76<T: Tracer>(
        ...
        // D s_76_5: write-var gs#86590 <= s_76_4
        fn_state.gs_86590 = s_76_4;
        // N s_76_6: jump b44
        return block_44(state, tracer, fn_state);
    }
    ...
    fn block_78<T: Tracer>(
        ...
        // D s_78_0: read-var __SCR_EL3_AIEn:u8
        let s_78_0: bool = fn_state.u__SCR_EL3_AIEn;
        ...
        // D s_78_5: write-var gs#86589 <= s_78_4
        fn_state.gs_86589 = s_78_4;
        // N s_78_6: jump b41
        return block_41(state, tracer, fn_state);
    }
    fn block_79<T: Tracer>(
        ...
        // D s_79_2: write-var gs#86588 <= s_79_1
        fn_state.gs_86588 = s_79_1;
        // N s_79_3: jump b39
        return block_39(state, tracer, fn_state);
    }
    fn block_80<T: Tracer>(
        ...
        // D s_80_5: write-var gs#86587 <= s_80_4
        fn_state.gs_86587 = s_80_4;
        // N s_80_6: jump b37
        return block_37(state, tracer, fn_state);
    }
    fn block_81<T: Tracer>(
        ...
        // D s_81_4: write-var gs#86586 <= s_81_3
        fn_state.gs_86586 = s_81_3;
        // N s_81_5: jump b35
        return block_35(state, tracer, fn_state);
    }
