...
use common::*;
pub fn decode_orr_log_imm_aarch64_instrs_integer_logical_immediate<T: Tracer>(
    state: &mut State,
    tracer: &T,
    Rd: u8,
    Rn: u8,
    ...
    struct FunctionState {
        ga_249425: ProductTypebc91b195b0b2a883,
        gs_143436: bool,
        setflags: bool,
        op: u32,
        n: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        let s_1_0: i64 = 32;
        // D s_1_1: write-var ga#249420 <= s_1_0
        fn_state.ga_249420 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var ga#249420:i64
        let s_2_0: i64 = fn_state.ga_249420;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: write-var opshadow#1046 <= s_4_0
        fn_state.opshadow_1046 = s_4_0;
        // D s_4_2: read-var setflags:u8
        let s_4_2: bool = fn_state.setflags;
        // D s_4_3: write-var setflagsshadow#1047 <= s_4_2
        fn_state.setflagsshadow_1047 = s_4_2;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_1: write-var gs#143436 <= s_5_0
        fn_state.gs_143436 = s_5_0;
        // N s_5_2: jump b6
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var gs#143436:u8
        let s_6_0: bool = fn_state.gs_143436;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_9: write-var ga#249425 <= s_7_8
        fn_state.ga_249425 = s_7_8;
        // N s_7_10: jump b8
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_0: read-var ga#249425.0:struct
        let s_8_0: Bits = fn_state.ga_249425._0;
        ...
        // D s_8_6: read-var opshadow#1046:u32
        let s_8_6: u32 = fn_state.opshadow_1046;
        // D s_8_7: read-var setflagsshadow#1047:u8
        let s_8_7: bool = fn_state.setflagsshadow_1047;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_5: write-var gs#143436 <= s_10_4
        fn_state.gs_143436 = s_10_4;
        // N s_10_6: jump b6
        return block_6(state, tracer, fn_state);
    }
    ...
    fn block_16<T: Tracer>(
        ...
        let s_16_0: i64 = 64;
        // D s_16_1: write-var ga#249420 <= s_16_0
        fn_state.ga_249420 = s_16_0;
        // N s_16_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
