...
extern crate alloc;
use X_set::*;
use u__get_VMECID_P_EL2::*;
use Halted::*;
use u_get_SCR_EL3_Type_MECEn::*;
...
use EDSCR_read::*;
use common::*;
pub fn VMECID_P_EL2_SysRegRead_85067caadb2f69e9<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    struct FunctionState {
        ...
        gs_74579: bool,
        gs_74575: bool,
        ga_100098: ProductType5c790c8ef59cc8b2,
        u__PSTATE_EL: u8,
        ga_100094: ProductType5c790c8ef59cc8b2,
        u__SCR_EL3_MECEn: bool,
        gs_74574: bool,
        gs_74577: bool,
        el: u8,
        op0: u8,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_9: call _get_SCR_EL3_Type_MECEn(s_0_8)
        let s_0_9: bool = u_get_SCR_EL3_Type_MECEn(state, tracer, s_0_8);
        // D s_0_10: write-var __SCR_EL3_MECEn <= s_0_9
        fn_state.u__SCR_EL3_MECEn = s_0_9;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_3: call __get_VMECID_P_EL2(s_5_2)
        let s_5_3: ProductType5c790c8ef59cc8b2 = u__get_VMECID_P_EL2(
            state,
            tracer,
            s_5_2,
        );
        // D s_5_4: write-var ga#100098 <= s_5_3
        fn_state.ga_100098 = s_5_3;
        // D s_5_5: read-var ga#100098.0:struct
        let s_5_5: u64 = fn_state.ga_100098._0;
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_0: u32 = 2;
        // S s_6_1: call IsCurrentSecurityState(s_6_0)
        let s_6_1: bool = IsCurrentSecurityState(state, tracer, s_6_0);
        // S s_6_2: not s_6_1
        let s_6_2: bool = !s_6_1;
        // N s_6_3: branch s_6_2 b32 b7
        if s_6_2 {
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: write-var gs#74573 <= s_8_0
        fn_state.gs_74573 = s_8_0;
        // N s_8_2: jump b9
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_0: read-var gs#74573:u8
        let s_9_0: bool = fn_state.gs_74573;
    ...
    fn block_10<T: Tracer>(
        ...
        // D s_10_1: write-var gs#74574 <= s_10_0
        fn_state.gs_74574 = s_10_0;
        // N s_10_2: jump b11
    ...
    fn block_11<T: Tracer>(
        ...
        // D s_11_0: read-var gs#74574:u8
        let s_11_0: bool = fn_state.gs_74574;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#74575 <= s_12_0
        fn_state.gs_74575 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#74575:u8
        let s_13_0: bool = fn_state.gs_74575;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#74576 <= s_14_0
        fn_state.gs_74576 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#74576:u8
        let s_15_0: bool = fn_state.gs_74576;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#74577 <= s_17_0
        fn_state.gs_74577 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#74577:u8
        let s_18_0: bool = fn_state.gs_74577;
    ...
    fn block_19<T: Tracer>(
        ...
        let s_19_0: i64 = 64;
        // C s_19_1: const #20600u : u32
        let s_19_1: u32 = 20600;
        ...
        // D s_19_3: call __get_VMECID_P_EL2(s_19_2)
        let s_19_3: ProductType5c790c8ef59cc8b2 = u__get_VMECID_P_EL2(
            state,
            tracer,
            s_19_2,
        );
        // D s_19_4: write-var ga#100094 <= s_19_3
        fn_state.ga_100094 = s_19_3;
        // D s_19_5: read-var ga#100094.0:struct
        let s_19_5: u64 = fn_state.ga_100094._0;
    ...
    fn block_21<T: Tracer>(
        ...
        // D s_21_1: write-var gs#74579 <= s_21_0
        fn_state.gs_74579 = s_21_0;
        // N s_21_2: jump b22
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_0: read-var gs#74579:u8
        let s_22_0: bool = fn_state.gs_74579;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_5: write-var gs#74579 <= s_25_4
        fn_state.gs_74579 = s_25_4;
        // N s_25_6: jump b22
        return block_22(state, tracer, fn_state);
    }
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var __SCR_EL3_MECEn:u8
        let s_26_0: bool = fn_state.u__SCR_EL3_MECEn;
        ...
        // D s_26_5: write-var gs#74577 <= s_26_4
        fn_state.gs_74577 = s_26_4;
        // N s_26_6: jump b18
        return block_18(state, tracer, fn_state);
    }
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_0: read-var __SCR_EL3_MECEn:u8
        let s_28_0: bool = fn_state.u__SCR_EL3_MECEn;
        ...
        // D s_28_5: write-var gs#74576 <= s_28_4
        fn_state.gs_74576 = s_28_4;
        // N s_28_6: jump b15
        return block_15(state, tracer, fn_state);
    }
    fn block_29<T: Tracer>(
        ...
        // D s_29_2: write-var gs#74575 <= s_29_1
        fn_state.gs_74575 = s_29_1;
        // N s_29_3: jump b13
        return block_13(state, tracer, fn_state);
    }
    fn block_30<T: Tracer>(
        ...
        // D s_30_5: write-var gs#74574 <= s_30_4
        fn_state.gs_74574 = s_30_4;
        // N s_30_6: jump b11
        return block_11(state, tracer, fn_state);
    }
    fn block_31<T: Tracer>(
        ...
        // D s_31_4: write-var gs#74573 <= s_31_3
        fn_state.gs_74573 = s_31_3;
        // N s_31_5: jump b9
        return block_9(state, tracer, fn_state);
    }
