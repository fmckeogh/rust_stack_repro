...
use common::*;
pub fn execute_aarch32_instrs_LDREXB_Op_A_txt<T: Tracer>(
    state: &mut State,
    tracer: &T,
    n: i64,
    t: i64,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_3: write-var gs#879931 <= s_1_2
        fn_state.gs_879931 = s_1_2;
        // N s_1_4: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#879931:bv
        let s_2_0: Bits = fn_state.gs_879931;
