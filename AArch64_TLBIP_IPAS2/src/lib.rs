...
use Unreachable::*;
use common::*;
pub fn AArch64_TLBIP_IPAS2<T: Tracer>(
    state: &mut State,
    tracer: &T,
    security: u32,
    regime: u32,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_7: write-var gs#26695 <= s_1_6
        fn_state.gs_26695 = s_1_6;
        // N s_1_8: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#26695:u8
        let s_2_0: bool = fn_state.gs_26695;
        ...
        let s_2_16: i128 = 44;
        // D s_2_17: read-var Xt:u128
        let s_2_17: u128 = fn_state.Xt;
        // D s_2_18: cast zx s_2_17 -> bv
        let s_2_18: Bits = Bits::new(s_2_17 as u128, 128u16);
        ...
        let s_2_26: i128 = 64;
        // C s_2_27: const #107s : i
        let s_2_27: i128 = 107;
        // C s_2_28: const #64s : i
        let s_2_28: i128 = 64;
        // C s_2_29: const #12s : i
        let s_2_29: i128 = 12;
        // D s_2_30: read-var Xt:u128
        let s_2_30: u128 = fn_state.Xt;
        // D s_2_31: cast zx s_2_30 -> bv
        let s_2_31: Bits = Bits::new(s_2_30 as u128, 128u16);
        ...
        // D s_2_35: read-var r.13:struct
        let s_2_35: u8 = fn_state.r._13;
        // C s_2_36: const #2s : i
        let s_2_36: i128 = 2;
        // D s_2_37: cast zx s_2_35 -> bv
        let s_2_37: Bits = Bits::new(s_2_35 as u128, 4u16);
        // C s_2_38: const #1s : i64
        let s_2_38: i64 = 1;
        // C s_2_39: cast zx s_2_38 -> i
        let s_2_39: i128 = (i128::try_from(s_2_38).unwrap());
        // C s_2_40: const #1s : i
        let s_2_40: i128 = 1;
        // C s_2_41: add s_2_40 s_2_39
        let s_2_41: i128 = (s_2_40 + s_2_39);
        // D s_2_42: bit-extract s_2_37 s_2_36 s_2_41
        let s_2_42: Bits = (Bits::new(
            ((s_2_37) >> (s_2_36)).value(),
            u16::try_from(s_2_41).unwrap(),
        ));
        // D s_2_43: cast reint s_2_42 -> u8
        let s_2_43: u8 = (s_2_42.value() as u8);
        // D s_2_44: cast zx s_2_43 -> bv
        let s_2_44: Bits = Bits::new(s_2_43 as u128, 2u16);
        // C s_2_45: const #0u : u8
        let s_2_45: u8 = 0;
        ...
        // D s_2_48: not s_2_47
        let s_2_48: bool = !s_2_47;
        // N s_2_49: branch s_2_48 b17 b3
        if s_2_48 {
    ...
    fn block_3<T: Tracer>(
        ...
        // C s_3_0: const #1u : u8
        let s_3_0: bool = true;
        // D s_3_1: write-var gs#26703 <= s_3_0
        fn_state.gs_26703 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#26703:u8
        let s_4_0: bool = fn_state.gs_26703;
        // D s_4_1: write-var r.4 <= s_4_0
        fn_state.r._4 = s_4_0;
        // C s_4_2: const #1u : u8
        let s_4_2: bool = true;
        // D s_4_3: write-var r.3 <= s_4_2
        fn_state.r._3 = s_4_2;
        // C s_4_4: const #0u : u32
        let s_4_4: u32 = 0;
        // D s_4_5: read-var security:u32
        let s_4_5: u32 = fn_state.security;
        // D s_4_6: cmp-eq s_4_4 s_4_5
        let s_4_6: bool = ((s_4_4) == (s_4_5));
        // D s_4_7: not s_4_6
        let s_4_7: bool = !s_4_6;
        // N s_4_8: branch s_4_7 b9 b5
        if s_4_7 {
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_0: i128 = 63;
        // D s_10_1: read-var Xt:u128
        let s_10_1: u128 = fn_state.Xt;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#26703 <= s_17_0
        fn_state.gs_26703 = s_17_0;
        // N s_17_2: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#26695 <= s_18_0
        fn_state.gs_26695 = s_18_0;
        // N s_18_2: jump b2
        return block_2(state, tracer, fn_state);
    }
}
