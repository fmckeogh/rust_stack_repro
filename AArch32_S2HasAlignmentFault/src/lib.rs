...
extern crate alloc;
use common::*;
pub fn AArch32_S2HasAlignmentFault<T: Tracer>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var memattrs.2:struct
        let s_2_0: u32 = fn_state.memattrs._2;
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var gs#27928 <= s_3_0
        fn_state.gs_27928 = s_3_0;
        // N s_3_2: jump b4
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_0: read-var gs#27928:u8
        let s_4_0: bool = fn_state.gs_27928;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var aligned:u8
        let s_6_0: bool = fn_state.aligned;
        // D s_6_1: not s_6_0
        let s_6_1: bool = !s_6_0;
        // D s_6_2: write-var gs#27928 <= s_6_1
        fn_state.gs_27928 = s_6_1;
        // N s_6_3: jump b4
        return block_4(state, tracer, fn_state);
    }
    fn block_7<T: Tracer>(
