...
use Mem_set::*;
use common::*;
pub fn execute_ST1W_Z_P_BZ_D_x32_unscaled<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    esize: i64,
    ...
    fn block_0<T: Tracer>(
        ...
        // D s_0_3: write-var VLshadow#5082 <= s_0_2
        fn_state.VLshadow_5082 = s_0_2;
        // C s_0_4: const #() : ()
        let s_0_4: () = ();
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_0: read-var VLshadow#5082:i64
        let s_1_0: i64 = fn_state.VLshadow_5082;
        // D s_1_1: write-var VLshadow#5083 <= s_1_0
        fn_state.VLshadow_5083 = s_1_0;
        // C s_1_2: const #8s : i
        let s_1_2: i128 = 8;
        // D s_1_3: read-var VLshadow#5083:i64
        let s_1_3: i64 = fn_state.VLshadow_5083;
        ...
        // D s_1_7: read-var VLshadow#5083:i64
        let s_1_7: i64 = fn_state.VLshadow_5083;
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_0: read-var VLshadow#5083:i64
        let s_6_0: i64 = fn_state.VLshadow_5083;
        ...
        // D s_6_8: read-var VLshadow#5083:i64
        let s_6_8: i64 = fn_state.VLshadow_5083;
    ...
    fn block_7<T: Tracer>(
        ...
        // D s_7_6: write-var gs#244771 <= s_7_5
        fn_state.gs_244771 = s_7_5;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_1: read-var gs#244771:i64
        let s_8_1: i64 = fn_state.gs_244771;
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_33: cast reint s_12_32 -> u64
        let s_12_33: u64 = (s_12_32.value() as u64);
        // C s_12_34: const #0s : i
        let s_12_34: i128 = 0;
        // C s_12_35: const #32s : i
        let s_12_35: i128 = 32;
        // D s_12_36: cast zx s_12_33 -> bv
        let s_12_36: Bits = Bits::new(s_12_33 as u128, 64u16);
        // D s_12_37: bit-extract s_12_36 s_12_34 s_12_35
        let s_12_37: Bits = (Bits::new(
            ((s_12_36) >> (s_12_34)).value(),
            u16::try_from(s_12_35).unwrap(),
        ));
        // D s_12_38: cast reint s_12_37 -> u32
        let s_12_38: u32 = (s_12_37.value() as u32);
        ...
        let s_12_41: Bits = Bits::new(s_12_38 as u128, 32u16);
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_1: write-var gs#244766 <= s_18_0
        fn_state.gs_244766 = s_18_0;
        // N s_18_2: jump b19
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_0: read-var gs#244766:u8
        let s_19_0: bool = fn_state.gs_244766;
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_2: write-var gs#244766 <= s_23_1
        fn_state.gs_244766 = s_23_1;
        // N s_23_3: jump b19
        return block_19(state, tracer, fn_state);
    }
}
