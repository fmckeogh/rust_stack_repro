...
use common::*;
pub fn decode_urshl_advsimd_aarch64_instrs_vector_arithmetic_binary_uniform_shift_sisd<
    T: Tracer,
>(
    state: &mut State,
    tracer: &T,
    ...
    fn block_1<T: Tracer>(
        ...
        // D s_1_1: write-var gs#171544 <= s_1_0
        fn_state.gs_171544 = s_1_0;
        // N s_1_2: jump b2
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_0: read-var gs#171544:u8
        let s_2_0: bool = fn_state.gs_171544;
    ...
    fn block_5<T: Tracer>(
        ...
        // D s_5_5: write-var gs#171544 <= s_5_4
        fn_state.gs_171544 = s_5_4;
        // N s_5_6: jump b2
        return block_2(state, tracer, fn_state);
    }
}
