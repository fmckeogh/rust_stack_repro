...
use common::*;
pub fn execute_PRFH_I_P_BI_S<T: Tracer>(
    state: &mut State,
    tracer: &T,
    VL: i64,
    esize: i64,
    ...
    fn block_3<T: Tracer>(
        ...
        // D s_3_1: write-var baseshadow#4488 <= s_3_0
        fn_state.baseshadow_4488 = s_3_0;
        ...
        // D s_3_8: write-var gs#225884 <= s_3_7
        fn_state.gs_225884 = s_3_7;
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_1: read-var gs#225884:i64
        let s_4_1: i64 = fn_state.gs_225884;
    ...
    fn block_8<T: Tracer>(
        ...
        // D s_8_10: read-var baseshadow#4488:u64
        let s_8_10: u64 = fn_state.baseshadow_4488;
