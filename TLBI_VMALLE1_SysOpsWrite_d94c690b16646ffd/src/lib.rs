...
use EL2Enabled::*;
use common::*;
pub fn TLBI_VMALLE1_SysOpsWrite_d94c690b16646ffd<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    op0: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_7: u32 = 0;
        // D s_6_8: call AArch64_TLBI_VMALL(s_6_2, s_6_5, s_6_4, s_6_6, s_6_7)
        let s_6_8: () = AArch64_TLBI_VMALL(
            state,
            tracer,
            s_6_2,
            s_6_5,
    ...
    fn block_7<T: Tracer>(
        ...
        // C s_7_3: const #3u : u32
        let s_7_3: u32 = 3;
        // C s_7_4: const #1080u : u32
        let s_7_4: u32 = 1080;
        // D s_7_5: read-reg s_7_4:u16
        let s_7_5: u16 = {
            let value = state.read_register::<u16>(s_7_4 as isize);
            tracer.read_register(s_7_4 as isize, value);
            value
        };
        // C s_7_6: const #0u : u32
        let s_7_6: u32 = 0;
        // C s_7_7: const #0u : u32
        let s_7_7: u32 = 0;
        // D s_7_8: call AArch64_TLBI_VMALL(s_7_2, s_7_3, s_7_5, s_7_6, s_7_7)
    ...
    fn block_9<T: Tracer>(
        ...
        // C s_9_5: const #4u : u32
        let s_9_5: u32 = 4;
        // C s_9_6: const #0u : u32
        let s_9_6: u32 = 0;
        // C s_9_7: const #0u : u32
        let s_9_7: u32 = 0;
        // D s_9_8: call AArch64_TLBI_VMALL(s_9_2, s_9_5, s_9_4, s_9_6, s_9_7)
        let s_9_8: () = AArch64_TLBI_VMALL(
            state,
            tracer,
            s_9_2,
            s_9_5,
    ...
    fn block_10<T: Tracer>(
        ...
        // C s_10_3: const #3u : u32
        let s_10_3: u32 = 3;
        // C s_10_4: const #1080u : u32
        let s_10_4: u32 = 1080;
        // D s_10_5: read-reg s_10_4:u16
        let s_10_5: u16 = {
            let value = state.read_register::<u16>(s_10_4 as isize);
        ...
        let s_10_7: u32 = 0;
        // D s_10_8: call AArch64_TLBI_VMALL(s_10_2, s_10_3, s_10_5, s_10_6, s_10_7)
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#103081 <= s_12_0
        fn_state.gs_103081 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#103081:u8
        let s_13_0: bool = fn_state.gs_103081;
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_1: write-var gs#103082 <= s_15_0
        fn_state.gs_103082 = s_15_0;
        // N s_15_2: jump b16
    ...
    fn block_16<T: Tracer>(
        ...
        // D s_16_0: read-var gs#103082:u8
        let s_16_0: bool = fn_state.gs_103082;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#103084 <= s_17_0
        fn_state.gs_103084 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#103084:u8
        let s_18_0: bool = fn_state.gs_103084;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#103085 <= s_19_0
        fn_state.gs_103085 = s_19_0;
        // N s_19_2: jump b20
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_0: read-var gs#103085:u8
        let s_20_0: bool = fn_state.gs_103085;
    ...
    fn block_22<T: Tracer>(
        ...
        // D s_22_1: write-var gs#103086 <= s_22_0
        fn_state.gs_103086 = s_22_0;
        // N s_22_2: jump b23
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_0: read-var gs#103086:u8
        let s_23_0: bool = fn_state.gs_103086;
    ...
    fn block_25<T: Tracer>(
        ...
        // D s_25_1: write-var gs#103087 <= s_25_0
        fn_state.gs_103087 = s_25_0;
        // N s_25_2: jump b26
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_0: read-var gs#103087:u8
        let s_26_0: bool = fn_state.gs_103087;
    ...
    fn block_27<T: Tracer>(
        ...
        // D s_27_1: write-var gs#103088 <= s_27_0
        fn_state.gs_103088 = s_27_0;
        // N s_27_2: jump b28
    ...
    fn block_28<T: Tracer>(
        ...
        // D s_28_0: read-var gs#103088:u8
        let s_28_0: bool = fn_state.gs_103088;
    ...
    fn block_29<T: Tracer>(
        ...
        // D s_29_1: write-var gs#103089 <= s_29_0
        fn_state.gs_103089 = s_29_0;
        // N s_29_2: jump b30
    ...
    fn block_30<T: Tracer>(
        ...
        // D s_30_0: read-var gs#103089:u8
        let s_30_0: bool = fn_state.gs_103089;
    ...
    fn block_31<T: Tracer>(
        ...
        // C s_31_5: const #4u : u32
        let s_31_5: u32 = 4;
        // C s_31_6: const #0u : u32
        let s_31_6: u32 = 0;
        // C s_31_7: const #0u : u32
        let s_31_7: u32 = 0;
        // D s_31_8: call AArch64_TLBI_VMALL(s_31_2, s_31_5, s_31_4, s_31_6, s_31_7)
        let s_31_8: () = AArch64_TLBI_VMALL(
            state,
            tracer,
            s_31_2,
            s_31_5,
    ...
    fn block_32<T: Tracer>(
        ...
        // C s_32_5: const #4u : u32
        let s_32_5: u32 = 4;
        // C s_32_6: const #0u : u32
        let s_32_6: u32 = 0;
        // C s_32_7: const #1u : u32
        let s_32_7: u32 = 1;
        // D s_32_8: call AArch64_TLBI_VMALL(s_32_2, s_32_5, s_32_4, s_32_6, s_32_7)
        let s_32_8: () = AArch64_TLBI_VMALL(
            state,
            tracer,
            s_32_2,
            s_32_5,
    ...
    fn block_33<T: Tracer>(
        ...
        // D s_33_5: write-var gs#103089 <= s_33_4
        fn_state.gs_103089 = s_33_4;
        // N s_33_6: jump b30
        return block_30(state, tracer, fn_state);
    }
    fn block_34<T: Tracer>(
        ...
        // D s_34_2: write-var gs#103088 <= s_34_1
        fn_state.gs_103088 = s_34_1;
        // N s_34_3: jump b28
        return block_28(state, tracer, fn_state);
    }
    fn block_35<T: Tracer>(
        ...
        // D s_35_2: write-var gs#103087 <= s_35_1
        fn_state.gs_103087 = s_35_1;
        // N s_35_3: jump b26
        return block_26(state, tracer, fn_state);
    }
    ...
    fn block_37<T: Tracer>(
        ...
        // D s_37_1: write-var gs#103090 <= s_37_0
        fn_state.gs_103090 = s_37_0;
        // N s_37_2: jump b38
    ...
    fn block_38<T: Tracer>(
        ...
        // D s_38_0: read-var gs#103090:u8
        let s_38_0: bool = fn_state.gs_103090;
    ...
    fn block_39<T: Tracer>(
        ...
        // D s_39_1: write-var gs#103091 <= s_39_0
        fn_state.gs_103091 = s_39_0;
        // N s_39_2: jump b40
    ...
    fn block_40<T: Tracer>(
        ...
        // D s_40_0: read-var gs#103091:u8
        let s_40_0: bool = fn_state.gs_103091;
    ...
    fn block_41<T: Tracer>(
        ...
        // D s_41_1: write-var gs#103092 <= s_41_0
        fn_state.gs_103092 = s_41_0;
        // N s_41_2: jump b42
    ...
    fn block_42<T: Tracer>(
        ...
        // D s_42_0: read-var gs#103092:u8
        let s_42_0: bool = fn_state.gs_103092;
    ...
    fn block_43<T: Tracer>(
        ...
        // C s_43_5: const #4u : u32
        let s_43_5: u32 = 4;
        // C s_43_6: const #1u : u32
        let s_43_6: u32 = 1;
        // C s_43_7: const #0u : u32
        let s_43_7: u32 = 0;
        // D s_43_8: call AArch64_TLBI_VMALL(s_43_2, s_43_5, s_43_4, s_43_6, s_43_7)
        let s_43_8: () = AArch64_TLBI_VMALL(
            state,
            tracer,
            s_43_2,
            s_43_5,
    ...
    fn block_44<T: Tracer>(
        ...
        // C s_44_5: const #4u : u32
        let s_44_5: u32 = 4;
        // C s_44_6: const #1u : u32
        let s_44_6: u32 = 1;
        // C s_44_7: const #1u : u32
        let s_44_7: u32 = 1;
        // D s_44_8: call AArch64_TLBI_VMALL(s_44_2, s_44_5, s_44_4, s_44_6, s_44_7)
        let s_44_8: () = AArch64_TLBI_VMALL(
            state,
            tracer,
            s_44_2,
            s_44_5,
    ...
    fn block_45<T: Tracer>(
        ...
        // D s_45_5: write-var gs#103092 <= s_45_4
        fn_state.gs_103092 = s_45_4;
        // N s_45_6: jump b42
        return block_42(state, tracer, fn_state);
    }
    fn block_46<T: Tracer>(
        ...
        // D s_46_2: write-var gs#103091 <= s_46_1
        fn_state.gs_103091 = s_46_1;
        // N s_46_3: jump b40
        return block_40(state, tracer, fn_state);
    }
    fn block_47<T: Tracer>(
        ...
        // D s_47_2: write-var gs#103090 <= s_47_1
        fn_state.gs_103090 = s_47_1;
        // N s_47_3: jump b38
        return block_38(state, tracer, fn_state);
    }
    fn block_48<T: Tracer>(
        ...
        // D s_48_5: write-var gs#103086 <= s_48_4
        fn_state.gs_103086 = s_48_4;
        // N s_48_6: jump b23
        return block_23(state, tracer, fn_state);
    }
    ...
    fn block_50<T: Tracer>(
        ...
        // D s_50_0: read-var __HFGITR_EL2_TLBIVMALLE1:u8
        let s_50_0: bool = fn_state.u__HFGITR_EL2_TLBIVMALLE1;
        ...
        // D s_50_5: write-var gs#103085 <= s_50_4
        fn_state.gs_103085 = s_50_4;
        // N s_50_6: jump b20
        return block_20(state, tracer, fn_state);
    }
    ...
    fn block_52<T: Tracer>(
        ...
        // D s_52_5: write-var gs#103083 <= s_52_4
        fn_state.gs_103083 = s_52_4;
        // N s_52_6: jump b53
    ...
    fn block_53<T: Tracer>(
        ...
        // D s_53_0: read-var gs#103083:u8
        let s_53_0: bool = fn_state.gs_103083;
        // D s_53_1: write-var gs#103084 <= s_53_0
        fn_state.gs_103084 = s_53_0;
        // N s_53_2: jump b18
        return block_18(state, tracer, fn_state);
    }
    fn block_54<T: Tracer>(
        ...
        // D s_54_1: write-var gs#103083 <= s_54_0
        fn_state.gs_103083 = s_54_0;
        // N s_54_2: jump b53
        return block_53(state, tracer, fn_state);
    }
    fn block_55<T: Tracer>(
        ...
        // D s_55_2: write-var gs#103082 <= s_55_1
        fn_state.gs_103082 = s_55_1;
        // N s_55_3: jump b16
        return block_16(state, tracer, fn_state);
    }
    ...
    fn block_57<T: Tracer>(
        ...
        // D s_57_5: write-var gs#103081 <= s_57_4
        fn_state.gs_103081 = s_57_4;
        // N s_57_6: jump b13
        return block_13(state, tracer, fn_state);
    }
