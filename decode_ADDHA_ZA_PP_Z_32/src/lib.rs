...
extern crate alloc;
use CurrentVL_read::*;
use execute_ADDHA_ZA_PP_Z_32::*;
use HaveSME::*;
use common::*;
pub fn decode_ADDHA_ZA_PP_Z_32<T: Tracer>(
    state: &mut State,
    tracer: &T,
    V: bool,
    Pm: u8,
    ...
    fn block_1<T: Tracer>(
        ...
        fn_state.n = s_1_13;
        // D s_1_15: read-var ZAda:u8
        let s_1_15: u8 = fn_state.ZAda;
        ...
        // D s_1_19: write-var da <= s_1_18
        fn_state.da = s_1_18;
        // D s_1_20: read-var VL:i64
        let s_1_20: i64 = fn_state.VL;
        // C s_1_21: const #128s : i
        let s_1_21: i128 = 128;
        // D s_1_22: cast zx s_1_20 -> i
        let s_1_22: i128 = (i128::try_from(s_1_20).unwrap());
        // D s_1_23: cmp-eq s_1_22 s_1_21
        let s_1_23: bool = ((s_1_22) == (s_1_21));
        // D s_1_24: not s_1_23
        let s_1_24: bool = !s_1_23;
        // N s_1_25: branch s_1_24 b3 b2
        if s_1_24 {
    ...
    fn block_2<T: Tracer>(
        ...
        // D s_2_27: call execute_ADDHA_ZA_PP_Z_32(s_2_0, s_2_21, s_2_22, s_2_23, s_2_24, s_2_25, s_2_26)
        let s_2_27: () = execute_ADDHA_ZA_PP_Z_32(
            state,
            tracer,
            s_2_0,
            s_2_21,
    ...
    fn block_4<T: Tracer>(
        ...
        // D s_4_27: call execute_ADDHA_ZA_PP_Z_32(s_4_0, s_4_21, s_4_22, s_4_23, s_4_24, s_4_25, s_4_26)
        let s_4_27: () = execute_ADDHA_ZA_PP_Z_32(
            state,
            tracer,
            s_4_0,
            s_4_21,
    ...
    fn block_6<T: Tracer>(
        ...
        let s_6_25: i64 = 32;
        // D s_6_26: read-var n:i64
        let s_6_26: i64 = fn_state.n;
        // D s_6_27: call execute_ADDHA_ZA_PP_Z_32(s_6_0, s_6_21, s_6_22, s_6_23, s_6_24, s_6_25, s_6_26)
        let s_6_27: () = execute_ADDHA_ZA_PP_Z_32(
            state,
            tracer,
            s_6_0,
            s_6_21,
    ...
    fn block_8<T: Tracer>(
        ...
        let s_8_25: i64 = 32;
        // D s_8_26: read-var n:i64
        let s_8_26: i64 = fn_state.n;
        // D s_8_27: call execute_ADDHA_ZA_PP_Z_32(s_8_0, s_8_21, s_8_22, s_8_23, s_8_24, s_8_25, s_8_26)
        let s_8_27: () = execute_ADDHA_ZA_PP_Z_32(
            state,
            tracer,
            s_8_0,
            s_8_21,
    ...
    fn block_10<T: Tracer>(
        ...
        let s_10_25: i64 = 32;
        // D s_10_26: read-var n:i64
        let s_10_26: i64 = fn_state.n;
        // D s_10_27: call execute_ADDHA_ZA_PP_Z_32(s_10_0, s_10_21, s_10_22, s_10_23, s_10_24, s_10_25, s_10_26)
        let s_10_27: () = execute_ADDHA_ZA_PP_Z_32(
            state,
            tracer,
            s_10_0,
            s_10_21,
