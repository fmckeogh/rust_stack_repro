...
use common::*;
pub fn ICH_LR_SysRegWrite32_c3bfb21b3a349563<T: Tracer>(
    state: &mut State,
    tracer: &T,
    el: u8,
    coproc: u8,
    ...
    fn block_6<T: Tracer>(
        ...
        // D s_6_2: call Mk_ICH_LR_Type(s_6_1)
        let s_6_2: ProductType700c18a878c5601b = Mk_ICH_LR_Type(state, tracer, s_6_1);
        // C s_6_3: const #10s : i64
        let s_6_3: i64 = 10;
        // D s_6_4: call ICH_LR_set(s_6_3, s_6_2)
        let s_6_4: () = ICH_LR_set(state, tracer, s_6_3, s_6_2);
        // N s_6_5: return
        return;
    }
    fn block_7<T: Tracer>(
    ...
    fn block_9<T: Tracer>(
        ...
        // D s_9_2: call Mk_ICH_LR_Type(s_9_1)
        let s_9_2: ProductType700c18a878c5601b = Mk_ICH_LR_Type(state, tracer, s_9_1);
        // C s_9_3: const #10s : i64
        let s_9_3: i64 = 10;
        // D s_9_4: call ICH_LR_set(s_9_3, s_9_2)
        let s_9_4: () = ICH_LR_set(state, tracer, s_9_3, s_9_2);
        // N s_9_5: return
        return;
    }
    ...
    fn block_12<T: Tracer>(
        ...
        // D s_12_1: write-var gs#129098 <= s_12_0
        fn_state.gs_129098 = s_12_0;
        // N s_12_2: jump b13
    ...
    fn block_13<T: Tracer>(
        ...
        // D s_13_0: read-var gs#129098:u8
        let s_13_0: bool = fn_state.gs_129098;
    ...
    fn block_14<T: Tracer>(
        ...
        // D s_14_1: write-var gs#129099 <= s_14_0
        fn_state.gs_129099 = s_14_0;
        // N s_14_2: jump b15
    ...
    fn block_15<T: Tracer>(
        ...
        // D s_15_0: read-var gs#129099:u8
        let s_15_0: bool = fn_state.gs_129099;
    ...
    fn block_17<T: Tracer>(
        ...
        // D s_17_1: write-var gs#129100 <= s_17_0
        fn_state.gs_129100 = s_17_0;
        // N s_17_2: jump b18
    ...
    fn block_18<T: Tracer>(
        ...
        // D s_18_0: read-var gs#129100:u8
        let s_18_0: bool = fn_state.gs_129100;
    ...
    fn block_19<T: Tracer>(
        ...
        // D s_19_1: write-var gs#129101 <= s_19_0
        fn_state.gs_129101 = s_19_0;
        // N s_19_2: jump b20
    ...
    fn block_20<T: Tracer>(
        ...
        // D s_20_0: read-var gs#129101:u8
        let s_20_0: bool = fn_state.gs_129101;
    ...
    fn block_23<T: Tracer>(
        ...
        // D s_23_5: write-var gs#129101 <= s_23_4
        fn_state.gs_129101 = s_23_4;
        // N s_23_6: jump b20
        return block_20(state, tracer, fn_state);
    }
    fn block_24<T: Tracer>(
        ...
        // D s_24_3: write-var gs#129100 <= s_24_2
        fn_state.gs_129100 = s_24_2;
        // N s_24_4: jump b18
        return block_18(state, tracer, fn_state);
    }
    ...
    fn block_26<T: Tracer>(
        ...
        // D s_26_5: write-var gs#129099 <= s_26_4
        fn_state.gs_129099 = s_26_4;
        // N s_26_6: jump b15
        return block_15(state, tracer, fn_state);
    }
    fn block_27<T: Tracer>(
        ...
        // D s_27_4: write-var gs#129098 <= s_27_3
        fn_state.gs_129098 = s_27_3;
        // N s_27_5: jump b13
        return block_13(state, tracer, fn_state);
    }
